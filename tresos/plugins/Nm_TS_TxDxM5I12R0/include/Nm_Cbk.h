...
#if (defined Nm_ForwardSynchronizedPncShutdown)
#error Nm_ForwardSynchronizedPncShutdown already defined
#endif

#define Nm_ForwardSynchronizedPncShutdown(NetworkHandle,PncBitVectorPtr)         \
...
/* !LINKSTO Nm.ASR403.SWS_Nm_00230,1 */
...
#ifndef RTE_SCHM_SWCBSW_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN
#define RTE_SCHM_SWCBSW_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN
/** \brief Calls ComM_Nm_ForwardSynchronizedPncShutdown.
 **
 ** Calls ComM_Nm_ForwardSynchronizedPncShutdown.
 **
 ** Preconditions:
 ** - The channel handle should be valid and the module should have been
 **   initialized for this channel (checked).
 ...
 ** \param[in] PncBitVectorPtr Data that needs to bo forwarded.
 **
 ** \ServiceID{40}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous} */
...
#endif /* RTE_SCHM_SWCBSW_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN */
#endif /* #if ((NM_SYNCHRONIZED_PNC_SHUTDOWN_ENABLED == STD_ON) && \
        *      (NM_DEV_ERROR_DETECT == STD_ON))
        */
