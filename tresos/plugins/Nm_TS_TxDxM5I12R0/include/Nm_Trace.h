...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_NM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_ENTRY
/** \brief Entry point of function Nm_RequestSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_NM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_ENTRY(NetworkHandle,PncId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_NM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_EXIT
/** \brief Exit point of function Nm_RequestSynchronizedPncShutdown()
 **
 ** The first parameter of the macro is the return
 ** value of the function, followed by the arguments
 ** of the function.
 */
#define DBG_NM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_EXIT(Retval,NetworkHandle,PncId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_ENTRY
/** \brief Entry point of function Nm_ForwardSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_ENTRY(NetworkHandle,PncBitVectorPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_EXIT
/** \brief Exit point of function Nm_ForwardSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_EXIT(NetworkHandle,PncBitVectorPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
