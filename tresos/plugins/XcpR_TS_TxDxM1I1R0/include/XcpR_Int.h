...
#if (defined XCPR_INVALID_DOMAIN)
#error XCPR_INVALID_DOMAIN already defined
#endif
/** \brief Invalid domain value. */
#define XCPR_INVALID_DOMAIN                                0xFFU
...
#define XCPR_NR_DET_ERROR_TYPES_PROCESSDEST                 3U
...
#define XCPR_DET_REPORT_E_INVALID_CONNECT_MODE              1U
...
#define XCPR_DET_REPORT_E_INVALID_LENGTH                    2U
 ...
 **
 ** This function Initializes all variables used by the XcpR receive processor.
 **/
extern FUNC(void, XCPR_CODE) XcpR_InitReceiveProcessor(void);

/** \brief Function to initialize transmit processor
 **
 ** This function Initializes all variables used by the XcpR transmit processor.
 **/
...
/** \brief Function to get the data to be passed through TriggerTransmit function
 **
 ** Use this function to get the data to be passed through TriggerTransmit function.
 **
 ...
 **             E_NOT_OK, if no data is available to be written into the output buffer copied
 **/
 ...
 ** \Reentrancy{Non-Reentrant}
 ** \Synchronicity{Synchronous} */
extern FUNC(void, XCPR_CODE) XcpR_ProcessBusMonitor(void);
 ...
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(Std_ReturnType, XCPR_CODE) XcpR_FindDestinationPduId
(
 ...
 **\ Runtime error {XCPR_E_INVALID_CONNECT_MODE}
 **\ Runtime error {XCPR_E_INVALID_LENGTH}
 **/
