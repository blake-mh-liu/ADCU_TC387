 ...
 **
 ** This function is called by the lower layer module when an XCPR PDU has been received.
 **
 ...
 ** \Reentrancy{Reentrant for different XcpRRxSrcPduId and non-Reentrant for the same XcpRRxSrcPduId}
 ...
 **
 ** This function is called by the lower layer module when an XCPR PDU has been transmitted.
 **
 ** \param[in] XcpRTxPduId PDU-ID that has been transmitted.
 ** \ServiceID{::XCPR_SID_IF_TX_CONFIRMATION}
 ** \Reentrancy{Reentrant for different XcpRTxPduId and non-Reentrant for the same XcpRTxPduId}
 ** \Synchronicity{Synchronous} */
 ...
 ** \Synchronicity{Synchronous} */
extern FUNC(void, XCPR_CODE) XcpR_SoAdSoConModeChg
(
