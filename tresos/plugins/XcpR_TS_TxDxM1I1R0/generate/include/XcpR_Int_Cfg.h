...
[!IF "node:existsAndTrue(XcpRGeneral/XcpRDevErrorDetect)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpRGeneral/XcpREventPacketEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "num:integer(count(XcpRGeneral/XcpRRoutingToConnectionMapping/eb-list::*)) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverFlexRay']/eb-list::*[node:existsAndTrue(XcpRDestinationSequenceCorrectionEnabled)])) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!"num:integer($NoOfDestEthernetPdus)"!]U

[!VAR "NoOfFlxMultiplePackSrc"="num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverFlexRay']/eb-list::*[node:existsAndTrue(XcpRSourcePackMultiMsgInOneFlexRayFrame)]))"!][!//
[!VAR "NoOfEthMultiplePackSrc"="num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverEthernet']/eb-list::*[node:existsAndTrue(XcpRSourcePackMultiMsgInOneEthernetFrame)]))"!][!//
[!VAR "NoOfFlxMultiplePackDest"="num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverFlexRay']/eb-list::*[node:existsAndTrue(XcpRDestinationPackMultiMsgInOneFlexRayFrame)]))"!][!//
[!VAR "NoOfEthMultiplePackDest"="num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet']/eb-list::*[node:existsAndTrue(XcpRDestinationPackMultiMsgInOneEthernetFrame)]))"!][!//
...
#define XCPR_NO_OF_DEST_MULTI_PDUS_IN_FRAME       [!"num:integer($NoOfFlxMultiplePackDest + $NoOfEthMultiplePackDest)"!]U
...
[!IF "num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverCANFD']/eb-list::*[node:existsAndTrue(XcpRDestinationCanFdMaxDlcRequired)])) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRPdu ='XcpRRxPdu']/eb-list::*[node:existsAndTrue(XcpRSrcPduSupportRxFromRxIndication)])) > 0) or (num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRPdu ='XcpRTxPdu']/eb-list::*[node:existsAndTrue(XcpRSrcPduSupportRxFromXcpRTransmit)])) > 0)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRPdu ='XcpRRxPdu']/eb-list::*[node:existsAndTrue(XcpRRxSrcPduSupportTxFromRxIndication)])) > 0) or (num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRPdu ='XcpRTxPdu']/eb-list::*[node:existsAndTrue(XcpRTxSrcPduSupportTxFromXcpRTransmit)])) > 0)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRPdu ='XcpRTxPdu']/eb-list::*[node:existsAndTrue(XcpRDestPduSupportTxFromTxConfirmation)])) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#define XCPR_MAX_PACKAGE_SIZE_RECEPTION    [!"num:integer($XcpRMaxSrcLength)"!]U
