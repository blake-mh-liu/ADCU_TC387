...
*/!][!VAR "NoOfDestFlexRayPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverFlexRay'])"!][!/*
*/!][!VAR "NoOfSrcFlexRayPdus"="count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverFlexRay'])"!][!/*
*/!][!VAR "NoOfDestCDDPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverCDD'])"!][!/*
*/!][!VAR "NoOfSrcCDDPdus"="count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverCDD'])"!][!/*
*/!][!VAR "NoOfDestCanFDPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverCANFD'])"!][!/*
*/!][!VAR "NoOfSrcCanFDPdus"="count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverCANFD'])"!][!/*
*/!][!VAR "NoOfDestCanPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[(XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverCAN')])"!][!/*
*/!][!VAR "NoOfSrcCanPdus"="count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[(XcpRSourceInterfaceType = 'XcpRSourceConnectionOverCAN')])"!][!/*
*/!][!VAR "NoOfDestEthernetPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet'])"!][!/*
*/!][!VAR "NoOfSrcEthernetPdus"="count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverEthernet'])"!][!/*

*** Ethernet: Variable to enable the automatically open socket connections ***
*/!][!VAR "XcpROpenSoCon" = "(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[(XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet') and (node:existsAndTrue(XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRDestinationOpenSoCon))]) > 0) or (count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[(XcpRSourceInterfaceType = 'XcpRSourceConnectionOverEthernet') and (node:existsAndTrue(XcpRSourceInterfaceType/eb-choice::*[1]/XcpRSourceOpenSoCon))]) > 0)"!][!/*

*** Variable to enable the support for SoAd Socket Protocol Tcp ***
*/!][!VAR "XcpRSupportForSoAdSocketProtocolTcp" = "'false'"!][!/*
*/!][!VAR "NoOfXcpRTcpIpConnections" = "0"!][!/*
*/!][!LOOP "XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet']"!][!/*
  */!][!VAR "TxDestPduName"="as:name(node:ref(./XcpRPdu/eb-choice::*[1]/XcpRTxDestinationPduReference))"!][!/*
    ...
    */!][!SELECT "node:ref(./XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRDestinationConnectionSoAdConfigRef)/SoAdPduRoute/eb-list::*[node:refvalid(SoAdTxPduRef) and (as:name(node:ref(SoAdTxPduRef)) = $TxDestPduName) and node:refvalid(SoAdPduRouteDest/eb-list::*/SoAdTxSocketConnOrSocketConnBundleRef) and (node:ref(SoAdPduRouteDest/eb-list::*/SoAdTxSocketConnOrSocketConnBundleRef)/../../SoAdSocketProtocol = 'SoAdSocketTcp')]"!][!/*
      */!][!VAR "XcpRSupportForSoAdSocketProtocolTcp" = "'true'"!][!/*
...
*/!][!VAR "XcpRSupportForSoAdSocketProtocolUdp" = "'false'"!][!/*
*/!][!LOOP "XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet']"!][!/*
  */!][!IF "node:existsAndTrue(./XcpRIsDestMasterConnection)"!][!/*
  */!][!VAR "TxDestPduName" = "as:name(node:ref(./XcpRPdu/eb-choice::*[1]/XcpRTxDestinationPduReference))"!][!/*
    */!][!IF "node:exists(as:modconf('SoAd')/SoAdConfig/eb-list::*/SoAdPduRoute/eb-list::*/SoAdPduRouteDest/eb-list::*/SoAdTxSocketConnOrSocketConnBundleRef)"!][!/*
    */!][!SELECT "node:ref(./XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRDestinationConnectionSoAdConfigRef)/SoAdPduRoute/eb-list::*[node:refvalid(SoAdTxPduRef) and (as:name(node:ref(SoAdTxPduRef)) = $TxDestPduName) and node:refvalid(SoAdPduRouteDest/eb-list::*/SoAdTxSocketConnOrSocketConnBundleRef) and (node:ref(SoAdPduRouteDest/eb-list::*/SoAdTxSocketConnOrSocketConnBundleRef)/../../SoAdSocketProtocol = 'SoAdSocketUdp')]"!][!/*
      */!][!VAR "XcpRSupportForSoAdSocketProtocolUdp" = "'true'"!][!/*
      */!][!BREAK!][!/*
    */!][!ENDSELECT!][!/*
    */!][!ENDIF!][!/*
  */!][!ENDIF!][!/*
...
*/!][!MACRO "GetPackagePduSize","FlxPackMultiMsgInOneFrame","EthPackMultiMsgInOneFrame","FlxMaxMsgLengthInit","EthMaxMsgLengthInit","XcpRConnectionType","FlxHeaderAlignment","SequenceCorrection", "XcpRMaxDataLength"!][!/*
  ...
  */!][!ELSEIF "$XcpRConnectionType = 'XcpRSourceConnectionOverCANFD'"!][!/*
    */!][!IF "node:existsAndTrue(XcpRSourceInterfaceType/eb-choice::*[1]/XcpRSourceCanFdMaxDlcRequired)"!][!/*
      */!][!VAR "XcpRPackagePduSize" = "XcpRSourceInterfaceType/eb-choice::*[1]/XcpRSourceCanFdMaxDlc"!][!/*
    */!][!ELSE!][!/*
  ...
  */!][!ELSEIF "$XcpRConnectionType = 'XcpRDestinationConnectionOverCANFD'"!][!/*
    */!][!IF "node:existsAndTrue(XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRDestinationCanFdMaxDlcRequired)"!][!/*
      */!][!VAR "XcpRPackagePduSize" = "XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRDestinationCanFdMaxDlc"!][!/*
    */!][!ELSE!][!/*
      */!][!VAR "XcpRPackagePduSize" = "$XcpRMaxDataLength"!][!/*
    */!][!ENDIF!][!/*
...
*/!][!LOOP "(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*)"!][!/*
...
*/!][!LOOP "(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType='XcpRDestinationConnectionOverCDD' and (XcpRPdu = 'XcpRTxPdu')])"!][!/*
  */!][!VAR "CddShortName" = "XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRCddInformation/XcpRCddShortName"!][!/*
  */!][!IF "not(contains($CddHeaderFileList, concat(' ', XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRCddInformation/XcpRCddHeaderFile, ' ')))"!][!/*
    */!][!VAR "CddHeaderFileList" = "concat($CddHeaderFileList, XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRCddInformation/XcpRCddHeaderFile, ' ')"!][!/*
  */!][!ENDIF!][!/*
*/!][!ENDLOOP!][!/*
...
*/!][!MACRO "GetCallbackFunction","Connection","PDUType", "NrOfTxSources"!][!/*
  */!][!IF "$Connection = 'XCPR_CONNECTION_OVER_CDD'"!][!/*
    */!][!IF "$PDUType = 'Tx'"!][!/*
        ...
        */!][!IF "node:existsAndTrue(XcpRIsDestMasterConnection) and ($NrOfTxSources > 0)"!][!/*
            */!][!VAR "TxConfirmationFunc" = "concat('&',XcpRDestUpperLayerInformation/XcpRTxConfirmationFunctionName)"!][!/*
            */!][!IF "node:existsAndTrue(XcpRPdu/eb-choice::*[1]/XcpRTxDestinationPduSupportForCddTriggerTransmit)"!][!/*
        ...
        */!][!ELSE!][!/*
            ...
            */!][!VAR "TriggerTransmitFunc" = "'NULL_PTR'"!][!/*
        */!][!ENDIF!][!/*
        */!][!VAR "TransmitFunc" = "concat('&',XcpRDestinationInterfaceType/eb-choice::*[1]/XcpRCddInformation/XcpRCddTransmitFunctionName)"!][!/*
    */!][!ELSE!][!/*
  ...
  */!][!ELSEIF "$Connection = 'XCPR_CONNECTION_OVER_FLEXRAY'"!][!/*
        ...
        */!][!IF "node:existsAndTrue(XcpRIsDestMasterConnection) and ($NrOfTxSources > 0)"!][!/*
            */!][!VAR "TxConfirmationFunc" = "concat('&',XcpRDestUpperLayerInformation/XcpRTxConfirmationFunctionName)"!][!/*
            */!][!IF "node:existsAndTrue(XcpRPdu/eb-choice::*[1]/XcpRTxDestinationPduSupportForFrTriggerTransmit)"!][!/*
                */!][!VAR "TriggerTransmitFunc" = "concat('&',XcpRDestUpperLayerInformation/XcpRTriggerTransmitFunctionName)"!][!/*
            */!][!ELSE!][!/*
                */!][!VAR "TriggerTransmitFunc" = "'NULL_PTR'"!][!/*
            */!][!ENDIF!][!/*
