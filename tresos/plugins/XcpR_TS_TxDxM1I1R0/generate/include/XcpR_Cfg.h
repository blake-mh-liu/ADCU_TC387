...
[!VAR "NoOfTxDestCDDPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverCDD' and (XcpRPdu = 'XcpRTxPdu')])"!]
[!VAR "NoOfRxDestCDDPdus"="count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverCDD' and (XcpRPdu = 'XcpRRxPdu')])"!]
...
[!IF "node:existsAndTrue(XcpRGeneral/XcpRMultipleSlavesEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpRGeneral/XcpRVersionInfoApi)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!"num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRPdu ='XcpRRxPdu']))"!]U
...
[!"num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRPdu ='XcpRTxPdu']))"!]U

#if (defined XCPR_MASTER_NO_OF_LINKED_RX_DESTINATION_PDUS)
#error XCPR_MASTER_NO_OF_LINKED_RX_DESTINATION_PDUS already defined
#endif
/** \brief The total number of configured Rx Destination PDUs which have a PDU master as source */
#define XCPR_MASTER_NO_OF_LINKED_RX_DESTINATION_PDUS         [!//
[!"num:integer(count(as:modconf('XcpR')/XcpRGeneral/XcpRRoutingPaths/eb-list::*[node:existsAndTrue(node:ref(XcpRSourcePduRef)/XcpRIsSrcMasterConnection) and node:name(node:ref(XcpRDestinationPduRef)/XcpRPdu) = 'XcpRRxPdu']))"!]U
...
[!"num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRPdu ='XcpRTxPdu']))"!]U

#if (defined XCPR_MASTER_NO_OF_LINKED_TX_DESTINATION_PDUS)
#error XCPR_MASTER_NO_OF_LINKED_TX_DESTINATION_PDUS already defined
#endif
/** \brief The total number of configured Tx Destination PDUs which have a PDU master as source */
#define XCPR_MASTER_NO_OF_LINKED_TX_DESTINATION_PDUS         [!//
[!"num:integer(count(as:modconf('XcpR')/XcpRGeneral/XcpRRoutingPaths/eb-list::*[node:existsAndTrue(node:ref(XcpRSourcePduRef)/XcpRIsSrcMasterConnection) and node:name(node:ref(XcpRDestinationPduRef)/XcpRPdu) = 'XcpRTxPdu']))"!]U
...
[!"num:integer(count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*))"!]U
...
[!"num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*))"!]U
...
[!"num:integer(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverFlexRay']/eb-list::*[node:existsAndTrue(XcpRDestinationSequenceCorrectionEnabled)]))"!]U
...
[!IF "$XcpRSupportForSoAdSocketProtocolTcp"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!] 
...
[!IF "$XcpRSupportForSoAdSocketProtocolUdp"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[(XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet') and (node:existsAndTrue(./XcpRIsDestMasterConnection))]) > 0)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "(count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[(XcpRDestinationInterfaceType = 'XcpRDestinationConnectionOverEthernet') and (node:existsAndFalse(./XcpRIsDestMasterConnection))]) > 0)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

[!VAR "SrcTotalPackageSize"="0"!][!//
[!LOOP "(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*)"!][!//
...
[!IF "count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRPdu = 'XcpRTxPdu']/eb-list::*[node:existsAndTrue(XcpRTxDestinationPduSupportForFrTriggerTransmit)]) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "count(XcpRGeneral/XcpRDestinationPDUConfiguration/eb-list::*[XcpRPdu = 'XcpRTxPdu']/eb-list::*[node:existsAndTrue(XcpRTxDestinationPduSupportForCddTriggerTransmit)]) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!"num:integer(count(XcpRGeneral/XcpRRoutingToConnectionMapping/eb-list::*))"!]U
...
[!IF "count(XcpRGeneral/XcpRSourcePDUConfiguration/eb-list::*[XcpRSourceInterfaceType = 'XcpRSourceConnectionOverEthernet']) > 0"!]
