...
typedef uint8 BswMActionType;

/*==================[macros]=================================================*/

/* Post-Build access macros */

#define BSWM_GET_NUM_RULES(inst) ((inst)->PostBuildConfig[(inst)->ID].NumRules)
#define BSWM_GET_NUM_RULES_DEFERRED(inst) ((inst)->PostBuildConfig[(inst)->ID].NumRulesDeferred)
#define BSWM_GET_NUM_ACTION_LISTS(inst) ((inst)->PostBuildConfig[(inst)->ID].NumActionLists)
#define BSWM_GET_RULE_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMRuleType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].RuleTable))
#define BSWM_GET_RULE_DEPENDENCY_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), uint16, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].RuleDependencyTable))
#define BSWM_GET_RULE_DEPENDENCY_LIST_RANGE_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMRangeType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].RuleDependencyListRangeTable))
#define BSWM_GET_ACTION_LIST_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMActionListType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].ActionListTable))
#define BSWM_GET_ACTION_LIST_ITEM_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMActionListItemType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].ActionListItemTable))
#define BSWM_GET_UINT8_INITIAL_VALUES_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), uint8, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].UInt8InitialValuesTable))
#define BSWM_GET_UINT16_INITIAL_VALUES_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), uint16, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].UInt16InitialValuesTable))
#define BSWM_GET_UINT32_INITIAL_VALUES_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), uint32, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].UInt32InitialValuesTable))
#define BSWM_GET_DEADLINE_MONITORING_CONTROL_ACTION_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMDeadLineMonitoringControlActionType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].DeadLineMonitoringControlActionTable))
#define BSWM_GET_PDU_GROUP_SWITCH_ACTION_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMPduGroupSwitchActionType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].PduGroupSwitchActionTable))
#define BSWM_GET_SWITCH_IPDU_MODE_ACTION_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMSwitchIPduModeActionType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].SwitchIPduModeActionTable))
#define BSWM_GET_TRIGGER_IPDU_SEND_ACTION_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMTriggerIPduSendActionType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].TriggerIPduSendActionTable))
#define BSWM_GET_TRIGGERED_IPDU_ID_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), uint16, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].TriggeredIPduIdTable))
#define BSWM_GET_PDU_ROUTER_CONTROL_ACTION_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMPduRouterControlActionType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].PduRouterControlActionTable))
#define BSWM_GET_PDUR_ROUTING_PATH_GROUP_ID_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), uint16, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].PduRRoutingPathGroupIdTable))
#define BSWM_GET_LIN_SCHEDULE_SWITCH_ACTION_TABLE(inst) (TS_UNCHECKEDGETCFG(((inst)->PostBuildConfig), BswMLinScheduleSwitchActionType, BSWM, ((inst)->PostBuildConfig)[(inst)->ID].LinScheduleSwitchActionTable))
...
#if (defined BSWM_ARBITRATION_UINT8_CHANNEL_UINT8_MODE_PORT)
#error BSWM_ARBITRATION_UINT8_CHANNEL_UINT8_MODE_PORT is already defined
#endif
#define BSWM_ARBITRATION_UINT8_CHANNEL_UINT8_MODE_PORT 0U
...
#if (defined BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT)
#error BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT is already defined
#endif
#define BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT 2U
...
#if (defined BSWM_OTHER_ACTION)
#error BSWM_OTHER_ACTION is already defined
#endif
#define BSWM_OTHER_ACTION 0U

#if (defined BSWM_PDU_GROUP_SWITCH_ACTION)
#error BSWM_PDU_GROUP_SWITCH_ACTION is already defined
#endif
#define BSWM_PDU_GROUP_SWITCH_ACTION 1U

#if (defined BSWM_DEADLINE_MONITORING_CONTROL_ACTION)
#error BSWM_DEADLINE_MONITORING_CONTROL_ACTION is already defined
#endif
#define BSWM_DEADLINE_MONITORING_CONTROL_ACTION 2U
