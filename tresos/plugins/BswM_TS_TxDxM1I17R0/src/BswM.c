...
/* !LINKSTO BswM.ASR403.BswM0027,2 */
#include <Dem.h>
#endif
...
/*==================[macros]================================================*/
/* !LINKSTO BswM.ASR403.BswM0136,1 */
...
/* minor version check */
#if (BSWM_SW_MINOR_VERSION < 17U)
#error BSWM_SW_MINOR_VERSION wrong (< 17U)
#endif
...
/* patch version check */
#if (BSWM_SW_PATCH_VERSION < 5U)
#error BSWM_SW_PATCH_VERSION wrong (< 5U)
#endif

/*------------------[BSWM implementation macros]----------------------------*/

#if (defined BSWM_HANDLE_REQUEST_WITH_TYPE)
#error BSWM_HANDLE_REQUEST_WITH_TYPE is already defined
#endif
#define BSWM_HANDLE_REQUEST_WITH_TYPE(inst,source,channel,mode, sid, type) ((void)inst->LinkTimeContext->handleStaticRequestFuncPtr((channel), (mode), (source), (sid), (type)))

#if (defined BSWM_HANDLE_REQUEST)
#error BSWM_HANDLE_REQUEST is already defined
#endif
#define BSWM_HANDLE_REQUEST(inst,source,channel,mode, sid) BSWM_HANDLE_REQUEST_WITH_TYPE(inst, source, channel, mode, sid, BSWM_ARBITRATION_UINT8_CHANNEL_UINT8_MODE_PORT)
...
#if (BSWM_LOGICAL_EXPRESSIONS_PRESENT == TRUE)
...
(
  ...
  P2VAR(BswM_PartitionContextType, AUTOMATIC, BSWM_VAR) inst
      ...
      (BSWM_DM_CONTROL_ACTION_USED == STD_ON) )
...
#endif
    {
      BSWM_HANDLE_REQUEST_WITH_TYPE(inst, BSWM_GENERIC_REQUEST, requesting_user, requested_mode, BSWM_SID_REQUESTMODE, BSWM_ARBITRATION_GENERIC_REQUEST_HANDLER_PORT);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
)
{
...
#endif
  {
    ...
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_COMM_INDICATION, Network, RequestedMode, BSWM_SID_COMM_CURRENT_MODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
)
{
...
#if (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE)
  if ( inst != NULL_PTR)
#elif (BSWM_COMM_PNC_REQUEST_PORTS_CONFIGURED == STD_OFF)
...
#endif
  {
    ...
    switch (RequestedMode)
    {
      ...
      case PNC_REQUESTED_WITH_WAKEUP_REQUEST:
      {
        in_range = TRUE;
        break;
      }
    ...
    {
      /* Report to DET that the requested mode is not in range */
      BSWM_DET_REPORT_ERROR(inst->ID, BSWM_SID_COMM_CURRENT_PNC_MODE, BSWM_E_REQ_MODE_OUT_OF_RANGE);
    }
    else
#endif
    {
      BSWM_HANDLE_REQUEST_WITH_TYPE(inst, BSWM_COMM_PNC_REQUEST, PNC, RequestedMode, BSWM_SID_COMM_CURRENT_PNC_MODE, BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      /* !LINKSTO BswM.SWS_BswM_00254,1 */
      BSWM_HANDLE_REQUEST(inst, BSWM_COMM_INITIATE_RESET, 0, BSWM_EVENT_IS_SET, BSWM_SID_COMM_INITIATE_RESET);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_DCM_COM_MODE_CURRENT_STATE, Network, RequestedMode, BSWM_SID_DCM_COMMUNICATIONMODE_CURRENT_STATE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
FUNC(void, BSWM_CODE) BswM_Dcm_ApplicationUpdated(void)
{
...
#endif
  {
    ...
    {
      /* Report error that module is not initialized to DET */
      /* !LINKSTO BswM.SWS_BswM_00159,1 */
      BSWM_DET_REPORT_ERROR(inst->ID, BSWM_SID_DCM_APPLICATION_UPDATED, BSWM_E_NO_INIT);
    }
    else
#endif /* (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_DCM_APPLICATION_UPDATED_INDICATION, 0U, 0U, BSWM_SID_DCM_APPLICATION_UPDATED);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_DCM_COM_MODE_REQUEST, Network, RequestedMode, BSWM_SID_DCM_REQUEST_COMMUNICATION_MODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
FUNC(void, BSWM_CODE) BswM_Dcm_RequestSessionMode(Dcm_SesCtrlType RequestedMode)
{
  ...
  #endif /* (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_DCM_SESSION_MODE_REQUEST, 0U, RequestedMode, BSWM_SID_DCM_REQUEST_SESSION_MODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_DCM_RESET_MODE_REQUEST, 0U, RequestedMode, BSWM_SID_DCM_REQUEST_RESET_MODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
)
{
...
#endif
  {
    ...
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_CAN_SM_INDICATION, Network, CurrentState, BSWM_SID_CANSM_CURRENT_STATE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
)
{
...
#endif
  {
    ...
    {
      /* !LINKSTO BswM.SWS_BswM_00268,1 */
      BSWM_DET_REPORT_ERROR(inst->ID, BSWM_SID_ETHIF_PORTGROUPLINKSTATECHG, BSWM_E_REQ_MODE_OUT_OF_RANGE);
    }
    else
#endif
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_ETHIF_PORT_GROUP_LINK_STATE_CHANGED, PortGroupIdx, PortGroupState, BSWM_SID_ETHIF_PORTGROUPLINKSTATECHG);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_ETH_SM_INDICATION, Network, CurrentState, BSWM_SID_ETHSM_CURRENT_STATE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_FR_SM_INDICATION, Network, CurrentState, BSWM_SID_FRSM_CURRENT_STATE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
)
{
...
#endif
  {
    ...
    switch (CurrentState)
    {
#ifdef LINSM_BSWM_WAKEUP_AND_SLEEP_INDICATION
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_LIN_SM_INDICATION, Network , CurrentState, BSWM_SID_LINSM_CURRENT_STATE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
)
{
...
#endif
  {
    ...
    if((CurrentState >= ECUM_SUBSTATE_MASK) && (CurrentState <= ECUM_STATE_RESET))
    {
      in_range = TRUE;
    }
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_ECUM_INDICATION, 0U, CurrentState, BSWM_SID_ECUM_CURRENT_STATE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_ECUM_WAKEUP_SOURCE, source, state, BSWM_SID_ECUM_CURRENT_WAKEUP);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_NM_CAR_WAKEUP_INDICATION, Network, 0U, BSWM_SID_NM_CAR_WAKEUP_INDICATION);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_NVM_REQUEST, Block, CurrentBlockMode, BSWM_SID_NVM_CURRENT_BLOCK_MODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_NVM_JOB_MODE_INDICATION, ServiceId, CurrentJobMode, BSWM_SID_NVM_CURRENT_JOB_MODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_LIN_SCHEDULE_INDICATION, Network, CurrentSchedule, BSWM_SID_LINSM_CURRENT_SCHEDULE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_LIN_TP_MODE_REQUEST, Network, LinTpRequestedMode, BSWM_SID_LINTP_REQUESTMODE);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST_WITH_TYPE(inst, BSWM_SD_CLIENT_SERVICE_CURRENT_STATE, SdClientServiceHandleId, CurrentClientState, BSWM_SID_SD_CLIENTSERVICE_CURRENTSTATE, BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST_WITH_TYPE(inst, BSWM_SD_CONSUMED_EVENT_GROUP_CURRENT_STATE, SdConsumedEventGroupHandleId, ConsumedEventGroupState, BSWM_SID_SD_CONSUMEDEVENTGROUP_CURRENTSTATE, BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST_WITH_TYPE(inst, BSWM_SD_EVENT_HANDLER_CURRENT_STATE, SdEventHandlerHandleId, EventHandlerStatus, BSWM_SID_SD_EVENTHANDLER_CURRENTSTATE, BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_WDGM_REQUEST_PARTITION_RESET, Application, 0U, BSWM_SID_WDGM_REQUEST_PARTITION_RESET);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif /* #if (BSWM_DEV_ERROR_DETECT == STD_ON) */
    {
      BSWM_HANDLE_REQUEST(inst, BSWM_J1939_DCM_BROADCAST_STATUS, NetworkMask, 0U, BSWM_SID_J1939DCMBROADCASTSTATUS);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
...
#endif
    {
      BSWM_HANDLE_REQUEST_WITH_TYPE(inst, BSWM_J1939_NM_INDICATION, (((uint32)Network << 8U) + Node), NmState, BSWM_SID_J1939NM_STATECHANGENOTIFICATION, BSWM_ARBITRATION_UINT16_CHANNEL_UINT8_MODE_PORT);
    }
  }
#if ((BSWM_DEV_ERROR_DETECT == STD_ON) && (BSWM_GET_INSTANCE_BSW_DISTRIBUTION == TRUE))
  else
        ...
        /* !LINKSTO BswM.SWS_BswM_00220,1 */
        {
          ...
          if (hasExpiredTimers == TRUE)
          {
            ...
            for (i = 0U; i < BSWM_TIMER_TABLE_SIZE; i++)
            {
              ...
              {
                /* !LINKSTO BswM.SWS_BswM_00264,1 */
                /* Mode arbitration already runs in an exclusive area */
                BswM_ExecuteModeArbitration(inst, &(inst->LinkTimeContext->timersTablePtr[i]), BSWM_TIMER_EXPIRED, BSWM_ARBITRATION_UINT8_CHANNEL_UINT8_MODE_PORT);
              }
            }
          }
        }
...
/* Deviation MISRAC2012-1 */
          ...
          for (i = 0U; i < BSWM_GET_NUM_RULES_DEFERRED(inst); i++)
          {
            actionListIndex = BswM_ExecuteRule(&BSWM_GET_RULE_TABLE(inst)[i], inst);
...
)
{
  ...
  if (TRUE == portPtr->isImmediate)
  {
    ...
    * be the index of a rule within the RuleTable. */
    ...
    for
    (
      dependIndex = BSWM_GET_RULE_DEPENDENCY_LIST_RANGE_TABLE(inst)[portPtr->id].Head;
      dependIndex < BSWM_GET_RULE_DEPENDENCY_LIST_RANGE_TABLE(inst)[portPtr->id].Tail;
      dependIndex++
    )
    {
      /* !LINKSTO BswM.SWS_BswM_00059,1 */
      ...
      actionListIndex =
        BswM_ExecuteRule(&BSWM_GET_RULE_TABLE(inst)[BSWM_GET_RULE_DEPENDENCY_TABLE(inst)[dependIndex]], inst);
...
#else
  TS_PARAM_UNUSED(inst);
  TS_PARAM_UNUSED(activatedActionLists);
  TS_PARAM_UNUSED(portPtr);
#endif
  return retVal;
}
...
{
  BswMResultType result = BSWM_UNDEFINED;
...
)
{
...
#endif
#if (BSWM_DM_CONTROL_ACTION_USED == STD_ON)
  ...
  /* !LINKSTO BswM.SWS_BswM_00276,1 */
  /*
   * This is the only point where the BswMActionListPriority is considered as a result
   * of indexes of activatedActionLists corresponding to action lists ordered by this parameter.
   * Nested action lists are processed in the order in which their corresponding action list items
   * are specified (based on BswMActionListItemIndex).
   */
  for (i = 0U; i < BSWM_GET_NUM_ACTION_LISTS(inst); i++)
  {
    if (TRUE == activatedActionLists[i])
    {
#if ( (BSWM_PDU_GROUP_SWITCH_ACTION_USED == STD_ON) ||         \
      (BSWM_DM_CONTROL_ACTION_USED == STD_ON) )
      BswM_ExecuteActionList(&BSWM_GET_ACTION_LIST_TABLE(inst)[i], inst, &deferredActionsQueue);
#else
      BswM_ExecuteActionList(&BSWM_GET_ACTION_LIST_TABLE(inst)[i], inst);
#endif
    }
    else
    {
  ...
  if (TRUE == deadlineMonitoringControlTriggered)
  {
    ...
    inst->SchMExit();
    /* !LINKSTO BswM.ASR403.SWS_BswM_00225,1 */
...
{
  uint16 i;
  P2CONST(BswMPduGroupSwitchActionType, AUTOMATIC, BSWM_CONST) action = &(BSWM_GET_PDU_GROUP_SWITCH_ACTION_TABLE(inst)[pbIndex]);
...
)
{
  ...
  for (i = 0U; i < BSWM_IPDU_GROUP_VECTOR_SIZE; i++)
  {
    inst->RunTimeContext.DmcIPduGroupVector[i] |=
      BSWM_GET_DEADLINE_MONITORING_CONTROL_ACTION_TABLE(inst)[pbIndex].EnableMask[i];
    inst->RunTimeContext.DmcIPduGroupVector[i] &=
      BSWM_GET_DEADLINE_MONITORING_CONTROL_ACTION_TABLE(inst)[pbIndex].DisableMask[i];
  }
}
#endif
...
{
  /* !LINKSTO BswM.Impl.RunTime.PartitionContext,1 */
  BswMPduRouterControlActionType action = BSWM_GET_PDU_ROUTER_CONTROL_ACTION_TABLE(inst)[pbIndex];
  BswM_IndexType i;
  ...
  for (i = action.Range.Head; i < action.Range.Tail; i++)
  {
    ...
    {
      PduR_EnableRouting(BSWM_GET_PDUR_ROUTING_PATH_GROUP_ID_TABLE(inst)[i]);
    }
    else
    {
      PduR_DisableRouting(BSWM_GET_PDUR_ROUTING_PATH_GROUP_ID_TABLE(inst)[i]);
    }
  }
}
#endif
...
)
{
  ...
  if (BSWM_TRUE == exprResult)
  {
    if (rulePtr->TrueActionListIndex != BSWM_ARTIFACT_UNDEFINED)
    {
       ...
       * must have changed. */
      boolean isTriggered = BSWM_GET_ACTION_LIST_TABLE(inst)[rulePtr->TrueActionListIndex].IsTriggered;
  ...
  else if (BSWM_FALSE == exprResult)
  {
    ...
    {
      boolean isTriggered = BSWM_GET_ACTION_LIST_TABLE(inst)[rulePtr->FalseActionListIndex].IsTriggered;
      if (FALSE == isTriggered)
      {
...
)
{
  ...
  while (FALSE == BSWM_STACK_EMPTY(stack))
  {
    ...
    {
      currentItemPtr = &BSWM_GET_ACTION_LIST_ITEM_TABLE(inst)[actionListContext.NextItemIndex];
      ...
      (BSWM_DM_CONTROL_ACTION_USED == STD_ON) )
...
#if ( BSWM_DEM_ENABLED == STD_ON)
          if ( currentItemPtr->DemEventId > 0U)
          {
            /* !LINKSTO BswM.ASR403.BswM0933_Conf,3 */
            Dem_EventStatusType demStatus = (result == E_OK) ?
                                            DEM_EVENT_STATUS_PASSED : DEM_EVENT_STATUS_FAILED;
            /* !LINKSTO BswM.ASR403.BswM0007,2 */
        ...
        case BSWM_ACTION_LIST:
        {
          ...
          BswM_PushActionList(inst, &stack, &BSWM_GET_ACTION_LIST_TABLE(inst)[currentItemPtr->ArtifactIndex]);
          isInterrupted = TRUE;
          break;
        }
        case BSWM_RULE:
        {
          ...
          BswMIndexType actionListIndex;
          inst->SchMEnter();
          actionListIndex = BswM_ExecuteRule(&BSWM_GET_RULE_TABLE(inst)[currentItemPtr->ArtifactIndex], inst);
          inst->SchMExit();
          if (actionListIndex != BSWM_ARTIFACT_UNDEFINED)
          {
            /* Interrupt processing of the current action list, and begin
             ...
             * completes, continue processing the original action list. */
            BswM_PushActionListContext(inst, &stack, actionListContext);
            BswM_PushActionList(inst, &stack, &BSWM_GET_ACTION_LIST_TABLE(inst)[actionListIndex]);
            isInterrupted = TRUE;
          }
#endif
          break;
...
)
{
  ...
  {
    queue->rear = (queue->rear + 1U) % BSWM_REQUEST_QUEUE_MAX;
...
)
{
  ...
  if (queue->size > 0U)
  {
    ...
    queue->front = (queue->front + 1U) % BSWM_REQUEST_QUEUE_MAX;
    queue->size--;
  }
  return ret;
}
