...
[!VAR "IpduM_CntrTxInstType_DEF" = "'{}?MetaDataValue:uint32|PduLength:PduLengthType|NumCntd:IpduM_NumCntdType|State:uint8|InstLock:uint8|?MetaDataPrio:uint8'"!]
[!VAR "MetaDataValue_COND" = "'TRUE:MetaDataEn'"!]
[!VAR "MetaDataPrio_COND" = "'TRUE:MetaDataTxPrioEn+FALSE:MetaDataEn'"!]
...
[!VAR "IpduM_ContainedRxPduType_DEF" = "'{}ContainedPduHeaderId:uint32|?ContainedMetaDataLength:uint32|?ContainedMetaDataPduId:PduIdType|OutgoingPduId:PduIdType'"!]
[!VAR "ContainedMetaDataPduId_COND" = "'TRUE:MetaDataEn'"!]
[!VAR "IpduM_ContainedRxPduType_COND" = "'TRUE:IpduMContainerPduHandlingEnable'"!]

[!/* ContainedMetaDataPduId : Condition already set for type IpduM_ContainedRxPduType */!]
[!VAR "IpduM_StaticContainedRxPduType_DEF" = "'{}?ContainedMetaDataLength:uint32|IpduMContainedPduOffset:PduLengthType|IpduMUpdateBitBytePosition:PduLengthType|PduLength:PduLengthType|OutgoingPduId:PduIdType|?ContainedMetaDataPduId:PduIdType|IpduMUpdateBitMask:uint8|HasIpduMUpdateBitPositionSet:boolean'"!]
[!VAR "IpduM_StaticContainedRxPduType_COND" = "'TRUE:IpduMContainerPduHandlingEnable;TRUE:IpduMStaticContainerPduHandlingEnable'"!]
[!VAR "ContainedMetaDataLength_COND" = "'TRUE:MetaDataEn'"!]

[!VAR "IpduM_ContainerRxPduType_DEF" = "'{}ContainedRxPduFirst:uint32|ContainedRxPduNum:uint32|?ContainerMetaDataLength:uint32|?QueueRAMOffset:IpduM_DataOffsetType|InstRAMOffset:IpduM_DataOffsetType|PduLength:PduLengthType|InstFirstIdx:uint16|?ContainerMetaDataPduId:PduIdType|NumInstances:uint8|HeaderSize:uint8'"!]
[!VAR "ContainerMetaDataLength_COND" = "'TRUE:MetaDataEn'"!]
[!VAR "ContainerMetaDataPduId_COND" = "'TRUE:MetaDataEn'"!]
...
[!VAR "IpduM_ContainerTxPduType_DEF" = "'{}QueueRAMOffset:IpduM_DataOffsetType|CntrDataRAMOffset:IpduM_DataOffsetType|InstRAMOffset:IpduM_DataOffsetType|TxConfListOffset:IpduM_DataOffsetType|IpduMContainerTxSizeThreshold:PduLengthType|PduLength:PduLengthType|IpduMContainerTxHandleId:PduIdType|?TxContainerMetaDataPduId:PduIdType|IpduMContainerTxConfirmationTimeout:uint16|NumCntdMax:uint16|InstFirstIdx:uint16|NumInstances:uint8|?IpduMUnusedAreasDefault:uint8|HeaderSize:uint8|CfgFlags:uint8'"!]
[!VAR "TxContainerMetaDataPduId_COND" = "'TRUE:MetaDataEn|TRUE:MetaDataTxPrioEn'"!]
[!VAR "IpduMUnusedAreasDefault_COND" = "'TRUE:IpduMStaticContainerPduHandlingEnable'"!]

[!VAR "IpduM_ContainedTxPduType_DEF" = "'{}IpduMContainedPduHeaderId:uint32|?IpduMTxMetaDataMask:uint32|?IpduMTxMetaDataValue:uint32|?IpduMContainedPduOffset:PduLengthType|?IpduMUpdateBitBytePosition:PduLengthType|PduLength:PduLengthType|IpduMContainedTxPduHandleId:PduIdType|IpduMContainerTxIndex:PduIdType|?TxContainedMetaDataPduId:PduIdType|IpduMContainedTxPduSendTimeout:uint16|?IpduMUpdateBitMask:uint8|?IpduMContainedTxPduPriority:uint8|CfgFlags:uint8'"!]
[!VAR "TxContainedMetaDataPduId_COND" = "'TRUE:MetaDataEn|TRUE:MetaDataTxPrioEn'"!]
[!VAR "IpduMTxMetaDataMask_COND" = "'TRUE:MetaDataEn'"!]
[!VAR "IpduMTxMetaDataValue_COND" = "'TRUE:MetaDataEn'"!]
...
[!VAR "RxPrtFieldStr" = "''"!]
[!LOOP "util:distinct(node:order(IpduMRxPathway/*, 'node:IpduMRxIndication/IpduMRxHandleId'))"!]
