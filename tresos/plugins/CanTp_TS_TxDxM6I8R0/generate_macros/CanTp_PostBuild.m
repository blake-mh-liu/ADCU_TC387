...
*/!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*/CanTpTxNPdu"!][!/*
   */!][!IF "CanTpTxNPduConfirmationPduId > number($max_tx)"!][!VAR "max_tx"="CanTpTxNPduConfirmationPduId"!][!ENDIF!][!/*
   ...
   */!][!ELSE!][!/*
      ...
      */!][!ASSERT "string($pduRef_tx) = CanTpTxNPduRef"!]Tx N-Pdu Id [!"num:i(CanTpTxNPduConfirmationPduId)"!] is used multiple times for different PDUs[!ENDASSERT!][!/*
   */!][!ENDIF!][!/*
*/!][!ENDLOOP!][!/*
*/!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[node:exists(CanTpTxFcNPdu)]/CanTpTxFcNPdu"!][!/*
   */!][!IF "CanTpTxFcNPduConfirmationPduId > number($max_tx)"!][!VAR "max_tx"="CanTpTxFcNPduConfirmationPduId"!][!ENDIF!][!/*
   ...
   */!][!ELSE!][!/*
      ...
      */!][!ASSERT "string($pduRef_tx) = CanTpTxFcNPduRef"!]Tx N-Pdu Id [!"num:i(CanTpTxFcNPduConfirmationPduId)"!] is used multiple times for different PDUs[!ENDASSERT!][!/*
   */!][!ENDIF!][!/*
*/!][!ENDLOOP!][!/*
...
*/!][!ENDIF!][!/*
*/!][!IF "number($numTxChannels) > CanTpGeneral/CanTpMaxTxChannels"!]
...
*/!][!ENDIF!][!/*
*/!][!IF "number($numRxChannels) > CanTpGeneral/CanTpMaxRxChannels"!]
...
*/!][!IF "number($numAllChannels) > (CanTpGeneral/CanTpMaxTxChannels + CanTpGeneral/CanTpMaxRxChannels)"!]
 ...
 */!][!LOOP "as:modconf('CanTp')[1]/CanTpGeneral/CanTpChannelProcessing/*/CanTpChannelRef/*"!][!/*
     ...
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpRxNSdu/*))"!][!/*
          */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNSduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = string($partitionref)])) > num:i(0))"!][!/*
               */!][!IF "not(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNSduRef)/EcucPduDefaultPartitionRef = string($partitionref))"!][!/*
     ...
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpTxNSdu/*))"!][!/*
        */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNSduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = string($partitionref)])) > num:i(0))"!][!/*
             */!][!IF "not(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNSduRef)/EcucPduDefaultPartitionRef = string($partitionref))"!][!/*
     ...
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpTxNSdu/*))"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNPdu/CanTpTxNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = string($partitionref)])) > num:i(0))"!][!/*
          */!][!IF "not(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxNPdu/CanTpTxNPduRef)/EcucPduDefaultPartitionRef = string($partitionref))"!][!/*
     ...
     */!][!FOR "I"="1" TO "num:i(count(as:ref(.)/CanTpRxNSdu/*))"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNPdu/CanTpRxNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = string($partitionref)])) > num:i(0))"!][!/*
         */!][!IF "not(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxNPdu/CanTpRxNPduRef)/EcucPduDefaultPartitionRef = string($partitionref))"!][!/*
     ...
     */!][!IF "as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpRxTaType = 'CANTP_PHYSICAL'"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpTxFcNPdu/CanTpTxFcNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = string($partitionref)])) > num:i(0))"!][!/*
           */!][!IF "not(as:ref(as:ref(.)/CanTpRxNSdu/*[num:i($I)]/CanTpTxFcNPdu/CanTpTxFcNPduRef)/EcucPduDefaultPartitionRef = string($partitionref))"!][!/*
     ...
     */!][!IF "as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpTxTaType = 'CANTP_PHYSICAL'"!][!/*
       */!][!IF "not(num:i(count(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpRxFcNPdu/CanTpRxFcNPduRef)/EcucPduDedicatedPartition/*[EcucPduDedicatedPartitionBswModuleRef = 'ASPath:/CanTp/CanTp' and EcucPduDedicatedPartitionRef = string($partitionref)])) > num:i(0))"!][!/*
          */!][!IF "not(as:ref(as:ref(.)/CanTpTxNSdu/*[num:i($I)]/CanTpRxFcNPdu/CanTpRxFcNPduRef)/EcucPduDefaultPartitionRef = string($partitionref))"!][!/*
...
*/!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*/CanTpRxNPdu"!][!/*
   */!][!IF "CanTpRxNPduId > number($max)"!][!VAR "max"="CanTpRxNPduId"!][!ENDIF!][!/*
   ...
   */!][!ELSE!][!/*
      ...
      */!][!ASSERT "string($pduRef) = CanTpRxNPduRef"!]Rx N-Pdu Id [!"num:i(CanTpRxNPduId)"!] is used multiple times for different PDUs[!ENDASSERT!][!/*
   */!][!ENDIF!][!/*
*/!][!ENDLOOP!][!/*
*/!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu)]/CanTpRxFcNPdu"!][!/*
   */!][!IF "CanTpRxFcNPduId > number($max)"!][!VAR "max"="CanTpRxFcNPduId"!][!ENDIF!][!/*
   ...
   */!][!ELSE!][!/*
      ...
      */!][!ASSERT "string($pduRef) = CanTpRxFcNPduRef"!]Rx N-Pdu Id [!"num:i(CanTpRxFcNPduId)"!] is used multiple times for different PDUs[!ENDASSERT!][!/*
   */!][!ENDIF!][!/*
*/!][!ENDLOOP!][!/*
...
*/!][!VAR "pdusPerRxNPdu"="''"!][!/*
*/!][!FOR "I"="0" TO "$max"!][!/*
   */!][!VAR "numRxI"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[CanTpRxNPdu/CanTpRxNPduId = number($I)])"!][!/*
   */!][!VAR "numTxI"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I))])"!][!/*
   */!][!IF "($numRxI + $numTxI) = 0"!][!/*
   ...
   */!][!VAR "numRxIStd"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I)) and (CanTpRxAddressingFormat = 'CANTP_STANDARD')])"!][!/*
   */!][!VAR "numTxIStd"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I)) and (CanTpTxAddressingFormat = 'CANTP_STANDARD')])"!][!/*
   */!][!VAR "numRxIExt"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I)) and (CanTpRxAddressingFormat = 'CANTP_EXTENDED')])"!][!/*
   */!][!VAR "numTxIExt"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I)) and (CanTpTxAddressingFormat = 'CANTP_EXTENDED')])"!][!/*
   */!][!VAR "numRxIMix"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I)) and (CanTpRxAddressingFormat = 'CANTP_MIXED')])"!][!/*
   */!][!VAR "numTxIMix"="count(CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I)) and (CanTpTxAddressingFormat = 'CANTP_MIXED')])"!][!/*
   */!][!IF "($numRxIStd + $numTxIStd + $numRxIMix + $numTxIMix) = 0"!][!/*
      ** all are extended --> check uniqueness of NSa values **
      */!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I))]"!][!/*
         */!][!IF "not(text:uniq(../../../../CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I))]/CanTpNSa/CanTpNSa, CanTpNSa/CanTpNSa))"!][!/*
         ...
         */!][!ENDIF!][!/*
      */!][!ENDLOOP!][!/*
      */!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I))]"!][!/*
         */!][!IF "not(text:uniq(../../../../CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I))]/CanTpNSa/CanTpNSa, CanTpNSa/CanTpNSa))"!][!/*
   ...
   */!][!ELSEIF "($numRxIStd + $numTxIStd + $numRxIExt + $numTxIExt) = 0"!][!/*
      ...
      */!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I))]"!][!/*
         */!][!IF "not(text:uniq(../../../../CanTpChannel/*/CanTpRxNSdu/*[(CanTpRxNPdu/CanTpRxNPduId = number($I))]/CanTpNAe/CanTpNAe, CanTpNAe/CanTpNAe))"!][!/*
      ...
      */!][!ENDLOOP!][!/*
      */!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I))]"!][!/*
         */!][!IF "not(text:uniq(../../../../CanTpChannel/*/CanTpTxNSdu/*[node:exists(CanTpRxFcNPdu) and (CanTpRxFcNPdu/CanTpRxFcNPduId = number($I))]/CanTpNAe/CanTpNAe, CanTpNAe/CanTpNAe))"!][!/*
   ...
   */!][!ELSEIF "($numRxIExt + $numTxIExt + $numRxIMix + $numTxIMix) = 0"!][!/*
      ** all are standard **
      */!][!IF "($numRxIStd > 1) and (as:modconf('CanTp')[1]/CanTpGeneral/CanTpMetaDataParallelHandling = 'false')"!][!/*
         */!][!ERROR!]Rx N-Pdu Id [!"num:i($I)"!] is used for multiple Rx N-Sdus with standard addressing mode.[!ENDERROR!][!/*
      */!][!ENDIF!][!/*
      */!][!IF "($numTxIStd > 1) and (as:modconf('CanTp')[1]/CanTpGeneral/CanTpMetaDataParallelHandling = 'false')"!][!/*
...
*/!][!LOOP "CanTpConfig/*[1]/CanTpChannel/*/CanTpRxNSdu/*[node:exists(CanTpTxFcNPdu)]/CanTpTxFcNPdu/CanTpTxFcNPduRef"!][!/*
   ...
   */!][!ELSE!][!/*
      */!][!ERROR!]Tx N-PDU [!"as:name(as:ref(.))"!] is used more than once.[!ENDERROR!][!/*
   */!][!ENDIF!][!/*
*/!][!ENDLOOP!][!/*
...
*/!][!VAR "TxCh"="''"!][!/*
       ...
       */!][!ELSE!][!/*
           ...
           */!][!IF "CanTpTxNPdu/CanTpTxNPduConfirmationPduId = number($fcPduID)"!][!/*
...
*/!][!VAR "RxCh"="''"!][!/*
       ...
       */!][!ELSE!][!/*
           ...
           */!][!IF "CanTpTxFcNPdu/CanTpTxFcNPduConfirmationPduId = number($txPduID)"!][!/*
...
*/!][!MACRO "calcNAbcRsValue", "value", "name", "direction"!][!/*
   ...
   */!][!IF "(($dValue - $mValue) > 0.00001) or (($dValue - $mValue) < -0.00001)"!][!/*
      */!][!WARNING!][!"$name"!] value of [!"$direction"!]-NSdu [!"as:name(.)"!] ([!"$value"!]s) is not divisible by CanTpMainFunctionPeriod. It will be rounded to: [!"$mValue * ./CanTpMainFunctionPeriod"!]s.[!ENDWARNING!][!/*
   */!][!ENDIF!][!/*
   */!][!"num:i($mValue)"!][!/*
   */!][!/*
*/!][!ENDMACRO!][!/*
...
*/!][!IF "$SymbolName = ''"!][!/*
   */!][!VAR "SymbolName" = "concat(as:name(../../.),'_',as:name(.),'_',$OldName)"!][!/*
*/!][!ELSE!][!/*
