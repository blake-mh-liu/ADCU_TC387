...
CONST(uint32, CRYSTUB_40_CONST) Cry_MacVerifyCfg = 0U;
...
FUNC(Csm_ReturnType, CRYSTUB_40_CODE) Cry_MacVerifyStart
(
...
FUNC(Csm_ReturnType, CRYSTUB_40_CODE) Cry_MacVerifyUpdate
(
...
FUNC(Csm_ReturnType, CRYSTUB_40_CODE) Cry_MacVerifyFinish
(
...
{
  CRY_PARAM_UNUSED(MacPtr);
  CRY_PARAM_UNUSED(MacLength);
...
/*------------------------------------------------------------------------------------------------*/
/*----[Cry_MacVerifyMainFunction]-----------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------*/

FUNC(void, CRYSTUB_40_CODE) Cry_MacVerifyMainFunction
(
  void
)
{
