...
[!IF "not(node:isconsecutive(util:distinct(node:refs(FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*/
...
[!SELECT "as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures"!]
  [!IF "((node:existsAndTrue(FrNmPnEiraCalcEnabled)) and
         (not(node:exists(as:modconf('PduR')[1]/PduRRoutingTables/eb-list::*/
          PduRRoutingTable/eb-list::*/PduRRoutingPath/eb-list::*/PduRSrcPdu[(node:exists(PduRSrcPduRef)) and
...
[!IF "node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGeneral/FrNmPnSupported)"!]
  [!LOOP "util:distinct(node:order(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*[1]/FrNmChannel/eb-list::*, 'node:value(node:ref(FrNmChannelIdentifiers/FrNmChannelHandle)/FrIfClstIdx)'))"!]
    [!IF "node:existsAndTrue(FrNmChannelIdentifiers/FrNmPnEraCalcEnabled)"!]
      [!IF "not(node:exists(as:modconf('PduR')[1]/PduRRoutingTables/eb-list::*/PduRRoutingTable/eb-list::*/PduRRoutingPath/eb-list::*/PduRSrcPdu[(node:exists(PduRSrcPduRef)) and (PduRSrcPduRef= node:current()/FrNmChannelIdentifiers/FrNmPnEraRxNSduRef)]/PduRSourcePduHandleId))"!]
...
[!LOOP "FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*/FrNmChannelIdentifiers"!]

  [!/* === Checks for Rx Pdus === */!]
  [!LOOP "FrNmRxPdu/eb-list::*"!]

    [!/* === Ensure that Rx Pdu length is in range === */!]
    [!/* !LINKSTO FrNm.EB.FRNM154.NMDataLength,1 */!]
    ...
    [!IF "((node:existsAndTrue(FrNmRxPduContainsData) ) and
           (node:existsAndTrue(../../FrNmSourceNodeIdentifierEnabled)) and
    ...
    [!IF "((node:existsAndTrue(FrNmRxPduContainsData)) and
            (node:exists(../../FrNmTxPdu/eb-list::*[node:existsAndTrue(FrNmTxPduContainsData)])) and
            (node:ref(FrNmRxPduRef)/PduLength !=
            node:ref(../../FrNmTxPdu/eb-list::*[node:existsAndTrue(FrNmTxPduContainsData)]/FrNmTxPduRef)/PduLength))"!]
    ...
    [!IF "num:max(util:distinct(node:refs(../eb-list::*/FrNmRxPduRef))/PduLength) !=
    ...
    [!IF "(node:existsAndTrue(../../FrNmPnEnabled)) and (node:existsAndTrue(FrNmRxPduContainsData)) and
  ...
  [!LOOP "FrNmTxPdu/eb-list::*"!]
    ...
    [!/* !LINKSTO FrNm.EB.FRNM154.NMDataLength,1 */!]
    [!IF "(num:max(util:distinct(node:refs(../../FrNmRxPdu/eb-list::*/FrNmRxPduRef))/PduLength) <
    ...
    [!IF "((node:existsAndTrue(FrNmTxPduContainsData)) and
           (node:existsAndTrue(../../FrNmSourceNodeIdentifierEnabled)) and
    ...
    [!IF "count(as:modconf('FrIf')[1]/FrIfConfig/eb-list::*/FrIfPdu/eb-list::*/FrIfPduDirection[
  ...
  [!SELECT "FrNmUserDataTxPdu"!]
    ...
    [!/* !LINKSTO FrNm.EB.ComUserDataSupport.UserDataLength.NoUserData,1 */!]
    [!IF "(node:refvalid(../FrNmTxPdu/eb-list::*[node:existsAndTrue(FrNmTxPduContainsData)]/FrNmTxPduRef)) and
           not(((node:existsAndTrue(../FrNmSourceNodeIdentifierEnabled)) and
                (as:ref(../FrNmTxPdu/eb-list::*[node:existsAndTrue(FrNmTxPduContainsData)]/FrNmTxPduRef)/PduLength > 2)) or
                ((node:existsAndFalse(../FrNmSourceNodeIdentifierEnabled)) and
                 (as:ref(../FrNmTxPdu/eb-list::*[node:existsAndTrue(FrNmTxPduContainsData)]/FrNmTxPduRef)/PduLength > 1)))"!]
    ...
    [!/* !LINKSTO FrNm.EB.ComUserDataSupport.UserDataLength.Error,1, FrNm.EB.ComUserDataSupport.UserDataLength,1, FrNm.SWS_FrNm_00155,1, FrNm.EB.FrNmSourceNodeIdentifierEnabled_True,1 */!]
    [!/* === When Source Node Identifier is enabled === */!]
    [!IF "(node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmComUserDataSupport)) and
          (node:existsAndTrue(../FrNmSourceNodeIdentifierEnabled)) and
          ((as:ref(../FrNmTxPdu/eb-list::*[node:existsAndTrue(FrNmTxPduContainsData)]/FrNmTxPduRef)/PduLength) !=
    ...
    [!/* !LINKSTO FrNm.EB.ComUserDataSupport.UserDataLength.Error,1, FrNm.EB.ComUserDataSupport.UserDataLength,1, FrNm.SWS_FrNm_00155,1, FrNm.EB.FrNmSourceNodeIdentifierEnabled_False,1 */!]
    ...
    [!IF "not(node:exists(as:modconf('PduR')[1]/PduRRoutingTables/eb-list::*/
              PduRRoutingTable/eb-list::*/PduRRoutingPath/eb-list::*/PduRDestPdu/eb-list::*[(node:exists(PduRDestPduRef)) and (PduRDestPduRef =
  ...
  [!SELECT "FrNmUserDataRxPdu"!]
    ...
    [!/* !LINKSTO FrNm.EB.ComUserDataSupport.UserDataLength.NoUserData,1 */!]
    [!IF "(node:refvalid(../FrNmRxPdu/eb-list::*[node:existsAndTrue(FrNmRxPduContainsData)]/FrNmRxPduRef)) and
           not(((node:existsAndTrue(../FrNmSourceNodeIdentifierEnabled)) and
                (as:ref(../FrNmRxPdu/eb-list::*[node:existsAndTrue(FrNmRxPduContainsData)]/FrNmRxPduRef)/PduLength > 2)) or
                ((node:existsAndFalse(../FrNmSourceNodeIdentifierEnabled)) and
                 (as:ref(../FrNmRxPdu/eb-list::*[node:existsAndTrue(FrNmRxPduContainsData)]/FrNmRxPduRef)/PduLength > 1)))"!]
    ...
    [!/* !LINKSTO FrNm.EB.ComUserDataSupport.UserDataLength.Error,1, FrNm.EB.ComUserDataSupport.UserDataLength,1, FrNm.SWS_FrNm_00155,1 */!]
    [!/* === When Source Node Identifier is enabled === */!]
    [!IF "(node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmComUserDataSupport)) and
          (node:existsAndTrue(../FrNmSourceNodeIdentifierEnabled)) and
          ((as:ref(../FrNmRxPdu/eb-list::*[node:existsAndTrue(FrNmRxPduContainsData)]/FrNmRxPduRef)/PduLength) !=
    ...
    [!/* !LINKSTO FrNm.EB.ComUserDataSupport.PduR_FrNmUserDataRxId,1 */!]
    [!IF "not(node:exists(as:modconf('PduR')[1]/PduRRoutingTables/eb-list::*/
              PduRRoutingTable/eb-list::*/PduRRoutingPath/eb-list::*/PduRSrcPdu[PduRSrcPduRef =
  ...
  [!IF "node:exists(FrNmCarWakeUpBytePosition)"!]
    [!IF "(node:existsAndTrue(FrNmPnEnabled)) and
  ...
  [!IF "(node:existsAndTrue(FrNmCarWakeUpRxEnabled)) and (count(FrNmRxPdu/eb-list::*[node:existsAndTrue(FrNmRxPduContainsData)]) = 0)"!]
...
/* Size needed in case passive mode is off for TxBuffers */
...
[!LOOP "util:distinct(node:order(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*, 'node:value(node:ref(FrNmChannelIdentifiers/FrNmChannelHandle)/FrIfClstIdx)'))"!]
  [!IF "node:exists(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled) and
    ...
    [!VAR "CalculatedPbRamSize" = "num:i($CalculatedPbRamSize + as:ref(FrNmChannelIdentifiers/FrNmUserDataTxPdu/FrNmTxUserDataPduRef)/PduLength)"!]
  [!ENDIF!]
[!ENDLOOP!]
...
[!IF "($CalculatedPbRamSize) > as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmPostBuildRamSize"!]
  [!ERROR!] Space needed for TX, RX and FrNmUserDataTxPdu pdus are less than configured FrNmPostBuildRamSize
  [!ENDERROR!]
[!ENDIF!]

[!/* Ensure that FrNmMaxPn is not smaller than the number of bits set to 1 in FrNmPnFilterMaskByteValue entries. */!]
[!IF "node:exists(as:modconf('FrNm')[1]/FrNmGeneral/FrNmMaxPn) and (node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGeneral/FrNmPnSupported))"!]
[!VAR "BitsSetTo1" = "0"!]
[!LOOP "util:distinct(node:order(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmPnInfo/FrNmPnFilterMaskByte/eb-list::*,'FrNmPnFilterMaskByteIndex'))"!]
  [!FOR "BitPos" = "0" TO "7"!]
    [!IF "node:existsAndTrue(bit:getbit(FrNmPnFilterMaskByteValue, $BitPos))"!]
      [!VAR "BitsSetTo1" = "$BitsSetTo1 + 1"!]
    [!ENDIF!]
  [!ENDFOR!]
[!ENDLOOP!]
[!IF "as:modconf('FrNm')[1]/FrNmGeneral/FrNmMaxPn < number($BitsSetTo1)"!]
...
[!/* Check that in case FrNmSynchronizedPncShutdownEnabled is set to true FrNmPnEnabled is set to true */!]
[!LOOP "as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*[1]/FrNmChannel/eb-list::*"!]
  [!IF "node:exists(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled) and 
        (node:existsAndTrue(FrNmChannelIdentifiers/FrNmSynchronizedPncShutdownEnabled)) and
        (node:existsAndFalse(FrNmChannelIdentifiers/FrNmPnEnabled))"!]
    [!ERROR!]"For channel [!"node:name(.)"!] FrNmSynchronizedPncShutdownEnabled is set to true but FrNmPnEnabled is set to false"  
    [!ENDERROR!]        
  [!ENDIF!]
[!ENDLOOP!]
