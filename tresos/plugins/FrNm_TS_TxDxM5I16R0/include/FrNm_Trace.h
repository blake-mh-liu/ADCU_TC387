...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_FRNM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_ENTRY
/** \brief Entry point of function FrNm_RequestSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_FRNM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_ENTRY(nmChannelHandle,pncId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_FRNM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_EXIT
/** \brief Exit point of function FrNm_RequestSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_FRNM_REQUESTSYNCHRONIZEDPNCSHUTDOWN_EXIT(nmChannelHandle,pncId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
