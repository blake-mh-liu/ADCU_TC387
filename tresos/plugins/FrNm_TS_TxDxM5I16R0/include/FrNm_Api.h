...
/*==================[inclusions]=========================================*/
/* !LINKSTO FrNm.EB_Ref.FRNM066.NmStack_Types,1 */
#include <NmStack_Types.h>       /* Nm specific types */
/* !LINKSTO FrNm.ASR403.FRNM400,1 */
 ...
 */
#define FRNM_SERVID_RXINDICATION                      0x42U
 ...
 */
#define FRNM_SERVID_TRIGGERTRANSMIT                       0x41U
 ...
 */
#define FRNM_SERVID_TXCONFIRMATION                     0x40U
 ...
 */
#define FRNM_SERVID_ENABLECOMMUNICATION                0x05U
...
#if (defined FRNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN)
#error FRNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN already defined
#endif /* #if (defined FRNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN) */
/** \brief AUTOSAR API service ID.
**
** Definition of FRNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN.
*/
#define FRNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN     0xF3U
...
/* !LINKSTO FrNm.EB.Init.Failed,1 */
#if (defined FRNM_E_INIT_FAILED)
#error FRNM_E_INIT_FAILED already defined
#endif
#define FRNM_E_INIT_FAILED                                0x06U

#if (defined FRNM_E_PNSR_FORWARD_SYNCHRONIZED_SHUTDOWN)
#error FRNM_E_PNSR_FORWARD_SYNCHRONIZED_SHUTDOWN already defined
#endif
/** \brief Error code for SchM Nm_ForwardSynchronizedPncShutdown */
#define FRNM_E_PNSR_FORWARD_SYNCHRONIZED_SHUTDOWN         251U
...
#if (defined FRNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST)
#error FRNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST already defined
#endif
/** \brief Error code for Invalid shutdown request */
#define FRNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST 32U

#if (defined FRNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED)
#error FRNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED already defined
#endif
/** \brief Error code for transmission of PNSR message failed */
#define FRNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED 33U

/*==================[type definitions]===================================*/

/*==================[external function declarations]=====================*/
/* !LINKSTO FrNm.ASR403.FRNM367,1 */
...
#ifndef RTE_SCHM_SWCBSW_FRNM_MULTIPLENETWORKOPERATIONS
#define RTE_SCHM_SWCBSW_FRNM_MULTIPLENETWORKOPERATIONS
/** \brief Single client interface.
 **
 ** This function is a single client interface for FrNm_PassiveStartUp,
 ** FrNm_NetworkRequest, FrNm_NetworkRelease, FrNm_NetworkGwEraRequest.
 ** \param[in] nmChannelHandle Identification of the NM channel.
 ** \param[in] operation  Operation to be executed (one of FrNM_PassiveStartUp,
 **                       FrNm_NetworkRequest, FrNm_NetworkRelease,
 ...
 */
extern FUNC(Std_ReturnType, FRNM_CODE) FrNm_MultipleNetworkOperations
(
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO FrNm.EB.API.Transmit,1 */
...
/** \brief Request synchronized shutdown.
 **
 ...
 **
 ** Preconditions:
 ** - The API is only available if FrNmSynchronizedPncShutdownEnabled is
 **   TRUE for at least one channel.
 **
 ** \param[in] nmChannelHandle Identification of the NM channel.
 ** \param[in] pncId Identifier of the PNC requested for a synchronized shutdown
 **
 ** \return Standard Return Code
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO FrNm.SWS_FrNm_91003,1 */
extern FUNC(Std_ReturnType, FRNM_CODE) FrNm_RequestSynchronizedPncShutdown
(
  NetworkHandleType nmChannelHandle,
  PNCHandleType pncId
);
