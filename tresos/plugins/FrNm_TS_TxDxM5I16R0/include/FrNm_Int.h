 ...
 */
#if (defined FRNM_MASK_3_BITS)
#error FRNM_MASK_3_BITS already defined
#endif
#define FRNM_MASK_3_BITS  0x07U
 ...
 */
#if (defined FRNM_SHIFT_3_BITS)
#error FRNM_SHIFT_3_BITS already defined
#endif
#define FRNM_SHIFT_3_BITS 0x03U
...
#define FRNM_CHANNEL_COM_USERDATA_BUFFER_OFFSET(a)   (FrNm_RootPtr->ComUserDataBufferOffsets[(a)])
...
#define FRNM_CHANNEL_COM_USERDATA_BUFFER_OFFSET(a)   (FrNm_RootPtr->ComUserDataBufferOffsets[(0)])
#endif
...
#endif
#define FRNM_EIRA_INVALID_INDEX 0xFFFFU
...
/** \brief MACRO for DET reporting
 */
#if (defined FRNM_DET_REPORT_RUNTIME_ERROR)
#error FRNM_DET_REPORT_RUNTIME_ERROR already defined
#endif
#define FRNM_DET_REPORT_RUNTIME_ERROR(InstanceId, ServiceId, ErrorCode)          \
   (void)Det_ReportRuntimeError(FRNM_MODULE_ID, (InstanceId), (ServiceId), (ErrorCode))
...
#if (defined FRNM_GATEWAY_TYPE_UNUSED)
#error FRNM_GATEWAY_TYPE_UNUSED already defined
#endif
#define FRNM_GATEWAY_TYPE_UNUSED     0U

#if (defined FRNM_GATEWAY_TYPE_PASSIVE)
#error FRNM_GATEWAY_TYPE_PASSIVE already defined
#endif
#define FRNM_GATEWAY_TYPE_PASSIVE    1U

#if (defined FRNM_GATEWAY_TYPE_ACTIVE)
#error FRNM_GATEWAY_TYPE_ACTIVE already defined
#endif
#define FRNM_GATEWAY_TYPE_ACTIVE     2U

#define FRNM_INVALID_OFFSET 4294967295U

#if (defined FRNM_CBV_PNSRBIT)
#error FRNM_CBV_PNSRBIT is already defined
#endif
#define FRNM_CBV_PNSRBIT                               1U

#if (defined FRNM_CBV_PNSRBITMASK)
#error FRNM_CBV_PNSRBITMASK is already defined
#endif
#define FRNM_CBV_PNSRBITMASK FRNM_BITPOS2MASK(FRNM_CBV_PNSRBIT)


#if (defined FRNM_PN_SYNC_SHUTDOWN_BIT)
#error FRNM_PN_SYNC_SHUTDOWN_BIT is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_BIT                      1U

#if (defined FRNM_PN_SYNC_SHUTDOWN)
#error FRNM_PN_SYNC_SHUTDOWN is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN \
   FRNM_BITPOS2MASK(FRNM_PN_SYNC_SHUTDOWN_BIT)

#if (defined FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX_BIT)
#error FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX_BIT already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX_BIT         2U

#if (defined FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX)
#error FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX \
   FRNM_BITPOS2MASK(FRNM_PN_SYNC_SHUTDOWN_IMMEDIATE_TX_BIT)

#if (defined FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX_BIT)
#error FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX_BIT already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX_BIT         3U

#if (defined FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX)
#error FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX \
   FRNM_BITPOS2MASK(FRNM_PN_SYNC_SHUTDOWN_DECOUPLED_TX_BIT)


#if (defined FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX_BIT)
#error FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX_BIT already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX_BIT    5U

#if (defined FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX)
#error FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX \
   FRNM_BITPOS2MASK(FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_RX_BIT)

#if (defined FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD_BIT)
#error FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD_BIT already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD_BIT   6U

#if (defined FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD)
#error FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD \
   FRNM_BITPOS2MASK(FRNM_PN_SYNC_SHUTDOWN_PASSIVE_CH_FWD_BIT)

#if (defined FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER_BIT)
#error FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER_BIT already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER_BIT   7U

#if (defined FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER)
#error FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER is already defined
#endif
#define FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER \
   FRNM_BITPOS2MASK(FRNM_PN_SYNC_SHUTDOWN_RESTART_TIMER_BIT)

/** \brief Macro to indicate the value of operation passive startup
 */
#if (defined FRNM_MULTI_CORE_USE_SINGLE_CS_PASSIVE_STARTUP)
#error FRNM_MULTI_CORE_USE_SINGLE_CS_PASSIVE_STARTUP is already defined
#endif
#define FRNM_MULTI_CORE_USE_SINGLE_CS_PASSIVE_STARTUP 0U

/** \brief Macro to indicate the value of operation network request
 */
#if (defined FRNM_MULTI_CORE_USE_SINGLE_CS_NETWORK_REQUEST)
#error FRNM_MULTI_CORE_USE_SINGLE_CS_NETWORK_REQUEST is already defined
#endif
#define FRNM_MULTI_CORE_USE_SINGLE_CS_NETWORK_REQUEST 1U

/** \brief Macro to indicate the value of operation network release
 */
#if (defined FRNM_MULTI_CORE_USE_SINGLE_CS_NETWORK_RELEASE)
#error FRNM_MULTI_CORE_USE_SINGLE_CS_NETWORK_RELEASE is already defined
#endif
#define FRNM_MULTI_CORE_USE_SINGLE_CS_NETWORK_RELEASE 2U
...
typedef Std_ReturnType (*FrNm_Nm_CallsFctPtrType1)(uint8 data0);

/** \brief SchM call function pointer which accepts two parameters */
typedef Std_ReturnType (*FrNm_Nm_CallsFctPtrType2)(uint8 data0,uint8 data1,uint8 data2);
#endif
...
typedef struct
{
  ...
  FrNm_TimeType     PnRetransmissionTimer;
  /* stores PnIds sent for wich there was trasnmitted a synchronized shutdown */
  uint8             PnInfoSentDecoupled[FRNM_PN_INFO_LENGTH];
  uint8             PnInfoSentImmediate[FRNM_PN_INFO_LENGTH];
#endif /* #if (FRNM_PN_SHUTDOWN_MESSAGE_RETRANSMISSION_ENABLED == STD_ON) */
  /* stores all requests received from FrNm_RequestSynchronizedPncShutdown calls */
  uint8             PnInfoRcv[FRNM_PN_INFO_LENGTH];
  /* aggregates all FrNm_RequestSynchronizedPncShutdown received between 2 main functions calls */
  uint8             PnInfoAgg[FRNM_PN_INFO_LENGTH];
} FrNm_SynchronizedPncShutdownIdsType;

typedef struct
{
  /* stores all PN synchronized shutdown requests from messages from Bus */
  uint8 PnInfoRx[FRNM_PN_INFO_LENGTH];
#if (FRNM_MULTICORE_ENABLED == STD_ON)
  /* snapshot(buffer copy) of PnInfoRx on main function execution */
  Nm_PnSyncShutdown_BusNm_To_Nm_DataType PnInfoRxAgg;
#else
  /* snapshot(buffer copy) of PnInfoRx on main function execution */
  uint8 PnInfoRxAgg[FRNM_PN_INFO_LENGTH];
#endif
} FrNm_SynchronizedPncShutdownRxIdsType;
...
#if (FRNM_PN_SYNCHRONIZED_SHUTDOWN_ENABLED == STD_ON)
#if (FRNM_PN_SHUTDOWN_MESSAGE_RETRANSMISSION_ENABLED == STD_ON)
  uint16 PnShutdownMessageRetransmissionDuration;
#endif /* #if (FRNM_PN_SHUTDOWN_MESSAGE_RETRANSMISSION_ENABLED == STD_ON) */
  uint8 FrNmTypeOfGateway;
#endif /*#if (FRNM_PN_SYNCHRONIZED_SHUTDOWN_ENABLED == STD_ON)*/
#if (FRNM_PN_ERA_CALC_ENABLED == STD_ON)
...
typedef struct
{
  ...
  P2VAR(uint8, TYPEDEF, AUTOSAR_COMSTACKDATA) ComUserDataPduPtr; /**< cluster specific Pdu transmit buffer */
#endif /*#if (FRNM_PN_GATEWAY_TYPE_ACTIVE_NUM > 0)*/
#if (FRNM_PN_GATEWAY_TYPE_ACTIVE_NUM > 0)
  P2VAR(FrNm_SynchronizedPncShutdownIdsType, TYPEDEF, FRNM_VAR_CLEARED)
                    FrNm_SynchronizedPncShutdownIds;
#endif /* #if (FRNM_PN_GATEWAY_TYPE_ACTIVE_NUM > 0) */
#if (FRNM_PN_GATEWAY_TYPE_PASSIVE_NUM > 0)
  P2VAR(FrNm_SynchronizedPncShutdownRxIdsType, TYPEDEF, FRNM_VAR_CLEARED)
                    FrNm_SynchronizedPncShutdownRxIds;
#endif /* #if (FRNM_PN_GATEWAY_TYPE_PASSIVE_NUM > 0) */
#endif /* #if (FRNM_PN_SYNCHRONIZED_SHUTDOWN_ENABLED  == STD_ON) */

#if (FRNM_PN_ERA_CALC_ENABLED == STD_ON)
  /* !LINKSTO FrNm.ASR403.FRNM430,1 */
/* !LINKSTO FrNm.EB_Ref.SWS_FrNm_00461.Era,1 */
  FrNm_PnStatusType             PnEra;
#endif
  FrNm_TimeType    UniversalTimer;  /**< Timer for repeat message time and remote sleep time */
  FrNm_TimeType    TimeoutTimer;    /**< Timer for detecting transmission timeout */
  /* !LINKSTO FrNm.ASR403.FRNM309,1 */
...
/* !LINKSTO FrNm.EB_Ref.SWS_FrNm_00461.Eira,1 */
