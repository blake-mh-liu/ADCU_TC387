...
{
[!LOOP "util:distinct(node:order(FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*, 'node:value(node:ref(FrNmChannelIdentifiers/FrNmChannelHandle)/FrIfClstIdx)'))"!]
  /* Configuration of FR NM channel [!"as:name(.)"!] : */
  {
...
CONST(FrNm_ChnConfigType, FRNM_CONST) FrNm_ChanConfig[FRNM_NUMBER_OF_CHANNELS] =
{
  [!LOOP "util:distinct(node:order(FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*, 'node:value(node:ref(FrNmChannelIdentifiers/FrNmChannelHandle)/FrIfClstIdx)'))"!][!//
  {
[!IF "node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGeneral/FrNmMultiCoreSupport)"!]
...
[!IF "node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmRemoteSleepIndicationEnabled)"!]
...
[!ENDIF!]
[!IF "node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmCoordinatorSyncSupport)"!]
     &SchM_Call_FrNm_RequiredCSEntry_Nm_CoordReadyToSleepIndication_[!"node:name(.)"!],
[!ENDIF!]
[!IF "num:i(count(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*/FrNmChannelIdentifiers[node:existsAndTrue(FrNmSynchronizationPointEnabled)])) != 0"!]
[!IF "node:existsAndTrue(FrNmChannelIdentifiers/FrNmSynchronizationPointEnabled)"!]
     &SchM_Call_FrNm_RequiredCSEntry_Nm_SynchronizationPoint_[!"node:name(.)"!],
[!ELSE!]
     NULL_PTR,
[!ENDIF!]
[!ENDIF!]
[!IF "node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmPduRxIndicationEnabled)"!]
     &SchM_Call_FrNm_RequiredCSEntry_Nm_PduRxIndication_[!"node:name(.)"!],
[!ENDIF!]
[!IF "node:existsAndTrue(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalFeatures/FrNmStateChangeIndicationEnabled)"!]
...
[!IF "count(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*[1]/FrNmChannel/eb-list::*[node:existsAndTrue(FrNmChannelIdentifiers/FrNmCarWakeUpRxEnabled)]) > 0"!]
[!IF "node:existsAndTrue(FrNmChannelIdentifiers/FrNmCarWakeUpRxEnabled)"!]
...
[!ENDIF!]
    [!SELECT "FrNmChannelIdentifiers"!]
    {
      ...
      [!IF "(node:existsAndTrue(FrNmPnEraCalcEnabled))"!][!//
      ...
      [!ENDIF!][!//
#endif
      [!IF "node:existsAndTrue($SynchronizedPncShutdownEnabled)"!]
        [!IF "(node:existsAndTrue(FrNmSynchronizedPncShutdownEnabled))"!]
          [!IF "node:exists(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalProperties/FrNmPnShutdownMessageRetransmissionDuration)"!]
      [!"num:i(((as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalProperties/FrNmPnShutdownMessageRetransmissionDuration) * 1000) div ((../FrNmChannelTiming/FrNmMainFunctionPeriod) * 1000))"!]U, /*FrNmPnShutdownMessageRetransmissionDuration*/
          [!ENDIF!] [!/*[!IF "node:exists(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalProperties/FrNmPnShutdownMessageRetransmissionDuration)"!]*/!]
          [!IF "node:exists(node:ref(FrNmComMNetworkHandleRef)/ComMPncGatewayType) and (node:ref(FrNmComMNetworkHandleRef)/ComMPncGatewayType = 'COMM_GATEWAY_TYPE_ACTIVE')"!]
      FRNM_GATEWAY_TYPE_ACTIVE, /* CanNmTypeOfGateway */
          [!ELSEIF "node:exists(node:ref(FrNmComMNetworkHandleRef)/ComMPncGatewayType) and (node:ref(FrNmComMNetworkHandleRef)/ComMPncGatewayType = 'COMM_GATEWAY_TYPE_PASSIVE')"!]
      FRNM_GATEWAY_TYPE_PASSIVE, /* CanNmTypeOfGateway */
          [!ELSE!]
      FRNM_GATEWAY_TYPE_UNUSED, /* CanNmTypeOfGateway */
          [!ENDIF!]
        [!ELSE!] [!/* [!IF "(node:existsAndTrue(FrNmSynchronizedPncShutdownEnabled))"!] */!]
          [!IF "node:exists(as:modconf('FrNm')[1]/FrNmGlobalConfig/FrNmGlobalProperties/FrNmPnShutdownMessageRetransmissionDuration)"!]
      0U,  /*FrNmPnShutdownMessageRetransmissionDuration*/  
          [!ENDIF!] [!/**/!] 
      FRNM_GATEWAY_TYPE_UNUSED, /* CanNmTypeOfGateway */       
        [!ENDIF!] [!/* [!IF "(node:existsAndTrue(FrNmSynchronizedPncShutdownEnabled))"!] */!]
      [!ENDIF!] [!/*[!IF "node:existsAndTrue($SynchronizedPncShutdownEnabled)"!]*/!]
#if (FRNM_PN_ERA_CALC_ENABLED == STD_ON)
      [!IF "(node:existsAndTrue(FrNmPnEraCalcEnabled))"!][!//
      1U, /* EraCalcEnabled */
      [!ELSE!]
...
[!IF "count(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*[1]/FrNmChannel/eb-list::*[node:existsAndTrue(FrNmChannelIdentifiers/FrNmCarWakeUpRxEnabled)]) > 0"!]
  ...
  [!ENDIF!][!//
[!ENDIF!]
      /* !LINKSTO FrNm.ECUC_FrNm_00070,1 */
      [!"num:i(as:ref(FrNmComMNetworkHandleRef)/ComMChannelId)"!]U, /* ComM channel Id */
  [!IF "node:existsAndTrue(FrNmSourceNodeIdentifierEnabled)"!]
  ...
  [!ENDIF!]
  [!IF "node:existsAndTrue(FrNmNodeDetectionEnabled)"!]
...
[!IF "num:i(count(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*[(node:exists(FrNmChannelIdentifiers/FrNmActiveWakeupBitEnabled)) and (node:existsAndTrue(FrNmChannelIdentifiers/FrNmActiveWakeupBitEnabled))])) != 0"!]
      [!IF "node:existsAndTrue(FrNmActiveWakeupBitEnabled)"!][!//
...
[!IF "count(as:modconf('FrNm')[1]/FrNmChannelConfig/eb-list::*[1]/FrNmChannel/eb-list::*[node:existsAndTrue(FrNmChannelIdentifiers/FrNmCarWakeUpRxEnabled)]) > 0"!]
  [!IF "node:exists(FrNmCarWakeUpFilterEnabled)"!][!//
    [!IF "node:existsAndTrue(FrNmCarWakeUpFilterEnabled)"!][!//
  ...
  [!ELSE!][!//
      FALSE, /* FrNmCarWakeUpFilterEnabled */
  [!ENDIF!][!//
  [!IF "node:existsAndTrue(FrNmCarWakeUpRxEnabled)"!][!//
...
[!ENDIF!]
    ...
    [!ENDSELECT!]
    [!IF "(node:existsAndTrue(FrNmAllNmMessagesKeepAwake))"!][!//
...
[!VAR "LeastMainFnPeriodChId" = "node:value(node:ref(FrNmChannelConfig/eb-list::*/FrNmChannel/eb-list::*[FrNmChannelTiming/FrNmMainFunctionPeriod = num:min(../eb-list::*/FrNmChannelTiming/FrNmMainFunctionPeriod)]/FrNmChannelIdentifiers/FrNmChannelHandle)/FrIfClstIdx)"!]
