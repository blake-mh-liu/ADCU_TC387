...
#endif
#define FRNM_HSM_FRNM_NUM_EVENTS 16U
...
{
  &FrNm_HsmFrNmSfReadySleepStateGuard3,
...
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrNetworkModeSteps2[1] =
{
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_ACTION_2,
};
/* trans sequence for transition #3 from state NetworkMode */
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrNetworkModeSteps3[1] =
{
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_ACTION_3,
};
/* trans sequence for transition #4 from state NetworkMode */
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrNetworkModeSteps4[3] =
{
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_EXIT,
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_ACTION_4,
  FRNM_HSM_FRNM_AIDX_BUSSLEEPMODE_ENTRY,
};
/* trans sequence for transition #5 from state NetworkMode */
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrNetworkModeSteps5[3] =
{
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_EXIT,
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_ACTION_5,
  FRNM_HSM_FRNM_AIDX_SYNCHRONIZEMODE_ENTRY,
};
/* trans sequence for transition #1 from state ReadySleepState */
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrReadySleepStateSteps1[1] =
{
  FRNM_HSM_FRNM_AIDX_READYSLEEPSTATE_ACTION_1,
};
/* trans sequence for transition #2 from state ReadySleepState */
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrReadySleepStateSteps2[1] =
{
  FRNM_HSM_FRNM_AIDX_READYSLEEPSTATE_ACTION_2,
};
/* trans sequence for transition #3 from state ReadySleepState */
STATIC CONST(FrNm_HsmActionIdxType, FRNM_CONST)
  FrNm_HsmTrReadySleepStateSteps3[4] =
{
  FRNM_HSM_FRNM_AIDX_READYSLEEPSTATE_EXIT,
  FRNM_HSM_FRNM_AIDX_NETWORKMODE_EXIT,
  FRNM_HSM_FRNM_AIDX_READYSLEEPSTATE_ACTION_3,
  FRNM_HSM_FRNM_AIDX_BUSSLEEPMODE_ENTRY,
};
...
},
{
  ...
  FRNM_HSM_FRNM_EV_TX_CONFIRMATION_NETWORK_MODE, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
  ...
  FRNM_HSM_FRNM_EV_TX_TIMEOUT_NETWORK_MODE, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
  FrNm_HsmTrNetworkModeSteps4,
  sizeof(FrNm_HsmTrNetworkModeSteps4)/sizeof(FrNm_HsmActionIdxType),
  FRNM_HSM_FRNM_EV_FAILSAFE_SLEEP_MODE, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_FRNM_SIDX_BUSSLEEPMODE /* target state */
},
{
  FrNm_HsmTrNetworkModeSteps5,
  sizeof(FrNm_HsmTrNetworkModeSteps5)/sizeof(FrNm_HsmActionIdxType),
...
STATIC CONST(FrNm_HsmTranType, FRNM_CONST)
 FrNm_HsmTrReadySleepState[3] =
{
{
  FrNm_HsmTrReadySleepStateSteps1,
  sizeof(FrNm_HsmTrReadySleepStateSteps1)/sizeof(FrNm_HsmActionIdxType),
  FRNM_HSM_FRNM_EV_VOTE_CYCLE_TIMESLOT_SEND_IN_RS, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
  FrNm_HsmTrReadySleepStateSteps2,
  sizeof(FrNm_HsmTrReadySleepStateSteps2)/sizeof(FrNm_HsmActionIdxType),
  FRNM_HSM_FRNM_EV_DATA_CYCLE_TIMESLOT_SEND_IN_RS, /* triggering event */
  FRNM_HSM_GIDX_INVALID, /* no guard */
  FRNM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
  FrNm_HsmTrReadySleepStateSteps3,
  sizeof(FrNm_HsmTrReadySleepStateSteps3)/sizeof(FrNm_HsmActionIdxType),
  FRNM_HSM_FRNM_EV_REP_CYCLE_COMPLETED, /* triggering event */
  FRNM_HSM_FRNM_GIDX_READYSLEEPSTATE_GUARD_3, /* guard idx */
  FRNM_HSM_FRNM_SIDX_BUSSLEEPMODE /* target state */
},
};
  ...
  FrNm_HsmScdFrNm[FRNM_HSM_FRNM_NO_OF_STATES] =
{
  ...
  },
  {
   ...
   (1UL << FRNM_HSM_FRNM_EV_RX_INDICATION)
    ...
    ,
      /* ignored event mask */
   (1UL << FRNM_HSM_FRNM_EV_TX_CONFIRMATION_NETWORK_MODE)
    |   (1UL << FRNM_HSM_FRNM_EV_TX_TIMEOUT_NETWORK_MODE)
    |   (1UL << FRNM_HSM_FRNM_EV_FAILSAFE_SYNCH_MODE)
    |   (1UL << FRNM_HSM_FRNM_EV_VOTE_CYCLE_TIMESLOT_SEND_IN_RS)
    |   (1UL << FRNM_HSM_FRNM_EV_DATA_CYCLE_TIMESLOT_SEND_IN_RS)
  ...
  },
  {
    ...
    FRNM_HSM_FRNM_AIDX_NETWORKMODE_EXIT, /* exit function */
    FRNM_HSM_AIDX_INVALID, /* no do action */
  ...
  FrNm_HsmFrNmActionNames[] =
{
  ...
  "NetworkMode action 4",
  "NetworkMode action 5",
  "ReadySleepState entry",
  "ReadySleepState exit",
  "ReadySleepState action 1",
  "ReadySleepState action 2",
  "ReadySleepState action 3",
  ...
  FrNm_HsmFrNmEventNames[] =
{
  "RX_INDICATION",
  "NETWORK_START",
  "TX_CONFIRMATION_NETWORK_MODE",
  "TX_TIMEOUT_NETWORK_MODE",
  "FAILSAFE_SYNCH_MODE",
  "VOTE_CYCLE_TIMESLOT_SEND_IN_RS",
  "DATA_CYCLE_TIMESLOT_SEND_IN_RS",
  "DATA_CYCLE_TIMESLOT",
  "VOTE_CYCLE_TIMESLOT",
  "TX_CONFIRMATION",
  "TX_TIMEOUT",
