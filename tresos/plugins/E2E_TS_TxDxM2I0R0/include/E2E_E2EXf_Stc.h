 ...
 *
 * MISRAC2012-2) Deviated Rule: 2.3 (advisory): A project should not contain unused type declarations.
 *
 * Reason:
 * As E2EXf_Init() is replaced with E2EXf_PartitionInit(),E2EXf_ConfigType will always be unused.
 */
 ...
 *
 * Reason:
 * This deviation exists only when server(s) are present on the partition.
 * No client is present on the partition.
 * In this case parition will be initialzed without Init.
 *
 */
...
#if (defined E2EXF_SR_DECL_FUNC_XF_INPLACE) /* to prevent double declaration */
#error E2EXF_SR_DECL_FUNC_XF_INPLACE already defined
#endif /* if (defined E2EXF_SR_DECL_FUNC_XF_INPLACE) */

#define E2EXF_SR_DECL_FUNC_XF_INPLACE(XfrmName)                                     \
...
E2EXF_SR_DECL_FUNC_XF_INPLACE(XfrmName)

#if (defined E2EXF_SR_DECL_FUNC_INVXF_INPLACE) /* to prevent double declaration */
#error E2EXF_SR_DECL_FUNC_INVXF_INPLACE already defined
#endif /* if (defined E2EXF_SR_DECL_FUNC_INVXF_INPLACE) */

#define E2EXF_SR_DECL_FUNC_INVXF_INPLACE(XfrmName) \
E2EXF_SR_DECL_FUNC_XF_INPLACE(XfrmName)
...
#if (defined E2EXF_SR_DECL_FUNC_XF_OUTOFPLACE) /* to prevent double declaration */
#error E2EXF_SR_DECL_FUNC_XF_OUTOFPLACE already defined
#endif /* if (defined E2EXF_SR_DECL_FUNC_XF_OUTOFPLACE) */

#define E2EXF_SR_DECL_FUNC_XF_OUTOFPLACE(XfrmName)                                  \
extern FUNC(uint8, E2EXF_CODE) XfrmName                                             \
(                                                                                   \
    P2VAR(uint8, AUTOMATIC, E2EXF_APPL_DATA) BufferPtr,                             \
    P2VAR(E2EXF_XFRMBUFFERLENGTH_TYPE, AUTOMATIC, E2EXF_APPL_DATA) BufferLengthPtr, \
...
E2EXF_SR_DECL_FUNC_XF_OUTOFPLACE(XfrmName)

#if (defined E2EXF_SR_DECL_FUNC_INVXF_OUTOFPLACE) /* to prevent double declaration */
#error E2EXF_SR_DECL_FUNC_INVXF_OUTOFPLACE already defined
#endif /* if (defined E2EXF_SR_DECL_FUNC_INVXF_OUTOFPLACE) */

#define E2EXF_SR_DECL_FUNC_INVXF_OUTOFPLACE(XfrmName) \
E2EXF_SR_DECL_FUNC_XF_OUTOFPLACE(XfrmName)
...
#define E2EXF_SOURCE_DECL_FUNC(XfrmName, BufferTypeReq, InvXfrmName, BufferTypeRes) \
          E2EXF_SOURCE_DECL_FUNC_XF_ ##BufferTypeReq (XfrmName) \
          E2EXF_SOURCE_DECL_FUNC_INVXF_ ##BufferTypeRes (InvXfrmName)


#if (defined E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_INPLACE) /* to prevent double declaration */
#error E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_INPLACE already defined
#endif /* if (defined E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_INPLACE) */
#define E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_INPLACE(XfrmName) \
extern FUNC(uint8, E2EXF_CODE) XfrmName                                             \
(                                                                                   \
...
#if (defined E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_INPLACE) /* to prevent double declaration */
#error E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_INPLACE already defined
#endif /* if (defined E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_INPLACE) */
#define E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_INPLACE(XfrmName) \
        E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_INPLACE(XfrmName)

#if (defined E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE) /* to prevent double declaration */
#error E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE already defined
#endif /* if (defined E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE) */
#define E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE(XfrmName) \
extern FUNC(uint8, E2EXF_CODE) XfrmName                                             \
(                                                                                   \
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,          \
    P2VAR(uint8, AUTOMATIC, E2EXF_APPL_DATA) BufferPtr,                             \
...
#if (defined E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_OUTOFPLACE) /* to prevent double declaration */
#error E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_OUTOFPLACE already defined
#endif /* if (defined E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_OUTOFPLACE) */
#define E2EXF_SOURCE_DECL_FUNC_XF_E2EXF_OUTOFPLACE(XfrmName)                              \
        E2EXF_SOURCE_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE(XfrmName)

#define E2EXF_SINK_DECL_FUNC(XfrmName, BufferTypeRes, InvXfrmName, BufferTypeReq) \
          E2EXF_SINK_DECL_FUNC_XF_ ##BufferTypeRes (XfrmName) \
          E2EXF_SINK_DECL_FUNC_INVXF_ ##BufferTypeReq (InvXfrmName)

#if (defined E2EXF_SINK_DECL_FUNC_XF_E2EXF_INPLACE) /* to prevent double declaration */
#error E2EXF_SINK_DECL_FUNC_XF_E2EXF_INPLACE already defined
#endif /* if (defined E2EXF_SINK_DECL_FUNC_XF_INPLACE) */
#define E2EXF_SINK_DECL_FUNC_XF_E2EXF_INPLACE(XfrmName)                                   \
extern FUNC(uint8, E2EXF_CODE) XfrmName                                             \
(                                                                                   \
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,          \
...
#if (defined E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_INPLACE) /* to prevent double declaration */
#error E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_INPLACE already defined
#endif /* if (defined E2EXF_SINK_DECL_FUNC_INVXF_INPLACE) */
#define E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_INPLACE(InvXfrmName) \
extern FUNC(uint8, E2EXF_CODE) InvXfrmName                                             \
(                                                                                   \
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,          \
    P2VAR(E2EXf_CSTransactionHandleType, AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr, \
    P2VAR(uint8, AUTOMATIC, E2EXF_APPL_DATA) BufferPtr,                             \
    P2VAR(E2EXF_XFRMBUFFERLENGTH_TYPE, AUTOMATIC, E2EXF_APPL_DATA) BufferLengthPtr, \
    E2EXF_XFRMBUFFERLENGTH_TYPE InputBufferLength                                   \
);

#if (defined E2EXF_SINK_DECL_FUNC_XF_E2EXF_OUTOFPLACE) /* to prevent double declaration */
#error E2EXF_SINK_DECL_FUNC_XF_E2EXF_OUTOFPLACE already defined
#endif /* if (defined E2EXF_SINK_DECL_FUNC_XF_E2EXF_OUTOFPLACE) */
#define E2EXF_SINK_DECL_FUNC_XF_E2EXF_OUTOFPLACE(XfrmName)                                \
extern FUNC(uint8, E2EXF_CODE) XfrmName                                             \
(                                                                                   \
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,          \
    P2CONST(E2EXf_CSTransactionHandleType, AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr, \
...
#if (defined E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE) /* to prevent double declaration */
#error E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE already defined
#endif /* if (defined E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE) */
#define E2EXF_SINK_DECL_FUNC_INVXF_E2EXF_OUTOFPLACE(XfrmName) \
extern FUNC(uint8, E2EXF_CODE) XfrmName                                             \
(                                                                                   \
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,          \
    P2VAR(E2EXf_CSTransactionHandleType, AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr, \
...
/* Transaction handle for the C/S method call.
 * Used to tunnel the E2E Source ID and the E2E Counter
 * from the request to the response at the server side via the RTE.
 */
typedef struct {
    uint32 e2eCounter;
