...
/** \brief This macro maps to the CPU specific macro for copying memory bytes,
 *  for 64bit CPU to E2E_MemCpy64()
 */
...
/** \brief Macro to cast a value to check the alignment in dependency of
 * platform specific type CPU_TYPE)
 */
