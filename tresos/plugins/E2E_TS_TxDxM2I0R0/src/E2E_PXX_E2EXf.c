...
FUNC(uint8, E2E_CODE) E2EXf_MethodPreCondCheck
(
...
)
{
  ...
  if(extractProtocolHeaderFieldsFctPtr == NULL_PTR)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else if(csTransactionHandlePtr == NULL_PTR)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else
...
FUNC(uint8, E2E_CODE) E2EXf_PXXmSourceInPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
    P2VAR(E2EXF_XFRMBUFFERLENGTH_TYPE, AUTOMATIC, E2E_APPL_DATA) BufferLengthPtr,
...
)
{
  ...
  /* Re-use of sender-receiver precondition check */
  if(E2EXf_InPlaceTransPreCondCheck(BufferPtr, BufferLengthPtr,
                      InputBufferLength, PXXConfigPtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else if(extractProtocolHeaderFieldsFctPtr == NULL_PTR)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else
...
FUNC(uint8, E2E_CODE) E2EXf_PXXmSinkInPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2CONST(E2EXf_CSTransactionHandleType,  AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
...
)
{
  ...
  /* Re-use of sender-receiver precondition check */
  if(E2EXf_InPlaceTransPreCondCheck(BufferPtr, BufferLengthPtr, InputBufferLength,
                   PXXConfigPtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else if(E2EXf_MethodPreCondCheck(extractProtocolHeaderFieldsFctPtr,
                   csTransactionHandlePtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else
...
FUNC(uint8, E2E_CODE) E2EXf_PXXmSourceOutOfPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
    P2VAR(E2EXF_XFRMBUFFERLENGTH_TYPE, AUTOMATIC, E2E_APPL_DATA) BufferLengthPtr,
...
)
{
  ...
  /* Re-use of sender-receiver precondition check */
  if(E2EXf_OutOfPlaceTransPreCondCheck(BufferPtr, BufferLengthPtr, InputBufferPtr, InputBufferLength,
             PXXConfigPtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
...
FUNC(uint8, E2E_CODE) E2EXf_PXXmSinkOutOfPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2CONST(E2EXf_CSTransactionHandleType, AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
...
)
{
  ...
  else if(E2EXf_MethodPreCondCheck(extractProtocolHeaderFieldsFctPtr, csTransactionHandlePtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
  else
...
)
{
  ...
  const uint16 OverallHeaderLengthBytes = (PXXConfigPtr->UpperHeaderBitsToShift +
                                            PXXConfigPtr->HeaderLength) / 8U;
...
FUNC(uint8, E2E_CODE) E2EXf_Inv_PXXmSourceInPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
    P2VAR(E2EXF_XFRMBUFFERLENGTH_TYPE, AUTOMATIC, E2E_APPL_DATA) BufferLengthPtr,
...
)
{
  ...
  /* Re-use of sender-receiver precondition check */
  if(E2EXf_Inv_InPlaceTransPreCondCheck(BufferPtr, BufferLengthPtr,
                          InputBufferLength, PXXConfigPtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
...
FUNC(uint8, E2E_CODE) E2EXf_Inv_PXXmSinkInPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2CONST(E2EXf_CSTransactionHandleType, AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
...
)
{
  ...
  /* Re-use of sender-receiver precondition check */
  if(E2EXf_Inv_InPlaceTransPreCondCheck(BufferPtr, BufferLengthPtr, InputBufferLength,
                       PXXConfigPtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
...
FUNC(uint8, E2E_CODE) E2EXf_Inv_PXXmSourceOutOfPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
    P2VAR(E2EXF_XFRMBUFFERLENGTH_TYPE, AUTOMATIC, E2E_APPL_DATA) BufferLengthPtr,
...
)
{
  ...
  /* Re-use of sender-receiver precondition check */
  if(E2EXf_Inv_OutOfPlaceTransPreCondCheck(BufferPtr, BufferLengthPtr, InputBufferPtr, InputBufferLength,
        PXXConfigPtr) != E_OK)
  {
    RetVal = E_SAFETY_HARD_RUNTIMEERROR;
  }
...
FUNC(uint8, E2E_CODE) E2EXf_Inv_PXXmSinkOutOfPlaceTransPreCondCheck
(
    Std_ExtractProtocolHeaderFieldsType extractProtocolHeaderFieldsFctPtr,
    P2CONST(E2EXf_CSTransactionHandleType, AUTOMATIC, E2EXF_APPL_DATA) csTransactionHandlePtr,
    P2VAR(uint8, AUTOMATIC, E2E_APPL_DATA) BufferPtr,
