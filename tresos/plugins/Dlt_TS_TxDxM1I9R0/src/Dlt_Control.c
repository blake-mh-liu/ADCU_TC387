...
FUNC(void, DLT_CODE) Dlt_SetLogLevelRunnableEntity(void)
{
...
#endif
  {
...
#endif
    {
      ...
      if ((ContextIdTable->Flags & DLT_CNTX_LOG_NOTIFY_MASK) != 0U)
      {
#if (DLT_NUM_SWCS_TO_NOTIFY > 0)
        uint32 CallbackIdx;
...
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
#if (DLT_PROTOCOL_VERSION == 2U)
        Dlt_CalculateAppIdLen(&Dlt_BSWMasterContextPtr->CoreContext.AppIdTable[ApplicationIdx].AppId[0U], &length);
        Dlt_FillAppIdInBuffer(&AppId[0U], &Dlt_BSWMasterContextPtr->CoreContext.AppIdTable[ApplicationIdx].AppId[0U],length);

        Dlt_CalculateCtxIdLen(&ContextIdTable->ContextId[0U], &length);
        Dlt_FillCtxIdInBuffer(&ContextId[0U], &ContextIdTable->ContextId[0U], length);
#else
        ...
        AppId = Dlt_BSWMasterContextPtr->CoreContext.AppIdTable[ApplicationIdx].AppId;
        ContextId = ContextIdTable->ContextId;
#else
        ...
        {
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
          (void)Dlt_LogTraceSessionControlCallbacks[CallbackIdx].LogLevelChangedCallback(((const uint8*)(void*)&AppId),
                                                                                         ((const uint8*)(void*)&ContextId),
                                                                                         ContextIdTable->LogLevel);
#elif (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_22_11)
          (void)Dlt_LogTraceSessionControlCallbacks[CallbackIdx].LogLevelChangedCallback(AppId,
                                                                                         ContextId,
                                                                                         ContextIdTable->LogLevel);
#endif
        }
#elif (DLT_NUM_SESSION_IDS > 0)
        /* !LINKSTO Dlt.ASR421.SWS_Dlt_00331,1, Dlt.ASR421.SWS_Dlt_00330,1,
                    Dlt.swdd.DltControl.API.SetLogLevel.InformSWC,1 */
#if (DLT_DEFAULT_ASR_RETVAL >= AUTOSAR_431)
        (void)Dlt_SessionIdTable[ContextIdTable->SessionIdTableIdx].LogLevelCallback(
                Dlt_BSWMasterContextPtr->CoreContext.AppIdTable[ApplicationIdx].AppId,
                ContextIdTable->ContextId,
                ContextIdTable->LogLevel);
#else
        (void)Dlt_SessionIdTable[ContextIdTable->SessionIdTableIdx].LogLevelCallback(
                Dlt_AppIdTable[ApplicationIdx].AppId,
                ContextIdTable->ContextId,
                ContextIdTable->LogLevel);
#endif
#endif /* (DLT_NUM_SWCS_TO_NOTIFY > 0) */
...
FUNC(void, DLT_CODE) Dlt_SetTraceStatusRunnableEntity(void)
{
...
#endif
  {
...
#endif
    {
      ...
      ContextIdTable = &DLT_GET_CONTEXT_TABLE(ApplicationIdx, ContextIdx);
      Dlt_BSWMasterContextPtr->ExitExclusiveArea();
      if ((ContextIdTable->Flags & DLT_CNTX_TRACE_NOTIFY_MASK) != 0U)
      {
#if (DLT_NUM_SWCS_TO_NOTIFY > 0)
        uint32 CallbackIdx;
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
        ...
        {
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
          (void)Dlt_LogTraceSessionControlCallbacks[CallbackIdx].TraceStatusChangedCallback(((const uint8*)(void*)&AppId),
                                                                                            ((const uint8*)(void*)&ContextId),
                                                                                            (boolean)ContextIdTable->TraceStatus);
#elif (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_22_11)
          (void)Dlt_LogTraceSessionControlCallbacks[CallbackIdx].TraceStatusChangedCallback(AppId,
                                                                                            ContextId,
                                                                                            (boolean)ContextIdTable->TraceStatus);
#endif
        }
#elif (DLT_NUM_SESSION_IDS > 0)
        /* !LINKSTO Dlt.ASR421.SWS_Dlt_00331,1, Dlt.ASR421.SWS_Dlt_00330,1, Dlt.SWS_Dlt_00283,1,
        ...
        (void)Dlt_SessionIdTable[ContextIdTable->SessionIdTableIdx].LogLevelCallback(
                ...
                (boolean)ContextIdTable->TraceStatus);
#else
        (void)Dlt_SessionIdTable[ContextIdTable->SessionIdTableIdx].TraceStatusCallback(
                Dlt_AppIdTable[ApplicationIdx].AppId,
                ContextIdTable->ContextId,
                (boolean)ContextIdTable->TraceStatus);
#endif
...
FUNC(void, DLT_CODE) Dlt_SetVerboseModeRunnableEntity(void)
{
  ...
  for (ApplicationIdx = 0U; ApplicationIdx < Dlt_MaxRegisteredAppldTableEntry; ApplicationIdx++)
  {
    ...
    for (ContextIdx = 0U; ContextIdx < Dlt_AppToContextIdTableIdx[ApplicationIdx]; ContextIdx++)
    {
      ...
      if ((ContextIdTable->Flags & DLT_CNTX_VERBOSE_NOTIFY_MASK) != 0U)
      {
        /* !LINKSTO Dlt.DltControl.API.SetVerboseMode.InformSWC,1,
                    Dlt.ASR421.SWS_Dlt_00258,1 */
        (void)Dlt_SessionIdTable[ContextIdTable->SessionIdTableIdx].VerboseModeCallback(
                Dlt_AppIdTable[ApplicationIdx].AppId,
                ContextIdTable->ContextId,
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
      if( (Dlt_CheckIfAppIdIsNull(appId_Internal) == FALSE) && (Dlt_CheckIfCtxIdIsNull(contextId_Internal) == FALSE) )
#else
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
      else if( ((Dlt_CheckIfAppIdIsNull(appId_Internal) == TRUE) && (Dlt_CheckIfCtxIdIsNull(contextId_Internal) == TRUE)) ||
               ((Dlt_CheckIfAppIdIsNull(appId_Internal) == TRUE) && (Dlt_CheckIfCtxIdIsNull(contextId_Internal) == FALSE)) )
#else
  ...
  P2VAR(uint8, AUTOMATIC, DLT_APPL_DATA) logInfo)
{
  ...
  /* !LINKSTO Dlt.GetLogInfo.ContextID_NULL, 1 */
    ...
    if ((Dlt_GetContextEntry(SessionID, AppID, ContextID, &ContextIdTable) == E_OK) ||
        ((Dlt_CheckIfAppIdIsNull(AppID) == TRUE) ||
        (Dlt_CheckIfCtxIdIsNull(ContextID) == TRUE)))
    /* CHECK: PARSE */
#else
    if ((Dlt_GetContextEntry(SessionID, AppID, ContextID, &ContextIdTable) == E_OK) ||
        ((AppID == DLT_APP_ID_NULL) ||
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
        if ((Dlt_CheckIfAppIdIsNull(AppId_Internal) == TRUE) && (Dlt_CheckIfCtxIdIsNull(ContextId_Internal) == TRUE))
#else
        if ((AppId_Internal == DLT_APP_ID_NULL) && (ContextId_Internal == DLT_CTX_ID_NULL))
#endif
        {
...
FUNC(Dlt_CtrlReturnType, DLT_CODE) Dlt_SetGlobalLogging(Dlt_GlobalLogStatusType logStatus)
{
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    if (Dlt_InitStateMaster != DLT_UNINITIALIZED)
    {
      /* !LINKSTO Dlt.swdd.DltControl.API.SetGlobalLogging,1,
                  ...
                  Dlt.EB_Ref.PRS_Dlt_00650.MatchedCurrentConfiguration,1*/
...
#endif
{
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    {
      Dlt_BSWMasterContextPtr->ExitExclusiveArea();
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_DEV_ERROR_DETECT == STD_ON))
...
#endif
      {
            ...
            (NewStatus == DLT_VERBOSE_MODE_OFF))
        {
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
          if (Dlt_CheckIfAppIdIsNull(AppId_Internal) == TRUE)
#else
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
          else if (Dlt_CheckIfCtxIdIsNull(ContextId_Internal) == TRUE)
#else
          ...
          if (VerboseModeChanged == TRUE)
          {
            ...
            {
              (void)Rte_IrTrigger_Dlt_RE_SetVerboseMode_Notify_SetVerboseModeTriggeringPoint();
            }
#endif
          }
        }
...
FUNC(void, DLT_CODE) Dlt_ReturnLogChannelName
(
...
FUNC(Dlt_CtrlReturnType, DLT_CODE) Dlt_SetComInterfaceMaxBandwidth(uint32 max_bandwidth)
{
...
FUNC(Std_ReturnType, DLT_CODE) Dlt_ASR43_SetMessageFiltering(boolean status)
{
  ...
  retValASR42 = Dlt_ASR42_SetMessageFiltering((Dlt_FilterMessagesType)status);
...
FUNC(Std_ReturnType, DLT_CODE) Dlt_ASR43_SetDefaultTraceStatus(boolean newTraceStatus)
{
  ...
  if (Dlt_ASR42_SetDefaultTraceStatus((Dlt_MessageTraceStatusType)newTraceStatus) == DLT_CTRL_OK)
  {
    /* !LINKSTO Dlt.SWS_Dlt_00744, 1 */
    retVal = E_OK;
  }
  else
  {
    /* !LINKSTO Dlt.SWS_Dlt_00745,1 */
    retVal = E_NOT_OK;
  }
...
/* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00752.Signature,1 */
...
)
{
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    if (Dlt_InitStateMaster != DLT_UNINITIALIZED)
    {
      ...
      /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00724.ControlError,1 */
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    if (Dlt_SetLogLevelLock == FALSE)
    {
      ...
      if (Dlt_InitStateMaster != DLT_UNINITIALIZED)
      {
        Dlt_BSWMasterContextPtr->ExitExclusiveArea();
        /* the log level is in range */
        /* !LINKSTO Dlt.SWS_Dlt_00656,1, Dlt.SWS_Dlt_00657,1,
             ...
             (NewLevel <= DLT_LOG_VERBOSE) )
        {
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
          if (Dlt_CheckIfAppIdIsNull(AppId) == TRUE)
#else
          ...
          {
        /* !LINKSTO Dlt.ASR421.SWS_Dlt_00069,1, Dlt.ASR421.SWS_Dlt_00057,1, Dlt.DltControl.API.SetLogLevel.SetNewLevel, 1 */
            retVal = Dlt_SetLogLevelInternal(AppId, ContextId, NewLevel, &LogLevelChanged);
#if (DLT_NUM_SWCS_TO_NOTIFY > 0) || (DLT_NUM_SESSION_IDS > 0)
            if (retVal != DLT_CTRL_ERROR)
            {
              needsNotification = TRUE;
            }
#endif /* (DLT_NUM_SWCS_TO_NOTIFY > 0) || (DLT_NUM_SESSION_IDS > 0) */
          ...
          if (LogLevelChanged == TRUE)
          {
            ...
            if (needsNotification == TRUE)
            {
              ...
              (void)Rte_IrTrigger_Dlt_RE_SetLogLevel_Notify_SetLogLevelTriggeringPoint();
            }
#endif /* (DLT_NUM_SWCS_TO_NOTIFY > 0) || (DLT_NUM_SESSION_IDS > 0) */
          }
        }
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    if(Dlt_SetTraceStatusLock == FALSE)
    {
      ...
      /* !LINKSTO Dlt.DltControl.API.SetTraceStatus.ApplicationID.OnMasterCore, 1,
            ...
            if (needsNotification == TRUE)
            {
              (void)Rte_IrTrigger_Dlt_RE_SetTraceStatus_Notify_SetTraceStatusTriggeringPoint();
            }
#endif /* (DLT_NUM_SWCS_TO_NOTIFY > 0) || (DLT_NUM_SESSION_IDS > 0) */
          }
        }
...
FUNC(void, DLT_CODE) Dlt_FindChannelIdEntry
(
...
)
{
  ...
  for (chnIndex = 0U; chnIndex < DLT_TXPDU_NO; chnIndex++ )
  {
    ...
    while (LocalDataLength > 0U)
    {
      if ((LogChannelId)[ptrOffset] != *(&Dlt_CfgLogChannel[chnIndex].DltLogChannelId[localChannelIndex]))
      {
        break;
      }
      else
  ...
  P2VAR(boolean, AUTOMATIC, DLT_APPL_DATA) traceStatus)
{
...
#endif /* DLT_DEV_ERROR_DETECT == STD_ON */
  {
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
    {
      ...
      if ( (defaultTraceStatus == DLT_TRACE_STATUS_ON) || (defaultTraceStatus == DLT_TRACE_STATUS_OFF) )
      {
        /* !LINKSTO Dlt.SWS_Dlt_00747, 1 */
        retVal = E_OK;
        /* !LINKSTO Dlt.DltControl.API.GetDefaultTraceStatus.ReturnValue,1 */
        *traceStatus = (boolean)defaultTraceStatus;
      }
    }
#if (DLT_ENABLE_BSW_DISTRIBUTION == STD_ON)
    else
    {
      /* !LINKSTO Dlt.SWS_Dlt_00748, 1 */
      retVal = E_NOT_OK;
...
/* !LINKSTO Dlt.EB_Ref.ASR431.SWS_Dlt_00749.logChannelNames,1 */
/* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00749.logChannelNames,1 */
  ...
  P2VAR(uint8, AUTOMATIC, DLT_APPL_DATA) logChannelNames)
{
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    if(Dlt_GetLogChannelNamesLock == FALSE)
    {
      ...
      {
        Dlt_BSWMasterContextPtr->ExitExclusiveArea();
        /* !LINKSTO Dlt.SWS_Dlt_00718,1 */
        /* number of configured log channels */
        /* Deviation TASKING-2 */
        if((numberOfLogChannels != NULL_PTR) && (logChannelNames != NULL_PTR))
        {
#if (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431)
          uint8 NumberOfChannels = DLT_TXPDU_NO;
#elif (DLT_DEFAULT_ASR_RETVAL >= AUTOSAR_20_11)
          uint8 NumberOfChannels = *numberOfLogChannels;
          if(*numberOfLogChannels <= DLT_TXPDU_NO)
#endif
          {
            uint8 LogChannelIndex = 0U;

            for (chnIdx = 0; chnIdx < NumberOfChannels; chnIdx++)
            {
              /* copy data into the buffer */
              Dlt_ReturnLogChannelName(&logChannelNames[LogChannelIndex], chnIdx);
              LogChannelIndex += DLT_CHANNEL_NAME_SIZE;
            }
            *numberOfLogChannels = DLT_TXPDU_NO;
            retVal = E_OK;
          }
#if ((DLT_DEFAULT_ASR_RETVAL >= AUTOSAR_20_11) && (DLT_DEV_ERROR_DETECT == STD_ON))
          else
          {
            /* !LINKSTO Dlt.EB.DetOn.GetLogChannelNames.InvalidNumberOfLogChannels,1 */
            DLT_DET_REPORT_ERROR(DLT_SID_GetLogChannelNames, DLT_E_WRONG_PARAMETERS);
          }
#endif
        }
#if (DLT_DEV_ERROR_DETECT == STD_ON)
...
/* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00753.Signature,1 */
...
#endif /* DLT_ENABLE_BSW_DISTRIBUTION == STD_ON */
  {
    ...
    if (Dlt_InitStateMaster != DLT_UNINITIALIZED)
    {
      ...
      if ((logChannelThreshold != NULL_PTR) && (traceStatus != NULL_PTR) && (logChannelName != NULL_PTR))
      {
        ...
        /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00726.ControlError,1 */
        if(ChannelIdx != DLT_TXPDU_NO)
        {
          Dlt_BSWMasterContextPtr->EnterExclusiveArea();
          /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00726.ControlError, 1,
                      Dlt.GetLogChannelThreshold.RetVal, 1 */
          /* check if the channel threshold is valid */
...
/* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00751.Signature,1 */
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
    ...
    if (Dlt_SetLogChannelAssignmentLock == FALSE)
    {
      ...
      if (Dlt_InitStateMaster != DLT_UNINITIALIZED)
      {
...
#endif
        {
          ...
          /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00722.ControlError,1, Dlt.EB_Ref.SWS_Dlt_00751.Signature.InvalidChannel,1 */
          Dlt_FindChannelIdEntry( &ChannelIdx, logChannelName);
          /* channel id is a valid one */
          /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00722.ControlError,1 */
          if (ChannelIdx != DLT_TXPDU_NO)
          {
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
#if (DLT_PROTOCOL_VERSION == 2U)
...
#endif
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
            if (Dlt_CheckIfAppIdIsNull(appId_Internal) == FALSE)
#else
            if (appId_Internal != DLT_APP_ID_NULL)
#endif
            {
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
              if (Dlt_CheckIfCtxIdIsNull(contextId_Internal) == FALSE)
#else
              ...
              if (ApplicationIdx != MaxRegisteredAppld)
              {
                for (ContextIdx = 0U; ContextIdx < MaxRegisteredAppld; ContextIdx++)
                {
                  ...
                  if (Dlt_CheckForRegisteredContext(contextId_Internal, ApplicationIdx, &CtIdx, &ApplToCtxIdx) == TRUE)
                  {
                    ...
                    {
                      /* !LINKSTO Dlt.SWS_Dlt_00721,1 */
                      /* Assign channel to all contexts of the found app */
                      LocalContextIdTable->ChannelsIdx[ChannelIdx] = FALSE;
                    }
                    else
                    {
                      /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00751.Signature.InvalidAddRemoveOp,1 */
...
{
  /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00729.StoreConfig, 1 */
  Std_ReturnType retVal = E_NOT_OK;

  DBG_DLT_STORECONFIGURATION_ENTRY();

#if (DLT_IMPLEMENT_NV_RAM_STORAGE == STD_OFF)
  /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00737.ImplementNVRamStorage, 1 */
...
#endif /* DLT_DEV_ERROR_DETECT != STD_ON */
      {
        /* !LINKSTO Dlt.EB_Ref.SWS_Dlt_00738.NvRamStorage, 1 */
    ...
    P2VAR(uint8, AUTOMATIC, DLT_APPL_DATA) logInfo)
{
     ...
     ((DLT_GETLOGINFO_OPTIONS_WITH_DESC == options) && (DLT_VERBOSE_MODE_ON == Dlt_LocalHeaderUseVerboseMode) ) )
  {
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
      TS_MemCpy(contextId, NullContextId, DLT_CTXID_LENGTH);
#else
      contextId = DLT_CTX_ID_NULL;
#endif
    ...
    else /* appId != DLT_APP_ID_NULL */
    {
      ...
      DLT_FILL_BUFFER_16_MSB(logInfo, LogInfoIdx, NoOfAppIds);
      LogInfoIdx += DLT_GETLOGINFO_UINT16_OFFSET;
    }
...
#if ((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11))
#if (DLT_PROTOCOL_VERSION == 2U)
        TS_MemCpy(&logInfo[LogInfoIdx], &Dlt_BSWMasterContextPtr->CoreContext.AppIdTable[AppIdIterator].AppId[0U], DLT_APPID_LENGTH);
#else
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
          /* CHECK: NOPARSE */
          if (Dlt_CheckIfCtxIdIsNull(contextId) == FALSE)
          /* CHECK: PARSE */
#else
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
            /* CHECK: NOPARSE */
            if (Dlt_CompareAppOrCtxId(&LocalContextIdTable->ContextId[0], contextId, DLT_CTXID_LENGTH) == TRUE)
            /* CHECK: PARSE */
#else
            if (LocalContextIdTable->ContextId == contextId)
#endif
            {
              uint16 NoOfContextIds = 1U;
              const uint32 NoOfCtxIdx = LogInfoIdx - DLT_GETLOGINFO_UINT16_OFFSET;
              /* Get the number of ContextIds of the current AppId. In this case it's always 1 */
              DLT_FILL_BUFFER_16_MSB(logInfo, NoOfCtxIdx, NoOfContextIds);
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
    /* CHECK: NOPARSE */
    if ((Dlt_CheckIfAppIdIsNull(appId) == TRUE) || (Dlt_CheckIfCtxIdIsNull(contextId) == TRUE))
    /* CHECK: PARSE */
#else
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
  /* CHECK: NOPARSE */
  TS_MemCpy(&logInfo[*LogInfoIdx], &ContextIdTable->ContextId[0U], DLT_CTXID_LENGTH);
  /* CHECK: PARSE */
#else
...
#if (((DLT_DEFAULT_ASR_RETVAL == AUTOSAR_431) || (DLT_DEFAULT_ASR_RETVAL == AUTOSAR_20_11)) && (DLT_PROTOCOL_VERSION == 2U))
  if (Dlt_CheckIfCtxIdIsNull(ContextId) == TRUE)
#else
  if (ContextId == DLT_CTX_ID_NULL)
#endif
  {
      ...
      if (ApplicationIdx != MaxRegisteredAppld)
      {
        ...
        for (ContextIdx = 0U; ContextIdx < Dlt_LocalAppToContextIdTableIdx; ContextIdx++)
        {
          ...
          if (Dlt_CheckForRegisteredContext(ContextId, ApplicationIdx, &CtIdx, &ApplToCtxIdx) == TRUE)
          {
            ...
            /* !LINKSTO Dlt.ASR421.SWS_Dlt_00069,1, Dlt.ASR421.SWS_Dlt_00057,1 */
      ...
      if (ApplicationIdx != MaxRegisteredAppld)
      {
        ...
        for (ContextIdx = 0U; ContextIdx < Dlt_LocalAppToContextIdTableIdx; ContextIdx++)
        {
          ...
          if (Dlt_CheckForRegisteredContext(ContextId, ApplicationIdx, &CtIdx, &ApplToCtxIdx) == TRUE)
          {
            ...
            /* !LINKSTO Dlt.ASR421.SWS_Dlt_00071,1,
    ...
    P2VAR(boolean, AUTOMATIC, DLT_APPL_DATA) needsNotification)
{
  ...
  /* !LINKSTO Dlt.EB_Ref.PRS_Dlt_00650.MatchedCurrentConfiguration,1 */
