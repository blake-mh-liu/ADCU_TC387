...
#if ((DLT_INCLUDE_RTE == STD_ON) || (DLT_ENABLE_BSW_DISTRIBUTION == STD_ON))
#include <Rte_Type.h>
#endif
...
/* !LINKSTO Dlt.EB_Ref.ASR421.SWS_Dlt_00238.ReturnValues,1 */
...
/* !LINKSTO Dlt.SWS_Dlt_00730,1 */
#if (DLT_DEFAULT_ASR_RETVAL >= AUTOSAR_431)
/** \brief This macro is used to add a channel assignment to a registered context */
#define DLT_ASSIGN_ADD  0x01U
/** \brief This macro is used to remove a channel assignment to a registered context */
#define DLT_ASSIGN_REMOVE  0x02U
/** \brief This macro is used to throw a not supported error in case the Service is not supported */
#define DLT_E_NOT_SUPPORTED  0x07U
#endif
/* Values of Dlt_MessageLogLevelType */
/* !LINKSTO Dlt.SWS_Dlt_00230,1, Dlt.PRS_Dlt_00619,1*/
#ifndef DLT_LOG_OFF
...
/* !LINKSTO Dlt.SWS_Dlt_00231,1, Dlt.PRS_Dlt_00620,1*/
...
/* !LINKSTO Dlt.SWS_Dlt_00225,1 */
/* !LINKSTO Dlt.ASR421.SWS_Dlt_00322,1 */
...
typedef uint8 Dlt_Internal_ApplicationIDType[DLT_APPID_LENGTH];
/** \brief Internal representation of Dlt_ContextIDType */
typedef uint8 Dlt_Internal_ContextIDType[DLT_CTXID_LENGTH];
#else
/** \brief Internal representation of Dlt_ApplicationIDType */
...
#ifndef RTE_TYPE_Dlt_MessageAttributesType
/* !LINKSTO Dlt.SWS_Dlt_91010,1 */
typedef struct
{
  boolean withPrivacyLevel;
  uint8   privacyLevel;
...
typedef uint8 Dlt_ApplicationIDType[DLT_APPID_LENGTH];
#else
/* !LINKSTO Dlt.ASR431.SWS_Dlt_00226, 1 */
typedef uint8 Dlt_ApplicationIDType[4U];
#endif
#else
/* !LINKSTO Dlt.SWS_Dlt_00226,1 */
...
/* !LINKSTO Dlt.ASR421.SWS_Dlt_00229, 1, Dlt.SWS_Dlt_00229, 1 */
/** \brief Bitfield */
...
/* !LINKSTO Dlt.ASR421.SWS_Dlt_00237,1 */
/* Violation of [BSWM_C_005]
 * Description:  Members of structs SHALL be sorted in descending alignment requirement order.
 * Rationale:    This is an exported data type, and the order is defined in SWS.
 */
