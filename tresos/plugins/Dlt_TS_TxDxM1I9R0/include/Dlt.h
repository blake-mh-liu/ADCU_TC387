 ...
 *
 *    Reason:
 *    The function declaration is generated in SchM_Dlt.h and is protected for re-declaration
...
#define Dlt_SendLogMessage                  Dlt_SendLogMessageV2Wrapper
#define Dlt_SendTraceMessage                Dlt_SendTraceMessageV2Wrapper
#else
...
#define Dlt_SendLogMessageWithAttributes    Dlt_SendLogMessageWithAttributesWrapper
#define Dlt_SendTraceMessageWithAttributes  Dlt_SendTraceMessageWithAttributesWrapper
#endif
...
#endif
/** \brief Service Id for Dlt_GetDefaultTraceStatus() */
...
#if (defined DLT_SID_MainFunction)
#error DLT_SID_MainFunction already defined
#endif
/** \brief Service Id for Dlt_MainFunction() */
#define DLT_SID_MainFunction                                      0x0U

#if (defined DLT_SID_GetRemainingBufferSize)
#error DLT_SID_GetRemainingBufferSize already defined
#endif
/** \brief Service Id for Dlt_GetRemainingBufferSize() */
#define DLT_SID_GetRemainingBufferSize                            0xFFU
...
#endif
/** \brief Service Id for Dlt_SetDefaultTraceStatus() */
...
#endif
/** \brief Service Id for Dlt_SetMessageFiltering() */
...
#if (defined DLT_E_RECEIVED_MSG_INCOMPLETE)
#error DLT_E_RECEIVED_MSG_INCOMPLETE already defined
#endif
/** \brief Runtime error for an incomplete received message */
#define DLT_E_RECEIVED_MSG_INCOMPLETE                             0x0CU
...
#ifndef RTE_SCHM_SWCBSW_DLT_MAINFUNCTION
#define RTE_SCHM_SWCBSW_DLT_MAINFUNCTION
