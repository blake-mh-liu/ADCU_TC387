...
#define DLT_START_SEC_CODE_APPL
...
/** \brief Function prototype for the user callout notification when the buffer ocupation
 ** threshold is reached.
 ** */
extern FUNC(Std_ReturnType, DLT_APPL_CODE) NotifyUserCalloutThresholdReached(P2CONST(uint8, AUTOMATIC, DLT_APPL_DATA) logChannelName);
[!ENDIF!]

#define DLT_STOP_SEC_CODE_APPL
#include <Dlt_MemMap.h>
