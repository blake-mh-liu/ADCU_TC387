 ...
 * \param[out] MetaDataItemPtr   pointer to the requested meta data item
 *
 * \return Result of operation
...
(
  ...
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint8, AUTOMATIC, ECUC_APPL_DATA) MetaDataItemPtr
);
...
(
  ...
  EcuC_MetaDataItemIdType MetaDataItemId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint16, AUTOMATIC, ECUC_APPL_DATA) MetaDataItemPtr
);
...
(
  ...
  EcuC_MetaDataItemIdType MetaDataItemId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint32, AUTOMATIC, ECUC_APPL_DATA) MetaDataItemPtr
);
...
)
{
  ...
  {
    ECUC_REPORT_ERROR(ECUC_SID_ECUC_SETMETADATAETHMAC, ECUC_E_PARAM_POINTER);
  }
  else
#endif /* (ECUC_DEV_ERROR_DETECT == STD_ON) */
  {
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint8, AUTOMATIC, ECUC_APPL_DATA) AddrExtensionPtr
)
{
  Std_ReturnType retval = E_NOT_OK;

#if (ECUC_DEV_ERROR_DETECT == STD_ON)
  if(AddrExtensionPtr == NULL_PTR)
  {
  ...
  {
    retval =
      EcuC_GetMetaDataUint8(PduId, ECUC_METADATA_ITEM_ADDRESS_EXTENSION_8, PduInfoPtr, AddrExtensionPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint32, AUTOMATIC, ECUC_APPL_DATA) CanIdPtr
)
{
  Std_ReturnType retval = E_NOT_OK;
...
#endif /* (ECUC_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    retval = EcuC_GetMetaDataUint32(PduId, ECUC_METADATA_ITEM_CAN_ID_32, PduInfoPtr, CanIdPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint8, AUTOMATIC, ECUC_APPL_DATA) LinNadPtr
)
{
  Std_ReturnType retval = E_NOT_OK;

#if (ECUC_DEV_ERROR_DETECT == STD_ON)
  if(LinNadPtr == NULL_PTR)
  {
...
#endif /* (ECUC_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    retval = EcuC_GetMetaDataUint8(PduId, ECUC_METADATA_ITEM_LIN_NAD_8, PduInfoPtr, LinNadPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint8, AUTOMATIC, ECUC_APPL_DATA) PriorityPtr
)
{
  Std_ReturnType retval = E_NOT_OK;

#if (ECUC_DEV_ERROR_DETECT == STD_ON)
  if(PriorityPtr == NULL_PTR)
  {
...
#endif /* (ECUC_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    retval = EcuC_GetMetaDataUint8(PduId, ECUC_METADATA_ITEM_PRIORITY_8, PduInfoPtr, PriorityPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint16, AUTOMATIC, ECUC_APPL_DATA) SoConIdPtr
)
{
  Std_ReturnType retval = E_NOT_OK;
  ...
  {
    retval =
      EcuC_GetMetaDataUint16(PduId, ECUC_METADATA_ITEM_SOCKET_CONNECTION_ID_16, PduInfoPtr, SoConIdPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint16, AUTOMATIC, ECUC_APPL_DATA) SrcAddrPtr
)
{
  Std_ReturnType retval = E_NOT_OK;
  ...
  {
    retval =
      EcuC_GetMetaDataUint16(PduId, ECUC_METADATA_ITEM_SOURCE_ADDRESS_16, PduInfoPtr, SrcAddrPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint16, AUTOMATIC, ECUC_APPL_DATA) TargetAddrPtr
)
{
  Std_ReturnType retval = E_NOT_OK;

#if (ECUC_DEV_ERROR_DETECT == STD_ON)
  if(TargetAddrPtr == NULL_PTR)
  {
...
#endif /* (ECUC_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    retval =
      EcuC_GetMetaDataUint16(PduId, ECUC_METADATA_ITEM_TARGET_ADDRESS_16, PduInfoPtr, TargetAddrPtr);
...
(
  EcuC_PduIdType PduId,
  P2CONST(PduInfoType, AUTOMATIC, ECUC_APPL_DATA) PduInfoPtr,
  P2VAR(uint16, AUTOMATIC, ECUC_APPL_DATA) PldTypePtr
)
{
  Std_ReturnType retval = E_NOT_OK;

#if (ECUC_DEV_ERROR_DETECT == STD_ON)
  if(PldTypePtr == NULL_PTR)
  {
...
#endif /* (ECUC_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    retval =
      EcuC_GetMetaDataUint16(PduId, ECUC_METADATA_ITEM_PAYLOAD_TYPE_16, PduInfoPtr, PldTypePtr);
...
)
{
  ...
  if(PduId < EcuC_ConfigData.numConfigPdus)
  {
    ...
    for ( i=dataOffset; i<(dataOffset + dataListNum); i++ )
    {
      ...
      {
        *MetaDataItemPtr = *EcuC_ConfigData.metaDataItemConfig[i].metaDataItem.metaDataItemOffsetPtr;
        retval = E_OK;
        break;
      }
    }
  ...
  if(PduId < EcuC_ConfigData.numConfigPdus)
  {
    ...
    for ( i=dataOffset; i<(dataOffset + dataListNum); i++ )
    {
      if(MetaDataItemId == EcuC_ConfigData.metaDataItemConfig[i].metaDataItemId)
      {
        ...
        *MetaDataItemPtr =
          COMSTACK_GET16(EcuC_ConfigData.metaDataItemConfig[i].metaDataItem.metaDataItemOffsetPtr, 0U);
        retval = E_OK;
        break;
      }
    }
...
)
{
  ...
  if(PduId < EcuC_ConfigData.numConfigPdus)
  {
    ...
    for ( i=dataOffset; i<(dataOffset + dataListNum); i++ )
    {
      ...
      {
        *MetaDataItemPtr =
          COMSTACK_GET32(EcuC_ConfigData.metaDataItemConfig[i].metaDataItem.metaDataItemOffsetPtr, 0U);
        retval = E_OK;
        break;
      }
    }
