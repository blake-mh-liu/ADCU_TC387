 ...
 * \param[in]   PduId             ID of the PDU
 * \param[out]  PduInfoPtr        pointer to the PDU info (unused)
 * \param[out]  AddrExtensionPtr  pointer to stored address extension field
 *
 * \return Result of operation
 ...
 * \param[in]  PduId           ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  CanIdPtr       pointer to stored CAN ID according to ISO 11898-2
 *
 * \return Result of operation
 ...
 * \param[in]  PduId           ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  LinNadPtr      LIN node address as used in the LIN transport protocol
 *
 * \return Result of operation
 ...
 * \param[in]  PduId           ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  PriorityPtr    Priority field of SAE J1939 IDs
 *
 * \return Result of operation
 ...
 * \param[in]   PduId          ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  SoConIdPtr     SoAd socket connection ID
 *
 * \return Result of operation
 ...
 * \param[in]  PduId           ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  SrcAddrPtr     Source address of CanTp, FrTp, or DoIP transport
 *                             protocol messages, or of SAE J1939 messages
 *
 * \return Result of operation
 ...
 * \param[in]   PduId           ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  TargetAddrPtr  Target address of CanTp, FrTp, or DoIP transport
 *                             protocol messages, or destination address of SAE
 *                             J1939 messages
 *
 * \return Result of operation
 ...
 * \param[in]   PduId          ID of the PDU
 * \param[out]  PduInfoPtr     pointer to the PDU info (unused)
 * \param[out]  PldTypePtr     payload type
 *
 * \return Result of operation
