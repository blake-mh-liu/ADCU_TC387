...
/**
 *
 * \brief Mask used to shift a parameter with 4 bits, used especially to extract the high nibble.
 *
 */
...
/**
 *
 * \brief Mask used to shift a parameter with 8 bits.
 *
 */
 ...
 *        the modeOfOperation parameter when equal to 0x02 (DeleteFile).
 *
 */
 ...
 *
 * \brief Macro used for FileTransfer service which represents
 *        the modeOfOperation parameter when equal to 0x05 (ReadDir).
 *
 */
 ...
 *        the sub-function parameter when equal to 0x01 (readExtendedTimingParameterSet).
 *
 */
 ...
 *
 * \brief Macro used for AccessTimingParameter service which represents
 *        the sub-function parameter when equal to 0x03 (readCurrentlyActiveTimingParameters).
 *
 */
 ...
 *        the sub-function parameter when equal to 0x01 (defineByIdentifier).
 *
 */
#if (defined DCCM_DEFINE_BY_IDENTIFIER)
  #error DCCM_DEFINE_BY_IDENTIFIER is already defined
#endif
#define DCCM_DEFINE_BY_IDENTIFIER 0x01U

/**
 *
 * \brief Macro used for DynamicallyDefineDataIdentifier service which represents
 *        the sub-function parameter when equal to 0x02 (defineByMemoryAddress).
 *
 */
 ...
 *
 * \brief Macro used for DynamicallyDefineDataIdentifier service which represents
 *        the sub-function parameter when equal to 0x03 (clearDynamicallyDefinedDataIdentifier).
 *
 */
...
/**
 *
 * \brief Macro which represents the sub-function parameter when equal to 0x00.
 *
 */
 ...
 *        the sub-function parameter when equal to 0x04 (enableRapidPowerShutDown).
 *
 */
 ...
 *
 * \brief Macro used for ReadDTCInformation service which represents
 *        the DTCFormatIdentifier parameter when equal to 0x2 (SAE_J1939-73_DTCFormat).
 *
 */
 ...
 *
 * \brief Macro used for ReadDTCInformation service which represents
 *        the DTCFormatIdentifier parameter when equal to 0x4 (SAE_J2012-DA_DTCFormat_04).
 *
 */
...
/**
 *
 * \brief Service ID for security access request.
 *
 */
...
/**
 *
 * \brief Service ID for access timing parameter request.
 *
 */
...
/**
 *
 * \brief Service ID for input output control by identifier request.
 *
 */
...
/**
 *
 * \brief Service ID for a negative response message.
 *
 */
...
/**
 *
 * \brief Service ID for security access response.
 *
 */
...
/**
 *
 * \brief Service ID for access timing response.
 *
 */
...
/**
 *
 * \brief Service ID for read data by identifier response.
 *
 */
...
/**
 *
 * \brief Service ID for read scaling data by identifier response.
 *
 */
...
/**
 *
 * \brief Service ID for read data by periodic identifier response.
 *
 */
...
/**
 *
 * \brief Service ID for dynamically define data identifier response.
 *
 */
...
/**
 *
 * \brief Service ID for write data by identifier response.
 *
 */
...
/**
 *
 * \brief Service ID for input output control by identifier response.
 *
 */
