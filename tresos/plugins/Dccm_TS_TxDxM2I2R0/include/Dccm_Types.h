...
/**
 *
 * \brief Diagnostic Protocol Callback type to notify the software component (SWC).
 *
 * \param[in]  ProtocolId The diagnostic protocol for which the notification
 *       is sent to the SWC.
 * \param[in]  ResponseCode The status of the request.
 */
