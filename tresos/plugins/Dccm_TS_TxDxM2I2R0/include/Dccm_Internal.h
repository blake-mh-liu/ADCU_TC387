...
#if (defined DCCM_E_PHYSICAL_ADDRESSING)
  #error DCCM_E_PHYSICAL_ADDRESSING is already defined
#endif
#define DCCM_E_PHYSICAL_ADDRESSING              0x11U
...
/**
 *
 * \brief Service Id for WriteDataByIdentifier.
 *
 */
...
/**
 *
 * \brief Service Id for RoutineControl.
 *
 */
...
/**
 *
 * \brief Service Id for TesterPresent.
 *
 */
...
/**
 *
 * \brief Service Id for DiagnosticSessionControl.
 *
 */
...
/**
 *
 * \brief Service Id for SecurityAccess.
 *
 */
...
/**
 *
 * \brief Service Id for CommunicationControl.
 *
 */
...
/**
 *
 * \brief Service Id for ControlDTCSetting.
 *
 */
...
/**
 *
 * \brief Service Id for ResponseOnEvent.
 *
 */
...
/**
 *
 * \brief Service Id for LinkControl.
 *
 */
...
/**
 *
 * \brief Service Id for DynamicallyDefineDataIdentifier.
 *
 */
...
/**
 *
 * \brief Service Id for ReadDTCInformation.
 *
 */
 ...
 *
 * \var Dccm_TesterPresent::TesterPresentInterval
 * \brief The periodicity of the TesterPresent message (in milliseconds).
 *
 * \var Dccm_TesterPresent::TesterPresentIntervalCounter
...
typedef struct
{
  ...
  Dccm_TimeoutType TesterPresentInterval;
  Dccm_TimeoutType TesterPresentIntervalCounter;
 ...
 *
 * Structure to save data related with the request message.
 *
 * \var Dccm_RequestInfoType::ServiceID
 * \brief This member holds the ID of the service for which the request is made.
 *
 * \var Dccm_RequestInfoType::SuppressPosRsp
 * \brief This member holds the value of the
 * SuppressPosRspMsgIndicationBit (SPRMIB) from the request.
 *
 * \var Dccm_RequestInfoType::isServiceIDsaved
 * \brief The significance of values:
 * TRUE - the SID from the request was saved in the member ServiceID.
 * FALSE - the SID from the request was not saved in the member ServiceID.
 *
 * \var Dccm_RequestInfoType::isSuppressPosRspSaved
 * \brief The value of the SuppressPosRspMsgIndicationBit (SPRMIB) from the
 * request was saved or not in the member SuppressPosRsp.
 * TRUE - the value of the SuppressPosRspMsgIndicationBit (SPRMIB) was saved.
 * FALSE - the value of the SuppressPosRspMsgIndicationBit (SPRMIB) was not saved.
 */
typedef struct
{
  uint8 ServiceID;
 ...
 *//**
 * \var Dccm_DiagnosticProtocolType::PduRTxPduId
 * \brief This variable contains the unique identifier of the TX connection
 * that must be used when Dccm calls PduR_DccmTransmit().
 *//**
 ...
 * \brief Variable used to mark a request.
 ...
 *//**
* \var Dccm_DiagnosticProtocolType::PreparedToReceiveFunctionalResponse
 * \brief The current communication protocol was prepared or not to receive a
 * "functional response".
 * TRUE: the protocol was prepared to receive a "functional response".
 * FALSE: the protocol was not prepared to receive a "functional response".
 *//**
* \var Dccm_DiagnosticProtocolType::ResponsePendingWasReceived
 * \brief ResponsePending was received or not from the diagnostic server.
 * This member is relevant only for a "functional response".
 * TRUE: ResponsePending was received.
 * FALSE: ResponsePending was not received.
 */
typedef struct
{
  PduIdType TxPduId;
  ...
  boolean PreparedToReceiveFunctionalResponse;
  boolean ResponsePendingWasReceived; /* relevant only for "functional response" */
} Dccm_DiagnosticProtocolType;

/**
 * \struct Dccm_FunctionalRequestHelperType
 * \brief Contains data related to the current functional request.
 *
 * \var Dccm_FunctionalRequestHelperType::FunctionalRequestOngoingOnProtocolId
 * \brief A functional request (that is not the TesterPresent sent by Dccm) is handled on the ProtocolId indicated by this variable.
 * The value DCCM_INVALID_PROTOCOL_ID means that there is no functional request on-going.
 *
 * \var Dccm_FunctionalRequestHelperType::SuppressPosRsp
 * \brief This member holds the value of the
 * SuppressPosRspMsgIndicationBit (SPRMIB) from the request.
 *
 * \var Dccm_FunctionalRequestHelperType::isSuppressPosRspSaved
 * \brief The value of the SuppressPosRspMsgIndicationBit (SPRMIB) from the
 * request was saved or not in the member SuppressPosRsp.
 * TRUE - the value of the SuppressPosRspMsgIndicationBit (SPRMIB) was saved.
 * FALSE - the value of the SuppressPosRspMsgIndicationBit (SPRMIB) was not saved.
 *
 * \var Dccm_FunctionalRequestHelperType::Timeout
 * \brief Communication timeout counter
 * Timer variable used for P2 or P6 timeouts, depending on the configuration.
 * This timeout is triggered (started, reloaded, and stopped), using the
 * configuration values:
 ...
 * API then it will be loaded with the default values: DCCM_TIMEOUT_P2CLIENT and DCCM_TIMEOUT_P2STARCLIENT
 * or DCCM_TIMEOUT_P6CLIENT and DCCM_TIMEOUT_P6STARCLIENT.
 * If this timer expires a timeout response will be send to software component (SWC).
 *
 * \var Dccm_FunctionalRequestHelperType::P2ClientConfigurationValue
 * \brief The configuration value for P2Client
 * The configurable value to be used for the Timeout.
 * This value is going to be used instead of DCCM_TIMEOUT_P2CLIENT to initialize the Timeout
 * parameter when the P2 timeout should start.
 *//**
 * \var Dccm_FunctionalRequestHelperType::P2StarClientConfigurationValue
 * \brief The configuration value for P2*Client.
 * The configurable value to be used for the Timeout.
 * This value is going to be used instead of DCCM_TIMEOUT_P2STARCLIENT to initialize the Timeout
 * parameter when the P2 timeout should start.
 *//**
 * \var Dccm_FunctionalRequestHelperType::P6ClientConfigurationValue
 * \brief The configuration value for P6Client
 * The configurable value to be used for the Timeout.
 * This value is going to be used instead of DCCM_TIMEOUT_P6CLIENT to initialize the Timeout
 * parameter when the P6 timeout should start.
 *//**
 * \var Dccm_FunctionalRequestHelperType::P6StarClientConfigurationValue
 * \brief The configuration value for P6*Client.
 * The configurable value to be used for the Timeout.
 * This value is going to be used instead of DCCM_TIMEOUT_P6STARCLIENT to initialize the Timeout
 * parameter when the P6 timeout should start.
...
typedef struct
{
  uint8 FunctionalRequestOngoingOnProtocolId;
  boolean SuppressPosRsp;
  boolean isSuppressPosRspSaved;
  Dccm_TimeoutType Timeout;
#if (DCCM_P2CLIENT_ENABLED == STD_ON)
  ...
  Dccm_TimeoutType P6StarClientConfigurationValue;
#endif
} Dccm_FunctionalRequestHelperType;

/**
 * \struct Dccm_PduIdsConfigurationType
 * \brief Structure to store the information related to configured ECUs.
 *
 * \var Dccm_PduIdsConfigurationType::EcuId
 * \brief Number of EcuId.
 *
 * \var Dccm_PduIdsConfigurationType::TxPduId
 * \brief Number of associated TxPdu.
 *
 * \var Dccm_PduIdsConfigurationType::RxPduId
 * \brief Number of associated RxPdu.
 *
 * \var Dccm_PduIdsConfigurationType::PduRTxPduId
 * \brief PduR Tx PduId that must be used when Dccm calls PduR_DccmTransmit().
 */
typedef struct
{
  uint32 EcuId;
...
extern VAR(Dccm_FunctionalRequestHelperType, DCCM_VAR) Dccm_FunctionalRequestHelper;
