...
[!VAR "CanTotalElement" = "0"!][!//
[!VAR "FDTotalElement" = "0"!][!//
[!LOOP "as:modconf('Mirror')[1]/MirrorConfigSet/MirrorSourceNetwork/*"!][!//
[!IF "node:name(.) = 'MirrorSourceNetworkCan'"!][!//
[!VAR "CanTotalElement" = "$CanTotalElement + num:i(((node:value(./MirrorCanFramesPerSecond) * $MainFuncPeriod) +1))"!][!//
[!IF "node:exists(./MirrorCanFDFramesPerSecond)"!][!//
[!VAR "FDTotalElement" = "$FDTotalElement + num:i(((node:value(./MirrorCanFDFramesPerSecond) * $MainFuncPeriod) +1))"!][!//
[!ENDIF!][!//
[!ENDIF!][!//
[!ENDLOOP!][!//
[!IF "num:i($CanTotalElement)< 256"!][!//
typedef VAR(uint8, TYPEDEF) Mirror_ElementIdxType;
[!ELSEIF "num:i($CanTotalElement)< 65535"!][!//
typedef VAR(uint16, TYPEDEF) Mirror_ElementIdxType;
[!ELSE!][!//
typedef VAR(uint32, TYPEDEF) Mirror_ElementIdxType;
[!ENDIF!][!//

[!IF "node:exists( as:modconf('Mirror')[1]/MirrorConfigSet/MirrorSourceNetwork/*/MirrorCanFDFramesPerSecond)"!][!//
[!IF "num:i($FDTotalElement) < 256"!][!//
typedef VAR(uint8, TYPEDEF) Mirror_FDElementIdxType;
[!ELSEIF "num:i($FDTotalElement) < 65535"!][!//
typedef VAR(uint16, TYPEDEF) Mirror_FDElementIdxType;
[!ELSE!][!//
typedef VAR(uint32, TYPEDEF) Mirror_FDElementIdxType;
[!ENDIF!][!//
[!ENDIF!][!//
[!ENDIF!][!//
...
{
[!IF "$CanSrcNWSize > 0"!][!//
  CONST(Mirror_ElementIdxType,TYPEDEF) Mirror_ElementIdx;
  CONST(Mirror_ElementIdxType,TYPEDEF) Mirror_ElementTotalNumber;
[!IF "node:exists( as:modconf('Mirror')[1]/MirrorConfigSet/MirrorSourceNetwork/*/MirrorCanFDFramesPerSecond)"!][!//
  CONST(Mirror_FDElementIdxType,TYPEDEF) Mirror_FDElementIdx;
  CONST(Mirror_FDElementIdxType,TYPEDEF) Mirror_FDElementTotalNumber;
[!ENDIF!][!//
[!ENDIF!][!//
  CONST(NetworkHandleType, TYPEDEF) ComMChannelId; /* ComM Channel ID */
  CONST(Mirror_NetworkType, TYPEDEF) NetworkType; /* Network type */
...
[!IF "$CanSrcNWSize > 0"!][!//
  VAR(Mirror_ElementIdxType,TYPEDEF) ElementCounter;
  VAR(Mirror_ElementIdxType,TYPEDEF) NetworkReadIndex;  
  VAR(Mirror_ElementIdxType,TYPEDEF) NetworkWriteIndex;
[!IF "node:exists(as:modconf('Mirror')[1]/MirrorConfigSet/MirrorSourceNetwork/*/MirrorCanFDFramesPerSecond)"!][!//
  VAR(Mirror_FDElementIdxType,TYPEDEF) ElementFDCounter;
  VAR(Mirror_FDElementIdxType,TYPEDEF) NetworkFDReadIndex;  
  VAR(Mirror_FDElementIdxType,TYPEDEF) NetworkFDWriteIndex;
[!ENDIF!][!//
[!ENDIF!][!//
...
[!IF "$CanSrcNWSize > 0"!][!//
  VAR(boolean, TYPEDEF) ReportingOngoing;
[!ENDIF!][!//
