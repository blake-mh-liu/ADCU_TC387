...
/** \brief Definition of DET error code MIRROR_E_INVALID_CANFD_NETWORK */
#if (defined MIRROR_E_INVALID_CANFD_NETWORK)
#error MIRROR_E_INVALID_CANFD_NETWORK already defined!
#endif /* #if (defined MIRROR_E_INVALID_CANFD_NETWORK)*/
#define MIRROR_E_INVALID_CANFD_NETWORK 0x19U /** Reporting CanFD Frame to a network which doesn't support CanFD */
