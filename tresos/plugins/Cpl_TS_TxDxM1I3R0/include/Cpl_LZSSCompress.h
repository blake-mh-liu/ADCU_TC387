#ifndef CPL_LZSSCOMPRESS_H
#define CPL_LZSSCOMPRESS_H

/*================================================================================================*/

/** \file        Cpl_LZSSCompress.h
 **
...
/* !LINKSTO EB_CPL_0804_000, 1
 */
/** \brief  Start LZSS compression computation.
 **
 ** This function requests the start of the LZSS compression for
 ...
 **                                     during the LZSS compression computation.
 ...
 **/
extern FUNC(Cal_ReturnType, CPL_CODE) Cpl_LZSSCompressStart
(
  P2CONST(void,                   AUTOMATIC, CPL_APPL_DATA) cfgPtr,
      VAR(Cal_CompressCtxBufType, AUTOMATIC               ) contextBuffer
);

/* !LINKSTO EB_CPL_0804_005, 1
 */
/** \brief  Update LZSS compression computation.
 **
 ** This function requests the update of the LZSS compression
 ...
 **/
extern FUNC(Cal_ReturnType, CPL_CODE) Cpl_LZSSCompressUpdate
(
  P2CONST(void,                   AUTOMATIC, CPL_APPL_DATA) cfgPtr,
      VAR(Cal_CompressCtxBufType, AUTOMATIC               ) contextBuffer,
...
/* !LINKSTO EB_CPL_0804_010, 1
 */
/** \brief  Finish LZSS compression computation.
 **
 ** This function requests the finishing of the LZSS compression computation.
 ...
 ** \retval   CAL_E_NOT_OK              Request failed.
 **/
extern FUNC(Cal_ReturnType, CPL_CODE) Cpl_LZSSCompressFinish
(
  P2CONST(void,                   AUTOMATIC, CPL_APPL_DATA) cfgPtr,
      VAR(Cal_CompressCtxBufType, AUTOMATIC               ) contextBuffer,
    P2VAR(uint8,                  AUTOMATIC, CPL_APPL_DATA) oputBuf,
...
#endif /* #if (CPL_LZSSCOMPRESS_ENABLED == STD_ON) */

#endif /* #ifndef CPL_LZSSCOMPRESS_H */
