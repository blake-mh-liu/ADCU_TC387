 ...
 * The macro _CLANG_C_TRICORE_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#ifndef _CLANG_C_TRICORE_ /* to prevent double definition */
/** \brief compiler symbol for clang compiler for TRICORE */
/* Deviation MISRAC2012-1 */
#define _CLANG_C_TRICORE_
#else
#error _CLANG_C_TRICORE_ already defined. Symbol for the target compiler is defined by compiler abstraction
#endif /* ifndef _CLANG_C_TRICORE_ */
