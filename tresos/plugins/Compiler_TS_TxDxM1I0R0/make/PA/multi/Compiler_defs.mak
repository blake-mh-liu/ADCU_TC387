...
CC              = $(COMPILER_DIR)/ccppc$(EXE_FILE_SUFFIX)
CCLIB           = $(COMPILER_DIR)/ccppc$(EXE_FILE_SUFFIX)
ASM             = $(COMPILER_DIR)/ccppc$(EXE_FILE_SUFFIX)
LINK            = $(COMPILER_DIR)/ccppc$(EXE_FILE_SUFFIX)
