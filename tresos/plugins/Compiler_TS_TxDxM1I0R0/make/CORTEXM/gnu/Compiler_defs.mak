...
CC              = $(COMPILER_DIR)/arm-none-eabi-gcc$(EXE_FILE_SUFFIX)
CCLIB           = $(PLUGINS_BASE)/Make_$(Make_VARIANT)/tools/gcc/bin/ar$(EXE_FILE_SUFFIX)
ASM             = $(CC)
LINK            = $(COMPILER_DIR)/arm-none-eabi-gcc$(EXE_FILE_SUFFIX)
...
CPP              = $(COMPILER_DIR)/arm-none-eabi-cpp$(EXE_FILE_SUFFIX)
