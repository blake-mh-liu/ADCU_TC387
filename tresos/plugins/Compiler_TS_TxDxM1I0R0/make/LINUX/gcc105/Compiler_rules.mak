...
#
# Copyright 2017 - 2023 Elektrobit Automotive GmbH
...
define build-postbuild-file
	$(EB_VERBOSE)$(LINK) $(LINK_OPT) -r -nostartfiles -nodefaultlibs -nostdlib -o $(basename $@).temp $(POSTBUILD_OBJECTS_OUT)\
