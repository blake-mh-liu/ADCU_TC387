...
ifdef TOOLPATH_COMPILER
override TOOLPATH_COMPILER := $(subst \,/,$(TOOLPATH_COMPILER))
endif
...
ifneq (,$(filter LINUX WINDOWS, $(TARGET)))
...
#################################################################
# checks if compiler was set correctly but only if building
ifneq (,$(GOALS_BUILD))
  ifeq (,$(PROJECT_BINARY))
