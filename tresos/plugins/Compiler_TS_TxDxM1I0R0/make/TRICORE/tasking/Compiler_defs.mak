...
CC              = $(COMPILER_DIR)/cctc$(EXE_FILE_SUFFIX)
CCLIB           = $(COMPILER_DIR)/artc$(EXE_FILE_SUFFIX)
ASM             = $(COMPILER_DIR)/astc$(EXE_FILE_SUFFIX)
LINK            = $(COMPILER_DIR)/ltc$(EXE_FILE_SUFFIX)
...
CPP             = $(COMPILER_DIR)/cptc$(EXE_FILE_SUFFIX)
CTC             = $(COMPILER_DIR)/ctc$(EXE_FILE_SUFFIX)
...
WAIT_FOR_LICENSE := $(shell $(PERL) $(GET_LICENSE_SCRIPT) $(COMPILER_DIR)/ctc$(EXE_FILE_SUFFIX) $(MAKECMDGOALS))
