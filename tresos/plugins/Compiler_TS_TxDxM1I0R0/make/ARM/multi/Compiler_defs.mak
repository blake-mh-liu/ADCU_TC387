...
CC              = $(COMPILER_DIR)/ccarm$(EXE_FILE_SUFFIX)
CCLIB           = $(COMPILER_DIR)/ccarm$(EXE_FILE_SUFFIX)
ASM             = $(COMPILER_DIR)/ccarm$(EXE_FILE_SUFFIX)
LINK            = $(COMPILER_DIR)/ccarm$(EXE_FILE_SUFFIX)
