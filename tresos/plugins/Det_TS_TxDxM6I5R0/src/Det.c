...
/* To prevent redeclarations of symbols from Rte_DevelopmentErrorTracer.h by our public headers */
...
/* Rte and SchM includes are handled by the Rte specific compilation units of Det */

#if ((DET_DEFENSIVE_PROGRAMMING_ENABLED == STD_ON) && (TS_ARCH_FAMILY == TS_WINDOWS))
/* Deviation MISRAC2012-1 */
#include <stdio.h> /* for fprintf */
#endif

/* !LINKSTO Det.SWS_Det_00211,1 */
...
/* patch version check */
#if (DET_SW_PATCH_VERSION < 15U)
#error DET_SW_PATCH_VERSION wrong (< 15U)
#endif
...
STATIC FUNC(void, DET_CODE) Det_StopExecution(uint8 ErrorType);
...
#else /* DET_MULTICORE_ENABLED == TRUE */
...
)
{
  ...
  DET_REPORT_ERROR_STATUS_PARAMETERS;
  ...
  if (Det_State != DET_STATE_UNINIT)
  {
    switch(ErrorType)
    {
      case DET_DEVELOPMENT_ERROR_TYPE:
      {
        ...
        /* !LINKSTO Det.EB_Ref.SWS_Det_00035.ReportError,1 */
        /* !LINKSTO Det.SWS_Det_00501,1 */
        /* !LINKSTO Det.EB_Ref.SWS_Det_00014.ReportError,1 */
      ...
      {
        /* call the notification functions which are configured */
        /* !LINKSTO Det.EB_Ref.SWS_Det_00035.ReportRuntimeError,1 */
        /* !LINKSTO Det.SWS_Det_00503,1 */
        /* !LINKSTO Det.EB_Ref.SWS_Det_00014.ReportRuntimeError,1 */
      ...
      {
        /* call the notification functions which are configured */
        /* !LINKSTO Det.EB_Ref.SWS_Det_00035.ReportTransientFault,1 */
        /* !LINKSTO Det.SWS_Det_00502,1 */
        /* !LINKSTO Det.EB_Ref.SWS_Det_00014.ReportTransientFault,1 */
    ...
    /* !LINKSTO Det.EB_Ref.SWS_Det_00034.ReportError,1,
                Det.EB_Ref.SWS_Det_00034.ReportRuntimeError,1,
                Det.EB_Ref.SWS_Det_00034.ReportTransientFault,1 */
#if (DET_FORWARD_TO_DLT == STD_ON)
    Dlt_DetForwardErrorTrace(ModuleId, InstanceId, ApiId, ErrorId);
#endif

    /* !LINKSTO Det.EB_Ref.SWS_Det_00026.ReportError,1 */
...
)
{
  ...
  P2VAR(Atomic_t, AUTOMATIC, DET_APPL_DATA) Det_WriteIndex = NULL_PTR;
  P2VAR(Atomic_t, AUTOMATIC, DET_APPL_DATA) Det_UsedSlots  = NULL_PTR;
  P2VAR(Atomic_t, AUTOMATIC, DET_APPL_DATA) Det_ErrorLost  = NULL_PTR;
#endif
  ...
  uint8  ErrorId)
{
  ...
  /* Casting to void because according to AUTOSAR 3.2 there is no return value*/
  /* !LINKSTO Det.ASR321.DET009,1 */
...
FUNC(void, DET_CODE) Det_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC, DET_APPL_DATA) VersionInfoPtr)
{
  DBG_DET_GETVERSIONINFO_ENTRY(VersionInfoPtr);
  /* !LINKSTO Det.ASR403.DET051,1 */
  ...
  {
    /* !LINKSTO Det.ASR403.DET023,1 */
    /* !LINKSTO Det.SWS_Det_00052,1 */
    /* !LINKSTO Det.SWS_Det_00301,1 */
