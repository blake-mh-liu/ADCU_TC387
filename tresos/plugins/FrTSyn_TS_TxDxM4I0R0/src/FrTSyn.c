...
/* minor version check */
#if (FRTSYN_AR_RELEASE_MINOR_VERSION != 7U )
#error FRTSYN_AR_RELEASE_MINOR_VERSION wrong (!= 7U)
#endif
...
/* major version check */
#if (FRTSYN_SW_MAJOR_VERSION != 4U)
#error FRTSYN_SW_MAJOR_VERSION wrong (!= 4U)
#endif
...
#define FRTSYN_ASSIGN_TIME_DATA(dst,src)                                                          \
        ...
        {                                                                                         \
          ...
          (dst).cycleLength = (src).cycleLength;                                                      \
          (dst).macrotickDuration = (src).macrotickDuration;                                                      \
          (dst).currentMacroticks = (src).currentMacroticks;                                                      \
          (dst).currentCycle = (src).currentCycle;  \
        } while (0)
...
#if (defined FRTSYN_INVALID_SEGMENT_ID)
#error FRTSYN_INVALID_SEGMENT_ID already defined!
#endif /* #if (defined FRTSYN_INVALID_SEGMENT_ID)*/
#define FRTSYN_INVALID_SEGMENT_ID 255U
...
#if(FRTSYN_IS_HYSTERESIS_USED == STD_ON)
/**
 * \brief Updates hysteresis counter.
 *
 * \param[in] pSlaveCfg -  pointer to slave configuration.
 *            pSlaveData -  pointer to slave data
 *            messageCanBeProcessed - Flag indicating if the message can be processed.
 *            validSequenceCounter - Flag indicating if SC is valid compared to configured Jump Width Counter
 * \return void
 */
STATIC FUNC(void, FRTSYN_CODE) FrTSyn_HysteresisCounterUpdate
(
  CONSTP2CONST(FrTSyn_SlaveTimeDomainConfigType, AUTOMATIC, FRTSYN_APPL_CONST) pSlaveCfg,
  CONSTP2VAR(FrTSyn_SlaveType, AUTOMATIC, FRTSYN_APPL_DATA) pSlaveData,
  P2VAR(boolean, AUTOMATIC, AUTOMATIC) messageCanBeProcessed,
  StbM_TimeBaseStatusType status,
  boolean validSequenceCounter
);
#endif /*FRTSYN_IS_HYSTERESIS_USED == STD_ON */

/**
 * \brief Service handle the Sequence Counter
 * \param[inout] messageCanBeProcessed - Flag indicating if the message can be processed
 * \param[in] pSlaveCfg -  pointer to slave configuration
 *            pSlaveData -  pointer to slave data
 *            receivedSequenceCounter - the SC received on the message
 *            isSync - Flag indicating if this is an OFS or a SYNC time base
 */
STATIC FUNC(void, FRTSYN_CODE) FrTsyn_SeqCounter_handle
(
  CONSTP2CONST(FrTSyn_SlaveTimeDomainConfigType, AUTOMATIC, FRTSYN_APPL_CONST) pSlaveCfg,
  CONSTP2VAR(FrTSyn_SlaveType, AUTOMATIC, FRTSYN_APPL_DATA) pSlaveData,
  P2VAR(boolean, AUTOMATIC, AUTOMATIC) messageCanBeProcessed,
  const uint8 receivedSequenceCounter,
...
/* !LINKSTO FrTSyn.SWS_FrTSyn_00064,1 */
...
)
{
  ...
  if(NULL_PTR == versioninfo)
  {
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
...
/* !LINKSTO FrTSyn.SWS_FrTSyn_00063,1 */
...
)
{
      ...
      FrTSyn_DomainActiveIndex++)
  {
    ...
    /* Set Macrotick per cycle for every Slave*/
    pSlaveData->MacroticksPerCycle = FrIf_GetMacroticksPerCycle(pSlaveCfg->ctrlId);
...
#if(FRTSYN_IS_HYSTERESIS_USED == STD_ON)
    /* Clear the hysteresis sequence counter */
    pSlaveData->hysteresisCounter = 0U;
#endif /*FRTSYN_IS_HYSTERESIS_USED == STD_ON */
      ...
      FrTSyn_DomainActiveIndex++)
  {
    ...
    /* Set Cycle Length for every master */
    pMasterData->cycleLength = FrIf_GetCycleLength(pMasterCfg->ctrlId);
    /* Set Macrotick per cycle for every master*/
    pMasterData->MacroticksPerCycle = FrIf_GetMacroticksPerCycle(pMasterCfg->ctrlId);
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00006,1 */
    ...
    pTimeValidationData->segmentId = FRTSYN_INVALID_SEGMENT_ID;
#endif /* (FRTSYN_TIME_VALIDATION_ENABLED == STD_ON) */
  ...
  DBG_FRTSYN_INIT_EXIT(configPtr);
}
...
)
{
  ...
  {
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00067.UNINIT.RxIndication,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
...
#endif /* FRTSYN_DEV_ERROR_DETECT == STD_ON */
  {
    ...
    if(NULL_PTR != PduInfoPtr)
    {
      ...
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00009,1 */
      if (FRTSYN_MESSAGE_PAYLOAD == PduInfoPtr->SduLength)
      {
        if(NULL_PTR != PduInfoPtr->SduDataPtr)
        {
          ...
          {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
            /* !LINKSTO FrTSyn.SWS_FrTSyn_00067.INVALID_PDUID.RxIndication,1 */
            /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
            /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
        ...
        {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00067.SduDataPtr.E_NULL_POINTER.RxIndication,1 */
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
      ...
      {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00067.PduInfoPtr.INVALID_SDULENGTH.RxIndication,1 */
    ...
    {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00067.PduInfoPtr.E_NULL_POINTER.RxIndication,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
      FRTSYN_DET_REPORT_ERROR(FRTSYN_SID_RXINDICATION, FRTSYN_E_NULL_POINTER);
#endif /* FRTSYN_DEV_ERROR_DETECT == STD_ON */
...
/* !LINKSTO FrTSyn.SWS_FrTSyn_00071,1 */
      ...
      FrTSyn_TimeDomainActiveIndex++)
  {
    ...
    if((TRUE == FRTSYN_TX_COND(pMasterData, pMasterCfg)) && (FRTSYN_TX_OFF != pMasterData->txMode))
    {
      ...
      if((ret == E_OK) && (state == FRIF_STATE_ONLINE))
      {
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00078,1 */
...
/* !LINKSTO FrTSyn.SWS_FrTSyn_00069,1 */
...
)
{
  ...
  if(FALSE == FrTSyn_Initialized)
  {
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00070.UNINIT.TriggerTransmit,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
...
#endif /* FRTSYN_DEV_ERROR_DETECT == STD_ON */
  {
      ...
      if(NULL_PTR != PduInfoPtr)
      {
        if(NULL_PTR != PduInfoPtr->SduDataPtr)
        {
          ...
          if(TxPduId < FRTSYN_NUMBER_OF_TIME_MASTERS)
          {
...
#if(FRTSYN_TIME_VALIDATION_ENABLED == STD_ON)
              /* !LINKSTO FrTSyn.SWS_FrTSyn_00100.Decoupled,1 */
            ...
            {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
            /* !LINKSTO FrTSyn.SWS_FrTSyn_00070.INVALID_PDUID.TriggerTransmit,1 */
            /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
            /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
        ...
        {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00070.SduDataPtr.E_NULL_POINTER.TriggerTransmit,1 */
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
      ...
      {
#if(FRTSYN_DEV_ERROR_DETECT == STD_ON)
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00070.PduInfoPtr.E_NULL_POINTER.TriggerTransmit,1 */
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00058,1 */
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00059,1 */
        FRTSYN_DET_REPORT_ERROR(FRTSYN_SID_TRIGGERTRANSMIT, FRTSYN_E_NULL_POINTER);
#endif /* FRTSYN_DEV_ERROR_DETECT == STD_ON */
...
/* !LINKSTO FrTSyn.SWS_FrTSyn_00065,1 */
...
/* !LINKSTO FrTSyn.EB.SetTransmissionMode.Uninit,1 */
  ...
  {
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00095.Mode.E_PARAM.SetTransmissionMode,1 */
  ...
  {
#if(FRTSYN_IS_MASTER_FUNC_USED == STD_ON)
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00026,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00027,1 */
    ...
    {
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00095.CtrlIdx.E_INV_CTRL_IDX.SetTransmissionMode,1 */
...
)
{
  ...
  StbM_FrTimeMasterMeasurementType measurementData = {0U, {0U, 0U}, {0U, 0U}, FRTSYN_INVALID_SEGMENT_ID, 0U, 0U, 0U, 0U};
#endif /* FRTSYN_TIME_VALIDATION_ENABLED == STD_ON */
  ...
  if(pMasterCfg->timeDomainId < 16U)
  {
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00028,1 */
    if (StbM_BusGetCurrentTime(pMasterCfg->syncTimeBaseId, &globalTime, &virtLocalT0, &userData) == E_OK)
    {
      ...
      if((E_OK == frifRet) && (E_OK == stbmRet))
      {
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00020,1 */
        const uint8 receivedSGW = ((uint8)(globalTime.timeBaseStatus & FRTSYN_SGW_TX_MASK) > 0U) ? 1U : 0U;

        /* The difference between T0VLT and T1VLT has to fit in an uint32 (ns),
         * the calls are right after another
         */
        uint32 addToTime = ((uint32)((uint32)FRTSYN_FR_CYCLE_COUNTER_MAX - (uint32)currentCycle) * pMasterData->cycleLength) - ((pMasterData->cycleLength / (uint32)pMasterData->MacroticksPerCycle) * (uint32)currentMacroticks);
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00037,1 */
...
#if (FRTSYN_TIME_VALIDATION_ENABLED == STD_ON)
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.seqCounter,1 */
        measurementData.sequenceCounter = pMasterData->seqCount;
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.T1VLT,1 */
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.T0,1 */
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.segID,1 */
        measurementData.segmentId = pMasterCfg->segmentId;
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.currentCycle,1 */
        measurementData.currentCycle = currentCycle;
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.currentMacroticks,1 */
        measurementData.currentMacroticks = currentMacroticks;
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.macrotickDuration,1 */
        measurementData.macrotickDuration = (uint16)(pMasterData->cycleLength / pMasterData->MacroticksPerCycle);
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00101.cycleLength,1 */
        measurementData.cycleLength = pMasterData->cycleLength;
#endif /* FRTSYN_TIME_VALIDATION_ENABLED == STD_ON */
  ...
  {
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00022,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00029,1 */
    if(StbM_GetOffset(pMasterCfg->syncTimeBaseId, &globalTime, &userData) == E_OK)
    {
      /* Get SGW from Time Stamp */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00020,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00079,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00080,1 */
      const uint8 receivedSGW = ((uint8)(globalTime.timeBaseStatus & FRTSYN_SGW_TX_MASK) > 0U) ? 1U : 0U;
  ...
  if(TRUE == eitherOK)
  {
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00010,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00012,1 */
        ...
        || (FRTSYN_OFS_CRC_SUPPORTED == pMasterCfg->txCrcSecured))
    {
      ...
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00035,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00036,1 */
      ...
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00031,1 */
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00070.INTERRUPTION.TriggerTransmit,1 */
    ...
    if(E_OK == FrIf_Transmit(pMasterCfg->txPduId, &TxDataPtr))
    {
      ...
      switch(pMasterCfg->txCondFuncIdx)
      {
        ...
        case FRTSYN_TXTYPE_IMMEDIATE:
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00085,1 */
...
#if(FRTSYN_TIME_VALIDATION_ENABLED == STD_ON)
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00100.Immediate,1 */
      if(FRTSYN_TIME_VALIDATION_ENABLED_ON_DOMAIN(pMasterCfg))
      {
    ...
    {
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00089,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00090,1 */
...
#endif
  {
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00019.Periodic.TxPeriodReload,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00023.Periodic.TxPeriodReload,1 */
...
#if (FRTSYN_TXTYPE_PERIODIC_USED == STD_ON)
/* !LINKSTO FrTSyn.SWS_FrTSyn_00019.Periodic.TxPeriodEnabled,1 */
/* !LINKSTO FrTSyn.SWS_FrTSyn_00023.Periodic.TxPeriodEnabled,1 */
STATIC FUNC(boolean, FRTSYN_CODE) FrTSyn_TxCondFunc_Periodic
(
  P2VAR(FrTSyn_MasterType, AUTOMATIC, AUTOMATIC) pMasterData,
  P2CONST(FrTSyn_MasterTimeDomainConfigType, AUTOMATIC, AUTOMATIC) pMasterCfg
...
#if (FRTSYN_TXTYPE_IMMEDIATE_USED == STD_ON)
/* !LINKSTO FrTSyn.SWS_FrTSyn_00019.Periodic.TxPeriodDisabled,1 */
/* !LINKSTO FrTSyn.SWS_FrTSyn_00023.Periodic.TxPeriodDisabled,1 */
STATIC FUNC(boolean, FRTSYN_CODE) FrTSyn_TxCondFunc_Immediate
(
  P2VAR(FrTSyn_MasterType, AUTOMATIC, AUTOMATIC) pMasterData,
  P2CONST(FrTSyn_MasterTimeDomainConfigType, AUTOMATIC, AUTOMATIC) pMasterCfg
)
{
  ...
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00084,1 */
  ...
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00086,1 */
  if(0U == pMasterData->dbncCntr)
  {
    const uint8 timeBaseUpdCntrPrev = pMasterData->timebaseUpdCntr;

    /* !LINKSTO FrTSyn.SWS_FrTSyn_00087,1 */
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00088,1 */
...
)
{
  ...
  if(0U == pMasterData->dbncCntr)
  {
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00088,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00019.Periodic.GlobalTimeBaseBit,1 */
    /* Deviation MISRAC2012-1 */
    if((timeBaseUpdCntrPrev != pMasterData->timebaseUpdCntr)
       && (TRUE == FrTSyn_IsTimeBaseSet(pMasterData, pMasterCfg)))
    {
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00089,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00091,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00093,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00019.Periodic.CyclicMsgResumeCounter,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00023.Periodic.CyclicMsgResumeCounter,1 */
    if(0U == pMasterData->txPeriod)
    {
...
)
{
  ...
  else
  {
    ...
    if(E_OK == StbM_GetTimeBaseStatus(pMasterCfg->syncTimeBaseId, &timeBaseStatus, &timeBaseOfsStatus))
    {
      ...
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00023.Periodic.GlobalTimeBaseBit,1 */
...
)
{
  ...
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00038,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00039,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00040,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00081,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00042,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00043,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00044,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00082.OFS_CRC_SECURED,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00082.OFS_NOT_CRC_SECURED,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00056,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00014,1 */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00015,1 */
  if (FRTSYN_IS_MESSAGE_TYPE_VALID(rcvdMsg[FRTSYN_MESSAGE_TYPE_BYTE], TimeDomainIdx) != 0U)
  {
    ...
    FrTsyn_SeqCounter_handle(pSlaveCfg, pSlaveData, &messageCanBeProcessed, receivedSequenceCounter, isSync);
    ...
    if(messageCanBeProcessed)
    {
      ...
      if((crcValidatedType == rcvdMsg[FRTSYN_MESSAGE_TYPE_BYTE]) && (FALSE == crcIgnored))
      {
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00054,1 */
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00055,1 */
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00050,1 */
...
#endif /* FRTSYN_CRC_CHECK_USED == STD_ON */
      {
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00011,1 */
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00013,1 */
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00010,1 */
    ...
    if(messageCanBeProcessed)
    {
      ...
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00046,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00007,1 */
      ...
      {
        /* Get received SGW */
        const uint8 receivedSGW = ((uint8) (rcvdMsg[FRTSYN_FCNT_AND_SGW_BYTE] & FRTSYN_SGW_MASK) > 0U) ? 1U : 0U;
        /* Get received FCNT */
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00028,1 */
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00047,1 */
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00094,1 */
        if (0U != receivedSGW)
        {
          receivedTimeStamp.timeBaseStatus = STBM_SYNC_TO_GATEWAY_FLAG;
        }

        /* !LINKSTO FrTSyn.SWS_FrTSyn_00057,1 */
...
)
{
    StbM_TimeBaseStatusType timeBaseStatus;
    StbM_TimeBaseStatusType timeBaseOfsStatus;
    /* See if SC is valid when compared to configured Jump Width Counter. */
    boolean validSequenceCounter = FALSE;
    /* Difference between the current SC and the one before is valid (>0). */
    boolean validDeltaSequenceCounter = TRUE;
   ...
   /* Check if global Sequence Counter Jump Width equals 0 to skip Sequence Counter Jump Width checks */
    if(pSlaveCfg->scjumpWidth <= 0U)
    {
      validSequenceCounter = TRUE;
    }
    else
    {
      ...
      const uint8 deltaSequenceCounter = (receivedSequenceCounter >= pSlaveData->seqCount) ?
        ...
        - pSlaveData->seqCount);
        if((deltaSequenceCounter > 0U) && (deltaSequenceCounter <= pSlaveCfg->scjumpWidth))
        {
          validSequenceCounter = TRUE;
        }
        else if(deltaSequenceCounter <= 0U)
        {
          validDeltaSequenceCounter = FALSE;
        }
        else
        {
          /* Do nothing. */
    ...
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00048,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00056,1 */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00049.Startup,1 */
    if((FRTSYN_SEQ_COUNTER_NOCHECK == pSlaveData->seqCount) || (TRUE == validSequenceCounter))
    {
      *messageCanBeProcessed = TRUE;
    }
    else
    {
#if(FRTSYN_IS_HYSTERESIS_USED == STD_OFF)
      /* Always returns E_OK */
      (void)StbM_GetTimeBaseStatus(pSlaveCfg->syncTimeBaseId, &timeBaseStatus, &timeBaseOfsStatus);
#endif /*FRTSYN_IS_HYSTERESIS_USED == STD_OFF */

      /* !LINKSTO FrTSyn.SWS_FrTSyn_00049.Timeout.DeltaSC.GreaterThan0.NoSCCheck,1 */
      /* Check if TIMEOUT bit was set in StbM and the difference between the previous SC. No check against JumpWidth*/
      if((STBM_TIMEOUT_FLAG == (*status & STBM_TIMEOUT_FLAG)) && (TRUE == validDeltaSequenceCounter))
      {
        *messageCanBeProcessed = TRUE;
      }
      else
      {
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00049.Timeout.DeltaSC.EqualsZero.MessageNotAccepted,1 */
        /* If TIMEOUT bit was set in StbM and the difference between the previous SC
           and FrTSyn_SendToStbM() will not be called */
      }
    }

#if(FRTSYN_IS_HYSTERESIS_USED == STD_ON)
    /* Timeout processing. */
    /* !LINKSTO FrTSyn.SWS_FrTSyn_00102,1 */
    FrTSyn_HysteresisCounterUpdate(pSlaveCfg, pSlaveData, messageCanBeProcessed, *status, validSequenceCounter);
#endif /*FRTSYN_IS_HYSTERESIS_USED == STD_ON */
...
{
  if((STBM_TIMEOUT_FLAG == (status & STBM_TIMEOUT_FLAG)) && (pSlaveCfg->scHysteresis > 0U))
  {
    if(*messageCanBeProcessed)
    {
      /* Hysteresis counter started however the consecutive seqCounters invalid the configured JumpWidth. */
      if(validSequenceCounter == FALSE)
      {
          /* No message should be sent to StbM until hysteresis is met. */
          *messageCanBeProcessed = FALSE;
          /* Set hysteresis counter to 1U considering this message to first. */
          pSlaveData->hysteresisCounter = 1U;
      }
      else
      {
          /* No message should be sent to StbM until hysteresis is met. */
          *messageCanBeProcessed = FALSE;
          ...
          pSlaveData->hysteresisCounter++;
      }

      /* Check if hysteresis counter reached it configured value. */
      if(pSlaveCfg->scHysteresis <= pSlaveData->hysteresisCounter)
      {
        /* Message should be sent to StbM since hysteresis is met. */
        *messageCanBeProcessed = TRUE;
...
)
{
  ...
  /* Measure Data */
  /* !LINKSTO FrTSyn.SWS_FrTSyn_00092,1 */
  ...
  if(isSync)
  {
    ...
    if ((E_OK == FrIf_GetState(pSlaveCfg->clstId, &state)) && (FRIF_STATE_ONLINE == state))
    {
      ...
      if((E_OK == frifRet) && (E_OK == stbmRet))
      {
        const uint32 timeDiff =  (pSlaveData->cycleLength * currentCycle) +  ((pSlaveData->cycleLength / (uint32)pSlaveData->MacroticksPerCycle) * (uint32)currentMacroTicks);
        ...
        /* !LINKSTO FrTSyn.SWS_FrTSyn_00041,1 */
        ...
        if(FRTSYN_TIME_VALIDATION_ENABLED_ON_DOMAIN(pSlaveCfg))
        {
          ...
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.seqCounter,1 */
          slaveMeasurement.sequenceCounter = pSlaveData->seqCount;
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.currentCycle,1 */
          slaveMeasurement.currentCycle = currentCycle;
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.currentMacroticks,1 */
          slaveMeasurement.CurrentMacroticks = currentMacroTicks;
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.FCNT,1 */
          slaveMeasurement.FCNT = receivedCycle;
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.CycleLength,1 */
          slaveMeasurement.cycleLength = pSlaveData->cycleLength;
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.MacrotickDuration,1 */
          slaveMeasurement.macrotickDuration = (uint16)(pSlaveData->cycleLength / pSlaveData->MacroticksPerCycle);
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.T1VLT,1 */
          ...
          /* !LINKSTO FrTSyn.SWS_FrTSyn_00099.T0,1 */
  ...
  else
  {
    ...
    if(E_OK == stbmRet)
    {
      ...
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00045,1 */
      /* !LINKSTO FrTSyn.SWS_FrTSyn_00041,1 */
      (void) StbM_BusSetGlobalTime(pSlaveCfg->syncTimeBaseId, receivedTimeStampPtr, userDataPtr, &measureData, &virtLocalTime);
    }
  } /* OFS */
