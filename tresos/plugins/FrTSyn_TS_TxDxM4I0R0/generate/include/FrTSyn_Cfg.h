...
*/
/* !LINKSTO FrTSyn.ECUC_FrTSyn_00019,1 */
...
[!IF "num:i($FrTSyn_TimeDomainSlavesSize) > num:i(0)"!][!//
#if (defined FRTSYN_IS_HYSTERESIS_USED)
#error FRTSYN_IS_HYSTERESIS_USED already defined!
#endif /* #if (defined FRTSYN_IS_HYSTERESIS_USED)*/
#define FRTSYN_IS_HYSTERESIS_USED     STD_[!IF "num:i($FrTSyn_AllHysteresisSum) > num:i(0)"!]ON[!ELSE!]OFF[!ENDIF!]
[!ENDIF!][!//
