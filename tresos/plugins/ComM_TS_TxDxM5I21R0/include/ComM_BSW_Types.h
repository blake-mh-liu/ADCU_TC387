...
/* !LINKSTO ComM.SWS_ComM_00672,1, ComM.EB_Ref.SWS_ComM_00828.Rte_Ports_UserMode_P.NO_COMMUNICATION,1 */
...
/* !LINKSTO ComM.EB_Ref.SWS_ComM_00828.Rte_Ports_UserMode_P.SILENT_COMMUNICATION,1 */
...
/* !LINKSTO ComM.EB_Ref.SWS_ComM_00828.Rte_Ports_UserMode_P.FULL_COMMUNICATION,1 */
...
#error COMM_FULL_COMMUNICATION_WITH_WAKEUP_REQUEST already defined
#endif
/** \brief Full Communication mode value for \ref ComM_ModeType */
#define COMM_FULL_COMMUNICATION_WITH_WAKEUP_REQUEST   3U

#if (defined COMM_INVALID_COM_MODE)
#error COMM_INVALID_COM_MODE already defined
#endif
/** \brief Invalid Communication Mode  value for \ref ComM_ModeType */
#define COMM_INVALID_COM_MODE   0xFFU
...
/** \brief PNC is requested by a local ComM user.
 **        The mode is used to indicate the BswM, that an active PNC
 **        request should trigger also a wake-up of the used communication hardware,
...
#if (defined PNC_REQUESTED_WITH_WAKEUP_REQUEST)
#error PNC_REQUESTED_WITH_WAKEUP_REQUEST already defined
#endif
#define PNC_REQUESTED_WITH_WAKEUP_REQUEST 5U


/** \brief PNC is requested by a local ComM user */
#if (defined COMM_PNC_REQUESTED)
#error COMM_PNC_REQUESTED already defined
#endif
#define COMM_PNC_REQUESTED 0U
/** \brief PNC is requested by a remote ComM user */
#if (defined COMM_PNC_READY_SLEEP)
#error COMM_PNC_READY_SLEEP already defined
#endif
#define COMM_PNC_READY_SLEEP 1U
/** \brief PNC is active with no deadline monitoring */
#if (defined COMM_PNC_PREPARE_SLEEP)
#error COMM_PNC_PREPARE_SLEEP already defined
#endif
#define COMM_PNC_PREPARE_SLEEP 2U
/** \brief PNC does not communicate */
#if (defined COMM_PNC_NO_COMMUNICATION)
#error COMM_PNC_NO_COMMUNICATION already defined
#endif
#define COMM_PNC_NO_COMMUNICATION 3U
/** \brief PNC is able to communicate */
#if (defined COMM_PNC_FULL_COMMUNICATION)
#error COMM_PNC_FULL_COMMUNICATION already defined
#endif
 ...
 **        if this is supported and configured (e.g. used for Ethernet switch port
 **        switching in combination with OA TC10 compliant Ethernet hardware).*/
#if (defined COMM_PNC_REQUESTED_WITH_WAKEUP_REQUEST)
#error COMM_PNC_REQUESTED_WITH_WAKEUP_REQUEST already defined
#endif
...
/* !LINKSTO ComM.EB_Ref.SWS_ComM_00668.ComM_InitStatusType,1 */
...
/* !LINKSTO ComM.EB_Ref.SWS_ComM_00673.ComM_PncModeType,1 */
