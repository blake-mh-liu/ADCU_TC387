...
/** \brief Channel To User  Data Get SID */
#if (defined COMM_SID_CHANNEL_TO_USER_DATA_GET)
#error COMM_SID_CHANNEL_TO_USER_DATA_GET already defined
#endif
#define COMM_SID_CHANNEL_TO_USER_DATA_GET  241U

/** \brief Channel To User  Data Set SID */
#if (defined COMM_SID_CHANNEL_COMM_INHIBITION_SET)
#error COMM_SID_CHANNEL_COMM_INHIBITION_SET already defined
#endif
#define COMM_SID_CHANNEL_COMM_INHIBITION_SET  240U

/** \brief Pnc mainfunction SID */
#if (defined COMM_SID_MAIN_FUNCTIONPNC)
#error COMM_SID_MAIN_FUNCTIONPNC already defined
#endif
#define COMM_SID_MAIN_FUNCTIONPNC 239
/*------------------[error codes]-------------------------------------------*/
/* !LINKSTO ComM.EB_Ref.ASR403.SWS_ComM_00234.COMM_E_NOT_INITED,1 */
...
/* !LINKSTO ComM.EB_Ref.SWS_ComM_00649.COMM_E_MULTIPLE_PNC_ASSIGNED,1 */
...
/* !LINKSTO ComM.EB_Ref.SWS_ComM_00649.COMM_E_NO_PNC_ASSIGNED,1 */
...
/** \brief Multicore Data set error Id */
#if (defined COMM_E_USER_TO_CH_DATASET_ERROR)
#error COMM_E_USER_TO_CH_DATASET_ERROR already defined
#endif
#define COMM_E_USER_TO_CH_DATASET_ERROR           242U

/** \brief Multicore user to master pnc data set error Id */
#if (defined COMM_E_USER_TO_MASTERPNC_DATASET_ERROR)
#error COMM_E_USER_TO_MASTERPNC_DATASET_ERROR already defined
#endif
#define COMM_E_USER_TO_MASTERPNC_DATASET_ERROR    241U

/** \brief Multicore user to inhibition data set error Id */
#if (defined COMM_E_USER_TO_INHIBITION_DATASET_ERROR)
#error COMM_E_USER_TO_INHIBITION_DATASET_ERROR already defined
#endif
#define COMM_E_USER_TO_INHIBITION_DATASET_ERROR   240U

/** \brief Multicore channel to inhibition data set error Id */
#if (defined COMM_E_CH_TO_INHIBITION_DATASET_ERROR)
#error COMM_E_CH_TO_INHIBITION_DATASET_ERROR already defined
#endif
#define COMM_E_CH_TO_INHIBITION_DATASET_ERROR     239U

/** \brief Multicore channel to channel data set error Id */
#if (defined COMM_E_CH_TO_CH_DATASET_ERROR)
#error COMM_E_CH_TO_CH_DATASET_ERROR already defined
#endif
#define COMM_E_CH_TO_CH_DATASET_ERROR             238U

/** \brief Multicore channel to master pnc data set error Id */
#if (defined COMM_E_CH_TO_MASTERPNC_DATASET_ERROR)
#error COMM_E_CH_TO_MASTERPNC_DATASET_ERROR already defined
#endif
#define COMM_E_CH_TO_MASTERPNC_DATASET_ERROR      237U

/** \brief Multicore inhibition to channel data set error Id */
#if (defined COMM_E_INHIBITION_TO_CH_DATASET_ERROR)
#error COMM_E_INHIBITION_TO_CH_DATASET_ERROR already defined
#endif
#define COMM_E_INHIBITION_TO_CH_DATASET_ERROR     236U

/** \brief Multicore channel to user data set error Id */
#if (defined COMM_E_CH_TO_USER_DATASET_ERROR)
#error COMM_E_CH_TO_USER_DATASET_ERROR already defined
#endif
#define COMM_E_CH_TO_USER_DATASET_ERROR           235U

/** \brief Multicore master pnc to channel data set error Id */
#if (defined COMM_E_MASTERPNC_TO_CH_DATASET_ERROR)
#error COMM_E_MASTERPNC_TO_CH_DATASET_ERROR already defined
#endif
#define COMM_E_MASTERPNC_TO_CH_DATASET_ERROR      234U
