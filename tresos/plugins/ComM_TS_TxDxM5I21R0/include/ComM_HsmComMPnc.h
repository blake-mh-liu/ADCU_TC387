...
#endif
#define COMM_HSM_COMMPNC_EV_PNC_UPDATE_TX_PASSIVE 1U
...
#if (defined COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED)
#error COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED already defined
#endif
#define COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED 5U
