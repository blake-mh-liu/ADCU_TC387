...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_COMM_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_ENTRY
/** \brief Entry point of function ComM_Nm_ForwardSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_COMM_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_ENTRY(Channel,PncBitVectorPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_COMM_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_EXIT
/** \brief Exit point of function ComM_Nm_ForwardSynchronizedPncShutdown()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_COMM_NM_FORWARDSYNCHRONIZEDPNCSHUTDOWN_EXIT(Channel,PncBitVectorPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
