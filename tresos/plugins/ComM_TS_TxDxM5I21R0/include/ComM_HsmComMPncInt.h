...
typedef enum
{
  ...
  COMM_HSM_COMMPNC_GIDX_PNCPREPARESLEEP_GUARD_2,
  COMM_HSM_COMMPNC_GIDX_PNCREADYSLEEP_GUARD_1,
  COMM_HSM_COMMPNC_GIDX_PNCREADYSLEEP_GUARD_2,
  COMM_HSM_COMMPNC_GIDX_PNCREQUESTED_GUARD_2,
  COMM_HSM_COMMPNC_GIDX_PNCNOCOM_GUARD_1,
  COMM_HSM_COMMPNC_GIDX_PNCNOCOM_GUARD_3,
  COMM_HSM_COMMPNC_GIDX_PNCNOCOM_GUARD_4,
...
extern FUNC(void, COMM_CODE)
 ComM_HsmComMPncSfPncPrepareSleepAction1(
  COMM_PDL_SF(const uint16 instIdx));
/* implements guard 'ComM_PncStateUserRequest[PNC] = 1' */
...
/* implements action 'ComM_TxEiraEraActive(PNC_ID) = 0; ComM_PncSendSignal(PNC); ComM_PNC_RequestComMode (COMM_NO_COMMUNICATION);' */
/* Deviation MISRAC2012-1 */
extern FUNC(void, COMM_CODE)
