...
)
{
...
#if (COMM_NUM_PNC > 0)
  const PNCHandleType NumPncs = COMM_NUM_PNCS_OF_CHANNEL(Channel);
#endif
  ...
  ComM_ASR40_ModeType ComModeWakeupSleepRequest = COMM_NO_COMMUNICATION;

#if (COMM_CURRENTCHANNELREQUEST_ENABLED == STD_ON)
#if ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_ON) || (COMM_DEFAULT_ASR_SERVICE_API == COMM_SERVICE_API_ASR40))
  CONSTP2VAR(ComM_UserHandleArrayType, AUTOMATIC, COMM_VAR) FullComReq =
    &ComM_FullComRequestors[Channel];
#endif /* ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_ON) || (COMM_DEFAULT_ASR_SERVICE_API == COMM_SERVICE_API_ASR40)) */
#if ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_OFF) && (COMM_ENABLE_ASR40_SERVICE_API == STD_ON))
  CONSTP2VAR(ComM_ASR40_UserHandleArrayType, AUTOMATIC, COMM_VAR) FullASR40ComReq =
    &ComM_ASR40_FullComRequestors[Channel];
#endif /* #if ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_OFF) && (COMM_ENABLE_ASR40_SERVICE_API == STD_ON)) */
 ...
 */
  ...
  for (ElementPos = 0U; ElementPos < NumUser; ElementPos++)
  {
    ...
    if (ComModeWakeupSleepRequest < UserReqMode)
    {
      ComModeWakeupSleepRequest = UserReqMode;
    }
  ...
  {
    const ComM_ASR40_ModeType PncReqMode = ComM_EB_GetPncRequestedComMode(Channel, ElementPos);
    if (ComModeWakeupSleepRequest < PncReqMode)
    {
      ComModeWakeupSleepRequest = PncReqMode;
    }
  }
#endif /* #if (COMM_WAKEUPSLEEPREQUEST_ENABLED == STD_ON) */
   ...
   * ComM */
  /* !LINKSTO ComM.SWS_ComM_00092,1 */
  ComM_EB_SetRequestedComMode(Channel, ComMode, ComModeWithoutPnc, ComModeWakeupSleepRequest);

  COMM_CHANNELPNC_EXIT_EXCLUSIVE_AREA(&ComM_HsmScComM , Channel);

  /* signal RTE */
  /* !LINKSTO ComM.EB.RteNrOfRequesters,1 */
#if (COMM_CURRENTCHANNELREQUEST_ENABLED == STD_ON)
#if ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_ON) || (COMM_DEFAULT_ASR_SERVICE_API == COMM_SERVICE_API_ASR40))
  if (ComM_RteWriteCbk[Channel] != NULL_PTR)
  {
    /* For multicore direct function call is enough */
    (void)ComM_RteWriteCbk[Channel](FullComReq);
  }
#endif /* ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_ON) || (COMM_DEFAULT_ASR_SERVICE_API == COMM_SERVICE_API_ASR40)) */
#if ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_OFF) && (COMM_ENABLE_ASR40_SERVICE_API == STD_ON))
  if (ComM_ASR40_RteWriteCbk[Channel] != NULL_PTR)
  {
    (void)ComM_ASR40_RteWriteCbk[Channel](FullASR40ComReq);
  }
#endif /* #if ((COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_OFF) && (COMM_ENABLE_ASR40_SERVICE_API == STD_ON)) */
#endif /* #if (COMM_CURRENTCHANNELREQUEST_ENABLED == STD_ON) */
...
#if (COMM_INCLUDE_RTE == STD_ON)
#if ((COMM_DEFAULT_ASR_SERVICE_API != COMM_SERVICE_API_NONE) || (COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_ON))
/* !LINKSTO ComM.SWS_ComM_00091,1 */
...
)
{
  ...
  /* CHECK: NOPARSE */
  /* When COMM_NUM_USERS is 0 the function ComM_ASR40_GetCurrentComMode will always
   * return E_NOT_OK whcih will make the macros COMM_EB_DEFAULT_RTE_NOTIFY and
   * COMM_EB_ASR40_RTE_NOTIFY and COMM_EB_RTE_NOTIFY not to execute any of the
   * RTE notify functions (ComM_RteNotify, ComM_ASR40_RteNotify unreachable)
   */
#else
...
#endif /* ((COMM_DEFAULT_ASR_SERVICE_API != COMM_SERVICE_API_NONE) || (COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_ON)) */
#endif /* (COMM_INCLUDE_RTE == STD_ON) */
...
#if (COMM_ENABLE_GETCURRENTPNCCOMMODE == STD_ON)
...
#endif /* #if (COMM_ENABLE_GETCURRENTPNCCOMMODE == STD_ON) */
#endif /* #if (COMM_NUM_USERS != 0U) */
#if (COMM_WAKEUP_INHIBITION_ENABLED == STD_ON)
/* !LINKSTO ComM.EB.ASR32.ComM111,1 */
/* Deviation MISRAC2012-2 */
...
/* !LINKSTO ComM.EB.ASR32.ComM111,1, ComM.SWS_ComM_00669,1 */
FUNC(Std_ReturnType, COMM_CODE) ComM_Rte_SetECUGroupClassification
(
  ComM_InhibitionStatusType Status
)
...
#endif /* (COMM_DEFAULT_ASR_SERVICE_API != COMM_SERVICE_API_NONE) */
#endif /* (COMM_INCLUDE_RTE == STD_ON) */
#endif /* (COMM_OS_APPLICATION_MULTICORE_ENABLED == STD_OFF) */
