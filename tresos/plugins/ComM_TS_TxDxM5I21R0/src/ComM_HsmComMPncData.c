  ...
  ComM_HsmComMPncActions[COMM_HSM_COMMPNC_NO_OF_ACTIONS] =
{
  ...
  &ComM_HsmComMPncSfPncRequestedAction2,
  ...
  ComM_HsmComMPncGuards[COMM_HSM_COMMPNC_NO_OF_GUARDS] =
{
  ...
  &ComM_HsmComMPncSfPncPrepareSleepGuard2,
  &ComM_HsmComMPncSfPncReadySleepGuard1,
  &ComM_HsmComMPncSfPncReadySleepGuard2,
  &ComM_HsmComMPncSfPncRequestedGuard2,
  &ComM_HsmComMPncSfPncNoComGuard1,
  &ComM_HsmComMPncSfPncNoComGuard3,
  &ComM_HsmComMPncSfPncNoComGuard4,
};
...
STATIC CONST(ComM_HsmActionIdxType, COMM_CONST)
  ComM_HsmTrPncRequestedSteps1[1] =
{
  COMM_HSM_COMMPNC_AIDX_PNCREQUESTED_ACTION_1,
};
/* trans sequence for transition #2 from state PncRequested */
STATIC CONST(ComM_HsmActionIdxType, COMM_CONST)
  ComM_HsmTrPncRequestedSteps2[2] =
{
  COMM_HSM_COMMPNC_AIDX_PNCREQUESTED_ACTION_2,
  COMM_HSM_COMMPNC_AIDX_PNCREADYSLEEP_ENTRY,
};
...
},
{
  ...
  COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED, /* triggering event */
  COMM_HSM_COMMPNC_GIDX_PNCPREPARESLEEP_GUARD_2, /* guard idx */
...
},
{
  ...
  COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED, /* triggering event */
  COMM_HSM_COMMPNC_GIDX_PNCREADYSLEEP_GUARD_2, /* guard idx */
  COMM_HSM_COMMPNC_SIDX_PNCREQUESTED /* target state */
},
};
/* transitions from state PncRequested */
STATIC CONST(ComM_HsmTranType, COMM_CONST)
 ComM_HsmTrPncRequested[2] =
{
{
...
{
  ComM_HsmTrPncRequestedSteps2,
  sizeof(ComM_HsmTrPncRequestedSteps2)/sizeof(ComM_HsmActionIdxType),
  COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED, /* triggering event */
  COMM_HSM_COMMPNC_GIDX_PNCREQUESTED_GUARD_2, /* guard idx */
  COMM_HSM_COMMPNC_SIDX_PNCREADYSLEEP /* target state */
},
};
...
},
{
  ...
  COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED, /* triggering event */
  COMM_HSM_COMMPNC_GIDX_PNCNOCOM_GUARD_4, /* guard idx */
  COMM_HSM_COMMPNC_SIDX_PNCREQUESTED /* target state */
},
};
  ...
  ComM_HsmScdComMPnc[COMM_HSM_COMMPNC_NO_OF_STATES] =
{
  ...
  },
  {
   ...
   (1UL << COMM_HSM_COMMPNC_EV_PREPARE_SLEEP_TIMEOUT)
    ...
    |   (1UL << COMM_HSM_COMMPNC_EV_PNC_REQ_STATUS_CHANGED)
    ,
      /* ignored event mask */
  ...
  ComM_HsmComMPncGuardNames[] =
{
  ...
  "PncPrepareSleep guard 2",
  "PncReadySleep guard 1",
  "PncReadySleep guard 2",
  "PncRequested guard 2",
  "PncNoCom guard 1",
  "PncNoCom guard 3",
  "PncNoCom guard 4",
};
