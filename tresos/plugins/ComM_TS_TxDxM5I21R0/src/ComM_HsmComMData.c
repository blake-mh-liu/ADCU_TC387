...
#endif
#define COMM_HSM_COMM_NUM_EVENTS 12U
  ...
  ComM_HsmComMActions[COMM_HSM_COMM_NO_OF_ACTIONS] =
{
  ...
  &ComM_HsmComMSfFULL_COMMUNICATIONAction1,
  ...
  &ComM_HsmComMSfFULL_COM_NETWORK_REQUESTED_PENDINGEntry,
...
{
  &ComM_HsmComMSfFULL_COMMUNICATIONGuard3,
...
{
  COMM_HSM_COMM_AIDX_FULL_COMMUNICATION_ACTION_1,
};
...
/* trans sequence for transition #3 from state FULL_COMMUNICATION */
STATIC CONST(ComM_HsmActionIdxType, COMM_CONST)
  ComM_HsmTrFULL_COMMUNICATIONSteps3[1] =
{
  COMM_HSM_COMM_AIDX_NO_COMMUNICATION_ENTRY,
};
...
/* trans sequence for transition #4 from state FULL_COM_NETWORK_REQUESTED */
STATIC CONST(ComM_HsmActionIdxType, COMM_CONST)
  ComM_HsmTrFULL_COM_NETWORK_REQUESTEDSteps4[1] =
{
...
STATIC CONST(ComM_HsmActionIdxType, COMM_CONST)
  ComM_HsmTrFULL_COM_NETWORK_REQUESTED_ENTRYSteps1[2] =
{
  COMM_HSM_COMM_AIDX_FULL_COM_NETWORK_REQUESTED_ENTRY_EXIT,
  COMM_HSM_COMM_AIDX_FULL_COM_NETWORK_REQUESTED_PENDING_ENTRY,
};
...
STATIC CONST(ComM_HsmTranType, COMM_CONST)
 ComM_HsmTrFULL_COMMUNICATION[3] =
{
{
  ComM_HsmTrFULL_COMMUNICATIONSteps1,
  sizeof(ComM_HsmTrFULL_COMMUNICATIONSteps1)/sizeof(ComM_HsmActionIdxType),
  COMM_HSM_COMM_EV_BUSSM_REQUEST_FULL_COM_WITH_WAKEUP_REQUEST, /* triggering event */
  COMM_HSM_GIDX_INVALID, /* no guard */
  COMM_HSM_SIDX_INVALID /* no target state, internal transition */
},
{
...
{
  ComM_HsmTrFULL_COMMUNICATIONSteps3,
  sizeof(ComM_HsmTrFULL_COMMUNICATIONSteps3)/sizeof(ComM_HsmActionIdxType),
  COMM_HSM_COMM_EV_NM_MODE_SWITCHED, /* triggering event */
  COMM_HSM_COMM_GIDX_FULL_COMMUNICATION_GUARD_3, /* guard idx */
  COMM_HSM_COMM_SIDX_NO_COMMUNICATION /* target state */
},
};
/* transitions from state FULL_COM_NETWORK_REQUESTED */
STATIC CONST(ComM_HsmTranType, COMM_CONST)
 ComM_HsmTrFULL_COM_NETWORK_REQUESTED[4] =
{
{
...
{
  ComM_HsmTrFULL_COM_NETWORK_REQUESTEDSteps4,
  sizeof(ComM_HsmTrFULL_COM_NETWORK_REQUESTEDSteps4)/sizeof(ComM_HsmActionIdxType),
  COMM_HSM_COMM_EV_RE_REQUEST_NETWORK, /* triggering event */
  COMM_HSM_GIDX_INVALID, /* no guard */
  ...
  ComM_HsmScdComM[COMM_HSM_COMM_NO_OF_STATES] =
{
  ...
  },
  {
   ...
   (1UL << COMM_HSM_COMM_EV_BUSSM_MODE_IND)
    |   (1UL << COMM_HSM_COMM_EV_BUSSM_REQUEST_FULL_COM_WITH_WAKEUP_REQUEST)
    |   (1UL << COMM_HSM_COMM_EV_BUS_SM_SLEEP_INDICATION)
    |   (1UL << COMM_HSM_COMM_EV_PNC_NM_REQUEST)
    |   (1UL << COMM_HSM_COMM_EV_RE_REQUEST_NETWORK)
  ...
  },
  {
   ...
   (1UL << COMM_HSM_COMM_EV_TIMEOUT)
    ...
    COMM_HSM_COMM_SIDX_FULL_COM_NETWORK_REQUESTED, /* parent state */
    COMM_HSM_SIDX_INVALID, /* no init state */
      COMM_HSM_COMM_AIDX_FULL_COM_NETWORK_REQUESTED_PENDING_ENTRY, /* entry function */
    COMM_HSM_AIDX_INVALID, /* no exit action */
    COMM_HSM_AIDX_INVALID, /* no do action */
    1 /* num of transitions */
  },
  ...
  ComM_HsmComMActionNames[] =
{
  ...
  "FULL_COM_NETWORK_REQUESTED_PENDING entry",
...
{
  "BUSSM_MODE_IND",
  "BUSSM_REQUEST_FULL_COM_WITH_WAKEUP_REQUEST",
