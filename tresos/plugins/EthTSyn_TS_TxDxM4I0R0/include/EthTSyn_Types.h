...
#if (defined ETHTSYN_SYNCFUP_FRAME_MAX_SIZE_ALL_TLVS)
#error ETHTSYN_SYNCFUP_FRAME_MAX_SIZE_ALL_TLVS is already defined
#endif
/* Maximum size of a fup frame(containing all 5 supported AUTOSAR Sub-TLVs). */
/* 406(the max value without timeauth) + 13(maxlength of the time auth without Icv) */
#define ETHTSYN_SYNCFUP_FRAME_MAX_SIZE_ALL_TLVS 419U

#if (defined ETHTSYN_SYNCFUP_RECEIVE_FRAME_MAX_SIZE_ALL_TLVS)
#error ETHTSYN_SYNCFUP_RECEIVE_FRAME_MAX_SIZE_ALL_TLVS is already defined
#endif
/* Maximum size of a fup frame(containing all 5 supported AUTOSAR Sub-TLVs). */
/* 439 = Maximum size of a SyncFUp frame without containing the ICV(1500 - 1061) */
#define ETHTSYN_SYNCFUP_RECEIVE_FRAME_MAX_SIZE_ALL_TLVS (439U + ETHTSYN_MAX_TIMEAUTH_ICV_LENGTH)

#if (defined ETHTSYN_SYNCFUP_MAX_SIZE_FV)
#error ETHTSYN_SYNCFUP_MAX_SIZE_FV is already defined
#endif
/* Maximum size of the freshness value. */
#define ETHTSYN_SYNCFUP_MAX_SIZE_FV 8U

#if (defined ETHTSYN_SYNCFUP_MAX_SIZE_FV_BITS)
#error ETHTSYN_SYNCFUP_MAX_SIZE_FV_BITS is already defined
#endif
/* Maximum size of the freshness value in bits. */
#define ETHTSYN_SYNCFUP_MAX_SIZE_FV_BITS 64U


/*==================[type definitions]======================================*/

/** \brief Transmission mode type */
/* !LINKSTO EthTSyn.SWS_EthTSyn_00033, 1 */
...
/** \brief Value for not configured Fv. */
#if (defined ETHTSYN_FV_NOT_CONFIGURED)
#error ETHTSYN_FV_NOT_CONFIGURED is already defined
#endif
#define ETHTSYN_FV_NOT_CONFIGURED 0xFFFFU

/** \brief Value for not configured Icv. */
#if (defined ETHTSYN_ICV_NOT_CONFIGURED)
#error ETHTSYN_ICV_NOT_CONFIGURED is already defined
#endif
#define ETHTSYN_ICV_NOT_CONFIGURED 0xFFFFU

/** \brief Invalid value of IdsM security event reference (invalid) */
#if (defined ETHTSYN_INVALID_SEV_REF)
#error ETHTSYN_INVALID_SEV_REF already defined!
#endif /* #if( defined ETHTSYN_INVALID_SEV_REF)*/
#define ETHTSYN_INVALID_SEV_REF                   0xFFU

/** \brief size of context data */
#if (defined ETHTSYN_CONTEXT_DATA_SIZE)
#error ETHTSYN_CONTEXT_DATA_SIZE already defined!
#endif /* #if( defined ETHTSYN_CONTEXT_DATA_SIZE)*/
#define ETHTSYN_CONTEXT_DATA_SIZE           1U
...
/** \brief Type for pdelay calculation */
typedef uint8 EthTSyn_IcvSubTlvActionsType;

#if (defined ETHTSYN_AUTH_GENERATION_IDLE)
#error ETHTSYN_AUTH_GENERATION_IDLE is already defined
#endif
#define ETHTSYN_AUTH_GENERATION_IDLE         0x0U

#if (defined ETHTSYN_AUTH_TRANSMIT_FRAME)
#error ETHTSYN_AUTH_TRANSMIT_FRAME is already defined
#endif
#define ETHTSYN_AUTH_TRANSMIT_FRAME           0x01U

#if (defined ETHTSYN_AUTH_WAIT_FOR_INDICATION)
#error ETHTSYN_AUTH_WAIT_FOR_INDICATION is already defined
#endif
#define ETHTSYN_AUTH_WAIT_FOR_INDICATION      0x02U

#if (defined ETHTSYN_AUTH_INDICATION_RECEIVED_TX_FUP)
#error ETHTSYN_AUTH_INDICATION_RECEIVED_TX_FUP is already defined
#endif
#define ETHTSYN_AUTH_INDICATION_RECEIVED_TX_FUP         0x03U

#if (defined ETHTSYN_AUTH_GENERATION_FAILED)
#error ETHTSYN_AUTH_GENERATION_FAILED is already defined
#endif
#define ETHTSYN_AUTH_GENERATION_FAILED         0x04U

#if (defined ETHTSYN_AUTH_GENERATION_IDLE_MASK)
#error ETHTSYN_AUTH_GENERATION_IDLE_MASK is already defined
#endif
#define ETHTSYN_AUTH_GENERATION_IDLE_MASK         0x0U

#if (defined ETHTSYN_AUTH_TRANSMIT_FRAME_MASK)
#error ETHTSYN_AUTH_TRANSMIT_FRAME_MASK is already defined
#endif
#define ETHTSYN_AUTH_TRANSMIT_FRAME_MASK           0x02U

#if (defined ETHTSYN_AUTH_WAIT_FOR_INDICATION_MASK)
#error ETHTSYN_AUTH_WAIT_FOR_INDICATION_MASK is already defined
#endif
#define ETHTSYN_AUTH_WAIT_FOR_INDICATION_MASK      0x04U

#if (defined ETHTSYN_AUTH_INDICATION_RECEIVED_TX_FUP_MASK)
#error ETHTSYN_AUTH_INDICATION_RECEIVED_TX_FUP_MASK is already defined
#endif
#define ETHTSYN_AUTH_INDICATION_RECEIVED_TX_FUP_MASK         0x08U

#if (defined ETHTSYN_AUTH_GENERATION_FAILED_MASK)
#error ETHTSYN_AUTH_GENERATION_FAILED_MASK is already defined
#endif
#define ETHTSYN_AUTH_GENERATION_FAILED_MASK         0x10U


/** \brief Type for pdelay calculation */
typedef uint8 EthTSyn_IcvVerificationNextActType;

#if (defined ETHTSYN_AUTH_VERIFICATION_IDLE)
#error ETHTSYN_AUTH_VERIFICATION_IDLE is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_IDLE         0x0U

#if (defined ETHTSYN_AUTH_VERIFICATION_PASSED)
#error ETHTSYN_AUTH_VERIFICATION_PASSED is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_PASSED           0x01U

#if (defined ETHTSYN_AUTH_VERIFICATION_WAIT_INDICATION)
#error ETHTSYN_AUTH_VERIFICATION_WAIT_INDICATION is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_WAIT_INDICATION      0x02U

#if (defined ETHTSYN_AUTH_VERIFICATION_FV_RETRY)
#error ETHTSYN_AUTH_VERIFICATION_FV_RETRY is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_FV_RETRY         0x03U

#if (defined ETHTSYN_AUTH_VERIFICATION_ICV_RETRY)
#error ETHTSYN_AUTH_VERIFICATION_ICV_RETRY is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_ICV_RETRY         0x04U

#if (defined ETHTSYN_AUTH_VERIFICATION_FAILED)
#error ETHTSYN_AUTH_VERIFICATION_FAILED is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_FAILED         0x05U

#if (defined ETHTSYN_AUTH_VERIFICATION_IDLE_MASK)
#error ETHTSYN_AUTH_VERIFICATION_IDLE_MASK is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_IDLE_MASK         1U

#if (defined ETHTSYN_AUTH_VERIFICATION_PASSED_MASK)
#error ETHTSYN_AUTH_VERIFICATION_PASSED_MASK is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_PASSED_MASK           2U

#if (defined ETHTSYN_AUTH_VERIFICATION_WAIT_INDICATION_MASK)
#error ETHTSYN_AUTH_VERIFICATION_WAIT_INDICATION_MASK is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_WAIT_INDICATION_MASK      4U

#if (defined ETHTSYN_AUTH_VERIFICATION_FV_RETRY_MASK)
#error ETHTSYN_AUTH_VERIFICATION_FV_RETRY_MASK is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_FV_RETRY_MASK         8U

#if (defined ETHTSYN_AUTH_VERIFICATION_ICV_RETRY_MASK)
#error ETHTSYN_AUTH_VERIFICATION_ICV_RETRY_MASK is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_ICV_RETRY_MASK         16U

#if (defined ETHTSYN_AUTH_VERIFICATION_FAILED_MASK)
#error ETHTSYN_AUTH_VERIFICATION_FAILED_MASK is already defined
#endif
#define ETHTSYN_AUTH_VERIFICATION_FAILED_MASK         32U
...
typedef struct
{
  ...
  Eth_TimeStampType SyncEgressTimeStamp;
#else
...
#if(ETHTSYN_ICV_USED == STD_ON)
  uint32 IcvIndication_Timeout; /* value of EthTSynGlobalTimeTxIcvGeneration if configured. */
  uint32 SyncFUp_BufIdx; /* BufIdx used to identify the txconfirmation of a fup frame. */
#endif
...
#endif
#if(ETHTSYN_ICV_USED == STD_ON)
  uint16 TimeAuthTotalLength; /* Total length of the time auth frame (header + fv + icv) */
  uint16 IcvAuthTlvOffset; /* Offset where the icv is started. */
#endif
...
#endif
#if(ETHTSYN_ICV_USED == STD_ON)
  uint8 BufferSubTlv[ETHTSYN_SYNCFUP_FRAME_MAX_SIZE_ALL_TLVS]; /* Buf to keep the fup frame. */
  uint8 NrOfIcvSegments; /* If the  is bigger than max value of the first sub-tlv, */
  uint8 StartOfTimeAuthTlv; /* Where the time auth subtlv will start. */
  EthTSyn_IcvSubTlvActionsType NextActionIcv; /* Next action to be processed. */
#endif
#if(ETHTSYN_HW_TIMESTAMP_SUPPORT != STD_ON)
...
typedef struct
{
...
#if (ETHTSYN_IEEE1588_CONFIGURED == STD_ON)
  /* Backup value, used in case that T1 > T4 (delay_resp received before the Sync) */
  Eth_TimeStampType Backup_Delay_TimeStamp_t1;
  /* Backup value, used in case that T1 > T4 (delay_req transmittted before receiving the Fup) */
  Eth_TimeStampType Backup_Delay_TimeStamp_t2;
  Eth_TimeIntDiffType SyncCorrection; /* Sync correction. Used for PTP with E2E mechanism. */
  Eth_TimeIntDiffType CorrectedSyncCorrection; /* Corrected sync correction. Used for PTP with E2E mechanism. */
  Eth_TimeIntDiffType CorrectionSyncFupCorrection; /* Fup correction. Used for PTP with E2E mechanism. */
  Eth_TimeIntDiffType CorrectionDelayRespCorrection; /* Delay_Resp correction. Used for PTP with E2E mechanism. */
  Eth_TimeIntDiffType BackupCorrectedSyncCorrection; /* Backup variable. Used for PTP with E2E mechanism. */
  Eth_TimeIntDiffType BackupCorrectionSyncFupCorrection; /* Backup variable. Used for PTP with E2E mechanism. */
#endif /* ETHTSYN_IEEE1588_CONFIGURED == STD_ON */
#if(ETHTSYN_BRIDGE_WITH_GTM_NOT_MGM_CPU == STD_ON)
  ...
  StbM_VirtualLocalTimeType SyncReceptionDelay;
#if(ETHTSYN_ICV_USED == STD_ON)
  StbM_VirtualLocalTimeType VirtualTimeToBePassed2StbM;
  StbM_TimeStampType TimeToBePassed2StbM;
  StbM_MeasurementType MeasureDataToBePassed2StbM;
  StbM_UserDataType UserDataToBePassed2StbM;
#endif
  uint32 Pdelay; /* Propagation delay in nanoseconds. */
  P2VAR(uint32, AUTOMATIC, ETHTSYN_APPL_DATA) RemotePDelay; /* Use Pdelay value from another TimeDomain. */
  uint32 PdelayFollowUpTimeout;
  uint32 GlobalTimeFollowUpTimeout; /* Timeout value of the Follow_Up message. */
  uint32 GlobalTimeRxDebounceTime; /* Timeout value of the Sync/Fup message. */
#if(ETHTSYN_ICV_USED == STD_ON)
  uint32 IcvVerificationTimeout; /* Timeout of ICV generation. */
  uint32 FreshnessValueLength; /* Holds the length in bits of the freshness value. */
#endif
...
#if(ETHTSYN_ICV_USED == STD_ON)
  uint16 TimeAuthVerificationAttempts; /* The number of timeauth verification attempts */
  uint16 ReceivedIcvLength;
#endif
  /* If a Time Base Timeout is present the TimeSlave will need GlobalTimeSequenceCounterHysteresis
  pairs of valid Sync/SyncFUp frames received in order to send the time to StbM. */
  uint8 ValidSyncSyncFUpPairs;
...
#if(ETHTSYN_ICV_USED == STD_ON)
  uint8 BufferSubTlv[ETHTSYN_SYNCFUP_RECEIVE_FRAME_MAX_SIZE_ALL_TLVS]; /* Buf to keep the fup frame. */
  uint8 FreshnessValueReceived[ETHTSYN_SYNCFUP_MAX_SIZE_FV]; /* Buf to keep the fup frame. */
  uint8 FreshnessValueStbM[ETHTSYN_SYNCFUP_MAX_SIZE_FV]; /* Buf to keep the fup frame. */
#if(ETHTSYN_MAX_SLAVE != 0U)
  uint8 BufferReceivedIcv[ETHTSYN_MAX_TIMEAUTH_ICV_LENGTH]; /* Buf to keep the fup frame. + FV(if received) */
#endif
  uint8 ReceivedFvLength;
  uint8 StartOfTimeAuthTlv; /* Where the time auth subtlv will start. */
  EthTSyn_IcvVerificationNextActType VerifIcvAction; /* Next action to be processed. */
  Crypto_VerifyResultType VerificationResult;
#endif
...
#endif
#if (ETHTSYN_IEEE1588_CONFIGURED == STD_ON)
  boolean ValidSyncFupReceived; /* The meanPathDelay shall be calculated only if a valid pair of Sync/Fup was received. */
#endif /* ETHTSYN_IEEE1588_CONFIGURED == STD_ON */
...
typedef struct
{
  ...
  uint32 GlobalTimeDebounceTimeOffset;
  /* To store incoming sequence number. */
  uint16 Ingress_PdelayReqSequNumber;
  ...
  EthTSyn_CtrlDebounceFramePrioType Frame2Transmit;
  uint8 EthTSynMaxNumberOfRetries;
  uint8 Pdelay_Rx_SrcPortIdentity[ETHTSYN_SOURCEPORTIDENTITY_SIZE];
