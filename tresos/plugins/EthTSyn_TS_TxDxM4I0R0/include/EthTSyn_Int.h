...
#if (defined ETHTSYN_MAX_SIGNED_CORRECTIONFIELD)
#error ETHTSYN_MAX_SIGNED_CORRECTIONFIELD is already defined
#endif
#define ETHTSYN_MAX_SIGNED_CORRECTIONFIELD (uint64) 0x7FFFFFFFFFFFU

#if (defined ETHTSYN_MAX_SECONDS_CORRECTIONFIELD_VALUE)
#error ETHTSYN_MAX_SECONDS_CORRECTIONFIELD_VALUE is already defined
#endif
#define ETHTSYN_MAX_SECONDS_CORRECTIONFIELD_VALUE (uint32) 0x225C1U

#if (defined ETHTSYN_MAX_NANOSECONDS_CORRECTIONFIELD_VALUE)
#error ETHTSYN_MAX_NANOSECONDS_CORRECTIONFIELD_VALUE is already defined
#endif
#define ETHTSYN_MAX_NANOSECONDS_CORRECTIONFIELD_VALUE (uint32) 0x1D1BB5FFU
...
#if (defined ETHTSYN_UNUSED_PORTIDX)
#error ETHTSYN_UNUSED_PORTIDX is already defined
#endif
#define ETHTSYN_UNUSED_PORTIDX 0U
