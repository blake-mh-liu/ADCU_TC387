...
#if(ETHTSYN_PBCFG_COMPILE == STD_ON)
[!LOOP "variant:all()"!][!//
...
#endif /* ETHTSYN_PBCFG_COMPILE == STD_ON */
/*==================[macros]=================================================*/
...
/*==================[external constants]=====================================*/
#define ETHTSYN_START_SEC_CONST_8
#include <EthTSyn_MemMap.h>

/* !LINKSTO EthTSyn.PRS_TS_00002, 1 */
...
#define ETHTSYN_STOP_SEC_CONST_8
#include <EthTSyn_MemMap.h>
/*==================[external data]==========================================*/
