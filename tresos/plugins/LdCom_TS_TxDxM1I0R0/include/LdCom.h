 ...
 *
 *   Reason:
 *   LdCom_Transmit will be available only once depending on the macro
 *   LDCOM_TP_TRANSMIT_HANDLEID_POLICY.
 *
...
/* !LINKSTO LdCom.SWS_LDCOM_00002,1 */
...
#else
/* Initiate a transmission of a signal. */
/* Deviation MISRAC2012-1, MISRAC2012-2 */
extern FUNC(Std_ReturnType, LDCOM_CODE) LdCom_Transmit
(
  PduIdType Id,
