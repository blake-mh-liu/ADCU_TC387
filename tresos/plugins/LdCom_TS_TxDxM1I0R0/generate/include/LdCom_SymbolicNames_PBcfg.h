...
[!INDENT "0"!][!//
  [!LOOP "LdComConfig/LdComIPdu/*"!]
    ...
    [!CALL "GenSymbols",
      ...
      "PduName"="as:name(node:ref(./LdComPduRef))"!]
  [!ENDLOOP!]
[!ENDINDENT!][!//
...
[!INDENT "0"!][!//
  [!LOOP "LdComConfig/LdComIPdu/*[./LdComIPduDirection = 'LDCOM_SEND']"!]
    ...
    */!][!CALL "GetOutputPduId","LdComPduRef"="./LdComPduRef"!]
    #if (defined PDUR_SOURCE_PDUID_[!"node:name(./..)"!]_[!"as:name(.)"!])
    #error PDUR_SOURCE_PDUID_[!"node:name(./..)"!]_[!"as:name(.)"!] is already defined
    #endif
    /* [!"node:path(LdComPduRef)"!] */
    #define PDUR_SOURCE_PDUID_[!"node:name(./..)"!]_[!"as:name(.)"!] [!"num:i($PduID)"!]U /* [!"as:name(node:ref(LdComPduRef))"!] */
  [!ENDLOOP!][!//
[!ENDINDENT!][!//
#endif
