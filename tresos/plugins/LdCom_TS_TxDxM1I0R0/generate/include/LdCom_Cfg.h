...
#if (defined LDCOM_TP_TRANSMIT_HANDLEID_POLICY)
#error LDCOM_TP_TRANSMIT_HANDLEID_POLICY already defined
#endif
/** \brief Macro for TP Transmit Handle usage */
#define LDCOM_TP_TRANSMIT_HANDLEID_POLICY [!//
[!IF "VendorSpecific/LdComTpTransmitHandleIdPolicy = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#define LDCOM_CFG_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('LdCom')[1], 'PreCompile', as:modconf('LdCom')[1]/VendorSpecific/LdComUpperLayerHeaderFile | as:modconf('LdCom')[1]/VendorSpecific/LdComUpperLayerHeaderFile/*)"!]U
...
#define LDCOM_PUBLIC_INFO_SIGNATURE  [!"asc:calculateConfigSignature(as:modconf('LdCom')[1]/CommonPublishedInformation, 'PublishedInformation', as:modconf('LdCom')[1]/CommonPublishedInformation/Release)"!]U
