...
CONST(uint32, LDCOM_CONST) LdCom_LcfgSignature = [!"asc:calculateConfigSignature(as:modconf('LdCom')[1], 'Link')"!]U; /* LcfgSignature */
...
{[!/*
*/!][!LOOP "util:distinct(node:order(as:modconf('LdCom')[1]/LdComConfig/LdComIPdu/*[./LdComApiType='LDCOM_TP'][./LdComIPduDirection='LDCOM_RECEIVE'], 'node:LdComHandleId'))"!]
...
{[!/*
*/!][!LOOP "util:distinct(node:order(as:modconf('LdCom')[1]/LdComConfig/LdComIPdu/*[./LdComApiType='LDCOM_TP'][./LdComIPduDirection='LDCOM_SEND'], 'node:LdComHandleId'))"!]
  { /* [[!"./LdComHandleId"!]] [!"node:name(.)"!] */[!INDENT "4"!]
...
{[!/*
*/!][!LOOP "util:distinct(node:order(as:modconf('LdCom')[1]/LdComConfig/LdComIPdu/*[./LdComApiType='LDCOM_IF'][./LdComIPduDirection='LDCOM_RECEIVE'], 'node:LdComHandleId'))"!]
  { /* [[!"./LdComHandleId"!]] [!"node:name(.)"!] */[!INDENT "4"!]
...
{[!/*
*/!][!LOOP "util:distinct(node:order(as:modconf('LdCom')[1]/LdComConfig/LdComIPdu/*[./LdComApiType='LDCOM_IF'][./LdComIPduDirection='LDCOM_SEND'], 'node:LdComHandleId'))"!]
  { /* [[!"./LdComHandleId"!]] [!"node:name(.)"!] */[!INDENT "4"!]
