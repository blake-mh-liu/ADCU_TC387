...
[!VAR "LinSMIDComMMin" = "num:min(util:distinct(node:refs(as:modconf('LinSM')[1]/LinSMConfigSet/*[1]/LinSMChannel/*/LinSMComMNetworkHandleRef))/ComMChannelId)"!]
[!/* node:isconsecutive() doesn't care about the order but it's ok since the channels are ordered by ComM ID */!]
[!VAR "LinSMComMIDsConsecutive" = "node:isconsecutive(util:distinct(node:refs(as:modconf('LinSM')[1]/LinSMConfigSet/*[1]/LinSMChannel/*/LinSMComMNetworkHandleRef))/ComMChannelId, $LinSMIDComMMin)"!]

[!VAR "LinSMIDLinIfMin" = "'255'"!]
[!LOOP "as:modconf('LinSM')[1]/LinSMConfigSet/*[1]/LinSMChannel/*"!]
  [!IF "LinSMNodeType = 'MASTER'"!]
    [!VAR "LinSMIDLinIfMinTmp" = "num:min(util:distinct(node:refs(LinSMSchedule/*/LinSMScheduleIndexRef))/../../../*/LinIfChannelId)"!]
  [!ELSE!]
    [!VAR "assocComMChanID" = "LinSMComMNetworkHandleRef"!]
    [!VAR "LinSMIDLinIfMinTmp" = "num:i(as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfChannelId[../LinIfComMNetworkHandleRef = string($assocComMChanID)])"!]
  [!ENDIF!]
...
[!LOOP "util:distinct(node:order(as:modconf('LinSM')[1]/LinSMConfigSet/*[1]/LinSMChannel/*,'as:ref(LinSMComMNetworkHandleRef)/ComMChannelId'))"!]
  [!IF "LinSMNodeType = 'MASTER'"!]
  ...
  [!ELSE!]
      [!VAR "assocComMChanID" = "LinSMComMNetworkHandleRef"!]
      [!VAR "LinSMAssocLinIfHandles" = "concat($LinSMAssocLinIfHandles, num:i(as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfChannelId[../LinIfComMNetworkHandleRef = string($assocComMChanID)]), ',')"!]
  [!ENDIF!]
[!ENDLOOP!]
...
[!LOOP "util:distinct(node:order(as:modconf('LinSM')[1]/LinSMConfigSet/*[1]/LinSMChannel/*,'as:ref(LinSMComMNetworkHandleRef)/ComMChannelId'))"!]
  ...
  [!ELSE!]
    [!VAR "assocComMChanID" = "LinSMComMNetworkHandleRef"!]
    [!VAR "assocLinIfChanID" = "node:when($LinSMIDMapLinIfType = 'LUT', num:i(as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfChannelId[../LinIfComMNetworkHandleRef = string($assocComMChanID)]), $chanPos)"!]
  [!ENDIF!]
