...
/* !LINKSTO LinSM.SWS_LinSM_00243,1 */
...
/* !LINKSTO LinSM.SWS_LinSM_91000_EB,1 */
...
)
{
  ...
  {
    /* !LINKSTO LinSM.SWS_LinSM_00240,1 */
  ...
  else
  {
    ...
    {
      /* !LINKSTO LinSM.SWS_LinSM_00239,1 */
...
#endif
    {
      ...
      /* !LINKSTO LinSM.SWS_LinSM_00232,1 */
      if (( currentState == LINSM_FULL_COM ) || (currentState == LINSM_WAKEUP) || (currentState == LINSM_NO_COM))
      {
        /* !LINKSTO LinSM.SWS_LinSM_00231_EB,1 */
        LinSM_GotoSleep(id);
