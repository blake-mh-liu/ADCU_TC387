...
#if (defined CANTSYN_SID_ICVGENERATIONINDICATION)
#error CANTSYN_SID_ICVGENERATIONINDICATION is already defined
#endif /* if (defined CANTSYN_SID_ICVGENERATIONINDICATION) */

/** \brief Defines API id of function CanTSyn_IcvGenerationIndication(). */
#define CANTSYN_SID_ICVGENERATIONINDICATION 0x07U

#if (defined CANTSYN_SID_ICVVERIFICATIONINDICATION)
#error CANTSYN_SID_ICVVERIFICATIONINDICATION is already defined
#endif /* if (defined CANTSYN_SID_ICVVERIFICATIONINDICATION) */

/** \brief Defines API id of function CanTSyn_IcvVerificationIndication(). */
#define CANTSYN_SID_ICVVERIFICATIONINDICATION 0x08U
...
#if (defined CANTSYN_E_FRESHNESSFAILURE)
#error CANTSYN_E_FRESHNESSFAILURE is already defined
#endif /* if (defined CANTSYN_E_FRESHNESSFAILURE) */
/** \brief Error code for reporting freshness failure to DET. */
#define CANTSYN_E_FRESHNESSFAILURE 0x01U  /**< DET error code: No FV available from the FVM */
