...
/* patch version check */
#if (FEE_SW_PATCH_VERSION < 31U)
#error FEE_SW_PATCH_VERSION wrong (< 31U)
#endif
...
VAR(Fee_State_t, FEE_VAR) Fee_PendingState_CancelOngoing = FEE_STATE_INVALID;
#endif
...
VAR(Fee_BlockConfiguration_t, FEE_VAR) Fee_NotCfgBlocks[FEE_NUMBER_NOT_CONFIGURED_BLOCKS];
#endif
...
#include <Fee_MemMap.h>
#else
#define FEE_START_SEC_VAR_CLEARED_64
#include <Fee_MemMap.h>
#endif

STATIC uint8 FeeBuffer[FEE_BUFFER_SIZE];
...
#include <Fee_MemMap.h>
#else
#define FEE_STOP_SEC_VAR_CLEARED_64
#include <Fee_MemMap.h>
#endif
...
#if (FEE_USE_MEMACC == STD_ON)
  {NULL_PTR, &Fee_SfCancelOngoingState},
#endif
};
...
)
{
  ...
  /* address of block info - not available, meaning that no space has been reserved for immediate blocks yet */
  Fee_Gv.FeeInfoAddressReserved = 0U;
  /* address of block data - not available, meaning that no space has been reserved for immediate blocks yet */
...
)
{
...
#endif /* ((FEE_WRITE_CUSTOM_API == STD_ON) || (FEE_READ_CUSTOM_API == STD_ON)) */
  {
...
#endif /* (FEE_CRITICAL_BLOCK_NUMBER != 0U) */
    {
      ...
      /* !LINKSTO Fee.SWS_Fee_00022,1 */
      /* !LINKSTO Fee.SWS_Fee_00172,1 */
      if (FEE_UNINIT == Fee_State)
      {
#if (FEE_DEV_ERROR_DETECT == STD_ON)
...
)
{
...
#endif /* ((FEE_WRITE_CUSTOM_API == STD_ON) || (FEE_READ_CUSTOM_API == STD_ON)) */
  {
...
#endif /* (FEE_CRITICAL_BLOCK_NUMBER != 0U) */
    {
      ...
      {
        /* !LINKSTO Fee.ASR40.SWS_Fee_00145,1 */
#if (FEE_DEV_ERROR_DETECT == STD_ON)
...
)
{
...
#endif /* ((FEE_WRITE_CUSTOM_API == STD_ON) || (FEE_READ_CUSTOM_API == STD_ON)) */
  {
...
#endif /* (FEE_CRITICAL_BLOCK_NUMBER != 0U) */
    {
      ...
      {
        /* !LINKSTO Fee.ASR40.SWS_Fee_00146,1 */
#if (FEE_DEV_ERROR_DETECT == STD_ON)
