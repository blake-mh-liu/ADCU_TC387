...
typedef struct
{
  Ea_LowerLayer_AddressType StartAddress; /**< Start address */
  Ea_LowerLayer_LengthType BlockPageSize; /**< Block size with full pages (bytes) */
  uint16 UserDataSize;
    /**< Size of user data (bytes).
         Data-type uint16 is used inplace of Ea_LowerLayer_LengthType as value
