...
#if (defined SOMEIPXF_BDT_WITHOUT_BUFFLENGTH_CHECK)
#error SOMEIPXF_BDT_WITHOUT_BUFFLENGTH_CHECK is already defined
#endif

#if (defined SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK)
#error SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK is already defined
#endif
...
#if (defined SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK_START)
#error SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK_START is already defined
#endif
...
#if (defined SOMEIPXF_FSA_OF_BDT_WITH_BUFFERLENGTH_CHECK_START)
#error SOMEIPXF_FSA_OF_BDT_WITH_BUFFERLENGTH_CHECK_START is already defined
#endif
...
#if (defined SOMEIPXF_FSA_OF_BASIC_DATA_TYPE_WITH_LF_START)
#error SOMEIPXF_FSA_OF_BASIC_DATA_TYPE_WITH_LF_START is already defined
#endif

#if (defined SOMEIPXF_FSA_OF_BDT_WITH_BUFFERLENGTH_CHECK_LF_START)
#error SOMEIPXF_FSA_OF_BDT_WITH_BUFFERLENGTH_CHECK_LF_START is already defined
#endif

#if (defined SOMEIPXF_FSA_OF_BASIC_DATA_TYPE_WITH_LF_STOP)
#error SOMEIPXF_FSA_OF_BASIC_DATA_TYPE_WITH_LF_STOP is already defined
#endif
...
#if (defined SOMEIPXF_FSA_OF_FSA_START)
#error SOMEIPXF_FSA_OF_FSA_START is already defined
#endif

#if (defined SOMEIPXF_FSA_OF_FSA_STOP)
#error SOMEIPXF_FSA_OF_FSA_STOP is already defined
#endif

#if (defined SOMEIPXF_FSA_ELEMENT_ENTER)
#error SOMEIPXF_FSA_ELEMENT_ENTER is already defined
#endif

#if (defined SOMEIPXF_STRUCT_TLV_START)
#error SOMEIPXF_STRUCT_TLV_START is already defined
#endif

#if (defined SOMEIPXF_STRUCT_TLV_STOP)
#error SOMEIPXF_STRUCT_TLV_STOP is already defined
#endif

#if (defined SOMEIPXF_STRUCT_TLV_MEMBER_OPT_START)
#error SOMEIPXF_STRUCT_TLV_MEMBER_OPT_START is already defined
#endif

#if (defined SOMEIPXF_STRUCT_TLV_MEMBER_OPT_STOP)
#error SOMEIPXF_STRUCT_TLV_MEMBER_OPT_STOP is already defined
#endif

#if (defined SOMEIPXF_STRUCT_TLV_MEMBER_FIX_START)
#error SOMEIPXF_STRUCT_TLV_MEMBER_FIX_START is already defined
#endif

#if (defined SOMEIPXF_STRUCT_TLV_MEMBER_FIX_STOP)
#error SOMEIPXF_STRUCT_TLV_MEMBER_FIX_STOP is already defined
#endif

#if (defined SOMEIPXF_ARG_TLV_START)
#error SOMEIPXF_ARG_TLV_START is already defined
#endif

/* Data type (uint16 or uint32) defines element config data size
 * This also defines the mask for BDT overflow check.
 */
#if (SOMEIPXF_XFRMBUFFERLENGTHTYPE_ISUINT32 == STD_ON)
#define SOMEIPXF_DATATYPE_MAX                              UINT32_C(0xFFFFFFFF)
#define SOMEIPXF_BDT_WITHOUT_BUFFLENGTH_CHECK              UINT32_C(0xFFFFFFFF)
#define SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK               UINT32_C(0xFFFFFFFE)
#else
#define SOMEIPXF_DATATYPE_MAX                              UINT16_C(0xFFFF)
#define SOMEIPXF_BDT_WITHOUT_BUFFLENGTH_CHECK              UINT16_C(0xFFFF)
#define SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK               UINT16_C(0xFFFE)
#endif
...
#define SOMEIPXF_BDT_WITH_BUFFERLENGTH_CHECK_START              (SOMEIPXF_DATATYPE_MAX - 3U)
#define SOMEIPXF_BASIC_DATA_TYPE_STOP                           (SOMEIPXF_DATATYPE_MAX - 5U)
#define SOMEIPXF_FSA_OF_BASIC_TYPE_START                        (SOMEIPXF_DATATYPE_MAX - 6U)
#define SOMEIPXF_FSA_OF_BDT_WITH_BUFFERLENGTH_CHECK_START       (SOMEIPXF_DATATYPE_MAX - 7U)
#define SOMEIPXF_FSA_OF_BASIC_TYPE_STOP                         (SOMEIPXF_DATATYPE_MAX - 9U)
#define SOMEIPXF_FSA_OF_STRUCT_START                            (SOMEIPXF_DATATYPE_MAX - 11U)
#define SOMEIPXF_FSA_OF_STRUCT_STOP                             (SOMEIPXF_DATATYPE_MAX - 13U)
#define SOMEIPXF_FSA_OF_FSA_START                               (SOMEIPXF_DATATYPE_MAX - 15U)
#define SOMEIPXF_FSA_OF_FSA_STOP                                (SOMEIPXF_DATATYPE_MAX - 17U)
#define SOMEIPXF_STRUCT_WITH_LF_START                           (SOMEIPXF_DATATYPE_MAX - 19U)
#define SOMEIPXF_STRUCT_WITH_LF_STOP                            (SOMEIPXF_DATATYPE_MAX - 21U)
#define SOMEIPXF_FSA_WITH_LF_START                              (SOMEIPXF_DATATYPE_MAX - 23U)
#define SOMEIPXF_FSA_WITH_LF_STOP                               (SOMEIPXF_DATATYPE_MAX - 25U)
#define SOMEIPXF_FSA_ELEMENT_ENTER                              (SOMEIPXF_DATATYPE_MAX - 27U)
#define SOMEIPXF_FSA_OF_BASIC_DATA_TYPE_WITH_LF_START           (SOMEIPXF_DATATYPE_MAX - 28U)
#define SOMEIPXF_FSA_OF_BDT_WITH_BUFFERLENGTH_CHECK_LF_START    (SOMEIPXF_DATATYPE_MAX - 29U)
#define SOMEIPXF_FSA_OF_BASIC_DATA_TYPE_WITH_LF_STOP            (SOMEIPXF_DATATYPE_MAX - 31U)
#define SOMEIPXF_VSA_START                                      (SOMEIPXF_DATATYPE_MAX - 33U)
#define SOMEIPXF_VSA_STOP                                       (SOMEIPXF_DATATYPE_MAX - 35U)
#define SOMEIPXF_VSA_ELEMENT_CHECK_POINT                        (SOMEIPXF_DATATYPE_MAX - 37U)
#define SOMEIPXF_VSA_ELEMENT_ENTER                              (SOMEIPXF_DATATYPE_MAX - 39U)
#define SOMEIPXF_STRUCT_TLV_START                               (SOMEIPXF_DATATYPE_MAX - 41U)
#define SOMEIPXF_STRUCT_TLV_STOP                                (SOMEIPXF_DATATYPE_MAX - 43U)
#define SOMEIPXF_STRUCT_TLV_MEMBER_OPT_START                    (SOMEIPXF_DATATYPE_MAX - 45U)
#define SOMEIPXF_STRUCT_TLV_MEMBER_OPT_STOP                     (SOMEIPXF_DATATYPE_MAX - 47U)
#define SOMEIPXF_STRUCT_TLV_MEMBER_FIX_START                    (SOMEIPXF_DATATYPE_MAX - 49U)
#define SOMEIPXF_STRUCT_TLV_MEMBER_FIX_STOP                     (SOMEIPXF_DATATYPE_MAX - 51U)
#define SOMEIPXF_ARG_TLV_START                                  (SOMEIPXF_DATATYPE_MAX - 53U)
#define SOMEIPXF_DATA_ELEMENT_STOP                              (SOMEIPXF_DATATYPE_MAX - 55U)
...
#define SOMEIPXF_MEMBER_SIZE(datatype, member) sizeof(((datatype *)(void *)0)->member)
 ...
 *  */
#define SOMEIPXF_SET_TLV_STRUCT_CONFIG(LFSize, availabilityBitfield_path, FixMemNum, DataIDNum) \
   (LFSize),                                                                                    \
   offsetof(SOMEIPXF_DATA_TYPE_NAME, availabilityBitfield_path),                                \
   sizeof(((SOMEIPXF_DATA_TYPE_NAME *)(void *)0)->availabilityBitfield_path),                           \
   (FixMemNum),                                                                                 \
   (DataIDNum)
 ...
 *  */
#define SOMEIPXF_SET_TLV_STRUCT_OPT_MEMBER_CONFIG(WireType, DataId, OptionalMemberIndex) \
   (WireType),                                                                           \
   (DataId),                                                                             \
   (OptionalMemberIndex)
...
#if (defined SOMEIPXF_DT_WITH_LF) /* to prevent double declaration */
#error SOMEIPXF_DT_WITH_LF already defined
#endif /* if (defined SOMEIPXF_GET_REQUEST_ID) */
...
#define SOMEIPXF_DT_WITH_LF   ( (SOMEIPXF_VSA_AVAILABLE == STD_ON) || \
...
#define SOMEIPXF_CONFIGNAME(ConfigID) SomeIpXf_Config_ ## ConfigID
...
#define SOMEIPXF_S_SR_DEF_FUNC_XF_HLP(XfrmName, DataType, PassMethodType, PassMethodCheck,       \
    PassMethod, InterfaceVersion, MessageType, fctName,                                          \
    ...
    {                                                                                            \
        ...
        *BufferLength = SOMEIPXF_HEADER_LENGTH;                                                  \
        ...
        RetVal = fctName(                                                                        \
            ...
            &SOMEIPXF_CONFIGNAME(ConfigID)[0]                                                    \
        );                                                                                       \
    }                                                                                            \
    return RetVal;                                                                               \
}
...
SOMEIPXF_S_SR_DEF_FUNC_XF_HLP(XfrmName, DataType, SOMEIPXF_ARG_ ## PassMethod,                    \
    ...
    MessageType, SomeIpXf_S_GenericTransformer, ConfigID, SessionHandling_Status)
...
#define SOMEIPXF_S_SR_DEF_FUNC_INVXF_HLP(XfrmName, DataType, InterfaceVersion,                 \
    fctName, ConfigID)                                                                         \
FUNC(uint8, SOMEIPXF_CODE) XfrmName                                                            \
(                                                                                              \
...
{                                                                                              \
    ...
    {                                                                                          \
        SomeIpXf_InvXfrmInfoType SomeIpXf_InvXfrmInfo;                                         \
        /*Initialize the bytes processed to size of someipxf header i.e 8 bytes  */            \
        SomeIpXf_InvXfrmInfo.BytesCopiedFromBuffer = SOMEIPXF_HEADER_LENGTH;                   \
        /*Initialize the overflow check for de-serialization to disbaled mask */               \
        SomeIpXf_InvXfrmInfo.BufferLengthCheck = SOMEIPXF_BDT_WITHOUT_BUFFLENGTH_CHECK;        \
        /* header of sender/receiver communication */                                          \
        RetVal = SomeIpXf_SR_GetHeader(Buffer, InterfaceVersion);                              \
        if(RetVal == E_OK)                                                                     \
        {                                                                                      \
            if(BufferLength > SomeIpXf_InvXfrmInfo.BytesCopiedFromBuffer)                      \
            {                                                                                  \
                RetVal = fctName(                                                              \
                    &Buffer[SomeIpXf_InvXfrmInfo.BytesCopiedFromBuffer],                       \
                    BufferLength,                                                              \
                    (P2VAR(void, AUTOMATIC, SOMEIPXF_APPL_DATA))DataElement,                   \
                    &SomeIpXf_InvXfrmInfo,                                                     \
                    &SOMEIPXF_CONFIGNAME(ConfigID)[0]                                          \
                );                                                                             \
                                                                                               \
                if( (RetVal == E_OK) && (SomeIpXf_InvXfrmInfo.BytesCopiedFromBuffer > BufferLength) ) \
                {                                                                              \
 ...
 */
#define SOMEIPXF_S_SR_DEF_FUNC_INVXF(XfrmName, DataType, InterfaceVersion, ConfigID)              \
SOMEIPXF_S_SR_DEF_FUNC_INVXF_HLP(XfrmName, DataType, InterfaceVersion,                            \
...
#if (defined SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START already defined
#endif /* if (SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START) */

#if (defined SOMEIPXF_S_CLIENT_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_S_CLIENT_XF_CALL_START already defined
#endif /* if (SOMEIPXF_S_CLIENT_XF_CALL_START) */

#if (defined SOMEIPXF_S_CLIENT_XF_CALL_GEN_START) /* to prevent double declaration */
#error SOMEIPXF_S_CLIENT_XF_CALL_GEN_START already defined
#endif /* if (SOMEIPXF_S_CLIENT_XF_CALL_GEN_START) */

#if (defined SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START_END) /* to prevent double declaration */
#error SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START_END already defined
#endif /* if (SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START_END) */
/* End of Macro guards */
...
/* Create transformer function start call */
/* Deviation MISRAC2012-1 <+5> */
#define SOMEIPXF_S_CLIENT_XF_CALL_GEN_START(DataType, Nr, PassMethod, config)              \
              RetVal = SomeIpXf_S_GenericTransformer(                                \
                  &Buffer[*BufferLength],                                            \
                  BufferLength,                                                      \
                  (P2CONST(void, AUTOMATIC, SOMEIPXF_APPL_DATA)) SOMEIPXF_PARAM_ ## PassMethod(Data_ ## Nr),   \
...
/* List of Transformer start call */
/* Deviation MISRAC2012-1 <+2> */
#define SOMEIPXF_S_CLIENT_XF_CALL_START(ARG_ID)                \
SOMEIPXF_S_CLIENT_XF_CALL_GEN_START SOMEIPXF_CLIENT_ ## ARG_ID

/* Macro loop */
#define SOMEIPXF_S_CLIENT_DEF_FUNC_XF_CALLS(SEQ) SOMEIPXF_CAT(SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START SEQ, _END)
#define SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START(x) SOMEIPXF_S_CLIENT_XF_CALL_START(x) SOMEIPXF_S_CLIENT_LOOP_XF_CALL_1
...
#define SOMEIPXF_S_CLIENT_LOOP_XF_CALL_START_END
...
#define SOMEIPXF_S_CLIENT_INVXF_CALL_GEN_TLV(DataType, Nr, PassMethod, config)                   \
        ...
        {                                                                                        \
          ...
          if( (RetVal == E_OK) && (BufferLength < SomeIpXf_InvXfrmInfo.BytesCopiedFromBuffer))   \
          {                                                                                      \
              RetVal = E_SER_MALFORMED_MESSAGE;                                                  \
          }                                                                                      \
        }                                                                                        \
...
#define SOMEIPXF_S_CLIENT_DEF_FUNC_INVXF_CALLS_NON_TLV_NOARG(UNUSED) \
    SOMEIPXF_PARAM_UNUSED(SomeIpXf_InvXfrmInfo.BytesCopiedFromBuffer);
...
#if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_NOAUTONERR) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_NOAUTONERR already defined
#endif /* if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_NOAUTONERR) */

#if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_NOAUTONERR) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_NOAUTONERR already defined
#endif /* if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_NOAUTONERR) */

#if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_AUTONERR) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_AUTONERR already defined
#endif /* if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_AUTONERR) */

#if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_AUTONERR) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_AUTONERR already defined
#endif /* if (defined SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_AUTONERR) */
...
#if (defined SOMEIPXF_S_SERVER_LOOP_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_LOOP_XF_CALL_START already defined
#endif /* if (SOMEIPXF_S_SERVER_LOOP_XF_CALL_START) */

#if (defined SOMEIPXF_S_SERVER_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_XF_CALL_START already defined
#endif /* if (SOMEIPXF_S_SERVER_XF_CALL_START) */

#if (defined SOMEIPXF_S_SERVER_XF_CALL_GEN_START) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_XF_CALL_GEN_START already defined
#endif /* if (SOMEIPXF_S_SERVER_XF_CALL_GEN_START) */

#if (defined SOMEIPXF_S_SERVER_LOOP_XF_CALL_START_END) /* to prevent double declaration */
#error SOMEIPXF_S_SERVER_LOOP_XF_CALL_START_END already defined
#endif /* if (SOMEIPXF_S_SERVER_LOOP_XF_CALL_START_END) */
/* Macro guards */
...
/* MidSection 2 */
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_TOP_ARG_NOAUTONERR (boolean)(0U)
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_TOP_NOARG_NOAUTONERR
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_TOP_ARG_AUTONERR (boolean)(0U)
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_TOP_NOARG_AUTONERR

#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_NOAUTONERR
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_NOAUTONERR
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_NOARG_AUTONERR
#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ARG_AUTONERR ) )
...
SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_TOP_ ## HasArguments ## _ ## AutonErrReact  ) SOMEIPXF_S_SERVER_DEF_FUNC_XF_SECT_MID_2_BRACKET_ ## HasArguments ## _ ## AutonErrReact    \
    {                                                                                           \
        /* defensive programming mechanism (no Det interface) */                                \
        RetVal = E_SER_GENERIC_ERROR;                                                           \
    }                                                                                           \
...
/* Create transformer function start call */
/* Deviation MISRAC2012-1 <+5> */
#define SOMEIPXF_S_SERVER_XF_CALL_GEN_START(DataType, Nr, PassMethod, config)                           \
                RetVal = SomeIpXf_S_GenericTransformer(                                           \
                    &Buffer[*BufferLength],                                                       \
                    BufferLength,                                                                 \
                    (P2CONST(void, AUTOMATIC, SOMEIPXF_APPL_DATA)) SOMEIPXF_PARAM_ ## PassMethod(Data_ ## Nr),   \
...
/* List of Transformer start call */
/* Deviation MISRAC2012-1 <+2> */
#define SOMEIPXF_S_SERVER_XF_CALL_START(ARG_ID)                 \
SOMEIPXF_S_SERVER_XF_CALL_GEN_START SOMEIPXF_SERVER_ ## ARG_ID

#define SOMEIPXF_S_SERVER_DEF_FUNC_XF_CALLS(SEQ) SOMEIPXF_CAT(SOMEIPXF_S_SERVER_LOOP_XF_CALL_START SEQ, _END)
#define SOMEIPXF_S_SERVER_LOOP_XF_CALL_START(x) SOMEIPXF_S_SERVER_XF_CALL_START(x) SOMEIPXF_S_SERVER_LOOP_XF_CALL_1
...
#define SOMEIPXF_S_SERVER_LOOP_XF_CALL_START_END
...
typedef struct
{
  /* total bytes processed */
   VAR(SOMEIPXF_XFRMBUFFERLENGTH_TYPE,  TYPEDEF) BytesCopiedFromBuffer;
   /*Mask for ext element , VSA, TLV enabled */
   VAR(SOMEIPXF_XFRMBUFFERLENGTH_TYPE,  TYPEDEF) BufferLengthCheck;
} SomeIpXf_InvXfrmInfoType;
