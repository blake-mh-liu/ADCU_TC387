...
SOMEIPXF_S_SR_DEF_FUNC_XF_HLP(XfrmName, DataType, SOMEIPXF_ARG_ ## PassMethod,                    \
    ...
    MessageType, SomeIpXf_GenericTransformer, ConfigID, SessionHandling_Status)
 ...
 */
#define SOMEIPXF_SR_DEF_FUNC_INVXF(XfrmName, DataType, InterfaceVersion, ConfigID)                \
...
#if (defined SOMEIPXF_CLIENT_LOOP_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_CLIENT_LOOP_XF_CALL_START already defined
#endif /* if (defined SOMEIPXF_CLIENT_LOOP_XF_CALL_START) */

#if (defined SOMEIPXF_CLIENT_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_CLIENT_XF_CALL_START already defined
#endif /* if (SOMEIPXF_CLIENT_XF_CALL_START) */

#if (defined SOMEIPXF_CLIENT_XF_CALL_GEN_START) /* to prevent double declaration */
#error SOMEIPXF_CLIENT_XF_CALL_GEN_START already defined
#endif /* if (SOMEIPXF_CLIENT_XF_CALL_GEN_START) */

#if (defined SOMEIPXF_CLIENT_LOOP_XF_CALL_START_END) /* to prevent double declaration */
#error SOMEIPXF_CLIENT_LOOP_XF_CALL_START_END already defined
#endif /* if (SOMEIPXF_CLIENT_LOOP_XF_CALL_START_END) */
/* Macro guards */
...
#define SOMEIPXF_CLIENT_XF_CALL_GEN_START(DataType, Nr, PassMethod, config)                                                \
              RetVal = SomeIpXf_GenericTransformer(                                                                        \
                  &Buffer[*BufferLength],                                                                                  \
                  BufferLength,                                                                                            \
                  (P2CONST(void, AUTOMATIC, SOMEIPXF_APPL_DATA)) SOMEIPXF_PARAM_ ## PassMethod(Data_ ## Nr),               \
...
/* Deviation MISRAC2012-1 <+2> */
#define SOMEIPXF_CLIENT_XF_CALL_START(ARG_ID)                 \
SOMEIPXF_CLIENT_XF_CALL_GEN_START SOMEIPXF_CLIENT_ ## ARG_ID

#define SOMEIPXF_CLIENT_DEF_FUNC_XF_CALLS(SEQ) SOMEIPXF_CAT(SOMEIPXF_CLIENT_LOOP_XF_CALL_START SEQ, _END)
#define SOMEIPXF_CLIENT_LOOP_XF_CALL_START(x) SOMEIPXF_CLIENT_XF_CALL_START(x) SOMEIPXF_CLIENT_LOOP_XF_CALL_1
...
#define SOMEIPXF_CLIENT_LOOP_XF_CALL_START_END
...
#if (defined SOMEIPXF_SERVER_LOOP_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_SERVER_LOOP_XF_CALL_START already defined
#endif /* if (SOMEIPXF_SERVER_LOOP_XF_CALL_START) */

#if (defined SOMEIPXF_SERVER_XF_CALL_START) /* to prevent double declaration */
#error SOMEIPXF_SERVER_XF_CALL_START already defined
#endif /* if (SOMEIPXF_SERVER_XF_CALL_START) */

#if (defined SOMEIPXF_SERVER_XF_CALL_GEN_START) /* to prevent double declaration */
#error SOMEIPXF_SERVER_XF_CALL_GEN_START already defined
#endif /* if (SOMEIPXF_SERVER_XF_CALL_GEN_START) */

#if (defined SOMEIPXF_SERVER_LOOP_XF_CALL_START_END) /* to prevent double declaration */
#error SOMEIPXF_SERVER_LOOP_XF_CALL_START_END already defined
#endif /* if (SOMEIPXF_SERVER_LOOP_XF_CALL_START_END) */
/* Macro guards */
...
/* Create transformer function start call */
/* Deviation MISRAC2012-1 <+5> */
#define SOMEIPXF_SERVER_XF_CALL_GEN_START(DataType, Nr, PassMethod, config)                              \
                RetVal = SomeIpXf_GenericTransformer(                                              \
                    &Buffer[*BufferLength],                                                        \
                    BufferLength,                                                                  \
                    (P2CONST(void, AUTOMATIC, SOMEIPXF_APPL_DATA)) SOMEIPXF_PARAM_ ## PassMethod(Data_ ## Nr),  \
...
/* List of Transformer start call */
/* Deviation MISRAC2012-1 <+2> */
#define SOMEIPXF_SERVER_XF_CALL_START(ARG_ID)                 \
SOMEIPXF_SERVER_XF_CALL_GEN_START SOMEIPXF_SERVER_ ## ARG_ID

#define SOMEIPXF_SERVER_DEF_FUNC_XF_CALLS(SEQ) SOMEIPXF_CAT(SOMEIPXF_SERVER_LOOP_XF_CALL_START SEQ, _END)
#define SOMEIPXF_SERVER_LOOP_XF_CALL_START(x) SOMEIPXF_SERVER_XF_CALL_START(x) SOMEIPXF_SERVER_LOOP_XF_CALL_1
...
#define SOMEIPXF_SERVER_LOOP_XF_CALL_START_END
/* End of Create transformer function calls */
