...
typedef struct
{
   ...
   /* root VSA entry offsetof value */
   VAR(SOMEIPXF_XFRMBUFFERLENGTH_TYPE, TYPEDEF) VSA_RootEntryDataByteOffset;
...
typedef struct
{
   ...
   /* root FSA entry offsetof value */
   VAR(SOMEIPXF_XFRMBUFFERLENGTH_TYPE, TYPEDEF) FSA_RootEntryDataByteOffset;
...
typedef struct
{
  ...
  /* Availability bit field position  */
  VAR(SOMEIPXF_XFRMBUFFERLENGTH_TYPE, TYPEDEF) offsetAvailabilitybitfield;
...
typedef struct
{
   ...
   VAR(SOMEIPXF_XFRMBUFFERLENGTH_TYPE, TYPEDEF) BufPosOffset;
...
{
#if (SOMEIPXF_VSA_AVAILABLE == STD_ON)
   P2VAR(VSA_NESTED_LEVEL_Type, TYPEDEF, TYPEDEF) VSAContextPtr;
#endif /* (SOMEIPXF_VSA_AVAILABLE == STD_ON) */
#if (SOMEIPXF_TLV_STRUCT_AVAILABLE == STD_ON)
   P2VAR(TLV_Nested_Type, TYPEDEF, TYPEDEF) TLVContextPtr;
#endif /* (SOMEIPXF_TLV_STRUCT_AVAILABLE == STD_ON) */
...
#if (SOMEIPXF_FSA_AVAILABLE == STD_ON)
   P2VAR(FSA_NESTED_LEVEL_Type, TYPEDEF, TYPEDEF) FSAContextPtr;
#endif /* (SOMEIPXF_FSA_AVAILABLE == STD_ON) */
#if (SOMEIPXF_STRUCT_WITH_LF_AVAILABLE == STD_ON)
   P2VAR(StructWithLf_NESTED_LEVEL_Type, TYPEDEF, TYPEDEF) StructWithLfContextPtr;
#endif /* (SOMEIPXF_STRUCT_WITH_LF_AVAILABLE == STD_ON) */
   P2VAR(SomeIpXf_DeSerInfoType, TYPEDEF, TYPEDEF) DeSerContextPtr;
