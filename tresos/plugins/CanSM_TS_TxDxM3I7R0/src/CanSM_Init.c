...
/*==================[macros]================================================*/
#define CANSM_GENERIC_INIT_FUNCTION 0U
/*==================[type definitions]======================================*/
...
)
{
...
#endif /* CANIF_DEV_ERROR_DETECT */
  {
    ...
    {
#if(CANSM_DISTRIBUTED_CHANNEL_INIT_ENABLED == STD_ON)
      /* !LINKSTO CanSM.EB.CanSMDistributedChannels_InitFunctions_StateTransition_Generic,1 */
      if(CANSM_NW_INFO_PARTITIONID(nw) == CANSM_GENERIC_INIT_FUNCTION)
      {
