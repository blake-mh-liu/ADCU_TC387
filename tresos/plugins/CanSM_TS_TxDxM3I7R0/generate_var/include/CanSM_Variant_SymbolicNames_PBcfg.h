...
#if (defined CanSM_[!"as:name(.)"!][!"$CANSM_VARIANT_SUFIX"!] )
#error CanSM_[!"as:name(.)"!][!"$CANSM_VARIANT_SUFIX"!] is already defined
#endif /* #if (defined CanSM_[!"as:name(.)"!][!"$CANSM_VARIANT_SUFIX"!] ) */

/** \brief Export symbolic name value */
#define CanSM_[!"as:name(.)"!][!"$CANSM_VARIANT_SUFIX"!] [!"as:ref(CanSMComMNetworkHandleRef)/ComMChannelId"!]U
