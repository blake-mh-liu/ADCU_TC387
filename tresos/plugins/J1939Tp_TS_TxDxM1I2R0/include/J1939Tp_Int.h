...
#include <J1939Tp_Api.h>              /* Types and decl. from public API */
#include <J1939Tp_Cfg.h>          /* Module configuration */
...
#endif
#define TS_RELOCATABLE_CFG_ENABLE J1939TP_RELOCATABLE_CFG_ENABLE
