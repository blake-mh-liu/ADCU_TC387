 ...
 *
 * This file defines the public interface for the IOC add-on when using Safety OS.
 *
 ...
 *
 * Reason:
 * While ioc_mkaddonopcodes_e/t are not used directly, the enum values are used for readability.
*/
