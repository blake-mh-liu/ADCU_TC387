...
Ioc_CORE_PATH       := $(PLUGINS_BASE)/Ioc_$(Ioc_VARIANT)
...
# OS_N_CORES is involved in selecting multi-core files. It is generated based on the configuration.
-include $(Ioc_OUTPUT_MAKE)/Os_objects.make
