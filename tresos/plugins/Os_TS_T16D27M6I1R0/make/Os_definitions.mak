...
OS_ULIB_OBJS_ARCH_COMMON = \
	$(addprefix $(AutosarOS_LIB_SRC_PATH)/$(OS_ARCH)/,										\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)activatetask.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)activatetaskasyn.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)allowaccess.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)incrementcounter.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)calltrustedfunction.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)cancelalarm.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)chainscheduletable.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)chaintask.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)checkisrmemoryaccess.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)checkobjectaccess.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)checkobjectownership.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)checktaskmemoryaccess.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)clearpendinginterrupt.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)clearevent.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)controlidle.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)disableinterruptsource.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)enableinterruptsource.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getactiveapplicationmode.$(OS_ASM_FILE_SUFFIX)	\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getalarm.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getalarmbase.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getapplicationid.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getapplicationstate.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getcountervalue.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getcurrentapplicationid.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getelapsedcountervalue.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getevent.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getisrid.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getresource.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getscheduletablestatus.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)getstackinfo.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)gettaskid.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)gettaskstate.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)iocemptyqueue.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)iocsend.$(OS_ASM_FILE_SUFFIX)						\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)iocwrite.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)iocaddonext.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)releaseresource.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)resumeinterrupts.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)schedule.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)setabsalarm.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)setevent.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)seteventasyn.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)setrelalarm.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)setscheduletableasync.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)shutdownos.$(OS_ASM_FILE_SUFFIX)					\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)simtimeradvance.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)startos.$(OS_ASM_FILE_SUFFIX)						\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)startscheduletable.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)startscheduletablesynchron.$(OS_ASM_FILE_SUFFIX)	\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)stopscheduletable.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)suspendinterrupts.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)syncscheduletable.$(OS_ASM_FILE_SUFFIX)			\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)terminateapplication.$(OS_ASM_FILE_SUFFIX)		\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)terminatetask.$(OS_ASM_FILE_SUFFIX)				\
		$(OS_ARCH_PREFIX)$(OS_USER_PREFIX)waitevent.$(OS_ASM_FILE_SUFFIX)					\
	)
