 ...
 *
 *
 * MISRAC2012-8) Deviated Rule: 2.3 (advisory)
 * A project should not contain unused type declarations.
 *
 * Reason:
 * Typedef used so OS_STATIC_ASSERT will not consume memory.
 *
 *
 * MISRAC2012-9) Deviated Rule: 2.1 (required)
 ...
 * 
 * 
 * MISRAC2012-10) Deviated Rule 10.4 (Required)
 * Both operands of an operator in which the usual arithmetic conversions are 
 * performed shall have the same essential type category.
 * 
 * Reason:
 * OS_ISRCONFIG is populated at generation phase and has the same type as specified.
 * 
 * 
 * MISRAC2012-11) Deviated Rule 10.4 (Required)
 * Both operands of an operator in which the usual arithmetic conversions are 
 * performed shall have the same essential type category.
 * 
 * Reason:
 * The is signedness is the same on both sides of the operator.
 * 
*/
...
*/
#include <memmap/Os_mm_const8_begin.h>
const os_erroraction_t OS_hookSelection = OS_HOOKSELECTION;
#include <memmap/Os_mm_const8_end.h>
...
*/
#include <memmap/Os_mm_const_begin.h>
/* Deviation MISRAC2012-6 <+1>, MISRAC2012-9 <+1> */
...
#include <memmap/Os_mm_const8_begin.h>
const os_counterid_t OS_nCounters = OS_NCOUNTERS;
#include <memmap/Os_mm_const8_end.h>
...
#include <memmap/Os_mm_const_begin.h>
/* Deviation MISRAC2012-4 <+1>, MISRAC2012-10 <+1> */
...
#include <memmap/Os_mm_const_begin.h>
/* Deviation MISRAC2012-7 <+1>, MISRAC2012-11 <+1> */
...
*/
/* CHECK: NOPARSE */
/* Deviation MISRAC2012-3 <+2>, MISRAC2012-8 <+2>  */
