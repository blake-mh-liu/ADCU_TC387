 ...
 *
 * Reason:
 * The calculation is devised in a way to be immune to overflows.
 *
 *
 ...
 *
 * Reason:
 * Only used in multi-core configurations.
*/
...
#define OS_STACKINFO_STATUS_INVALID		OS_U(0xffffffff)
 ...
 */
#define OS_CreateObjectId(id, type)			((os_objectid_t)(OS_ShiftLeft(os_objectid_t,(type), 24u) | (id)))
#define OS_GetIdFromObjectId(objectid)		((os_objectid_t)((objectid) & OS_U(0xffffff)))
#define OS_GetTypeFromObjectId(objectid)	(OS_ShiftRight(os_objectid_t,(objectid), 24u))
...
#else
typedef mk_objectid_t os_coreid_t;
#endif
...
#define OS_IsrToTOI(i)			((os_taskorisr_t) ((OS_TOI_ISR)+(i)))
