 ...
 *
 * Reason:
 * IsrType is defined for ProOSEK compatibility.
 *
 *
 * MISRAC2012-3) Deviated Rule: 2.3 (advisory)
 ...
 *
 *
 * MISRAC2012-4) Deviated Rule: D4.5 (advisory)
 * Identifiers in the same name space with overlapping visibility should be
 * typographically unambiguous
 *
 * Reason:
...
#if (MK_SW_MAJOR_VERSION == 2) && (MK_SW_MINOR_VERSION == 0)
...
#define OSError_DisableInterruptSource_DisableISR()	((os_isrid_t)(OS_GetErrorInfo()->parameter[0]))
...
#define EnableInterruptSource(i, f)				OS_UserEnableInterruptSource((i),(f))
#endif
#define OS_EnableInterruptSource(i)					OS_UserEnableInterruptSource((i), 0)
#define OSServiceID_EnableInterruptSource			OS_SID_EnableInterruptSource
#define OSError_EnableInterruptSource_ISRID()		((ISRType)(OS_GetErrorInfo()->parameter[0]))
#define OSError_EnableInterruptSource_ClearPending()	((ISRType)(OS_GetErrorInfo()->parameter[1]))
...
#define OSError_ClearPendingInterrupt_ISRID()		((ISRType)(OS_GetErrorInfo()->parameter[0]))
...
*/
#ifndef OS_ASM
/* Deviation MISRAC2012-3 <+1>, MISRAC2012-4 <+1>  */
...
/* Deviation MISRAC2012-2 <+1>, MISRAC2012-4 <+1>  */
typedef os_isrid_t              ISRType;
...
*/
#define OSError_IncrementCounter_CounterID()				((CounterType)						(OS_GetErrorInfo()->parameter[0]))
#define OSError_StartScheduleTableRel_ScheduleTableID()		((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_StartScheduleTableRel_Offset()				((TickType)							(OS_GetErrorInfo()->parameter[1]))
#define OSError_StartScheduleTableAbs_ScheduleTableID()		((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_StartScheduleTableAbs_Tickvalue()			((TickType)							(OS_GetErrorInfo()->parameter[1]))
#define OSError_ChainScheduleTable_SchedTableID_current()	((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_ChainScheduleTable_SchedTableID_next()		((ScheduleTableType)				(OS_GetErrorInfo()->parameter[1]))
#define OSError_StopScheduleTable_ScheduleTableID()			((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_SyncScheduleTable_SchedTableID()			((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_SyncScheduleTable_GlobalTime()				((TickType)							(OS_GetErrorInfo()->parameter[1]))
#define OSError_SetScheduleTableAsync_ScheduleID()			((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_GetScheduleTableStatus_ScheduleID()			((ScheduleTableType)				(OS_GetErrorInfo()->parameter[0]))
#define OSError_GetScheduleTableStatus_ScheduleStatus()		((ScheduleTableStatusRefType)		(OS_GetErrorInfo()->parameter[1]))
#define OSError_CallTrustedFunction_FunctionIndex()			((TrustedFunctionIndexType)			(OS_GetErrorInfo()->parameter[0]))
#define OSError_CallTrustedFunction_FunctionParams()		((TrustedFunctionParameterRefType)	(OS_GetErrorInfo()->parameter[1]))
#define OSError_CheckIsrMemoryAccess_ISRID()				((ISRType)							(OS_GetErrorInfo()->parameter[0]))
#define OSError_CheckIsrMemoryAccess_Address()				((MemoryStartAddressType)			(OS_GetErrorInfo()->parameter[1]))
#define OSError_CheckIsrMemoryAccess_Size()					((MemorySizeType)					(OS_GetErrorInfo()->parameter[2]))
#define OSError_CheckTaskMemoryAccess_TaskID()				((TaskType)							(OS_GetErrorInfo()->parameter[0]))
#define OSError_CheckTaskMemoryAccess_Address()				((MemoryStartAddressType)			(OS_GetErrorInfo()->parameter[1]))
#define OSError_CheckTaskMemoryAccess_Size()				((MemorySizeType)					(OS_GetErrorInfo()->parameter[2]))
#define OSError_CheckObjectAccess_ApplID()					((ApplicationType)					(OS_GetErrorInfo()->parameter[0]))
#define OSError_CheckObjectAccess_ObjectType()				((ObjectTypeType)					(OS_GetErrorInfo()->parameter[1]))
#define OSError_CheckObjectAccess_Object()					((os_objectid_t)					(OS_GetErrorInfo()->parameter[2]))
#define OSError_CheckObjectOwnership_ObjectType()			((ObjectTypeType)					(OS_GetErrorInfo()->parameter[0]))
#define OSError_CheckObjectOwnership_Object()				((os_objectid_t)					(OS_GetErrorInfo()->parameter[1]))
#define OSError_GetCounterValue_CounterID()					((CounterType)						(OS_GetErrorInfo()->parameter[0]))
#define OSError_GetCounterValue_Value()						((TickRefType)						(OS_GetErrorInfo()->parameter[1]))
#define OSError_StartScheduleTableSynchron_ScheduleTableID()	((ScheduleTableType)			(OS_GetErrorInfo()->parameter[0]))
#define OSError_GetElapsedCounterValue_CounterID()			((CounterType)						(OS_GetErrorInfo()->parameter[0]))
#define OSError_GetElapsedCounterValue_PreviousValue()		((TickType)							(OS_GetErrorInfo()->parameter[1]))
#define OSError_GetElapsedCounterValue_Value()				((TickRefType)						(OS_GetErrorInfo()->parameter[2]))
/* API may be referenced as GetElapsedCounterValue (<= 3.1) or as GetElapsedValue (>= 4.0) */
#define OSError_GetElapsedValue_CounterID()					((CounterType)						(OS_GetErrorInfo()->parameter[0]))
#define OSError_GetElapsedValue_PreviousValue()				((TickType)							(OS_GetErrorInfo()->parameter[1]))
#define OSError_GetElapsedValue_Value()						((TickRefType)						(OS_GetErrorInfo()->parameter[2]))
#define OSError_ControlIdle_CoreID()						((CoreIdType)						(OS_GetErrorInfo()->parameter[0]))
#define OSError_ControlIdle_IdleMode()						((IdleModeType)						(OS_GetErrorInfo()->parameter[1]))
/* CHECK: RESTORE
*/
