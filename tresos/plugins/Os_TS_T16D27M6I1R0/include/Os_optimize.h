 ...
 *
 * Reason:
 * The ## operator is used to support different levels of error reporting,
...
#ifdef OS_EXCLUDE_ERRORHOOK
#define OS_CALLERRORHOOK(e)				OS_PARAM_UNUSED(e)
