...
#define OS_GetOsObjectCoreId(osx)			OS_GetAppCoreId(OS_GET_APP((osx)->app))
#define OS_GetTaskCoreId(tsx)				OS_GetOsObjectCoreId(tsx)
#define OS_GetIsrCoreId(isx)				OS_GetOsObjectCoreId(isx)
#define OS_GetResourceCoreId(rsx)			OS_GetOsObjectCoreId(rsx)
#define OS_GetTrustedFunctionCoreId(tfx)	OS_GetOsObjectCoreId(tfx)
#define OS_GetAlarmCoreId(asx)				OS_GetOsObjectCoreId(asx)
#define OS_GetCounterCoreId(csx)			OS_GetOsObjectCoreId(csx)
#define OS_GetScheduleTableCoreId(ssx)		OS_GetOsObjectCoreId(ssx)
...
#ifndef OS_ASM
extern os_errorresult_t OS_DoControlIdle(os_idlemode_t);
#endif

/* Deviation MISRAC2012-4 <+3>, MISRAC2012-5 <+3> */
#if (OS_N_CORES > 1)
#ifndef OS_ASM
