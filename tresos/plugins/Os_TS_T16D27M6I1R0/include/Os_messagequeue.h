 ...
 * determined.
 */
#define OS_CROSSCORE_MESSAGE_QUEUE_SIZE	OS_U(16)
...
#define OS_XC_OP_ReturnTaskState				(OS_XC_OP_ReturnResult + OS_U(1))
#define OS_XC_OP_ReturnTick						(OS_XC_OP_ReturnResult + OS_U(2))
#define OS_XC_OP_ReturnEvent					(OS_XC_OP_ReturnResult + OS_U(3))
#define OS_XC_OP_ReturnScheduleTableStatus		(OS_XC_OP_ReturnResult + OS_U(4))
#define OS_XC_OP_ReturnApplicationState			(OS_XC_OP_ReturnResult + OS_U(5))
#define OS_N_CROSSCORE_HANDLERS					(OS_XC_OP_ReturnResult + OS_U(6))
...
extern os_errorresult_t OS_SendGetScheduleTableStatus(os_scheduleid_t, const os_schedule_t *, os_schedulestatus_t *);
