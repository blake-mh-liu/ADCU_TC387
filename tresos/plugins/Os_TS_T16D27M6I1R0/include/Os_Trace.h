...
#define OS_TRACE_TERMINATEAPPLICATION_ENTRY(ApplicationId,RestartOption)
#endif

#ifndef OS_TRACE_TERMINATEAPPLICATION_EXIT
#define OS_TRACE_TERMINATEAPPLICATION_EXIT_P(r,ApplicationId,RestartOption)
#else
#ifdef TRACE_EXIT_WITH_PARAMS
#define OS_TRACE_TERMINATEAPPLICATION_EXIT_P(r,ApplicationId,RestartOption) OS_TRACE_TERMINATEAPPLICATION_EXIT(r,RestartOption)
#else
#define OS_TRACE_TERMINATEAPPLICATION_EXIT_P(r,ApplicationId,RestartOption) OS_TRACE_TERMINATEAPPLICATION_EXIT()
#endif
#endif
