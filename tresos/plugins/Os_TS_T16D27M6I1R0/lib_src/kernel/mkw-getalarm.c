/* kern-mkwgetalarm.c
 *
 * This file contains the OS_MkwGetAlarm function.
 *
...
/* OS_MkwGetAlarm
 *
 * This function provides a wrapper for OS_KernGetAlarm so that it can be called
 * in an OS thread in the microkernel
*/
OS_TOOL_FUNCTION_ATTRIB_PRE
mk_parametertype_t OS_MkwGetAlarm(
...
OS_TOOL_FUNCTION_ATTRIB_POST
{
	...
	os_result_t result = OS_KernGetAlarm(a, &localcount);
	/* COVPT-1 */
	OS_PARAM_UNUSED(p1);
	OS_PARAM_UNUSED(p2);
...
const os_uint8_t OS_dummy_mkw_getalarm_c = 0xeb;
