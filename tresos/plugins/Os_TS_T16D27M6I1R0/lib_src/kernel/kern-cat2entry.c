 ...
 *
 *
 * MISRAC2012-9) Deviated Rule: 12.4 (advisory)
 ...
 *
 * TOOLDIAG-6) Possible diagnostic: GNUStatementExpressionExtension
...
OS_TOOL_FUNCTION_ATTRIB_POST
{
	...
	/* Deviation MISRAC2012-4 <+2>, MISRAC2012-5 <+2>, MISRAC2012-7 <+2>, MISRAC2012-8 <+2> */
