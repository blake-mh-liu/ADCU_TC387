 ...
 **/
#ifdef CSM_SID_CALLBACKNOTIFICATION
 ...
 **/
#ifdef CSM_SID_CERTIFICATEPARSE
 ...
 **/
#ifdef CSM_SID_CERTIFICATEVERIFY
 ...
 **/
#ifdef CSM_SID_KEYEXCHANGECALCPUBVAL
 ...
 **/
#ifdef CSM_SID_KEYEXCHANGECALCSECRET
 ...
 **/
#ifdef CSM_SID_KEYSETVALID
  #error CSM_SID_KEYSETVALID is already defined
#endif
#define  CSM_SID_KEYSETVALID               0x0067U

/** \brief  The 'Csm_KeySetInvalid' API service identifier
 **/
#ifdef CSM_SID_KEYSETINVALID
  #error CSM_SID_KEYSETINVALID is already defined
#endif
#define  CSM_SID_KEYSETINVALID             0x0085U

/** \brief  The 'Csm_KeyGetStatus' API service identifier
 **/
#ifdef CSM_SID_KEYGETSTATUS
  #error CSM_SID_KEYGETSTATUS is already defined
#endif
#define  CSM_SID_KEYGETSTATUS              0x0083U

/** \brief  The 'Csm_MacGenerate' API service identifier
 **/
#ifdef CSM_SID_MACGENERATE
 ...
 **/
#ifdef CSM_SID_SIGNATUREGENERATE
 ...
 **/
#ifdef CSM_SID_SIGNATUREVERIFY
  #error CSM_SID_SIGNATUREVERIFY is already defined
#endif
#define  CSM_SID_SIGNATUREVERIFY           0x0064U

/** \brief  The 'Csm_KeyElementCopyPartial' API service identifier
 **/
#ifdef CSM_SID_KEYELEMENTCOPYPARTIAL
  #error CSM_SID_KEYELEMENTCOPYPARTIAL is already defined
#endif
#define  CSM_SID_KEYELEMENTCOPYPARTIAL     0x0079U

/** \brief  The 'Csm_JobKeySetValid' API service identifier
 **/
#ifdef CSM_SID_JOBKEYSETVALID
  #error CSM_SID_JOBKEYSETVALID is already defined
#endif
#define  CSM_SID_JOBKEYSETVALID            0x007AU

/** \brief  The 'Csm_JobRandomSeed' API service identifier
 **/
#ifdef CSM_SID_JOBRANDOMSEED
  #error CSM_SID_JOBRANDOMSEED is already defined
#endif
#define  CSM_SID_JOBRANDOMSEED             0x007BU

/** \brief  The 'Csm_JobKeyGenerate' API service identifier
 **/
#ifdef CSM_SID_JOBKEYGENERATE
  #error CSM_SID_JOBKEYGENERATE is already defined
#endif
#define  CSM_SID_JOBKEYGENERATE            0x007CU

/** \brief  The 'Csm_JobKeyDerive' API service identifier
 **/
#ifdef CSM_SID_JOBKEYDERIVE
  #error CSM_SID_JOBKEYDERIVE is already defined
#endif
#define  CSM_SID_JOBKEYDERIVE              0x007DU

/** \brief  The 'Csm_JobKeyExchangeCalcPubVal' API service identifier
 **/
#ifdef CSM_SID_JOBKEYEXCHANGECALCPUBVAL
  #error CSM_SID_JOBKEYEXCHANGECALCPUBVAL is already defined
#endif
#define  CSM_SID_JOBKEYEXCHANGECALCPUBVAL  0x007EU

/** \brief  The 'Csm_JobKeyExchangeCalcSecret' API service identifier
 **/
#ifdef CSM_SID_JOBKEYEXCHANGECALCSECRET
  #error CSM_SID_JOBKEYEXCHANGECALCSECRET is already defined
#endif
#define  CSM_SID_JOBKEYEXCHANGECALCSECRET  0x007FU

/** \brief  The 'Csm_JobCertificateParse' API service identifier
 **/
#ifdef CSM_SID_JOBCERTIFICATEPARSE
  #error CSM_SID_JOBCERTIFICATEPARSE is already defined
#endif
#define  CSM_SID_JOBCERTIFICATEPARSE       0x0080U

/** \brief  The 'Csm_JobCertificateVerify' API service identifier
 **/
#ifdef CSM_SID_JOBCERTIFICATEVERIFY
  #error CSM_SID_JOBCERTIFICATEVERIFY is already defined
#endif
#define  CSM_SID_JOBCERTIFICATEVERIFY      0x0081U
 ...
 **/
#ifdef CSM_E_SERVICE_NOT_STARTED
...
#ifdef CSM_E_SERVICE_NOT_IDENTICAL
 ...
 **                        (only available in {CSM_API_VERSION_440})
 **
...
#if ((CSM_API_ENABLED_KEYMNGMNT == STD_ON) && ((CSM_RTE_ENABLED_KEYMNGMNT == STD_OFF) || (!defined(CSM_SRC))) && (CSM_API_ENABLED_KEYSETINVALID == STD_ON))
#ifndef RTE_SCHM_SWCBSW_CSM_KEYSETINVALID
#define RTE_SCHM_SWCBSW_CSM_KEYSETINVALID

/** \brief  Sets the key state of the key identified by keyId to invalid.
 **
 ** \param[in]  keyId  Holds the identifier of the key for which the material shall be
 **                    invalidated.
 **
 ** \returns  Error value.
 **
 ...
 ** \retval   CRYPTO_E_BUSY  Request Failed, Crypro Driver Object is busy
 **
 ** \ServiceID{::CSM_SID_KEYSETINVALID}
 ** \Synchronicity{Synchronous}
 ** \Reentrancy{Non Reentrant}
 **/
extern FUNC(Std_ReturnType, CSM_CODE) Csm_KeySetInvalid
(
  uint32 keyId
);
#endif /* #ifndef RTE_SCHM_SWCBSW_CSM_KEYSETINVALID */
#endif /* #if ((CSM_API_ENABLED_KEYMNGMNT == STD_ON) && ((CSM_RTE_ENABLED_KEYMNGMNT == STD_OFF) || (!defined(CSM_SRC))) && (CSM_API_ENABLED_KEYSETINVALID == STD_ON)) */

#if ((CSM_API_ENABLED_KEYMNGMNT == STD_ON) && ((CSM_RTE_ENABLED_KEYMNGMNT == STD_OFF) || (!defined(CSM_SRC))) && (CSM_API_ENABLED_KEYGETSTATUS == STD_ON))
#ifndef RTE_SCHM_SWCBSW_CSM_KEYGETSTATUS
#define RTE_SCHM_SWCBSW_CSM_KEYGETSTATUS

/** \brief  Returns the key state of the key identified by keyId.
 **
 ** \param[in]   keyId         Holds the identifier of the key for which the key state shall be
 **                            returned.
 ** \param[out]  keyStatusPtr  Contains the pointer to the data where the status of the key
 **                            shall be stored.
 **
 ** \returns  Error value.
 **
 ...
 ** \retval   E_NOT_OK  Request failed
 **
 ** \ServiceID{::CSM_SID_KEYGETSTATUS}
 ** \Synchronicity{Synchronous}
 ** \Reentrancy{Reentrant}
 **/
extern FUNC(Std_ReturnType, CSM_CODE) Csm_KeyGetStatus
(
        uint32                                          keyId,
  P2VAR(Crypto_KeyStatusType, AUTOMATIC, CSM_APPL_DATA) keyStatusPtr
);
#endif /* #ifndef RTE_SCHM_SWCBSW_CSM_KEYGETSTATUS */
#endif /* #if ((CSM_API_ENABLED_KEYMNGMNT == STD_ON) && ((CSM_RTE_ENABLED_KEYMNGMNT == STD_OFF) || (!defined(CSM_SRC))) && (CSM_API_ENABLED_KEYGETSTATUS == STD_ON)) */
...
#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBKEYSETVALID == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYSETVALID == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBKEYSETVALID == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYSETVALID == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBRANDOMSEED == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBRANDOMSEED == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBRANDOMSEED == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBRANDOMSEED == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBKEYGENERATE == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYGENERATE == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBKEYGENERATE == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYGENERATE == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBKEYDERIVE == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYDERIVE == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBKEYDERIVE == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYDERIVE == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBKEYEXCHANGECALCPUBVAL == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYEXCHANGECALCPUBVAL == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBKEYEXCHANGECALCPUBVAL == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYEXCHANGECALCPUBVAL == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBKEYEXCHANGECALCSECRET == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYEXCHANGECALCSECRET == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBKEYEXCHANGECALCSECRET == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBKEYEXCHANGECALCSECRET == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBCERTIFICATEPARSE == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBCERTIFICATEPARSE == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBCERTIFICATEPARSE == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBCERTIFICATEPARSE == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */

#if (CSM_API_VERSION == CSM_API_VERSION_440)
#if ((CSM_API_ENABLED_SERVICE_JOBCERTIFICATEVERIFY == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBCERTIFICATEVERIFY == STD_OFF) || (!defined(CSM_SRC))))
...
#endif /* #if ((CSM_API_ENABLED_SERVICE_JOBCERTIFICATEVERIFY == STD_ON) && ((CSM_RTE_ENABLED_SERVICE_JOBCERTIFICATEVERIFY == STD_OFF) || (!defined(CSM_SRC)))) */
#endif /* #if (CSM_API_VERSION == CSM_API_VERSION_440) */
