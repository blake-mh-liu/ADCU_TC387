...
[!VAR "Csm_Api_Enabled_JobCertificateParse"      = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobCertificateParse))     "!][!//
[!VAR "Csm_Api_Enabled_JobCertificateVerify"     = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobCertificateVerify))    "!][!//
[!VAR "Csm_Api_Enabled_JobKeyDerive"             = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyDerive))            "!][!//
[!VAR "Csm_Api_Enabled_JobKeyExchangeCalcPubVal" = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyExchangeCalcPubVal))"!][!//
[!VAR "Csm_Api_Enabled_JobKeyExchangeCalcSecret" = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyExchangeCalcSecret))"!][!//
[!VAR "Csm_Api_Enabled_JobKeyGenerate"           = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyGenerate))          "!][!//
[!VAR "Csm_Api_Enabled_JobKeySetValid"           = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeySetValid))          "!][!//
[!VAR "Csm_Api_Enabled_JobRandomSeed"            = "string(node:exists(as:modconf('Csm')/CsmPrimitives/*/CsmJobRandomSeed))           "!][!//
...
[!VAR "Csm_Rte_Enabled_CallbackR2011"            = "string(boolean(num:i(count(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true' and node:exists(node:ref(./CsmJobPrimitiveRef)/*) = 'true' and node:value(node:ref(./CsmJobPrimitiveRef)/*/*/*[contains(node:name(.),'Processing')]) = 'CSM_ASYNCHRONOUS']))))"!][!//
[!//
...
[!VAR "Csm_Rte_Enabled_JobCertificateParse"      = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobCertificateParse']))))     "!][!//
[!VAR "Csm_Rte_Enabled_JobCertificateVerify"     = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobCertificateVerify']))))    "!][!//
[!VAR "Csm_Rte_Enabled_JobKeyDerive"             = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobKeyDerive']))))            "!][!//
[!VAR "Csm_Rte_Enabled_JobKeyExchangeCalcPubVal" = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobKeyExchangeCalcPubVal']))))"!][!//
[!VAR "Csm_Rte_Enabled_JobKeyExchangeCalcSecret" = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobKeyExchangeCalcSecret']))))"!][!//
[!VAR "Csm_Rte_Enabled_JobKeyGenerate"           = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobKeyGenerate']))))          "!][!//
[!VAR "Csm_Rte_Enabled_JobKeySetValid"           = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobKeySetValid']))))          "!][!//
[!VAR "Csm_Rte_Enabled_JobRandomSeed"            = "string(boolean(num:i(count(node:refs(as:modconf('Csm')/CsmJobs/CsmJob/*[CsmJobUsePort = 'true']/CsmJobPrimitiveRef)/*[@name = 'CsmJobRandomSeed']))))           "!][!//
...
[!VAR "Csm_Flg_Sync_JobCertificateParse"         = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobCertificateParse/CsmJobCertificateParseConfig[CsmJobCertificateParseProcessing = 'CSM_SYNCHRONOUS']))))               "!][!//
[!VAR "Csm_Flg_Sync_JobCertificateVerify"        = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobCertificateVerify/CsmJobCertificateVerifyConfig[CsmJobCertificateVerifyProcessing = 'CSM_SYNCHRONOUS']))))            "!][!//
[!VAR "Csm_Flg_Sync_JobKeyDerive"                = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyDerive/CsmJobKeyDeriveConfig[CsmJobKeyDeriveProcessing = 'CSM_SYNCHRONOUS']))))                                    "!][!//
[!VAR "Csm_Flg_Sync_JobKeyExchangeCalcPubVal"    = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyExchangeCalcPubVal/CsmJobKeyExchangeCalcPubValConfig[CsmJobKeyExchangeCalcPubValProcessing = 'CSM_SYNCHRONOUS']))))"!][!//
[!VAR "Csm_Flg_Sync_JobKeyExchangeCalcSecret"    = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyExchangeCalcSecret/CsmJobKeyExchangeCalcSecretConfig[CsmJobKeyExchangeCalcSecretProcessing = 'CSM_SYNCHRONOUS']))))"!][!//
[!VAR "Csm_Flg_Sync_JobKeyGenerate"              = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyGenerate/CsmJobKeyGenerateConfig[CsmJobKeyGenerateProcessing = 'CSM_SYNCHRONOUS']))))                              "!][!//
[!VAR "Csm_Flg_Sync_JobKeySetValid"              = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeySetValid/CsmJobKeySetValidConfig[CsmJobKeySetValidProcessing = 'CSM_SYNCHRONOUS']))))                              "!][!//
[!VAR "Csm_Flg_Sync_JobRandomSeed"               = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobRandomSeed/CsmJobRandomSeedConfig[CsmJobRandomSeedProcessing = 'CSM_SYNCHRONOUS']))))                                 "!][!//
...
[!VAR "Csm_Flg_Async_JobCertificateParse"        = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobCertificateParse/CsmJobCertificateParseConfig[CsmJobCertificateParseProcessing = 'CSM_ASYNCHRONOUS']))))               "!][!//
[!VAR "Csm_Flg_Async_JobCertificateVerify"       = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobCertificateVerify/CsmJobCertificateVerifyConfig[CsmJobCertificateVerifyProcessing = 'CSM_ASYNCHRONOUS']))))            "!][!//
[!VAR "Csm_Flg_Async_JobKeyDerive"               = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyDerive/CsmJobKeyDeriveConfig[CsmJobKeyDeriveProcessing = 'CSM_ASYNCHRONOUS']))))                                    "!][!//
[!VAR "Csm_Flg_Async_JobKeyExchangeCalcPubVal"   = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyExchangeCalcPubVal/CsmJobKeyExchangeCalcPubValConfig[CsmJobKeyExchangeCalcPubValProcessing = 'CSM_ASYNCHRONOUS']))))"!][!//
[!VAR "Csm_Flg_Async_JobKeyExchangeCalcSecret"   = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyExchangeCalcSecret/CsmJobKeyExchangeCalcSecretConfig[CsmJobKeyExchangeCalcSecretProcessing = 'CSM_ASYNCHRONOUS']))))"!][!//
[!VAR "Csm_Flg_Async_JobKeyGenerate"             = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeyGenerate/CsmJobKeyGenerateConfig[CsmJobKeyGenerateProcessing = 'CSM_ASYNCHRONOUS']))))                              "!][!//
[!VAR "Csm_Flg_Async_JobKeySetValid"             = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobKeySetValid/CsmJobKeySetValidConfig[CsmJobKeySetValidProcessing = 'CSM_ASYNCHRONOUS']))))                              "!][!//
[!VAR "Csm_Flg_Async_JobRandomSeed"              = "string(boolean(num:i(count(as:modconf('Csm')/CsmPrimitives/*/CsmJobRandomSeed/CsmJobRandomSeedConfig[CsmJobRandomSeedProcessing = 'CSM_ASYNCHRONOUS']))))                                 "!][!//
...
[!IF "$Csm_Api_Enabled_KeyMngmnt                = 'true' or
      ...
      $Csm_Api_Enabled_JobCertificateParse      = 'true' or
      $Csm_Api_Enabled_JobCertificateVerify     = 'true' or
      $Csm_Api_Enabled_JobKeyDerive             = 'true' or
      $Csm_Api_Enabled_JobKeyExchangeCalcPubVal = 'true' or
      $Csm_Api_Enabled_JobKeyExchangeCalcSecret = 'true' or
      $Csm_Api_Enabled_JobKeyGenerate           = 'true' or
      $Csm_Api_Enabled_JobKeySetValid           = 'true' or
      $Csm_Api_Enabled_JobRandomSeed            = 'true' or
...
[!IF "$Csm_Rte_Enabled_KeyMngmnt                = 'true' or
      ...
      $Csm_Rte_Enabled_JobCertificateParse      = 'true' or
      $Csm_Rte_Enabled_JobCertificateVerify     = 'true' or
      $Csm_Rte_Enabled_JobKeyDerive             = 'true' or
      $Csm_Rte_Enabled_JobKeyExchangeCalcPubVal = 'true' or
      $Csm_Rte_Enabled_JobKeyExchangeCalcSecret = 'true' or
      $Csm_Rte_Enabled_JobKeyGenerate           = 'true' or
      $Csm_Rte_Enabled_JobKeySetValid           = 'true' or
      $Csm_Rte_Enabled_JobRandomSeed            = 'true' or
...
[!IF "$Csm_Flg_Sync_AEADDecrypt              = 'true' or
      ...
      $Csm_Flg_Sync_JobCertificateParse      = 'true' or
      $Csm_Flg_Sync_JobCertificateVerify     = 'true' or
      $Csm_Flg_Sync_JobKeyDerive             = 'true' or
      $Csm_Flg_Sync_JobKeyExchangeCalcPubVal = 'true' or
      $Csm_Flg_Sync_JobKeyExchangeCalcSecret = 'true' or
      $Csm_Flg_Sync_JobKeyGenerate           = 'true' or
      $Csm_Flg_Sync_JobKeySetValid           = 'true' or
      $Csm_Flg_Sync_JobRandomSeed            = 'true' or
...
[!IF "$Csm_Flg_Async_AEADDecrypt              = 'true' or
      ...
      $Csm_Flg_Async_JobCertificateParse      = 'true' or
      $Csm_Flg_Async_JobCertificateVerify     = 'true' or
      $Csm_Flg_Async_JobKeyDerive             = 'true' or
      $Csm_Flg_Async_JobKeyExchangeCalcPubVal = 'true' or
      $Csm_Flg_Async_JobKeyExchangeCalcSecret = 'true' or
      $Csm_Flg_Async_JobKeyGenerate           = 'true' or
      $Csm_Flg_Async_JobKeySetValid           = 'true' or
      $Csm_Flg_Async_JobRandomSeed            = 'true' or
