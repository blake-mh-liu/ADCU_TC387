...
#include <Rte_Csm_[!"string($ecucPartition)"!]_Type.h>
[!ENDIF!][!//
[!ENDLOOP!][!//
[!ENDIF!][!//
[!ENDIF!][!//
...
/** \brief   tbd
 **/
/* !LINKSTO Csm.Asr.SWS_Csm_91024,1 */
...
[!ENDIF!]
[!IF "node:value(./CsmEbGeneral/CsmEbMisc/CsmEbAutosarApiVersion) = 'CSM_API_VERSION_440'"!]
/** \brief  CertificiateParse Service.
 **/
/* !LINKSTO CSM.Dsn.SWS_Csm_01031,2 */
#ifndef  CRYPTO_CERTIFICATEPARSE
  #define  CRYPTO_CERTIFICATEPARSE  0x0011U
#endif /* #ifndef  CRYPTO_CERTIFICATEPARSE */
[!ENDIF!]
[!IF "node:value(./CsmEbGeneral/CsmEbMisc/CsmEbAutosarApiVersion) = 'CSM_API_VERSION_440'"!]
/** \brief  CertificateVerify Service.
 **/
/* !LINKSTO CSM.Dsn.SWS_Csm_01031,2 */
#ifndef  CRYPTO_CERTIFICATEVERIFY
  #define  CRYPTO_CERTIFICATEVERIFY  0x0012U
#endif /* #ifndef  CRYPTO_CERTIFICATEVERIFY */
[!ENDIF!]
[!IF "node:value(./CsmEbGeneral/CsmEbMisc/CsmEbAutosarApiVersion) = 'CSM_API_VERSION_440'"!]
...
[!ENDIF!]
[!IF "node:value(./CsmEbGeneral/CsmEbMisc/CsmEbEnhancementApiCsmKeyGetStatus) = 'true'"!][!//
/* --- Crypto_KeyStatusType --------------------------------------------------------------------- */
/** \brief  The status of the key is invalid (for example after Csm_KeyElementSet the
 **         Csm_KeySetValid was not called).
 **/
/* !LINKSTO CSM.Dsn.SWS_Csm_91102,1 */
#ifndef  CRYPTO_KEYSTATUS_INVALID
  #define  CRYPTO_KEYSTATUS_INVALID  0x0000U
#endif /* #ifndef  CRYPTO_KEYSTATUS_INVALID */
/** \brief  The status of the key is valid (for example the status was successfully set by the
 **         Csm_KeySetValid).
 **/
/* !LINKSTO CSM.Dsn.SWS_Csm_91102,1 */
#ifndef  CRYPTO_KEYSTATUS_VALID
  #define  CRYPTO_KEYSTATUS_VALID  0x0001U
#endif /* #ifndef  CRYPTO_KEYSTATUS_VALID */
[!ENDIF!][!//
/* --- Csm_ResultType --------------------------------------------------------------------------- */
...
[!IF "node:value(./CsmEbGeneral/CsmEbMisc/CsmEbAutosarApiVersion) = 'CSM_API_VERSION_440'"!]
/** \brief  Crypto stack Std_ReturnType extension 'CRYPTO_E_KEY_EMPTY'
 **/
#ifndef CRYPTO_E_KEY_EMPTY
  #define  CRYPTO_E_KEY_EMPTY           0x000DU
#endif /* #ifndef CRYPTO_E_JOB_CANCELED */
...
#ifdef CSM_SYM_KEY_MAX_LENGTH
  #error CSM_SYM_KEY_MAX_LENGTH is already defined
#endif /* #ifdef CSM_SYM_KEY_MAX_LENGTH */
...
#ifdef CSM_ASYM_PRIVATE_KEY_MAX_LENGTH
  #error CSM_ASYM_PRIVATE_KEY_MAX_LENGTH is already defined
#endif /* #ifdef CSM_ASYM_PRIVATE_KEY_MAX_LENGTH */
...
#ifdef CSM_ASYM_PUBLIC_KEY_MAX_LENGTH
  #error CSM_ASYM_PUBLIC_KEY_MAX_LENGTH is already defined
#endif /* #ifdef CSM_ASYM_PUBLIC_KEY_MAX_LENGTH */
 ...
 **/
/* !LINKSTO Csm.Asr.SWS_Csm_91024,1 */
#ifndef RTE_TYPE_Crypto_InputOutputRedirectionConfigType
  #define RTE_TYPE_Crypto_InputOutputRedirectionConfigType
typedef uint8 Crypto_InputOutputRedirectionConfigType;
#endif /* #ifndef RTE_TYPE_Crypto_InputOutputRedirectionConfigType */
 ...
 **/
/* !LINKSTO CSM.Dsn.SWS_Csm_91102,1 */
#ifndef RTE_TYPE_Crypto_KeyStatusType
  #define RTE_TYPE_Crypto_KeyStatusType
typedef uint8 Crypto_KeyStatusType;
#endif /* #ifndef RTE_TYPE_Crypto_KeyStatusType */
[!ENDIF!][!//
 ...
 **/
/* !LINKSTO Csm.Asr.SWS_Csm_01085,1 */
#ifndef RTE_TYPE_Csm_ConfigType
  #define RTE_TYPE_Csm_ConfigType
typedef struct
{
  uint32 dummy;
}
Csm_ConfigType;
#endif /* #ifndef RTE_TYPE_Csm_ConfigType */
 ...
 **/
/* !LINKSTO Csm.Asr.SWS_Csm_91026,1 */
#ifndef RTE_TYPE_Crypto_JobRedirectionInfoType
  #define RTE_TYPE_Crypto_JobRedirectionInfoType
typedef struct
{
...
#endif /* #ifndef RTE_TYPE_Crypto_JobRedirectionInfoType */
