...
IF "%1" == "GHS2018" SET COMPILER=Ghs2018
IF "%1" == "GHS2021" SET COMPILER=Ghs2021

IF "%COMPILER%" == "Tasking" SET B_Tasking_COMPILER_PATH=C:/sofit/aurix2g_sw_mcal/tasking/6.3r1p5/tasking/ctc/bin
...
IF "%COMPILER%" == "Ghs2018" SET B_GHS_TRICORE_PATH=C:/sofit/aurix2g_sw_mcal/green-hills/v2018.1.5-9.15.1/green-hills/comp_201815
IF "%COMPILER%" == "Ghs2021" SET B_GHS_TRICORE_PATH=C:/sofit/aurix2g_sw_mcal/green-hills/v2021.1.5/green-hills/comp_202115
...
xcopy /y ..\..\..\Tools\Compiler_Configs_AS440_225MR\TC37A_ED_Config_%COMPILER%.xml 1_ToolEnv\0_Build\1_Config\Config.xml
make all
