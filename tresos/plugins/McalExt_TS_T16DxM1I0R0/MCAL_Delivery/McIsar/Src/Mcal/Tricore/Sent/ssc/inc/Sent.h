...
#define Sent_SpcGenPulse(ChanId, SpcCfgPtr) \
                          (ERROR_Sent_SpcGenPulse_API_IS_NOT_SELECTED)
#endif
...
#define Sent_GetVersionInfo(versioninfo)                              \
                           (ERROR_Sent_GetVersionInfo_API_IS_NOT_SELECTED)
...
/* MISRA2012_RULE_4_9_JUSTIFICATION: Function like macro used to generate
  compile time error in case of incorrect configuration*/
#define Sent_DeInit(void)        (ERROR_Sent_DeInit_API_IS_NOT_SELECTED)
#endif
