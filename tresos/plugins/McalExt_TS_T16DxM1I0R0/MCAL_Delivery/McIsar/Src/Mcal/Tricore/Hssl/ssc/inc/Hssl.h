...
typedef void(*Hssl_DMAUserNotify)(uint32 Event);
...
extern Std_ReturnType Hssl_ReadRply (const Hssl_InstanceID id,\
                                     const Hssl_ChannelType *const Channel);
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: With Hssl_ReadRply disabled
Hssl_ReadRply is implemented as Function like macro*/
#define Hssl_ReadRply(id, Channel) (ERROR_Hssl_ReadRply_API_IS_NOT_SELECTED)
#endif
/*******************************************************************************
** Traceability    : [cover parentID=][/cover]                                **
**                                                                            **
...
extern Std_ReturnType Hssl_SelectSlave(const Hssl_InstanceID id,\
                                       const uint8 Hssl_SlaveID);
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: With Hssl_SelectSlave disabled
Hssl_SelectSlave is implemented as Function like macro*/
#define Hssl_SelectSlave(id, Hssl_SlaveID) \
                        (ERROR_Hssl_SelectSlave_API_IS_NOT_SELECTED)
#endif

#if ((HSSL_INTERFACE_MODE == HSSL_MASTER) && (HSSL_MULTI_SLAVE_MODE == STD_ON))
/*******************************************************************************
** Traceability    : [cover parentID=][/cover]                                **
**                                                                            **
...
extern Std_ReturnType Hssl_ActivateSlave(const Hssl_InstanceID id,\
        ...
        Hssl_SlaveStatusType *const Hssl_SlaveStatus);
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: With Hssl_ActivateSlave disabled
Hssl_ActivateSlave is implemented as Function like macro*/
#define Hssl_ActivateSlave(id, Hssl_SlaveID, Hssl_SlaveStatus) \
                          (ERROR_Hssl_ActivateSlave_API_IS_NOT_SELECTED)
#endif
...
extern Std_ReturnType Hssl_DeactivateSlave(const Hssl_InstanceID id,\
        ...
        Hssl_SlaveStatusType *const Hssl_SlaveStatus);
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: With Hssl_DeactivateSlave disabled
Hssl_DeactivateSlave is implemented as Function like macro*/
#define Hssl_DeactivateSlave(id, Hssl_SlaveID, Hssl_SlaveStatus) \
                            (ERROR_Hssl_DeactivateSlave_API_IS_NOT_SELECTED)
#endif
...
** Description     :                                                          **
*******************************************************************************/
extern void Hssl_DmaErrCallout (const uint8 Channel,
                                 const uint32 Event);
...
** Description     :                                                          **
*******************************************************************************/
extern void Hssl_DmaCallout(const uint8 Channel, const uint32 Event);
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: With Hssl_GetVersionInfo disabled
Hssl_GetVersionInfo is implemented as Function like macro*/
#define Hssl_GetVersionInfo(versioninfo) \
                           (ERROR_Hssl_GetVersionInfo_API_IS_NOT_SELECTED)
#endif
