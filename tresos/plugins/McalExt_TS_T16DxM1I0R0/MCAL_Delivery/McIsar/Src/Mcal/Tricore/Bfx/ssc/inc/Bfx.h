...
ASCINFINEON-996 : Specification of AUTOSAR srs_bsw_00318 requires each module to provide 
a <MODULENAME>_AR_RELEASE(MAJOR|MINOR|REVISION)_VERSION. Currently this is missing for Bfx.
EB added as workaround the defines with values 4.4.0 as per Bfx user manual.
*/
#define BFX_AR_RELEASE_MAJOR_VERSION                      (4U)
#define BFX_AR_RELEASE_MINOR_VERSION                      (4U)
#define BFX_AR_RELEASE_REVISION_VERSION                   (0U)
