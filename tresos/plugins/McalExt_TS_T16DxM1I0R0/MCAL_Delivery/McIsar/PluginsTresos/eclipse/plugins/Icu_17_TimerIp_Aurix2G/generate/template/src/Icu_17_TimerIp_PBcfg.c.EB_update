...
[!SELECT "as:modconf('Icu')[1]"!][!//
  ...
  [!NOCODE!][!//
        ...
        [!IF "contains($CGCoreMap,concat('CORE',num:i($CoreId) - num:i(1))) or ((num:i($CGMasterCoreId_Extract) = (num:i($CoreId) - num:i(1))) and (count(text:split($CGCoreMap,',')) != $MaxChannels))"!][!//
          [!INDENT "0"!]
            ...
            [!IF "var:defined('postBuildVariant')"!][!//
              static const Icu_17_TimerIp_ChannelConfigType Icu_17_TimerIp_kChannelConfigCore_[!"num:i(num:i($CoreId) - num:i(1))"!]_[!"$postBuildVariant"!][ ] =
            [!ELSE!]
              ...
              [!IF "$CGAllocationResult = 'TRUE'"!][!//
                ...
                [!NOCODE!][!//
                  ...
                  [!IF "($HWused = 'GTM')"!][!//
                    ...
                    [!VAR "temp2" = "concat('ICU_',$temp1)"!][!//
                    [!VAR "temp3" ="concat($temp2,'&ICU_FLT_MODE_MSK')"!]
          ...
          [!INDENT "0"!]
            ...
            in generated code due to Autosar Naming constraints.*/
            [!IF "var:defined('postBuildVariant')"!][!//
              static const Icu_17_TimerIp_CoreConfigType Icu_17_TimerIp_kConfigCore_[!"num:i(num:i($CoreId) - num:i(1))"!]_[!"$postBuildVariant"!] =
            [!ELSE!]
          ...
          [!INDENT "2"!]
            ...
            [!IF "num:i($MaxChannelsCorex) != num:i(0)"!]
              [!IF "var:defined('postBuildVariant')"!][!//
                &Icu_17_TimerIp_kChannelConfigCore_[!"num:i(num:i($CoreId) - num:i(1))"!]_[!"$postBuildVariant"!][0],
              [!ELSE!]
    ...
    [!INDENT "0"!]
      ...
      [!IF "var:defined('postBuildVariant')"!][!//
        const Icu_17_TimerIp_ConfigType Icu_17_TimerIp_Config_[!"$postBuildVariant"!] =
      [!ELSE!]
    ...
    [!SELECT "IcuConfigSet"!][!//
      ...
      [!INDENT "4"!]
        [!IF "num:i($MaxChannelsCore0) != num:i(0)"!]
          [!IF "var:defined('postBuildVariant')"!][!//
            &Icu_17_TimerIp_kConfigCore_0_[!"$postBuildVariant"!],
          [!ELSE!]
        ...
        [!IF "num:i($MaxChannelsCore1) != num:i(0)"!]
          [!IF "var:defined('postBuildVariant')"!][!//
            &Icu_17_TimerIp_kConfigCore_1_[!"$postBuildVariant"!],
          [!ELSE!]
        ...
        [!IF "num:i($MaxChannelsCore2) != num:i(0)"!]
          [!IF "var:defined('postBuildVariant')"!][!//
            &Icu_17_TimerIp_kConfigCore_2_[!"$postBuildVariant"!],
          [!ELSE!]
        ...
        [!IF "num:i($MaxChannelsCore3) != num:i(0)"!]
          [!IF "var:defined('postBuildVariant')"!][!//
            &Icu_17_TimerIp_kConfigCore_3_[!"$postBuildVariant"!],
          [!ELSE!]
        ...
        [!IF "num:i($MaxChannelsCore4) != num:i(0)"!]
          [!IF "var:defined('postBuildVariant')"!][!//
            &Icu_17_TimerIp_kConfigCore_4_[!"$postBuildVariant"!],
          [!ELSE!]
        ...
        [!IF "num:i($MaxChannelsCore5) != num:i(0)"!]
          [!IF "var:defined('postBuildVariant')"!][!//
            &Icu_17_TimerIp_kConfigCore_5_[!"$postBuildVariant"!]
          [!ELSE!]
