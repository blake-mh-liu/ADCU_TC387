  ...
  [!SELECT "as:modconf('Uart')[1]"!][!//
    ...
    [!LOOP "UartConfigSet/UartChannel/*"!][!//
      ...
      [!IF "num:isnumber($TxAbortNotify) !=  'true' and $TxAbortNotify != 'NULL_PTR'"!]
        ...
        [!ENDIF!][!//
      [!ENDIF!][!//
      [!VAR "RxStreamingNotify" = "UartNotification/UartStreamingRecvNotifPtr"!][!//
      [!IF "num:isnumber($RxStreamingNotify) !=  'true' and $RxStreamingNotify != 'NULL_PTR'"!]
        /* Streaming notification function of [!"node:name(.)"!] */
        [!IF "not(text:contains(text:split($Uart_MasterCallBackJobLstNum,','),$RxStreamingNotify))"!]
          extern void [!"$RxStreamingNotify"!](Uart_ErrorIdType ErrorId,Uart_SizeType RxDataSize);
          [!VAR "Uart_MasterCallBackJobLstNum" = "concat($Uart_MasterCallBackJobLstNum,$RxStreamingNotify,',')"!]
        [!ENDIF!][!//
      [!ENDIF!][!//
    [!ENDLOOP!][!//
  [!ENDSELECT!][!//
  ...
  [!SELECT "as:modconf('Uart')[1]"!][!//
    ...
    */!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!]
      static const Uart_ChannelConfigType  Uart_ChannelConfig_[!"$postBuildVariant"!][[!"string(num:i($TotalChannel))"!]] =
    [!ELSE!][!//
      ...
      [!LOOP "node:order(UartConfigSet/UartChannel/*, './UartChannelId')"!][!//
        ...
        [!INDENT "4"!]
          ...
          [!INDENT "6"!]
            ...
            [!VAR "SymbolicName" = "UartNotification/UartStreamingRecvNotifPtr"!][!//
            [!IF "num:isnumber($SymbolicName) = 'true'"!][!//
              [!"concat('(Uart_Streaming_NotificationPtrType)',num:inttohex(num:radixtoint($SymbolicName),8),'U')"!],
            [!ELSE!][!//
              [!IF "($SymbolicName != 'NULL_PTR')"!][!//
                &[!"$SymbolicName"!],
              [!ELSE!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!]
      static const uint8 Uart_ChannelIdLookup_[!"$postBuildVariant"!][UART_MAX_HW_UNIT] =
    [!ELSE!][!//
    ...
    [!SELECT "UartConfigSet/*[1]"!][!//
      [!IF "var:defined('postBuildVariant')"!]
        const Uart_ConfigType Uart_Config_[!"$postBuildVariant"!] =
      [!ELSE!]
    ...
    [!INDENT "2"!]
      [!IF "var:defined('postBuildVariant')"!]
        &Uart_ChannelConfig_[!"$postBuildVariant"!][0],
      [!ELSE!][!//
        &Uart_ChannelConfig[0],
      [!ENDIF!][!//
      [!IF "var:defined('postBuildVariant')"!][!//
        &Uart_ChannelIdLookup_[!"$postBuildVariant"!][0],
      [!ELSE!][!//
