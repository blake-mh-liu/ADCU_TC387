...
[!INDENT "0"!][!//
  [!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
      [!WS"0"!]/* Extern declaration of Smu Config Root for [!"."!] */
      [!WS"0"!]extern const Smu_ConfigType Smu_Config_[!"."!];
    [!ENDLOOP!]
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of Smu Config Root */
    [!WS"0"!]extern const Smu_ConfigType Smu_Config;
  [!ENDIF!][!//
[!ENDINDENT!][!//
