  ...
  */
  ...
  [!SELECT "as:modconf('Lin')[1]"!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      static const uint8 Lin_17_AscLin_Hw_To_ChannelIdMap_[!"$postBuildVariant"!][LIN_17_ASCLIN_MAX_HW_UNIT] =
    [!ELSE!][!//
    ...
    */
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      static const uint8 Lin_17_AscLin_Channel_To_Core_SpecificArray_[!"$postBuildVariant"!][LIN_17_ASCLIN_MAXIMUM_CHANNEL_CONFIGURED] =
    [!ELSE!][!//
    ...
    [!FOR "CoreId" = "num:i(0)" TO "num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!]
      ...
      [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId)) or ($CGMasterCoreId = $TempCoreId)"!][!//
        ...
        [!IF "$MaxChannelsCore > num:i(0)"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Lin_17_AscLin_ChannelType  Lin_kChannelConfigurationCore[!"$CoreId"!]_[!"$postBuildVariant"!][[!"(num:i($MaxChannelsCore))"!]] =
          [!ELSE!][!//
              ...
              [!IF "$CGAllocationResult = 'TRUE'"!][!//
                [!NOCODE!][!//
                  ...
                  [!IF "$MinorVersion = num:i(2)"!][!//
                    [!VAR "Channel_Node" = "'MASTER'"!][!//
                  [!ELSE!][!//
                    [!VAR "Channel_Node" = "node:value(LinNodeType)"!][!//
                  [!ENDIF!][!//
                [!ENDNOCODE!][!//
                [!INDENT "2"!][!//
                  ...
                  [!INDENT "4"!]
                    ...
                    LIN_17_ASCLIN_[!"$Channel_Node"!]_NODE  /*Channel node type */
                  [!ENDINDENT!][!//
                  [!VAR "Count" = "$Count + 1"!][!//
        ...
        [!IF "$MaxChannelsCore > num:i(0)"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Lin_17_AscLin_CoreConfigType Lin_CoreConfigCore[!"$CoreId"!]_[!"$postBuildVariant"!] =
          [!ELSE!][!//
          ...
          [!INDENT "4"!][!//
            ...
            [!IF "var:defined('postBuildVariant')"!][!//
              (const Lin_17_AscLin_ChannelType*)&Lin_kChannelConfigurationCore[!"$CoreId"!]_[!"$postBuildVariant"!][0]
            [!ELSE!][!//
    ...
    */
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      const Lin_17_AscLin_ConfigType  Lin_17_AscLin_Config_[!"$postBuildVariant"!] =
    [!ELSE!][!//
    ...
    [!INDENT "2"!]
        ...
        [!FOR "CoreId" = "num:i(0)" TO "num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!][!//
          ...
          [!ENDFOR!]
            [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId)) or ($MaxChannelsCore > num:i(0) and $CGMasterCoreId = $TempCoreId)"!]
              [!IF "var:defined('postBuildVariant')"!]
                (Lin_17_AscLin_CoreConfigType*)&Lin_CoreConfigCore[!"$CoreId"!]_[!"$postBuildVariant"!][!IF "$CoreId < num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!],[!ENDIF!][!CR!]
              [!ELSE!]
      ...
      [!IF "var:defined('postBuildVariant')"!][!//
        &Lin_17_AscLin_Channel_To_Core_SpecificArray_[!"$postBuildVariant"!][0],
      [!ELSE!][!//
        &Lin_17_AscLin_Channel_To_Core_SpecificArray[0],
      [!ENDIF!][!//
      [!IF "var:defined('postBuildVariant')"!][!//
        &Lin_17_AscLin_Hw_To_ChannelIdMap_[!"$postBuildVariant"!][0]
      [!ELSE!][!//
