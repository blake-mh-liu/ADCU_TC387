...
[!SELECT "as:modconf('Spi')[1]/SpiDriver/SpiExternalDevice/*[node:name(.) = $Spi_OutDevice]"!]
  ...
  [!ELSE!][!//
    [!VAR "Spi_MacParitysupport"="num:i(0)"!]
  [!ENDIF!][!//
  [!VAR "Spi_MacDelayIdlePre"="num:i(0)"!]
  [!VAR "Spi_MacDelayIdleLength"="num:i(0)"!]
  [!VAR "Spi_MacDelayLeadPre"="num:i(0)"!]
  [!VAR "Spi_MacDelayLeadLength"="num:i(0)"!]
  [!VAR "Spi_MacDelayTrailPre"="num:i(0)"!]
  [!VAR "Spi_MacDelayTrailLength"="num:i(0)"!]
...
[!FOR "CPUINDEX" = "0" TO "num:i($Spi_MaxCore)"!][!//
  ...
  [!IF "($QSPI0CoreID = $CPUINDEX) or ($QSPI1CoreID = $CPUINDEX) or ($QSPI2CoreID = $CPUINDEX) or ($QSPI3CoreID = $CPUINDEX) or ($QSPI4CoreID = $CPUINDEX) or ($QSPI5CoreID = $CPUINDEX)"!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      &Spi_Config_Core[!"num:i($CPUINDEX)"!]_[!"$postBuildVariant"!][!//
    [!ELSE!][!//
...
[!IF "var:defined('postBuildVariant')"!][!//
  [!INDENT "0"!][!//
  static const uint8 SequenceLookupIndex_[!"$postBuildVariant"!][[!"num:i(count(SpiDriver/SpiSequence/*))"!]] =
  [!ENDINDENT!][!//
[!ELSE!][!//
  [!INDENT "0"!][!//
...
[!INDENT "0"!][!//
[!IF "var:defined('postBuildVariant')"!][!//
  static const uint16 JobLookupIndex_[!"$postBuildVariant"!][[!"num:i(count(SpiDriver/SpiJob/*))"!]] =
[!ELSE!][!//
...
[!INDENT "0"!][!//
[!IF "var:defined('postBuildVariant')"!][!//
  static const uint8 ChannelLookupIndex_[!"$postBuildVariant"!][[!"num:i(count(SpiDriver/SpiChannel/*))"!]] =
[!ELSE!][!//
