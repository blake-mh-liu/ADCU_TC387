...
[!INDENT "0"!]
  ...
  *******************************************************************************/
  ...
  [!SELECT "as:modconf('Icu')[1]"!][!// 
    ...
    */
    [!/* [cover parentID={51D27490-D204-4c45-ACBC-D9A136649510}] */!]
    [!IF "node:exists(IcuGeneral/IcuRunTimeErrorDetect)"!]
      #define ICU_17_TIMERIP_RUNTIME_ERROR_DETECT           [!CALL "ICU_CG_ConfigSwitch", "nodeval" = "IcuGeneral/IcuRunTimeErrorDetect"!]
    [!ELSE!]
    ...
    */
    [!/* [cover parentID={191FD605-E397-41fb-9B82-D593B0DB0F86}] */!]
    #define ICU_17_TIMERIP_TIMEOUT_DETECTION_API        [!CALL "ICU_CG_ConfigSwitch", "nodeval" = "IcuOptionalApis/IcuTimeoutDetectionApi"!] 
    [!/*  [/cover] */!]
    /*
    ...
    */
    ...
    [!IF "node:exists(IcuGeneral/IcuIndex)"!]
