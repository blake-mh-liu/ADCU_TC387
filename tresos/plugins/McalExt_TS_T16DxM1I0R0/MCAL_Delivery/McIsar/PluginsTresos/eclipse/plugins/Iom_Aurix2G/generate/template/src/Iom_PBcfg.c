...
[!SELECT "as:modconf('Iom')[1]"!][!//
  ...
  [!INDENT "0"!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      static const Iom_FpcConfigType Iom_kFpcConfiguration_[!"$postBuildVariant"!][] =
    [!ELSE!]
  ...
  [!INDENT "0"!][!//
    ...
    /* LAM Configuration */
    [!IF "var:defined('postBuildVariant')"!][!//
      static const Iom_LamConfigType Iom_kLamConfiguration_[!"$postBuildVariant"!][] =
    [!ELSE!]
  ...
  [!INDENT "0"!][!//
    /* ECM configuration */
    [!IF "var:defined('postBuildVariant')"!][!//
      static const Iom_EcmConfigType Iom_kEcmConfiguration_[!"$postBuildVariant"!] =
    [!ELSE!]
  ...
  [!INDENT "0"!][!//
    [!IF "var:defined('postBuildVariant')"!][!//
      const Iom_ConfigType Iom_Config_[!"$postBuildVariant"!] =
    [!ELSE!]
    ...
    [!ENDIF!][!//
    {
      [!INDENT "2"!][!//
    [!IF "var:defined('postBuildVariant')"!][!//
      &Iom_kFpcConfiguration_[!"$postBuildVariant"!][0],
    [!ELSE!]
      &Iom_kFpcConfiguration[0],
    [!ENDIF!][!//
    [!IF "var:defined('postBuildVariant')"!][!//
      &Iom_kLamConfiguration_[!"$postBuildVariant"!][0],
    [!ELSE!]
      &Iom_kLamConfiguration[0],
    [!ENDIF!][!//
    [!IF "var:defined('postBuildVariant')"!][!//
      &Iom_kEcmConfiguration_[!"$postBuildVariant"!],
    [!ELSE!]
