...
[!INDENT "0"!][!//
  ...
  [!SELECT "as:modconf('Irq')[1]"!][!//
    ...
    */
    ...
    [!IF "num:i(count(IrqCanConfig/*)) = 1"!][!//
      ...
      */
      ...
      [!IF "contains( ecu:get('Irq.CanModulesAvailable'), 'IrqCan3' )"!][!//
        /* CAN3 interrupt Category Setting */
        [!FOR "SrnId" ="num:i(1)" TO "num:i(count(IrqCanConfig/*[1]/IrqCan3Config/IrqCanCatConfig/*))"!][!//
          #define IRQ_CAN3_SR[!"substring-before(substring-after(node:name(IrqCanConfig/*[1]/IrqCan3Config/IrqCanCatConfig/*[num:i($SrnId)]), 'IrqCanSR'),'Cat')"!]_CAT      (IRQ_[!"IrqCanConfig/*[1]/IrqCan3Config/IrqCanCatConfig/*[num:i($SrnId)]"!])[!CR!][!//
        [!ENDFOR!][!//

        /* CAN3 interrupt Priority Setting */
        [!FOR "SrnId" ="num:i(1)" TO "num:i(count(IrqCanConfig/*[1]/IrqCan3Config/IrqCanPrioConfig/*))"!][!//
          [!VAR "Givenno" = "num:i(IrqCanConfig/*[1]/IrqCan3Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!//
          [!VAR "TypeOfService" = "IrqCanConfig/*[1]/IrqCan3Config/IrqCanTosConfig/*[num:i($SrnId)]"!][!//
          [!VAR "cont" = "'CAN3'"!][!//
          [!NOCODE!][!//
            [!IF "$TypeOfService != 'DMA'"!][!//
              [!CALL "CG_PriorityCheck", "Givenno" = "$Givenno","cont" = "$cont"!][!//
            ...
            [!ENDIF!][!//
          [!ENDNOCODE!][!//
          #define IRQ_CAN3_SR[!"substring-before(substring-after(node:name(IrqCanConfig/*[1]/IrqCan3Config/IrqCanPrioConfig/*[num:i($SrnId)]), 'IrqCanSR'),'Prio')"!]_PRIO     [!"num:inttohex(IrqCanConfig/*[1]/IrqCan3Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!CR!][!//
          [!NOCODE!][!//
            ...
            [!IF "(IrqGeneral/IrqOsekEnable = 'true')"!][!//
              [!/* Assign current priority to variable "PRIORITY" */!][!//
              [!VAR "PRIORITY" = "num:i(IrqCanConfig/*[1]/IrqCan3Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!//
              [!/* Assign current category to variable "CATEGORY" */!][!//
              [!VAR "CATEGORY" = "IrqCanConfig/*[1]/IrqCan3Config/IrqCanCatConfig/*[num:i($SrnId)]"!][!//
              [!/* Check if Priority value 1 and 2 are not used if IRQ_OSEK_ENABLE is ON */!][!//
              [!IF "((num:i($PRIORITY) = num:i(1))or (num:i($PRIORITY)= num:i(2)))"!][!//
                [!WARNING "Priority 1 and 2 of CPU Interrupts are used by OSEK for Task Switching!"!][!//
              [!ENDIF!][!//
            ...
            [!ENDIF!][!/* End of "Check only if IRQ_OSEK_ENABLE is ON " */!][!//
          [!ENDNOCODE!][!//
        [!ENDFOR!][!/* End of CAN3 interrupt Priority Setting for loop */!][!//

        /* CAN3 interrupt type of service Setting */
        [!FOR "SrnId" ="num:i(1)" TO "num:i(count(IrqCanConfig/*[1]/IrqCan3Config/IrqCanTosConfig/*))"!][!//
          #define IRQ_CAN3_SR[!"substring-before(substring-after(node:name(IrqCanConfig/*[1]/IrqCan3Config/IrqCanTosConfig/*[num:i($SrnId)]), 'IrqCanSR'),'Tos')"!]_TOS      (IRQ_TOS_[!"IrqCanConfig/*[1]/IrqCan3Config/IrqCanTosConfig/*[num:i($SrnId)]"!])[!CR!][!//
          [!NOCODE!][!//
            [!VAR "PrioVal" = "num:i(IrqCanConfig/*[1]/IrqCan3Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!//
            [!VAR "TypeOfService" = "IrqCanConfig/*[1]/IrqCan3Config/IrqCanTosConfig/*[num:i($SrnId)]"!][!//
            [!IF "$TypeOfService = 'DMA'"!][!//
              [!IF "num:i($PrioVal) > num:i($DmaMaxPrio)"!][!//
                [!ERROR!][//
        ...
        [!ENDFOR!][!//
      [!ENDIF!][!//
      [!IF "contains( ecu:get('Irq.CanModulesAvailable'), 'IrqCan4' )"!][!//
        /* CAN4 interrupt Category Setting */
        [!FOR "SrnId" ="num:i(1)" TO "num:i(count(IrqCanConfig/*[1]/IrqCan4Config/IrqCanCatConfig/*))"!][!//
          #define IRQ_CAN4_SR[!"substring-before(substring-after(node:name(IrqCanConfig/*[1]/IrqCan4Config/IrqCanCatConfig/*[num:i($SrnId)]), 'IrqCanSR'),'Cat')"!]_CAT      (IRQ_[!"IrqCanConfig/*[1]/IrqCan4Config/IrqCanCatConfig/*[num:i($SrnId)]"!])[!CR!][!//
        [!ENDFOR!][!//

        /* CAN4 interrupt Priority Setting */
        [!FOR "SrnId" ="num:i(1)" TO "num:i(count(IrqCanConfig/*[1]/IrqCan4Config/IrqCanPrioConfig/*))"!][!//
          [!VAR "Givenno" = "num:i(IrqCanConfig/*[1]/IrqCan4Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!//
          [!VAR "TypeOfService" = "IrqCanConfig/*[1]/IrqCan4Config/IrqCanTosConfig/*[num:i($SrnId)]"!][!//
          [!VAR "cont" = "'CAN4'"!][!//
          [!NOCODE!][!//
            [!IF "$TypeOfService != 'DMA'"!][!//
              [!CALL "CG_PriorityCheck", "Givenno" = "$Givenno","cont" = "$cont"!][!//
            ...
            [!ENDIF!][!//
          [!ENDNOCODE!][!//
          #define IRQ_CAN4_SR[!"substring-before(substring-after(node:name(IrqCanConfig/*[1]/IrqCan4Config/IrqCanPrioConfig/*[num:i($SrnId)]), 'IrqCanSR'),'Prio')"!]_PRIO     [!"num:inttohex(IrqCanConfig/*[1]/IrqCan4Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!CR!][!//
          [!NOCODE!][!//
            ...
            [!IF "(IrqGeneral/IrqOsekEnable = 'true')"!][!//
              [!/* Assign current priority to variable "PRIORITY" */!][!//
              [!VAR "PRIORITY" = "num:i(IrqCanConfig/*[1]/IrqCan4Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!//
              [!/* Assign current category to variable "CATEGORY" */!][!//
              [!VAR "CATEGORY" = "IrqCanConfig/*[1]/IrqCan4Config/IrqCanCatConfig/*[num:i($SrnId)]"!][!//
              [!/* Check if Priority value 1 and 2 are not used if IRQ_OSEK_ENABLE is ON */!][!//
              [!IF "((num:i($PRIORITY) = num:i(1))or (num:i($PRIORITY)= num:i(2)))"!][!//
                [!WARNING "Priority 1 and 2 of CPU Interrupts are used by OSEK for Task Switching!"!][!//
              [!ENDIF!][!//
            ...
            [!ENDIF!][!/* End of "Check only if IRQ_OSEK_ENABLE is ON " */!][!//
          [!ENDNOCODE!][!//
        [!ENDFOR!][!/* End of CAN4 interrupt Priority Setting for loop */!][!//

        /* CAN4 interrupt type of service Setting */
        [!FOR "SrnId" ="num:i(1)" TO "num:i(count(IrqCanConfig/*[1]/IrqCan4Config/IrqCanTosConfig/*))"!][!//
          #define IRQ_CAN4_SR[!"substring-before(substring-after(node:name(IrqCanConfig/*[1]/IrqCan4Config/IrqCanTosConfig/*[num:i($SrnId)]), 'IrqCanSR'),'Tos')"!]_TOS      (IRQ_TOS_[!"IrqCanConfig/*[1]/IrqCan4Config/IrqCanTosConfig/*[num:i($SrnId)]"!])[!CR!][!//
          [!NOCODE!][!//
            [!VAR "PrioVal" = "num:i(IrqCanConfig/*[1]/IrqCan4Config/IrqCanPrioConfig/*[num:i($SrnId)])"!][!//
            [!VAR "TypeOfService" = "IrqCanConfig/*[1]/IrqCan4Config/IrqCanTosConfig/*[num:i($SrnId)]"!][!//
            [!IF "$TypeOfService = 'DMA'"!][!//
              [!IF "num:i($PrioVal) > num:i($DmaMaxPrio)"!][!//
                [!ERROR!][//
    ...
    */
    ...
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.CanModulesAvailable'), 'IrqCan3' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.CanModulesAvailable'), 'IrqCan4' ))  and ($ModAdded = 'true')"!][!//
    ...
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn0' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN0_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN0_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn1' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN1_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN1_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn2' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN2_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN2_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn3' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN3_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN3_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn4' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN4_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN4_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn5' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN5_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN5_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn6' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN6_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN6_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn7' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN7_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN7_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn8' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN8_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN8_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn9' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN9_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN9_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn10' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN10_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN10_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn11' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN11_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN11_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn12' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN12_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN12_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn13' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN13_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN13_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn14' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN14_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN14_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can3SrnAvailable'), 'IrqCanSrn15' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN3SRN15_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN3SRN15_EXIST             (STD_OFF)
    [!ENDIF!][!//

    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn0' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN0_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN0_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn1' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN1_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN1_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn2' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN2_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN2_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn3' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN3_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN3_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn4' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN4_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN4_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn5' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN5_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN5_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn6' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN6_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN6_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn7' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN7_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN7_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn8' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN8_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN8_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn9' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN9_EXIST              (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN9_EXIST              (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn10' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN10_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN10_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn11' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN11_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN11_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn12' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN12_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN12_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn13' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN13_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN13_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn14' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN14_EXIST             (STD_ON)
    [!ELSE!][!//
      #define IRQ_CAN4SRN14_EXIST             (STD_OFF)
    [!ENDIF!][!//
    [!IF "(contains( ecu:get('Irq.Can4SrnAvailable'), 'IrqCanSrn15' ))  and ($ModAdded = 'true')"!][!//
      #define IRQ_CAN4SRN15_EXIST             (STD_ON)
    [!ELSE!][!//
    ...
    [!IF "($ModAdded = 'true')"!][!//
      ...
      [!SELECT "as:modconf('Mcu')[1]/McuHardwareResourceAllocationConf/*[1]/McuAscLinAllocationConf"!][!//
        ...
        [!FOR "count"="num:i(1)" TO "$TotalUnits"!][!//
          [!IF "(./*[num:i($count)]/McuAscLinChannelAllocationConf/*[1] != 'ASCLIN_CH_NOT_USED')"!][!//
           #define IRQ_ASCLIN_CHANNEL[!"num:i(substring-after(node:value(./*[num:i($count)]/McuAscLinChannelAllocationConf/McuAscLinKernelId),'ASCLIN'))"!]_USED IRQ_[!"./*[num:i($count)]/McuAscLinChannelAllocationConf/*[1]"!]
          [!ENDIF!][!//
        [!ENDFOR!][!//
      [!ENDSELECT!][!//
    [!ENDIF!][!//
