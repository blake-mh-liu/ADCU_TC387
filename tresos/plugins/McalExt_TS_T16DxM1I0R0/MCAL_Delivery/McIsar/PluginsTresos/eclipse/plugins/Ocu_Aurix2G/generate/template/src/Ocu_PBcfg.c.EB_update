...
[!SELECT "as:modconf('Ocu')[1]"!][!//
      ...
      [!IF "contains($CGCoreMap,concat('CORE',num:i($CoreId) - num:i(1))) or num:i($CGMasterCoreId_Extract) = (num:i($CoreId) - num:i(1))"!][!//
        [!INDENT "0"!]
          ...
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Ocu_ChannelConfigType Ocu_kChannelConfigCore_[!"num:i(num:i($CoreId) - num:i(1))"!]_[!"$postBuildVariant"!][ ] =
            [!ELSE!]
        ...
        [!INDENT "0"!]
          ...
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Ocu_CoreConfigType Ocu_kConfigCore_[!"num:i(num:i($CoreId) - num:i(1))"!]_[!"$postBuildVariant"!] =
          [!ELSE!]
        ...
        [!INDENT "2"!]
          ...
          [!IF "num:i($MaxChannelsCorex) != num:i(0)"!]
            [!IF "var:defined('postBuildVariant')"!][!//
              &Ocu_kChannelConfigCore_[!"num:i(num:i($CoreId) - num:i(1))"!]_[!"$postBuildVariant"!][0],
            [!ELSE!]
  ...
  [!INDENT "0"!]
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      const Ocu_ConfigType Ocu_Config_[!"$postBuildVariant"!] =
    [!ELSE!]
  ...
  [!SELECT "OcuConfigSet"!][!//
    ...
    [!INDENT "4"!]
      [!IF "num:i($MaxChannelsCore0) != num:i(0)"!]
        [!IF "var:defined('postBuildVariant')"!][!//
          &Ocu_kConfigCore_0_[!"$postBuildVariant"!],
        [!ELSE!]
          &Ocu_kConfigCore_0,
        [!ENDIF!]
      [!ELSE!][!//
      ...
      [!IF "num:i($MaxChannelsCore1) != num:i(0)"!]
        [!IF "var:defined('postBuildVariant')"!][!//
          &Ocu_kConfigCore_1_[!"$postBuildVariant"!],
        [!ELSE!]
          &Ocu_kConfigCore_1,
        [!ENDIF!]
      [!ELSE!][!//
      ...
      [!IF "num:i($MaxChannelsCore2) != num:i(0)"!]
        [!IF "var:defined('postBuildVariant')"!][!//
          &Ocu_kConfigCore_2_[!"$postBuildVariant"!],
        [!ELSE!]
          &Ocu_kConfigCore_2,
        [!ENDIF!]
      [!ELSE!][!//
      ...
      [!IF "num:i($MaxChannelsCore3) != num:i(0)"!]
        [!IF "var:defined('postBuildVariant')"!][!//
          &Ocu_kConfigCore_3_[!"$postBuildVariant"!],
        [!ELSE!]
          &Ocu_kConfigCore_3,
        [!ENDIF!]
      [!ELSE!][!//
      ...
      [!IF "num:i($MaxChannelsCore4) != num:i(0)"!]
        [!IF "var:defined('postBuildVariant')"!][!//
          &Ocu_kConfigCore_4_[!"$postBuildVariant"!],
        [!ELSE!]
          &Ocu_kConfigCore_4,
        [!ENDIF!]
      [!ELSE!][!//
      ...
      [!IF "num:i($MaxChannelsCore5) != num:i(0)"!]
        [!IF "var:defined('postBuildVariant')"!][!//
          &Ocu_kConfigCore_5_[!"$postBuildVariant"!]
        [!ELSE!]
          &Ocu_kConfigCore_5
        [!ENDIF!]
      [!ELSE!][!//
