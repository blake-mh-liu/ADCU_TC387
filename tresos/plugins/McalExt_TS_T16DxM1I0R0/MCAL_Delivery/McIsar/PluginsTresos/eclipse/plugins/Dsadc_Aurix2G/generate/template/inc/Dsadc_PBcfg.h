...
[!AUTOSPACING!]
  [!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!]
      [!WS"0"!]/* Extern declaration of DSADC Config Root for [!"."!] */
      [!WS"0"!]extern const Dsadc_ConfigType Dsadc_Config_[!"."!];
    [!ENDLOOP!]
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of DSADC Config Root */
    [!WS"0"!]extern const Dsadc_ConfigType Dsadc_Config;
  [!ENDIF!][!//
