...
[!INDENT "0"!][!//
  [!IF "var:defined('postBuildVariant')"!][!//
    static const I2c_ChannelConfigType  I2c_ChannelConfig_[!"$postBuildVariant"!][I2C_MAX_CHANNELS] =
  [!ELSE!][!//
  ...
  /* MISRA2012_RULE_8_7_JUSTIFICATION: Module configuration data structure
   ...
   /* MISRA2012_RULE_8_4_JUSTIFICATION: Module configuration data structure
    ...
    [!SELECT "I2cConfigSet/*[1]"!][!//
      [!IF "var:defined('postBuildVariant')"!]
        const I2c_ConfigType I2c_Config_[!"$postBuildVariant"!] =
      [!ELSE!]
    ...
    [!INDENT "6"!][!//
      [!IF "var:defined('postBuildVariant')"!][!//
        &I2c_ChannelConfig_[!"$postBuildVariant"!][0],
      [!ELSE!][!//
        &I2c_ChannelConfig[0],
      [!ENDIF!][!//
      I2C_MAX_CHANNELS
