...
[!INDENT "0"!][!//
  [!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!]
      [!WS"0"!]/* Extern declaration of Fee Config Root for [!"."!] */
      [!WS"0"!]extern const Fee_ConfigType Fee_Config_[!"."!];
    [!ENDLOOP!]
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of Fee Config Root */
    [!WS"0"!]extern const Fee_ConfigType Fee_Config;
[!ENDIF!][!//
[!ENDINDENT!][!//
