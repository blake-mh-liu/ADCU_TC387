...
[!INDENT "0"!]
  [!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
      [!WS"0"!]/* Extern declaration of Uart Config Root for [!"."!] */
      [!WS"0"!]extern const Uart_ConfigType Uart_Config_[!"."!];
    [!ENDLOOP!]
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of Uart Config Root */
    [!WS"0"!]extern const Uart_ConfigType Uart_Config;
  [!ENDIF!][!//
[!ENDINDENT!]
