...
[!AUTOSPACING!]
  [!IF "var:defined('postBuildVariant')"!]
    [!LOOP "variant:all()"!]
      [!WS"0"!]/* Extern declaration of Spi Config Root for [!"."!] */
      [!WS"0"!]extern const Spi_ConfigType Spi_Config_[!"."!];
    [!ENDLOOP!]
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of Spi Config Root */
    [!WS"0"!]extern const Spi_ConfigType Spi_Config;
[!ENDIF!][!//
/* MISRA2012_RULE_5_1_JUSTIFICATION: External identifiers going beyond 32 chars
* because of AS naming convention*/
/* MISRA2012_RULE_5_2_JUSTIFICATION: Identifiers going beyond 32 chars
