...
**                                                                            **
**  DESCRIPTION  : Code template source file for Sent Driver                  **
**                                                                            **
**  [/cover]                                                                  **
**                                                                            **
**  SPECIFICATION(S) : NA                                                     **
...
[!INDENT "0"!][!//
  ...
  *******************************************************************************/
  ...
  [!SELECT "as:modconf('Sent')[1]"!][!//
            ...
            [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId)) or ($CGMasterCoreId = $TempCoreId)"!][!//
              [!CODE!]
                ...
                [!IF "var:defined('postBuildVariant')"!][!//
                  static const Sent_ChannelCfgType Sent_ChanConfig_Core[!"$CoreId"!]_[!"$postBuildVariant"!][SENT_CHANNEL_COUNT_CORE[!"$CoreId"!]] =
                [!ELSE!][!//
          ...
          [!FOR "CoreId" = "num:i(0)" TO "num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!][!//
            ...
            [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId)) or ($CGMasterCoreId = $TempCoreId)"!][!//
              ...
              [!CODE!]
                ...
                #include "Sent_MemMap.h"
                [!IF "var:defined('postBuildVariant')"!][!//
                  static const Sent_CoreConfigType Sent_CoreConfigCore[!"$CoreId"!]_[!"$postBuildVariant"!] =
                [!ELSE!][!//
                ...
                [!INDENT "2"!][!//
                  ...
                  [!ELSE!][!//
                    [!IF "var:defined('postBuildVariant')"!][!//
                      Sent_ChanConfig_Core[!"$CoreId"!]_[!"$postBuildVariant"!]
                    [!ELSE!][!//
    ...
    [!SELECT "SentConfigSet/*[num:i(1)]"!][!//
      ...
      [!NOCODE!]
        ...
        [!CODE!]
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Sent_ChannelMapType Sent_ChannelLookUp_[!"$postBuildVariant"!][[!"num:i($TotalChannels)"!]] =
          [!ELSE!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      static const Sent_ChannelIdxType Sent_LogicalChannelId_[!"$postBuildVariant"!][SENT_HW_MAX_CHANNELS] =
    [!ELSE!][!//
    ...
    [!IF "var:defined('postBuildVariant')"!][!//
      static const Sent_ChannelIdxType Sent_PhyChannelId_[!"$postBuildVariant"!][SENT_MAX_CHANNELS_CONFIGURED] =
    [!ELSE!][!//
  ...
  [!IF "var:defined('postBuildVariant')"!][!//
    const Sent_ConfigType Sent_Config_[!"$postBuildVariant"!] =
  [!ELSE!]
    const Sent_ConfigType Sent_Config =
  [!ENDIF!]
  {
    ...
    [!SELECT "SentConfigSet/*[num:i($SentId)]"!][!//
      ...
      [!INDENT "4"!][!//
        [!FOR "CoreId" = "num:i(0)" TO "num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!][!//
          ...
          [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId)) or ($CGMasterCoreId = $TempCoreId)"!][!//
            [!IF "var:defined('postBuildVariant')"!][!//
              &Sent_CoreConfigCore[!"$CoreId"!]_[!"$postBuildVariant"!][!IF "$CoreId < num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!],[!ENDIF!][!//
            [!ELSE!][!//
      ...
      [!IF "var:defined('postBuildVariant')"!][!//
        Sent_ChannelLookUp_[!"$postBuildVariant"!],
      [!ELSE!][!//
        Sent_ChannelLookUp,
      [!ENDIF!][!//
      /* Physical to Logical Id mapping */
      [!IF "var:defined('postBuildVariant')"!][!//
        Sent_LogicalChannelId_[!"$postBuildVariant"!],
      [!ELSE!][!//
        Sent_LogicalChannelId,
      [!ENDIF!][!//
      /* Logical to Physical ID mapping */
      [!IF "var:defined('postBuildVariant')"!][!//
        Sent_PhyChannelId_[!"$postBuildVariant"!]
      [!ELSE!][!//
        Sent_PhyChannelId
      [!ENDIF!][!//
    [!ENDSELECT!][!//
