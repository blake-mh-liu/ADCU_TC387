...
[!SELECT "as:modconf('Pwm')[1]"!][!//
  ...
  [!INDENT "0"!][!//
    [!IF "var:defined('postBuildVariant')"!][!//
      static const uint8 Pwm_ChannelIndexMap_[!"$postBuildVariant"!] [[!"num:i($MaxChannels)"!]] =
    [!ELSE!][!//
  ...
  [!FOR "CoreId" = "num:i(0)" TO "num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!][!//
    ...
    [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId))"!][!//
      ...
      [!IF "$GtmChannelIndex > num:i(0)"!][!//
        ...
        [!INDENT "0"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Mcu_17_Gtm_TomAtomChConfigType Pwm_kChannelConfigGtm_Core[!"$CoreId"!]_[!"$postBuildVariant"!][[!"num:i($GtmChannelIndex)"!]] = 
          [!ELSE!][!//
      ...
      [!IF "$Ccu6ChannelIndex > num:i(0)"!][!//
        [!INDENT "0"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
            ...
            [/cover] */!]
            static const Mcu_17_Ccu6_TimerConfigType Pwm_kChannelConfigCcu6_Core[!"$CoreId"!]_[!"$postBuildVariant"!][[!"num:i($Ccu6ChannelIndex)"!]] = 
          [!ELSE!][!//
                ...
                [!NOCODE!]
                  ...
                  [!IF "$CCU6TimerUsed = num:i(0)"!][!//
                    ...
                    [!ELSE!]
                      [!VAR "PasStateLvlReg" = "num:i(0)"!][!//
                    [!ENDIF!][!//
                    [!IF "./CCU6CC6Configuration/*[1]/Cout6xChEnable = 'true'"!][!//
                      [!VAR "ModCtrlReg" = "bit:or(num:i($ModCtrlReg),num:i(2))"!][!//
                      [!IF "./CCU6CC6Configuration/*[1]/Cout6xChPolarity = 'PWM_HIGH'"!][!//
                        [!VAR "PasStateLvlReg" = "bit:or(num:i($PasStateLvlReg),num:i(2))"!][!//
                      [!ENDIF!]
                    [!ENDIF!]
                  [!ELSE!]
                  ...
                  [!ENDIF!][!//
                  [!IF "$classvalue = 'PWM_FIXED_PERIOD_SHIFTED'"!][!//
                    [!IF "$TimerPeriodReg > num:i(1)"!][!//
                      /* In Edge-aligned mode, Period value of T12 and T13 is (Perod Value+1) due to HW, 
                      hence reducing 1 count in counter register from user configured period value to address 
                      timer over-flow during 0% or 100% shift, 
                      Period value reducing to 1 count is done in source code to support Init and Run-time APIs */
                      [!VAR "TimerCntCompensate" = "$TimerPeriodReg - num:i(1)"!][!//
                      [!VAR "TimerCntReg" = "num:i($TimerCntCompensate) - num:i($ShiftValue)"!][!//
                    [!ELSE!]
                      [!VAR "TimerCntReg" = "$TimerPeriodReg"!][!//
                    [!ENDIF!][!//
                  [!ENDIF!][!//
                  [!IF "$CCU6TimerUsed = num:i(0)"!][!//
      ...
      [!IF "$MaxChannelsCore > num:i(0)"!][!//
        [!INDENT "0"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Pwm_17_GtmCcu6_ChannelConfigType Pwm_kChannelConfigurationCore[!"$CoreId"!]_[!"$postBuildVariant"!][] =
          [!ELSE!][!//
          ...
          [!SELECT "PwmChannelConfigSet/PwmChannel/*[PwmChannelId = num:i($ChannelId)]"!][!//
            ...
            [!IF "$CGAllocationResult = 'TRUE'"!][!//
              ...
              [!INDENT "4"!][!//
                ...
                [!IF "$PwmTimerUsed = num:i(0)"!][!//
                  [!IF "var:defined('postBuildVariant')"!][!//
                    (const void*)&Pwm_kChannelConfigGtm_Core[!"$CoreId"!]_[!"$postBuildVariant"!][[!"num:i(num:i($GtmChannelIndex) - num:i(1))"!]]
                  [!ELSE!][!//
                    (const void*)&Pwm_kChannelConfigGtm_Core[!"$CoreId"!][[!"num:i(num:i($GtmChannelIndex) - num:i(1))"!]]
                  [!ENDIF!][!//
                [!ELSE!][!//
                  [!IF "var:defined('postBuildVariant')"!][!//
                    (const void*)&Pwm_kChannelConfigCcu6_Core[!"$CoreId"!]_[!"$postBuildVariant"!][[!"num:i(num:i($Ccu6ChannelIndex) - num:i(1))"!]]
                  [!ELSE!][!//
      ...
      [!IF "$MaxChannelsCore > num:i(0)"!][!//
        [!INDENT "0"!][!//
          [!IF "var:defined('postBuildVariant')"!][!//
            static const Pwm_17_GtmCcu6_CoreConfigType Pwm_CoreConfigCore[!"$CoreId"!]_[!"$postBuildVariant"!] =
          [!ELSE!][!//
        ...
        [!INDENT "2"!][!//
          ...
          [!IF "var:defined('postBuildVariant')"!][!//
            (const Pwm_17_GtmCcu6_ChannelConfigType*)&Pwm_kChannelConfigurationCore[!"$CoreId"!]_[!"$postBuildVariant"!][0]
          [!ELSE!][!//
  ...
  [!INDENT "0"!][!//
    ...
    [/cover] */!]
    [!IF "var:defined('postBuildVariant')"!][!//
      const Pwm_17_GtmCcu6_ConfigType Pwm_17_GtmCcu6_Config_[!"$postBuildVariant"!] =
    [!ELSE!][!//
  ...
  [!INDENT "4"!][!//
    [!FOR "CoreId" = "num:i(0)" TO "num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!]
      ...
      [!IF "(text:contains( text:split($CGAllocatedCores,','), $TempCoreId))"!]
        ...
        [!IF "var:defined('postBuildVariant')"!]
        (Pwm_17_GtmCcu6_CoreConfigType*)&Pwm_CoreConfigCore[!"$CoreId"!]_[!"$postBuildVariant"!][!IF "$CoreId < num:i(ecu:get('Mcu.NoOfCoreAvailable')) - num:i(1)"!],[!ENDIF!]
        [!ELSE!]
        [!CR!]
  ...
  [!INDENT "2"!][!//
    ...
    which is defined as constant to be allocated in Read only memory, Hence no side effects foreseen by violating this MISRA rule */
    [!IF "var:defined('postBuildVariant')"!][!//
      (uint8*)&Pwm_ChannelIndexMap_[!"$postBuildVariant"!],
    [!ELSE!][!//
