...
#include "Wdg_17_Scu_MemMap.h"
  [!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!]
      /* Extern declaration of Wdg_17_Scu Config Root for [!"."!] */
      [!WS"0"!]extern const Wdg_17_Scu_ConfigType Wdg_17_Scu_Config_[!"$WdgCoreID"!]_[!"."!];
    [!ENDLOOP!][!//
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of Wdg_17_Scu Config Root */
    [!WS"0"!]extern const Wdg_17_Scu_ConfigType Wdg_17_Scu_Config_[!"$WdgCoreID"!];
  [!ENDIF!][!//
/* MISRA2012_RULE_5_1_JUSTIFICATION: External identifiers going beyond 32 chars.
due to Autosar Naming constraints.*/
/* MISRA2012_RULE_5_2_JUSTIFICATION: External identifiers going beyond 32 chars.
