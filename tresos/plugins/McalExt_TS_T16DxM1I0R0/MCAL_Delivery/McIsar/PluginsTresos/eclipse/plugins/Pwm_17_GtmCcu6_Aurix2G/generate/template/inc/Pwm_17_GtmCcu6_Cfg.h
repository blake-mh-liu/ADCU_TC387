...
Header file (Generated) containing constants and pre-processor macros [/cover] */!]
/*******************************************************************************
**                      Includes                                              **
*******************************************************************************/
/*******************************************************************************
...
[!INDENT "0"!][!//
  [!/* [cover parentID={F5CF0050-FA3F-4e14-8C3E-FD0E8CB08831}] Autosar variant management [/cover]*/!]
...
[!SELECT "as:modconf('Pwm')[1]"!][!//
  [!INDENT "0"!][!//
    ...
    */
      ...
      PWM_17_GTMCCU6_DEV_ERROR_DETECT [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_MULTICORE_ERROR_DETECT [/cover] */!]
    ...
    [!ENDIF!][!//
      ...
      PWM_17_GTMCCU6_INSTANCE_ID [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_DE_INIT_API [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_GET_OUTPUT_STATE_API [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_SET_DUTY_CYCLE_API [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_SET_OUTPUT_TO_IDLE_API [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_SET_PERIOD_AND_DUTY_API [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_HANDLE_SHIFT_BY_OFFSET [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_NOTIFICATION_SUPPORTED [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_NOTIF_FOR_100_0_ENABLE [/cover] */!]
    ...
    */
      ...
      PWM_17_GTMCCU6_DUTYCYCLE_UPDATED_ENDPERIOD [/cover] */!]
    ...
    [!ENDIF!][!//
      ...
      PWM_17_GTMCCU6_DUTY_PERIOD_UPDATED_ENDPERIOD [/cover] */!]
    ...
    PWM_17_GTMCCU6_INITCHECK_API [/cover] */!]
    ...
    */
    ...
    PWM_17_GTMCCU6_DUTY_SHIFT_IN_TICKS [/cover] */!]
    ...
    */
    ...
    PWM_17_GTMCCU6_MAX_CORES [/cover] */!]
    ...
    [!FOR "CoreId" = "num:i(0)" TO "num:i(6) - num:i(1)"!][!//
      ...
      PWM_17_GTMCCU6_MAX_CHANNELS_CORE [/cover] */!]
      /* MISRA2012_RULE_5_1_JUSTIFICATION: External identifiers going beyond 32 chars.
      in generated code due to Autosar Naming constraints.*/
      /* MISRA2012_RULE_5_2_JUSTIFICATION: External identifiers going beyond 32 chars.
      in generated code due to Autosar Naming constraints.*/
    ...
    PWM_17_GTMCCU6_GTM_TIMER_USED [/cover] */!]
    [!IF "$PwmGtmUsed = 'true'"!][!//
    ...
    PWM_17_GTMCCU6_CCU6_TIMER_USED [/cover] */!]
    [!IF "$PwmCcu6Used = 'true'"!][!//
