...
[!AUTOSPACING!] 
  [!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!]
      [!WS"0"!]/* Extern declaration of Adc Config Root for [!"."!] */
      [!WS"0"!]extern const Adc_ConfigType Adc_Config_[!"."!];
    [!ENDLOOP!][!//
  [!ELSE!][!//
    [!WS"0"!]/* Extern declaration of Adc Config Root */
    [!WS"0"!]extern const Adc_ConfigType Adc_Config;
  [!ENDIF!][!//
