...
extern volatile uint16 Test_EthTxConfirmCount[ETH_17_GETHMACV2_MAX_CONTROLLERS];
extern volatile uint16 Test_EthRxConfirmCount[ETH_17_GETHMACV2_MAX_CONTROLLERS];
