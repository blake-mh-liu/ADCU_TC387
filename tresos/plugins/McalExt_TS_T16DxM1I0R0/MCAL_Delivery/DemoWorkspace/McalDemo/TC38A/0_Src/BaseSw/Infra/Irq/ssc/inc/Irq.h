...
/*
  ...
  Please see for the reasons in the file ImportantNotes.txt for tag
      ...
      1.) ASCINFINEON-857 : As per Specification of Compiler Abstraction AUTOSAR Release 4.2.2 SWS_COMPILER_00010
...
#define IFX_INTERRUPT(isr, vectabNum, prio) \
                    void __interrupt(prio) __vector_table(vectabNum) OS_ISR_##isr(void)
#endif
