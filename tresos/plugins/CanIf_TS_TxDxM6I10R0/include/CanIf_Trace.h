...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_GETCURRENTTIME_ENTRY
/** \brief Entry point of function CanIf_GetCurrentTime()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_CANIF_GETCURRENTTIME_ENTRY(Controller,timeStampPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_GETCURRENTTIME_EXIT
/** \brief Exit point of function CanIf_GetCurrentTime()
 **
 ** The first parameter of the macro is the return
 ** value of the function, followed by the arguments
 ** of the function.
 */
#define DBG_CANIF_GETCURRENTTIME_EXIT(Retval,Controller,timeStampPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_ENABLEEGRESSTIMESTAMP_ENTRY
/** \brief Entry point of function CanIf_EnableEgressTimeStamp()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_CANIF_ENABLEEGRESSTIMESTAMP_ENTRY(TxPduId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_ENABLEEGRESSTIMESTAMP_EXIT
/** \brief Exit point of function CanIf_EnableEgressTimeStamp()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_CANIF_ENABLEEGRESSTIMESTAMP_EXIT(TxPduId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_GETEGRESSTIMESTAMP_ENTRY
/** \brief Entry point of function CanIf_GetEgressTimeStamp()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_CANIF_GETEGRESSTIMESTAMP_ENTRY(TxPduId,timeStampPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_GETEGRESSTIMESTAMP_EXIT
/** \brief Exit point of function CanIf_GetEgressTimeStamp()
 **
 ** The first parameter of the macro is the return
 ** value of the function, followed by the arguments
 ** of the function.
 */
#define DBG_CANIF_GETEGRESSTIMESTAMP_EXIT(Retval,TxPduId,timeStampPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_GETINGRESSTIMESTAMP_ENTRY
/** \brief Entry point of function CanIf_GetIngressTimeStamp()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_CANIF_GETINGRESSTIMESTAMP_ENTRY(RxPduId,timeStampPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_CANIF_GETINGRESSTIMESTAMP_EXIT
/** \brief Exit point of function CanIf_GetIngressTimeStamp()
 **
 ** The first parameter of the macro is the return
 ** value of the function, followed by the arguments
 ** of the function.
 */
#define DBG_CANIF_GETINGRESSTIMESTAMP_EXIT(Retval,RxPduId,timeStampPtr)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
