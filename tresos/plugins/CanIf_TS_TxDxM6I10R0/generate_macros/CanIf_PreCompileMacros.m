...
*** Global Time APIs used when hardware timestamping is supported. ***
*/!][!VAR "canIfGlobalTimeSupport" = "(node:existsAndTrue(CanIfPublicCfg/CanIfGlobalTimeSupport))"!][!/*
...
*/!][!VAR "canIfTxMirrorBufSize" = "num:i(ceiling(CanIfMirroringSupport/TxMirrorBufferSize div 8) * 8)"!][!/*
*/!][!VAR "canIfTxMirrorSize" = "num:i(ceiling(CanIfMirroringSupport/TxMirrorBufferSize div 8))"!][!/*

*/!][!IF "$canifMulticoreEnabled = 'true'"!][!/*
*/!][!VAR "canIfTxMirrorBufCtrlMaxSize" = "num:i(ceiling(num:max(CanIfMirroringSupport/CanIfTxMirrorBuffers/CanIfTxMirrorBufferSize/*/CanIfTxMirrorBufferSizePart) div 8) * 8)"!][!/*
*/!][!VAR "canIfTxMirrorBufCtrlNum" = "num:i(count(node:refs(../CanIfCtrlDrvCfg/*/CanIfCtrlCfg/*/CanIfCtrlCanCtrlRef)/CanControllerEcucPartitionRef))"!][!/*
*/!][!VAR "canIfTxMirrorCtrlMaxSize" = "num:i(ceiling(num:max(CanIfMirroringSupport/CanIfTxMirrorBuffers/CanIfTxMirrorBufferSize/*/CanIfTxMirrorBufferSizePart) div 8))"!][!/*
*/!][!ENDIF!][!/* $canifMulticoreEnabled = 'true' */!][!/*
