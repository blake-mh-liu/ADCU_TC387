...
[!IF "node:exists( DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*)"!]
  /* Array of configuration information for diagnostic security levels */
  CONST(Dcm_SecurityLevelEntryConfigType, DCM_CONST) Dcm_SecurityLevelEntryConfig[[!"num:integer( count( DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*))"!]] =
  {
    [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*"!][!//
      ...
      [!INDENT "4"!]
        ...
        [!/* Generate only if the delay timers feature is enabled for security access */!][!//
        [!IF "node:exists(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*[(DcmDspSecurityDelayTime != 0) or (DcmDspSecurityDelayTimeOnBoot != 0)])"!][!//
          [!IF "node:exists(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*[node:existsAndTrue(DcmDspSecurityAttemptCounterEnabled)])"!]
          ...
          [!IF "node:exists(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*[node:existsAndTrue(DcmDspSecurityAttemptCounterEnabled)])"!]
            ...
            [!ENDIF!]
          [!ENDIF!]
          [!IF "node:existsAndTrue(DcmDspSecurityDelayTimeOnBootOverride)"!][!//
            TRUE,  /* Force delay on boot */
          [!ELSE!]
            FALSE, /* Do not force delay on boot */
          [!ENDIF!]
          [!IF "node:existsAndTrue(DcmDspSecurityDelayTimeInfinite)"!][!//
