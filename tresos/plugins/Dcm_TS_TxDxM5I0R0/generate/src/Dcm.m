...
*/!][!ELSEIF "num:inttohex( DcmDsdSidTabServiceId, 2) = '0x29'"!][!/*
*/!]Dcm_Dsp_Authentication_SvcH[!/*
...
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x19' and num:inttohex( DcmDsdSubServiceId, 2) = '0x1a'"!][!/*
*/!]Dcm_DspInternal_ReportSupportedDTCExtDataRecord_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x19' and num:inttohex( DcmDsdSubServiceId, 2) = '0x42'"!][!/*
*/!]Dcm_DspInternal_ReportWWHOBDDTCByMaskRecord_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x19' and num:inttohex( DcmDsdSubServiceId, 2) = '0x55'"!][!/*
*/!]Dcm_DspInternal_ReportWWHOBDDTCWithPermanentStatus_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x19' and num:inttohex( DcmDsdSubServiceId, 2) = '0x56'"!][!/*
...
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x29' and num:inttohex( DcmDsdSubServiceId, 2) = '0x00'"!][!/*
*/!]Dcm_Dsp_Authentication_DeAuthenticate_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x29' and num:inttohex( DcmDsdSubServiceId, 2) = '0x01'"!][!/*
*/!]Dcm_Dsp_Authentication_VerifyCertificateUnidirectional_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x29' and num:inttohex( DcmDsdSubServiceId, 2) = '0x02'"!][!/*
*/!]Dcm_Dsp_Authentication_VerifyCertificateBidirectional_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x29' and num:inttohex( DcmDsdSubServiceId, 2) = '0x03'"!][!/*
*/!]Dcm_Dsp_Authentication_ProofOfOwnership_SSvcH[!/*
*/!][!ELSEIF "num:inttohex(../.././DcmDsdSidTabServiceId,2) ='0x29' and num:inttohex( DcmDsdSubServiceId, 2) = '0x08'"!][!/*
*/!]Dcm_Dsp_Authentication_AuthenticationConfiguration_SSvcH[!/*
...
[!INDENT "0"!][!//
  ...
  [!ELSE!][!//
    ...
    [!ENDIF!][!//
    [!/*--- WriteVariableData------*/!][!//
    [!IF "node:existsAndFalse(node:ref(DcmDspDataInfoRef)/DcmDspDataFixedLength)"!][!//
      [!IF "DcmDspDataUsePort = 'USE_DATA_SYNCH_FNC'"!][!//
        [!IF "node:exists(DcmDspDataWriteFnc)"!][!//
          [!IF "$GenerateFunctions = 'TRUE'"!][!//
