  ...
  CONST(Dcm_CommunicationControlLookupType, DCM_CONST) Dcm_CommunicationControlLookUpTable[DCM_COMMUNICATIONCONTROL_LOOKUP_SIZE] =
  {
    ...
    [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsl/DcmDslProtocol/DcmDslProtocolRow/eb-list::*/DcmDslConnection/eb-list::*/DcmDslProtocolRx/eb-list::*"!][!//
      ...
      [!INDENT "4"!]
        ...
        &SchM_Switch_Dcm_DcmCommunicationControl_[!"as:name(as:ref(DcmDslProtocolRxComMChannelRef))"!],
        /* Network Id */
...
[!//
    [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlAllChannel/eb-list::*"!]
      ...
      [!INDENT "4"!]
        /* pointer to SchM Switch for DcmCommunicationControl */
        &SchM_Switch_Dcm_DcmCommunicationControl_[!"as:name(as:ref(./DcmDspAllComMChannelRef))"!],
        /* Network Id */
...
[!//
    [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSpecificChannel/eb-list::*"!]
      ...
      [!INDENT "4"!]
         /* pointer to SchM Switch for DcmCommunicationControl */
        &SchM_Switch_Dcm_DcmCommunicationControl_[!"as:name(as:ref(./DcmDspSpecificComMChannelRef))"!],
        /* Network Id */
        [!"as:ref(DcmDspSpecificComMChannelRef)/ComMChannelId"!]U,
       [!ENDINDENT!]
      [!WS "2"!]},
...
[!//
    [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSubNode/eb-list::*"!]
      ...
      [!INDENT "4"!]
        /* pointer to SchM Switch for DcmCommunicationControl */
        &SchM_Switch_Dcm_DcmCommunicationControl_[!"as:name(as:ref(./DcmDspComControlSubNodeComMChannelRef))"!],
        /* Network Id */
        [!"as:ref(DcmDspComControlSubNodeComMChannelRef)/ComMChannelId"!]U,
      [!ENDINDENT!]
      [!WS "2"!]},
...
CONST(Dcm_ModeRuleFunctionType, DCM_CONST) Dcm_Dsp_CommunicationControl_ModeRuleFunction =
  [!WS "2"!]&Dcm_ModeRule_[!"as:name(node:ref(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSetting/DcmDspComControlCommunicationReEnableModeRuleRef))"!]_Result;
[!ENDIF!][!//
