...
[!"num:i(count(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspVehInfo/eb-list::*))"!]U
...
[!"num:i(count(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspVehInfo/eb-list::*/DcmDspVehInfoData/eb-list::*))"!]U
...
#endif
#define DCM_DSP_VEHINFO_USED_ARRAY_SIZE [!"num:i((count(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspVehInfo/eb-list::*)+7) div 8)"!]U
...
[!IF "as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmGeneral/DcmDspVehInfoASRVersion = 'AUTOSAR_403'"!]DCM_DSP_VEHINFO_AUTOSAR_403[!ELSE!]DCM_DSP_VEHINFO_AUTOSAR_440[!ENDIF!]
...
extern CONST(uint8,DCM_CONST_CALIBRATION) Dcm_DspVehInfoUsed[DCM_DSP_VEHINFO_USED_ARRAY_SIZE];
