...
/*==================[macros]=====================================================================*/
[!IF "as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmGeneral/DcmServiceAPI/DcmDefaultASRServiceAPI = 'AUTOSAR_42'"!][!//
...
[!VAR "genMacroSvc" = "''"!][!//
[!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*"!][!//
...
[!VAR "genMacroSSvc" = "''"!][!//
[!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*/DcmDsdSubService/eb-list::*"!][!//
...
[!VAR "userfnc" = "':'"!][!//
[!/*-----------Extern declarations of user functions for the services 0x08 or -0x31 via OBD--------*/!][!//
/* !LINKSTO RequestControl.Callout,1 */
[!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspRequestControl/eb-list::*[DcmDspRequestControlUsePort = 'USE_REQUESTCONTROL_SYNCH_FNC']"!][!//
...
[!//
  ...
  [!IF "count(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*/DcmDspDidSignal/eb-list::*[node:name(node:ref(DcmDspDidDataRef)) = $nodeName]) > 0"!][!//
    [!IF "node:exists(node:ref(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*/DcmDspDidSignal/eb-list::*[node:name(node:ref(DcmDspDidDataRef)) = $nodeName][1]/../../DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl/DcmDspDidControlMask) and
         (node:ref(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*/DcmDspDidSignal/eb-list::*[node:name(node:ref(DcmDspDidDataRef)) = $nodeName][1]/../../DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl/DcmDspDidControlMask = 'DCM_CONTROLMASK_EXTERNAL')"!][!//
      [!VAR "MaskExtern" = "'TRUE'"!][!//
      [!VAR "MaskSize" = "num:i(node:ref(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*/DcmDspDidSignal/eb-list::*[node:name(node:ref(DcmDspDidDataRef)) = $nodeName][1]/../../DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl/DcmDspDidControlMaskSize)"!]
...
[!//
  [!IF "node:exists(DcmDspDataReturnControlToEcuFnc)"!][!//
    [!IF "(DcmDspDataUsePort = 'USE_DATA_ASYNCH_FNC' and (as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmGeneral/DcmServiceAPI/DcmDefaultASRServiceAPI = 'AUTOSAR_40'))"!][!//
      [!IF "not( contains( $userfnc, concat( ':', ./DcmDspDataReturnControlToEcuFnc, ':')))"!][!//
        /* !LINKSTO Dcm.ReturnControlToECU.AsyncFnc.ASR40,1 */
      ...
      [!ENDIF!][!//
    [!ELSEIF "(DcmDspDataUsePort = 'USE_DATA_SYNCH_FNC' or (DcmDspDataUsePort = 'USE_DATA_ASYNCH_FNC' and not(as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmGeneral/DcmServiceAPI/DcmDefaultASRServiceAPI = 'AUTOSAR_40')))"!][!//
      [!IF "not( contains( $userfnc, concat( ':', ./DcmDspDataReturnControlToEcuFnc, ':')))"!][!//
...
extern FUNC(Std_ReturnType, DCM_APPL_CODE) [!"$DcmDspOperationRoutineFnc"!](
[!INDENT "4"!]
  ...
  [!IF "(node:exists(DcmDspRoutineUsePortASRVersion) and
    ...
    [!ENDIF!][!//
  [!ELSE!][!//
    [!IF "(node:existsAndFalse(DcmDspRoutineFixedLength))"!]
      [!CALL "SPLIT_ELEM_LIST", "indent"="4", "paramList"="$inParamList"!]Dcm_OpStatusType OpStatus,
      [!CALL "SPLIT_ELEM_LIST", "indent"="4", "paramList"="$outParamList"!]P2VAR(uint16, AUTOMATIC, DCM_VAR) currentDataLength,
      P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) ErrorCode);
    [!ELSE!][!//
...
[!VAR "userfnc" = "':'"!][!//
[!LOOP "as:modconf('Dcm')[1]/DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspRoutine/eb-list::*"!][!//
  [!IF "node:existsAndTrue(DcmDspRoutineUsed) and (((node:existsAndTrue(../../DcmDspEnableObdMirror)) and not(node:exists(DcmDspRoutineTidRef))) or (node:existsAndFalse(../../DcmDspEnableObdMirror)))"!][!//
    [!IF "node:existsAndFalse(DcmDspRoutineUsePort)"!][!//
[!/* for StartRoutineControl functions */!][!//
      [!VAR "inVarCount"="0"!][!//
      [!VAR "inParamListStart"="''"!][!//
      [!LOOP "util:distinct(node:order(node:ref(DcmDspRoutineInfoRef)/DcmDspStartRoutineIn/DcmDspStartRoutineInSignal/eb-list::*, 'DcmDspRoutineSignalPos'))"!][!//
      ...
      [!LOOP "util:distinct(node:order(node:ref(DcmDspRoutineInfoRef)/DcmDspStartRoutineOut/DcmDspStartRoutineOutSignal/eb-list::*, 'DcmDspRoutineSignalPos'))"!][!//
        [!IF "contains(DcmDspRoutineSignalType, '_N')"!]
      ...
      [!IF "not( contains( $userfnc, concat( ':', ./DcmDspStartRoutineFnc, ':')))"!][!//
        ...
        [!CALL "ROUTINECONTROL_GENERATE_PROTOTYPE", "DcmDspOperationRoutineFnc" = "DcmDspStartRoutineFnc", "inParamList" = "$inParamListStart", "outParamList" = "$outParamListStart",
          "RoutineVariableInSignals" = "(node:exists(node:ref(DcmDspRoutineInfoRef)/DcmDspStartRoutineIn/DcmDspStartRoutineInSignal/eb-list::*[(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')]))",
          "RoutineVariableOutSignals" = "(node:exists(node:ref(DcmDspRoutineInfoRef)/DcmDspStartRoutineOut/DcmDspStartRoutineOutSignal/eb-list::*[(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')]))"!]
      [!ENDIF!][!//
[!/* for StopRoutineControl functions */!][!//
      [!VAR "inVarCount"="0"!][!//
      [!VAR "inParamListStop"="''"!][!//
      [!LOOP "util:distinct(node:order(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineStopIn/DcmDspRoutineStopInSignal/eb-list::*, 'DcmDspRoutineSignalPos'))"!][!//
        [!IF "contains(DcmDspRoutineSignalType, '_N')"!]
      ...
      [!LOOP "util:distinct(node:order(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineStopOut/DcmDspRoutineStopOutSignal/eb-list::*, 'DcmDspRoutineSignalPos'))"!][!//
        [!IF "contains(DcmDspRoutineSignalType, '_N')"!]
      ...
      [!IF "(node:exists(DcmDspStopRoutineFnc)) and (not( contains( $userfnc, concat( ':', ./DcmDspStopRoutineFnc, ':'))))"!][!//
        ...
        [!CALL "ROUTINECONTROL_GENERATE_PROTOTYPE", "DcmDspOperationRoutineFnc" = "DcmDspStopRoutineFnc", "inParamList" = "$inParamListStop", "outParamList" = "$outParamListStop",
          "RoutineVariableInSignals" = "(node:exists(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineStopIn/DcmDspRoutineStopInSignal/eb-list::*[(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')]))",
          "RoutineVariableOutSignals" = "(node:exists(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineStopOut/DcmDspRoutineStopOutSignal/eb-list::*[(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')]))"!]
      [!ENDIF!][!//
[!/* for ResultsRoutineControl functions */!][!//
      [!VAR "inVarCount"="0"!][!//
      [!VAR "inParamListRequestRes"="''"!][!//
      [!LOOP "util:distinct(node:order(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineRequestResIn/DcmDspRoutineRequestResInSignal/eb-list::*, 'DcmDspRoutineSignalPos'))"!][!//
        [!IF "contains(DcmDspRoutineSignalType, '_N')"!]
      ...
      [!LOOP "util:distinct(node:order(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineRequestResOut/DcmDspRoutineRequestResOutSignal/eb-list::*, 'DcmDspRoutineSignalPos'))"!][!//
        [!IF "contains(DcmDspRoutineSignalType, '_N')"!]
      ...
      [!IF "(node:exists(DcmDspRequestResultsRoutineFnc)) and (not( contains( $userfnc, concat( ':', ./DcmDspRequestResultsRoutineFnc, ':'))))"!][!//
        ...
        [!CALL "ROUTINECONTROL_GENERATE_PROTOTYPE", "DcmDspOperationRoutineFnc" = "DcmDspRequestResultsRoutineFnc", "inParamList" = "$inParamListRequestRes", "outParamList" = "$outParamListRequestRes",
          "RoutineVariableInSignals" = "(node:exists(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineRequestResIn/DcmDspRoutineRequestResInSignal/eb-list::*[(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')]))",
          "RoutineVariableOutSignals" = "(node:exists(node:ref(DcmDspRoutineInfoRef)/DcmDspRoutineRequestResOut/DcmDspRoutineRequestResOutSignal/eb-list::*[(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')]))"!]
      [!ENDIF!][!//
    [!ENDIF!][!//
  [!ENDIF!][!//
[!ENDLOOP!][!//
...
[!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspPid/eb-list::*[(DcmDspPidService='DCM_SERVICE_01') or (DcmDspPidService='DCM_SERVICE_01_02')]/DcmDspPidData/eb-list::*[DcmDspPidService01/DcmDspPidDataUsePort = 'USE_DATA_SYNCH_FNC']"!][!//
...
[!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspVehInfo/eb-list::*/DcmDspVehInfoData/eb-list::*[node:existsAndFalse(DcmDspVehInfoDataUsePort)]"!][!//
