...
[!IF "$DCM_MODEDECLARATION_SUPPORT = 'STD_ON' and (node:exists(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSetting/DcmDspComControlCommunicationReEnableModeRuleRef))"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!//
...
[!IF "node:exists(DcmConfigSet/eb-list::*/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*[DcmDsdSidTabServiceId='40']/eb-list::*/eb-list::*[DcmDsdSubServiceId='0' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/eb-list::*/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*[DcmDsdSidTabServiceId='40']/eb-list::*/eb-list::*[DcmDsdSubServiceId='1' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/eb-list::*/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*[DcmDsdSidTabServiceId='40']/eb-list::*/eb-list::*[DcmDsdSubServiceId='2' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/eb-list::*/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*[DcmDsdSidTabServiceId='40']/eb-list::*/eb-list::*[DcmDsdSubServiceId='3' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/eb-list::*/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*[DcmDsdSidTabServiceId='40']/eb-list::*/eb-list::*[DcmDsdSubServiceId='4' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/eb-list::*/DcmDsd/DcmDsdServiceTable/eb-list::*/DcmDsdService/eb-list::*[DcmDsdSidTabServiceId='40']/eb-list::*/eb-list::*[DcmDsdSubServiceId='5' and not(node:exists(DcmDsdSubServiceFnc))])"!]
STD_ON
[!ELSE!][!//
STD_OFF
[!ENDIF!][!//
...
[!"num:integer( count( DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlAllChannel/eb-list::*))"!]U
...
[!"num:integer( count( DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSpecificChannel/eb-list::*))"!]U
...
[!"num:integer(count(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSubNode/eb-list::*))"!]U
[!//
[!ENDIF!][!//
[!//
[!VAR "ChannelList"="'#'"!]
[!VAR "LookUpTabSize" = "0"!]
  ...
  [!ENDLOOP!]
[!IF "$DCM_MODEDECLARATION_SUPPORT = 'STD_ON'"!]
  [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlAllChannel/eb-list::*"!]
    ...
    [!ENDIF!]
  [!ENDLOOP!]
  [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSpecificChannel/eb-list::*"!][!//
    ...
    [!ENDIF!]
  [!ENDLOOP!]
  [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSubNode/eb-list::*"!][!//
...
[!IF "node:exists(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspComControl/DcmDspComControlSetting/DcmDspComControlCommunicationReEnableModeRuleRef)"!][!//
