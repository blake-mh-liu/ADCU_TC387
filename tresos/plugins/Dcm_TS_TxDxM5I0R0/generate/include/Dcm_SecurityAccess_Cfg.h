...
[!"num:integer(count(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*))"!]U
...
[!IF "node:exists(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*[(DcmDspSecurityDelayTime != 0) or (DcmDspSecurityDelayTimeOnBoot != 0)])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:exists(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityRow/eb-list::*[node:existsAndTrue(DcmDspSecurityAttemptCounterEnabled)])"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!"num:integer(ceiling(node:value(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityMaxAttemptCounterReadoutTime) div node:value(DcmConfigSet/eb-list::*[1]/DcmGeneral/DcmTaskTime)))"!]U
...
[!"num:integer(ceiling(node:value(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityMaxAttemptCounterWriteTime) div node:value(DcmConfigSet/eb-list::*[1]/DcmGeneral/DcmTaskTime)))"!]U
...
[!IF "node:existsAndTrue(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityUnifiedDelayTimer)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityLegacyAttemptCountersHandling)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityResetAttemptCounterOnTimeout)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityAttemptCounterReadoutFailInfiniteDelay)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspSecurity/DcmDspSecurityIncrementAttemptCounterPastLimit)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
