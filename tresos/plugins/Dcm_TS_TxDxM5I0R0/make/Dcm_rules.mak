...
Dcm_src_FILES_Authentication := \
     $(Dcm_CORE_PATH)/src/Dcm_Authentication.c \
     $(Dcm_CORE_PATH)/src/Dcm_Authentication_AuthenticationHandler.c \
     $(Dcm_OUTPUT_PATH)/src/Dcm_Authentication_Cfg.c \
     $(Dcm_CORE_PATH)/src/Dcm_Authentication_CryptoStackFacade.c \
     $(Dcm_CORE_PATH)/src/Dcm_Authentication_DiagnosticPolicyHandler.c \
     $(Dcm_CORE_PATH)/src/Dcm_Dsp_SvcH_Authentication.c
...
Dcm_src_FILES_ClearDiagnosticInformation := $(Dcm_CORE_PATH)/src/Dcm_Dsp_SvcH_ClearDiagnosticInformation.c
...
Dcm_src_FILES_SEVReportingServices := $(Dcm_CORE_PATH)/src/Dcm_SEVReportingServices.c
#
##     HSM #
Dcm_src_FILES_Hsm := \
