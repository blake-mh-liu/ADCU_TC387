...
#if (defined DCM_DSP_READDTCINFORMATION_PARALLEL_PROCESSING_ENABLED)
  #error "DCM_DSP_READDTCINFORMATION_PARALLEL_PROCESSING_ENABLED is already defined"
#endif
#if( ((DCM_HAS_ROE_TYPE2 == STD_ON) && (DCM_ROE_NUM_ROEONDTCSTATUSCHANGE > 0U)) ||\
      (DCM_NUM_STACKS > 1U) )
#define DCM_DSP_READDTCINFORMATION_PARALLEL_PROCESSING_ENABLED  STD_ON
#else
#define DCM_DSP_READDTCINFORMATION_PARALLEL_PROCESSING_ENABLED  STD_OFF
#endif
...
typedef struct
{
  /** \brief Processing subservice handler */
...
#if (defined DCM_DSP_FUNCTIONALGROUPID)
  #error "DCM_DSP_FUNCTIONALGROUPID is already defined"
#endif
/** \brief FunctionalGroupIdentifier Emissions-system group for Read DTC Information */
#define DCM_DSP_FUNCTIONALGROUPID   0x33U
#endif

#if (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x56 == STD_ON)
#if (defined DCM_DSP_READINESSGROUPID_INVALID)
  #error "DCM_DSP_READINESSGROUPID_INVALID is already defined"
#endif
/** \brief ReadinessGroupId All groups for Read DTC Information */
#define DCM_DSP_READINESSGROUPID_INVALID   0xFFU
#endif
...
/** \brief Initializes the control structures for services 0x19 and 0xAF
 */
extern FUNC(void, DCM_CODE) Dcm_DspInternal_ReadDTCInformation_Init(void);
...
#if (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x1A == STD_ON)
/** \brief UDS service 0x19-0x1A (reportSupportedDTCExtDataRecord)
 **
 ** \param[in] OpStatus Operation state of the function.
 ** \param[inout] pMsgContext Message related information for one diagnostic protocol identifier.
 **
...
/** \brief UDS service 0x19-0x42 (reportWWHOBDDTCByMaskRecord)
 **
 ** \param[in] OpStatus Operation state of the function.
 ** \param[inout] pMsgContext Message related information for one diagnostic protocol identifier.
 **
...
/** \brief UDS service 0x19-0x55 (reportWWHOBDDTCWithPermanentStatus))
 **
 ** \param[in] OpStatus Operation state of the function.
 ** \param[inout] pMsgContext Message related information for one diagnostic protocol identifier.
 **
...
#if (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x56 == STD_ON)
/** \brief UDS service 0x19-0x56 (reportDTCInformationByDTCReadinessGroupIdentifier))
 **
 ** \param[in] OpStatus Operation state of the function.
 ** \param[inout] pMsgContext Message related information for one diagnostic protocol identifier.
 **
