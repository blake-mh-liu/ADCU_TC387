...
typedef struct
{
  ...
  /** \brief Stores the DataFormatIdentifier */
  uint8 FormatId;
  /** \brief the Memory Identifier of the transfer request */
  uint8 ReqMemIdValue;
}
 ...
 **  \return void
 **/
extern FUNC(void, DCM_CODE) Dcm_Dsl_DataTransferServices_SessionChange(
