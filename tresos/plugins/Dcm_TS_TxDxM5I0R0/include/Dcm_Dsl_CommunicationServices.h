...
/** \brief This is an internally originating request coming from the PostBoot subsystem. */
#if (defined DCM_INTERNAL_POST_BOOT)
  #error "DCM_INTERNAL_POST_BOOT is already defined"
#endif
#define DCM_INTERNAL_POST_BOOT 6U
...
/** \brief Unique identifier of the tester which uses this DcmDslMainConnection
           connection for diagnostic communication.
 */
typedef uint16 Dcm_ConnectionIdType;
...
typedef struct
{
  ...
  /** \brief Ecu source address used for diagnostic communication.
   */
  Dcm_ProtocolECUAddressType EcuAddress;
...
typedef struct
{
  ...
  /** \brief Unique identifier of the tester which uses this DcmDslMainConnection
             connection for diagnostic communication.
   */
  Dcm_ConnectionIdType ConnectionId;

#if (DCM_AUTHENTICATION_CONNECTION == STD_ON)
  /** \brief Index of authenticated connection in DcmDspAuthenticatedConnection table, otherwise DCM_NUM_AUTHENTICATION_CONNECTIONS.
   */
  Dcm_AuthenticationConnectionIndexType AuthenticatedIndex;
