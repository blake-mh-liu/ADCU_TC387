...
#include <Dcm_Authentication_Cfg.h>                                   /* Generated configuration */
...
/* !LINKSTO Dcm.DcmProtocolType.Types,1 */
...
#if (defined DCM_E_AUTHENTICATIONREQUIRED)
#error DCM_E_AUTHENTICATIONREQUIRED already defined
#endif /* if (defined DCM_E_AUTHENTICATIONREQUIRED) */

/** \brief This return value indicates that the requested service will not be taken because the
 **        client has insufficient rights based on its Authentication state. This NRC is in general
 **        supported by each diagnostic service, therefore it is not listed in the list of
...
#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDTIMEPERIOD)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDTIMEPERIOD already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDTIMEPERIOD     0x50U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDSIGNATURE)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDSIGNATURE already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDSIGNATURE      0x51U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDCHAINOFTRUST)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDCHAINOFTRUST already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDCHAINOFTRUST   0x52U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDTYPE)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDTYPE already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDTYPE           0x53U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDFORMAT)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDFORMAT already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDFORMAT         0x54U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDCONTENT)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDCONTENT already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDCONTENT        0x55U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDSCOPE)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDSCOPE already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDINVALIDSCOPE          0x56U


#if (defined DCM_E_CERTIFICATEVERIFICATIONFAILEDREVOKED)
#error DCM_E_CERTIFICATEVERIFICATIONFAILEDREVOKED already defined
#endif

#define DCM_E_CERTIFICATEVERIFICATIONFAILEDREVOKED               0x57U


#if (defined DCM_E_OWNERSHIPVERIFICATIONFAILED)
#error DCM_E_OWNERSHIPVERIFICATIONFAILED already defined
#endif
...
/* !LINKSTO Dcm.EB.AuthenticationStateHandling.AuthenticationState.Range,1 */
/** @defgroup Macro_Dcm_AuthenticationState Macros for Dcm_AuthenticationStateType
 ** \brief    These macros are used as values for Dcm_AuthenticationStateType
 **  @{
 */
/** \brief This value represents the deauthentication state of a diagnostic connection */
#if (defined DCM_DEAUTHENTICATED)
#error DCM_DEAUTHENTICATED already defined
#endif /* if (defined DCM_DEAUTHENTICATED) */
#define DCM_DEAUTHENTICATED 0U

/** \brief This value represents the authentication state of a diagnostic connection */
#if (defined DCM_AUTHENTICATED)
#error DCM_AUTHENTICATED already defined
#endif /* if (defined DCM_AUTHENTICATED) */
#define DCM_AUTHENTICATED 1U
/* @} **//* End of macros definitions for Dcm_AuthenticationStateType */
...
#if (defined DCM_POS_RESPONSE_SENT)
#error DCM_POS_RESPONSE_SENT already defined
#endif/* #if (defined DCM_POS_RESPONSE_SENT) */

/** \brief Indicates that a positive response has been sent successfully */
#define DCM_POS_RESPONSE_SENT 0x04U

#if (defined DCM_POS_RESPONSE_FAILED)
#error DCM_POS_RESPONSE_FAILED already defined
#endif/* #if (defined DCM_POS_RESPONSE_FAILED) */

/** \brief Indicates that a positive response has not been sent successfully */
#define DCM_POS_RESPONSE_FAILED 0x05U

#if (defined DCM_NEG_RESPONSE_SENT)
#error DCM_NEG_RESPONSE_SENT already defined
#endif/* #if (defined DCM_NEG_RESPONSE_SENT) */

/** \brief Indicates that a negative response has been sent successfully */
#define DCM_NEG_RESPONSE_SENT 0x06U

#if (defined DCM_NEG_RESPONSE_FAILED)
#error DCM_NEG_RESPONSE_FAILED already defined
#endif/* #if (defined DCM_NEG_RESPONSE_FAILED) */
...
/* @} *//* End of macros definitions for Dcm_OpStatusType and Dcm_ExtendedOpStatusType */
...
/* !LINKSTO Dcm.DcmConfirmationStatusType.Types,1 */
/** \brief Type used for status informations in confirmations sent to Central Diagnostic Software
 **        Component */
typedef uint8 Dcm_ConfirmationStatusType;

/* !LINKSTO Dcm.DcmSecLevelType.Types,1 */
/** \brief Type of diagnostic security level */
typedef uint8 Dcm_SecLevelType;

#ifdef DCM_DSP_AUTHENTICATION_ROLE_SIZE
/* !LINKSTO Dcm.Dsn.Type.Dcm_AuthenticationRoleType,1 */
/** \brief Type of the deauthenticated role */
typedef VAR(uint8, TYPEDEF) Dcm_AuthenticationRoleType[DCM_DSP_AUTHENTICATION_ROLE_SIZE];
#endif /* ifdef DCM_DSP_AUTHENTICATION_ROLE_SIZE */

/* !LINKSTO Dcm.EB.TransferData.RequestDataArrayType.Configuration,1 */
typedef VAR(uint8, TYPEDEF) Dcm_RequestDataArrayType[DCM_MAX_RX_BUFFER_SIZE];
...
/* !LINKSTO Dcm.DcmOpStatusType.Types,1 */
/** \brief Type used for providing the status of service being processed, to the application */
typedef uint8 Dcm_OpStatusType;

/* !LINKSTO Dcm.EB.ExtendedOpStatusType.Configuration,1 */
typedef uint8 Dcm_ExtendedOpStatusType;

/* !LINKSTO Dcm.DcmNegativeResponseCodeType.Types,1 */
...
#ifdef DCM_DSP_AUTHENTICATION_ROLE_SIZE
#ifndef RTE_TYPE_Dcm_AuthenticationRoleType
#define RTE_TYPE_Dcm_AuthenticationRoleType
/** \brief Type of the deauthenticated role */
typedef VAR(uint8, TYPEDEF) Dcm_AuthenticationRoleType[DCM_DSP_AUTHENTICATION_ROLE_SIZE];
#endif
#endif /* ifdef DCM_DSP_AUTHENTICATION_ROLE_SIZE */
...
#ifndef RTE_TYPE_Dcm_ExtendedOpStatusType
#define RTE_TYPE_Dcm_ExtendedOpStatusType
/* !LINKSTO Dcm.EB.ExtendedOpStatusType.Configuration,1 */
/** \brief Type used for providing the status of service being processed, to the application */
typedef uint8 Dcm_ExtendedOpStatusType;
#endif
...
#ifndef RTE_TYPE_Dcm_RequestDataArrayType
#define RTE_TYPE_Dcm_RequestDataArrayType
/* !LINKSTO Dcm.EB.TransferData.RequestDataArrayType.Configuration,1 */
typedef VAR(uint8, TYPEDEF) Dcm_RequestDataArrayType[DCM_MAX_RX_BUFFER_SIZE];
#endif
...
/* !LINKSTO Dcm.Dsp.Type.Dcm_AuthenticationStateType,1 */
/** \brief Type of the authentication state */
...
*/
/* !LINKSTO Dcm.EB.ServiceProcessing.EcuStartModeType, 1 */
...
/* !LINKSTO Dcm.EB.ServiceProcessing.ASR403.ProgConditionsType, 2 */
typedef struct
{
...
/* !LINKSTO Dcm.EB.ServiceProcessing.ASR22-11.ProgConditionsType, 1 */
typedef struct
{
  /** \brief Unique id of the connection on which the request has been received
             (This reffers to the DcmDslProtocolRxPduId)  */
  uint16 ConnectionId;
  /** \brief Source address of the received request if meta data is enabled,
             otherwise the value as configured in DcmDslProtocolRxTesterSourceAddr */
...
/* !LINKSTO Dcm.DcmMsgLenType.Type, 1 */
/** \brief Length of diagnostic message */
typedef uint32 Dcm_MsgLenType;

/* !LINKSTO Dcm.DcmMsgAddInfoType.Type,1 */
...
/* !LINKSTO Dcm.DcmIdContextType.Type,1 */
...
/* !LINKSTO Dcm.DcmMsgContextType.Type,1 */
