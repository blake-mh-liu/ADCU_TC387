...
/** \brief Entry point of function Dcm_SetDeauthenticatedRole()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_DCM_SETDEAUTHENTICATEDROLE_ENTRY(connectionId,deauthenticatedRole)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** \brief Exit point of function Dcm_SetDeauthenticatedRole()
 **
 ** The first parameter of the macro is the return
 ** value of the function, followed by the arguments
 ** of the function.
 */
#define DBG_DCM_SETDEAUTHENTICATEDROLE_EXIT(Retval,connectionId,deauthenticatedRole)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_DCM_RESETAUTHENTICATION_ENTRY(connectionId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** of the function.
 */
#define DBG_DCM_RESETAUTHENTICATION_EXIT(Retval,connectionId)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_DCM_KEYMASYNCCERTIFICATEVERIFYFINISHED_ENTRY
/** \brief Entry point of function Dcm_KeyMAsyncCertificateVerifyFinished()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_DCM_KEYMASYNCCERTIFICATEVERIFYFINISHED_ENTRY(CertId,Result)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_DCM_KEYMASYNCCERTIFICATEVERIFYFINISHED_EXIT
/** \brief Exit point of function Dcm_KeyMAsyncCertificateVerifyFinished()
 **
 ** The first parameter of the macro is the return
 ** value of the function, followed by the arguments
 ** of the function.
 */
#define DBG_DCM_KEYMASYNCCERTIFICATEVERIFYFINISHED_EXIT(Retval,CertId,Result)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_DCM_CSMASYNCJOBFINISHED_ENTRY
/** \brief Entry point of function Dcm_CsmAsyncJobFinished()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_DCM_CSMASYNCJOBFINISHED_ENTRY(Job,Result)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
...
/** @cond
 ** \brief Exclude section from doxygen */
#ifndef DBG_DCM_CSMASYNCJOBFINISHED_EXIT
/** \brief Exit point of function Dcm_CsmAsyncJobFinished()
 **
 ** The macro takes the function arguments as parameters.
 */
#define DBG_DCM_CSMASYNCJOBFINISHED_EXIT(Job,Result)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
