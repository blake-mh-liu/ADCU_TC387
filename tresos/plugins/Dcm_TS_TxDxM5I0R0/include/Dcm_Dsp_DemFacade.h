...
#if (defined DCM_DSP_READDTCINFORMATION_0x1A_ID)
  #error "DCM_DSP_READDTCINFORMATION_0x1A_ID is already defined"
#endif
#define DCM_DSP_READDTCINFORMATION_0x1A_ID   (0x1AU)

#if (defined DCM_DSP_READDTCINFORMATION_0x42_ID)
  #error "DCM_DSP_READDTCINFORMATION_0x42_ID is already defined"
#endif
#define DCM_DSP_READDTCINFORMATION_0x42_ID   (0x42U)

#if (defined DCM_DSP_READDTCINFORMATION_0x55_ID)
  #error "DCM_DSP_READDTCINFORMATION_0x55_ID is already defined"
#endif
#define DCM_DSP_READDTCINFORMATION_0x55_ID   (0x55U)

#if (defined DCM_DSP_READDTCINFORMATION_0x56_ID)
  #error "DCM_DSP_READDTCINFORMATION_0x56_ID is already defined"
#endif
#define DCM_DSP_READDTCINFORMATION_0x56_ID   (0x56U)
...
#if (defined DCM_DEMFACADE_LOCK_MECHANISM_ENABLED)
  #error "DCM_DEMFACADE_LOCK_MECHANISM_ENABLED is already defined"
#endif
#if( ((DCM_HAS_ROE_TYPE2 == STD_ON) && (DCM_ROE_NUM_ROEONDTCSTATUSCHANGE > 0U)) ||\
     (DCM_NUM_STACKS > 1U) )
#define DCM_DEMFACADE_LOCK_MECHANISM_ENABLED    STD_ON
#else
#define DCM_DEMFACADE_LOCK_MECHANISM_ENABLED    STD_OFF
#endif
...
/* This is the expected size of DTCAndSeverityRecord which contains the DTCSeverityMask, the DTC and the StatusOfDTC information for subservice 0x42 */
#if (defined DCM_SIZE_OF_DTC_AND_STATUS_WITH_SEVERITY_0x42)
  #error "DCM_SIZE_OF_DTC_AND_STATUS_WITH_SEVERITY_0x42 is already defined"
#endif
#define DCM_SIZE_OF_DTC_AND_STATUS_WITH_SEVERITY_0x42 (5U)
...
/** \brief This data structure is meant to handle the program flow and input and output data */
typedef struct
{
  /* Available amount of data free on the response buffer */
  Dcm_MsgLenType BufferSize;
  ...
  Dcm_MsgLenType NextPositionToFillOnResponseBuffer;
  ...
  /* This pointer contains the address where the Status of DTC will be stored */
  P2VAR(uint8, TYPEDEF, DCM_VAR) DTCStatus;
...
#if ((DCM_SUBSERVICES_EDR_AND_FF_GROUP == STD_ON) || (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x09 == STD_ON))
  /* Indicates if the Status of DTC was obtained or not. */
  boolean StatusOfDTC;
#endif /* #if ((DCM_SUBSERVICES_EDR_AND_FF_GROUP == STD_ON) || (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x09 == STD_ON)) */
  ...
  /* This flag is to disable calling the Dem interface DemGetNextFilteredDTCAndSeverity(), DemGetNextFilteredDTC()
   * or DemGetNextFilteredDTCAndFDC() again once it returns with DEM_NO_SUCH_ELEMENT during paged-buffering since all the
   * remaining DTCs are padded with zero */
  boolean SkipDemGetNextFilteredDTC;
...
typedef struct
{
   ...
   * for sub-services 0x19-0x01, -0x02, -0x0A, -0x14, -0x15, -0x17, -0x1A, -0x42, -0x55 and -0x56 */
  ...
  * for sub-services 0x19-0x07, 0x19-0x08, 0x19-0x42*/
  uint8 RequestedSeverityMask;
  uint8 RequestedSeverityBits;
  ...
  /* Process severity regarding the DEM availability mask */
  uint8 AvailabilityMaskSeverity;

  /* Process severity regarding the DEM extended data record */
  uint8 ExtendedDataRecordState;
  ...
  uint8 FunctionGroupId;
#endif

  /* Process status regarding the Functional Group Identifier DTCs */
  uint8 FunctionGroupIdState;

#if (DCM_DSP_SUBSERVICE_READDTCINFORMATION_0x56 == STD_ON)
  Dem_EventOBDReadinessGroupType ReadinessGroupId;
#endif

  /* Process status regarding the Readiness Group Identifier DTCs */
  uint8 ReadinessGroupIdState;
 ...
 **                                           of DTC was wrong
 **/
extern FUNC(Dcm_ReturnControlDTCSettingType, DCM_CODE) Dcm_Dsp_DemFacade_ControlDTCSetting_Enable(
