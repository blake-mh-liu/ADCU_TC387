...
#if (defined DCM_SID_READDATABYID)
#error DCM_SID_READDATABYID already defined
#endif /* if (defined DCM_SID_READDATABYID) */

/** \brief Definition of service ID of diagnostic service 'Read Data By Identifier' */
#define DCM_SID_READDATABYID (0x22U)

#if (defined DCM_SID_READMEMBYADDR)
#error DCM_SID_READMEMBYADDR already defined
#endif /* if (defined DCM_SID_READMEMBYADDR) */

/** \brief Definition of service ID of diagnostic service 'Read Memory By Address' */
#define DCM_SID_READMEMBYADDR (0x23U)

#if (defined DCM_SID_READSCALINGDATABYID)
#error DCM_SID_READSCALINGDATABYID already defined
#endif /* if (defined DCM_SID_READSCALINGDATABYID) */

/** \brief Definition of service ID of diagnostic service 'Read Scaling Data By Identifier' */
#define DCM_SID_READSCALINGDATABYID (0x24U)

#if (defined DCM_SID_READDATABYPERIODICID)
#error DCM_SID_READDATABYPERIODICID already defined
#endif /* if (defined DCM_SID_READDATABYPERIODICID) */

/** \brief Definition of service ID of diagnostic service 'Read Data By Periodic Identifier' */
#define DCM_SID_READDATABYPERIODICID (0x2AU)

#if (defined DCM_SID_DYNDEFDATAID)
#error DCM_SID_DYNDEFDATAID already defined
#endif /* if (defined DCM_SID_DYNDEFDATAID) */

/** \brief Definition of service ID of diagnostic service 'Dynamically Define Data Identifier' */
#define DCM_SID_DYNDEFDATAID (0x2CU)

#if (defined DCM_SID_WRITEDATABYID)
#error DCM_SID_WRITEDATABYID already defined
#endif /* if (defined DCM_SID_WRITEDATABYID) */

/** \brief Definition of service ID of diagnostic service 'Write Data By Identifier' */
#define DCM_SID_WRITEDATABYID (0x2EU)

#if (defined DCM_SID_IOCONTROLBYID)
#error DCM_SID_IOCONTROLBYID already defined
#endif /* if (defined DCM_SID_IOCONTROLBYID) */

/** \brief Definition of service ID of diagnostic service 'Input Output Control By Identifier' */
#define DCM_SID_IOCONTROLBYID (0x2FU)

#if (defined DCM_SID_WRITEMEMBYADDR)
#error DCM_SID_WRITEMEMBYADDR already defined
#endif /* if (defined DCM_SID_WRITEMEMBYADDR) */

/** \brief Definition of service ID of diagnostic service 'Write Memory By Address' */
#define DCM_SID_WRITEMEMBYADDR (0x3DU)
...
#if (defined DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETX)
#error DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETX already defined
#endif /* if (defined DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETX) */
/** \brief Definition of subservice id of UDS service CommunicationControl enableRxAndDisableTx */
#define DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETX (0x01U)

#if (defined DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDENABLETX)
#error DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDENABLETX already defined
#endif /* if (defined DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDENABLETX) */
/** \brief Definition of subservice id of UDS service CommunicationControl disableRxAndEnableTx */
#define DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDENABLETX (0x02U)

#if (defined DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDTX)
#error DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDTX already defined
#endif /* if (defined DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDTX) */
/** \brief Definition of subservice id of UDS service CommunicationControl disableRxAndTx */
#define DCM_SSID_COMMUNICATIONCONTROL_DISABLERXANDTX (0x03U)

#if (defined DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETXWITHENHANCEDADDRESSINFORMATION)
#error DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETXWITHENHANCEDADDRESSINFORMATION already defined
#endif /* if (defined DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETXWITHENHANCEDADDRESSINFORMATION) */
/** \brief Definition of subservice id of UDS service CommunicationControl enableRxAndDisableTxWithEnhancedAddressInformation */
#define DCM_SSID_COMMUNICATIONCONTROL_ENABLERXANDDISABLETXWITHENHANCEDADDRESSINFORMATION (0x04U)

#if ((DCM_DSP_USE_SERVICE_0X29 == STD_ON) || (DCM_AUTHENTICATION_CONNECTION == STD_ON))
#if (defined DCM_SID_AUTHENTICATION)
#error DCM_SID_AUTHENTICATION already defined
#endif /* if (defined DCM_SID_AUTHENTICATION) */

/** \brief Definition of service ID of diagnostic service 'Authentication' */
...
/* This is defined as a runtime error in SWS with value 0x02. Here we report it as a DET error
   with value 0x13 */
/** \brief Error code for an invalid input/output parameter or a return value */
...
#endif
/* Values greater than 0x78 are invalid according to Autosar 403,
   see AUTOSAR_SWS_CommunicationStackTypes.pdf */
...
/* \brief Macro to indicate the necessity of exclusive access to the MidServices */
     ...
     (DCM_DSP_SERVICE_0X06_ASYNC == STD_ON)) || (DCM_DSP_MIDSERVICES_USE_ASYNC == STD_ON)) &&\
 ...
 */
#define DCM_SVCID_NVMWRITEDATA 0xD0U
 ...
 */
#define DCM_SVCID_NVMREADDATA 0xD1U
 ...
 */
#define DCM_SVCID_NVMREADBLOCK 0xD2U
 ...
 */
#define DCM_SVCID_NVMWRITEBLOCK 0xD3U
 ...
 */
#define DCM_SVCID_NVMCANCELJOBS 0xD4U
 ...
 */
#define DCM_SVCID_NVMGETERRORSTATUS 0xD5U
...
#if (defined DCM_SVCID_SETDTCFILTERBYEXTENDEDDATARECORDNUMBER)
#error DCM_SVCID_SETDTCFILTERBYEXTENDEDDATARECORDNUMBER already defined
#endif /* if (defined DCM_SVCID_SETDTCFILTERBYEXTENDEDDATARECORDNUMBER) */

/** \brief Internal API service ID.
 **
 ** Definition of DCM_SVCID_SETDTCFILTERBYEXTENDEDDATARECORDNUMBER.
 */
#define DCM_SVCID_SETDTCFILTERBYEXTENDEDDATARECORDNUMBER 0xC1U
...
/* Start Authentication range */

#if (defined DCM_SVCID_AUTHENTICATION)
#error DCM_SVCID_AUTHENTICATION already defined
#endif /* if (defined DCM_SVCID_AUTHENTICATION) */

/** \brief Internal API service ID for Dcm_Dsp_Authentication_SvcH.
 **
 ** Definition of DCM_SVCID_AUTHENTICATION.
 */
#define DCM_SVCID_AUTHENTICATION 0xE0U

#if (defined DCM_SVCID_KEYMSETCERTIFICATE)
#error DCM_SVCID_KEYMSETCERTIFICATE already defined
#endif /* if (defined DCM_SVCID_KEYMSETCERTIFICATE) */

/** \brief Service ID for API KeyM_SetCertificate.
 **
 ** Definition of DCM_SVCID_KEYMSETCERTIFICATE.
 */
#define DCM_SVCID_KEYMSETCERTIFICATE 0xE1U

#if (defined DCM_SVCID_KEYMVERIFYCERTIFICATE)
#error DCM_SVCID_KEYMVERIFYCERTIFICATE already defined
#endif /* if (defined DCM_SVCID_KEYMVERIFYCERTIFICATE) */

/** \brief Service ID for API KeyM_VerifyCertificate.
 **
 ** Definition of DCM_SVCID_KEYMVERIFYCERTIFICATE.
 */
#define DCM_SVCID_KEYMVERIFYCERTIFICATE 0xE2U

#if (defined DCM_SVCID_KEYMGETCERTIFICATE)
#error DCM_SVCID_KEYMGETCERTIFICATE already defined
#endif /* if (defined DCM_SVCID_KEYMGETCERTIFICATE) */

/** \brief Service ID for API KeyM_GetCertificate.
 **
 ** Definition of DCM_SVCID_KEYMGETCERTIFICATE.
 */
#define DCM_SVCID_KEYMGETCERTIFICATE 0xE3U

#if (defined DCM_SVCID_KEYMCERTELEMENTGET)
#error DCM_SVCID_KEYMCERTELEMENTGET already defined
#endif /* if (defined DCM_SVCID_KEYMCERTELEMENTGET) */

/** \brief Service ID for API KeyM_CertElementGet.
 **
 ** Definition of DCM_SVCID_KEYMCERTELEMENTGET.
 */
#define DCM_SVCID_KEYMCERTELEMENTGET 0xE4U

/* DCM_SVCID_KEYMCERTELEMENTGETFIRST 0xE5U */
/* DCM_SVCID_KEYMCERTELEMENTGETNEXT 0xE6U */

#if (defined DCM_SVCID_KEYMASYNCCERTIFICATEVERIFYFINISHED)
#error DCM_SVCID_KEYMASYNCCERTIFICATEVERIFYFINISHED already defined
#endif /* if (defined DCM_SVCID_KEYMASYNCCERTIFICATEVERIFYFINISHED) */

/** \brief Service ID for API Dcm_KeyMAsyncCertificateVerifyFinished.
 **
 ** Definition of DCM_SVCID_KEYMASYNCCERTIFICATEVERIFYFINISHED.
 */
#define DCM_SVCID_KEYMASYNCCERTIFICATEVERIFYFINISHED 0xE7U

#if (defined DCM_SVCID_CSMRANDOMGENERATE)
#error DCM_SVCID_CSMRANDOMGENERATE already defined
#endif /* if (defined DCM_SVCID_CSMRANDOMGENERATE) */

/** \brief Service ID for API Csm_RandomGenerate.
 **
 ** Definition of DCM_SVCID_CSMRANDOMGENERATE.
 */
#define DCM_SVCID_CSMRANDOMGENERATE 0xE8U

#if (defined DCM_SVCID_CSMSIGNATUREGENERATE)
#error DCM_SVCID_CSMSIGNATUREGENERATE already defined
#endif /* if (defined DCM_SVCID_CSMSIGNATUREGENERATE) */

/** \brief Service ID for API Csm_SignatureGenerate.
 **
 ** Definition of DCM_SVCID_CSMSIGNATUREGENERATE.
 */
#define DCM_SVCID_CSMSIGNATUREGENERATE 0xE9U

#if (defined DCM_SVCID_CSMSIGNATUREVERIFY)
#error DCM_SVCID_CSMSIGNATUREVERIFY already defined
#endif /* if (defined DCM_SVCID_CSMSIGNATUREVERIFY) */

/** \brief Service ID for API Csm_SignatureVerify.
 **
 ** Definition of DCM_SVCID_CSMSIGNATUREVERIFY.
 */
#define DCM_SVCID_CSMSIGNATUREVERIFY 0xEAU

/* DCM_SVCID_CSMKEYELEMENTGET 0xEBU */

#if (defined DCM_SVCID_RESETAUTHENTICATION)
#error DCM_SVCID_RESETAUTHENTICATION already defined
#endif /* if (defined DCM_SVCID_RESETAUTHENTICATION) */

/** \brief API service ID.
 **
 ** Definition of DCM_SVCID_RESETAUTHENTICATION.
 */
#define DCM_SVCID_RESETAUTHENTICATION 0xECU

#if (defined DCM_SVCID_CSMASYNCJOBFINISHED)
#error DCM_SVCID_CSMASYNCJOBFINISHED already defined
#endif /* if (defined DCM_SVCID_CSMASYNCJOBFINISHED) */

/** \brief AUTOSAR API service ID.
 **
 ** Definition of DCM_SVCID_CSMASYNCJOBFINISHED.
 */
#define DCM_SVCID_CSMASYNCJOBFINISHED 0x28U

#if (defined DCM_SVCID_SETDEAUTHENTICATEDROLE)
#error DCM_SVCID_SETDEAUTHENTICATEDROLE already defined
#endif /* if (defined DCM_SVCID_SETDEAUTHENTICATEDROLE) */

/** \brief AUTOSAR API service ID.
 **
 ** Definition of DCM_SVCID_SETDEAUTHENTICATEDROLE.
 */
#define DCM_SVCID_SETDEAUTHENTICATEDROLE 0x79U

/* End Authenticate range */

#if (defined DCM_SVCID_REQCTRLVIAROUTINECTRL_UDSSHELL)
#error DCM_SVCID_REQCTRLVIAROUTINECTRL_UDSSHELL already defined
#endif /* if (defined DCM_SVCID_REQCTRLVIAROUTINECTRL_UDSSHELL) */

/** \brief AUTOSAR API service ID.
 **
 ** Definition of DCM_SVCID_REQCTRLVIAROUTINECTRL_UDSSHELL.
 */
#define DCM_SVCID_REQCTRLVIAROUTINECTRL_UDSSHELL 0xB6U
...
#error DCM_DTC_ORIGIN_USER_MEMORY_BASE already defined
#endif /* if (defined DCM_DTC_ORIGIN_USER_MEMORY_BASE) */

#endif /* if ( (DCM_DSP_USE_SERVICE_0X19 == STD_ON) ||
               (DCM_DSP_USE_SERVICE_0XAF == STD_ON) ||
               (DCM_DSP_USE_SERVICE_0X14 == STD_ON) ) */

/** \brief Definition of length of DTC memory base origin */
...
#if (defined DCM_SID_REQUEST_DOWNLOAD)
#error DCM_SID_REQUEST_DOWNLOAD already defined
#endif /* if (defined DCM_SID_REQUEST_DOWNLOAD) */
/** \brief Definition of service id of UDS service RequestDownload */
...
/* Macro for not configured ConnectionId */
#if (defined DCM_NOT_CONFIGURED_CONNECTION_ID)
  #error "DCM_NOT_CONFIGURED_CONNECTION_ID is already defined"
#endif
#define DCM_NOT_CONFIGURED_CONNECTION_ID            (0xFFFFU)
#endif

/** \brief invalid SEV event reference */
/* SEV Reporting Services uses the Idsm IdsMInternalEventId.
   The IdsM configuration parameter IdsMInternalEventId has a
   reduced upper limit to 65534 instead of 65535. That means an
   internal ID of 0xFFFF is considered invalid.
   If passed to a SEv-reporting API, it should trigger a DET reporting,
   provided that IdsMDevErrorDetect is enabled. */
#if (defined DCM_SEV_INVALID_SEV_REF)
#error DCM_SEV_INVALID_SEV_REF already defined!
#endif /* #if( defined DCM_SEV_INVALID_SEV_REF)*/
#define DCM_SEV_INVALID_SEV_REF                 0xFFFFU
...
typedef struct
{
  ...
  /** \brief SubService Role for Role verification whether the subservice execution is allowed */
...
#if (DCM_AUTHENTICATION_CONNECTION == STD_ON)
  /** \brief Service Role for Role verification whether the service execution is allowed */
  Dcm_AuthenticationRoleType Role;
#endif /* #if (DCM_AUTHENTICATION_CONNECTION == STD_ON) */
...
/** \brief ReadOBDDID Service request */
#if (defined DCM_DID_OP_READ_OBD)
  #error "DCM_DID_OP_READ_OBD is already defined"
#endif
#define DCM_DID_OP_READ_OBD 6U
...
#if (defined DCM_DIDCONFIGIDX_INVALID)
  #error "DCM_DIDCONFIGIDX_INVALID is already defined"
#endif

#if ( (DCM_DSP_DIDSERVICES_NUM_DIDS > 0xFEU)         || \
      (DCM_DSP_DIDSERVICES_NUM_DID_RANGES > 0xFEU) )
typedef uint16_least Dcm_DidConfigIdxType;
#define DCM_DIDCONFIGIDX_INVALID 0xFFFFU
#else
typedef uint8_least Dcm_DidConfigIdxType;
#define DCM_DIDCONFIGIDX_INVALID 0xFFU
#endif
...
/* !LINKSTO Dcm.ServiceRequestNotification.XxxIndication.API,1 */
...
/* !LINKSTO Dcm.ServiceRequestNotification.XxxConfirmation.API,1 */
...
/** \brief Type for UDS requests message context index */
typedef uint8 Dcm_StackContextIndexType;
...
/** \brief This function compares the new UDS service request against
 **        all other incomplete UDS service requests currently processing
 **        on other stacks to check for shared common resources that can
 **        only be used exclusively by one service request at a time.
 **
 ** \param[in]    NewRequestProtocolIndex  The index of the protocol for the new request
 ** \param[in]    NewRequestServiceId      The service ID for the new request
 ** \param[in]    NewRequestType           The type of request for the new request
 **
 *  \return
 **             - TRUE         if execution of new service request is allowed
 **             - FALSE        if execution of new service request is not allowed
 */
extern FUNC (boolean, DCM_CODE) Dcm_Dsp_ServiceExecutionAllowed(
...
#if (DCM_ASYNC_SERVICE_HANDLER == STD_ON)
/** \brief Checks if Service execution type set as asynchronous.
 **
 ** \param[in]    RxPduId  The RxPduId of the incoming request.
 **
 *  \return
 **             - TRUE         if service execution is asynchronous
 **             - FALSE        if service execution is synchronous
 */
extern FUNC (boolean, DCM_CODE) Dcm_Dsp_IsServiceExecutionTypeAsync(
  PduIdType RxPduId);
#endif /* #if (DCM_ASYNC_SERVICE_HANDLER == STD_ON) */
...
extern FUNC_P2VAR(Dcm_HsmInfoType, AUTOMATIC, DCM_CODE)
  Dcm_Dsp_GetCurrentHsmInfo(Dcm_ServiceIDType ServiceId);
 ...
 ** \param[in] ProtocolIdx   The index of protocol
 */
extern FUNC(void, DCM_CODE) Dcm_DsdInternal_ProcessPage(
 ...
 ** \param[in] ProtocolIdx The index of protocol
 */
extern FUNC(void, DCM_APPL_CODE) Dcm_DspInternal_CancelPagedBufferProcessing(
    Dcm_ProtocolIndexType ProtocolIdx);
#endif
...
/** \brief Initializes the control structures for OBD services 0x03, 0x04, 0x07, 0x0A
 */
extern FUNC(void, DCM_CODE) Dcm_Dsp_EmissionRelatedService_Init(void);
...
/** \brief Used by SEV Reporting to get the subservice ID.
 **
 ** \param instIdx [in]             HSM instance index
 *
 *  \return uint8 subServiceId
 */
extern FUNC (uint8, DCM_CODE) Dcm_Dsp_GetSubServiceID(
  uint8  instIdx
);

/** \brief Used by SEV Reporting to get the Tester Type
 **        and Tester Source Address.
 **
 ** \param instIdx [in]               HSM instance index
 ** \param TesterType [out]           Ptr to TesterType
 ** \param TesterSourceAddress [out]  Ptr to TesterSourceAddress
 *
 *  \return none
 */
extern FUNC (void, DCM_CODE) Dcm_Dsp_GetTesterInformation(
  uint8                                           instIdx,
...
/** \brief Used by SEV Reporting to get the RID or DID
 **        from the request message to add to the SEV
 **        ContextData.
 **
 ** \param instIdx [in]               HSM instance index
 ** \param Dcm_MsgType [out]          Ptr to SevContextData for the RID/DID
 *
 *  \return none
 */
extern FUNC (void, DCM_CODE) Dcm_Dsp_GetRequestContextDataInformation(
  uint8                  instIdx,
...
#if (DCM_NUM_UDS_STACKS > 0)
/** \brief Global array holding the configuration information for the UDS stacks */
extern CONST(Dcm_StackContextIndexType, DCM_CONST) Dcm_StackContextIndex[DCM_NUM_UDS_STACKS];
#endif /* #if (DCM_NUM_UDS_STACKS > 0) */

#if (DCM_ASYNC_SERVICE_HANDLER == STD_ON)
/** \brief Definition of asynchronous UDS stack index */
extern CONST(Dcm_StackContextIndexType, DCM_CONST) Dcm_AsyncStackContextIndex;
#endif /* #if (DCM_ASYNC_SERVICE_HANDLER == STD_ON) */
...
/* !LINKSTO Dcm.Dsn.DiagServiceDispatcher.Dcm_DsdServiceUsed,1 */
/* Deviation MISRAC2012-4 */
extern CONST(uint8, DCM_CONST_CALIBRATION)
  Dcm_DsdServiceUsed[DCM_DSP_NUMBER_OF_SRV_TABLES_USED][DCM_DSP_SERVICE_USED_BUF_SIZE];

#if (DCM_DSP_SUBSERVICE_USED_BUF_SIZE > 0)
/** \brief Global array holding the availability configuration for the configured subservices */
/* !LINKSTO Dcm.Dsn.DiagServiceDispatcher.Dcm_DsdSubServiceUsed,1 */
/* Deviation MISRAC2012-4 */
extern CONST(uint8, DCM_CONST_CALIBRATION)
  Dcm_DsdSubServiceUsed[DCM_DSP_NUMBER_OF_SRV_TABLES_USED][DCM_DSP_NUMBER_OF_SERVICE_USED][DCM_DSP_SUBSERVICE_USED_BUF_SIZE];
#endif
...
/* Deviation MISRAC2012-4 */
extern CONST(Dcm_DspRequestControlUsedType, DCM_CONST_CALIBRATION)
