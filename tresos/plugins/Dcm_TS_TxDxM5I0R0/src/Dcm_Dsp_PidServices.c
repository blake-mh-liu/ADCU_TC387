...
#if(DCM_DSP_USE_SERVICE_0X01 == STD_ON)
/** \brief Executor function for RequestCurrentPowertrainDiagnosticData
 **
 ...
 **
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_RequestCurrentPowertrainDiagnosticData_ServiceExecution(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext);
#endif /*(DCM_DSP_USE_SERVICE_0X01 == STD_ON)*/

#if (DCM_DSP_USE_SERVICE_0X02 == STD_ON)
/** \brief Executor function for RequestPowertrainFreezeFrameData
 **
 ** \param[in] OpStatus Operation state of the function.
 ** \param[inout] pMsgContext Message related information for one diagnostic protocol identifier.
 **
 ...
 **
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_RequestPowertrainFreezeFrameData_ServiceExecution(
  Dcm_OpStatusType OpStatus,
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext);
...
/* !LINKSTO Dcm.Dsn.OBDPidServices.LockStatus,1 */
STATIC VAR(Dcm_MutexType, DCM_VAR) Dcm_Dsp_PidServices_LockStatus = DCM_MUTEX_UNLOCKED;
#endif
 ...
 */
STATIC VAR(uint8, DCM_VAR) Dcm_PidDataBuffer[DCM_PID_DATA_MAX_SIZE];
#endif
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) Nrc)
{
...
#if (DCM_DSP_USE_SERVICE_0X01 == STD_ON)
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDNotConfigured.PIDsNotConfigured.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.FirstAvailabilityPID,1 */
  /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.FirstAvailabilityPID,1 */
  ReturnVal = DCM_E_OK;
...
#if (DCM_DSP_USE_SERVICE_0X01 == STD_ON)
  /* Deviation TASKING-2 */
  if((PIDsEnabled == FALSE) && (RequestedAvailabilityPidId == 0x00U))
  {
    ReturnVal = DCM_E_OK;
  }
#endif
  ...
  if (ReturnVal == DCM_E_NOT_OK)
  {
    ...
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDsNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.AvailabilityPID.TransmitNRC0x31,1 */

    *Nrc = DCM_E_REQUESTOUTOFRANGE;
  }

#if (DCM_NUM_PID_CFG == 0U)
  TS_PARAM_UNUSED(RequestedAvailabilityPidId);
...
#endif
  {
    ...
    for (Index=0U; Index<DCM_NUM_PID_CFG; Index++)
    {
      ...
      if (PidId == curPidConfig->PidIdentifier)
      {
        ...
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDConfigured.PidNotEnabled.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDConfigured.PidEnabled.Service02.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDConfigured.PidNotEnabled.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDConfigured.PidEnabled.Service02.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDConfigured.PidNotEnabled.NonAvailability.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDConfigured.PidEnabled.Service02.NonAvailability.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDConfigured.PidNotEnabled.NonAvailability.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDConfigured.PidEnabled.Service02.NonAvailability.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDConfigured.PidEnabled.Service02.NonAvailability.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDConfigured.PidNotEnabled.NonAvailability.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDConfigured.PidNotEnabled.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDConfigured.PidEnabled.Service02.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.AvailabilityPID.TransmitNRC0x31,1 */

        /* If PID not supporting requested service or is not used */
        /* Deviation TASKING-3 <+3> */
          ...
          if (ServiceId == DCM_SERVICE_02)
          {
            ...
            *  Dcm_Dsp_DemFacade_ReadDataOfOBDFreezeFrame()
                ...
                Dcm_PidDataBuffer, &UsedBufsize))
            {
              ...
              /* !LINKSTO Dcm.EB.OBD.RequestPowerTrainFreezeFrameData.SinglePIDRequested.ReadDataOfOBDFreezeFrameReturnsNOK.NoAnswer,1 */
              ReturnVal = DCM_E_NO_DATA;
  ...
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext)
{
  ...
  {
    Std_ReturnType PidLockStatus = Dcm_Dsp_PidServices_LockService();

    if (PidLockStatus == DCM_E_RESOURCE_LOCKED)
    {
      /* !LINKSTO Dcm.EB.RequestCurrentPowertrainDiagnosticData.RequestCurrentPowertrainDiagnosticDataAlreadyRunningOnDifferentStack.Postpone,1 */
      /* !LINKSTO Dcm.EB.RequestCurrentPowertrainDiagnosticData.RequestPowertrainFreezeFrameDataAlreadyRunningOnDifferentStack.Postpone,1 */
      /* !LINKSTO Dcm.EB.RequestCurrentPowertrainDiagnosticData.ReadDataByIdentifierAlreadyRunningOnDifferentStack.Postpone,1 */
      ServiceProcessStatus = DCM_E_PENDING;
    }
    else
    {
      /* Once the lock is obtained, the service execution is synchronous */
      ServiceProcessStatus = Dcm_Dsp_RequestCurrentPowertrainDiagnosticData_ServiceExecution(DCM_INITIAL,
                                                                                  pMsgContext);
...
#else
  ServiceProcessStatus = Dcm_Dsp_RequestCurrentPowertrainDiagnosticData_ServiceExecution(OpStatus, pMsgContext);
  ...
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext)
{
     ...
     (OpStatus != DCM_CONFIRMED_NOK))
  {
    ...
    if (PidLockStatus == DCM_E_RESOURCE_LOCKED)
    {
      /* !LINKSTO Dcm.EB.RequestPowertrainFreezeFrameData.RequestCurrentPowertrainDiagnosticDataAlreadyRunningOnDifferentStack.Postpone,1 */
      /* !LINKSTO Dcm.EB.RequestPowertrainFreezeFrameData.RequestPowertrainFreezeFrameDataAlreadyRunningOnDifferentStack.Postpone,1 */
      /* !LINKSTO Dcm.EB.RequestPowertrainFreezeFrameData.ReadDataByIdentifierAlreadyRunningOnDifferentStack.Postpone,1 */
      ServiceProcessStatus = DCM_E_PENDING;
    }
    else
    {
      /* Once the lock is obtained, the service execution is synchronous */
      ServiceProcessStatus = Dcm_Dsp_RequestPowertrainFreezeFrameData_ServiceExecution(DCM_INITIAL,
                                                                                  pMsgContext);
...
#else
  ServiceProcessStatus = Dcm_Dsp_RequestPowertrainFreezeFrameData_ServiceExecution(OpStatus, pMsgContext);
#endif /*#if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U))*/
...
#if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U))
FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_PidServices_LockService(void)
{
  Std_ReturnType RetVal = DCM_E_RESOURCE_LOCKED;

  DBG_DCM_DSP_PIDSERVICES_LOCKSERVICE_ENTRY();

  RetVal = Dcm_Internal_GetLock(&Dcm_Dsp_PidServices_LockStatus);

  DBG_DCM_DSP_PIDSERVICES_LOCKSERVICE_EXIT(RetVal);

  return RetVal;
}

FUNC(void, DCM_CODE) Dcm_Dsp_PidServices_UnlockService(void)
{
  DBG_DCM_DSP_PIDSERVICES_UNLOCKSERVICE_ENTRY();

  Dcm_Internal_ReleaseLock(&Dcm_Dsp_PidServices_LockStatus);

  DBG_DCM_DSP_PIDSERVICES_UNLOCKSERVICE_EXIT();
}
#endif /* #if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U)) */
