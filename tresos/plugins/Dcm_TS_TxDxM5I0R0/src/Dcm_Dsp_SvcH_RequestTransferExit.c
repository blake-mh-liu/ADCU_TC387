  ...
  )
{
  ...
  {
    /* !LINKSTO Dcm.EB.UDSServices.RequestTransferExit.transferRequestParameterRecordSizeIsNotZero.InvokeAPIDcm_ProcessRequestTransferExit,1 */
    TransferRequestParameterRecord = pMsgContext->reqData;
  }
  else
  {
    /* !LINKSTO Dcm.EB.RequestTransferExit.transferRequestParameterRecordSizeZero,3 */
    /* !LINKSTO Dcm.EB.RequestTransferExit.transferRequestParameterRecordSizeZero.AUTOSAR422,3 */
...
#if (DCM_DATATRANSFER_SERVICES_ASR_VERSION == DATA_TRANSFER_SERVICES_AUTOSAR_403)
  /* !LINKSTO Dcm.EB.RequestTransferExit.OptionalParametersNotUsed.ASR403,3 */
  TransferExitResult = Dcm_ProcessRequestTransferExit(OpStatus, NULL_PTR, 0U, &Nrc);
#else

  /* Give the callout the maximum available size of the TxBuffer. The callout will return the actual
   * number of written data bytes in TransferResponseParameterRecord */
  TransferResponseParameterRecordSize = pMsgContext->resMaxDataLen;
  ...
  if (OpStatus != DCM_CANCEL)
  {
    ...
    (DCM_DATATRANSFER_SERVICES_ASR_VERSION == DATA_TRANSFER_SERVICES_AUTOSAR_430)
        ...
        /* !LINKSTO Dcm.EB.RequestTransferExit.transferResponseParameterRecordSizeZero,3 */
        /* !LINKSTO Dcm.EB.RequestTransferExit.transferResponseParameterRecordSizeZero.AUTOSAR422,3 */
        /* !LINKSTO Dcm.EB.UDSServices.RequestTransferExit.transferResponseParameterRecordSizeIsNotZero.PositiveResponse,1 */
