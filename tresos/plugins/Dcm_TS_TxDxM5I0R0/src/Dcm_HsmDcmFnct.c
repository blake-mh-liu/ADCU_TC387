  ...
  DCM_PDL_SF(const uint8 instIdx))
{
  ...
  /* Initialize CancellationConditions */
  ...
  DCM_PDL_SF(const uint8 instIdx))
{
  ...
  /* !LINKSTO Dcm.EB.ReadDataById.ReadMemory.RCRRP.WaitTillConfirmation,1 */
  ...
  DCM_PDL_SF(const uint8 instIdx))
{
...
#endif /* ((DCM_DSP_USE_SERVICE_0X04 == STD_ON) || (DCM_DSP_USE_SERVICE_0X09 == STD_ON)) */
  {
    ...
    /* !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.LimitRCRRP.KeyMJobCancellation.TransmitNRC0x10,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateUnidirectional.LimitRCRRP.CsmJobRandomGenerateCancellation.TransmitNRC0x10,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.ProofOfOwnership.LimitRCRRP.CsmJobSignatureVerifyCancellation.TransmitNRC0x10,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.LimitRCRRP.KeyMJobCancellation.TransmitNRC0x10,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.LimitRCRRP.CsmJobRandomGenerateCancellation.TransmitNRC0x10,1
       !LINKSTO Dcm.EB.UDSServices.AuthenticationServiceRequest.VerifyCertificateBidirectional.LimitRCRRP.CsmJobSignatureGenerateCancellation.TransmitNRC0x10,1 */
...
STATIC FUNC(boolean, DCM_CODE) Dcm_SuppressResponse(const uint8 instIdx)
{
  ...
  else if (DCM_E_OK != nrc)
  {
    ...
    else if ((DCM_HSM_INFO(instIdx).serviceId == DCM_SID_CLEAR_DTC) &&
            (DCM_E_INCORRECTMESSAGELENGTHORINVALIDFORMAT == nrc))
    {
