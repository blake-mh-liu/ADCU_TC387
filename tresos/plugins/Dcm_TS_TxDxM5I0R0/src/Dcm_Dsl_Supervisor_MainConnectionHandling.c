...
)
{
  ...
  boolean MainConnectionFound = FALSE;

   while ((MainConnectionIndex < DCM_NUM_MAIN_CONNECTIONS) && (MainConnectionFound == FALSE))
   {
...
)
{
  ...
  Dcm_MainConnectionStatus[MainConnectionIndex].MsgContext.reqDataLen = RequestBuffer.FilledLength - 1U;
  ...
  Dcm_MainConnectionStatus[MainConnectionIndex].MsgContext.msgAddInfo.requestOrigin = DCM_EXTERNAL;
...
)
{
  ...
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.StartProtocol.ReturnsNotE_OK.GetMetaDataTargetAddr, 2 */
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.StopProtocol.ReturnsNotE_OK.GetMetaDataSourceAddr, 1 */
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.StopProtocol.ReturnsNotE_OK.GetMetaDataTargetAddr, 2 */
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.TransmitBRR.GetMetaDataSourceAddr, 1 */
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.TransmitBRR.GetMetaDataTargetAddr, 2 */
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.TransmitRCRRP.GetMetaDataSourceAddr, 1 */
  /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.TransmitRCRRP.GetMetaDataTargetAddr, 2 */
