 ...
 **
 ** \return       Operation status
 ** \retval       E_OK     The pObdMidValue parameter was updated with the supported MIDs
 ** \retval       E_NOT_OK There are no supported MIDs in the requested or upper range.
 */
...
)
{
  ...
  /* Deviation TASKING-1 */
  for(IteratorOdbMid = 0U; IteratorOdbMid < DCM_NUM_OBDMID_CFG; IteratorOdbMid++)
  {
...
)
{
  ...
  for(IteratorOdbMid = 0U; IteratorOdbMid < DCM_NUM_OBDMID_CFG; IteratorOdbMid++)
  {
    ...
    if(DCM_IS_BYTE_FLAG_SET(IteratorOdbMid, Dcm_DspOBDMIDUsed) == TRUE)
    {
       ...
       * The MIDs above the current availability range are used to decide wheter to set the bit
      ...
      if (NonAvailabilityObdMid >= ObdMid)
      {
        if (Dcm_Dsp_MidServices_SwcGetNumTIDsOfOBDMID((uint8)IteratorOdbMid, &NoOfTids) == E_OK)
        {
          ...
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotSupported.OBDMIDTIDsEnabled.AtLeastOneVisibleOBDMIDTID.AvailabilityDID.ResponseBitMapWithSupportedOBDMIDs,1 */
...
)
{
  ...
  if(DCM_IS_BYTE_FLAG_SET(TidIndex, Dcm_DspOBDMIDConfig[ObdMidIntId].TidUsedPtr) == TRUE)
  {
    ...
    *pUaSID = Dcm_DspOBDMIDTidConfig[TidInternalId].UaSid;
    /* get test values */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.SWCSupportConfigured.OBDMIDConfigured.OBDMIDTIDsEnabled.NonAvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.SWCSupportConfigured.OBDMIDConfigured.OBDMIDTIDsEnabled.NonAvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.SWCSupportConfigured.OBDMIDConfigured.OBDMIDTIDsEnabled.NonAvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsDisabledByCalibration.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsEnabled.AvailabilityDID.InvokeXxx_GetDTRValue,1 */
  ...
  else
  {
    ...
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.SWCSupportConfigured.OBDMIDConfigured.OBDMIDEnabled.OBDMIDTIDsConfigured.OBDMIDTIDsNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.SWCSupportConfigured.OBDMIDConfigured.OBDMIDEnabled.OBDMIDTIDsConfigured.OBDMIDTIDsNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.SWCSupportConfigured.OBDMIDConfigured.OBDMIDEnabled.OBDMIDTIDsConfigured.OBDMIDTIDsNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    Result = E_NOT_OK;
  }
...
)
{
  ...
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationFalse.DemSupportConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationFalse.DemSupportConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationFalse.DemSupportConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotEnabled.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotEnabled.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotEnabled.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsDisabledByCalibration.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsConfigured.AvailabilityDID.InvokeDemDcmGetAvailableOBDMIDs,1 */
  ...
  if (Result == E_OK)
  {
    ...
    if (ObdMidValue != 0UL)
    {
      ...
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotSupported.AvailabilityDID.AtLeastOneSupportedOBDMIDs.ResponseBitMapWithSupportedOBDMIDs,1 */
  ...
  boolean WriteMidBeforeTid)
{
  ...
  if(Dcm_Dsp_MidServices_GetObdMidInternalId(ObdMid, &ObdMidIntId) == E_OK)
  {
    ...
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DemSupportConfigured.NonAvailabilityDID.InvokeDemDcmGetNumTIDsOfOBDMID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DemSupportConfigured.NonAvailabilityDID.InvokeDemDcmGetNumTIDsOfOBDMID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DemSupportConfigured.NonAvailabilityDID.InvokeDemDcmGetNumTIDsOfOBDMID,1 */
    if (DCM_GET_NO_OF_OBDMIDTIDS(ObdMidIntId, &NrTidsOBDMID) == E_OK)
    {
      ...
      if (NrTidsOBDMID > 0U)
      {
        ...
        for(IteratorObdMidTid = 0U; IteratorObdMidTid < NrTidsOBDMID; IteratorObdMidTid++)
        {
          ...
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DemSupportConfigured.NonAvailabilityDID.AtleastOneVisibleOBDMIDTID.InvokeDemDcmGetDTRData,1 */
          ...
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DemSupportConfigured.NonAvailabilityDID.AtleastOneVisibleOBDMIDTID.DemDcmGetDTRDataReturnsNotE_OK.Ignore,1 */
          if (E_OK == DTROpResult)
          {
            ...
            pResBuf[WritePosition] = TIDValue;
        ...
        if (0U != WritePosition)
        {
          ...
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DemSupportConfigured.NonAvailabilityDID.AtleastOneVisibleOBDMIDTID.PositiveResponse,1 */
        ...
        else
        {
          if (IteratorObdMidTid == NrTidsOBDMID)
          {
            ...
            /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.SWCSupportConfigured.GetDTRValue.NonAvailabilityDID.NoVisibleOBDMIDTID.TransmitNRC0x31,1 */
    ...
    else
    {
      ...
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.SWCSupportConfigured.OBDMIDConfigured.OBDMIDEnabled.OBDMIDTIDsConfigured.OBDMIDTIDsNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.SWCSupportConfigured.OBDMIDConfigured.OBDMIDEnabled.OBDMIDTIDsConfigured.OBDMIDTIDsNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DemSupportConfigured.NonAvailabilityDID.DemDcmGetNumTIDsOfOBDMIDReturnsNotE_OK.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DemSupportConfigured.NonAvailabilityDID.DemDcmGetNumTIDsOfOBDMIDReturnsE_OK.NoVisibleOBDMIDTID.TransmitNRC0x31,1 */
      *pNrc = DCM_E_REQUESTOUTOFRANGE;
    }
  }
  else
...
FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_MidServices_GetAvailabilityMid(
  uint8 ObdMid, P2VAR(uint8, AUTOMATIC, DCM_VAR) pResBuf)
{
  Std_ReturnType Result = E_NOT_OK;

  DBG_DCM_DSP_MIDSERVICES_GETAVAILABILITYMID_ENTRY(ObdMid, pResBuf);

  /* Clean the buffer where the availability data will be set. Skip the
   * availability ID */
  TS_MemSet(&(pResBuf[0U]), 0U, DCM_OBD_MID_AVAILDATALEN);

  /* !LINKSTO Dcm415,1 */
  Result = DCM_GET_AVAILABLE_OBDMIDS(ObdMid, &(pResBuf[0U]));

  DBG_DCM_DSP_MIDSERVICES_GETAVAILABILITYMID_EXIT(Result, ObdMid, pResBuf);
