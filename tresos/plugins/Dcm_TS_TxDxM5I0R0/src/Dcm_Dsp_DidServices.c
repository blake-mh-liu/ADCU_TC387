...
#endif
#if (DCM_DSP_USE_MIDSERVICES == STD_ON)
...
#if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
#if (defined DCM_DIDSERVICES_READSINGLESTATICDID_AVAILABILITY_CALCULATION)
  #error "DCM_DIDSERVICES_READSINGLESTATICDID_AVAILABILITY_CALCULATION is already defined"
#endif
#endif /* #if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON) */
...
#if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
#define DCM_DIDSERVICES_READSINGLESTATICDID_AVAILABILITY_CALCULATION \
...
#define DCM_DIDSERVICES_READSINGLESTATICDID_OBD_OFFSET \
  (DCM_DIDSERVICES_READSINGLESTATICDID_AVAILABILITY_CALCULATION + 1U)
#else
/* With DID ranges enabled, OBD Did state ids start after DID range state ids */
#define DCM_DIDSERVICES_READSINGLESTATICDID_OBD_OFFSET \
  (DCM_DIDSERVICES_READSINGLESTATICDID_RANGE_DATA + 1U)
...
/** \brief Size in bytes of the availability response (DATA A/B/C/D) */
#if (defined DCM_UDS_DID_AVAILDATALEN)
  #error "DCM_UDS_DID_AVAILDATALEN is already defined"
#endif
#define DCM_UDS_DID_AVAILDATALEN                       4U

#if (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)

/** \brief Macro for UDS availability ranges */
#if (defined DCM_UDS_AVAILABILITY_RANGE)
  #error "DCM_UDS_AVAILABILITY_RANGE is already defined"
#endif
#define DCM_UDS_AVAILABILITY_RANGE                     0x20U

/** \brief Macro for start of F4 read data stream range */
#if (defined DCM_UDS_READDATASTREAM_F4_RANGE_START)
  #error "DCM_UDS_READDATASTREAM_F4_RANGE_START is already defined"
#endif
#define DCM_UDS_READDATASTREAM_F4_RANGE_START          0xF400U

/** \brief Macro for end of F4 read data stream range */
#if (defined DCM_UDS_READDATASTREAM_F4_RANGE_END)
  #error "DCM_UDS_READDATASTREAM_F4_RANGE_END is already defined"
#endif
#define DCM_UDS_READDATASTREAM_F4_RANGE_END            0xF4FFU

/** \brief Macro for end of F5 read data stream range */
#if (defined DCM_UDS_READDATASTREAM_F5_RANGE_END)
  #error "DCM_UDS_READDATASTREAM_F5_RANGE_END is already defined"
#endif
#define DCM_UDS_READDATASTREAM_F5_RANGE_END            0xF5FFU

/** \brief Macro for start of F7 read data stream range */
#if (defined DCM_UDS_READDATASTREAM_F7_RANGE_START)
  #error "DCM_UDS_READDATASTREAM_F7_RANGE_START is already defined"
#endif
#define DCM_UDS_READDATASTREAM_F7_RANGE_START            0xF700U

/** \brief Macro for end of F7 read data stream range */
#if (defined DCM_UDS_READDATASTREAM_F7_RANGE_END)
  #error "DCM_UDS_READDATASTREAM_F7_RANGE_END is already defined"
#endif
#define DCM_UDS_READDATASTREAM_F7_RANGE_END            0xF7FFU
...
#endif
#if (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
/** \brief Function to check the configured data according to the following ranges:
 **        0xF400U - 0xF4FFU - Checks for the configured DIDs and corresponding PIDs (0x00U - 0xFFU)
 **        0xF500U - 0xF5FFU - Checks for the configured DIDs
 **        0xF700U - 0xF7FFU - Checks for the configured DIDs
 **
 **        For the configured DIDs/PIDs the corresponding bit is set to '1' in the response message
 **        according to J1979DA-202203' SAE standard, tables:
 **          * 'SAE J1979/ISO 15031-5'
 **          * 'ISO 27145-2/J1979-2'
 **
 ** \param[in]  context A specialized Dsp context.
 **
 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_DidServices_ReadSingleStaticDid_GetAvailabilityDid(
  Dcm_Dsp_ContextPtr context);
#endif
#if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON)
#if (DCM_DSP_USE_PIDSERVICES == STD_ON)
...
#endif /* (DCM_DSP_USE_PIDSERVICES == STD_ON) */
#if (DCM_DSP_USE_MIDSERVICES == STD_ON)
STATIC FUNC(void, DCM_CODE)
...
#endif /* (DCM_DSP_USE_MIDSERVICES == STD_ON) */
...
#endif /* ((DCM_DSP_USE_VINSERVICES == STD_ON) && (DCM_DSP_VEHINFO_NUM > 0)) */
#endif /* DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON */
...
#endif
#if (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
  /* AVAILABILITY DID */ &Dcm_Dsp_DidServices_ReadSingleStaticDid_GetAvailabilityDid,
#endif
#if ((DCM_DSP_USE_OBDSERVICES == STD_ON) || (DCM_DSP_USE_SERVICE_0X22 == STD_ON))
#if (DCM_DSP_USE_PIDSERVICES == STD_ON)
 ...
 */
/* !LINKSTO Dcm.Dsn.IB.DidServices.DidSetStatus,1 */
...
#if (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
/** \brief Search if the requested Did is an OBD availability DID.
 **
 ** \param[in]  Did Requested Did.
 **
 ** \retval TRUE   The Did is in the OBD range (0xF400-0xF8FF).
 ** \retval FALSE  The Did is not in the OBD range.
 */
STATIC FUNC(boolean, DCM_CODE) Dcm_Dsp_DidServices_isObdAvailabilityDid(
  uint16 Did);

#if (DCM_NUM_PID_CFG > 0U)
/** \brief Get the availability data for the requested availability PID.
 **
 ** \param[in]      Pid              Requested availability PID.
 ** \param[in|out]  AvailabilityData Update the AvailabilityData received as input
 **                                  with the available PIDs for the requested range
 **
 ** \retval DCM_E_OK      The AvailabilityData was updated
 ** \retval DCM_E_NOT_OK  The AvailabilityData was not updated
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_DidServices_GetAvailabilityPid(
  uint8 Pid,
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData);
#endif /* (DCM_NUM_PID_CFG > 0U) */

#if (DCM_DSP_DIDSERVICES_NUM_DIDS > 0)
/** \brief Get the availability data for the requested availability DID in the OBD DataStream range
 **        (0xF400-0xF5FF, 0xF700-0xF7FF).
 **
 ** \param[in]      Did              Requested availability DID.
 ** \param[in|out]  AvailabilityData Update the AvailabilityData received as input
 **                                  with the available DIDs for the requested range
 **
 ** \retval DCM_E_OK      The AvailabilityData was updated
 ** \retval DCM_E_NOT_OK  The AvailabilityData was not updated
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_DidServices_GetAvailabilityObdDid(
  uint16 Did,
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData);

/** \brief Get the availability data for the requested availability DID in the OBD Monitor range
 **        (0xF600-0xF6FF).
 **
 ** \param[in]      Did              Requested availability DID.
 ** \param[in|out]  AvailabilityData Update the AvailabilityData received as input
 ...
 ** \retval DCM_E_NOT_OK  The AvailabilityData was not updated
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_DidServices_GetAvailabilityMonitorDid(
  uint16 Did,
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData);

/** \brief Get the availability data for the requested availability DID in the OBD InfoType range
 **        (0xF800-0xF8FF).
 **
 ** \param[in]      Did              Requested availability DID.
 ** \param[in|out]  AvailabilityData Update the AvailabilityData received as input
 ...
 ** \retval DCM_E_NOT_OK  The AvailabilityData was not updated
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsp_DidServices_GetAvailabilityInfoTypeDid(
  uint16 Did,
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData);

#endif /* (DCM_DSP_DIDSERVICES_NUM_DIDS > 0) */

#endif /* (DCM_DID_AVAILABILITY_CALCULATION == STD_ON) */
...
STATIC FUNC(uint16, DCM_CODE) Dcm_Dsp_DidServices_EndianessConversion_CalculateDataPosition (
  ...
  uint16              DataPosition);
     ...
     (DCM_NUM_READSCALING_DID_DATA > 0U))
...
STATIC FUNC(boolean, DCM_CODE) Dcm_Dsp_DidServices_ScalingInfoSizeFitsIntoBuffer(
  P2VAR(Dcm_ReadSignalContextType, AUTOMATIC, DCM_VAR) pReadSignalContext);
#endif /* ((DCM_DSP_USE_SERVICE_0X24 == STD_ON) && \
           (DCM_NUM_READSCALING_DID_DATA > 0U)) */
...
#if ((DCM_DID_SIGNALS_COUNT > 0) || (DCM_DSP_USE_DIDRANGES == STD_ON))
...
#endif /* ((DCM_DID_SIGNALS_COUNT > 0) || (DCM_DSP_USE_DIDRANGES == STD_ON)) */
...
/* !LINKSTO Dcm.Dsn.IB.DidServices.ValidateDidUsed,1 */
#if (DCM_DSP_DIDSERVICES_NUM_DIDS > 0U)
FUNC(boolean, DCM_CODE) Dcm_Dsp_DidServices_ValidateDidUsed(
Dcm_DidConfigIdxType DidIdx)
{
  boolean DidUsed;
  const Dcm_DidConfigIdxType DidEnabledIdx = DidIdx / 8U;
  const uint8 DidEnabledBitMask = (1U << (DidIdx % 8U));

  DBG_DCM_DSP_DIDSERVICES_VALIDATEDIDUSED_ENTRY(DidIdx);

  /* Check if the corresponding Did is available */
  if ((Dcm_DspDidUsed[DidEnabledIdx] & DidEnabledBitMask) != 0U)
  {
  /* the did has been found in the list of statically defined dids with
     configuration parameter 'DcmDspDidUsed' that is set to 'true' */
    DidUsed = TRUE;
  }
  else
  {
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.DID,2 */
    ...
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.DID,2 */
    /* !LINKSTO Dcm.EB.ReadDataByPeriodicIdentifier.DisabledFromCalibrationDid.DID,1 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.DID,2 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.DisabledFromCalibrationDid.DidNotInRange.OBD,1 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.DID,2 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.DisabledFromCalibrationDid.DidNotInRange.OBD,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Enabled.DisabledFromCalibrationDid.ResetToDefault,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Enabled.DisabledFromCalibrationDid.ReturnControlToEcu,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Enabled.DisabledFromCalibrationDid.FreezeCurrentState,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Enabled.DisabledFromCalibrationDid.ShortTermAdjustment,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.DisabledFromCalibrationDid.ResetToDefault,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.DisabledFromCalibrationDid.ReturnControlToEcu,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.DisabledFromCalibrationDid.FreezeCurrentState,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.DisabledFromCalibrationDid.ShortTermAdjustment,1 */
    /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.DisabledFromCalibrationDid.DynamicallyDefinedDID,1 */
    /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.DisabledFromCalibrationDid.SourceDID,1 */
    /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineByMemoryAddress.DisabledFromCalibrationDid.DynamicallyDefinedDID,1 */
    DidUsed = FALSE;
  }

  DBG_DCM_DSP_DIDSERVICES_VALIDATEDIDUSED_EXIT(DidUsed, DidIdx);
...
FUNC(boolean, DCM_CODE) Dcm_Dsp_DidServices_IsDidSynchronous(
  uint16 Did)
{
  boolean DidSynchronous;
  Dcm_DidConfigIdxType DidConfigIdx = 0U;
#if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON)
  Dcm_DidType ConfigType;
  Dcm_Dsp_DidServices_GetDidInfo_IsObdDIDAvailable(Did, &ConfigType);
#endif /* #if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON) */

  if (TRUE == Dcm_Dsp_DidServices_GetDidIndex(Did, &DidConfigIdx))
  {
#if (DCM_DSP_DIDSERVICES_NUM_DIDS > 0)
    if ((Dcm_DidConfig[DidConfigIdx].NumRefDids != 0U) ||
        (Dcm_DidConfig[DidConfigIdx].IsDidSync != TRUE))
    {
      DidSynchronous = FALSE;
    }
    else
#endif /* #if (DCM_DSP_DIDSERVICES_NUM_DIDS > 0) */
    {
...
#if (DCM_DSP_USE_DIDRANGES == STD_ON)
  else if (Dcm_Dsp_DidServices_GetDidRangeIndex(Did, &DidConfigIdx) != FALSE)
  {
...
#endif /* (DCM_DSP_USE_DIDRANGES == STD_ON) */
#if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
  else if (Dcm_Dsp_DidServices_isObdAvailabilityDid(Did) != FALSE)
  {
    /* DID is an OBD availability DID */
    DidSynchronous = TRUE;
  }
#endif /* #if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON) */
#if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON)
  else if (ConfigType != DCM_DID_UNCONFIGURED)
  {
    /* OBD DID is available */
    DidSynchronous = TRUE;
  }
#endif /* #if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON) */
  else
  {
    ...
    DidSynchronous = FALSE;
#else
    /* Default interface is disabled */
    DidSynchronous = TRUE;
#endif /* #if (DCM_REQUEST_SUPPLIER_DEFAULT_DID_READ == STD_ON) */
  }

  return DidSynchronous;
}
  ...
  P2VAR(Dcm_DidConfigIdxType, AUTOMATIC, DCM_VAR) ConfigIdx)
{
...
#if (DCM_DSP_DIDSERVICES_NUM_DIDS > 0)
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.DID,2 */
  ...
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.DID,2 */
  ...
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.DID,2 */
  ...
  /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.DID,2 */
  /* !LINKSTO Dcm.EB.ReadDataByPeriodicIdentifier.UnconfiguredDid.DID,1 */
  /* !LINKSTO Dcm.EB.ReadDataByPeriodicIdentifier.UnusedDid.DID,1 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.DID,3 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.DID,3 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnusedDid.DidNotInRange.OBD,1 */
  /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnconfiguredDid.DidNotInRange.OBD,1 */
  ...
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnusedDid.ResetToDefault,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnusedDid.ReturnControlToEcu,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnusedDid.FreezeCurrentState,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnusedDid.ShortTermAdjustment,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnconfiguredDid.ResetToDefault,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnconfiguredDid.ReturnControlToEcu,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnconfiguredDid.FreezeCurrentState,1 */
  /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnconfiguredDid.ShortTermAdjustment,1 */
  /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.UnconfiguredDid.DynamicallyDefinedDID,1 */
  /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.UnusedDid.DynamicallyDefinedDID,1 */
  /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.UnconfiguredDid.SourceDID,1 */
  /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.UnusedDid.SourceDID,1 */
  /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineByMemoryAddress.UnconfiguredDid.DynamicallyDefinedDID,1 */
  /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineByMemoryAddress.UnusedDid.DynamicallyDefinedDID,1 */
  ...
  if((Did >= Dcm_DidConfig[LowDidIdx].Did) && (Did <= Dcm_DidConfig[HighDidIdx].Did))
  {
    ...
    while (HighDidIdx >= LowDidIdx)
    {
      ...
      else
      {
        ...
        /* Check if the corresponding Did is available */
        DIDFound = Dcm_Dsp_DidServices_ValidateDidUsed(MidDidIdx);
...
#if ((DCM_DSP_USE_SERVICE_0X24 == STD_ON) && (DCM_NUM_READSCALING_DID_DATA > 0))
...
#endif /* ((DCM_DSP_USE_SERVICE_0X24 == STD_ON) && (DCM_NUM_READSCALING_DID_DATA > 0)) */
    {
      ...
      if (numSignals != 0U)
      {
        ...
        while ((pReadSignalContext->SignalInd < numSignals) && breakConditionsNotFulfilled )
        {
          if (pReadSignalContext->NewSignal == TRUE)
          {
            ...
            {
              if(pReadSignalContext->SignalInd == 0x00U)
              {
                didDataPosn = 0;
              }
              else
...
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_DidServices_WriteDid_GetDidInfo(Dcm_Dsp_ContextPtr context)
{
  ...
  if (DCM_CANCEL == DCM_DSP_CONTEXT_OPSTATUS(context))
  {
    ...
    /* inherit the result of the subroutine */
  ...
  else
  {
    ...
    {
      /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.DID,2 */
      /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.DID,2 */
      /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.UnusedDid.DidNotInRange.OBD,1 */
      /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Enabled.UnconfiguredDid.DidNotInRange.OBD,1 */
...
#if ((DCM_SECURITY_EVENT_REPORTING == STD_ON) && \
     ((DIAG_SEV_WRITE_INV_DATA != DCM_SEV_INVALID_SEV_REF) || (DIAG_SEV_DID_NOT_SUPPORTED != DCM_SEV_INVALID_SEV_REF)))
    if (DCM_DID_UNCONFIGURED == (DidInfoContextPtr->DidInfoContext.ConfigType))
    {
      Dcm_SEVReportingServices_IdsMSetSecurityEvent_WriteDidNotSupported_NRC(DCM_DSP_CONTEXT_NRC(context));
    }
#endif
  }
}
  ...
  uint16 Did)
{
  ...
  if ((Did >= 0xF400U) && (Did <= 0xF8FFU) && (Did % DCM_UDS_AVAILABILITY_RANGE == 0x00U))
  {
    result = TRUE;
  }
  ...
  P2VAR(Dcm_DidType, AUTOMATIC, DCM_VAR) ConfigType)
{
      ...
      (DCM_DSP_USE_MIDSERVICES == STD_ON) || \
      (DCM_DSP_USE_VINSERVICES == STD_ON) )
  ...
  *ConfigType = DCM_DID_UNCONFIGURED;
  ...
  if ((DCM_DID_OBD_PID_LOW_LIMIT <= Did) && (Did <= DCM_DID_OBD_PID_UP_LIMIT))
  {
    ...
    if (PidId == 0x00U)
    {
      /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.AvailabilityPID, 1 */
      /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.AvailabilityPID, 1 */
      /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.AvailabilityPID,1 */
  ...
  if ((DCM_DID_OBD_MID_LOW_LIMIT <= Did) && (Did <= DCM_DID_OBD_MID_UP_LIMIT))
  {
    ...
    while ((iteratorOdbMid < DCM_NUM_OBDMID_CFG) && (*ConfigType == DCM_DID_UNCONFIGURED))
    {
  ...
  if ((DCM_DID_OBD_MID_LOW_LIMIT <= Did) && (Did <= DCM_DID_OBD_MID_UP_LIMIT))
  {
    ...
    else
    {
      ...
      if(DCM_UINT32_IS_BIT_SET(ObdMidValue, (0x00000020U - ((uint32)RequestedOBDMID - (uint32)AvailabilityOBDMID))))
      {
  ...
  TS_PARAM_UNUSED(Range);
           ...
           (DCM_DSP_VEHINFO_USED_ARRAY_SIZE > 0)) */
#endif /* (DCM_DSP_USE_VINSERVICES == STD_ON) */
}
#endif /* #if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON) */
...
/* !LINKSTO Dcm.Dsn.DidServices.IB.GetDidInfo_SelectType,3 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_DidServices_GetDidInfo_SelectType (Dcm_Dsp_ContextPtr context)
{
  /* Deviation MISRAC2012-2 */
  CONSTP2VAR(Dcm_DidInfoContextExtType, AUTOMATIC, DCM_VAR) DidInfo =
  ...
  if (Dcm_Dsp_DidServices_GetDidIndex(DidInfo->Did, &DidInfo->ConfigIdx) != FALSE)
  {
    ...
    {
#if (DCM_DSP_DIDSERVICES_DYNAMIC_DID_SUPPORT == STD_ON)
      /* !LINKSTO Dcm.Dsn.IB.DidServices.GetDidInfo_SelectType.DynamicRange,1 */
      if (DidInfo->DidOp == DCM_DID_OP_DYNAMIC)
      {
        if (Dcm_DidInfo[DidInfo->InfoIdx].DDDidMaxNumSrcElements == 0x00U)
        {
          /* Error: user wants to configure a static DID from the dynamic range */
          /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineById.StaticDID.TransmitNrc0x31,1 */
          /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.DefineByMemoryAddress.StaticDID.TransmitNrc0x31,1 */
          DidInfo->ConfigType = DCM_DID_UNCONFIGURED;
        }
        else
        {
      ...
      else if (Dcm_DidInfo[DidInfo->InfoIdx].DDDidMaxNumSrcElements == 0x00U)
      {
        /* The upper condition means that the DID is configured as static */
        /* !LINKSTO Dcm.EB.ReadDataById.DynamicRange.StaticDID,1 */
        /* !LINKSTO Dcm.EB.WriteDataById.DynamicRange.StaticDID,1 */
          DidInfo->ConfigType = DCM_DID_TYPE_ID_STATIC;
      }
      /* read access: check if the dynamic configuration is available and operation is READ */
      else if (((DidInfo->DidOp == DCM_DID_OP_READ) || (DidInfo->DidOp == DCM_DID_OP_PERIODIC)) &&
               (Dcm_Dsp_DidServices_IsDidDynamicallyConfigured(DidInfo->ConfigIdx)))
      {
          /* set Did configuration type to 'dynamic by id' */
          DidInfo->ConfigType = DCM_DID_TYPE_ID_DYNAMIC;
      }
...
#else
      /* if Service 0x2C is not configured, set the type to 'static by id' */
      /* !LINKSTO Dcm.EB.ReadDataById.DynamicRange.StaticDID,1 */
      /* !LINKSTO Dcm.EB.WriteDataById.DynamicRange.StaticDID,1 */
      DidInfo->ConfigType = DCM_DID_TYPE_ID_STATIC;
#endif /* #if (DCM_DSP_DIDSERVICES_DYNAMIC_DID_SUPPORT == STD_ON) */
    }
    else if (Dcm_Dsp_DidServices_IsDidInObdRange(DidInfo->Did))
    {
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDIDFromOBDRange,1 */
...
#endif /* (DCM_DSP_USE_DIDRANGES == STD_ON) */
#if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
  else if ((Dcm_Dsp_DidServices_isObdAvailabilityDid(DidInfo->Did) != FALSE) && ((DCM_DID_OP_READ == DidInfo->DidOp) || (DCM_DID_OP_READ_OBD == DidInfo->DidOp)))
  {
    /* Did is an OBD availability DID */
    /* set Did configuration type to 'availability' */
    DidInfo->ConfigType =  DCM_DID_TYPE_AVAILABILITY;
  }
#endif /* #if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON) */
#if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON)
  else if ((Dcm_Dsp_DidServices_IsDidInObdRange(DidInfo->Did) != FALSE) && ((DCM_DID_OP_READ == DidInfo->DidOp) || (DCM_DID_OP_READ_OBD == DidInfo->DidOp)))
  {
    ...
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.PIDNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.PIDNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.PIDNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F7Range.DIDNotConfigured.DIDType.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F7Range.DIDConfigured.DIDNotEnabled.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F7Range.DIDConfigured.DisabledByCalibration.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F5Range.DIDNotConfigured.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F5Range.DIDConfigured.DIDNotEnabled.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F5Range.DIDConfigured.DisabledByCalibration.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDNotConfigured.DIDType.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.ITIDConfigured.ITIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DisabledByCalibration.ITIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.ITIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.ITIDConfigured.ITIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.ITIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.ITIDsNotConfigured.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.ITIDsNotConfigured.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.ITIDsConfigured.ITIDsNotEnabled.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.ITIDsConfigured.ITIDsNotEnabled.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.ITIDsNotConfigured.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.ITIDsNotConfigured.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.ITIDsConfigured.ITIDsNotEnabled.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.ITIDsConfigured.ITIDsNotEnabled.Availability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDConfigured.ITIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDConfigured.ITIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDConfigured.ITIDNotEnabled.NonAvailability.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDNotConfigured.NonAvailability.TransmitNRC0x31,1 */

    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.SWCSupportConfigured.OBDMIDNotConfigured.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.SWCSupportConfigured.OBDMIDConfigured.OBDMIDNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.SWCSupportConfigured.OBDMIDNotConfigured.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.SWCSupportConfigured.OBDMIDConfigured.OBDMIDNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.SWCSupportConfigured.OBDMIDNotConfigured.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.SWCSupportConfigured.OBDMIDConfigured.OBDMIDNotEnabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.NoOBDMIDSupportConfigured.DefaultInterface.Disabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.NoOBDMIDSupportConfigured.DefaultInterface.Disabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.NoOBDMIDSupportConfigured.DefaultInterface.Disabled.NonAvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationFalse.NoOBDMIDSupportConfigured.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationFalse.NoOBDMIDSupportConfigured.AvailabilityDID.TransmitNRC0x31,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationFalse.NoOBDMIDSupportConfigured.AvailabilityDID.TransmitNRC0x31,1 */
  ...
  if((DidInfo->DidOp == DCM_DID_OP_READSCALING) && (DidInfo->ConfigType!= DCM_DID_TYPE_ID_STATIC))
  {
    ...
    /* !LINKSTO Dcm.EB.UDSServices.ReadScalingDataByIdentifierServiceRequest.RequestOutOfRange.DisabledFromCalibrationDid.TransmitNRC0x31,1 */
  ...
  if(DidInfo->ConfigType == DCM_DID_UNCONFIGURED)
  {
    ...
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.NoOBDMIDSupportConfigured.DefaultInterface.Enabled.NonAvailabilityDID.InvokeDcmDefaultDIDRead,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.NoOBDMIDSupportConfigured.DefaultInterface.Enabled.NonAvailabilityDID.InvokeDcmDefaultDIDRead,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.NoOBDMIDSupportConfigured.DefaultInterface.Enabled.NonAvailabilityDID.InvokeDcmDefaultDIDRead,1 */
    DidInfo->ConfigType = DCM_DID_UNCONFIGURED_DEFAULT_INTERFACE;
#endif /* DCM_REQUEST_SUPPLIER_DEFAULT_DID_READ */
    /* Did has not been found, stop processing */
    /* !LINKSTO Dcm.EB.ReadDataById.DefaultInterface.Disabled.UnsupportedDid.DidNotInRange.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.WriteDataById.DefaultInterface.Disabled.UnsupportedDid.DidNotInRange.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.DefaultInterface.Disabled.UnsupportedDid.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.ReadDataByPeriodicIdentifier.UnsupportedDid.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.DynamicallyDefineDataIdentifier.UnsupportedDid.TransmitNrc0x31,1 */
    DCM_DSP_CONTEXT_RESULT(context) = DCM_E_NOT_OK;
  }
#if (DCM_DSP_USE_DIDRANGES == STD_ON)
...
#endif /* (DCM_DSP_USE_DIDRANGES == STD_ON) */
#if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
  else if (DidInfo->ConfigType == DCM_DID_TYPE_AVAILABILITY)
  {
    /* availability Did has been found, stop processing */
    DCM_DSP_CONTEXT_RESULT(context) = DCM_E_OK;
  }
#endif /* #if(DCM_DID_AVAILABILITY_CALCULATION == STD_ON) */
#if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON)
  ...
  Dcm_Dsp_ContextPtr context)
{
  ...
  if (NULL_PTR != AccessInfo)
  {
    ...
    /* !LINKSTO Dcm.EB.IOControl.ResetToDefault.SessionNotAllowed.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.ReturnControlToEcu.SessionNotAllowed.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.FreezeCurrentState.SessionNotAllowed.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.ShortTermAdjustment.SessionNotAllowed.TransmitNrc0x31,1 */
  ...
  {
    /* !LINKSTO Dcm433,1, Dcm468,1 */
    /* !LINKSTO Dcm.EB.IOControl.ResetToDefault.ControlAccessNotConfigured.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.ReturnControlToEcu.ControlAccessNotConfigured.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.FreezeCurrentState.ControlAccessNotConfigured.TransmitNrc0x31,1 */
    /* !LINKSTO Dcm.EB.IOControl.ShortTermAdjustment.ControlAccessNotConfigured.TransmitNrc0x31,1 */
  ...
  Dcm_Dsp_ContextPtr context)
{
  ...
  if (TRUE == Dcm_Dsp_DidServices_IsDidAvailableInSecLevel(AccessInfo))
  {
    ...
    if ((NULL_PTR != AccessInfo) && (NULL_PTR != AccessInfo->ModeRuleDidFunction))
    {
  ...
  {
    /* set the NRC */
    /* !LINKSTO Dcm.EB.IOControl.ResetToDefault.SecurityAccessDenied.TransmitNrc0x33,1 */
    /* !LINKSTO Dcm.EB.IOControl.ReturnControlToEcu.SecurityAccessDenied.TransmitNrc0x33,1 */
    /* !LINKSTO Dcm.EB.IOControl.FreezeCurrentState.SecurityAccessDenied.TransmitNrc0x33,1 */
    /* !LINKSTO Dcm.EB.IOControl.ShortTermAdjustment.SecurityAccessDenied.TransmitNrc0x33,1 */
...
#if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U))
  const Std_ReturnType  PidLockStatus = Dcm_Dsp_PidServices_LockService();

  if (PidLockStatus == DCM_E_RESOURCE_LOCKED)
  {
    /* !LINKSTO Dcm.EB.ReadDataByIdentifier.RequestCurrentPowertrainDiagnosticDataAlreadyRunningOnDifferentStack.Postpone,1 */
    /* !LINKSTO Dcm.EB.ReadDataByIdentifier.RequestPowertrainFreezeFrameDataAlreadyRunningOnDifferentStack.Postpone,1 */
    DCM_DSP_CONTEXT_RESULT(context) = DCM_E_PENDING;
  }
  else
#endif /*#if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U))*/
  {
...
#if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U))
    /* If the locking was successful, since the Pid read execute is synchronous, release the lock */
    Dcm_Dsp_PidServices_UnlockService();
#endif /*#if((DCM_DSP_PIDSERVICES_LOCK_MECHANISM_ENABLED == STD_ON) && (DCM_NUM_PID_CFG > 0U))*/

    /* execution path finishes here */
  }
}
#endif /* #if (DCM_DSP_USE_PIDSERVICES == STD_ON) */
...
/* !LINKSTO Dcm.Dsn.IB.DidServices.ReadSingleStaticDid.ObdMidRead,1 */
STATIC FUNC(void, DCM_CODE)
  Dcm_Dsp_DidServices_ReadSingleStaticDid_ObdMidRead (Dcm_Dsp_ContextPtr context)
{
  /* Deviation MISRAC2012-2 */
  ...
  * DCM_E_PEDNING response and therefore the unlocking can happen during the same call/cycle */
  ...
  if (LockStatus == DCM_E_RESOURCE_LOCKED)
  {
     ...
     * NRC RequestCorretlyReceivedResponsePending (0x78) */
    DCM_DSP_CONTEXT_NRC(context) = DCM_E_REQUESTCORRECTLYRECEIVEDRESPONSEPENDING;
...
#endif /* #if (DCM_DSP_MIDSERVICES_USE_LOCKING == STD_ON) */
  {
    ...
    {
      /* Get availability Mid */
      if (Size >= DCM_UDS_DID_AVAILDATALEN)
      {
        Result = Dcm_Dsp_MidServices_GetAvailabilityMid(Mid, BufferPtr);
        if (Result == DCM_E_NOT_OK)
        {
          /* !LINKSTO Dcm.ISO-15031-5_8.6.2_2,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.NoVisibleOBDMIDTIDs.AvailabilityDID.TransmitNRC0x31,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationFalse.DemSupportConfigured.AvailabilityDID.ReturnsNoSupportedOBDMIDs.TransmitNRC0x31,1 */
          DCM_DSP_CONTEXT_NRC(context) = DCM_E_REQUESTOUTOFRANGE;
        }
        else
        {
          DataLength = DCM_UDS_DID_AVAILDATALEN;
        }
      }
      else
      {
    ...
    if (DCM_E_OK == Result)
    {
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.SWCSupportConfigured.GetDTRValue.NonAvailabilityDID.AtleastOneVisibleOBDMIDTID.PositiveResponse,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationFalse.SWCSupportConfigured.AtLeastOneVisibleOBDMIDTID.AvailabilityDID.ResponseBitMapWithSupportedOBDMIDs,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationFalse.DemSupportConfigured.AvailabilityDID.ReturnsSupportedOBDMIDs.ResponseBitMapWithSupportedOBDMIDs,1 */
  ...
  Dcm_Dsp_DidServices_ReadSingleStaticDid_ObdInfoSelect (Dcm_Dsp_ContextPtr context)
{
  ...
  /* The service context is service 0x22, so set the service22 to TRUE */
  ReadSingleStaticDidContextPtr->ReadInfoContext.service22 = TRUE;
#endif

  result = Dcm_Dsp_VinServices_HelperInit(
    InfoId,
  ...
  Dcm_Dsp_ContextPtr context)
{
  ...
  else
  {
    ...
    if (result == DCM_E_OK)
    {
      ...
      const uint8 NumRefDids = Dcm_Dsp_DidServices_GetNumRefDids(Did);

      /* Deviation MISRAC2012-2 */
      DCM_DSP_READSTATICDID_CONTEXT(context).NumRefDids = NumRefDids;
  ...
  Dcm_Dsp_ContextPtr context)
{
  ...
  else /* (result == DCM_E_NOT_OK) */
  {
    ...
    /* !LINKSTO Dcm.EB.ReadDataById.UnusedReferencedDIDs,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReferencedDIDs.DisabledFromCalibrationDid,1 */
    if (RefDidInfoContext->DidInfoContext.ConfigType == DCM_DID_UNCONFIGURED)
    {
      /* Did is not configured, continue with the next Did */
      /* Deviation MISRAC2012-2 */
      DCM_DSP_READSTATICDID_CONTEXT(context).RefDidIdx += 1U;
      /* go back to setup the next Did read */
      DCM_DSP_CONTEXT_NEXT(context) = DCM_DIDSERVICES_READSTATICDID_REFSELECT;
    }
    else if (DCM_DSP_CONTEXT_NRC(context) == DCM_E_REQUESTOUTOFRANGE)
    {
  ...
  Dcm_Dsp_ContextPtr context)
{
  ...
  {
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4F5Range.DIDConfigured.DIDType,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F7Range.DIDConfigured.DIDType,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4F5Range.DIDConfigured.DIDEnabled.DIDType,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDEnabled.DIDType,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.InvokeXxx_ReadData,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.InvokeXxx_ReadData,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.InvokeXxx_ReadData,1 */
...
#if (DCM_DSP_USE_DIDRANGES == STD_ON)
    /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.InvokeXxx_ReadDidData,1 */
...
#if (DCM_DID_AVAILABILITY_CALCULATION == STD_ON)
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.Availability.ResponseBitMapWithSupportedDIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.Availability.ResponseBitMapWithSupportedDIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.Availability.ResponseBitMapWithSupportedDIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.Availability.ResponseBitMapWithSupportedDIDsAndITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.Availability.ResponseBitMapWithSupportedDIDsAndITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.Availability.ResponseBitMapWithSupportedDIDsAndITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.Availability.ResponseBitMapWithSupportedITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.Availability.ResponseBitMapWithSupportedITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.Availability.ResponseBitMapWithSupportedITIDs,1 */
    case DCM_DID_TYPE_AVAILABILITY:
    {
      /* calculate the configured data of an availability range */
      DCM_DSP_CONTEXT_NEXT(context) = DCM_DIDSERVICES_READSINGLESTATICDID_AVAILABILITY_CALCULATION;
    }
    break;
#endif

#if (DCM_DSP_DIDSERVICES_USE_OBDSERVICES == STD_ON)
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.Service01.NonAvailabilityPID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDNotConfigured.Service01_02.NonAvailabilityPID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.Service01.NonAvailabilityPID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DIDNotEnabled.Service01_02.NonAvailabilityPID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.Service01.NonAvailabilityPID,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationFalse.F4Range.DIDConfigured.DisabledByCalibration.Service01_02.NonAvailabilityPID,1 */
    ...
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DIDConfigured.DIDNotEnabled.NonAvailability.InvokeXxx_GetInfotypeValueData,2 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DIDConfigured.DisabledByCalibration.NonAvailability.InvokeXxx_GetInfotypeValueData,2 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DIDNotConfigured.NonAvailability.InvokeXxx_GetInfotypeValueData,2 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DIDNotEnabled.Availability.ResponseBitMapWithSupportedITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDConfigured.DisabledByCalibration.Availability.ResponseBitMapWithSupportedITIDs,1 */
    /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.DcmDspDidAvailabilityCalculationFalse.DIDNotConfigured.Availability.ResponseBitMapWithSupportedITIDs,1 */
  ...
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData)
{
  ...
  uint8 PidIndex;
  /* Deviation TASKING-1 */
  for(PidIndex = 0; PidIndex < DCM_NUM_PID_CFG; PidIndex++)
  {
    P2CONST(Dcm_DspPidConfigType, AUTOMATIC, DCM_CONST) CurPidConfig =
                                                                  &Dcm_DspPidConfig[PidIndex];

    if(DCM_UINT8_IS_BIT_SET(Dcm_DspPidUsed[PidIndex/8U], PidIndex%8U) &&
      ((((Dcm_DspPidBitFieldType)(CurPidConfig->BitField)) & DCM_DSP_SERVICE01_MASK) != 0x00U))
    {
      /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.AvailabilityMixResponse,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.AvailabilityMixResponse,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.AvailabilityMixResponse,1 */
      Std_ReturnType ResultsUpdate = Dcm_OBDSupport_UpdateAvailableInfoWithID(
                                                                  CurPidConfig->PidIdentifier,
                                                                  Pid,
                                                                  AvailabilityData);

      if (ResultsUpdate == DCM_E_OK)
      {
        Result = DCM_E_OK;
      }
    }
  ...
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData)
{
  ...
  /* Deviation TASKING-1 */
  for(DidIndex = Dcm_FirstObdDidConfigIndex; DidIndex < DCM_DSP_DIDSERVICES_NUM_DIDS; DidIndex++)
  {
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.AvailabilityDID.DisabledFromCalibrationDid.IgnoreDIDsFromBitMapResponse,1 */
    if(Dcm_Dsp_DidServices_ValidateDidUsed(DidIndex) == TRUE)
    {
      P2CONST(Dcm_DidConfigType, AUTOMATIC, DCM_CONST) curDidConfig = &Dcm_DidConfig[DidIndex];
      /* Dcm_OBDSupport_UpdateAvailableInfoWithID() works only per ranges of length 0xFF - i.e. from F400 to F4FF, F500 to F5FF, F700 to F7FF
       * First check that the current Did belongs to the same range as the availability one
       * Dcm_OBDSupport_UpdateAvailableInfoWithID will also search in all subsequent availability ranges */
      if(curDidConfig->Did >> 8U == Did >> 8U)
      {
        const uint8 CurrentAvailabilityDidLSB = (uint8)(curDidConfig->Did & DCM_UINT8_MAX);
        const uint8 RequestedAvailabilityDidLSB = (uint8)(Did & DCM_UINT8_MAX);
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.AvailabilityMixResponse,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.AvailabilityMixResponse,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.AvailabilityMixResponse,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.AvailabilityDID,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.AvailabilityDID,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.AvailabilityDID,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDNotConfigured.AvailabilityDID,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDNotEnabled.AvailabilityDID,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.AvailabilityDID,1 */
        Std_ReturnType ResultsUpdate = Dcm_OBDSupport_UpdateAvailableInfoWithID(
                                                                    CurrentAvailabilityDidLSB,
                                                                    RequestedAvailabilityDidLSB,
                                                                    AvailabilityData);
      ...
      {
        /* now search across next ranges of length 0xFF for subsequent configured Dids
         * for availability requests starting with 0xF4 search in F500 to F5FF, F700 to F7FF since the whole F400 to F4FF is already taken care of
         * for availability requests starting with 0xF5 search in F700 to F7FF since the whole F500 to F5FF is already taken care of
         * */
        if(((Did >> 8U == 0xF4U) && ((curDidConfig->Did >> 8U == 0xF5U) || (curDidConfig->Did >> 8U == 0xF7U))) ||
            ((Did >> 8U == 0xF5U) && (curDidConfig->Did >> 8U == 0xF7U)))
        {
          /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4E0.DIDNotConfigured.AvailabilityRangeF5,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4E0.DIDConfigured.DIDNotEnabled.AvailabilityRangeF5,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F4E0.DIDConfigured.DisabledByCalibration.AvailabilityRangeF5,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5E0.DIDNotConfigured.AvailabilityRangeF7,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5E0.DIDConfigured.DIDNotEnabled.AvailabilityRangeF7,1 */
          /* !LINKSTO Dcm.ReadDataById.ReadDataStream.DcmDspDidAvailabilityCalculationTrue.F5E0.DIDConfigured.DisabledByCalibration.AvailabilityRangeF7,1 */
  ...
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData)
{
  ...
  Dcm_DidConfigIdxType DidIndex;
  /* Deviation TASKING-1 */
  for (DidIndex = Dcm_FirstMonitorDidConfigIndex; DidIndex < DCM_DSP_DIDSERVICES_NUM_DIDS; DidIndex++)
  {
    if (Dcm_Dsp_DidServices_ValidateDidUsed(DidIndex) == TRUE)
    {
      P2CONST(Dcm_DidConfigType, AUTOMATIC, DCM_CONST) curDidConfig = &Dcm_DidConfig[DidIndex];
      if (curDidConfig->Did >> 8U == Did >> 8U)
      {
        const uint8 CurrentAvailabilityDidLSB = (uint8)(curDidConfig->Did & DCM_UINT8_MAX);
        const uint8 RequestedAvailabilityDidLSB = (uint8)(Did & DCM_UINT8_MAX);
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDsNotConfigured.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDsNotEnabled.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDsNotConfigured.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDsNotEnabled.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDsNotConfigured.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDsNotEnabled.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsEnabled.NoVisibleOBDMIDTIDs.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsConfigured.OBDMIDTIDsEnabled.AtLeastOneVisibleOBDMIDTID.AvailabilityDID.ResponseBitMapWithSupportedDIDsAndOBDMIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsConfigured.AvailabilityDID.NoSupportedOBDMIDs.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsConfigured.AvailabilityDID.AtLeastOneSupportedOBDMIDs.ResponseBitMapWithSupportedDIDsAndOBDMIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsConfigured.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsConfigured.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsConfigured.AvailabilityDID.ResponseBitMapWithSupportedDIDs,1 */
        Std_ReturnType ResultsUpdate = Dcm_OBDSupport_UpdateAvailableInfoWithID(
                                                                    CurrentAvailabilityDidLSB,
                                                                    RequestedAvailabilityDidLSB,
                                                                    AvailabilityData);
  ...
  P2VAR(uint8, AUTOMATIC, DCM_VAR) AvailabilityData)
{
  ...
  Dcm_DidConfigIdxType DidIndex;
  /* Deviation TASKING-1 */
  for (DidIndex = Dcm_FirstInfoTypeDidConfigIndex; DidIndex < DCM_DSP_DIDSERVICES_NUM_DIDS; DidIndex++)
  {
    if (Dcm_Dsp_DidServices_ValidateDidUsed(DidIndex) == TRUE)
    {
      P2CONST(Dcm_DidConfigType, AUTOMATIC, DCM_CONST) curDidConfig = &Dcm_DidConfig[DidIndex];
...
/* !LINKSTO Dcm.Dsn.IB.DidServices.ReadSingleStaticDid.GetAvailabilityDid,1 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_DidServices_ReadSingleStaticDid_GetAvailabilityDid(
  Dcm_Dsp_ContextPtr context)
{
  /* Deviation MISRAC2012-2 */
  ...
  Dcm_MsgLenType size = BufferCfgPtr->Size - BufferCfgPtr->Occupied;

  Std_ReturnType result = DCM_E_NOT_OK;
  Std_ReturnType AvailabilityDidResult = DCM_E_NOT_OK;

  const uint16 requestedAvailabilityDid = DidInfoPtr->Did;

  if(size < DCM_UDS_DID_AVAILDATALEN)
  {
    /* Buffer is too small for the response data;
       Set the negative response code to DCM_E_RESPONSETOOLONG(0x14U). */
    /* !LINKSTO Dcm.EB.ReadDataById.NRC0x14,1 */
    DCM_DSP_CONTEXT_NRC(context) = DCM_E_RESPONSETOOLONG;
  ...
  else
  {
    P2VAR(uint8, AUTOMATIC, DCM_VAR) availabilityData =
                                                 &(BufferCfgPtr->BufferPtr[BufferCfgPtr->Occupied]);
    size = DCM_UDS_DID_AVAILDATALEN;

    TS_MemSet(availabilityData, 0U, DCM_UDS_DID_AVAILDATALEN);


    if (((requestedAvailabilityDid >= DCM_UDS_READDATASTREAM_F4_RANGE_START) &&
         (requestedAvailabilityDid <= DCM_UDS_READDATASTREAM_F5_RANGE_END)) ||
        ((requestedAvailabilityDid >= DCM_UDS_READDATASTREAM_F7_RANGE_START) &&
         (requestedAvailabilityDid <= DCM_UDS_READDATASTREAM_F7_RANGE_END)))
    {
#if (DCM_NUM_PID_CFG > 0U)
      /* Deviation TASKING-3 */
      if ((requestedAvailabilityDid >= DCM_UDS_READDATASTREAM_F4_RANGE_START) &&
          (requestedAvailabilityDid <= DCM_UDS_READDATASTREAM_F4_RANGE_END))
      {
        /* update the availabilityData based on the configured PIDs */
        result = Dcm_Dsp_DidServices_GetAvailabilityPid(
                    (uint8)(requestedAvailabilityDid & DCM_UINT8_MAX),
                    availabilityData);
      }
#endif /* #if(DCM_NUM_PID_CFG > 0U) */

      /* update the availabilityData based on the configured DIDs */
      AvailabilityDidResult =
        Dcm_Dsp_DidServices_GetAvailabilityObdDid(requestedAvailabilityDid, availabilityData);
    }

    if((requestedAvailabilityDid >= DCM_DID_OBD_MID_LOW_LIMIT) &&
       (requestedAvailabilityDid <= DCM_DID_OBD_MID_UP_LIMIT))
    {
#if (DCM_DSP_USE_MIDSERVICES == STD_ON)
      /* update the availabilityData based on the configured Monitor Ids */
      result = Dcm_Dsp_MidServices_GetAvailabilityMid(
                  (uint8)(requestedAvailabilityDid & DCM_UINT8_MAX),
                  availabilityData);
#endif /* #if (DCM_DSP_USE_MIDSERVICES == STD_ON) */

      /* update the availabilityData based on the configured DIDs */
      AvailabilityDidResult =
        Dcm_Dsp_DidServices_GetAvailabilityMonitorDid(requestedAvailabilityDid, availabilityData);
    }

    if((requestedAvailabilityDid >= DCM_DID_OBD_INFO_LOW_LIMIT) &&
       (requestedAvailabilityDid <= DCM_DID_OBD_INFO_UP_LIMIT))
    {
#if (DCM_DSP_VEHINFO_NUM > 0U)
      /* update the availabilityData based on the configured InfoType Ids */
      result = Dcm_Dsp_VinServices_GetAvailabilityInfoTypeId(
                  (uint8)(requestedAvailabilityDid & DCM_UINT8_MAX),
                  availabilityData);
#endif /* #if (DCM_DSP_VEHINFO_NUM > 0U) */

      /* update the availabilityData based on the configured DIDs */
      AvailabilityDidResult =
        Dcm_Dsp_DidServices_GetAvailabilityInfoTypeDid(requestedAvailabilityDid, availabilityData);
    }

    if (DCM_E_OK == AvailabilityDidResult)
    {
      result = DCM_E_OK;
    }
    ...
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsNotConfigured.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsNotConfigured.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsNotConfigured.FirstAvailabilityPID,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsConfigured.DisabledByCalibration.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsConfigured.DisabledByCalibration.FirstAvailabilityPID,2 */
    /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F400.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsConfigured.DisabledByCalibration.FirstAvailabilityPID,2 */
    if(requestedAvailabilityDid == 0xF400U)
    {
      result = DCM_E_OK;
    }
#endif /* #if (DCM_DSP_USE_SERVICE_0X01 == STD_ON) */

    if (result == DCM_E_OK)
    {
      BufferCfgPtr->Occupied += size;
    }
    else
    {
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDNotEnabled.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DIDNotEnabled.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDNotConfigured.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDNotConfigured.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DIDNotEnabled.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDNotConfigured.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.DIDsNotConfigured.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.DIDsNotEnabled.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsNotConfigured.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsNotEnabled.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsNotConfigured.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsNotEnabled.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.DIDsConfigured.DisabledByCalibration.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.DIDsConfigured.DisabledByCalibration.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsConfigured.DisabledByCalibration.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsConfigured.DisabledByCalibration.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsConfigured.DisabledByCalibration.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsNotConfigured.DIDsConfigured.DisabledByCalibration.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsNotEnabled.DIDsConfigured.DisabledByCalibration.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F4Range.DIDConfigured.DisabledByCalibration.PIDsConfigured.PIDsEnabled.Service02.DIDsConfigured.DisabledByCalibration.AvailabilityPID.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F5Range.DIDConfigured.DisabledByCalibration.DIDsConfigured.DisabledByCalibration.TransmitNRC0x31,2 */
      /* !LINKSTO Dcm.EB.ReadDataById.ReadDataStream.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.F7Range.DIDConfigured.DisabledByCalibration.DIDsConfigured.DisabledByCalibration.TransmitNRC0x31,1 */

      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsNotConfigured.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsNotConfigured.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.DIDsConfigured.DisabledByCalibration.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsNotConfigured.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsNotConfigured.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsConfigured.ITIDsNotEnabled.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsConfigured.ITIDsNotEnabled.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.DIDsConfigured.DisabledByCalibration.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsConfigured.ITIDsNotEnabled.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.OBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsConfigured.ITIDsNotEnabled.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsNotConfigured.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsNotConfigured.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsNotConfigured.DIDsConfigured.DisabledByCalibration.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsNotConfigured.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsNotConfigured.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsConfigured.ITIDsNotEnabled.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DIDNotEnabled.ITIDsConfigured.ITIDsNotEnabled.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDConfigured.DisabledByCalibration.ITIDsConfigured.ITIDsNotEnabled.DIDsConfigured.DisabledByCalibration.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsConfigured.ITIDsNotEnabled.DIDsNotConfigured.Availability.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadVehicleInformation.NonOBDOnUDS.DcmDspDidAvailabilityCalculationTrue.DIDNotConfigured.ITIDsConfigured.ITIDsNotEnabled.DIDsNotEnabled.Availability.TransmitNRC0x31,1 */

      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotConfigured.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotEnabled.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsDisabledByCalibration.OBDMIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsDisabledByCalibration.OBDMIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsDisabledByCalibration.OBDMIDTIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.SWCSupportConfigured.DIDsNotSupported.OBDMIDTIDsEnabled.NoVisibleOBDMIDTIDs.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotSupported.DcmDspDidAvailabilityCalculationTrue.DemSupportConfigured.DIDsNotSupported.AvailabilityDID.NoSupportedOBDMIDs.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDNotConfigured.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DIDNotEnabled.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsNotConfigured.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsNotEnabled.AvailabilityDID.TransmitNRC0x31,1 */
      /* !LINKSTO Dcm.ReadDataById.ReadOBDMIDs.DIDConfigured.DisabledByCalibration.DcmDspDidAvailabilityCalculationTrue.NoOBDMIDSupportConfigured.DIDsDisabledByCalibration.AvailabilityDID.TransmitNRC0x31,1 */

      /* No PIDs/ITIDs or DIDs are configured in the req range;
         Set the negative response code to DCM_E_REQUESTOUTOFRANGE(0x31U). */
      DCM_DSP_CONTEXT_NRC(context) = DCM_E_REQUESTOUTOFRANGE;
...
FUNC(void, DCM_CODE) Dcm_Dsp_DidServices_DynamicDid_Clear(uint16 Did)
{
  ...
  for (DidCfgIdx = 0U; DidCfgIdx < DCM_DSP_DIDSERVICES_NUM_DIDS; ++DidCfgIdx)
  {
    if ((TRUE == Dcm_Dsp_DidServices_ValidateDidUsed(DidCfgIdx)) &&
        ((Dcm_DidConfig[DidCfgIdx].Did == Did) || (Did == DCM_DDDID_CLEAR_ALL)))
    {
...
/* !LINKSTO Dcm.DynamicallyDefineDataIdentifier.DcmDDDIDStorage.FALSE,1 */
  ...
  for (DidCfgIdx = DCM_DDDID_INIT_START_INDEX; DidCfgIdx <= DCM_DDDID_INIT_STOP_INDEX; DidCfgIdx++)
  {
    ...
    if (Dcm_DidConfig[DidCfgIdx].DDDidSrcTableIdx != DCM_DDDIDSRCTABLEIDX_INVALID)
    {
      ...
      /* Deviation TASKING-2 <+8> */
      /* Deviation TASKING-3 <+7>*/
