 ...
 *  \return none
 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsl_TxConnectionInitSingleTxConnection(
  Dcm_TxConnectionIndexType TxConnectionIndex
);
 ...
 */
STATIC FUNC(Std_ReturnType, DCM_CODE) Dcm_Dsl_ProcessRetryInformation(
 ...
 *  \return none
 */
STATIC FUNC (void, DCM_CODE) Dcm_Dsl_ConfirmTransmissionToRequester(
  Dcm_BufferUserType Requester,
  Dcm_TxResultType Result,
  Dcm_BufferUserType TxConnectionId
);

/** \brief Common function called from the ASR_R21-11/ASR_403 Dcm_CopyTxData() API
 *
 ...
 *         copied.
 */
STATIC FUNC(BufReq_ReturnType, DCM_CODE) Dcm_Dsl_CopyTxDataCommon(
...
/** \brief Common function called from the ASR_R21-11/ASR_403 Dcm_TpTxConfirmation() API
 *
 * \param[in] DcmTxPduId ID of DCM I-PDU that has been transmitted.
 *
 * \param[in] Result Result of the N-PDU transmission.
 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsl_TpTxConfirmationCommon(
  PduIdType DcmTxPduId,
  Dcm_TxResultType Result
);

/** \brief Common function called from the ASR_R21-11/ASR_403 Dcm_TxConfirmation() API
 *
 * \param[in] DcmTxPduId ID of DCM I-PDU that has been transmitted.
 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsl_TxConfirmationCommon(
  PduIdType DcmTxPduId
);

/** \brief Wrapper function for calling PduR_DcmTransmit() API based on ASR version ASR_R21-11/ASR_403
 *
 * \param[in]    TxPduId      Id of DCM I-PDU that has been transmitted.
 * \param[inout] TxPduInfoPtr Pointer to the TxPduInfo. containing information about the TxPduId
                              necessary in the PduR_DcmTransmit call
 */
STATIC FUNC (Std_ReturnType, DCM_CODE) Dcm_Dsl_CommunicationServices_TxConnection_Transmit(
  PduIdType TxPduId,
  P2VAR(PduInfoType, AUTOMATIC, EBSTUBS_APPL_CONST) TxPduInfoPtr
);
...
/* !LINKSTO Dcm.Dsn.IB.LowerLayerInterfaces.DcmPdurInterfaceVersionAutosarR21_11.Dcm_CopyTxData,1 */
...
)
{
  ...
  DBG_DCM_COPYTXDATA_ENTRY(id,info,retry,availableDataPtr);

  DataCopyResult = Dcm_Dsl_CopyTxDataCommon(id,info,retry,availableDataPtr);

  DBG_DCM_COPYTXDATA_EXIT(DataCopyResult,id,info,retry,availableDataPtr);

  return DataCopyResult;
}
#else /* #if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11) */
/* !LINKSTO Dcm.Dsn.IB.LowerLayerInterfaces.DcmPdurInterfaceVersionAutosar403.Dcm_CopyTxData,1 */
FUNC(BufReq_ReturnType, DCM_CODE) Dcm_CopyTxData(
  PduIdType DcmTxPduId,
...
{
  BufReq_ReturnType DataCopyResult = BUFREQ_E_NOT_OK;
  P2CONST(PduInfoType, AUTOMATIC, DCM_APPL_DATA) info = PduInfoPtr;
  P2CONST(RetryInfoType, AUTOMATIC, DCM_APPL_DATA) retry = RetryInfoPtr;

  DBG_DCM_COPYTXDATA_ENTRY(DcmTxPduId,PduInfoPtr,RetryInfoPtr,TxDataCntPtr);

  DataCopyResult = Dcm_Dsl_CopyTxDataCommon(DcmTxPduId,info,retry,TxDataCntPtr);
...
{
  DBG_DCM_TXCONFIRMATION_ENTRY(DcmTxPduId,result);

  TS_PARAM_UNUSED(result);
  Dcm_Dsl_TxConfirmationCommon(DcmTxPduId);

  DBG_DCM_TXCONFIRMATION_EXIT(DcmTxPduId,result);
}
#else /* #if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11) */
FUNC(void, DCM_CODE) Dcm_TxConfirmation(
  PduIdType DcmTxPduId
  ...
  Dcm_BufferUserType TxConnectionId)
{
  ...
  for (TransmissionIndex = 0;
      ...
      TransmissionIndex++)
  {
    if (0x00U != Dcm_PeriodicTransmissionConfig[TransmissionIndex].NumberOfPeriodicConnections)
    {
...
#if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11)
/* !LINKSTO Dcm.Dsn.IB.LowerLayerInterfaces.DcmPdurInterfaceVersionAutosarR21_11.Dcm_TpTxConfirmation,1 */
FUNC(void, DCM_CODE) Dcm_TpTxConfirmation(
  PduIdType id,
  Std_ReturnType result
)
{
  Dcm_TxResultType TxResult = DCM_TX_FAILED;

  DBG_DCM_TPTXCONFIRMATION_ENTRY(id,result);

  if (result == E_OK)
  {
    TxResult = DCM_TX_OK;
  }
  Dcm_Dsl_TpTxConfirmationCommon(id,TxResult);

  DBG_DCM_TPTXCONFIRMATION_EXIT(id,result);
}
#else /* #if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11) */
/* !LINKSTO Dcm.Dsn.IB.LowerLayerInterfaces.DcmPdurInterfaceVersionAutosar403.Dcm_TpTxConfirmation,1 */
FUNC(void, DCM_CODE) Dcm_TpTxConfirmation(
  PduIdType DcmTxPduId,
...
)
{
  ...
  {
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.PduRInterface.Dcm_TpTxConfirmation.InvalidDcmTxPduIdInvalidResult.ReportDETError,2 */
...
#endif /* #if (DCM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    Dcm_Dsl_TpTxConfirmationCommon(DcmTxPduId,TxResult);
  }
...
#endif
  Dcm_MainConnectionIndexType ConnectionIndex;
    ...
    if (TRUE == Dcm_MainConnectionConfig[ConnectionIndex].MetaDataIsConfigured)
    {
      ...
      else
      {
        ...
        if ( (DCM_INVALID_PERIODIC_TRANSMISSION > PeriodicTransmissionId) &&
             (0x00U != Dcm_PeriodicTransmissionConfig[PeriodicTransmissionId].NumberOfPeriodicConnections) )
        {
  ...
  if (DCM_COMM_OPERATION_ENABLED == ComMChnTxState)
  {
    ...
    if(TRUE == GenericConnIdFound)
    {
      ...
      if (E_OK != SetMetaDataInfoResult)
      {
       ...
       /* !LINKSTO Dcm.EB.LowerLayerInterfaces.Response.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.Response.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel.ReturnsNotE_OK.ReportDETError,1 */
        /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel.ReturnsNotE_OK.ReportDETError,1 */
    ...
    /* !LINKSTO SWS_Dcm_01101_TransmissionThroughPduR,1 */
     ...
     (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_403) && \
               ...
               (DCM_HAS_PERIODIC_RESPONSE_TYPE2 == STD_ON) && (DCM_NUM_PERIODIC_TRANSMISSIONS > 0U)) */
    {
      ...
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.AcceptedForProcessing.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRREnabled.TransmitBRR,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.AcceptedForProcessing.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRREnabled.TransmitBRR,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.AcceptedForProcessing.UDSRequestUDSFinishedOnDifferentStack.LowerPriority.BRREnabled.TransmitBRR,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.AcceptedForProcessing.UDSRequestUDSFinishedOnDifferentStack.EqualPriority.BRREnabled.TransmitBRR,1 */
      ...
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.UDSRequest.HigherPriority.AcceptedForProcessing.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.RequestedProtocolNotStarted.StartProtocol.ReturnsNotE_OK.TransmitNRC0x22,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.UDSRequest.HigherPriority.AcceptedForProcessing.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.StartProtocol.ReturnsUnsupportedCode.TransmitNRC0x22,1 */
      ...
      PduRTransmitResult = Dcm_Dsl_CommunicationServices_TxConnection_Transmit(
                             TxPduId, &(Dcm_TxConnections[TxConnectionIndex].TxPduInfo));
    }
...
{
  Std_ReturnType PduRTransmitResult = E_NOT_OK;
#if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11)
  P2CONST(PduInfoType, AUTOMATIC, DCM_CONST) LocalTxPduInfoPtr = TxPduInfoPtr;

  /* !LINKSTO Dcm.MandatoryInterfaces,1 */
  PduRTransmitResult = PduR_DcmTransmit(TxPduId, LocalTxPduInfoPtr);
#else /* #if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11) */
  PduRTransmitResult = PduR_DcmTransmit(TxPduId, TxPduInfoPtr);
#endif /* #if (DCM_PDUR_INTERFACE_VERSION == DCM_PDUR_INTERFACE_AUTOSAR_R21_11) */
  return PduRTransmitResult;
}
