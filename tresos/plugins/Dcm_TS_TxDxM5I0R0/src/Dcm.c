...
/* !LINKSTO Dcm.Dsn.File.Dcm.Impl,1 */
  ...
  *
  *    Reason:
  *    The type for pointer to uint8 used by the RTE has a different name than the name used
  *    in the function definition. Both names have the same type definition, to uint8.
  *
  */
...
STATIC FUNC(void, DCM_CODE) Dcm_Internal_ProcessAsynchronousProtocolCancellation(
  Dcm_ProtocolIndexType ProtocolIndex
    ...
    (DCM_DSP_USE_SERVICE_0X24 == STD_ON)
  ...
  P2VAR(Dcm_ProtocolType, AUTOMATIC, DCM_APPL_DATA) ActiveProtocol)
{
...
#endif /* DCM_DEV_ERROR_DETECT == STD_ON */
  {
    ...
    SchM_Enter_Dcm_SCHM_DCM_EXCLUSIVE_AREA_0();
    {
      ...
      retVal = Dcm_Dsl_Supervisor_GetLatestExternalUDSProtocolConfig(&CurProtocolConfig, Dcm_StackContextIndex[0U]);
...
FUNC(Std_ReturnType, DCM_CODE) Dcm_HardResetModeEntry(void)
{
  ...
  {
    /* get Hsm information */
    CONSTP2VAR(Dcm_HsmInfoType, AUTOMATIC, DCM_VAR) curHsmInfo = Dcm_Dsp_GetCurrentHsmInfo(DCM_SID_ECU_RESET);
...
FUNC(Std_ReturnType, DCM_CODE) Dcm_BootloaderResetModeEntry(void)
{
  ...
  {
    /* get Hsm information */
    CONSTP2VAR(Dcm_HsmInfoType, AUTOMATIC, DCM_VAR) curHsmInfo = Dcm_Dsp_GetCurrentHsmInfo(DCM_SID_SESSION_CONTROL);
    /* Update the confirmed Reset Mode */
...
#if (DCM_DSP_USE_SERVICE_0X24 == STD_ON)
  Dcm_Dsp_ReadScalingDataByIdentifier_Init();
  ...
  P2CONST(Dcm_ConfigType, AUTOMATIC, DCM_APPL_CONST) ConfigPtr)
{
...
#endif /* DCM_DEV_ERROR_DETECT */
  {
    ...
    Dcm_Dsl_RoeServices_Init();
      ...
      (DCM_DSP_USE_SERVICE_0X3D == STD_ON) ||                                 \
      (DCM_DSP_USE_SERVICE_0X34 == STD_ON)) &&                                \
     ((DCM_MAX_NUM_READ_RANGES != 0U) || (DCM_MAX_NUM_WRITE_RANGES != 0U)) && \
...
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_Init(void)
{
...
#if (DCM_DSP_USE_SERVICE_0X29 == STD_ON)
    Dcm_Dsp_Authentication_Init();
#endif /* #if (DCM_DSP_USE_SERVICE_0X29 == STD_ON) */

#if (DCM_AUTHENTICATION_CONNECTION == STD_ON)
    Dcm_Authentication_Init();
#endif /* #if (DCM_AUTHENTICATION_CONNECTION == STD_ON) */
...
#if (DCM_DSP_USE_SERVICE_0X14 == STD_ON)
  Dcm_DspInternal_ClearDiagnosticInformation_Init();
#endif

#if ((DCM_DSP_USE_SERVICE_0X19 == STD_ON) || \
     (DCM_DSP_USE_SERVICE_0XAF == STD_ON))
  Dcm_DspInternal_ReadDTCInformation_Init();
#endif
  ...
  Dcm_Dsp_EmissionRelatedService_Init();
#endif
...
STATIC FUNC(void, DCM_CODE) Dcm_MainFunction_Part1(void)
{
  ...
  Dcm_Dsl_DiagnosticSessionHandler_StartOfMainFunctionCycle();
...
/* !LINKSTO Dcm.ReadDataByPeriodicIdentifier.Dsn.SchedInvocation,1 */
#if (DCM_DSP_USE_SERVICE_0X2A == STD_ON)
...
#if (DCM_AUTHENTICATION_CONNECTION == STD_ON)
  Dcm_AuthenticationHandler_MainFunction();
#endif /* #if (DCM_AUTHENTICATION_CONNECTION == STD_ON) */
