  ...
  )
{
  ...
  if ((Direction == DCM_ENDIANNESSINTERPRETATION_COPY_DATA_FROM_IN_BUFFER) &&
      (Endianness != DCM_OPAQUE_ENDIAN) &&
       ((SizeOfDataType > DataLength) || (((DataLength%SizeOfDataType) != 0x00U) && (DCM_IS_ARRAY_TYPE(DataType)))) &&
  ...
  for (DataElementsIndex=0U; DataElementsIndex<DataArraySize; DataElementsIndex++)
  {
    ...
    {
      /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.StopAtTypeLength.USE_DATA_SENDER_RECEIVER,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.StopAtTypeLength.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
    ...
    {
      /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.StopAtSignalLength.USE_DATA_SENDER_RECEIVER,1 */
      /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.StopAtSignalLength.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
    ...
    if (Direction == DCM_ENDIANNESSINTERPRETATION_COPY_DATA_TO_OUT_BUFFER)
    {
      ...
      {
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint8Array.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint16Array.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint32Array.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint8Array.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint16Array.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint32Array.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint8Array.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint16Array.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint32Array.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint8Array.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint16Array.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint32Array.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
      ...
      {
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint8Array.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint16Array.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint32Array.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint8Array.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint16Array.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint32Array.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint8Array.Opaque.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint16Array.Opaque.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint32Array.Opaque.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint8Array.Opaque.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint16Array.Opaque.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint32Array.Opaque.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint8Array.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint16Array.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint32Array.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint8Array.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint16Array.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint32Array.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint8Array.Opaque.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint16Array.Opaque.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.uint32Array.Opaque.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint8Array.Opaque.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint16Array.Opaque.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.sint32Array.Opaque.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
...
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.LittleEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.BigEndian.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.OpaqueOnLittleEndianCPU.USE_DATA_SENDER_RECEIVER,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.LittleEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.BigEndian.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.OpaqueOnLittleEndianCPU.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
        ...
        {
          /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.OpaqueOnBigEndianCPU.USE_DATA_SENDER_RECEIVER,1 */
          /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Start.OpaqueOnBigEndianCPU.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
          SourceDataPosition = (uint16)(DataElementsIndex*SizeOfDataType);
        }
#endif /*(CPU_BYTE_ORDER == LOW_BYTE_FIRST)*/
      }
  ...
  P2VAR(uint16, AUTOMATIC, DCM_VAR) DataArraySize)
{
  ...
  uint16 DataArrayLengthInBytes = (uint16)DCM_GET_BYTES(DataLength);
