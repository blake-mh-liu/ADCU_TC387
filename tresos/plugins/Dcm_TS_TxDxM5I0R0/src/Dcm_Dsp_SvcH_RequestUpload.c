  ...
  P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_VAR) pMsgContext)
{
  ...
  if (DCM_E_DONE != ServiceProcessStatus)
  {
    ...
    /* !LINKSTO Dcm.EB.0x35.AddressAndLengthFormatIdentifier.OutOfRangeAdressFormat,1 */
    /* !LINKSTO Dcm.EB.0x35.AddressAndLengthFormatIdentifier.OutOfRangeLengthFormat,1 */
