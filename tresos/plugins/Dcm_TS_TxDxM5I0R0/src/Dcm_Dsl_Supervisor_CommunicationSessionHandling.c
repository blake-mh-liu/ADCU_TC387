...
#include <Dcm_Authentication.h>                                /* Dcm Authentication header file */
#endif
/*===========================[macro definitions]=================================================*/
...
#if (DCM_AUTHENTICATION_IDLECONNECTIONTIMER == STD_ON)
STATIC FUNC (void, DCM_CODE) Dcm_Dsl_Supervisor_CommunicationSessionHandling_CheckIdleConnectionTimerStart(
  Dcm_BufferUserType RxConnectionId
);
STATIC FUNC (void, DCM_CODE) Dcm_Dsl_Supervisor_CommunicationSessionHandling_CheckIdleConnectionTimerStop(
  Dcm_BufferUserType RxConnectionId
);
...
#if (DCM_AUTHENTICATION_IDLECONNECTIONTIMER == STD_ON)
    Dcm_Dsl_Supervisor_CommunicationSessionHandling_CheckIdleConnectionTimerStop(RxConnectionId);
#endif /* #if (DCM_AUTHENTICATION_IDLECONNECTIONTIMER == STD_ON)*/
  }
}
...
#if (DCM_AUTHENTICATION_IDLECONNECTIONTIMER == STD_ON)
  /* See if the Authentication IdleConnectionTimer needs to be started. */
  Dcm_Dsl_Supervisor_CommunicationSessionHandling_CheckIdleConnectionTimerStart(RxConnectionId);
#endif /* #if (DCM_AUTHENTICATION_IDLECONNECTIONTIMER == STD_ON) */
}
...
#if (DCM_AUTHENTICATION_IDLECONNECTIONTIMER == STD_ON)
/* !LINKSTO Dcm.Dsn.IB.Supervisor.CommunicationSessionHandling.CheckIdleConnectionTimerStart,1 */
STATIC FUNC (void, DCM_CODE) Dcm_Dsl_Supervisor_CommunicationSessionHandling_CheckIdleConnectionTimerStart(
  Dcm_BufferUserType RxConnectionId
)
{
  uint16_least RxConnectionIndexLoop;
  boolean CommunicationSessionIsActive = FALSE;

  /* Get the MainConnection which changed the session to non-default */
  Dcm_MainConnectionIndexType MainConnectionIndexNonDefault =
    Dcm_Dsl_DiagnosticSessionHandler_GetNonDefaultSessionMainConnection();

  /* Get the MainConnection for which IdleConnectionTimer shall be checked. */
  Dcm_MainConnectionIndexType MainConnectionIndex =
    Dcm_RxPduIdConfig[DCM_RX_CONNECTION_INDEX_FROM_ID(RxConnectionId)].MainConnectionIndex;

  /* Get AuthenticationConnectionIndex or invalid value DCM_NUM_MAIN_CONNECTIONS. */
  Dcm_AuthenticationConnectionIndexType AuthenticationConnectionIndex =
      Dcm_Authentication_GetAuthenticationConnectionIndex(MainConnectionIndex);

  /* Skip MainConnection which does not support authentication, i.e. is not referenced in authentication connection table.
     Skip MainConnection which changed session to non-default session, if Dcm is in a non-default session. */
  if ((AuthenticationConnectionIndex != DCM_NUM_MAIN_CONNECTIONS) &&
      (MainConnectionIndex != MainConnectionIndexNonDefault) &&
      (DCM_COMMUNICATION_SESSION_IDLE == Dcm_CommunicationSessionState[DCM_RX_CONNECTION_INDEX_FROM_ID(RxConnectionId)]))
  {

    /* Check that all RxConnection which belong to MainConnection are IDLE */
    for (RxConnectionIndexLoop = 0U;
         RxConnectionIndexLoop < DCM_NUM_RX_CONNECTIONS;
         RxConnectionIndexLoop ++)
    {
      if ((MainConnectionIndex == Dcm_RxPduIdConfig[RxConnectionIndexLoop].MainConnectionIndex) &&
          (DCM_COMMUNICATION_SESSION_IDLE != Dcm_CommunicationSessionState[RxConnectionIndexLoop])
         )
      {
        CommunicationSessionIsActive = TRUE;
        break;
    ...
    if (CommunicationSessionIsActive == FALSE)
    {
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.UnsuccessfulReception.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.UnsuccessfulReception.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.WrongSizeReception.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.WrongSizeReception.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ImmediateApplicationRequest.ConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ImmediateApplicationRequest.ConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.DelayedApplicationRequest.ConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.DelayedApplicationRequest.ConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.PotentialConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.PotentialConcurrentTesterPresent.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.CancelledReception.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.CancelledReception.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.NoComMode.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.NoComMode.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.BusyMainConnection.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.BusyMainConnection.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.BusyProtocol.NoBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.BusyProtocol.NoBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.SuppressedResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.SuppressedResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProcessingComplete.ManufacturerAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProcessingComplete.ManufacturerAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProcessingComplete.SupplierAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProcessingComplete.SupplierAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProcessingComplete.TxBufferBusy.NoBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProcessingComplete.TxBufferBusy.NoBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.SuppressedResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.SuppressedResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProcessingComplete.ManufacturerAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProcessingComplete.ManufacturerAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProcessingComplete.SupplierAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProcessingComplete.SupplierAbortWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProcessingComplete.TxBufferBusy.NoBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProcessingComplete.TxBufferBusy.NoBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProcessingComplete.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProcessingComplete.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProcessingComplete.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProcessingComplete.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.StartOfReceptionBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.StartOfReceptionBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.RxBufferBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.RxBufferBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.RxIndicationBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.RxIndicationBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.TxBufferBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.TxBufferBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.TxBufferBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.TxBufferBRR.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProtocolPreemptionFailed.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProtocolPreemptionFailed.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProtocolPreemptionFailed.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProtocolPreemptionFailed.TxConfirmation.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProcessingComplete.ProcessingCancelled.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProcessingComplete.ProcessingCancelled.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProcessingComplete.ProcessingCancelled.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProcessingComplete.ProcessingCancelled.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRRDisabled.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRRDisabled.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.External.ProtocolPreemptionFailedWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProtocolPreemptionFailedWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ApplicationRequest.ProtocolPreemptionFailedWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ApplicationRequest.ProtocolPreemptionFailedWithoutResponse.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.External.ProtocolOfHigherPritorityCurrent.NoBRR.Restart,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NotIdle.NonDefaultSession.UDSService0x10.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NotIdle.NonDefaultSession.ResetToDefaultSessionAPI.StartIdleConnectionTimer,1 */
      /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NotIdle.NonDefaultSession.ProtocolPreemption.StartIdleConnectionTimer,1 */ 

      (void)Dcm_AuthenticationHandler_IdleConnectionTimerStart(AuthenticationConnectionIndex);
    }
  }
}

/* !LINKSTO Dcm.Dsn.IB.Supervisor.CommunicationSessionHandling.CheckIdleConnectionTimerStop,1 */
STATIC FUNC (void, DCM_CODE) Dcm_Dsl_Supervisor_CommunicationSessionHandling_CheckIdleConnectionTimerStop(
  Dcm_BufferUserType RxConnectionId
)
{
  /* Get MainConnection on which IdleConnectionTimer shall be checked. */
  Dcm_MainConnectionIndexType MainConnectionIndex =
    Dcm_RxPduIdConfig[DCM_RX_CONNECTION_INDEX_FROM_ID(RxConnectionId)].MainConnectionIndex;
  ...
  /* Skip MainConnection which does not support authentication, i.e. is not referenced in authentication configuration.
     Skip MainConnection which changed session to non-default session, if Dcm is in a non-default session. */
  if ((AuthenticationConnectionIndex != DCM_NUM_MAIN_CONNECTIONS) &&
      (MainConnectionIndexNonDefault != MainConnectionIndex))
  {
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ExternalRequestReception.NotTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ExternalRequestReception.NotTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ImmediateApplicationRequest.NotTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ImmediateApplicationRequest.NotTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.DelayedApplicationRequest.NotTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.DelayedApplicationRequest.NotTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ExternalRequestReception.PotentialTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ExternalRequestReception.PotentialTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.ImmediateApplicationRequest.PotentialTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.ImmediateApplicationRequest.PotentialTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.DefaultSession.DelayedApplicationRequest.PotentialTesterPresent.StopIdleConnectionTimer,1 */
    /* !LINKSTO Dcm.EB.AuthenticationStateHandling.Authenticated.NonDefaultSession.DelayedApplicationRequest.PotentialTesterPresent.StopIdleConnectionTimer,1 */
