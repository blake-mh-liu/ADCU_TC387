  ...
  PduIdType RxPduIdx)
{
  ...
  {
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.DcmGenericConnectionUsage.GetMetaDataTargetAddr,2 */
    if(DCM_PHYSICAL_ADDRESSING == Dcm_RxPduIdConfig[RxPduIdx].AddressingType)
    {
  ...
  Dcm_PduInfo[GenericConnIdx].RxPduIdx = RxPduIdx;
  ...
  P2VAR(PduInfoType, AUTOMATIC, EBSTUBS_APPL_CONST) PduInfoPtr)
{
  ...
  const PduIdType RxPduIdx = Dcm_PduInfo[GenericConIdx].RxPduIdx;
  const Dcm_MainConnectionIndexType MainConnIdx = Dcm_RxPduIdConfig[RxPduIdx].MainConnectionIndex;
  const Dcm_ProtocolIndexType ProtocolIndex = Dcm_MainConnectionConfig[MainConnIdx].ProtocolIndex;
  ...
  if(DCM_PHYSICAL_ADDRESSING == Dcm_RxPduIdConfig[RxPduIdx].AddressingType)
  {
    ...
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.Response.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel,2 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel,2 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel,2 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel,2 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.PhysicalChannel,2 */
  ...
  {
    DCM_PRECONDITION_ASSERT((DCM_FUNCTIONAL_TYPE == Dcm_RxPduIdConfig[RxPduIdx].AddressingType), DCM_INTERNAL_API_ID);

    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.Response.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel,1 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel,1 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2ROE.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel,1 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE1Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel,1 */
    /* !LINKSTO Dcm.EB.LowerLayerInterfaces.TYPE2Periodic.DcmGenericConnectionUsage.SetMetaDataSourceAddr.FunctionalChannel,1 */
    ReturnFromEcuC = EcuC_SetMetaDataSourceAddr(EcuPduId,
                                                PduInfoPtr,
                                                Dcm_ProtocolConfig[ProtocolIndex].EcuAddress);
  }
