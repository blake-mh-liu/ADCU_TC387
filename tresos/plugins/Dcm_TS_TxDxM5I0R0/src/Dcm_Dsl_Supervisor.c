 ...
 *    Reason:
 *    Condition depends on preprocessor settings that is configuration specific. Under certain configurations
 *    only one case is used from the switch statement. This does not pose any functional risk.
 */
...
)
{
  Dcm_BufferUserType ProtocolId =
    DCM_PROTOCOL_ID_FROM_INDEX(Dcm_Dsl_Supervisor_ProtocolHandling_GetLatestExternalUDSProtocolIndex(StackNumber));

  return ProtocolId;
}

FUNC(boolean, DCM_CODE) Dcm_Dsl_Supervisor_CheckIfExternalUDSProtocolExist(
  void
)
{
  boolean ExternalUDSProtocolExist = Dcm_Dsl_Supervisor_ProtocolHandling_CheckIfExternalUDSProtocolExist();
...
{
  Dcm_MainConnectionIndexType MainConnectionIndex = 0;
...
)
{
  ...
  Dcm_SessionSwitchPermissionType IsSessionClearedToSwitch =
    Dcm_Dsl_Supervisor_ProtocolHandling_IsSessionClearedToSwitch(NewSession, ProcessingProtocolIdx);
...
)
{
  ...
  switch (ReceptionArbitrationResult)
  {
    ...
    case DCM_SUPERVISOR_ARBITRATION_REJECT_PRIORITY:
    {
      ...
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRREnabled.AcceptRx,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRREnabled.AcceptRx,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSFinishedOnDifferentStack.LowerPriority.BRREnabled.AcceptRx,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSFinishedOnDifferentStack.EqualPriority.BRREnabled.AcceptRx,1 */
      ...
      else
      {
        ...
        if (TRUE == PotentialTesterPresent)
        {
          ...
          /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRRDisabled.PotentialConcurrentTesterPresent.AcceptRx,1 */
          /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRRDisabled.PotentialConcurrentTesterPresent.AcceptRx,1 */
        ...
        else
        {
          ...
          /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRRDisabled.NotConcurrentTesterPresentSize.RejectRx,1 */
          /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRRDisabled.NotConcurrentTesterPresentSize.RejectRx,1 */
          /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRRDisabled.NotConcurrentTesterPresentFunctional.RejectRx,1 */
          /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRRDisabled.NotConcurrentTesterPresentFunctional.RejectRx,1 */
    ...
    case DCM_SUPERVISOR_ARBITRATION_ACCEPT:
      ...
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.UDSRequestUDSAlreadyRunningOnDifferentStack.DefaultSession.AcceptRx,1 */
      RxPermission = DCM_RX_ACCEPT;
      break;
...
)
{
  ...
  */
  ...
  /*
  5. For non-default session:
       After all this is done, if session is non-default, seek out all UDS Protocols
       and cancel them. Do this without changing the CurrentProtocol status of the
       cancelled Protocols. Cancel both Running and Presumptive UDS Protocols.
  */

  if (DCM_DEFAULT_SESSION != CurrentSession)
  {
    Dcm_Dsl_Supervisor_ProtocolHandling_CancelUDSProtocolsInNonDefaultSession(ProcessingProtocolIndex);
    /* Enqueue a reset of the diag session only if there will be no protocol preemption
       on Stack and the request is for an OBD Protocol.
       Otherwise preemption handles this anyway. */
    if ((FALSE == PreemptionNecessary) && (DCM_PROTOCOL_OBD_GROUP == ProcessingProtocolGroup))
    {
...
)
{
  ...
  switch (ReceptionArbitrationResult)
  {
    ...
    case DCM_SUPERVISOR_ARBITRATION_REJECT_PRIORITY:
      ...
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.AcceptedForProcessing.UDSRequestUDSAlreadyRunningOnDifferentStack.LowerPriority.BRRDisabled.Discard,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.RxIndication.ResultNTFRSLT_OK.NonDefaultSession.AcceptedForProcessing.UDSRequestUDSAlreadyRunningOnDifferentStack.EqualPriority.BRRDisabled.Discard,1 */
    ...
    case DCM_SUPERVISOR_ARBITRATION_ACCEPT:
      ...
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.ExternalUDS.HigherPriority.AcceptRx,1 */
      /* !LINKSTO Dcm.EB.DiagnosticProtocolHandling.StartOfReception.NonDefaultSession.Type2PeriodicRunningOnDifferentStack.AcceptRx,1 */
