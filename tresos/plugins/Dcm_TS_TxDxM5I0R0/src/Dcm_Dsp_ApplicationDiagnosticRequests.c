...
FUNC(void, DCM_CODE) Dcm_Dsl_ApplicationDiagnosticRequests_MainFunction(void)
{
  ...
  if(Dcm_ReattemptRequest == TRUE)
  {
    ...
    else
    {
      ...
      /* !LINKSTO Dcm.EB.ApplicationDiagnosticRequests.Enabled.EnqueuedRequest.OBDRequestOBDAlreadyRunning.Repoll, 1 */
      /* !LINKSTO Dcm.EB.ApplicationDiagnosticRequests.Enabled.EnqueuedRequest.NonDefaultSession.UDSRequestUDSFinishedOnDifferentStack.RequestedProtocol.EqualPriority.Repoll, 1 */
      /* !LINKSTO Dcm.EB.ApplicationDiagnosticRequests.Enabled.EnqueuedRequest.NonDefaultSession.UDSRequestUDSFinishedOnDifferentStack.RequestedProtocol.LowerPriority.Repoll, 1 */
      /* !LINKSTO Dcm.EB.ApplicationDiagnosticRequests.Enabled.EnqueuedRequest.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.RequestedProtocol.EqualPriority.Repoll, 1 */
      /* !LINKSTO Dcm.EB.ApplicationDiagnosticRequests.Enabled.EnqueuedRequest.NonDefaultSession.UDSRequestUDSAlreadyRunningOnDifferentStack.RequestedProtocol.LowerPriority.Repoll, 1 */
