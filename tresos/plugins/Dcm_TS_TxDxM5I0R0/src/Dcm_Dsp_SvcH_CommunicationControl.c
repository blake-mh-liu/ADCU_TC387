 ...
 ** \retval void
 */
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_CommunicationControl_ResetOnSessionChange(
...
FUNC(void, DCM_CODE) Dcm_Dsp_CommunicationControl_ProcessModeRules(void)
{
  ...
  (void)Dcm_Dsp_CommunicationControl_ModeRuleFunction(&Nrc);
  ...
  Dcm_SesCtrlType NewSession)
{
  ...
  Dcm_ProtocolIndexType ProtocolIdx = Dcm_Dsl_DiagnosticSessionHandler_GetNonDefaultSessionProtocolIndex();
  DBG_DCM_DSP_COMMUNICATIONCONTROL_RESETONSESSIONCHANGE_ENTRY(NewSession);
