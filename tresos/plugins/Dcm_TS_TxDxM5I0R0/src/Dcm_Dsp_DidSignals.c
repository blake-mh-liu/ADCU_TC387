...
/** \brief Pointer to Dcm_VariableFunctionPointerRecordType */
typedef P2CONST(Dcm_VariableFunctionPointerRecordType, TYPEDEF, DCM_CONST)
  Dcm_VariableFunctionPointerRecordPointerType;
...
STATIC FUNC(void, DCM_CODE) Dcm_Dsp_DidSignals_GetDidDataAsyncFuncPointers(
  P2VAR(Dcm_DidDataType, AUTOMATIC, DCM_VAR) DidDataPtr,
  uint16 DidDataIndex);
STATIC FUNC(Dcm_VariableFunctionPointerRecordPointerType, DCM_CODE) Dcm_Dsp_DidSignals_GetReadWriteDidDataAsyncFuncPointers(
  P2VAR(Dcm_DidDataType, AUTOMATIC, DCM_VAR) DidDataPtr,
  uint16 DidDataIndex,
  P2CONST(Dcm_VariableFunctionPointerRecordType, AUTOMATIC, DCM_CONST) DataCfg);
STATIC FUNC(Dcm_VariableFunctionPointerRecordPointerType, DCM_CODE) Dcm_Dsp_DidSignals_GetIOControlDidDataAsyncFuncPointers(
  P2VAR(Dcm_DidDataType, AUTOMATIC, DCM_VAR) DidDataPtr,
  uint16 DidDataIndex,
  P2CONST(Dcm_VariableFunctionPointerRecordType, AUTOMATIC, DCM_CONST) DataCfg);
...
#if (DCM_DSP_OBD_SIGNALBUFFER == STD_ON)

/** \brief Buffer that Dcm uses whenever reading OBD DID signals */
/* Deviation MISRAC2012-3 */
STATIC VAR(uint8, DCM_VAR) Dcm_ObdDidSignalBuffer[DCM_DATA_MAX_SIZE_OBD_DID_BYTE_ARRAY];

#endif /* #if (DCM_DSP_OBD_SIGNALBUFFER == STD_ON) */
...
#if ((DCM_DID_DATA_TABLE_SIZE > 0) || \
     (DCM_DID_BLOCK_ID_CONFIGURED == STD_ON))
...
#endif /* (DCM_RW_DID_BLOCK_ID_CONFIGURED == STD_ON) */
  ...
  )
{
...
#if ((DCM_DSP_USE_SERVICE_0X24 == STD_OFF) &&\
     (DCM_DSP_USE_SERVICE_0X2A == STD_OFF) &&\
     (DCM_DSP_OBD_SIGNALBUFFER == STD_OFF))
  ...
  {
#if (DCM_NUM_READSCALING_DID_DATA > 0U)
...
#endif /* ((DCM_DSP_USE_SERVICE_0X24 == STD_ON) && (DCM_NUM_READSCALING_DID_DATA > 0U)) */
  {
  ...
  {
#if (DCM_DSP_OBD_SIGNALBUFFER == STD_ON)
    if (DCM_DID_OP_READ_OBD == DidOp)
    {
      ReadContext->SignalBuffer = Dcm_ObdDidSignalBuffer;
      ReadContext->CheckBufferAvailability = FALSE;
    }
    else
#endif
  ...
  switch (ReadContext->ProcessingState)
  {
...
#endif
    {
      ...
      else
      {
        ...
        /* !LINKSTO Dcm.EB.ReadDataById.CONDITIONSNOTCORRECT,1 */
  ...
  uint16 DidDataIndex)
{
  ...
  /* Split this function due to HIS_PATH rules */
  /* DataCfg must be passed back from the first function in the return value, as the functions passes
     back the original value of DataCfg in the parameters */
  DataCfg = Dcm_Dsp_DidSignals_GetReadWriteDidDataAsyncFuncPointers(DidDataPtr, DidDataIndex, DataCfg);
  (void)Dcm_Dsp_DidSignals_GetIOControlDidDataAsyncFuncPointers(DidDataPtr, DidDataIndex, DataCfg);
  ...
  P2CONST(Dcm_VariableFunctionPointerRecordType, AUTOMATIC, DCM_CONST) DataCfg)
{
  ...
  if (DCM_IS_IOCTRLRESET_AVAILABLE(DataDescriptor))
  {
    /* Get ResetToDefault Function pointer */
  ...
  /* Get ReturnControlToEcu Function pointer */
#if(DCM_DEFAULT_ASR_SERVICE_API == DCM_SERVICE_API_ASR40)
  ...
  P2VAR(uint8, AUTOMATIC, DCM_VAR) SignalBuffer)
{
  ...
  uint16 DataLength = (uint16)DCM_GET_BYTES(DataCfg->DataLength);
...
#if(DCM_DEFAULT_ASR_SERVICE_API != DCM_SERVICE_API_ASR42)
  ...
  *Nrc = E_OK;
  ...
  else
  {
    ...
    *SignalLength = ReadSignalDataLengthInBits;
    ...
    if( (ReadSignalDataLength >= (uint16)DCM_GET_BYTES(DCM_UINT16_MAX)) )
    {
  ...
  P2VAR(Dcm_NegativeResponseCodeType, AUTOMATIC, DCM_VAR) Nrc)
{
  ...
  CONSTP2VAR(Dcm_DidDataType, AUTOMATIC, DCM_VAR) DataCfg = &(ReadContext->DataCfg);
  /* The total number of bytes contained by the current signal plus all the previous signals of the Did */
      ...
      if (BufferCheckStatus == DCM_E_OK)
      {
            ...
            (DataCfg->AccessInterface != DCM_USE_DATA_SENDER_RECEIVER))
        {
          ...
          Dcm_Dsp_DidSignals_Endianness_Conversion(
            ...
            (uint16)DCM_GET_BYTES(ReadContext->SignalLength),
            DataCfg->DataType);
        }
#endif /* ((DCM_ENDIANNESS_CONVERSION == STD_ON) && (DCM_DID_ENDIANNESS_CONVERSION == STD_ON)) */
  ...
  {
    /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Opaque.OutOfBounds.USE_DATA_SENDER_RECEIVER,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.Opaque.OutOfBounds.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.LittleEndian.OutOfBounds.USE_DATA_SENDER_RECEIVER,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.LittleEndian.OutOfBounds.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.BigEndian.OutOfBounds.USE_DATA_SENDER_RECEIVER,1 */
    /* !LINKSTO Dcm.EB.ReadDataById.EndiannessInterpretation.BigEndian.OutOfBounds.USE_DATA_SENDER_RECEIVER_AS_SERVICE,1 */
...
#if ((DCM_DSP_USE_SERVICE_0X24 == STD_ON) && (DCM_NUM_READSCALING_DID_DATA > 0U))
...
#endif /* #if ((DCM_DSP_USE_SERVICE_0X24 == STD_ON) && (DCM_NUM_READSCALING_DID_DATA > 0U)) */
