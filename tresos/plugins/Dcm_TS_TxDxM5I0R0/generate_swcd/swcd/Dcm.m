...
[!IF "(node:existsAndFalse(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspGenerateOnlyNeededIOControlOperations))"!][!//
...
[!ELSE!][!//
  [!VAR "DcmDspDataControlDcmDspDidReturnControlToEcuList" = "text:join(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*[node:exists(node:ref(DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl) and (node:existsAndTrue(as:ref(DcmDspDidInfoRef)/eb-list::*/DcmDspDidControl/DcmDspDidReturnControlToEcu))]/DcmDspDidSignal/eb-list::*/DcmDspDidDataRef)"!][!//
  [!VAR "DcmDspDataControlDcmDspDidResetToDefaultList" = "text:join(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*[node:exists(node:ref(DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl) and (node:existsAndTrue(as:ref(DcmDspDidInfoRef)/eb-list::*/DcmDspDidControl/DcmDspDidResetToDefault))]/DcmDspDidSignal/eb-list::*/DcmDspDidDataRef)"!][!//
  [!VAR "DcmDspDataControlDcmDspDidFreezeCurrentStateList" = "text:join(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*[node:exists(node:ref(DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl) and (node:existsAndTrue(as:ref(DcmDspDidInfoRef)/eb-list::*/DcmDspDidControl/DcmDspDidFreezeCurrentState))]/DcmDspDidSignal/eb-list::*/DcmDspDidDataRef)"!][!//
  [!VAR "DcmDspDataControlDcmDspDidShortTermAdjustmentList" = "text:join(DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspDid/eb-list::*[node:exists(node:ref(DcmDspDidInfoRef)/DcmDspDidAccess/DcmDspDidControl) and (node:existsAndTrue(as:ref(DcmDspDidInfoRef)/eb-list::*/DcmDspDidControl/DcmDspDidShortTermAdjustment))]/DcmDspDidSignal/eb-list::*/DcmDspDidDataRef)"!][!//
[!ENDIF!][!//
...
[!MACRO "DspDataElement_Read_Write_Control_ReadScalingDataAccess"!][!//
  ...
  [!LOOP "DcmConfigSet/eb-list::*[1]/DcmDsp/DcmDspData/eb-list::*"!][!//
    ...
    [!IF "(node:existsAndFalse(../../DcmDspGenerateOnlyNeededIOControlOperations))"!][!//
...
[!IF "not(DcmDspRoutineSignalType = 'VARIABLE_LENGTH')"!][!//
  [!IF "contains(DcmDspRoutineSignalType, '_N')"!][!//
    ...
    [!/* !LINKSTO Dcm.EB.RoutineControl.DcmDspRoutineSignalType.RequestIn.ArrayType.RoutineSignalUint8_N,1 */!][!//
...
[!ELSE!][!//
  ...
  <IMPLEMENTATION-DATA-TYPE>
  [!WS "2"!]<SHORT-NAME>[!"$RoutineInfoName"!]_[!"node:name(../.)"!]_ArrayType</SHORT-NAME>
  [!WS "2"!]<CATEGORY>ARRAY</CATEGORY>
  [!WS "2"!]<SUB-ELEMENTS>
  [!WS "4"!]<IMPLEMENTATION-DATA-TYPE-ELEMENT>
  [!WS "6"!]<SHORT-NAME>AuxU8_[!"$RoutineInfoName"!]_[!"node:name(../.)"!]_ArrayType</SHORT-NAME>
  [!WS "6"!]<CATEGORY>TYPE_REFERENCE</CATEGORY>
  [!WS "6"!]<ARRAY-SIZE>[!"num:integer((DcmDspRoutineSignalLength + 7) div 8)"!]</ARRAY-SIZE>
  [!WS "6"!]<ARRAY-SIZE-SEMANTICS>FIXED-SIZE</ARRAY-SIZE-SEMANTICS>
  [!WS "6"!]<SW-DATA-DEF-PROPS>
