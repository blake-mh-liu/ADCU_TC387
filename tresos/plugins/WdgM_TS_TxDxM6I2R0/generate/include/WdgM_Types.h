...
/*==================[inclusions]=================================================================*/
/* !LINKSTO WDGM.EB.Design.IncludeFileStructure14,1 */
#include <Std_Types.h>
...
#define WDGM_EB_INIT_STATUS_INIT              0xAA55U
[!ELSE!]
...
[!IF "(node:existsAndTrue(as:modconf('WdgM')[1]/WdgMGeneral/WdgMMixedSafetyCriticalityEnabled))"!][!//
#define WDGM_EB_INIT_STATUS_DEINIT              0x55AAU
[!ELSE!]
 ...
 */
[!IF "(node:existsAndTrue(as:modconf('WdgM')[1]/WdgMGeneral/WdgMMixedSafetyCriticalityEnabled))"!][!//
typedef uint16 WdgM_EB_InitStatusType;
[!ELSE!][!//
