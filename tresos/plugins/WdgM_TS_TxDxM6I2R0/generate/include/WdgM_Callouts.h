...
/** \brief Indicates a violation of a satellite main function run.
 */
extern FUNC(void, WDGM_CODE) [!"$SatelliteAlivenessCalloutName"!]
(
  void
);
[!ELSE!]
/** \brief Indicates a violation of a satellite main function run.
 **
 ** \param[out] CoreId The core id of the failed satellite.
 */
extern FUNC(void, WDGM_CODE) [!"$SatelliteAlivenessCalloutName"!]
(
...
[!ENDIF!][!/* IF $SatelliteAlivenessCoreIdDisable */!][!//
[!ENDIF!][!/* IF $SatelliteAlivenessCalloutEnabled */!][!//
