...
*/!][!MACRO "getModeSpecificLCM", "modeRef"!][!/*
    */!][!IF "num:i(count(as:ref($modeRef)/WdgMAliveSupervision/eb-list::*/WdgMSupervisionReferenceCycle)) >= 1"!][!/*
      */!][!VAR "lcm" = "num:i(as:ref($modeRef)/WdgMAliveSupervision/eb-list::*[1]/WdgMSupervisionReferenceCycle)"!][!/*
      */!][!LOOP "as:ref($modeRef)/WdgMAliveSupervision/eb-list::*/WdgMSupervisionReferenceCycle"!][!/*
        */!][!VAR "val1" = "num:i($lcm)"!][!/*
        */!][!VAR "val2" = "num:i(.)"!][!/*
        */!][!VAR "lcm"!][!/*
...
*/!][!MACRO "getFinalCPsFromInitialCP", "sourceCPRef", "modeId", "extLogSupervIndex", "visited"!][!/*
  ...
  */!][!LOOP "as:modconf('WdgM')[1]/WdgMConfigSet/eb-list::*[1]/WdgMMode/eb-list::*[number(WdgMModeId) = $modeId]/WdgMExternalLogicalSupervision/eb-list::*[node:pos(.) = $extLogSupervIndex]/WdgMExternalTransition/eb-list::*[node:value(WdgMExternalTransitionSourceRef) = $sourceCPRef]/WdgMExternalTransitionDestRef"!][!/*
    */!][!VAR "nextCP" = "node:value(.)"!][!/*
    */!][!IF "not(text:contains(text:split($visited), $nextCP))"!][!/*
      */!][!IF "num:i(count(../../../WdgMExternalCheckpointFinalRef/eb-list::*[node:value(.) = $nextCP])) != 0"!][!/*
        */!][!"$nextCP"!] [!/*
      */!][!ELSE!][!/*
