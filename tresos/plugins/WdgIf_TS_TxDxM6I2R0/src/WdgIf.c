 ...
 *
 * Reason:
 * This typedef is used in generated files to avoid empty translation unit.
 *
 * MISRAC2012-2) Deviated Rule: 5.5 (required)
 * Identifiers shall be distinct from macro names.
 *
 * Reason:
 * For a configuration with one watchdog the function will be generated as macros
 *
 ...
 * in them are required for multiple functions which are defined as macros
 */
...
/* patch version check */
#if (WDGIF_SW_PATCH_VERSION < 6U)
#error WDGIF_SW_PATCH_VERSION wrong (< 6U)
#endif
