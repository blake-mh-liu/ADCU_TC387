...
[!NOCODE!]
[!AUTOSPACING!]
[!VAR "WDGIF_DEVCOUNT"="count(WdgIfDevice/eb-list::*)"!][!//
...
[!IF "node:existsAndTrue(WdgIfGeneral/WdgIfDevErrorDetect)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(WdgIfGeneral/WdgIfVersionInfoApi)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!CODE!][!//
[!LOOP "WdgIfDevice/eb-list::*"!]

#if (defined WdgIfConf_WdgIfDevice_[!"as:name(.)"!])
#error WdgIfConf_WdgIfDevice_[!"as:name(.)"!] is already defined
#endif
/** \brief Export symbolic name value */
#define WdgIfConf_WdgIfDevice_[!"as:name(.)"!]  [!"WdgIfDeviceIndex"!]U
[!ENDLOOP!]
[!ENDCODE!]
...
************************************************************************
[!IF "node:existsAndTrue(WdgIfGeneral/WdgIfDriverAPIInfixEnable)"!][!//
[!LOOP "WdgIfDevice/eb-list::*"!][!//
