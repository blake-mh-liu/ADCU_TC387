...
#if (defined PDUR_SID_GATEIF_DF_MCORE_RXIND)
#error PDUR_SID_GATEIF_DF_MCORE_RXIND already defined
#endif /* if (defined PDUR_SID_GATEIF_DF_MCORE_RXIND) */

/** \brief Definition of service ID for internal handler function PduR_GateIfDfMCoreRxIndication */
#define PDUR_SID_GATEIF_DF_MCORE_RXIND 0x5AU

#if (defined PDUR_SID_GATEIF_SBNOINIT_MCORE_RXIND)
#error PDUR_SID_GATEIF_SBNOINIT_MCORE_RXIND already defined
#endif /* if (defined PDUR_SID_GATEIF_SBNOINIT_MCORE_RXIND) */

/** \brief Definition of service ID for internal handler function PduR_GateIfSbNoInitMCoreRxIndication */
#define PDUR_SID_GATEIF_SBNOINIT_MCORE_RXIND 0x5BU

#if (defined PDUR_SID_GATEIF_SBNOINIT_MCORE_UP_RXIND)
#error PDUR_SID_GATEIF_SBNOINIT_MCORE_UP_RXIND already defined
#endif /* if (defined PDUR_SID_GATEIF_SBNOINIT_MCORE_UP_RXIND) */

/** \brief Definition of service ID for internal handler function PduR_GateIfSbNoInitMCoreUpRxIndication */
#define PDUR_SID_GATEIF_SBNOINIT_MCORE_UP_RXIND 0x5CU
