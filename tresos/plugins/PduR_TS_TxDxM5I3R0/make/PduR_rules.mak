...
PduR_src_FILES_static      += \
   ...
   $(PduR_CORE_PATH)/src/PduR_MCastIfMCoreUpTransmit.c \
...
PduR_src_FILES_static += \
   ...
   $(PduR_CORE_PATH)/src/PduR_GateIfSbNoInitMCoreRxIndication.c \
   ...
   $(PduR_CORE_PATH)/src/PduR_GateIfDfMCoreTxConfirmation.c \
   $(PduR_CORE_PATH)/src/PduR_GateIfRxIndicationTfDynPyld.c \
   $(PduR_CORE_PATH)/src/PduR_GateIfDfMCoreRxIndication.c \
   $(PduR_CORE_PATH)/src/PduR_GateIfSbNoInitMCoreUpRxIndication.c
