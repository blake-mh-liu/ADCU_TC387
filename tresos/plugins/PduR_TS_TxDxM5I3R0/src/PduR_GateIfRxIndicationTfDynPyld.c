...
)
{
...
#endif /* #if (PDUR_DEV_ERROR_DETECT == STD_ON) */
   {
      ...
      TS_MemCpy(&pBufMem[TailPos * LenTfBuffer], PduInfoPtr->SduDataPtr, ActUsedSduLength);
      ...
      if (Transmit == TRUE)
      {
         ...
         PduR_PduInfo.SduDataPtr = &pBufMem[TailPos * LenTfBuffer];
...
typedef void PduR_PreventEmptyTranslationUnit_GateIfRxIndicationTfDynPyldType;
