...
#include "PduR_GateIfSbNoInitMCoreRxIndication.c"
#include "PduR_GateIfRxIndicationTfDynPyld.c"
#include "PduR_GateIfDfMCoreRxIndication.c"
...
#include "PduR_GateIfDfMCoreTxConfirmation.c"
#include "PduR_GateIfSbNoInitMCoreUpRxIndication.c"
...
#include "PduR_MCastIfMCoreUpTransmit.c"
