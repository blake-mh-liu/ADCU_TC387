...
FUNC(void,PDUR_CODE) PduR_GateIfDfMCoreTxConfirmation
(
    PduIdType GPduId
)
{
   ...
   DBG_PDUR_GATEIFDFMCORETXCONFIRMATION_ENTRY(GPduId);
   ...
   DBG_PDUR_GATEIFDFMCORETXCONFIRMATION_EXIT(GPduId);
}
...
typedef void PduR_PreventEmptyTranslationUnit_GateIfDfMCoreTxConfirmationType;
