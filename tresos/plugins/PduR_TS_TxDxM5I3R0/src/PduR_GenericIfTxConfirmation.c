...
)
{
   ...
   {
      /* according to SWS_PduR_00330, no routing shall be performed in the uninitialized state */
   ...
   else
   {
      ...
      /* Sb (intra and inter-core usage) or Nb gateway I-PDU */
...
typedef void PduR_PreventEmptyTranslationUnit_GenericIfTxConfirmationType;
