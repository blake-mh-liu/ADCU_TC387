...
FUNC(Std_ReturnType, PDUR_CODE) PduR_MCastIfMCoreUpTransmit
(
   PduIdType   MPduId,
...
)
{
   ...
   DBG_PDUR_PDUR_MCASTIFMCOREUPTRANSMIT_ENTRY(MPduId, PduInfoPtr);
...
#else
   {
      ...
      do{
         ...
         /* reset flags since PduR_MCastIfMCoreUpTransmit might be called after Timeout of upper layer,
   ...
   DBG_PDUR_MCASTIFMCOREUPTRANSMIT_EXIT(RetVal, MPduId, PduInfoPtr);
...
typedef void PduR_PreventEmptyTranslationUnit_MCastIfMCoreUpTransmitType;
