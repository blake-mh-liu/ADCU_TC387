...
/* !LINKSTO Base.SWS_Fr_00117,1, Base.ASR403.FR455,1, Base.SWS_Fr_00102,1, Base.ASR403.FR657,1, Base.SWS_Fr_00500,1 */

/*==================[inclusions]=============================================*/

#include <Std_Types.h>      /* basic AUTOSAR type definitions */
#include <Fr_GeneralTypes_Cfg.h>
/*==================[macros]=================================================*/
...
/* !LINKSTO Base.ASR403.FR110,1, Base.SWS_Fr_00077,1 */

/** \brief This enumerator type represents the FlexRay controller POC states. */
/* !LINKSTO Base.SWS_Fr_00505,1 */
typedef enum
{
...
/** \brief These values are used to determine whether a LPdu has been transmitted or not. */
/* !LINKSTO Base.SWS_Fr_00511,1 */
typedef enum
{
    FR_TRANSMITTED = 0,      /* LPdu has been transmitted */
...
/* !LINKSTO Base.ASR403.FR514,1, Base.SWS_Fr_00514,1 */
typedef enum
{
    FR_CHANNEL_A = FRCHANNELAVALUE,     /**< FlexRay channel A */
