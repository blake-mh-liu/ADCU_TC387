...
/* !LINKSTO Base.SWS_Can_00436,1, Base.ASR403.CAN438,1 */

/** \brief This type is used to provide ID, DLC and SDU from CAN interface to
 *         CAN driver.
 */
/* !LINKSTO Base.SWS_Can_00415,1 */
typedef struct
{
...
/** \brief This type is used to express time stamps based on relative time. */
/* !LINKSTO Base.ASR22-11.SWS_CAN_91029, 1 */
typedef struct
{
...
/* \brief Errory types of a CAN controller. */
/* !LINKSTO Base.SWS_Can_91021,1 */
typedef enum
{
  ...
  CAN_ERROR_BIT,                    /**< The HW reports a CAN bit error but cannot report distinguish between CAN_ERROR_BIT_MONITORING1 and CAN_ERROR_BIT_MONITORING0 */
  ...
  CAN_ERROR_OVERLOAD,               /**< CAN overload detected via an overload frame. Indicates that the receive buffers of a receiver are full. */
...
/* !LINKSTO Base.SWS_CanTrcv_00163,1 */
typedef enum
{
...
/* !LINKSTO Base.SWS_CanTrcv_00164,1 */
typedef enum
{
...
/* !LINKSTO Base.ASR403.CanTrcv165,1 */
typedef enum
{
...
/* !LINKSTO Base.EB_Ref.SWS_CanTrcv_00210.AvailableVia,1 */
typedef enum
{
...
/* !LINKSTO Base.EB_Ref.SWS_CanTrcv_00211.AvailableVia,1 */
typedef enum
{
