...
/* allow overriding with chip-dependent version by compiler|platforms|integrator */
...
#define COMSTACK_GET32(headerPtr, constByteOffset) \
  (((uint32)(((uint32)(((ComStack_ConstUint8PtrType)(headerPtr))[(constByteOffset)     ])) << 24U)) | \
   ((uint32)(((uint32)(((ComStack_ConstUint8PtrType)(headerPtr))[(constByteOffset) + 1U])) << 16U)) | \
   ((uint32)(((uint32)(((ComStack_ConstUint8PtrType)(headerPtr))[(constByteOffset) + 2U])) <<  8U)) | \
   ((uint32)(((uint32)(((ComStack_ConstUint8PtrType)(headerPtr))[(constByteOffset) + 3U]))       )) )
 ...
 * refer to en.wikipedia.org/wiki/Hamming_weight#Efficient_implementation
 */
