#ifndef STD_TYPES_H
/* !LINKSTO Base.ASR403.STD003,1, Base.SWS_Std_00014,1 */
#define STD_TYPES_H
...
/* !LINKSTO Base.SWS_Std_00006,1 */
#ifndef E_OK
/** \brief Constant for value OK of StatusType */
/* !LINKSTO Base.SWS_Std_00011,1 */
#define E_OK 0U
#endif
...
/** \brief Autosar definition for forwarded error code to 'Generate a deliberately wrong CRC' */
/* !LINKSTO Base.ASR21-11.SWS_Std_00028,1 */
#define E_SAFETY_INVALID_CRC 3U
...
/* !LINKSTO Base.SWS_Std_91001,1 */
typedef uint8 Std_MessageTypeType;

/** \brief Autosar standard Message Result type */
/* Currently is limited to the distinction between requests and responses in C/S communication. */
/* !LINKSTO Base.SWS_Std_91002,1 */
...
/* !LINKSTO Base.SWS_Std_91003,1 */
typedef P2FUNC(Std_ReturnType, BASE_APPL_DATA, Std_ExtractProtocolHeaderFieldsType)
(
   P2CONST(uint8, AUTOMATIC, BASE_APPL_DATA) buffer,
   uint32 bufferLength,
   P2VAR(Std_MessageTypeType, AUTOMATIC, BASE_APPL_DATA) messageType,
   P2VAR(Std_MessageResultType, AUTOMATIC, BASE_APPL_DATA) messageResult
);

/** \brief Autosar standard Transformer Forward Code type */
/* Currently is limited to the symbol E_SAFETY_INVALID_CRC */
/* !LINKSTO Base.ASR21-11.SWS_Std_00029,1 */
