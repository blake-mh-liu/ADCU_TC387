...
#if (defined TS_MEMSETS_NOCHECK)
#error TS_MEMSETS_NOCHECK is already defined
#endif
...
/*------------------[TS_MemSetS64]-------------------------------------------*/
FUNC(void, BASE_CODE) TS_MemSetS64
(
...
)
{
  ...
  if (TS_MEM_IS_ENOUGH_DATA(len2))
  {
    ...
    /* Deviation MISRAC2012-3, CERTC-1 */
...
/*------------------[TS_MemBZeroS64]-----------------------------------------*/
FUNC(void, BASE_CODE) TS_MemBZeroS64
(
  CONSTP2VAR(void, AUTOMATIC, BASE_APPL_DATA) dst,
  const usize len
)
{
  ...
  if (TS_MEM_IS_ENOUGH_DATA(len2))
  {
    ...
    if (TS_MEM_IS_64ALIGNED(dst2))
    {
      /* assign data in 64-bit mode */
      /* Deviation MISRAC2012-1, MISRAC2012-2, MISRAC2012-5 */
      TS_MEMSETS_NOCHECK(dst2, UINT64_C(0), len2, uint64);
    }
    /* check if dst is 32-bit aligned */
    /* Deviation MISRAC2012-3, CERTC-1 */
    else if (TS_MEM_IS_32ALIGNED(dst2))
    {
      /* assign data in 32-bit mode */
      /* Deviation MISRAC2012-1, MISRAC2012-2, MISRAC2012-5 */
      TS_MEMSETS_NOCHECK(dst2, UINT32_C(0), len2, uint32);
    }
    /* check if dst is 16-bit aligned */
    /* Deviation MISRAC2012-3, CERTC-1 */
    else if (TS_MEM_IS_16ALIGNED(dst2))
    {
      /* assign data in 16-bit mode */
      /* Deviation MISRAC2012-1, MISRAC2012-2, MISRAC2012-5 */
      TS_MEMSETS_NOCHECK(dst2, UINT16_C(0), len2, uint16);
    }
    else
    {
      /* for MISRA */
   ...
   * unoptimized case: assign everything byte-wise */
  /* Deviation MISRAC2012-1, MISRAC2012-5 */
  TS_MEMSETS_NOCHECK(dst2, UINT8_C(0), len2, uint8);
}

/*------------------[TS_MemCmpS64]-------------------------------------------*/
FUNC(Std_ReturnType, BASE_CODE) TS_MemCmpS64
(
...
/*------------------[TS_MemSetS16]-------------------------------------------*/
FUNC(void, BASE_CODE) TS_MemSetS16
(
  CONSTP2VAR(void, AUTOMATIC, BASE_APPL_DATA) dst,
  const uint8 val,
  const usize len
...
/*------------------[TS_MemBZeroS16]-----------------------------------------*/
FUNC(void, BASE_CODE) TS_MemBZeroS16
(
  CONSTP2VAR(void, AUTOMATIC, BASE_APPL_DATA) dst,
  const usize len
)
...
/*------------------[TS_MemCmpS16]-------------------------------------------*/
FUNC(Std_ReturnType, BASE_CODE) TS_MemCmpS16
(
  CONSTP2CONST(void, AUTOMATIC, BASE_APPL_DATA) a,
  CONSTP2CONST(void, AUTOMATIC, BASE_APPL_DATA) b,
  const usize len
...
/*------------------[TS_MemSetS8]--------------------------------------------*/
FUNC(void, BASE_CODE) TS_MemSetS8
(
  CONSTP2VAR(void, AUTOMATIC, BASE_APPL_DATA) dst,
  const uint8 val,
  const usize len
...
/*------------------[TS_MemBZeroS8]------------------------------------------*/
FUNC(void, BASE_CODE) TS_MemBZeroS8
(
  CONSTP2VAR(void, AUTOMATIC, BASE_APPL_DATA) dst,
  const usize len
)
...
/*------------------[TS_MemCmpS8]--------------------------------------------*/
FUNC(Std_ReturnType, BASE_CODE) TS_MemCmpS8
(
  CONSTP2CONST(void, AUTOMATIC, BASE_APPL_DATA) a,
  CONSTP2CONST(void, AUTOMATIC, BASE_APPL_DATA) b,
  const usize len
