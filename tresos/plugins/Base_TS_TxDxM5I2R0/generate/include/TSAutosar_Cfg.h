...
[!MACRO "GetCType","Prefix","Type","Label"!][!//
  ...
  [!IF "node:exists(as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property])"!]
    [!VAR "BaseType"="as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property]"!]
...
[!FOR "i"="1" TO "num:i($BitWidthListLength)"!]
  ...
  [!IF "node:existsAndTrue(as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property])"!]
 ...
 */
#define TS_SIZE_[!"$Type"!] [!WS!][!"as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property]"!]U
 ...
 */
#define TS_ALIGNMENT_[!"$Type"!] [!WS!][!"as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property]"!]U
 ...
 */
typedef[!WS!][!"as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property]"!][!WS!][!"$DerivedType"!];
