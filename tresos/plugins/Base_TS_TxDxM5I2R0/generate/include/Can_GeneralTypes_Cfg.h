...
#define TS_GENERALTYPES_CAN_CONTROLLERSTATETYPE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/GeneralTypes/GeneralTypes_Can_ControllerStateType)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 *  - uint32 (otherwise)
 */
/* !LINKSTO Base.ASR413.SWS_Can_00416,1 */
