 ...
 */
#define BASE_DBG_ENABLE [!WS!][!IF "node:exists(as:modconf('Base')[1]/BaseDbg/BaseDbgHeaderFile)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMCPY_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemCpy)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMSET_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemSet)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMSETS_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemSetS)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMCMP_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemCmp)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMCMPS_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemCmpS)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMBZERO_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemBZero)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 */
#define TS_MEMBZEROS_CUSTOM_OVERRIDE [!WS!][!IF "node:existsAndTrue(as:modconf('Base')[1]/CustomOverrides/CustomOverride_MemBZeroS)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!FOR "i"="1" TO  "num:i($ListLength)"!]
  ...
  [!IF "node:exists(as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property])"!]
 ...
 */
typedef[!WS!][!"as:modconf('Base')[1]/BaseTypes/eb-list::*[node:name(.)=$property]"!][!WS!][!"$AutosarType"!];
 ...
 */
[!LOOP "as:modconf('Base')[1]/CustomStdIncludeFiles/CustomStdIncludeFiles/eb-list::*"!]
#include <[!"."!]>
[!ENDLOOP!]
