...
/* anse1271: store ValidApplication Flag and Link it to 0x801FFF00 */
#define VERIFY_BOOTWORD_MAGIC_NUM 8
const uint8 verifyApplBootword[VERIFY_BOOTWORD_MAGIC_NUM] =
{
    /* PROGRAMM in ASCII */
    0x50U,
    0x52U,
