...
=item C<< $be->printOutputSection($osecName, $osecType, $inFiles, $inSections, $startSymbol, $endSymbol, $initSymbol, $initEndSymbol) >>
...
by the C<align> and C<endalign> properties of the output section specification found in the
C<< GenldArch<TARGET> >> module.
