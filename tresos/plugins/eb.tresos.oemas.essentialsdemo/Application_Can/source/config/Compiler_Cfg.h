...
#if (defined FCU_CODE)
#error FCU_CODE already defined
#endif
#define FCU_CODE

#if (defined FCU_CONST)
#error FCU_CONST already defined
#endif
#define FCU_CONST

#if (defined FCU_APPL_DATA)
#error FCU_APPL_DATA already defined
#endif
#define FCU_APPL_DATA

#if (defined FCU_APPL_CONST)
#error FCU_APPL_CONST already defined
#endif
#define FCU_APPL_CONST

#if (defined FCU_APPL_CODE)
#error FCU_APPL_CODE already defined
#endif
#define FCU_APPL_CODE

#if (defined FCU_VAR_NOINIT)
#error FCU_VAR_NOINIT already defined
#endif
#define FCU_VAR_NOINIT

#if (defined FCU_VAR_POWER_ON_INIT)
#error FCU_VAR_POWER_ON_INIT already defined
#endif
#define FCU_VAR_POWER_ON_INIT

#if (defined FCU_VAR_FAST)
#error FCU_VAR_FAST already defined
#endif
#define FCU_VAR_FAST

#if (defined FCU_VAR)
#error FCU_VAR already defined
#endif
#define FCU_VAR
...
#if (defined GPTA_CODE)
#error GPTA_CODE already defined
#endif
#define GPTA_CODE

#if (defined GPTA_CONST)
#error GPTA_CONST already defined
#endif
#define GPTA_CONST

#if (defined GPTA_APPL_DATA)
#error GPTA_APPL_DATA already defined
#endif
#define GPTA_APPL_DATA

#if (defined GPTA_APPL_CONST)
#error GPTA_APPL_CONST already defined
#endif
#define GPTA_APPL_CONST

#if (defined GPTA_APPL_CODE)
#error GPTA_APPL_CODE already defined
#endif
#define GPTA_APPL_CODE

#if (defined GPTA_VAR_NOINIT)
#error GPTA_VAR_NOINIT already defined
#endif
#define GPTA_VAR_NOINIT

#if (defined GPTA_VAR_POWER_ON_INIT)
#error GPTA_VAR_POWER_ON_INIT already defined
#endif
#define GPTA_VAR_POWER_ON_INIT

#if (defined GPTA_VAR_FAST)
#error GPTA_VAR_FAST already defined
#endif
#define GPTA_VAR_FAST

#if (defined GPTA_VAR)
#error GPTA_VAR already defined
#endif
#define GPTA_VAR
...
#if (defined IRQ_CODE)
#error IRQ_CODE already defined
#endif
#define IRQ_CODE

#if (defined IRQ_CONST)
#error IRQ_CONST already defined
#endif
#define IRQ_CONST

#if (defined IRQ_APPL_DATA)
#error IRQ_APPL_DATA already defined
#endif
#define IRQ_APPL_DATA

#if (defined IRQ_APPL_CONST)
#error IRQ_APPL_CONST already defined
#endif
#define IRQ_APPL_CONST

#if (defined IRQ_APPL_CODE)
#error IRQ_APPL_CODE already defined
#endif
#define IRQ_APPL_CODE

#if (defined IRQ_VAR_NOINIT)
#error IRQ_VAR_NOINIT already defined
#endif
#define IRQ_VAR_NOINIT

#if (defined IRQ_VAR_POWER_ON_INIT)
#error IRQ_VAR_POWER_ON_INIT already defined
#endif
#define IRQ_VAR_POWER_ON_INIT

#if (defined IRQ_VAR_FAST)
#error IRQ_VAR_FAST already defined
#endif
#define IRQ_VAR_FAST

#if (defined IRQ_VAR)
#error IRQ_VAR already defined
#endif
#define IRQ_VAR
