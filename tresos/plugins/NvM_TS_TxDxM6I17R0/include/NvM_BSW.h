 ...
 *    jira.autosar.org/browse/AR-16331
 ...
 ** of the asynchronous function is called. If the asynchronous request
...
#if (NVM_BSW_DISTRIBUTION_ENABLED == STD_OFF)
...
#endif /* (NVM_BSW_DISTRIBUTION_ENABLED == STD_OFF) */
 ...
 ** set to FALSE and if a Permanent Data RAM Block is defined for block
 ...
 ** neither enabled nor disabled for this block and the DET error
