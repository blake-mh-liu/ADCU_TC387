...
[!LOOP "NvMCommon/NvMUserHeader/eb-list::*"!][!//
[!IF "normalize-space(.) != ''"!][!//
...
[!IF "node:existsAndTrue(NvMCommon/NvMCommonCryptoSecurityParameters/NvMEnableCryptoSecurityHooks)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
