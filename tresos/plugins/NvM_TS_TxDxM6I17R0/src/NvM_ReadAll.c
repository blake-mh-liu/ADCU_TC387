...
STATIC FUNC(void,NVM_CODE) NvM_ReadAll_Async_State1(void)
{
  ...
  {
    /* !LINKSTO NvM.SWS_NvM_00673,1 */
    /* !LINKSTO NvM.NvMSoftwareChangeCallout.SWS_NvM_00673,1 */
    /* According to NvM.SWS_NvM_00673, in case Dynamic Configuration is enabled and the Configuration ID
  ...
  else
  {
    ...
    {
      /* !LINKSTO NvM.SWS_NvM_00246,1 */
      /* !LINKSTO NvM.NvMSoftwareChangeCallout.SWS_NvM_00246,1 */
      /* !LINKSTO NvM.SWS_NvM_00073,1 */
      ...
      {
        /* NvM.SWS_NvM_00313: The Configuration Ids are equal --> the Compiled
         *         Configuration Id must not be written --> set block to
         *         unchanged ( NvM.SWS_NvM_00313 )
         */
        NvM_SetPermanentRamBlockUnchanged();
      }
    ...
    {
      /* NvM.SWS_NvM_00305: Configuration cannot be read because of an error
   ...
   * the multi block job result must be set to NVM_REQ_NOT_OK ( NvM.SWS_NvM_00301 ).
   */
...
FUNC(void,NVM_CODE) NvM_ReadAll_Async_State5(void)
{
  ...
  if ( NvM_GlobalBlockNumber < ( NVM_TOTAL_NUMBER_OF_NVRAM_BLOCKS - 1U ) )
  {
     ...
     * synchronization mechanism enabled (SWS_NvM_00356, NvM.SWS_NvM_00718),
...
#endif /* NVM_SYNC_MECHANISM = STD_ON */
    {
      ...
      /* !LINKSTO NvM.SWS_NvM_00128,1, NvM.SWS_NvM_00133,1, NvM.SWS_NvM_00345,1 */
          ...
          (NvM_AdminBlockTable[NvM_GlobalBlockNumber].NvMValid != NVM_BLOCK_VALID ))
      {
         ...
         * --> copy data from NVM Block or ROM Block ( NvM.SWS_NvM_00362,SWS_NvM_00293 ).
         */
      ...
      else
      {
        ...
        if(NVM_BD_CALCRAMBLOCKCRC(NvM_CurrentBlockDescriptorPtr->blockDesc))
        {
           ...
           *     specific RAM CRC buffer ( NvM.SWS_NvM_00362 ).
           */
...
STATIC FUNC(void,NVM_CODE) NvM_ReadAll_Async_State7(void)
{
  ...
  if ( NvM_GlobalErrorStatus == NVM_REQ_OK )
  {
     ...
     * --> Don't copy NVM or ROM Block ( NvM.SWS_NvM_00364 ).
     */
    NvM_CurrentFunctionPtr[NvM_GlobalCallLevel] = &NvM_ReadAll_Async_State6;
  }
  else
  {
     ...
     * --> Copy NVM or ROM Block ( NvM.SWS_NvM_00293 ).
     */
    /* !LINKSTO NvM.SWS_NvM_00293,2 */
    NvM_CurrentFunctionPtr[NvM_GlobalCallLevel] = &NvM_ReadAll_Async_State8;
  }/* if ( NvM_GlobalErrorStatus == NVM_REQ_OK ) */
