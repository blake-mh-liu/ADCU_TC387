...
FUNC(void,NVM_CODE) NvM_FirstInitAll_Async_State1(void)
{
  ...
  */
  ...
  if (NVM_BD_FIRSTINITALL(NvM_CurrentBlockDescriptorPtr->blockDesc))
  {
    ...
    FirstInitNvMDatasetBlockIndex = NvM_CurrentBlockDescriptorPtr->nvBlockNum - 1U;
    NvM_GlobalCallLevel++;
    /* !LINKSTO NvM.SWS_NvM_00913,1 */
    /* !LINKSTO NvM.SWS_NvM_00915,1 */
    /* !LINKSTO NvM.SWS_NvM_00919,1 */
    /* !LINKSTO NvM.SWS_NvM_00920,1 */
    /* !LINKSTO NvM.SWS_NvM_00923,1 */
    ...
    else
    {
      ...
      /* Set the token for a satellite */
      NVM_SET_SATELLITE_JOB_ONGOING_FLAG(NvM_GlobalBlockNumber);
      NVM_ATOMIC_STORE( &NvM_MultiPartitionToken, (NvM_Atomic_value_t)NvM_BlockDescriptorTable[NvM_GlobalBlockNumber].OsAppId);
...
FUNC(void,NVM_CODE) NvM_FirstInitAll_Async_PrepareDefData(void)
{
  ...
  {
    /* !LINKSTO NvM.SWS_NvM_00914,1 */
    /* !LINKSTO NvM.SWS_NvM_00917,1 */
  ...
  {
#if ( NVM_NUMBER_OF_INIT_BLOCK_CALLBACK > 0U )
    /* !LINKSTO NvM.InitCallback2011.Function,1 */
    /* !LINKSTO NvM.InitCallback2011.Port,1 */
#if(NVM_CBK2011ACTIVE == STD_ON)
    if (NVM_BD_AR2011CBK(NvM_CurrentBlockDescriptorPtr->blockDesc))
    {
      /* !LINKSTO NvM.InitBlockCallback2011.FIRST_INIT_ALL,1 */
      /* Deviation MISRAC2012-1 */
      InitCallbackResult = ((NvM_InitBlockCallbackTypeAR2011)NvM_CurrentBlockDescriptorPtr->initBlockCallback)(NVM_INIT_FIRST_INIT_ALL);
    }
    else
    {
      /* Deviation MISRAC2012-1 */
      InitCallbackResult = ((NvM_InitBlockCallbackType)NvM_CurrentBlockDescriptorPtr->initBlockCallback)();
    }
#else
    /* Deviation MISRAC2012-1 */
    InitCallbackResult = ((NvM_InitBlockCallbackType)*(NvM_CurrentBlockDescriptorPtr->initBlockCallback))();
#endif
    /* !LINKSTO NvM.SWS_NvM_00921,1 */
    /* !LINKSTO NvM.SWS_NvM_00922,1 */
...
#endif/* NVM_NUMBER_OF_INIT_BLOCK_CALLBACK >0*/
  {
    ...
    if(
        ...
        (
            ...
            ||
            /* Deviation CERTC-1 */
            ( ((uint32)((uint8 *)NvM_CurrentBlockDescriptorPtr->ramBlockDataAddress) & (NVM_BUFFER_ALIGNMENT_BITS/8U - 1U)) != 0U)
         )
       )
#else
...
#endif
    {
       ...
       * Copy the Block Identifier to internal buffer (SWS_NvM_00522, NvM.SWS_NvM_00523).
       */
      if (NVM_BD_USESTATICBLOCKID(NvM_CurrentBlockDescriptorPtr->blockDesc))
      {
        TS_MemCpy(CurrentRamAddress, NVM_STATIC_BLOCKID(), NVM_BLOCKID_LENGTH);
...
FUNC(void,NVM_CODE) NvM_FirstInitAll_Async_CopyToNv(void)
{
  ...
  if (MEMIF_BUSY != MemIf_GetStatus( NVM_BD_DEVICEID(NvM_CurrentBlockDescriptorPtr->blockDesc)))
  {
    ...
    {
    /* !LINKSTO NvM.SWS_NvM_00925,1 */
      NvM_StateMachine_TerminateCurrentLevel();
      NvM_GlobalErrorStatus = NVM_REQ_NOT_OK;
      NvM_AdminBlockTable[NvM_GlobalBlockNumber].NvMResult = NvM_GlobalErrorStatus;
    /* !LINKSTO NvM.SWS_NvM_00940,1 */
      NVM_REQUEST_INTERIM_RESULT = NvM_GlobalErrorStatus;

#if (NVM_BSW_DISTRIBUTION_ENABLED == STD_ON)
  /* Satellite letting Master know that the current block was processed. */
  NVM_SET_SATELLITE_MULTIBLOCK_FINALIZING_FLAG();
#endif /* (NVM_BSW_DISTRIBUTION_ENABLED == STD_ON) */
    }
  }
  else
...
FUNC(void,NVM_CODE) NvM_FirstInitAll_ProcessJobRestore_Async(void)
{
  ...
  if (Result == MEMIF_JOB_OK)
  {
    ...
    {
      /* !LINKSTO NvM.SWS_NvM_00916,1 */
      if (FirstInitNvMDatasetBlockIndex == 1U)
      {
...
FUNC(void,NVM_CODE) NvM_FirstInitAll_Async_Invalidate(void)
{
  ...
  if ( MEMIF_BUSY != Status )
  {
    ...
    {
      /* !LINKSTO NvM.SWS_NvM_00927,1 */
      /* !LINKSTO NvM.SWS_NvM_00928,1 */
      /* !LINKSTO NvM.SWS_NvM_00929,1 */
      NvM_StateMachine_TerminateCurrentLevel();
      NvM_GlobalErrorStatus = NVM_REQ_NOT_OK;
      NvM_AdminBlockTable[NvM_GlobalBlockNumber].NvMResult = NvM_GlobalErrorStatus;
      /* !LINKSTO NvM.SWS_NvM_00940,1 */
...
FUNC(void,NVM_CODE) NvM_FirstInitAll_ProcessJobInvalidate_Async(void)
{
  ...
  if (Result == MEMIF_JOB_OK)
  {
    ...
    NvM_GlobalErrorStatus = NVM_REQ_OK;
    /* !LINKSTO NvM.SWS_NvM_00924,1 */
    if (FirstInitNvMDatasetBlockIndex != 0U)
    {
      FirstInitNvMDatasetBlockIndex--;
      NvM_CurrentFunctionPtr[NvM_GlobalCallLevel] = &NvM_FirstInitAll_Async_Invalidate;
    }
