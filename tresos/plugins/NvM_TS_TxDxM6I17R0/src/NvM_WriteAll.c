...
FUNC(void,NVM_CODE) NvM_WriteAll_Async(void)
{
   ...
   * Block ID 1 (configuration ID) shall be written only at the end (SWS_NvM_00733).
   */
...
FUNC(void,NVM_CODE) NvM_WriteAll_Async_State1(void)
{
  ...
  else
  {
    ...
    {
      /* !LINKSTO NvM.SWS_NvM_00128,1, NvM.SWS_NvM_00133,1 */
