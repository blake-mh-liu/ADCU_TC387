...
/* minor version check */
#if (TM_AR_RELEASE_MINOR_VERSION != 6U )
#error TM_AR_RELEASE_MINOR_VERSION wrong (!= 6U)
#endif
...
/* patch version check */
#if (TM_SW_PATCH_VERSION < 11U)
#error TM_SW_PATCH_VERSION wrong (< 11U)
#endif
...
#if (TM_DET_RUNTIME_CHECKS == STD_ON)
...
#endif /*#if (TM_DET_RUNTIME_CHECKS == STD_ON)*/
...
)
{
  ...
  /* !LINKSTO Tm.SWS_Tm_00063,1 */
#if (TM_DEV_ERROR_DETECT == STD_ON)
  if (NULL_PTR == VersionInfoPtr)
  {
    /* !LINKSTO Tm.SWS_Tm_00037,1, Tm.swdd.Err_TM_E_PARAM_POINTER,1 */
...
)
{
  ...
  {
    /* !LINKSTO Tm.SWS_Tm_00008,1, Tm.swdd.Err_TM_E_PARAM_POINTER,1 */
    TM_DET_REPORT_ERROR( TM_SID_RESET_TIMER_1US_16BIT, TM_E_PARAM_POINTER);
  }
  else
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00001,1, Tm.SWS_Tm_00002,1 */
    RetVal = Gpt_GetPredefTimerValue(GPT_PREDEF_TIMER_1US_16BIT, &CurrentTimeStamp);

    if (E_OK == RetVal)
    {
      /* !LINKSTO Tm.SWS_Tm_00006,1, Tm.swdd.ResetFunctionReEntry,1 */
      TS_AtomicAssign16(TimerPtr->TimeValue, (uint16) CurrentTimeStamp);
    }
    else
    {
#if (TM_DET_RUNTIME_CHECKS == STD_ON)
      /* !LINKSTO Tm.EB_Ref.SWS_Tm_00064.1us16bit,1, Tm.swdd.ReportRuntimeError,1 */
...
)
{
...
#if (TM_DEV_ERROR_DETECT == STD_ON)
  /* !LINKSTO Tm.EB_Ref.SWS_Tm_00012.TimerPtr,1, Tm.EB_Ref.SWS_Tm_00012.TimeSpanPtr,1 */
...
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    if (TimeSpanPtr != NULL_PTR)
    {
      ...
      if (E_OK == RetVal)
      {
        /* !LINKSTO Tm.SWS_Tm_00009,1, Tm.SWS_Tm_00010,1, Tm.swdd.GetTmeSpanFunctionReEntry,1 */
        TS_AtomicAssign16(*TimeSpanPtr, (uint16) ((CurrentTimeStamp - TimerPtr->TimeValue) & TM_MAX_TIMESTAMP_16_BIT));
      }
      else
      {
        /* !LINKSTO Tm.SWS_Tm_00065,1 */
...
)
{
  ...
  if (NULL_PTR == TimerPtr)
  {
    /* !LINKSTO Tm.SWS_Tm_00018,1, Tm.swdd.Err_TM_E_PARAM_POINTER,1 */
    TM_DET_REPORT_ERROR( TM_SID_SHIFT_TIMER_1US_16BIT, TM_E_PARAM_POINTER);
  }
  else
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00013,1, Tm.SWS_Tm_00014,1, Tm.swdd.ShiftTimerFunctionReEntry,1 */
...
)
{
  ...
  {
    /* !LINKSTO Tm.SWS_Tm_00021,1, Tm.swdd.Err_TM_E_PARAM_POINTER,1 */
    TM_DET_REPORT_ERROR( TM_SID_SYNC_TIMER_1US_16BIT, TM_E_PARAM_POINTER);
  }
  else
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00019,1, Tm.swdd.SyncTimerFunctionReEntry,1 */
...
)
{
  ...
  /* !LINKSTO Tm.SWS_Tm_00022,1, Tm.SWS_Tm_00024,1, Tm.EB_Ref.SWS_Tm_00066.BusyWait1us16bit,1 */
  while ( (E_OK == RetVal) &&
...
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00001,1, Tm.SWS_Tm_00003,1 */
    ...
    {
#if (TM_DET_RUNTIME_CHECKS == STD_ON)
      /* !LINKSTO Tm.EB_Ref.SWS_Tm_00064.1us24bit,1, Tm.swdd.ReportRuntimeError,1 */
...
)
{
  ...
  {
    /* !LINKSTO Tm.SWS_Tm_00016,1, Tm.swdd.Err_TM_E_PARAM_VALUE,1 */
    TM_DET_REPORT_ERROR( TM_SID_SHIFT_TIMER_1US_24BIT, TM_E_PARAM_VALUE);
  }
  else
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00013,1, Tm.SWS_Tm_00014,1, Tm.SWS_Tm_00015,1, Tm.swdd.ShiftTimerFunctionReEntry,1 */
...
)
{
  ...
  /* !LINKSTO Tm.SWS_Tm_00022,1, Tm.SWS_Tm_00024,1, Tm.EB_Ref.SWS_Tm_00066.BusyWait1us24bit,1 */
  while ( (E_OK == RetVal) &&
...
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00001,1, Tm.SWS_Tm_00004,1 */
    ...
    {
#if (TM_DET_RUNTIME_CHECKS == STD_ON)
      /* !LINKSTO Tm.EB_Ref.SWS_Tm_00064.1us32bit,1, Tm.swdd.ReportRuntimeError,1 */
...
)
{
  ...
  /* !LINKSTO Tm.SWS_Tm_00022,1, Tm.SWS_Tm_00024,1, Tm.EB_Ref.SWS_Tm_00066.BusyWait1us32bit,1 */
  while ( (E_OK == RetVal) &&
...
#endif /* #if (TM_DEV_ERROR_DETECT == STD_ON) */
  {
    /* !LINKSTO Tm.SWS_Tm_00001,1, Tm.SWS_Tm_00005,1 */
    ...
    {
#if (TM_DET_RUNTIME_CHECKS == STD_ON)
      /* !LINKSTO Tm.EB_Ref.SWS_Tm_00064.100us32bit,1, Tm.swdd.ReportRuntimeError,1 */
