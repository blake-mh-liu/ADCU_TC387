 ...
 * the issue reported in www.autosar.org/bugzilla/show_bug.cgi?id=53853 and should be fixed
...
/* !LINKSTO CanNm.ASR403.CANNM021,1 */
...
/* !LINKSTO CanNm.ASR403.CANNM210,1 */
...
#if (defined CANNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN)
#error CANNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN already defined
#endif /* #if (defined CANNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN) */
/** \brief AUTOSAR API service ID.
**
** Definition of CANNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN.
*/
#define CANNM_SERVID_REQUESTSYNCHRONIZEDPNCSHUTDOWN     0xF3U
...
#if (defined CANNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST)
#error CANNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST already defined
#endif
/** \brief Error code for case in which a PN synchronize shutdown message is
 **        received on an active channel
 */
#define CANNM_E_INVALID_PN_SYNC_SHUTDOWN_REQUEST              0x20U

#if (defined CANNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED)
#error CANNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED already defined
#endif
/** \brief Error code for case in which a PN synchronize shutdown message is
 **        received on an active channel
 */
#define CANNM_E_TRANSMISSION_OF_PN_SHUTDOWN_MESSAGE_FAILED    0x21U
...
#if (defined CANNM_E_INVALID_OSAPPLICATION)
#error CANNM_E_INVALID_OSAPPLICATION already defined
#endif
/** \brief Error code for case in which current running application id doesn't match
 **        configured application id of channel
 */
#define CANNM_E_INVALID_OSAPPLICATION     239U

/*==================[type definitions]======================================*/

/*==================[external function declarations]========================*/
/* !LINKSTO CanNm.ASR403.CANNM302,1 */
...
#ifndef RTE_SCHM_SWCBSW_CANNM_MULTIPLENETWORKOPERATIONS
#define RTE_SCHM_SWCBSW_CANNM_MULTIPLENETWORKOPERATIONS
/** \brief Single client interface.
 **
 ** This function is a single client interface for CanNm_PassiveStartUp,
 ** CanNm_NetworkRequest, CanNm_NetworkRelease.
 ** \param[in] nmChannelHandle Identification of the NM channel.
 ** \param[in] operation  Operation to be executed (one of CanNm_PassiveStartUp,
 **                       CanNm_NetworkRequest, CanNm_NetworkRelease).
 **
 ** \return Standard Return Code
 ** \retval E_OK No Error.
 ...
 ** \Synchronicity{Asynchronous}
 */
extern FUNC(Std_ReturnType, CANNM_CODE) CanNm_MultipleNetworkOperations
(
  NetworkHandleType nmChannelHandle,
  uint8             operation
);
 ...
 **
 ** Preconditions:
 ** - The API is only available if CanNmSynchronizedPncShutdownEnabled is
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Std_ReturnType, CANNM_CODE) CanNm_RequestSynchronizedPncShutdown
(
  NetworkHandleType nmChannelHandle,
  PNCHandleType pncId
);
