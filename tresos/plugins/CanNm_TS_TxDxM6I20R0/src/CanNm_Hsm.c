 ...
 *
 * Reason:
 * Violations of rule 14.2 is false positive, rearranging the condition check would lead towards
 * unexpected result.
 *
 ...
 *
 * Reason:
 * printf() is used for the debugging purpose only. Misra warning is raised because of length
 * difference of message strings "TRUE", "FALSE" that are passed as parameter for printf to display.
 */
