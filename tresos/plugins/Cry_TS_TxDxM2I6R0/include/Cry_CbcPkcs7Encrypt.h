...
/* !LINKSTO EB_CRY_0001,1, CS_SECURE_CRY_0001_CbcPkcs7Encrypt,1 */

#ifndef CRY_CBCPKCS7ENCRYPT_H
#define CRY_CBCPKCS7ENCRYPT_H

/*==[Includes]================================================================*/

#include <Std_Types.h>

#include <Cry_CbcPkcs7EncryptConfig.h>  /* !LINKSTO EB_CRY_0002,1 */
 ...
 **                         running.
 **/
extern FUNC(Csm_ReturnType,CRY_CODE) Cry_CbcPkcs7EncryptStart
(
 ...
 **                               encrypted data.
 **/
extern FUNC(Csm_ReturnType,CRY_CODE) Cry_CbcPkcs7EncryptUpdate
(
 ...
 **                               encrypted data.
 **/
extern FUNC(Csm_ReturnType,CRY_CODE) Cry_CbcPkcs7EncryptFinish
(
  P2VAR(uint8,  AUTOMATIC, CRY_APPL_DATA) oputTextPtr,
  P2VAR(uint32, AUTOMATIC, CRY_APPL_DATA) oputTextLengthPtr
);
 ...
 **/
extern FUNC(void,CRY_CODE) Cry_CbcPkcs7EncryptMainFunction
(
  void
);
...
#endif /* #ifndef CRY_CBCPKCS7ENCRYPT_H */
