...
/* !LINKSTO EB_CRY_0001,1, CS_SECURE_CRY_0001_CbcPkcs7Decrypt,1 */

#ifndef CRY_CBCPKCS7DECRYPT_H
#define CRY_CBCPKCS7DECRYPT_H

/*==[Includes]================================================================*/

#include <Std_Types.h>

#include <Cry_CbcPkcs7DecryptConfig.h>  /* !LINKSTO EB_CRY_0002,1 */
 ...
 **                         running.
 **/
extern FUNC(Csm_ReturnType,CRY_CODE) Cry_CbcPkcs7DecryptStart
(
 ...
 **                               decrypted data.
 **/
extern FUNC(Csm_ReturnType,CRY_CODE) Cry_CbcPkcs7DecryptUpdate
(
 ...
 **                               encrypted data.
 **/
extern FUNC(Csm_ReturnType,CRY_CODE) Cry_CbcPkcs7DecryptFinish
(
  P2VAR(uint8,  AUTOMATIC, CRY_APPL_DATA) oputTextPtr,
  P2VAR(uint32, AUTOMATIC, CRY_APPL_DATA) oputTextLengthPtr
);
...
extern FUNC(void,CRY_CODE) Cry_CbcPkcs7DecryptMainFunction
(
  void
);
...
#endif /* #ifndef CRY_CBCPKCS7DECRYPT_H */
