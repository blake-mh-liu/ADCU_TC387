...
#elif defined (PROG_VDS_TABLE_START_SEC_VAR_NO_INIT_8)
#undef      PROG_VDS_TABLE_START_SEC_VAR_NO_INIT_8
#undef MEMMAP_ERROR

#elif defined (PROG_VDS_TABLE_STOP_SEC_VAR_NO_INIT_8)
#undef      PROG_VDS_TABLE_STOP_SEC_VAR_NO_INIT_8
#undef MEMMAP_ERROR
