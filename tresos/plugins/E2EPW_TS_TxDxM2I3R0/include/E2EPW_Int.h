 ...
 *
 * MISRAC2012-2) Deviated Rule: 11.9 (required)
...
/** \brief Infix PDAI1 shall be used for E2E state variable definitions
 *  (i.e. E2E_ ## PDAI1 ## SenderStateType, E2E_ ## PDAI1 ## ReceiverStateType) */
#define E2EPW_PROFILE_DAI1 PDAI1
...
/** \brief Infix PDAI2 shall be used for E2E state variable definitions
 *  (i.e. E2E_ ## PDAI2 ## SenderStateType, E2E_ ## PDAI2 ## ReceiverStateType) */
#define E2EPW_PROFILE_DAI2 PDAI2
...
/** \brief Infix P01 shall be used for E2E state variable definitions
 *  (i.e. E2E_ ## P01 ## SenderStateType, E2E_ ## P01 ## ReceiverStateType) */
#define E2EPW_PROFILE_01 P01
...
/** \brief Infix P02 shall be used for E2E state variable definitions
 *  (i.e. E2E_ ## P02 ## SenderStateType, E2E_ ## P02 ## ReceiverStateType) */
#define E2EPW_PROFILE_02 P02
 ...
 * \param[in] applDataType Data type name of the application data element
 * \param[in] e2eprotsn Shortname of the E2E protection
 * \param[in] e2eprofile the name of the E2E profile (e.g. P02, P01, PDAI1, etc.)
 */
#define E2EPW_DEFVAR1_E2EPW_SC_WR(port_dataelement,applDataType,e2eprotsn,e2eprofile)        \
   static VAR(E2EPW_CONCAT3(E2E_,e2eprofile,SenderStateType), E2EPW_VAR)                     \
...
#define E2EPW_DEFVAR1_E2EPW_SC_RD(port_dataelement,applDataType,e2eprotsn,e2eprofile)        \
   static VAR(E2EPW_CONCAT3(E2E_,e2eprofile,ReceiverStateType), E2EPW_VAR)                   \
      E2EPW_Rd_St_ ## port_dataelement =                                                     \
      { (E2EPW_CONCAT3(E2E_,e2eprofile,STATUS_NONEWDATA)), 0U, 0U, TRUE, FALSE, 0U, 0U, 0U };
...
#define E2EPW_DEFVAR_CONST1_E2EPW_SC_WR(port_dataelement,applDataType,e2eprotsn,e2eprofile,detype_comtype) \
   static CONST(E2EPW_CONCAT3(E2E_,e2eprofile,ConfigType), E2EPW_CONST)                         \
      E2EPW_Wr_Cf_ ## port_dataelement =                                                        \
        { E2EPW_CONCAT2(E2EPW_GET_CFG_,e2eprofile)(e2eprotsn,detype_comtype,applDataType) };
   ...
   static CONST(E2EPW_GenericConfigType, E2EPW_CONST)                                              \
      E2EPW_GenericConfig_Rd_ ## port_dataelement =                                                \
        {                                                                                          \
           ...
           & E2EPW_CONCAT2(detype_comtype ## _GenericInnerRead_,e2eprofile),                       \
           & E2EPW_Rd_Cf_ ## port_dataelement,                                                     \
           & E2EPW_Rd_St_ ## port_dataelement,                                                     \
   ...
   static CONST(E2EPW_GenericConfigType, E2EPW_CONST)                                              \
      E2EPW_GenericConfig_Wr_ ## port_dataelement =                                                \
        {                                                                                          \
           ...
           & E2EPW_CONCAT2(detype_comtype ## _GenericInnerWrite_,e2eprofile),                      \
           & E2EPW_Wr_Cf_ ## port_dataelement,                                                     \
   ...
   static CONST(E2EPW_GenericConfigType, E2EPW_CONST)                                              \
      E2EPW_GenericConfig_W2_ ## port_dataelement =                                                \
        {                                                                                          \
           ...
           & E2EPW_CONCAT2(detype_comtype ## _GenericInnerWrite2_,e2eprofile),                     \
           & E2EPW_W2_Cf_ ## port_dataelement,                                                     \
...
#if (defined E2E_) /* Ensure that string can be used for macro concatenation */
#error E2E_ already defined
#endif /* if (defined E2E_) */
   ...
   do {                                                                                           \
      ...
      ?(((offset)==0U)?((uint8)((uint32)(nValue)&0xffU))                                          \
        :((uint8)((pnData)[0]&(uint8)((uint32)((uint32)0xffU<<(8U-(offset)))&0xffU))              \
          ...
          :(((offset)==0U)?((uint8)((pnData)[0]&(uint8)((uint32)0xffU>>(lastbits)))               \
            |(uint8)((uint32)((uint32)(nValue)<<(8U-(lastbits)))&0xffU))                          \
              :((uint8)((pnData)[0]                                                               \
                &(uint8)((uint8)((uint32)((uint32)0xffU<<(8U-(offset)))&0xffU)|(uint8)((uint32)0xffU>>(lastbits))))\
...
#define E2EPW_PACK_BE_HELP3_2(lastbits, offset, pnData, nValue )                                  \
   do {                                                                                           \
      (pnData)[1] = ((lastbits)==8U)?((uint8)((uint32)(nValue)&0xffU))                            \
        :((uint8)((pnData)[1]&(uint8)((uint32)0xffU>>(lastbits)))                                 \
          |(uint8)(((uint32)((uint32)(nValue)<<(8U-(lastbits))))&0xffU));                         \
      (pnData)[0] = ((offset)==0U)?                                                               \
...
#define E2EPW_PACK_BE_HELP3_4(lastbits, offset, pnData, nValue )                                  \
   do {                                                                                           \
      (pnData)[3] = ((lastbits)==8U)?((uint8)((uint32)(nValue)&0xffU))                            \
        :((uint8)((pnData)[3]&(uint8)((uint32)0xffU>>(lastbits)))                                 \
          |(uint8)(((uint32)((uint32)(nValue)<<(8U-(lastbits))))&0xffU));                         \
...
#define E2EPW_PACK_LE_HELP3_1(lastbits, offset, pnData, nValue )                                        \
   do {                                                                                                 \
      (pnData)[0] = ((offset)==0U)?(((lastbits)==8U)?((uint8)((uint32)(nValue)&0xffU))                  \
        ...
        |(uint8)((pnData)[0]&(uint8)((uint32)0xffU>>(8U-(offset)))))                                    \
        :((uint8)((uint32)((uint32)((uint32)(nValue)<<(offset))&(uint32)(0xffU>>(8U-(lastbits))))&0xffU)\
        |(uint8)((pnData)[0]                                                                            \
        &(uint8)((uint8)(((uint32)((uint32)0xffU<<(lastbits)))&0xffU)|(uint8)((uint32)0xffU>>(8U-(offset)))))));\
   } while (0)
