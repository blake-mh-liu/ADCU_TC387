...
/* This file contains or includes all internal configuration dependent
...
#if ((DEM_DEV_ERROR_DETECT == STD_ON) || (DEM_DET_RUNTIME_CHECK == STD_ON))
...
#endif /* (DEM_DEV_ERROR_DETECT == STD_ON) || (DEM_DET_RUNTIME_CHECK == STD_ON) */
 ...
 ** functionality is available  */
     ...
     (DEM_OBD_CENTRALIZED_PID31_HANDLING == STD_OFF))
...
#if (defined DEM_REPORT_RUNTIME_ERROR)
#error DEM_REPORT_RUNTIME_ERROR already defined
#endif
/** \brief Macro for DET calls in Dem runtime error detection sections */
#if (DEM_BSW_DISTRIBUTION_FOR_BSW_EVENT_REPORTING == STD_ON)
#define DEM_REPORT_RUNTIME_ERROR(ApiId, ErrorId) \
  (void)Det_ReportRuntimeError(DEM_MODULE_ID, GetCoreID(), (ApiId), (ErrorId))
#else
/* !LINKSTO Dem.BSWDistribution.MultipleInstanceDetErrorHandling,1 */
#define DEM_REPORT_RUNTIME_ERROR(ApiId, ErrorId) \
...
/*------------------[Helper Macros for DTCFormat validation]----------------*/

#if (defined DEM_DTCFORMAT_MAX)
#error DEM_DTCFORMAT_MAX already defined
#endif
/** \brief Largest DTCFormat value (width of uint8 mask) */
#define DEM_DTCFORMAT_MAX DEM_DTC_FORMAT_OBD_3BYTE

#if (defined DEM_IS_VALID_DTCFMT)
#error DEM_IS_VALID_DTCFMT already defined
#endif
/** \brief Logical expression of the condition that the bit at index of "DTCFormat"
 ** is set in "Bitfield"
 */
#define DEM_IS_VALID_DTCFMT(Bitfield, DTCFormat) \
  (((DTCFormat) <= DEM_DTCFORMAT_MAX) && \
    (DEM_IS_ANY_BIT_SET(Bitfield, DEM_MASK_IDX_8(DTCFormat)) != 0U))
...
#else
#define DEM_STATUS_FAILED_MASK            0x20000U
#endif
...
#else
#define DEM_EVENT_STATUS_UNCONFIRMED_MASK 0x30000U
#endif
...
#else
#define DEM_EVENT_STATUS_CONFIRMED_MASK   0x10000U
#endif
...
#else
#define DEM_EVENT_STATUS_FFTOC_MASK       0x40000U
#endif

#if (defined DEM_EVENT_STATUS_DTC_TF_MASK)
#error DEM_EVENT_STATUS_DTC_TF_MASK is already defined
#endif /* DEM_EVENT_STATUS_DTC_TF_MASK */
#if (DEM_ERROR_QUEUE_EXTENDED == STD_OFF)
#define DEM_EVENT_STATUS_DTC_TF_MASK       0x1000U
#else
#define DEM_EVENT_STATUS_DTC_TF_MASK       0x80000U
#endif

#if (defined DEM_EVENT_STATUS_DTC_TFTOC_MASK)
#error DEM_EVENT_STATUS_DTC_TFTOC_MASK is already defined
#endif /* DEM_EVENT_STATUS_DTC_TFTOC_MASK */
#if (DEM_ERROR_QUEUE_EXTENDED == STD_OFF)
#define DEM_EVENT_STATUS_DTC_TFTOC_MASK    0x0800U
#else
#define DEM_EVENT_STATUS_DTC_TFTOC_MASK    0x100000U
#endif

#if (defined DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK)
#error DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK is already defined
#endif /* DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK */
#if (DEM_ERROR_QUEUE_EXTENDED == STD_OFF)
#if (DEM_OBDONUDS_FF_SUPPORT == STD_ON)
#define DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK    0x0400U
#else
#define DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK    0x1000U
#endif
#else /* (DEM_ERROR_QUEUE_EXTENDED == STD_OFF) */
#define DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK    0x200000U
#endif
...
#define DEM_CLEAR_EVENT_FFTOC(to) \
  DEM_CLR_MASK(Dem_ErrorQueueElementType, (to), DEM_EVENT_STATUS_FFTOC_MASK)

#if (defined DEM_SET_EVENT_DTC_TF)
#error DEM_SET_EVENT_DTC_TF is already defined
#endif /* DEM_SET_EVENT_DTC_TF */
#define DEM_SET_EVENT_DTC_TF(to) \
  DEM_SET_MASK((to), DEM_EVENT_STATUS_DTC_TF_MASK)

#if (defined DEM_SET_EVENT_DTC_TFTOC)
#error DEM_SET_EVENT_DTC_TFTOC is already defined
#endif /* DEM_SET_EVENT_DTC_TFTOC */
#define DEM_SET_EVENT_DTC_TFTOC(to) \
  DEM_SET_MASK((to), DEM_EVENT_STATUS_DTC_TFTOC_MASK)

#if (defined DEM_SET_EVENT_DTC_PDTC_WHILE_CDTC_NOT_SET)
#error DEM_SET_EVENT_DTC_PDTC_WHILE_CDTC_NOT_SET is already defined
#endif /* DEM_SET_EVENT_DTC_TFTOC */
#define DEM_SET_EVENT_DTC_PDTC_WHILE_CDTC_NOT_SET(to) \
  DEM_SET_MASK((to), DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK)
...
#if (defined DEM_IS_ST_BIT_TNCSLC_SET)
#error DEM_IS_ST_BIT_TNCSLC_SET is already defined
#endif /* DEM_IS_ST_BIT_TNCSLC_SET */
/** \brief Check if TNCSLC bit set in DTC status */
#define DEM_IS_ST_BIT_TNCSLC_SET(StatusByte) \
  DEM_IS_ANY_BIT_SET((StatusByte), DEM_UDS_STATUS_TNCSLC)
...
#define DEM_ERRORQUEUE_GET_EVID(ErrorQueueEntry) \
  ((uint16)((ErrorQueueEntry) & (uint16)DEM_ERRORQUEUE_EVID_MASK))
...
#if (defined DEM_ERRORQUEUE_GET_DTC_TF)
#error DEM_ERRORQUEUE_GET_DTC_TF already defined
#endif
/** \brief Get DTC TF flag in queued entry */
#define DEM_ERRORQUEUE_GET_DTC_TF(ErrorQueueEntry) \
  (DEM_IS_ANY_BIT_SET((ErrorQueueEntry), DEM_EVENT_STATUS_DTC_TF_MASK) ?\
   TRUE : FALSE)

#if (defined DEM_ERRORQUEUE_GET_DTC_TFTOC)
#error DEM_ERRORQUEUE_GET_DTC_TFTOC already defined
#endif
/** \brief Get DTC TFTOC flag in queued entry */
#define DEM_ERRORQUEUE_GET_DTC_TFTOC(ErrorQueueEntry) \
  (DEM_IS_ANY_BIT_SET((ErrorQueueEntry), DEM_EVENT_STATUS_DTC_TFTOC_MASK) ?\
   TRUE : FALSE)

#if (defined DEM_ERRORQUEUE_GET_DTC_PDTC_WHILE_CDTC_NOT_SET)
#error DEM_ERRORQUEUE_GET_DTC_PDTC_WHILE_CDTC_NOT_SET already defined
#endif
/** \brief Get DTC TFTOC flag in queued entry */
#define DEM_ERRORQUEUE_GET_DTC_PDTC_WHILE_CDTC_NOT_SET(ErrorQueueEntry) \
  (DEM_IS_ANY_BIT_SET((ErrorQueueEntry), DEM_EVENT_STATUS_DTC_PDTC_WHILE_CDTC_NOT_SET_MASK) ?\
   TRUE : FALSE)
...
/*------------[Helper macros for ResetEventStatus Suppression]--------------*/

#if (defined DEM_SET_RESISTANT_TF_STATUS_BIT)
#error DEM_SET_RESISTANT_TF_STATUS_BIT already defined
#endif

#if (DEM_IGNORE_RESET_EVENT_STATUS_FOR_ENTRY == STD_ON)
/* !LINKSTO dsn.Dem.IgnoreResetEventStatusForEntry.ResistantTFStatus.Macro,1 */
/** \brief Sets the reset resistant TF status bit of an event */
#define DEM_SET_RESISTANT_TF_STATUS_BIT(EventId) \
  (DEM_SET_BIT_IN_ARRAY(Dem_NvData.Dem_ResetStatusResistantTFStatus, EventId))
#else
/** \brief Empty macro if feature 'ignore ResetStatus' is disabled */
#define DEM_SET_RESISTANT_TF_STATUS_BIT(EventId)
#endif /* (DEM_IGNORE_RESET_EVENT_STATUS_FOR_ENTRY == STD_ON) */

#if (defined DEM_CLEAR_RESISTANT_TF_STATUS_BIT)
#error DEM_CLEAR_RESISTANT_TF_STATUS_BIT already defined
#endif

#if (DEM_IGNORE_RESET_EVENT_STATUS_FOR_ENTRY == STD_ON)
/* !LINKSTO dsn.Dem.IgnoreResetEventStatusForEntry.ResistantTFStatus.Macro,1 */
/** \brief Clears the reset resistant TF status bit of an event */
#define DEM_CLEAR_RESISTANT_TF_STATUS_BIT(EventId) \
  (DEM_CLR_BIT_IN_ARRAY(Dem_NvData.Dem_ResetStatusResistantTFStatus, EventId))
#else
/** \brief Empty macro if feature 'ignore ResetStatus' is disabled */
#define DEM_CLEAR_RESISTANT_TF_STATUS_BIT(EventId)
#endif /* (DEM_IGNORE_RESET_EVENT_STATUS_FOR_ENTRY == STD_ON) */
...
#if (defined DEM_IS_RESISTANT_TF_STATUS_BIT_SET)
#error DEM_IS_RESISTANT_TF_STATUS_BIT_SET already defined
#endif

/* !LINKSTO dsn.Dem.IgnoreResetEventStatusForEntry.ResistantTFStatus.Macro,1 */
/** \brief Check if the reset resistant TF status bit of an event is set */
#define DEM_IS_RESISTANT_TF_STATUS_BIT_SET(EventId) \
  (DEM_IS_BIT_SET_IN_ARRAY(Dem_NvData.Dem_ResetStatusResistantTFStatus, EventId))
#endif /* (DEM_IGNORE_RESET_EVENT_STATUS_FOR_ENTRY == STD_ON) */

#if (defined DEM_IS_CAPTURE_RELEVANT_TF_STATUS_BIT_SET)
#error DEM_IS_CAPTURE_RELEVANT_TF_STATUS_BIT_SET already defined
#endif

#if (DEM_IGNORE_RESET_EVENT_STATUS_FOR_ENTRY == STD_ON)
/** \brief Check if the reset resistant TF status bit of an event is set */
#define DEM_IS_CAPTURE_RELEVANT_TF_STATUS_BIT_SET(EventId) \
  (DEM_IS_RESISTANT_TF_STATUS_BIT_SET(EventId))
#else
/** \brief Check if the TF status bit of an event is set */
#define DEM_IS_CAPTURE_RELEVANT_TF_STATUS_BIT_SET(EventId) \
  (DEM_IS_EV_ST_BIT_TF_SET(EventId))
#endif

/*------------[Helper macros for OBD freeze frame]--------------------------*/
...
/** \brief Macro used to abstract the access to first occurrence OBDFFData from Dem_EntryOBDFF */
#define DEM_OBDFF_ENTRY_FFDATA_LINK(EvMemEntryIdx)   Dem_EntryOBDFF[(EvMemEntryIdx)].OBDFFData
/** \brief Macro used to abstract the access to last occurrence OBDFFData2 from Dem_EntryOBDFF */
#define DEM_OBDFF_ENTRY_FFDATA_2_LINK(EvMemEntryIdx)   Dem_EntryOBDFF[(EvMemEntryIdx)].OBDFFData2
...
/** \brief Macro used to abstract the access to first occurrence OBDFFData from Dem_NvData.OBDFF */
#define DEM_OBDFF_ENTRY_FFDATA_LINK(EvMemEntryIdx)   Dem_NvData.EntryOBDFF[(EvMemEntryIdx)].OBDFFData
/** \brief Macro used to abstract the access to last occurrence OBDFFData2 from Dem_NvData.OBDFF */
#define DEM_OBDFF_ENTRY_FFDATA_2_LINK(EvMemEntryIdx)   Dem_NvData.EntryOBDFF[(EvMemEntryIdx)].OBDFFData2
...
/** \brief Macro to set supported monitor bit for J1939 DEM_OBD_RDY_AC readiness */
#define DEM_J1939_SET_RDY_AC_SUPPORTED(PIDvalue) \
  (((PIDvalue)[1U]) |= (uint8)(1U << 4U))
/** \brief Macro to set readiness bits for J1939 DEM_OBD_RDY_AC readiness to 'Not Complete' value */
#define DEM_J1939_SET_RDY_AC_NOT_COMPLETE(PIDvalue) \
  (((PIDvalue)[2U]) |= (uint8)(1U << 4U))

#endif /* ((DEM_J1939_SUPPORT == STD_ON) && (DEM_J1939_READINESS1_SUPPORT == STD_ON)) */

#if (defined DEM_RGID_NOTSUPPORTED)
#error DEM_RGID_NOTSUPPORTED already defined
#endif
/** \brief Macro used to denote unsupported readiness groups */
#define DEM_RGID_NOTSUPPORTED 255U

#if (defined DEM_MAX_NUM_DTC_IN_PID)
#error DEM_MAX_NUM_DTC_IN_PID already defined
#endif
/** \brief Maximum number of confirmed DTCs reported by PID $01, $F401 and
 ** $F501 byte A, bits 0-6 */
#define DEM_MAX_NUM_DTC_IN_PID 0x7FU
...
#define DEM_RESET_READINESS_GROUP_ENABLED(ReadinessStatus) \
  ((ReadinessStatus) |= (DEM_RGP_RGMASK_PID01_PID41))
...
#if (defined DEM_RG_EVENTS_ARRAY_SIZE)
#error DEM_RG_EVENTS_ARRAY_SIZE already defined
#endif
/** \brief Size of the Dem_RGEvents bit-array */
#define DEM_RG_EVENTS_ARRAY_SIZE ((DEM_NUMBER_OF_EVENTS + 7U) / 8U)

#if (defined DEM_ARE_RG_FLAGS_UPDATED)
#error DEM_ARE_RG_FLAGS_UPDATED already defined
#endif
/** \brief Macro to check whether Dem_RGEvents[] flags were updated
 ** after Dem restart */
#define DEM_ARE_RG_FLAGS_UPDATED (DEM_IS_BIT_SET_IN_ARRAY(Dem_RGEvents, 0U))
...
#define DEM_IS_EVENT_PASSIVE(evMemEntryPtr, currentEventId, reportedEventID) \
        Dem_CheckForPassiveEvent(currentEventId)
#else
#define DEM_IS_EVENT_PASSIVE(evMemEntryPtr, currentEventId, reportedEventID)  \
...
#if (defined DEM_GBI_DTCCONFIDX)
#error DEM_GBI_DTCCONFIDX already defined
#endif
/** \brief Retrieves the index of the associated DTC in Dem_DTCDesc[].
 */
#if (DEM_DTCCONFIDX_OFFSET == 0U)
#define DEM_GBI_DTCCONFIDX(EventId)  Dem_EventDTCConfIdx[EventId]
#else
#define DEM_GBI_DTCCONFIDX(EventId) \
...
#define DEM_IS_EVENT_COMBINED(EventId) (DEM_GBI_DTCCONFIDX((EventId)) < DEM_NUM_CMB_DTCS)
...
#define DEM_IS_CMB_ST_BIT_SET(EventId, Mask) \
  DEM_IS_ANY_BIT_SET((Dem_CmbDTCStatus[DEM_GBI_DTCCONFIDX(EventId)]), (Mask))

#if (defined DEM_IS_DTC_COMBINED)
#error DEM_IS_DTC_COMBINED already defined
#endif
/** \brief check if a DTC is combined or not */
#define DEM_IS_DTC_COMBINED(DTCConfIdx) (DTCConfIdx < DEM_NUM_CMB_DTCS)

#if (defined DEM_IS_CMB_ST_BIT_SET_IN_DTC)
#error DEM_IS_CMB_ST_BIT_SET_IN_DTC already defined
#endif
/** \brief used at storing, aging and displacement of cmb events where the cmb DTC status
 * should be used instead of event status */
#define DEM_IS_CMB_ST_BIT_SET_IN_DTC(DTCConfIdx, Mask) \
  DEM_IS_ANY_BIT_SET((Dem_CmbDTCStatus[DTCConfIdx]), (Mask))
...
#if (DEM_NUM_CMB_DTCS > 0U)
#define DEM_GET_MASTER_EVID(EventId) Dem_GetMasterEventId(EventId)
#else
...
#if (DEM_NUM_CMB_DTCS > 0U)
#define DEM_GET_DTC_STATUS(EventId) Dem_GetCmbDtcStatus(EventId)
#else
...
#if (defined DEM_SEV_CONFIG_ARRAY_SIZE)
#error DEM_SEV_CONFIG_ARRAY_SIZE already defined
#endif
/** \brief Size of the SEV configuration bit-array: Dem_SevConfigArray[] */
#define DEM_SEV_CONFIG_ARRAY_SIZE ((DEM_NUMBER_OF_EVENTS + 7U) / 8U)
 ...
 */
/* !LINKSTO Dem.AdaptableConfirmationThreshold.NoIndicatorThreshold,1 */
...
#define DEM_GET_CALIBRATED_FAILURECYCLE_THRESHOLD(EventId, IndicatorClass) \
  ((IndicatorClass)->IsIndFailureCycleSrcEvent ? \
    (Dem_EventFailureCycleCfg[Dem_GbiEventFailureClassIdx((EventId))].EventFailureCycleCounterThreshold) : \
    (IndicatorClass)->FailureCycleThreshold)
...
#define DEM_VALID_DTC_FOR_EVENT_STORAGE(EventId) \
  ( (FALSE == Dem_IsInternalEvent((EventId))) )
#else
#define DEM_VALID_DTC_FOR_EVENT_STORAGE(EventId) \
  (DEM_NO_DTC != Dem_GbiUdsDTC((EventId)))
#endif
...
#if (defined DEM_GET_OBD_VARIANT)
#error DEM_GET_OBD_VARIANT already defined
#endif
/** \brief Get the active OBD variant */
#if (DEM_OBD_CLASSIC_SUPPORT && DEM_OBDONUDS_SUPPORT)
#define DEM_GET_OBD_VARIANT() (Dem_ActiveOBDVariant)
#else
#define DEM_GET_OBD_VARIANT() (DEM_OBD_VARIANT)
#endif
...
/*------------------[Helper Macros for Extended Error Queue]----------------*/
#if (DEM_ERROR_QUEUE_EXTENDED == STD_OFF)
#define DEM_ERRORQUEUE_READ(QueueIdx) Dem_ErrorQueue[(QueueIdx)]

#define DEM_ERRORQUEUE_WRITE(QueueIdx, QueueEntry)                         \
  do                                                                       \
  {                                                                        \
    Dem_ErrorQueue[(QueueIdx)] = (Dem_ErrorQueueEntryType)(QueueEntry);    \
  } while (0)

#else
#define DEM_ERRORQUEUE_READ(QueueIdx)                                      \
  (((Dem_ErrorQueueElementType)Dem_ErrorQueue[(QueueIdx)]) |               \
  (((Dem_ErrorQueueElementType)Dem_ErrorQueueExt[(QueueIdx)]) << 16U))

#define DEM_ERRORQUEUE_WRITE(QueueIdx, QueueEntry)                                     \
  do                                                                                   \
  {                                                                                    \
    Dem_ErrorQueue[(QueueIdx)] = (Dem_ErrorQueueEntryType)((QueueEntry) & 0xFFFFU);    \
    Dem_ErrorQueueExt[(QueueIdx)] =                                                    \
    (Dem_ErrorQueueEntryExtType)(((QueueEntry) >> 16U) & 0xFFU);                       \
  } while (0)
#endif

/*------------------[J1939 event configuration macros]----------------------*/

#if (defined DEM_J1939_NODE_IDX_OFFSET)
#error DEM_J1939_NODE_IDX_OFFSET already defined
#endif
/** \brief Macro holds offset value to retrieve index of J1939 Node Ids */
#define DEM_J1939_NODE_IDX_OFFSET 24U
 ...
 **
 ** Note: If DemEventConfirmationThresholdCounterAdaptable is enabled,
 ** the internal failure cycle counter is adaptable via the API
 ** Dem_SetEventConfirmationThresholdCounter() for the supporting events.
 **/
/* !LINKSTO dsn.Dem.OperationCycle.SetConfirmationThresholdCounter.RuntimeValue,1 */
...
#else /* (DEM_EVENT_CONFIRMATION_THRESHOLD_COUNTER_ADAPTABLE == STD_OFF) */
...
#define DEM_INTERN_EVT_FAILCYC_CTR_THRESHOLD(EventId, EventFailureClassIdx) \
  (Dem_EventClassDesc[DEM_GBI_EVENTCLASSDESCIDX(EventId)].EventFailureCycleCounterThreshold)
#endif
#endif /* DEM_EVENT_CONFIRMATION_THRESHOLD_COUNTER_ADAPTABLE */
...
/* !LINKSTO Dem.FaultConfirmation.Zerotrip.Config,1 */
/* !LINKSTO Dem.AdaptableConfirmationThreshold.ZeroTripEvent,1 */
#if (DEM_OPCYC_OBD_DCY_USED == STD_ON)
#if (DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_OFF)
#if (DEM_NUM_FAILURECYCLES == 0U)
#define DEM_IS_CYCLE_QUALIFIED(EventId) \
  (((Dem_GbiOpCycleIdx(EventId)) != DEM_OPCYC_OBD_DCY_ID) ? (boolean)TRUE : Dem_NvData.Dem_OpCycleDCYIsQualified)
#else
#define DEM_IS_CYCLE_QUALIFIED(EventId) \
  (((Dem_GbiOpCycleIdx(EventId)) != DEM_OPCYC_OBD_DCY_ID) ? \
  (boolean)TRUE : ((Dem_GbiEventFailureClassIdx(EventId) == DEM_NUM_FAILURECYCLES) ? \
                  (boolean)TRUE : ((DEM_INTERN_EVT_FAILCYC_CTR_THRESHOLD(EventId, Dem_GbiEventFailureClassIdx(EventId)) == 0U) ? \
                                  (boolean)TRUE : Dem_NvData.Dem_OpCycleDCYIsQualified)))
#endif
#else /* (DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_ON) */
#define DEM_IS_CYCLE_QUALIFIED(EventId) \
  (((Dem_GbiOpCycleIdx(EventId)) != DEM_OPCYC_OBD_DCY_ID) ? \
  (boolean)TRUE : ((DEM_INTERN_EVT_FAILCYC_CTR_THRESHOLD(EventId, Dem_GbiEventFailureClassIdx(EventId)) == 0U) ? \
                  (boolean)TRUE : Dem_NvData.Dem_OpCycleDCYIsQualified))
...
#if (defined DEM_OBD_DTC_3BYTE_MASK)
#error DEM_OBD_DTC_3BYTE_MASK already defined
#endif
/** \brief Mask of DTCValue3Byte in Dem_OBDConfig[] */
#define DEM_OBD_DTC_3BYTE_MASK ((1UL << DEM_OBD_DTC_3BYTE_WIDTH) - 1UL)
#endif /* (DEM_OBD_DTCVALUE3BYTE_SUPPORT == STD_ON) */

#if (defined DEM_MINRATIOEVENT_MASK)
#error DEM_MINRATIOEVENT_MASK already defined
#endif
/** \brief Mask of Min Ratio Event in Dem_OBDConfig[]
 *  used if DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_OFF
 */
...
#endif
/** \brief Width of Min Ratio Event in Dem_OBDConfig[]
 *  used if DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_OFF
 */
...
/** \brief Offset of Min Ratio Event in Dem_EventClassDesc[].Bitfield
  * used if DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_ON
  */
...
#define DEM_OBD_READINESS_MASK          0x1FU

#if (defined DEM_WWHOBD_DTCCLASS_MASK)
#error DEM_WWHOBD_DTCCLASS_MASK already defined
#endif
/** \brief Mask of WWHOBD DTC Class */
#define DEM_WWHOBD_DTCCLASS_MASK          0x07U
...
/*-------------------------------[OBDonUDS FF]------------------------------*/
#if (defined DEM_TRANSITION_EVENT_TFTOC)
#error DEM_TRANSITION_EVENT_TFTOC already defined
#endif
/** \brief Macro for bit 0 indicating that event TFTOC bit changed from 0 to 1 */
#define DEM_TRANSITION_EVENT_TFTOC    1U
#if (defined DEM_TRANSITION_DTC_TF)
#error DEM_TRANSITION_DTC_TF already defined
#endif
/** \brief Macro for bit 1 indicating that DTC TF bit changed from 0 to 1 */
#define DEM_TRANSITION_DTC_TF         2U
#if (defined DEM_TRANSITION_DTC_TFTOC)
#error DEM_TRANSITION_DTC_TFTOC already defined
#endif
/** \brief Macro for bit 2 indicating that DTC TFTOC bit changed from 0 to 1 */
#define DEM_TRANSITION_DTC_TFTOC      4U

#if (defined DEM_TRANSITION_DTC_PDTC_WHILE_CDTC_NOT_SET)
#error DEM_TRANSITION_DTC_PDTC_WHILE_CDTC_NOT_SET already defined
#endif
/** \brief Macro for bit 3 indicating that DTC PDTC bit changed from 0 to 1,
 *         while DTC CDTC bit was not set */
#define DEM_TRANSITION_DTC_PDTC_WHILE_CDTC_NOT_SET      8U

#if (defined DEM_SET_TRANSITION_EVENT_TFTOC)
#error DEM_SET_TRANSITION_EVENT_TFTOC is already defined
#endif /* DEM_SET_TRANSITION_EVENT_TFTOC */
#define DEM_SET_TRANSITION_EVENT_TFTOC(to) \
  DEM_SET_MASK((to), DEM_TRANSITION_EVENT_TFTOC)

#if (defined DEM_CLEAR_TRANSITION_EVENT_TFTOC)
#error DEM_CLEAR_TRANSITION_EVENT_TFTOC is already defined
#endif /* DEM_CLEAR_TRANSITION_EVENT_TFTOC */
#define DEM_CLEAR_TRANSITION_EVENT_TFTOC(to) \
  DEM_CLR_MASK(Dem_StatusTransitionType, (to), DEM_TRANSITION_EVENT_TFTOC)

#if (defined DEM_NUM_OBD_FF_OCCURRENCES)
#error DEM_NUM_OBD_FF_OCCURRENCES already defined
#endif
/** \brief Macro number of OBDonUDS FF occurrences */
#if (DEM_OBDONUDS_FF_SUPPORT == STD_ON)
#define DEM_NUM_OBD_FF_OCCURRENCES         2U
#else
#define DEM_NUM_OBD_FF_OCCURRENCES         1U
#endif

#if (defined DEM_OBD_FF_CONSIDERED_FIRST)
#error DEM_OBD_FF_CONSIDERED_FIRST already defined
#endif
/** \brief Macro index of first occurrence ObdFFConsidered flag */
#define DEM_OBD_FF_CONSIDERED_FIRST         0U
#if (defined DEM_OBD_FF_CONSIDERED_LAST)
#error DEM_OBD_FF_CONSIDERED_LAST already defined
#endif
/** \brief Macro index of last occurrence ObdFFConsidered flag */
#define DEM_OBD_FF_CONSIDERED_LAST          1U
...
#define DEM_RECORD_UPDATE_LOCKED(EventId) \
  (Dem_IsRecordUpdateLocked(EventId) == TRUE)
#else
#define DEM_RECORD_UPDATE_LOCKED(EventId) \
  (DEM_GET_MASTER_EVID(EventId) == Dem_EvIdOfLockedMemoryEntry[0U])
#endif
...
#if (defined DEM_IS_CLEAR_IS_FINISHED)
#error DEM_IS_CLEAR_IS_FINISHED already defined
#endif
/** \brief Checks if the ClearDTC operation is finished and ready to go back to IDLE state */
#define DEM_IS_CLEAR_FINISHED() \
  (DEM_CLEARDTC_STATE_FINISHED == Dem_ClearDtcAsyncStatus.RunState)

#if (defined DEM_IS_CLEAR_STARTED)
#error DEM_IS_CLEAR_STARTED already defined
#endif
/** \brief Checks if the ClearDTC operation is started and ready to go to PROCESSING_RAM state */
#define DEM_IS_CLEAR_STARTED() \
  (DEM_CLEARDTC_STATE_STARTED == Dem_ClearDtcAsyncStatus.RunState)
...
#if (defined DEM_PERMANENT_MEMORY_FILL_COND_MASK)
#error DEM_PERMANENT_MEMORY_FILL_COND_MASK already defined
#endif
/** \brief Mask value for the flag of the permanent memory entry (bit 15) */
#define DEM_PERMANENT_MEMORY_FILL_COND_MASK               0x8000U
...
#if (defined DEM_SET_PERMANENT_MEMORY_FILL_COND)
#error DEM_SET_PERMANENT_MEMORY_FILL_COND already defined
#endif
/** \brief Macro to mark that permanent memory was completely filled,
 ** but at least one entry was removed meanwhile */
#define DEM_SET_PERMANENT_MEMORY_FILL_COND(Entry)                \
  DEM_SET_MASK((Entry), DEM_PERMANENT_MEMORY_FILL_COND_MASK)

#if (defined DEM_CLR_PERMANENT_MEMORY_FILL_COND)
#error DEM_CLR_PERMANENT_MEMORY_FILL_COND already defined
#endif
/** \brief Macro to mark that "Passed Cycle" condition to erase the permanent
 ** DTC after ClearDTC is not satisfied */
#define DEM_CLR_PERMANENT_MEMORY_FILL_COND(Entry)                \
  DEM_CLR_MASK_16((Entry), DEM_PERMANENT_MEMORY_FILL_COND_MASK)

#if (defined DEM_GET_PERMANENT_MEMORY_FILL_COND)
#error DEM_GET_PERMANENT_MEMORY_FILL_COND already defined
#endif
/** \brief Macro to check whether "Passed Cycle" condition to erase the
 ** permanent DTC after ClearDTC is satisfied */
#define DEM_GET_PERMANENT_MEMORY_FILL_COND(Entry)                \
  DEM_IS_ANY_BIT_SET((Entry), DEM_PERMANENT_MEMORY_FILL_COND_MASK)
...
#if (defined DEM_IS_SECURITY_EVENT)
#error DEM_IS_SECURITY_EVENT already defined
#endif
/** \brief Macro to check if an event is DEM_EVENT_KIND_SEV */
#define DEM_IS_SECURITY_EVENT(EventId) \
  DEM_IS_BIT_SET_IN_ARRAY(Dem_SevConfigArray, EventId)
#endif
...
#if (defined DEM_AWIL_OFFSET)
#error DEM_AWIL_OFFSET already defined
#endif
/** \brief Macro to define the amber warning lamp bit offset in the lamp
 **  status bytes */
#define DEM_AWIL_OFFSET 2U

#if (defined DEM_RSIL_OFFSET)
#error DEM_RSIL_OFFSET already defined
#endif
/** \brief Macro to define the red stop lamp bit offset in the lamp
 **  status bytes */
#define DEM_RSIL_OFFSET 4U

#if (defined DEM_MIL_OFFSET)
#error DEM_MIL_OFFSET already defined
#endif
/** \brief Macro to define the Malfunction lamp bit offset in the lamp
 **  status bytes */
#define DEM_MIL_OFFSET 6U

#endif /* DEM_J1939_READING_DTC_SUPPORT == STD_ON */
#endif /* DEM_J1939_SUPPORT == STD_ON */

#if (defined DEM_CONFIG_EVENT_BIT_ARRAY_SIZE)
#error DEM_CONFIG_EVENT_BIT_ARRAY_SIZE already defined
#endif
/** \brief Generic size of an array of type uin8,
 **  which includes a bit for every configured event. */
#define DEM_CONFIG_EVENT_BIT_ARRAY_SIZE ((DEM_NUMBER_OF_EVENTS + 7U) / 8U)

/*==================[type definitions]======================================*/

/*------------------[pointer types]-----------------------------------------*/
/** \brief Function pointer type for generic 'Get[Visible]DTC' functions
...
/*------------------[definitions for Monitor Activity Ratio]-----------------*/

/** \brief Type used for the start index values of the MAR events associated
 ** to each MAR event combination
 **
 ** Used to access ::Dem_MAREvents[]. */
#if (DEM_NUM_MAR_EVENTS > 255U)
typedef uint16 Dem_MAREventIndexType;
#else
typedef uint8 Dem_MAREventIndexType;
#endif
#endif /* (DEM_MAR_SUPPORT == STD_ON) */

#if (DEM_MILGROUP_SUPPORT == STD_ON)
/*------------------[definitions for MIL groups]----------------------------*/

/** \brief Type used for MIL group start index values of the events associated
 ** to each MIL group
 **
 ** Used to access ::Dem_MILGroupStartIndex[]. */
#if (DEM_MILGROUP_NUM_GROUP > 255U)
typedef uint16 Dem_MILGroupIndexType;
#else
typedef uint8 Dem_MILGroupIndexType;
#endif

/** \brief Type used for index values of the MIL groups to which events are
 ** associated
 **
 ** Used to access ::Dem_MILGroupEventId[]. */
#if (DEM_MILGROUP_NUM_EVENTS > 255U)
typedef uint16 Dem_MILGroupEventIndexType;
#else
typedef uint8 Dem_MILGroupEventIndexType;
#endif

/** \brief Current event processing state
 **
 ** Range:: DEM_MILGROUP_FAILURE_COUNTER_UPDATE,
 **         DEM_MILGROUP_MIL_COUNTER_UPDATE,
 **         DEM_MILGROUP_ENTRY_ALLOCATION
 */
typedef uint8 Dem_MILGroup_EventProcessingStateType;

#if (defined DEM_MILGROUP_FAILURE_COUNTER_UPDATE)
#error DEM_MILGROUP_FAILURE_COUNTER_UPDATE already defined
#endif
/** \brief Internally used value to indicate that the current event is
 ** processed for failure counter update */
#define DEM_MILGROUP_FAILURE_COUNTER_UPDATE      0U

#if (defined DEM_MILGROUP_MIL_COUNTER_UPDATE)
#error DEM_MILGROUP_MIL_COUNTER_UPDATE already defined
#endif
/** \brief Internally used value to indicate that the current event is
 ** processed for MIL indicator counter update */
#define DEM_MILGROUP_MIL_COUNTER_UPDATE          1U

#if (defined DEM_MILGROUP_ENTRY_ALLOCATION)
#error DEM_MILGROUP_ENTRY_ALLOCATION already defined
#endif
/** \brief Internally used value to indicate that the current event is
 ** processed for memory entry allocation */
#define DEM_MILGROUP_ENTRY_ALLOCATION            2U
...
/** \brief Pointer to the event specific processing function evaluating each
 ** event for the required readiness groups */
typedef P2FUNC(void, DEM_CODE, Dem_RGProcessEvPtrType) (
 ...
 ** runtime error ::DEM_E_NODATAAVAILABLE to the DET and continuous his
 ** normal operation.
 */

/* !LINKSTO Dem.DataElementCCallback.Basic,1 */
...
/** \brief Pointer to function for read sint8 data element operations */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadData_sint8) (
  P2VAR(sint8, AUTOMATIC, DEM_APPL_DATA) Data);
/** \brief Pointer to function for read sint16 data element operations */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadData_sint16) (
  P2VAR(sint16, AUTOMATIC, DEM_APPL_DATA) Data);
/** \brief Pointer to function for read sint32 data element operations */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadData_sint32) (
  P2VAR(sint32, AUTOMATIC, DEM_APPL_DATA) Data);
/** \brief Pointer to function for read float32 data element operations */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadData_float32) (
  P2VAR(float32, AUTOMATIC, DEM_APPL_DATA) Data);

/* !LINKSTO Dem.DataElementCCallback.WithEventId,1 */
/** \brief Pointer to function for read uint8 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_uint8) (
  P2VAR(uint8, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
/** \brief Pointer to function for read uint16 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_uint16) (
  P2VAR(uint16, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
/** \brief Pointer to function for read uint32 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_uint32) (
  P2VAR(uint32, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
/** \brief Pointer to function for read sint8 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_sint8) (
  P2VAR(sint8, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
/** \brief Pointer to function for read sint16 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_sint16) (
  P2VAR(sint16, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
/** \brief Pointer to function for read sint32 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_sint32) (
  P2VAR(sint32, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
/** \brief Pointer to function for read float32 data element operations with EventId parameter */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_FuncPtrReadDataWithEventID_float32) (
  P2VAR(float32, AUTOMATIC, DEM_APPL_DATA) Data,
  Dem_EventIdType                        EventId);
...
typedef union
{
  ...
  /** \brief Rte_Read operation for UINT8 data element type                  **/
  Dem_FuncPtrReadData_uint8  Rte_Read_DataElement_uint8;
  /** \brief Rte_Read operation for UINT16 data element type                 **/
  Dem_FuncPtrReadData_uint16 Rte_Read_DataElement_uint16;
  /** \brief Rte_Read operation for UINT32 data element type                 **/
  Dem_FuncPtrReadData_uint32 Rte_Read_DataElement_uint32;
  /** \brief Rte_Read operation for SINT8 data element type                  **/
  Dem_FuncPtrReadData_sint8  Rte_Read_DataElement_sint8;
  /** \brief Rte_Read operation for SINT16 data element type                 **/
  Dem_FuncPtrReadData_sint16 Rte_Read_DataElement_sint16;
  /** \brief Rte_Read operation for SINT32 data element type                 **/
  Dem_FuncPtrReadData_sint32 Rte_Read_DataElement_sint32;
  /** \brief Rte_Read operation for FLOAT32 data element type                 **/
  Dem_FuncPtrReadData_float32 Rte_Read_DataElement_float32;
  /** \brief Rte_Read operation for UINT8 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_uint8  Rte_Read_DataElement_uint8_WithEventId;
  /** \brief Rte_Read operation for UINT16 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_uint16  Rte_Read_DataElement_uint16_WithEventId;
  /** \brief Rte_Read operation for UINT32 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_uint32  Rte_Read_DataElement_uint32_WithEventId;
  /** \brief Rte_Read operation for SINT8 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_sint8  Rte_Read_DataElement_sint8_WithEventId;
  /** \brief Rte_Read operation for SINT16 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_sint16  Rte_Read_DataElement_sint16_WithEventId;
  /** \brief Rte_Read operation for SINT32 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_sint32  Rte_Read_DataElement_sint32_WithEventId;
  /** \brief Rte_Read operation for FLOAT32 data element type with EventId parameter **/
  Dem_FuncPtrReadDataWithEventID_float32  Rte_Read_DataElement_float32_WithEventId;
...
typedef struct
{
  ...
  /* !LINKSTO dsn.Dem.FFCaptureOnDequalification.TriggerPointAndDataType,1 */
  const Dem_DataElementTriggerPointAndDataTypeType TriggerPointAndDataType;
                       /**< Data type and trigger point of the DataElement */
#if (DEM_DATA_ELEMENT_INTERFACE_WITH_EVENTID_SUPPORT == STD_ON)
  const uint8 EventIdSupport;              /**< EventID support is enabled */
#endif
#if (DEM_SR_SUPPORT == STD_ON)
  ...
  const uint8 CaptureOnRetrieval;
                 /**< DemDataElementCaptureOnRetrieval of the data element */
#endif
} Dem_DataElementType;
...
/*---------------[definitions for OBDonUDS FF]------------------------------*/
/** \brief Data type to hold information about the conditions that triggered event processing. */
typedef uint8 Dem_StatusTransitionType;
...
typedef struct
{
   ...
   * - i[1]:  ImmediateStorage     fixed size
   * - q[1]:  EvSignificance       fixed size
   * - x[2]:  free for future use
   *
   * Memory layout:
   * xxxx xxxx  xxxx xxxx  xxxx xxxx  xxxx xxxx
   * xxqi ssoo  dddd dddd  dddd dddd  dddd dddd
   */
   ...
   * - g[3]: DTCGroup              var size
   * - x[4]: free for future use
   *
   * Memory layout:
   * xxxx xxxx  xxxx xxxx  xxxx xxxx  xxxx xxxx
   * xxxx gggu  hhhh hhaa  eeee nntt  tttt tppp
   */
} Dem_DTCDescType;
...
typedef struct
{
   ...
   * - f[5]: EventFailureClassIdx   var size
   * - o[2]: OpCycleIdx             var size (unused if calibration and common operation cycle is enabled)
   * - p[8]: DTCConfIdx             var size (DTCConfIdx is available only if it can be accomodated in 32 bit size)
   *
   * Memory layout:
   * xxxx xxxx  xxxx xxxx  xxxx xxxx  xxxx xxxx
...
#if ( (DEM_COMMON_OPERATION_CYCLE_SUPPORT == STD_OFF) || \
      (DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_OFF) )
...
/** \brief Function pointer type for generic "ClearDtcNotification callback"
 ** function
 **
 ** This prototype is identical for C- and RTE-callbacks. */
/* !LINKSTO Dem.SWS_Dem_91002,1 */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_CbFuncPtrClearDTCNotifType) (
  uint32            DTC,
...
/* !LINKSTO Dem.SWS_Dem_91042,1 */
/** \brief Function pointer type for generic "EventSyncStorageProcessed C-callback"
 ** function */
typedef P2FUNC(Std_ReturnType, DEM_APPL_CODE, Dem_CbFuncPtrSevSyncStoreProcType) (void);
...
typedef struct
{
  ...
  /* !LINKSTO dsn.Dem.ASR431.DTCFilterType.CurrentFilterType,2 */
  uint8                           CurrentFilterType;            /**< Filter's type and validity */
  /* !LINKSTO dsn.Dem.ASR21-11.DTCFilterType.ExtDataFilter,1 */
  uint8                           ExtendedDataRecordNumber;            /**< EDRN to filter with */
  /* !LINKSTO dsn.Dem.ASR21-11.DTCFilterType.ReadinessFilter,1 */
  Dem_EventOBDReadinessGroupType  ReadinessGroupNumber;                 /**< RGN to filter with */
...
typedef struct
{
  ...
  boolean                    ObdFFConsidered[DEM_NUM_OBD_FF_OCCURRENCES];     /**< Flag used to
                                                       recognize whether the OBD FF records were
...
/*------------------[Immediate storage event memory entry block types]-------*/
 ...
 **
 ** Type to store the J1939 DTC value and index of node ID for each configured
 ** event.
 ** Three lower bytes are used for DTC value and highest byte is used for
 ** index of node ID.
 */
...
/** \brief Data type defining the readiness kind (PID $01, PID $F501, J1939Readiness1) */
typedef uint8 Dem_ReadinessType;

#if (defined DEM_RGP_READINESS_PID01)
#error DEM_RGP_READINESS_PID01 already defined
#endif
/** \brief Id of PID $01 used for Dem_RgpCalcSelectedReadiness() */
#define DEM_RGP_READINESS_PID01  0x00U

#if (defined DEM_RGP_READINESS_PID41)
#error DEM_RGP_READINESS_PID41 already defined
#endif
/** \brief Id of PID $41 used for Dem_RgpCalcSelectedReadiness() */
#define DEM_RGP_READINESS_PID41  0x01U

#if (defined DEM_RGP_READINESS_PIDF501)
#error DEM_RGP_READINESS_PIDF501 already defined
#endif
/** \brief Id of PID $F501 used for Dem_RgpCalcSelectedReadiness() */
#define DEM_RGP_READINESS_PIDF501  0x02U

#if (defined DEM_RGP_READINESS_J1939READINESS1)
#error DEM_RGP_READINESS_J1939READINESS1 already defined
#endif
/** \brief Id of J1939Readiness1 used for Dem_RgpCalcSelectedReadiness() */
#define DEM_RGP_READINESS_J1939READINESS1  0x03U

/** \brief Data type defining clear notification at the
           begining or end of the clear */
typedef uint8 Dem_ClearStatusType;

#if (defined DEM_CLEAR_START)
#error DEM_CLEAR_START already defined
#endif
/** \brief Notification is at the start of the clear */
#define DEM_CLEAR_START  0x00U

#if (defined DEM_CLEAR_FINISH)
#error DEM_CLEAR_FINISH already defined
#endif
/** \brief Notification is at the end of the clear */
#define DEM_CLEAR_FINISH  0x01U

#if (defined DEM_J1939_READINESS1_CALCULATION_SUPPORT)
#error DEM_J1939_READINESS1_CALCULATION_SUPPORT already defined
#endif
#endif

/** \brief Macro indicating if J1939Readiness1 calculation is required */
#if ((DEM_J1939_READINESS1_SUPPORT == STD_ON) && \
     (defined DEM_RGP_NUM_J1939_READINESS_NODES) && \
     (DEM_RGP_NUM_J1939_READINESS_NODES > 0))

#define DEM_J1939_READINESS1_CALCULATION_SUPPORT  STD_ON

#else

#define DEM_J1939_READINESS1_CALCULATION_SUPPORT  STD_OFF
...
/** \brief Function which update the role of the given indicator cycle counter
 **
 ** \param[in] Dem_IndicatorIdType Address the indicator
 ** \param[in] CounterDataIdx  Address the indicator
 ** \param[in] CounterDataRole New role
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_SetCycleCounterRole(
  Dem_IndicatorIdType              IndicatorId,
  Dem_CounterDataIdxType           CounterDataIdx,
  Dem_IndicatorCounterDataRoleType CounterDataRole);

/** \brief Function to check the warning indicator On-Criteria of an event
 **
 ** \param[in] IndicatorIdx  Index of Indicator for which the On-Criteria is checked
 ** \param[in] EventId       Id of the event for which the On-Criteria is checked
 **
 ** \return Boolean value indicating whether Warning indicator On-Criteria is
 **         fulfilled or not.
 ** \retval TRUE   Warning indicator On-Criteria is fulfilled
 ** \retval FALSE  Warning indicator On-Criteria is not fulfilled
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(boolean, DEM_CODE) Dem_CheckWIROnCriteriaFulfilled(
  Dem_IndicatorIdxType IndicatorIdx,
  Dem_EventIdType      EventId);
...
#if (DEM_OBD_Support == STD_ON)
/** \brief Check if MIL may be activated for a specific event
 **
 ** Internal function for checking if the MIL may be activated for a specific event.
 ** This internal function determines the relevant DTC format, checks whether the
 ** relevant DTC is suppressed and whether the event is emission-related, to decide
 ** if MIL activation is allowed.
 **
 ** \param[in] EventId    EventId of an event for which MIL activation is checked
 **
 ** \return Boolean indicating if MIL may be activated
 ** \retval TRUE    MIL activation is allowed
 ** \retval FALSE   MIL activation is NOT allowed
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(boolean, DEM_CODE) Dem_MILActivationAllowed(
  Dem_EventIdType   EventId);
#endif /* DEM_OBD_Support == STD_ON */

#if (DEM_OBDONUDS_COMBINATION_ENABLED == STD_ON)
/** \brief Function which processes the common MIL counter when
 **        OBDonUDS combination is enabled
 **
 ** It is used by Dem_ProcessIndicatorFailureCycleCounter().
 **
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_ProcessCommonMILOnCriteria(
  Dem_IndicatorIdxType IndicatorIdx,
  Dem_EventIdType      EventId);
...
#if (DEM_FREEZE_FRAME_CAPTURE != DEM_TRIGGER_ON_FDC_THRESHOLD)
/** \brief This function checks if any of the bits provided via
 **  Mask are set in the DTC status byte of the given EventId.
 **  For combined events it checks the combined DTC status.
 **
 ** \param[in] EventId  0 < EventId <= DEM_MAX_EVENTID
 ** \param[in] Mask: flag mask to be checked
 **
 ** \return Boolean value indicating if the given status bit is set
 ** \retval TRUE   Status bit is set
 ** \retval FALSE  Status bit is not set
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(boolean, DEM_CODE) Dem_IsAnyDTCStatusBitSet(
  Dem_EventIdType                      EventId,
  uint8                                Mask);
...
/** \brief Internal function to wrap multi-event triggering functionality
 **
 ** This helper function is called by the API Dem_SetEventAvailable().
 **
 ...
 **
 ** \param[in]    EventId  0 < EventId <= DEM_MAX_EVENTID
 ** \param[inout] EventStatus, reported before (in) and after debouncing (out)
 **               In case of error or no qualification,
 **               the out-value is set to DEM_EVENT_STATUS_UNQUALIFIED.
 **               Otherwise to DEM_EVENT_STATUS_PASSED, DEM_EVENT_STATUS_FAILED
 **               or DEM_EVENT_STATUS_UNCONFIRMED/DEM_EVENT_STATUS_FDC_THRESHOLD_REACHED
 **               (if supported).
 **
 ** \return success of the operation
 ** \retval DEM_E_DET_REPORT  A Pre-Qualified status was reported
 **                           (DEM_EVENT_STATUS_PREPASSED or DEM_EVENT_STATUS_PREFAILED)
 **                           by an event with monitor internal debouncing.
 ** \retval E_OK              Otherwise.
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_DebounceEvent(
  Dem_EventIdType                                  EventId,
...
#if (DEM_NUM_CMB_DTCS > 0U)
/** \brief Calculates the combined DTCStatus for the DTC associated with
 **  the given DTCConfIdx
 **
 ** \param[in] DTCConfIdx  DTCConfIdx of event, for which the combined DTC status
 **                        is to be updated.
 ** \param[in] ResetCmbPDTC  ResetCmbPDTC value decides whether combined PDTC bit
                             needs to be reset.
 ** \return Updated combined DTC
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Dem_EventStatusExtendedType, DEM_CODE) Dem_CalculateCmbDTCStatus(Dem_DTCConfIdxType DTCConfIdx, boolean ResetCmbPDTC);
 ...
 **
 ** \return success of operation
 ** \retval E_OK     The function always returns E_OK, except for the case when
                     development errors are identified during debouncing
 ** \retval E_NOT_OK Only when development errors are identified during debouncing
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_ReportErrorStatusPreInit(
      Dem_EventInfoType EventInfo,
      Dem_EventStatusType EventStatus);
#endif
...
#if (DEM_OBDONUDS_COMBINATION_ENABLED == STD_ON)
/** \brief Given a combined DTC, the function checks if an event entry exists in the error-queue
 ** for any of the events in combination with a failed status,
 ** in case the OBDonUDS event combination is enabled
 **
 ** \param[in] EventId  An Event Id for one of the events in combination that should be checked
 **
 ** \return Boolean value indicating presence of one of the combined events in error-queue
 ** \retval TRUE  one of the combined events is already present in the error-queue
 **               with a failed status
 ** \retval FALSE none of the combined events is present in the error-queue with a failed status
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(boolean, DEM_CODE) Dem_CheckErrQueueEntryForFailedCmbEvents(Dem_EventIdType EventId);
#endif /* DEM_OBDONUDS_COMBINATION_ENABLED == STD_ON */
 ...
 ** - DTC setting allowed
 ** It is called by the Dem_InternalSetEventStatus(),
 ** Dem_InternalProcessEventReport() and Dem_ReportErrorStatusPreInit()
 **
 ** \param[in] EventId  0 < EventId <= DEM_MAX_EVENTID
 **
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_CheckProcessingConditions(
  Dem_EventIdType EventId);
...
/** \brief Function to get the size of an extended data by the given extended
 **  data segment, only parts that requires memory storage (i.e excluding
 **  internal data elements and data elements with enabled CaptureOnRetrieval)
 **
 ** \param[in] EDSegment
 **
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Dem_SizeEDType, DEM_CODE) Dem_SizeOfStoredDEsInSegment(
...
/** \brief Function to get the size of non stored DEs (internal values mapped
 **  to an extended data segment plus DEs with enabled CaptureOnRetrieval)
 **
 ** \param[in] EDSegment
 **
 ** \return Size of mapped internal values plus data elements with enabled
 **         CaptureOnRetrieval. This along with the size returned by
 **         Dem_SizeOfStoredDEsInSegment() gives the size required for storing
 **         the assembled extended data segment (record).
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Dem_SizeEDType, DEM_CODE) Dem_SizeOfNonStoredDEsInSegment(
  P2CONST(Dem_EDSegmentType, AUTOMATIC, DEM_CONST) EDSegment);
#endif
 ...
 ** \param[in] PassMasterEventIdToDECallOut  determines whether to pass Master
 **                                          EventId to Capture on Retrieval
 **                                          external DE callouts.
  ** \param[in] CriticalSectionActive        determines whether critical section
 **                                          is active or not.
 **
...
#if (DEM_EXTENDED_DATA_CAPTURE == DEM_TRIGGER_ON_FDC_THRESHOLD)
/** \brief Function to process the event aging
 **
 ** \param[in] EventId      Id of the event for aging needs to be processed
 ** \param[in] EvMemEntry   Pointer to event memory entry
 **
 ** \return none
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_ProcessEventAging(
  Dem_EventIdType                        EventId,
  Dem_EventMemoryEntryPtrType            EvMemEntry);
#endif
#endif
 ...
 **
 ** \param[in] EventId    0 < EventId <= DEM_MAX_EVENTID
 ** \param[in] CaptureBuffer    Buffer to capture single OBD freeze frame.
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 */
...
/** \brief Function to store a complete J1939 freeze frame at the
 ...
 ** \param[in] CapturedDataSize  Size of the captured data
 ** \param[in] EventId  The Id of the event which triggered the
 **                     capture of the J1939FreezeFrame
 ** \param[out] EvMemEntryPtr  Pointer to event memory entry where to store
 **                           data
 ** \param[out] Notification  Information for delayed status notifications
 **
 ** \Reentrancy{Non reentrant}
...
/** \brief Function to capture J1939 freeze frame data into
 ** the provided buffer.
 **
 ** It shall not be called from within the critical section
 **
 ** \param[in] EventId  Id of the event for which FreezeFrame is captured
 ** \param[in] CaptureBuffer  Buffer to capture J1939FF freeze frame
 **
 ** \param[out] J1939FFSize  J1939FF size
 **
 ** \return Result of J1939FF capture
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_CaptureJ1939FF(
  Dem_EventIdType                                          EventId,
...
/** \brief Get the DTC value for either the provided single event or one of
 ** the available combined events
 **
 ** This function handles both single and combined events. Since all combined
 ** events refer to the same DTC, the DTC suppression status remains consistent
 ** across all combined events. Hence, it is optimal to first check the
 ** suppression status of the DTC and then verify the availability of the
 ** single event or each combined event.
 **
 ** \param[in] DTCFormat  Selects the DTC format.
 ** \param[in] EventId    0 < EventId <= DEM_MAX_EVENTID
 **
 ** \return DEM_NO_DTC in the following scenarios:
 ** if the DTC is suppressed,
 ** if the single event is not available or if none of the events in the event
 ** combination are available, or if no DTC is assigned to the single event or
 ** any of the available combined events, or the selected DTCFormat is not
 ** applicable for the activated OBD variant
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
...
/* !LINKSTO Dem_OBD_0001,2 */
#if (DEM_OBD_Support == STD_ON)
/** \brief Get OBD DTC value from ::Dem_OBDDTC by using index.
 **
...
#if (DEM_OBD_DTCVALUE3BYTE_SUPPORT == STD_ON)
/** \brief Get 3-byte OBD DTC value from ::Dem_OBDConfig[] by using index
 **
 ** This function reads the assigned 3-byte OBD DTC regardless of the event
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(uint32, DEM_CODE) Dem_GetObdDTCValue3Byte(Dem_EventIdType EventId);

/** \brief Get 3-byte OBD DTC value from ::Dem_OBDConfig[] by using index if the event is enabled
 ** and the DTC is not suppressed
 **
 ** \param[in] EventId  0 < EventId <= DEM_MAX_EVENTID
 **
 ** \return DEM_NO_DTC if the event is not available or no 3-byte OBD DTC is assigned to
 **         the event or if the 3-byte OBD DTC is suppressed, otherwise the assigned
 **         3-byte OBD DTC value
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(uint32, DEM_CODE) Dem_GetVisibleObdDTCValue3Byte(Dem_EventIdType EventId);
#endif /* (DEM_OBD_DTCVALUE3BYTE_SUPPORT == STD_ON) */

/** \brief Get DTC kind for given Event
 **
 ** \param[in] EventId  0 < EventId <= DEM_MAX_EVENTID
 **
 ** \return DTC kind
 ** \retval ::DEM_DTC_KIND_EMISSION_REL_DTCS  A 2-byte or 3-byte OBD DTC is
 **                                           assigned to the event
 ** \retval ::DEM_DTC_KIND_ALL_DTCS           Otherwise
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
...
/** \brief Checks if an event is an internal event
 **
 ** This function checks if any DTC is assigned to an event. If no DTC
 ** is configured or calibrated for the event, it is identified as
 ** internal event.
 **
 ** \param[in] EventId  0 < EventId <= DEM_MAX_EVENTID
 **
 ** \return Boolean value indicating whether an event is an internal event or not
 ** \retval TRUE   The event is an internal event
 ** \retval FALSE  The event is not an internal event
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(boolean, DEM_CODE) Dem_IsInternalEvent(
  Dem_EventIdType EventId);
...
/* !LINKSTO dsn.Dem.OBD.config.MinRatioEvent.0002,1 */
extern FUNC(boolean, DEM_CODE) Dem_GbiMinRatioEvent(Dem_EventIdType EventId);

/** \brief Function to map readiness data to the desired output layout
 **
 ** The function maps the supported and ready information from positional
 ** bit fields into the provided output buffer. The desired output layout
 ** is specified by the given RGBitPosMap.
 **
 ** \param[in]    RGSupported      Support status of the readiness group.
 ** \param[in]    RGReady          Ready status of the readiness group.
 ** \param[in]    NeededGroupsMask Mask indicating which readiness groups are
                                   required for the output.
 ** \param[in]    RGBitPosMap      Structure which describes the bit position
 **                                within 'Buffer' where the support and ready
 **                                info for each readiness group has to be stored.
 ** \param[out]   Buffer           Output buffer for the mapped readiness data.
 **
 ** \return none
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_RgpMapOutputData(
  uint32                                                 RGSupported,
  uint32                                                 RGReady,
...
/** \brief Initializes the readiness group processor's internal data.
 **
 ** \return none
 **
 ** \Reentrancy{Non-Reentrant}
...
extern FUNC(void, DEM_CODE)  Dem_InitReadinessGroupProcessor(void);

#if (DEM_READINESS_CALCULATION_SUPPORT == STD_ON)
/** \brief Function to calculate readiness information
 **
 ** Calculates the supported and ready bits for the applicable readiness groups
 ** of the selected readiness type and stores the result in NV data.
 **
 ** \param[in]    ReadinessId       Readiness Id of targeted readiness calculation API.
 ** \param[in]    Node              Filter specific attribute which is currently
 **                                 used only for J1939Readiness1.
 ** \param[out]   RGSupported       Positional bit mask containing the supported
 **                                 status of the readiness groups.
 ** \param[out]   RGReady           Positional bit mask containing the ready
 **                                 status of the readiness groups.
 **
 ** \return none
 **
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_RgpCalcSelectedReadiness(
  Dem_ReadinessType                    ReadinessId,
  uint8                                Node,
  P2VAR(uint32, AUTOMATIC, AUTOMATIC)  RGSupported,
  P2VAR(uint32, AUTOMATIC, AUTOMATIC)  RGReady);

/** \brief Function notify Readiness Group Processor about the start
 **        of the operation cycle
 **
 ** This function resets the enable status of the readiness groups, and
 ** calculates the readiness status for PID $01, PID $F501 and J1939Readiness1
 ** and store them in their respective places in the Dem_NvData.
 **
 ** \return none
 **
 ** \Reentrancy{Non-Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_RgpNotifyDCYStart(void);

/** \brief Function to notify Readiness Group Processor about a ClearDTC
 **        operation
 **
 ** Function to notify the RGP with the start and end of the
 ** clear operation.
 **
 ** \param[in]   ClearState State of the clear if it is Started or Finished.
 ** \param[in]   CallSID    SID of the API triggering the notification.
 ** \param[in]   Filter     filtering attribute for J1939 node.
 **
 ** \return none
 **
 ** \Reentrancy{Non-Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_RgpNotifyClearReadiness(
  uint8                     ServiceID,
...
#if (DEM_OBDONUDS_SUPPORT)
/** \brief Function to count the DTCs matching the filter criteria
 **
 ** This function counts the number of DTCs corresponding to the events assigned
 ** to the readiness group defined by the filter criteria set with
 ** Dem_SetDTCFilterByReadinessGroup().
 ** The DTC corresponding to combined events is counted only once, for the
 ** master event. Identical OBD DTCs are counted for each event/group of
 ** combined events that match the filtering criteria.
 **
 ** \param[in]  ReadinessGroupNumber   Readiness group number used as filtering
 **                                    criteria.
 ** \param[in]  DTCFormat              DTC format of the requested data.
 ** \param[out] NumOfFilteredDTCs      The number of DTCs matching the filter
 **                                    criteria.
 ** \return The number of DTCs matching the filter criteria.
 **
 ** \Reentrancy{Non-Reentrant}
 ** \Synchronicity{Synchronous}
 */
extern FUNC(uint16, DEM_CODE) Dem_RgpGetNumDTCForRG(
  Dem_EventOBDReadinessGroupType  ReadinessGroupNumber,
  Dem_DTCFormatType               DTCFormat);

/** \brief Function to get the next DTC that matches the filter criteria
 **
 ** This function gets the next DTC that matches the filter criteria set with
 ** Dem_SetDTCFilterByReadinessGroup().
 **
 ** \param[in]    ReadinessGroupNumber Readiness group number used as filtering
 **                                    criteria.
 ** \param[in]    DTCFormat            DTC format of the requested data.
 ** \param[inout] NextItem             Indicates the next event id or the next
 **                                    index of Dem_OBDReadinessGroup[]
 **                                    array from which the search for the next
 **                                    matching DTC is resumed.
 ** \param[out]   DTCStatus            Receives the status information of the
 **                                    DTC corresponding to the next event
 **                                    assigned to the readiness group defined
 **                                    by the filter criteria.
 ** \param[out]   DTC                  Receives the DTC value corresponding to
 **                                    the next event assigned to the readiness
 **                                    group defined by the filter criteria.
 **
 ** \return success of operation
 ** \retval E_OK:                Successfuly returned next DTC.
 ** \retval DEM_NO_SUCH_ELEMENT: No further DTC that matches the filter criteria
 **                              was found.
 **
 ** \Reentrancy{Non-Reentrant}
 ** \Synchronicity{Asynchronous}
 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_RgpGetNextDTCForRG(
  Dem_EventOBDReadinessGroupType                     ReadinessGroupNumber,
  Dem_DTCFormatType                                  DTCFormat,
...
#if (DEM_DTC_WWHOBD_CLASS_SUPPORT == STD_ON)
/** \brief Get DTC Class information of Event */
extern FUNC(Dem_DTCSeverityType, DEM_CODE) Dem_GbiDTCClass(
  Dem_EventIdType EventId);
#endif

#if (DEM_VCC_OCC5_USED == STD_ON)
/** \brief Function to get the OBD Aging CYcle Counter Threshold of an Event */
extern FUNC(Dem_AgingCyclesType, DEM_CODE) Dem_GbiOBDAgingCycleCounterThreshold(
  Dem_EventIdType EventId);
...
#if (DEM_NUM_CMB_DTCS > 0U)
/** \brief Retrieves the master of the event combination to which the given
 ** event belongs. If the given event is a single event, then the function
 ** returns that event.
 **
 ** \param[in] EventId  0 < EventId <= DEM_MAX_EVENTID
 **
 ** \return Associated Master EventId
 */
 extern FUNC(Dem_EventIdType, DEM_CODE) Dem_GetMasterEventId(Dem_EventIdType EventId);

/** \brief Retrieves the DTC status byte of a combined event or single event. If
 ** the given event is single event, then function returns the status of DTC
 ** mapped to the event. In case the given event is master or slave event of an
 ** event combination the status of the mapped combined DTC is retrieved.
 **
 ** \param[in] EventId of the event for which combined DTC status is requested
 **
 ** \return DTC status of the combined event
 */
 extern FUNC(Dem_DTCStatusMaskType, DEM_CODE) Dem_GetCmbDtcStatus(Dem_EventIdType EventId);

/** \brief Function to check if an event is a passive event. In case of single events the
 ** check for TF bit set in the status of DTC mapped to the event is done. In case
 ** of combined events the check for TF bit set in the status of combined DTC mapped
 ** to the event is done.
 **
 ** \param[in] EventId of the event for which combined DTC status is requested
 **
 ** \return boolean TRUE: Incase combined event is a passive event.
 **                 FALSE: Incase combined event is not a passive event.
 */
 extern FUNC(boolean, DEM_CODE) Dem_CheckForPassiveEvent(Dem_EventIdType EventId);
#endif
 ...
 **
 ** Checks combined DTC Status change. If status changed triggers
 ** Dem_CbTriggerOnDTCStatus().
 **
 **
 ** \param[in] EventId          EventId for which the DTC status change callbacks
 **                             shall be triggered.
 ** \param[in] OldDTCStatusMask The DTC status before the changes that triggered
 **                             the callbacks.
 ** \param[in] NewDTCStatusMask The updated DTC status.
 */
extern FUNC(void, DEM_CODE) Dem_InternalCheckOnCmbDTCStatusChange(
  Dem_EventIdType       EventId,
...
/** \brief Function to get the callback DemCallbackEventSyncStorageProcessed
 ** for the given security event
 **
 ** \param[in] EventId  EventId of the security event, for which the callback
 **                     shall be returned.
 **
 ** \return Function pointer to requested callback
 */
extern FUNC(Dem_CbFuncPtrSevSyncStoreProcType, DEM_CODE) Dem_GetSevSyncStoreProcCb(
  Dem_EventIdType EventId);
#endif
...
#if (DEM_MILGROUP_SUPPORT == STD_ON)
/** \brief Get MIL group index from Dem_MILGroupIndexPerEvent[] array
 **
 ** \param[in] EventId  Id of the event
 **
 ** \return Dem_MILGroupIndexType value representing the index of the MIL group
 **         in Dem_MILGroupStartIndex[] to which the event is assigned. If the
 **         event is not assigned to a MIL group then
 **         DEM_MILGROUP_GROUP_IDX_INVALID will be returned.
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(Dem_MILGroupIndexType, DEM_CODE) Dem_GbiMILGroupIndex(
  Dem_EventIdType EventId);

/** \brief Function to reset the MIL group counter and also the MIL
 ** indicator counters and event failure counters for all events in the group
 **
 ...
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(void, DEM_CODE) Dem_MILGroupResetGroupCounter(
...
/** \brief Updates the content of J1939Readiness1 for an event
 **
 ...
 ** readiness group for J1939Readiness1.
 **
 ...
 **                             for a given readiness group has not yet started
 ...
 ** \Synchronicity{Synchronous}
 */
extern FUNC(void, DEM_CODE) Dem_RGCalcPerEventJ1939Readiness1(
  Dem_OBDReadinessGroupType                         RgId,
  Dem_EventIdType                                   EventId,
  uint8                                             Filter,
  P2VAR(boolean, AUTOMATIC, AUTOMATIC)              Supported,
...
/** \brief Get the index of the selected node
 **
 ** Internal function used for readiness calculation to get the index
 ** of the selected node.
 **
 ** \param[in] Node  A valid J1939Nm node
 **
 ** \return The index of node within array Dem_RGP_J1939NmNodes[]
 */
extern FUNC(uint8, DEM_CODE) Dem_GetJ1939RGPNodeIdx(uint8 Node);
...
#if (DEM_NUMBER_OF_CLIENTS > 1)
/** \brief Checks status of DTC record update for the current event
 **
 ** \param[in] EventId  Identification of an Event.
 **
 ** \return if DTC record update for current event is locked return TRUE, otherwise return FALSE.
 **
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(boolean, DEM_CODE)Dem_IsRecordUpdateLocked(Dem_EventIdType EventId);
#endif

/** \brief Set return result for the client currently holding the ClearDTC process lock
 **
 ** \param[in] Result result value to be set.
 **
 ** \return none
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(void, DEM_CODE) Dem_SetClearDTCResult(Std_ReturnType Result);

/** \brief Check if the event entry must be created/updated and set the
 **        transition bits that are required during entry processing.
 **
 ** \param[in]    EventId  Identifies the currently processed event.
 ** \param[in]    EventStatus  Status of the event.
 ** \param[inout] TransitionType Bit mask holding the applicable status
 **                              bit transitions.
 **
 ** \return Boolean
 ** \retval TRUE  Event entry must be created/updated.
 ** \retval FALSE Event entry processing not needed.
 **
 ** \Reentrancy{Non reentrant}
 ** \Synchronicity{Synchronous}
 **/
extern FUNC(boolean, DEM_CODE) Dem_CheckEntryProcessingConditions(
  Dem_EventIdType                                        EventId,
  Dem_EventStatusType                                    EventStatus,
...
extern CONST(Dem_EventIdType, DEM_CONST_CALIBRATION)
  Dem_OBDReadinessGroup[DEM_RGP_MAX_NUM_READINESS_EVENTS];
...
/** \brief Array holding the offset to the next readiness group segment in the
 ** Dem_OBDReadinessGroup[] array. */
extern CONST(uint16, DEM_CONST)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_IndicatorClassType, DEM_CONST_CALIBRATION)
...
#if (DEM_NUM_INDICATOR_GROUPS > 1U)
#define DEM_START_SEC_CONST_UNSPECIFIED
#include <Dem_MemMap.h>
...
#if (DEM_CALIBRATION_WITHOUTEVCOMB_SUPPORT == STD_OFF)
/* Deviation MISRAC2012-2 */
extern CONST(Dem_IndicatorGrpIdxType, DEM_CONST_CALIBRATION)
...
/** \brief Holds the events for which MAR data is tracked, i.e., events that
 ** have the EDRN 0x93 configured.
 **
 ** Number of elements: ::DEM_NUM_MAR_EVENTS
 */
extern CONST(Dem_EventIdType, DEM_CONST) Dem_MAREvents[DEM_NUM_MAR_EVENTS];
...
/** \brief This array contains the indices of the first event from each
 ** MAR event combination stored in Dem_MAREvents[]. The last element contains
 ** an invalid value to indicate the end of the last MAR event combination.
 **
 ** Number of elements: ::DEM_NUM_MAR_CMB_DTCS + 1
 */
extern CONST(Dem_MAREventIndexType, DEM_CONST)
  Dem_MAREventCombinationIdx[DEM_NUM_MAR_CMB_DTCS + 1U];
#endif /* (DEM_NUM_MAR_CMB_DTCS > 0U) */

#if ((DEM_NUM_MAR_EVENTS > 255U) || (DEM_NUM_MAR_CMB_DTCS == 0U))
#define DEM_STOP_SEC_CONST_16
#include <Dem_MemMap.h>
#else
#define DEM_STOP_SEC_CONST_8
...
/** \brief Array containing all EventIds assigned to any MIL group
 ** sorted/grouped by MIL groups
 **
 ** Number of elements: ::DEM_MILGROUP_NUM_EVENTS
 */
extern CONST(Dem_EventIdType, DEM_CONST)
  Dem_MILGroupEventId[DEM_MILGROUP_NUM_EVENTS];

#if (DEM_MILGROUP_NUM_EVENTS <= 255U)
/* Note: DEM_MILGROUP_NUM_EVENTS is always >= DEM_MILGROUP_NUM_GROUP, therefore
   uint8 is used for both Dem_MILGroupIndexType and Dem_MILGroupEventIndexType,
   when DEM_MILGROUP_NUM_EVENTS <= 255 */
#define DEM_STOP_SEC_CONST_16
#include <Dem_MemMap.h>
...
/** \brief This array contains the indices of the first event from each
 ** MIL group held in Dem_MILGroupEventId[]. The last element contains an
 ** invalid value to indicate the end of the last group.
 **
 ** Number of elements: ::DEM_MILGROUP_NUM_GROUP + 1
 */
extern CONST(Dem_MILGroupEventIndexType, DEM_CONST)
  Dem_MILGroupStartIndex[DEM_MILGROUP_NUM_GROUP + 1U];

#if ((DEM_MILGROUP_NUM_EVENTS > 255U) && (DEM_MILGROUP_NUM_GROUP <= 255U))
#define DEM_STOP_SEC_CONST_16
#include <Dem_MemMap.h>
...
/** \brief This array contains the indices of the MIL groups to which the
 ** corresponding events are assigned. If an event is not assigned to a MIL
 ** group, then the array will contain the DEM_MILGROUP_GROUP_IDX_INVALID value
 ** for the corresponding event.
 **
 ** Number of elements: ::DEM_NUMBER_OF_EVENTS
 */
extern CONST(Dem_MILGroupIndexType, DEM_CONST)
  Dem_MILGroupIndexPerEvent[DEM_NUMBER_OF_EVENTS];
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_DebounceCounterClassType, DEM_CONST_CALIBRATION)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_DebounceCounterClassIdxType, DEM_CONST_CALIBRATION)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_DebounceTimeClassType, DEM_CONST_CALIBRATION)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_DebounceTimeClassIdxType, DEM_CONST_CALIBRATION)
...
/* Deviation MISRAC2012-2 */
extern CONST(Dem_EventFailureCycleCfgType, DEM_CONST_CALIBRATION)
 ...
 **  if DemEventConfirmationThresholdCounterAdaptable is enabled and set to true.
 */
extern CONST(uint8, DEM_CONST) Dem_ConfirmThresholdAdaptable[DEM_CONFIG_EVENT_BIT_ARRAY_SIZE];
#endif
...
#if (DEM_START_CLEAR_DTC_NOTIFICATION_SIZE != 0U)
/** \brief Generic callback function pointer table for ClearDTCNotification START */
extern CONST(Dem_CbFuncPtrClearDTCNotifType, DEM_CONST)
  Dem_CbFuncPtrStartClearDTCNotif[DEM_START_CLEAR_DTC_NOTIFICATION_SIZE];
#endif

#if (DEM_FINISH_CLEAR_DTC_NOTIFICATION_SIZE != 0U)
/** \brief Generic callback function pointer table for ClearDTCNotification FINISH */
extern CONST(Dem_CbFuncPtrClearDTCNotifType, DEM_CONST)
  Dem_CbFuncPtrFinishClearDTCNotif[DEM_FINISH_CLEAR_DTC_NOTIFICATION_SIZE];
#endif
...
#if (DEM_NUM_SEV_WITH_SYNC_STORE_PROC_CB != 0U)
/** \brief C-Callback function pointer table for EventSyncStorageProcessed */
extern CONST(Dem_CbFuncPtrSevSyncStoreProcType, DEM_CONST)
  Dem_CbFncPtrSevSyncStoreProc[DEM_NUM_SEV_WITH_SYNC_STORE_PROC_CB];
#endif
...
#if (DEM_NUM_SEV_WITH_SYNC_STORE_PROC_CB != 0U)
/** \brief C-Callback function lookup table for DemCallbackEventSyncStorageProcessedFnc */
extern CONST(Dem_EventIdType, DEM_CONST)
  Dem_SevWithSyncStoreProcCb[DEM_NUM_SEV_WITH_SYNC_STORE_PROC_CB];
#endif
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_PidClassType, DEM_CONST_CALIBRATION)
  Dem_PidClass[DEM_NUM_OF_PIDS_IN_OBDFF];
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_AdvDisplPassiveTableLinePassiveEventsType, DEM_CONST_CALIBRATION)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_EventDescDevFFType, DEM_CONST_CALIBRATION)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_FFClassIdxType, DEM_CONST_CALIBRATION)
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_EventClassDescType, DEM_CONST_CALIBRATION)
...
#if ((DEM_EVENT_COMBINATION_SUPPORT == DEM_EVCOMB_TYPE1) && (DEM_DTCCONFIDX_OFFSET == 0U))
#if (DEM_DTCCONFIDX_WIDTH <= 8U)
#define DEM_START_SEC_CONST_8
#include <Dem_MemMap.h>

/** \brief table which holds the DTC configuration index */
extern CONST(Dem_DTCConfIdxType, DEM_CONST) Dem_EventDTCConfIdx[DEM_NUMBER_OF_EVENTS];
 ...
 */
/* Deviation MISRAC2012-2 */
extern CONST(Dem_EventDescType, DEM_CONST_CALIBRATION)
 ...
 **
 ** This array contains DTC related configuration data for
...
#include <Dem_MemMap.h>
/* Deviation MISRAC2012-2 */
extern CONST(Dem_DTCDescType, DEM_CONST_CALIBRATION) Dem_DTCDesc[DEM_NUMBER_OF_DTCS];
...
/* Deviation MISRAC2012-2 */
extern CONST(uint8, DEM_CONST_CALIBRATION)
  Dem_EventEnabled[DEM_EVENT_ENABLED_ARRAY_SIZE];
#endif
...
/* Deviation MISRAC2012-2 */
extern CONST(uint8, DEM_CONST_CALIBRATION) Dem_ObdReadinessForceCompleteMask;
#endif
...
/* Deviation MISRAC2012-2 */
extern CONST(uint8, DEM_CONST_CALIBRATION) Dem_ObdReadinessPID41ByteB;
#endif
#if ( (DEM_OBD_Support == STD_ON) || (DEM_J1939_READINESS1_SUPPORT == STD_ON) )

/* Deviation MISRAC2012-2 */
extern CONST(uint8, DEM_CONST_CALIBRATION) Dem_ObdCompliancyPID1CByte;
#endif
#define DEM_STOP_SEC_CALIB_8
#include <Dem_MemMap.h>

#if (DEM_SEM_SUPPORT == STD_ON)
/* !LINKSTO dsn.Dem.Sem.ConfigArray,1 */
#define DEM_START_SEC_CONST_8
#include <Dem_MemMap.h>

/*------------------[Array for DemEventKind: Sev]---------------------*/
/** \brief Array holding the information for every event, if DemEventKind
 ** is set to DEM_EVENT_KIND_SEV.
 */
extern CONST(uint8, DEM_CONST) Dem_SevConfigArray[DEM_SEV_CONFIG_ARRAY_SIZE];
...
extern  VAR(Dem_ErrorQueueEntryExtType, DEM_VAR_CLEARED) Dem_ErrorQueueExt[DEM_BSW_ERROR_BUFFER_SIZE];
#endif
 ...
 ** is enabled (unlocked).
 */
extern VAR(Dem_EventIdType, DEM_VAR_CLEARED) Dem_EvIdOfLockedMemoryEntry[DEM_NUMBER_OF_CLIENTS];
...
extern VAR(Dem_DTCSelectionType, DEM_VAR_CLEARED) Dem_ClearDTCSelection;
 ...
 **
 ** holds the index of the next available entry in DTC record locking (EventID/ClientId) arrays.
 ** It also serves a secondary purpose of keeping such DTC record locking arrays gapless,
 ** i.e when removing elements from the array, the gap is filled with the last used array element
 ** (i.e index equal to Dem_DTCRecordLockingNextFreeIndex -1)
 */
extern VAR(uint8, DEM_VAR_CLEARED) Dem_DTCRecordLockingNextFreeIndex;
#endif

/** \brief Array to store ClearDTC process results per requesting client */
extern VAR(Std_ReturnType, DEM_VAR_CLEARED) Dem_ClearDTCResult
...
extern VAR(uint8, DEM_VAR_CLEARED) Dem_RGEvents[DEM_RG_EVENTS_ARRAY_SIZE];
#endif

#if (DEM_CALIBRATION_SUPPORT == STD_ON)
/** \brief DTC severity availability mask derived from DTC severity and
 ** WWH-OBD DTC class, when calibration is enabled */
 /* !LINKSTO dsn.Dem.DTCSeverity.AvailabilityMask,1 */
extern VAR(uint8, DEM_VAR_CLEARED) Dem_SeverityAvailabilityMask;

/** \brief Indicates whether Dem_SeverityAvailabilityMask was updated
 ** after Dem restart, or not, when calibration is enabled */
 /* !LINKSTO dsn.Dem.DTCSeverity.IsMaskUpdated,1 */
extern VAR(boolean, DEM_VAR_CLEARED) Dem_IsSeverityMaskUpdated;
#endif

#if (DEM_EVENT_CONFIRMATION_THRESHOLD_COUNTER_ADAPTABLE == STD_ON)
/*----------------[Adaptable Event Failure/Confirmation Thresholds]---------*/
/** \brief Currently valid DemEventFailureCycleCounterThreshold for each event
 ** This RAM array is used if DemEventConfirmationThresholdCounterAdaptable
 ** is enabled for at least one event. */
extern VAR(uint8, DEM_VAR_CLEARED)
          Dem_ConfirmationThresholdRuntime[DEM_NUMBER_OF_EVENTS];
...
extern VAR(uint8, DEM_VAR) Dem_ActiveOBDVariant;
#endif
