 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00179,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00181,1 */
...
#if ((DEM_INCLUDE_RTE == STD_OFF) || (DEM_DEFAULT_ASR_SERVICE_API != DEM_SERVICE_API_ASR2011) || (!defined DEM_INTERNAL))
...
/** \brief Sets event as failed and captures a snapshot record.
 **
 ** If called the Dem sets the event to failed and this failed event
 ** requires that a snapshot record is captured, the Dem synchronously
 ** retrieves the data within the call of this API. Depending on
 ** configuration, the data may be retrieved asynchronously.
 **
 ** \param[in] EventId  Identification of an Event by assigned Event ID.
 **                     The Event ID is configured in the Dem.
 **
 ** \ServiceID{::DEM_SID_SetEventFailedWithSyncFreezeFrame}
 ** \Reentrancy{Reentrant for different EventIds.
 **             Non reentrant for the same EventId.}
 ** \Synchronicity{Synchronous/Asynchronous}
 */
/* !LINKSTO Dem.Sem.Dem_SetEventFailedWithSyncFreezeFrame,1 */
extern FUNC(void, DEM_CODE) Dem_SetEventFailedWithSyncFreezeFrame(
...
/* If the RTE is not used, the declaration of the Dem_SetEventStatus API
 * shall be visible in the Dem.h file.
 * If RTE is used:
 * - The declaration is generated automatically by the RTE if the number of SWC events
 *   is larger than zero.
 * - If there is no configured SWC events and the reporting of the BSW events via
 *   Dem_SetEventStatus API is enabled, the declaration shall be done in the Dem.h file.
 */
#if ( (DEM_INCLUDE_RTE == STD_OFF) || \
      ( (DEM_NUM_SWC_EVENTS == 0) && (DEM_REPORT_BSW_EVENTS_VIA_SET_EVENT_STATUS == STD_ON) ) )

/** \brief Processes the events reported by SW-Cs or BSW modules
 **
 ** This API provides a service for reporting monitor status information to the Dem.
 ** This service shall be used to report an Event Status as soon as a new test result is available.
 ** This Service stores the event in the Event Memory.
 **
 ** This API is called by SW-Cs or BSW modules.
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00185,3 */
 ...
 **
 ** Dem shall be called by the SW-Component as soon as it detects the restart of the Operation Cycle.
 **
 ...
 **
 ** \ServiceID{::DEM_SID_RestartOperationCycle}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.OperationCycle.RestartOperationCycle.API,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00554,1 */
 ...
 **
 */
/* !LINKSTO Dem.SWS_Dem_00831,1 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00839,1 */
 ...
 ** \param[in]    EventId   Identification of an Event by assigned Event ID
 **                         The Event ID is configured in the Dem
 ** \param[in]    RecordNumber  This parameter is a unique identifier
 **                         for a freeze frame record as defined in ISO14229-1
 **                         0xFF means most recent freeze frame record is returned
 **                         0x00 is only supported if the Dem module supports WWH-OBD
 ** \param[in]    DataId    This parameter specifies the DID that shall be
 ...
 ** \param[in,out] BufSize   When the function is called this parameter contains
 ...
 **                               stored (but the request was valid) OR
 **                               The requested record number is not
 **                               supported by the event OR The requested
 **                               DID is not supported by the freeze frame
 ** \retval DEM_BUFFER_TOO_SMALL  The provided buffer size is too small
 **
 ** \ServiceID{::DEM_SID_GetEventFreezeFrameDataEx}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.SWS_Dem_01191,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_01191,1 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_ASR42_GetEventFreezeFrameDataEx(
  Dem_EventIdType                         EventId,
  uint8                                   RecordNumber,
  uint16                                  DataId,
  P2VAR(uint8, AUTOMATIC, DEM_APPL_DATA)  DestBuffer,
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_01190,1 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_ASR42_GetEventExtendedDataRecordEx(
  Dem_EventIdType                         EventId,
  uint8                                   RecordNumber,
  P2VAR(uint8, AUTOMATIC, DEM_APPL_DATA)  DestBuffer,
  P2VAR(uint16, AUTOMATIC, DEM_APPL_DATA) BufSize);
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00203,2 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_GetFaultDetectionCounter(
  ...
  P2VAR(sint8, AUTOMATIC, DEM_APPL_DATA) FaultDetectionCounter);
      ...
      ( (DEM_DEFAULT_ASR_SERVICE_API == DEM_SERVICE_API_ASR2011) && \
        (DEM_ENABLE_ASR40_SERVICE_API ==STD_OFF) && (DEM_ENABLE_ASR42_SERVICE_API == STD_OFF) ) )
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00194,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00195,1 */
...
#if ( (DEM_INCLUDE_RTE == STD_OFF) || (!defined DEM_INTERNAL) || \
      ( (DEM_ENABLE_ASR43_SERVICE_API == STD_OFF) && (DEM_DEFAULT_ASR_SERVICE_API != DEM_SERVICE_API_ASR2011) ) )
/** \brief Gets the current UDS status byte assigned to the DTC for the event
 **
 ** This API shall be used to read the current UDS status byte from the Dem. This API is
 ** provided to be used by SW-Components or other basic software modules e.g. FiM.
 **
 ** \param[in] EventId  Identification of an event by assigned EventId.
 ** \param[out] UDSStatusByte  UDS DTC status byte of the requested event (refer to chapter
 ...
 ** \retval E_NOT_OK get of event status failed
 **
 ** \ServiceID{::DEM_SID_GetEventUdsStatus}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00196,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00197,1 */
 ...
 **                     that can be either in OBD DTC format, UDS DTC format, or,
 **                     if OBDonUDS with OBD/UDS DTC separation is configured,
 **                     in OBD_3BYTE DTC format.
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00198,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00201,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00046,2 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00205,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00558,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00557,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00652,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00586,1 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00589,2 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00312,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00740,1 */
/* !LINKSTO Dem.ASR41.SWS_Dem_00725,1 */
 ...
 ** conditions among the OBD relevant ECUs, the API is used to forward the
 ** condition status to a Dem of a particular ECU.
 **
 ** With this API, the Dem is informed whether the specified condition is
 ** currently fulfilled (ConditionStatus DEM_IUMPR_DEN_STATUS_REACHED) or not
 ** (ConditionStatus DEM_IUMPR_DEN_STATUS_NOT_REACHED).
 ** The ConditionStatus DEM_IUMPR_DEN_STATUS_INHIBITED is used to indicate
 ** that the specified condition is inhibited and cannot be reached. This
 ** inhibition can be reported in any state, but it cannot be undone for the
 ** current driving cycle. The API no longer accepts another request for this
 ** condition until the end of the current cycle and returns E_NOT_OK.
 ** The condition status is automatically reset to DEM_IUMPR_DEN_STATUS_NOT_REACHED
 ** when a new driving cycle is started.

 ** Notes:
 ** - The general denominator condition reported via this API is relevant for
 **   the denominator and numerator update of the Monitor Activity Data (see
 **   chapter "Monitor Activity Data/Ratio" in the Diagnostic Stack user's
 **   guide).
 ** - This API currently supports the ConditionId ::DEM_IUMPR_GENERAL_OBDCOND
 **   if Monitor Activity data is supported and returns E_NOT_OK otherwise.
 **
 ** \param[in] ConditionId      Identification of a IUMPR denominator condition ID
 **                             (General Denominator, Cold start, EVAP, 500mi).
 ** \param[in] ConditionStatus  Status of the IUMPR denominator condition
 ...
 ** \retval E_NOT_OK  set of IUMPR denominator condition failed or could not be
 **                   accepted.
 **
 ** \ServiceID{::DEM_SID_SetIUMPRDenCondition}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.SWS_Dem_00717,1 */
/* !LINKSTO Dem.ASR21-11.SWS_Dem_00733,1 */
...
/** \brief In order to communicate the status of the (additional) denominator
 ** conditions among the OBD relevant ECUs, the API is used to retrieve the
 ** condition status from the Dem of the ECU where the conditions are computed.
 ** API is needed in OBD-relevant ECUs only.
 **
 ** Note: Functionality is partially implemented. The API retrieves the denominator
 ** condition status only if it is invoked with the ConditionId argument as
 ** DEM_IUMPR_GENERAL_OBDCOND. Otherwise, the API returns E_NOT_OK
 ** and the out parameter ConditionStatus does not contain valid data.
 **
 ** \param[in] ConditionId      Identification of a IUMPR denominator condition ID
 **                             (General Denominator, Cold start, EVAP, 500mi).
 ** \param[out] ConditionStatus  Status of the IUMPR denominator condition
 **                             (Not-reached, reached, not reachable / inhibited).
 ** \return success of operation
 ** \retval E_OK      get of IUMPR denominator condition was successful.
 ** \retval E_NOT_OK  get of condition status failed.
 **
 ** \ServiceID{::DEM_SID_GetIUMPRDenCondition}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
...
/** \brief The function resets the selected performance monitor counters
 **
 ** \param[in] CountersKind     Identifies the set of performance counters
 **                             requested to be reset.
 ** \return success of operation
 ** \retval E_OK      the selected performance counters were successfully reset
 ** \retval E_NOT_OK  indicates an invalid or unsupported request.
 **
 ** \ServiceID{::DEM_SID_ResetPerformanceCounters}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.OBD.ResetPerformanceCounters.API,1 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_ResetPerformanceCounters(
  Dem_PerformanceCountersKindType CountersKind);
#endif

/* !LINKSTO Dem.ASR43.SWS_Dem_01080,1 */
...
#if ( (DEM_INCLUDE_RTE == STD_OFF) || (!defined DEM_INTERNAL) || \
      (DEM_EVENT_CONFIRMATION_THRESHOLD_COUNTER_ADAPTABLE == STD_OFF) )
 ...
 ** \retval E_NOT_OK Threshold cannot be changed as DemEvent
 **                  ConfirmationThresholdCounterAdaptable is set to FALSE
 **                  for this event.
 **
 ** \ServiceID{::DEM_SID_SetEventConfirmationThresholdCounter}
 ** \Reentrancy{Reentrant for different EventIds. Non reentrant for the same EventId.}
 ** \Synchronicity{Aynchronous}
 */
/* !LINKSTO Dem.SWS_Dem_91004,1 */
 ...
 ** the next call of any set DTC filter API or Dem_Init().
 **
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR431.SetDTCFilter.Signature,1 */
...
/** \brief Allows filtering for DTCs with extended data record
 ** number information.
 **
 ** This API shall be used for the API's
 ** Dem_GetNumberOfFilteredDTC() and Dem_GetNextFilteredDTC().
 ** The function resets the internal counter to the first event that
 ** matches the filter settings until the next call of any set DTC
 ** filter API or Dem_Init().
 **
 ** Note: This API must only be used by the Dcm module!
 ** \param[in] ClientId   Unique client ID, assigned to the instance of the
 **                       calling module
 ** \param[in] DTCFormat  Defines the DTC format of the requested data.
 **                       Valid selections are DEM_DTC_FORMAT_UDS and
 **                       DEM_DTC_FORMAT_OBD_3BYTE.
 ** \param[in] ExtendedDataRecordNumber  The extended data record number the
 **                       filter is set for. Valid values are within the
 **                       range of 0x01 and 0xFD.
 **
 ** \return Status of the operation to set DTC filter by extended data
 **         record number
 ** \retval E_OK DTC filter for requested extended data record
 **              successfully set.
 ** \retval E_NOT_OK Indicates an invalid extended data record number
 **                  was selected.
 **
 ** \ServiceID{::DEM_SID_DTCFilterByExtDataRecordNumber}
 ** \Reentrancy{Reentrant for different client IDs. Non reentrant for the same
 **  client ID.}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR21-11.SWS_Dem_91192,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR43.SWS_Dem_00209,1 */
 ...
 **
 ** The API shall be used to get the DTC Severity availability mask, i.e.
 ** the DTC severity information (according to ISO14229) supported by the Dem.
 **
 ** Note: This API must only be used by the Dcm module!
 ** \param[in]  ClientId         Unique client id, assigned to the instance of
 **                              the calling module.
 ** \param[out] DTCSeverityMask  The value DTCSeverityMask indicates the supported
 ...
 ** \Synchronicity{Asynchronous}
 */
/* !LINKSTO Dem.ASR21-11.SWS_Dem_00061,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.EnableDTCRecordUpdate,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.SelectExtendedDataRecord,1 */
...
/* !LINKSTO Dem.ASR21-11.SWS_Dem_91050,1 */
/** \brief Service to report the value of monitor activity denominator PID
 **        computed by the Dem.
 **
 ** Note: This API must only be used by the Dcm module!
 **
 ** \param[in]     OpStatus            Only DCM_INITIAL will appear, because
 **                                    this API behaves synchronous.
 ** \param[in,out] DataValueBufferSize The maximum number of data bytes that can
 **                                    be written to the DataValueBuffer. When
 **                                    the function returns, the value is
 **                                    updated with the actual number of data
 **                                    bytes that are written to the
 **                                    DataValueBuffer.
 ** \param[out]    DataValueBuffer     Buffer containing the contents of the
 **                                    monitor activity denominator. The buffer
 **                                    is provided by the caller with the
 **                                    appropriate size.
 **
 ** \retval Always E_OK is returned.
 **
 ** \ServiceID{::DEM_SID_DcmGetInfoTypeValue79}
 ** \Reentrancy{Non Reentrant}
 ** \Synchronicity{Synchronous}
 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00318,2, dsn.Dem.OBDPid01.DemReadDataOfPID01,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR40.SWS_Dem_00319,2 */
...
/*------------------[OBDonUDS-specific Interfaces]--------------------------*/

/* !LINKSTO Dem.SetDTCFilterByReadinessGroup.OBDonUDS,1 */
#if (DEM_OBDONUDS_SUPPORT)
/** \brief Service to report the value of PID $F501 computed by the Dem.
 **
 ** Note: This API must only be used by the Dcm module!
 ** \param[out] PIDF501value  Buffer containing the contents of PID $F501
 **                           computed by Dem.
 **
 ** \return Status of the operation of type ::Std_ReturnType
 ** \retval E_OK Always E_OK is returned, as E_NOT_OK will never appear.
 **
 ** \ServiceID{::DEM_SID_DcmReadDataOfPIDF501}
 ** \Reentrancy{Reentrant}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR21-11.SWS_Dem_91051,1 */
extern FUNC(Std_ReturnType, DEM_CODE) Dem_DcmReadDataOfPIDF501(
  P2VAR(uint8, AUTOMATIC, DEM_APPL_DATA) PIDF501value);

/** \brief Allows filtering for DTCs based on a given DTC readiness group on the
 **        primary fault memory.
 **
 ** This API sets the DTC filter for the subsequent calls of the APIs
 ** Dem_GetNumberOfFilteredDTC() and Dem_GetNextFilteredDTC().
 ** The function resets the internal counter to the first event that
 ** matches the filter settings until the next call of any set DTC
 ** filter API or Dem_Init().
 ...
 **                       Valid selections are DEM_DTC_FORMAT_UDS and
 **                       DEM_DTC_FORMAT_OBD_3BYTE.
 ** \param[in] ReadinessGroupNumber  Specifies the DTC readiness group number
 **                       defined by SAE J1979-DA
 **
 ** \return Status of the operation to set DTC filter by DTC readiness group
 ** \retval E_OK         DTC filter for requested DTC readiness group
 **                      successfully set.
 ** \retval E_NOT_OK     Indicates an invalid DTC readiness group
 **                      was selected.
 **
 ** \ServiceID{::DEM_SID_SetDTCFilterByReadinessGroup}
 ** \Reentrancy{Reentrant for different client IDs. Non reentrant for the same
 **  client ID.}
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR21-11.SWS_Dem_91193,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00970,1 */
 ...
 ** \Synchronicity{Asynchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00976,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00977,1 */
 ...
 ** \Synchronicity{Synchronous}
 */
/* !LINKSTO Dem.ASR42.SWS_Dem_00982,1 */
