...
#endif
/** \brief START_STOP_SYNCH command parameter "mode = start selected". */
...
#endif
/** \brief START_STOP_SYNCH command parameter "mode = stop select". */
...
#if (defined XCP_SUPPORT_FOR_CMD_CTO_PDU_BIT)
#error XCP_SUPPORT_FOR_CMD_CTO_PDU_BIT already defined
#endif
/** \brief Bit indicating that the support for CMD CTO packages. */
#define XCP_SUPPORT_FOR_CMD_CTO_PDU_BIT                     0U
...
#define XCP_SUPPORT_FOR_CMD_CTO_PDU                         (1U << XCP_SUPPORT_FOR_CMD_CTO_PDU_BIT)

#if (defined XCP_SUPPORT_FOR_STIM_DTO_PDU_BIT)
#error XCP_SUPPORT_FOR_STIM_DTO_PDU_BIT already defined
#endif
/** \brief Bit indicating that the support for STIM DTO packages. */
#define XCP_SUPPORT_FOR_STIM_DTO_PDU_BIT                        1U
...
#define XCP_SUPPORT_FOR_STIM_DTO_PDU                        (1U << XCP_SUPPORT_FOR_STIM_DTO_PDU_BIT)

#if (defined XCP_ENABLE_STATE_DYNAMIC_RX_PDU_BIT)
#error XCP_ENABLE_STATE_DYNAMIC_RX_PDU_BIT already defined
#endif
/** \brief Bit indicating that the dynamic reception Pdu is
    in state ENABLE*/
#define XCP_ENABLE_STATE_DYNAMIC_RX_PDU_BIT                 4U
...
/** \brief Flag indicating that the dynamic reception Pdu is
    in state ENABLE*/
#define XCP_ENABLE_STATE_DYNAMIC_RX_PDU                     (1U << XCP_ENABLE_STATE_DYNAMIC_RX_PDU_BIT)

#if (defined XCP_DYNAMIC_RX_PDU_BIT)
#error XCP_DYNAMIC_RX_PDU_BIT already defined
#endif
/** \brief Bit indicating that the reception Pdu can be enabled/disabled
           at runtime */
#define XCP_DYNAMIC_RX_PDU_BIT                             5U
...
/** \brief Flag indicating that the reception Pdu can be enabled/disabled
           at runtime */
#define XCP_DYNAMIC_RX_PDU                                  (1U << XCP_DYNAMIC_RX_PDU_BIT)

#if (defined XCP_SUPPORT_FOR_RESERR_CTO_PDU_BIT)
#error XCP_SUPPORT_FOR_RESERR_CTO_PDU_BIT already defined
#endif
/** \brief Bit indicating that the support for RES/ERR CTO packages. */
#define XCP_SUPPORT_FOR_RESERR_CTO_PDU_BIT                  0U
...
#define XCP_SUPPORT_FOR_RESERR_CTO_PDU                      (1U << XCP_SUPPORT_FOR_RESERR_CTO_PDU_BIT)

#if (defined XCP_SUPPORT_FOR_EVSERV_CTO_PDU_BIT)
#error XCP_SUPPORT_FOR_EVSERV_CTO_PDU_BIT already defined
#endif
/** \brief Bit indicating that the support for EV/SERV CTO packages. */
#define XCP_SUPPORT_FOR_EVSERV_CTO_PDU_BIT                  1U
...
#define XCP_SUPPORT_FOR_EVSERV_CTO_PDU                      (1U << XCP_SUPPORT_FOR_EVSERV_CTO_PDU_BIT)

#if (defined XCP_SUPPORT_FOR_DAQ_DTO_PDU_BIT)
#error XCP_SUPPORT_FOR_DAQ_DTO_PDU_BIT already defined
#endif
/** \brief Flag indicating that the support for DAQ DTO packages. */
#define XCP_SUPPORT_FOR_DAQ_DTO_PDU_BIT                     2U

#if (defined XCP_SUPPORT_FOR_DAQ_DTO_PDU)
#error XCP_SUPPORT_FOR_DAQ_DTO_PDU already defined
#endif
/** \brief Flag indicating that the support for DAQ DTO packages. */
#define XCP_SUPPORT_FOR_DAQ_DTO_PDU                         (1U << XCP_SUPPORT_FOR_DAQ_DTO_PDU_BIT)

#if (defined XCP_ENABLE_STATE_DYNAMIC_TX_PDU_BIT)
#error XCP_ENABLE_STATE_DYNAMIC_TX_PDU_BIT already defined
#endif
/** \brief Bit indicating that the transmission Pdu can be enabled/disabled
           at runtime */
#define XCP_ENABLE_STATE_DYNAMIC_TX_PDU_BIT                 4U
...
/** \brief Flag indicating that the transmission Pdu can be enabled/disabled
           at runtime */
#define XCP_ENABLE_STATE_DYNAMIC_TX_PDU                     (1U << XCP_ENABLE_STATE_DYNAMIC_TX_PDU_BIT)

#if (defined XCP_DYNAMIC_TX_PDU_BIT)
#error XCP_DYNAMIC_TX_PDU_BIT already defined
#endif
/** \brief Bit indicating that the dynamic transmission Pdu is
    in state ENABLE */
#define XCP_DYNAMIC_TX_PDU_BIT                                  5U
...
/** \brief Flag indicating that the dynamic transmission Pdu is
    in state ENABLE */
#define XCP_DYNAMIC_TX_PDU                                  (1U << XCP_DYNAMIC_TX_PDU_BIT)

#if (defined XCP_SUPPORT_TX_FROM_CONFIRMATION_BIT)
#error XCP_SUPPORT_TX_FROM_CONFIRMATION_BIT already defined
#endif
/** \brief Flag indicating that the transmission can be done from
           the context of TxConfirmation. */
#define XCP_SUPPORT_TX_FROM_CONFIRMATION_BIT                6U
...
/** \brief Flag indicating that the transmission can be done from
           the context of TxConfirmation. */
#define XCP_SUPPORT_TX_FROM_CONFIRMATION                    (1U << XCP_SUPPORT_TX_FROM_CONFIRMATION_BIT)

#if (defined XCP_SUPPORT_RX_FROM_INDICATION_BIT)
#error XCP_SUPPORT_RX_FROM_INDICATION_BIT already defined
#endif
/** \brief Bit indicating that the reception can be done from
           the context of RxIndication. */
#define XCP_SUPPORT_RX_FROM_INDICATION_BIT                  6U
...
/** \brief Flag indicating that the reception can be done from
           the context of RxIndication. */
#define XCP_SUPPORT_RX_FROM_INDICATION                      (1U << XCP_SUPPORT_RX_FROM_INDICATION_BIT)

#if (defined XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_BIT)
#error XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_BIT already defined
#endif
/** \brief Bit indicating that the trigger transmit function is supported
 **        by the PDU channel. */
#define XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_BIT                7U

#if (defined XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_FLAG)
#error XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_FLAG already defined
#endif
/** \brief Flag indicating that the trigger transmit function is supported
 **        by the PDU channel. */
#define XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_FLAG               (1U << XCP_SUPPORT_FOR_TRIGGER_TRANSMIT_BIT)

#if (defined XCP_MULTI_PDUS_IN_FRAME_BIT)
#error XCP_MULTI_PDUS_IN_FRAME_BIT already defined
#endif
#define XCP_MULTI_PDUS_IN_FRAME_BIT                         0U
...
#define XCP_MULTI_PDUS_IN_FRAME_FLAG                        (1U << XCP_MULTI_PDUS_IN_FRAME_BIT)


#if (defined XCP_AUTO_OPEN_SOCON_BIT)
#error XCP_AUTO_OPEN_SOCON_BIT already defined
#endif
/** \brief Bit indicating that the support for Automatically
 *         opening Socket connection is supported. */
#define XCP_AUTO_OPEN_SOCON_BIT                            1U
 ...
 *         opening Socket connection is supported. */
#define XCP_AUTO_OPEN_SOCON_FLAG                            (1U << XCP_AUTO_OPEN_SOCON_BIT)

#if (defined XCP_SEQUENCE_CORRECTION_BIT)
#error XCP_SEQUENCE_CORRECTION_BIT already defined
#endif
/** \brief Bit indicating that the support for FlexRay sequence correction is enabled. */
#define XCP_SEQUENCE_CORRECTION_BIT                         2U
...
#define XCP_SEQUENCE_CORRECTION_FLAG                        (1U << XCP_SEQUENCE_CORRECTION_BIT)
...
#if (defined XCP_MAX_DLC_REQUIRED_BIT)
#error XCP_MAX_DLC_REQUIRED_BIT already defined
#endif
/** \brief Bit indicating that the MAX_DLC_REQUIRED parameter is enabled */
#define XCP_MAX_DLC_REQUIRED_BIT                            3U

#if (defined XCP_MAX_DLC_REQUIRED_FLAG)
#error XCP_MAX_DLC_REQUIRED_FLAG already defined
#endif
/** \brief Flag indicating that the MAX_DLC_REQUIRED parameter is enabled */
#define XCP_MAX_DLC_REQUIRED_FLAG                           (1U << XCP_MAX_DLC_REQUIRED_BIT)

#if (defined XCP_AUTONOMOUS_DISCONNECT_BIT)
#error XCP_AUTONOMOUS_DISCONNECT_BIT already defined
#endif
/** \brief Bit indicating that the Xcp slave decided to autonomously disconnect. */
#define XCP_AUTONOMOUS_DISCONNECT_BIT                       0U
...
#define XCP_AUTONOMOUS_DISCONNECT_FLAG                      (1U << XCP_AUTONOMOUS_DISCONNECT_BIT)
...
#define XCP_FLEXRAY_BUFFERS_READY_FLAG                      (1U << XCP_FLEXRAY_BUFFERS_READY_BIT)
 ...
 * (e.g. DAQ list accepted by this PUD). */
#define XCP_TP_CONFIGURATION_DONE_FLAG                      (1U << XCP_TP_CONFIGURATION_DONE_BIT)
...
#define XCP_MULTICAST_TRANSMIT_MODE_FLAG                    (1U << XCP_MULTICAST_TRANSMIT_MODE_BIT)
 ...
 ** to 0x00U.
 ** The uploaded bytes counter is also reset.
 ** */
