...
#if (defined XCP_E_WRONG_SET_DAQ_PTR_CMD_SEQUENCE_ERROR)
#error XCP_E_WRONG_SET_DAQ_PTR_CMD_SEQUENCE_ERROR already defined
#endif
/** \brief Error Code thrown when SET_DAQ_PTR is called without allocating
 ** odt entries.
 ** */
#define XCP_E_WRONG_SET_DAQ_PTR_CMD_SEQUENCE_ERROR        0x94U
