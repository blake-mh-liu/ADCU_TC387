...
[!ENDIF!]
[!IF "node:existsAndTrue(XcpGeneral/XcpOnFlexRayEnabled)"!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpSupportForOverloadMSB)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpBlockWriteReadMemoryRAMMechanism)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpBuildChecksumMainFunctionSupport)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpVersionInfoApi)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpOnCanEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]


#if (defined XCP_ON_CAN_MAX_DLC_REQUIRED)
#error XCP_ON_CAN_MAX_DLC_REQUIRED already defined
#endif
/** \brief Switch, indicating whether there is at least one CAN connection with configuration parameter
 ** XcpCanMaxDlcRequired set to TRUE
 */
#define XCP_ON_CAN_MAX_DLC_REQUIRED           [!//
[!IF "count(XcpConfig/eb-list::*/XcpConnectionCfg/eb-list::*[XcpConnectionInterfaceType = 'XcpConnectionOverCAN' and node:existsAndTrue(XcpConnectionInterfaceType/eb-choice::*[1]/XcpCanMaxDlcRequired)]) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpOnCanFDEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpOnFlexRayEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpOnEthernetEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpOnCddEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpEventTriggerMainFunc)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpProcessMultiEventMainFunc)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#if (defined XCP_DET_RUNTIME_CHECKS)
#error XCP_DET_RUNTIME_CHECKS is already defined
#endif
/** \brief DET runtime checks reporting
 **
 ** En- or disables the reporting of the DET runtime checks */
#define XCP_DET_RUNTIME_CHECKS   [!//
[!IF "XcpDetRuntimeChecks = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_RETRY_FAILED)/DemEventId)"!]U
[!ENDIF!][!//


[!IF "num:i(count(XcpConfig/eb-list::*/XcpMemoryAccessArea/eb-list::*)) > 0"!]
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_ILLEGAL_MEMORY_ACCESS)/DemEventId)"!]U
[!ENDIF!][!//
[!ENDIF!][!//
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_PDU_BUFFER_LOCKED)/DemEventId)"!]U
[!ENDIF!][!//
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_RESP_CTO_QUEUE_FULL)/DemEventId)"!]U
[!ENDIF!][!//
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_PDU_BUFFER_FULL)/DemEventId)"!]U
[!ENDIF!][!//
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_PDU_LOST)/DemEventId)"!]U
[!ENDIF!][!//
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_STIMULATION_DATA_LOST)/DemEventId)"!]U
[!ENDIF!][!//
...
[!"node:value(as:ref(XcpConfig/eb-list::*[1]/XcpDemEventParameterRefs/XCP_E_ACQUISITION_DATA_LOST)/DemEventId)"!]U
[!ENDIF!][!//
...
[!IF "node:existsAndTrue(XcpGeneral/XcpEnableXcpControlApi)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpDefaultXcpModuleState)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 **/
#define XCP_NUMBER_OF_USERCOMMANDS                                [!"num:i(count(XcpUserCommand/eb-list::*))"!]U
...
STD_[!IF "node:existsAndTrue(XcpGeneral/XcpSupportDynamicComChannels)"!]ON[!ELSE!]OFF[!ENDIF!]
...
STD_[!IF "node:exists(XcpGeneral/XcpSupportComMainFunctions)"!]ON[!ELSE!]OFF[!ENDIF!]
...
STD_[!IF "node:existsAndTrue(XcpGeneral/XcpSupportForPDURoutingTable)"!]ON[!ELSE!]OFF[!ENDIF!]
...
STD_[!IF "(node:existsAndTrue(XcpGeneral/XcpSupportForFlxTPCommands))"!]ON[!ELSE!]OFF[!ENDIF!]
 ...
 **/
#define XCP_NO_OF_FLX_BUF_CONFIGURED                                [!"num:i(count(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpConnectionInterfaceType/eb-choice::*[1]/XcpFlexrayBufferCfg/eb-list::*))"!]U
...
STD_[!IF "node:existsAndTrue(XcpGeneral/XcpSuppressTxSupport)"!]ON[!ELSE!]OFF[!ENDIF!]
...
[!LOOP "util:distinct(node:order(XcpConfig/eb-list::*/XcpConnectionCfg/eb-list::*,'XcpConnectionId'))"!]

#if (defined XcpConf_XcpConnectionCfg_[!"as:name(.)"!])
#error XcpConf_XcpConnectionCfg_[!"as:name(.)"!] already defined
#endif
/** \brief The Index number of the connection configuration*/
#define XcpConf_XcpConnectionCfg_[!"as:name(.)"!]         [!"XcpConnectionId"!]U
...
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define [!"as:name(.)"!]        [!"XcpConnectionId"!]U

#if (defined Xcp_[!"as:name(.)"!])
#error Xcp_[!"as:name(.)"!] is already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define Xcp_[!"as:name(.)"!]        [!"XcpConnectionId"!]U
#endif /* XCP_DONT_PROVIDE_LEGACY_SYMBOLIC_NAMES */
[!ENDLOOP!]

[!LOOP "util:distinct(node:order(XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*,'XcpEventChannelNumber'))"!]

#if (defined XcpConf_XcpEventChannel_[!"as:name(.)"!])
#error XcpConf_XcpEventChannel_[!"as:name(.)"!] already defined
#endif
/** \brief The Index number of the event channel*/
#define XcpConf_XcpEventChannel_[!"as:name(.)"!]         [!"XcpEventChannelNumber"!]U
...
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define [!"as:name(.)"!]        [!"XcpEventChannelNumber"!]U

#if (defined Xcp_[!"as:name(.)"!])
#error Xcp_[!"as:name(.)"!] is already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define Xcp_[!"as:name(.)"!]        [!"XcpEventChannelNumber"!]U
#endif /* XCP_DONT_PROVIDE_LEGACY_SYMBOLIC_NAMES */
[!ENDLOOP!]

[!LOOP "util:distinct(node:order(XcpConfig/eb-list::*/XcpDaqList/eb-list::*,'XcpDaqListNumber'))"!]

#if (defined XcpConf_XcpDaqList_[!"as:name(.)"!])
#error XcpConf_XcpDaqList_[!"as:name(.)"!] already defined
#endif
/** \brief The Index number of the static/predefined DAQ List*/
#define XcpConf_XcpDaqList_[!"as:name(.)"!]         [!"XcpDaqListNumber"!]U
...
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define [!"as:name(.)"!]        [!"XcpDaqListNumber"!]U

#if (defined Xcp_[!"as:name(.)"!])
#error Xcp_[!"as:name(.)"!] is already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define Xcp_[!"as:name(.)"!]        [!"XcpDaqListNumber"!]U
#endif /* XCP_DONT_PROVIDE_LEGACY_SYMBOLIC_NAMES */
[!ENDLOOP!]

[!LOOP "util:distinct(node:order(XcpConfig/eb-list::*/XcpDaqList/eb-list::*[XcpDaqListNumber < node:current()/XcpGeneral/XcpMinDaq],'XcpDaqListNumber'))"!]
  [!LOOP "util:distinct(node:order(XcpOdt/eb-list::*,'XcpOdtNumber'))"!]

#if (defined XcpConf_[!"as:name(../..)"!]_[!"as:name(.)"!])
#error XcpConf_[!"as:name(../..)"!]_[!"as:name(.)"!] already defined
#endif
/** \brief Index number of ODT [!"XcpOdtNumber"!] within the predefined DAQ list [!"../../XcpDaqListNumber"!] */
#define XcpConf_[!"as:name(../..)"!]_[!"as:name(.)"!]         [!"XcpOdtNumber"!]U

#ifndef XCP_DONT_PROVIDE_LEGACY_SYMBOLIC_NAMES
#if (defined [!"as:name(../..)"!]_[!"as:name(.)"!])
#error [!"as:name(../..)"!]_[!"as:name(.)"!] is already defined
#endif
/** \brief Export symbolic name value without prefix (AUTOSAR version <= 3.1 rev4) */
#define [!"as:name(../..)"!]_[!"as:name(.)"!]        [!"XcpOdtNumber"!]U

#if (defined Xcp_[!"as:name(../..)"!]_[!"as:name(.)"!])
#error Xcp_[!"as:name(../..)"!]_[!"as:name(.)"!] is already defined
#endif
/** \brief Export symbolic name value with module abbreviation as prefix only (3.1 rev4 < AUTOSAR version <= AUTOSAR 4.0 rev2) */
#define Xcp_[!"as:name(../..)"!]_[!"as:name(.)"!]        [!"XcpOdtNumber"!]U
#endif /* XCP_DONT_PROVIDE_LEGACY_SYMBOLIC_NAMES */
  [!ENDLOOP!]
[!ENDLOOP!]
...
STD_[!IF "(node:existsAndTrue(XcpGeneral/XcpCalPagStoreSupported))"!]ON[!ELSE!]OFF[!ENDIF!]
...
STD_[!IF "(node:existsAndTrue(XcpGeneral/XcpSupportForGetDaqId))"!]ON[!ELSE!]OFF[!ENDIF!]
 ...
 **/
#define XCP_NUMBER_OF_MEMORY_AREAS          [!"num:i(count(XcpConfig/eb-list::*/XcpMemoryAccessArea/XcpMemoryAccessArea/eb-list::*))"!]U
...
STD_[!IF "node:existsAndTrue(XcpConfig/eb-list::*[1]/XcpMemoryAccessArea/XcpMemoryAccessAreasCallout)"!]ON[!ELSE!]OFF[!ENDIF!]
...
#if (defined XCP_BSW_DISTRIBUTION_MEMORY_ACCESS_AREAS)
#error XCP_BSW_DISTRIBUTION_MEMORY_ACCESS_AREAS already defined
#endif
/** \brief Switch, indicating whether memory access areas are configured.
 **/
[!IF "$XcpBswDistributionMemoryAccessAreas"!]
#define XCP_BSW_DISTRIBUTION_MEMORY_ACCESS_AREAS STD_ON
[!ELSE!]
#define XCP_BSW_DISTRIBUTION_MEMORY_ACCESS_AREAS STD_OFF
[!ENDIF!]

/* !LINKSTO Xcp.BswDistribution.Calibration.MemoryProxy.Usage,1 */
#if (defined XCP_BSW_DISTRIBUTION_CALIBRATION_MEMORY_ACCESS_AREAS)
#error XCP_BSW_DISTRIBUTION_CALIBRATION_MEMORY_ACCESS_AREAS already defined
#endif
/** \brief Switch, indicating whether calibration memory access areas are configured.
 **/
[!IF "$XcpBswDistributionCalibrationMemoryAccessAreas"!]
#define XCP_BSW_DISTRIBUTION_CALIBRATION_MEMORY_ACCESS_AREAS STD_ON
[!ELSE!]
#define XCP_BSW_DISTRIBUTION_CALIBRATION_MEMORY_ACCESS_AREAS STD_OFF
[!ENDIF!]

#if (defined XCP_BSW_DISTRIBUTION_DAQSTIM_MEMORY_ACCESS_AREAS)
#error XCP_BSW_DISTRIBUTION_DAQSTIM_MEMORY_ACCESS_AREAS already defined
#endif
...
#define XCP_BSW_DISTRIBUTION_DAQSTIM_MEMORY_ACCESS_AREAS STD_ON
[!ELSE!]
#define XCP_BSW_DISTRIBUTION_DAQSTIM_MEMORY_ACCESS_AREAS STD_OFF
[!ENDIF!]
 ...
 **/
#define XCP_ENABLE_DAQ_OPTIMIZATION [!"node:when(node:existsAndTrue(RamOptimizations/XcpEnableDaqOptimization),'STD_ON','STD_OFF')"!]
 ...
 **/
#define XCP_ENABLE_BIT_OFFSET [!"node:when(node:existsAndTrue(RamOptimizations/XcpEnableBitOffset),'STD_ON','STD_OFF')"!]

/*==================[type definitions]=======================================*/

[!IF "(node:existsAndTrue(XcpGeneral/XcpBlockWriteReadMemoryRAMMechanism))"!]

/** \brief Function pointer for a RAM callout. */
typedef P2FUNC(uint8, XCP_APPL_CODE, Xcp_RAMCalloutType)
(
...
typedef struct
{
    Xcp_RAMCalloutType writeToRAMCallout;
    Xcp_RAMCalloutType readFromRAMCallout;
}Xcp_DescriptorCalloutType;
...
[!ENDIF!] [!/* XcpGeneral/XcpTimestampType != 'NO_TIME_STAMP and node:existsAndTrue(XcpGeneral/XcpDaqSupported) */!]
...
[!IF "$XcpTotalNumberOfOdts > 255"!][!//
typedef uint16 Xcp_DaqPrioQueueIndexType;
[!ELSE!][!//
typedef uint8 Xcp_DaqPrioQueueIndexType;
[!ENDIF!]
...
[!IF "node:existsAndTrue(as:modconf('Xcp')[1]/RamOptimizations/XcpEnableDaqOptimization)"!][!//
...
[!IF "number($MaxLPduBufferSize) < bit:shl(1,8)"!]
typedef uint8 Xcp_LPduLengthType;
[!ELSEIF "number($MaxLPduBufferSize) < bit:shl(1,16)"!]
typedef uint16 Xcp_LPduLengthType;
[!ELSEIF "number($MaxLPduBufferSize) < bit:shl(1,32)"!]
...
[!IF "((node:existsAndTrue(XcpGeneral/XcpOnCanEnabled)) or (node:existsAndTrue(XcpGeneral/XcpOnCanFDEnabled)) or (node:existsAndTrue(XcpGeneral/XcpOnCddEnabled)))"!]
...
[!IF "(count(XcpConfig/eb-list::*/XcpConnectionCfg/eb-list::*[XcpConnectionInterfaceType = 'XcpConnectionOverCANFD']) > 0) or (count(XcpConfig/eb-list::*/XcpConnectionCfg/eb-list::*[XcpConnectionInterfaceType = 'XcpConnectionOverCAN' and node:existsAndTrue(XcpConnectionInterfaceType/eb-choice::*[1]/XcpCanMaxDlcRequired)]) > 0)"!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpEventTriggerMainFunc) or 
      node:existsAndTrue(XcpGeneral/XcpBuildChecksumMainFunctionSupport) or
      node:exists(XcpGeneral/XcpSupportComMainFunctions)"!]
#define XCP_START_SEC_CODE
#include <Xcp_MemMap.h>
[!ENDIF!]

[!IF "node:existsAndTrue(XcpGeneral/XcpEventTriggerMainFunc)"!]
  [!IF "node:exists(XcpConfig/eb-list::*[1]/XcpEventChannel)"!]
    [!IF "num:i(count(XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*)) > 0"!]
      [!LOOP "XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*"!]
        [!IF "XcpEventChannelTimeCycle > 0"!]   
#ifndef RTE_SCHM_SWCBSW_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]
#define RTE_SCHM_SWCBSW_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]
/** \brief Scheduled functions of the XCP module for event [!"as:name(.)"!].
 ** This functions handle the events with [!"XcpEventChannelNumber"!] Id.
 */
extern FUNC(void, XCP_CODE) Xcp_MainFunction_[!"as:name(.)"!](void);
#endif
        [!ENDIF!]
      [!ENDLOOP!]
    [!ENDIF!] 
...
[!IF "node:existsAndTrue(XcpGeneral/XcpBuildChecksumMainFunctionSupport)"!]
#ifndef RTE_SCHM_SWCBSW_XCP_CRCMAINFUNCTION
#define RTE_SCHM_SWCBSW_XCP_CRCMAINFUNCTION
...
#ifndef RTE_SCHM_SWCBSW_XCP_RXMAINFUNCTION
#define RTE_SCHM_SWCBSW_XCP_RXMAINFUNCTION
/** \brief Scheduled function of the XCP module for processing the reception.
 */
extern FUNC(void, XCP_CODE) Xcp_RxMainFunction(void);
#endif

#ifndef RTE_SCHM_SWCBSW_XCP_TXMAINFUNCTION
#define RTE_SCHM_SWCBSW_XCP_TXMAINFUNCTION
...
extern CONST( Xcp_ConfigType, XCP_CONST ) [!"node:name(XcpConfig/eb-list::*[1])"!];
...
extern VAR(Xcp_DescriptorCalloutType, XCP_VAR) Xcp_DescriptorCalloutTypePtr;
