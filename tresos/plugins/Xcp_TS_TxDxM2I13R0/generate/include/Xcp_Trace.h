...
#ifndef DBG_XCP_MAINFUNCTION_FINISHED
/** \brief Exit point of function Xcp_MainFunction() */
#define DBG_XCP_MAINFUNCTION_FINISHED()
#endif
...
#ifndef DBG_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]_ENTRY
/** \brief Entry point of function Xcp_MainFunction_[!"as:name(.)"!]() */
#define DBG_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]_ENTRY()
#endif

#ifndef DBG_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]_EXIT
/** \brief Exit point of function Xcp_MainFunction_[!"as:name(.)"!]() */
#define DBG_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]_EXIT()
#endif

#ifndef DBG_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]_FINISHED
/** \brief Exit point of function Xcp_MainFunction_[!"as:name(.)"!]() */
#define DBG_XCP_MAINFUNCTION_[!"text:toupper(as:name(.))"!]_FINISHED()
#endif
...
#ifndef DBG_XCP_TXMAINFUNCTION_FINISHED
/** \brief Exit point of function Xcp_TxMainFunction() */
#define DBG_XCP_TXMAINFUNCTION_FINISHED()
#endif
...
#ifndef DBG_XCP_RXMAINFUNCTION_FINISHED
/** \brief Exit point of function Xcp_RxMainFunction() */
#define DBG_XCP_RXMAINFUNCTION_FINISHED()
#endif
