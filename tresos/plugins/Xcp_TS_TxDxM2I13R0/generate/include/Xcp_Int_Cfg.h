...
[!ENDLOOP!]
[!//
[!ENDIF!] [!/* node:existsAndTrue(XcpGeneral/XcpMasterBlockModeSupported) */!][!//
[!//
...
[!IF "node:existsAndTrue($XcpTimestampIsEnabled)"!]
  [!IF "node:existsAndFalse(XcpGeneral/XcpUserTimestampSupported)"!]
    [!IF "node:refvalid(XcpGeneral/XcpCounterRef) and node:exists(as:ref(XcpGeneral/XcpCounterRef)/OsSecondsPerTick)"!]
      [!VAR "OsSecondsPerTick"="util:distinct(node:refs(XcpGeneral/XcpCounterRef))/OsSecondsPerTick"!]
      [!IF "floor($OsSecondsPerTick) = number($OsSecondsPerTick)"!] [!/* If OsSecondsPerTick is an integer - we have a multiple of seconds */!]
  ...
  [!ELSE!] [!/* node:existsAndTrue(XcpGeneral/XcpUserTimestampSupported) */!]
    [!VAR "TimeStampUnit"="XcpGeneral/XcpTimestampUnit"!]
    [!VAR "TimeStampTicks"="XcpGeneral/XcpTimestampTicks"!]
  [!ENDIF!] [!/* node:existsAndFalse(XcpGeneral/XcpUserTimestampSupported) */!][!//
...
[!IF "node:existsAndTrue(XcpGeneral/XcpSynchReceivedCallout)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpDaqSupported)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpStimSupported)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpDevErrorDetect)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpConfig/eb-list::*[1]/XcpMemoryAccessArea/XcpMemoryAccessAreasSupport)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#if (defined XCP_GET_ID_GENERIC_TYPE_CALLOUT_ENABLED)
#error XCP_GET_ID_GENERIC_TYPE_CALLOUT_ENABLED already defined
#endif
/** \brief Switch, indicating whether the GET_ID command for generic type uses information from an user defined callout
 */
#define XCP_GET_ID_GENERIC_TYPE_CALLOUT_ENABLED          [!//
[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdGenericTypeCallout)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

#if (defined XCP_GET_ID_TYPE1_CALLOUT_ENABLED)
#error XCP_GET_ID_TYPE1_CALLOUT_ENABLED already defined
#endif
/** \brief Switch, indicating whether the GET_ID command for type 1 uses information from
 *  the configuration or gets the information from an user defined callout
 */
#define XCP_GET_ID_TYPE1_CALLOUT_ENABLED          [!//
[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdType1Callout)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

[!VAR "MaxLength" = "0"!]
[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdType1Callout) and node:existsAndTrue(XcpGeneral/XcpGetIdGenericTypeCallout)"!]
  [!IF "num:i(XcpGeneral/XcpGetIdType1MaxLength) > num:i(XcpGeneral/XcpGetIdGenericTypeMaxLength)"!]
    [!VAR "MaxLength" = "num:i(XcpGeneral/XcpGetIdType1MaxLength)"!]
  [!ELSE!][!//
    [!VAR "MaxLength" = "num:i(XcpGeneral/XcpGetIdGenericTypeMaxLength)"!]
  [!ENDIF!][!//
[!ELSEIF "node:existsAndTrue(XcpGeneral/XcpGetIdType1Callout)"!]
  [!VAR "MaxLength" = "num:i(XcpGeneral/XcpGetIdType1MaxLength)"!]
[!ELSEIF "node:existsAndTrue(XcpGeneral/XcpGetIdGenericTypeCallout)"!]
  [!VAR "MaxLength" = "num:i(XcpGeneral/XcpGetIdGenericTypeMaxLength)"!]
[!ENDIF!][!//

[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdType1Callout) or (node:existsAndTrue(XcpGeneral/XcpGetIdGenericTypeCallout))"!]
#if (defined XCP_GET_ID_MAX_LENGTH)
#error XCP_GET_ID_MAX_LENGTH already defined
#endif
/** \brief Definition of the maximum Length of the identification information
 */
#define XCP_GET_ID_MAX_LENGTH  [!"$MaxLength"!]U
[!ENDIF!][!//
...
[!VAR "GetIdType1MaxSize" = "0"!]
[!VAR "GetIdGenericTypeMaxSize" = "0"!]
[!VAR "GetIdASAMFileMaxSize" = "0"!]

[!VAR "Min1Length" = "0"!]
[!VAR "Min2Length" = "0"!]
[!VAR "MaxResLength" = "0"!]

[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdType1Callout)"!]
  [!VAR "GetIdType1MaxSize" = "num:i(8) + num:i(XcpGeneral/XcpGetIdType1MaxLength)"!][!// The value 8 represents XCP_CMD_GETID_RES_LENGTH_MIN
[!ENDIF!]
[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdGenericTypeCallout)"!]
  [!VAR "GetIdGenericTypeMaxSize" = "num:i(8) + num:i(XcpGeneral/XcpGetIdGenericTypeMaxLength)"!][!// The value 8 represents XCP_CMD_GETID_RES_LENGTH_MIN
[!ENDIF!]
[!IF "node:exists(XcpGeneral/XcpASAMMC2Filename)"!]
  [!VAR "GetIdASAMFileMaxSize" = "num:i(8) + num:i(string-length(normalize-space(XcpGeneral/XcpASAMMC2Filename)))"!][!// The value 8 represents XCP_CMD_GETID_RES_LENGTH_MIN
[!ENDIF!]

[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdType1Callout)"!]
  [!IF "number($GetIdType1MaxSize) < (num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto))"!]
    [!VAR "Min1Length" = "$GetIdType1MaxSize"!]
  [!ELSE!]
    [!VAR "Min1Length" = "num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto)"!]
  [!ENDIF!]
[!ELSEIF "node:exists(XcpGeneral/XcpASAMMC2Filename)"!]
  [!IF "number($GetIdASAMFileMaxSize) < (num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto))"!]
    [!VAR "Min1Length" = "$GetIdASAMFileMaxSize"!]
  [!ELSE!]
    [!VAR "Min1Length" = "num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto)"!]
  [!ENDIF!]
[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpGetIdGenericTypeCallout)"!]
  [!IF "number($GetIdGenericTypeMaxSize) < (num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto))"!]
    [!VAR "Min2Length" = "$GetIdType1MaxSize"!]
  [!ELSE!]
    [!VAR "Min2Length" = "num:i(0)"!]
  [!ENDIF!]
[!ENDIF!]

[!IF "$Min1Length > $Min2Length"!]
  [!VAR "MaxResLength" = "$Min1Length"!]
[!ELSE!]
  [!VAR "MaxResLength" = "$Min2Length"!]
[!ENDIF!]

#if (defined XCP_CMD_GETID_RES_LENGTH_MAX)
#error XCP_CMD_GETID_RES_LENGTH_MAX already defined
#endif
/** \brief Maximum response length a command can send.
 */
#define XCP_CMD_GETID_RES_LENGTH_MAX  [!"num:i($MaxResLength)"!]U

[!IF "node:existsAndFalse(XcpGeneral/XcpGetIdType1Callout) and node:exists(XcpGeneral/XcpASAMMC2Filename)"!][!//
...
#define XCP_MAX_CTO [!"num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto)"!]U
...
#define XCP_MIN_OF_ALL_MAX_CTO [!"num:min(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCto)"!]U
...
#define XCP_MAX_CTO_PGM             [!"num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*/XcpMaxCtoPgm)"!]U
[!ELSE!]
...
[!IF "node:existsAndFalse(XcpGeneral/XcpEventTriggerMainFunc)"!]
[!"num:i(count(XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*))"!]U
[!ELSE!] [!//
[!"num:i(count(XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*[XcpEventChannelTimeCycle = 0]))"!]U
[!ENDIF!]
...
[!IF "(node:existsAndTrue(XcpGeneral/XcpDaqSupported)) and (node:existsAndTrue(XcpGeneral/XcpPrescalerSupported))"!]XCP_PRESCALER_MASK[!ELSE!](0U)[!ENDIF!]
...
[!IF "node:existsAndTrue($XcpTimestampIsEnabled)"!]XCP_TIMESTAMP_MASK[!ELSE!](0U)[!ENDIF!]
...
[!IF "node:existsAndTrue($XcpTimestampIsEnabled)"!]XCP_[!"XcpGeneral/XcpTimestampType"!]_TS_MASK[!ELSE!]XCP_NO_TIME_STAMP_TS_MASK[!ENDIF!]
...
[!"as:name(as:ref(XcpGeneral/XcpCounterRef))"!]
  [!ENDIF!]
[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpCalPagSupported)"!]XCP_RESOURCE_CAL_PAG_MASK[!ELSE!](0U)[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpDaqSupported)"!]XCP_RESOURCE_DAQ_MASK[!ELSE!](0U)[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpStimSupported)"!]XCP_RESOURCE_STIM_MASK[!ELSE!](0U)[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpPgmSupported)"!]XCP_RESOURCE_PGM_MASK[!ELSE!](0U)[!ENDIF!]
...
STD_[!IF "node:existsAndTrue(XcpGeneral/XcpPgmSupported)"!]ON[!ELSE!]OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpMasterBlockModeSupported)"!]XCP_MASTER_BLOCK_MODE_MASK[!ELSE!](0U)[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpMasterBlockModeSupported)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
 ...
 **/
#define XCP_MAX_BS                   [!//
[!IF "node:existsAndTrue(XcpGeneral/XcpMasterBlockModeSupported)"!][!"$XcpMaxOfMaxBs"!]U[!ELSE!](0U)[!ENDIF!]
...
#define XCP_MIN_ST                   [!//
[!IF "node:existsAndTrue(XcpGeneral/XcpMasterBlockModeSupported)"!][!"XcpGeneral/XcpMinST"!]U[!ELSE!](0U)[!ENDIF!]
...
[!IF "(node:exists(XcpGeneral/XcpTimestampFixed))"!]
#define XCP_TIMESTAMP_FIXED          [!//
[!IF "node:existsAndTrue(XcpGeneral/XcpTimestampFixed)"!]XCP_TIMESTAMP_FIXED_MASK[!ELSE!](0U)[!ENDIF!]
[!ELSE!]
...
[!VAR "XcpMaxEntriesPerOdt" = "num:i(0)"!]
  [!LOOP "util:distinct(node:order(XcpConfig/eb-list::*[1]/XcpDaqList/eb-list::*, 'XcpDaqListNumber'))"!]
    [!IF "(XcpDaqListNumber < ../../../../XcpGeneral/XcpMinDaq)"!]
      [!VAR "ODTEntryCnt" = "num:i(0)"!]
      [!LOOP "util:distinct(node:order(XcpOdt/eb-list::*, 'XcpOdtNumber'))"!]
        [!VAR "ODTEntryCnt" = "num:i(count(XcpOdtEntry/eb-list::*))"!]
...
[!IF "XcpGeneral/XcpDaqConfigType = 'DAQ_STATIC'"!]
  [!LOOP "util:distinct(node:order(XcpConfig/eb-list::*[1]/XcpDaqList/eb-list::*, 'XcpDaqListNumber'))"!]
   [!IF "XcpDaqListNumber >= ../../../../XcpGeneral/XcpMinDaq"!]
      [!IF "number($XcpMaxEntriesPerOdt) < ./XcpMaxOdtEntries"!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpSupportForOverloadMSB)"!]XCP_PID_OL_MASK[!//
[!ELSEIF "node:existsAndTrue(XcpGeneral/XcpEventPacketEnabled)"!]XCP_EVENT_OL_MASK[!//
...
#define XCP_MAXIMUM_ODT             [!//
  ...
  [!LOOP "XcpConfig/eb-list::*[1]/XcpDaqList/eb-list::*"!]
     [!IF "XcpDaqListNumber < number($XcpMinDaq)"!]
      [!VAR "MaxOdtPerDaqList" = "count(./XcpOdt/eb-list::*)"!]
      [!IF "$Max < $MaxOdtPerDaqList"!]
        [!VAR "Max" = "$MaxOdtPerDaqList"!]
      [!ENDIF!]
    [!ELSE!]
      [!IF "number($Max) < XcpMaxOdt"!]
        [!VAR "Max" = "XcpMaxOdt"!]
      [!ENDIF!]
    [!ENDIF!]
  [!ENDLOOP!]
...
STD_[!IF "node:exists(XcpGeneral/XcpFlexRaySyncTimeout)"!]ON[!ELSE!]OFF[!ENDIF!]

[!IF "node:exists(XcpGeneral/XcpFlexRaySyncTimeout)"!]
 ...
 ** in case a FlexRay hardware buffer initialization error has occurred
 **/
...
[!IF "node:existsAndTrue(XcpGeneral/XcpSetMtaEndianness)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#define XCP_NO_OF_RX_PDU_IDS                               [!"num:i(count(XcpConfig/eb-list::*[1]/XcpPdu/eb-list::*[node:name(.)='XcpRxPdu']))"!]U
...
#define XCP_NO_OF_TX_PDU_IDS                               [!"num:i(count(XcpConfig/eb-list::*[1]/XcpPdu/eb-list::*[node:name(.)='XcpTxPdu']))"!]U
...
[!IF "node:existsAndTrue(XcpGeneral/XcpOnEthernetEnabled)"!]
...
[!IF "node:existsAndTrue($AutomaticOpenSoCon)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpSeedAndKeyEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpEventPacketEnabled)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

[!IF "node:existsAndTrue(XcpGeneral/XcpEventPacketEnabled)"!]
  [!IF "(node:existsAndTrue(XcpGeneral/XcpStimSupported)) or (node:existsAndTrue(XcpGeneral/XcpStoreDaqSupported))"!]
    [!VAR "XcpMaxEvCto"="8"!]
  [!ELSE!]
    [!VAR "XcpMaxEvCto"="2"!]
  [!ENDIF!]
...
[!IF "node:exists(XcpGeneral/XcpEventPacketEnabled)"!]
  [!IF "node:existsAndTrue(XcpGeneral/XcpStimSupported)"!]
    [!VAR "XcpEvCtoQueueSize"="num:max(XcpConfig/eb-list::*/XcpEventChannel/eb-list::*/XcpEventChannelMaxDaqList)"!]
...
[!"num:i(sum(XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*/XcpEventChannelMaxDaqList))"!]U
...
[!"num:i(count(XcpConfig/eb-list::*[1]/XcpEventChannel/eb-list::*/XcpEventChannelTriggeredDaqListRef/eb-list::*))"!]U

#if (defined XCP_MODIFY_BITS_SUPPORTED)
#error XCP_MODIFY_BITS_SUPPORTED already defined
#endif
/** \brief MODIFY_BITS supported */
#define XCP_MODIFY_BITS_SUPPORTED         STD_[!IF "node:existsAndTrue(XcpGeneral/XcpModifyBitsSupported)"!]ON[!ELSE!]OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpWriteDaqMultipleSupported)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpBuildChecksumSupport)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

#if (defined XCP_BUILD_CHECKSUM_TYPE)
#error XCP_BUILD_CHECKSUM_TYPE already defined
#endif
[!IF "node:existsAndTrue(XcpGeneral/XcpBuildChecksumSupport)"!]
...
#define XCP_USER_TIMESTAMP_SUPPORTED  STD_[!IF "(node:existsAndTrue(XcpGeneral/XcpUserTimestampSupported))"!]ON[!ELSE!]OFF[!ENDIF!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpSlaveBlockModeSupported)"!]XCP_SLAVE_BLOCK_MODE_MASK[!ELSE!](0U)[!ENDIF!]
...
#define XCP_MULTI_PDUS_IN_FRAME_SUPPORT  STD_[!IF "node:existsAndTrue($MultiplePdusInOneFrame)"!]ON[!ELSE!]OFF[!ENDIF!]

#if (defined XCP_FLEXRAY_SEQUENCE_CORRECTION_SUPPORT)
#error XCP_FLEXRAY_SEQUENCE_CORRECTION_SUPPORT already defined
#endif
/** \brief Switch for enabling support of multiple XCP messages in one frame */
#define XCP_FLEXRAY_SEQUENCE_CORRECTION_SUPPORT  STD_[!IF "node:existsAndTrue($FlexRaySequenceCorrection)"!]ON[!ELSE!]OFF[!ENDIF!]
...
[!IF "num:i(count(XcpConfig/eb-list::*/XcpConnectionCfg/eb-list::*/XcpTxPduConnectionInfo/eb-list::*[node:existsAndTrue(XcpPduSupportTxFromTxConfirmation)])) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
[!IF "num:i(count(XcpConfig/eb-list::*/XcpConnectionCfg/eb-list::*/XcpRxPduConnectionInfo/eb-list::*[node:existsAndTrue(XcpPduSupportRxFromRxIndication)])) > 0"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

/* Validation: If XcpMulticastCommands is set as true, at least one IPv4 UDP connection needs to be configured */
[!IF "node:existsAndTrue(XcpGeneral/XcpMulticastCommands) and $IsUpdIPv4 = 'false'"!]
...
[!IF "node:existsAndTrue(XcpGeneral/XcpMulticastCommands)"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

[!IF "node:existsAndTrue(XcpGeneral/XcpMulticastCommands)"!]
...
#endif
[!IF "node:existsAndTrue(XcpGeneral/XcpMasterBlockModePgmSupported)"!]
...
[!IF "count(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*[XcpConnectionInterfaceType = 'XcpConnectionOverCANFD' and node:existsAndTrue(XcpConnectionInterfaceType/eb-choice::*[1]/XcpCanFdMaxDlcRequired)]) > 0"!]
#define XCP_GET_MAX_OF_MAX_DLC [!"num:max(XcpConfig/eb-list::*[1]/XcpConnectionCfg/eb-list::*[XcpConnectionInterfaceType = 'XcpConnectionOverCANFD' and node:existsAndTrue(XcpConnectionInterfaceType/eb-choice::*[1]/XcpCanFdMaxDlcRequired)]/XcpConnectionInterfaceType/eb-choice::*[1]/XcpCanFdMaxDlc)"!]U
[!ELSE!]
#define XCP_GET_MAX_OF_MAX_DLC 0U
[!ENDIF!]

[!IF "$XcpBswDistributionMemoryAccessAreas"!][!//
[!IF "$XcpBswDistributionDaqStimMemoryAccessAreas"!][!//
...
/** \brief size of buffer for queued requests to MemProxy
  */
#define XCP_NUMBER_OF_QUEUED_EVENTS  [!"num:i(XcpBswDistribution/XcpMemProxyNumberOfRequestQueued)"!]U
[!ENDIF!][!//
[!ENDIF!][!//
 ...
 **/
typedef CONSTP2FUNC(Std_ReturnType, RTE_CODE, Xcp_SendMemoryProxyData_FuncPtr)(
 ...
 **/
typedef CONSTP2FUNC(Std_ReturnType, RTE_CODE, Xcp_SendMemoryProxyNotification_FuncPtr)(uint16 EventId);
...
[!IF "$XcpBswDistributionEnabled"!][!//
[!IF "text:tolower($StoreDaq) = 'true'"!][!//
typedef CONSTP2FUNC(Std_ReturnType, RTE_CODE, Xcp_SendNvMRequest_FuncPtr)(uint8 PartitionId);
