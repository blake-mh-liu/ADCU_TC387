...
[!VAR "XcpWrapperEnabled"="node:existsAndTrue(XcpGeneral/XcpServiceWrapper)"!]

[!IF "$XcpWrapperEnabled"!]
#define XCP_WRAPPER_START_SEC_CODE_WRAPPER
#include <Xcp_MemMap.h>

/*------------------[Scheduled functions]-----------------------------------*/
#ifndef RTE_SCHM_SWCBSW_XCP_WRAPPER_MAINFUNCTION
#define RTE_SCHM_SWCBSW_XCP_WRAPPER_MAINFUNCTION
...
#ifndef RTE_SCHM_SWCBSW_XCP_WRAPPER_MAINFUNCTION_[!"text:toupper(as:name(.))"!]
#define RTE_SCHM_SWCBSW_XCP_WRAPPER_MAINFUNCTION_[!"text:toupper(as:name(.))"!]
 ...
 **
 ** \ServiceID{::255} */
extern FUNC(void, XCP_WRAPPER_CODE) Xcp_Wrapper_MainFunction_[!"as:name(.)"!](void);
#endif
    [!ENDIF!]
  [!ENDLOOP!]
[!ENDIF!]
...
#ifndef RTE_SCHM_SWCBSW_XCP_WRAPPER_TXMAINFUNCTION
#define RTE_SCHM_SWCBSW_XCP_WRAPPER_TXMAINFUNCTION
/** \brief Scheduled function of the XCP wrapper for processing the CRC. This function calls
...
#ifndef RTE_SCHM_SWCBSW_XCP_WRAPPER_RXMAINFUNCTION
#define RTE_SCHM_SWCBSW_XCP_WRAPPER_RXMAINFUNCTION
/** \brief Scheduled function of the XCP wrapper for processing the CRC. This function calls
...
#define XCP_WRAPPER_STOP_SEC_CODE_WRAPPER
#include <Xcp_MemMap.h>
