...
[!INCLUDE "../../generate_macros/FrSM_Variables.m"!][!//
#ifndef FRSM_CFG_H
#define FRSM_CFG_H
...
[!CALL "GuardedDefine", "Comment"="'Switch to enable the use of FrIf_GetWakeupRxStatus API'",
  "Name"="'FRSM_FRIF_GETWAKEUPRXSTATUS_ENABLE'"!] [!IF "$VarFrSMFrIfGetWakeupRxStatusSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
