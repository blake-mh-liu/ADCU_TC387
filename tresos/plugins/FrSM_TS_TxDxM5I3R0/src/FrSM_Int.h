...
#define FRSM_SINGLE_CHANNEL_WAKEUP          0U
#define FRSM_DUAL_CHANNEL_WAKEUP            1U
#define FRSM_DUAL_CHANNEL_WAKEUP_FORWARD    2U
#define FRSM_DUAL_CHANNEL_ECHO_WAKEUP       3U
#define FRSM_NO_WAKEUP                      4U
