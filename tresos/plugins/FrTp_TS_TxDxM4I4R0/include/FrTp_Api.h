 ...
 *
 * Reason:
 * FrTp_MainFunction can be redefined by BSW Scheduler (SchM).
 */

/* mgcc62 Deviation List
 *
 * MGCC62-1) Deviated Rule: redundant-decls
 * warning: redundant redeclaration of "FrTp_MainFunction" [-Wredundant-decls]
 *
 * Reason:
 ...
 * \Synchronicity{Synchronous}
 *
 * \param[in] FrTpRxSduId  Contains the FlexRay TP instance unique identifier of
 *                         the Fr N-SDU to be cancelled.
 *
 * \return E_OK            Cancellation request of the transfer (sending or
 *                         receiving) of the specified Fr N-SDU is accepted.
