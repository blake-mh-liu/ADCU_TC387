...
/* !LINKSTO FrTp.EB.UlCallout.HeaderFileName.Parameter, 1 */
[!IF "node:exists(FrTpGeneral/VendorSpecific/FrTpUlCalloutConfig/FrTpUlCalloutHeaderFileName)"!][!//
#include <[!"FrTpGeneral/VendorSpecific/FrTpUlCalloutConfig/FrTpUlCalloutHeaderFileName"!]>
[!ENDIF!][!//
...
[!CALL "GuardedDefine", "Comment"="'Support metadata handling'",
  "Name"="'FRTP_METADATA_HANDLING_ENABLE'"!] [!IF "$FrTpMetaDataHandlingEnable = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

/* !LINKSTO FrTp.EB.UlCallout.RxIndicationName.Parameter, 1 */
[!CALL "GuardedDefine", "Comment"="'Upper layer callout preceding PduR_FrTpCopyRxData() call with payload data'",
  "Name"="'FRTP_UL_CALLOUT_RX_INDICATION'", "Params"="'(RxPduId, FrTpLa, FrTpRa, FrameType, PduInfoPtr)'"!][!//
[!IF "node:exists(FrTpGeneral/VendorSpecific/FrTpUlCalloutConfig/FrTpUlCalloutRxIndicationName)"!][!//
  [!"FrTpGeneral/VendorSpecific/FrTpUlCalloutConfig/FrTpUlCalloutRxIndicationName"!](RxPduId, FrTpLa, FrTpRa, FrameType, PduInfoPtr)
[!ENDIF!][!//
