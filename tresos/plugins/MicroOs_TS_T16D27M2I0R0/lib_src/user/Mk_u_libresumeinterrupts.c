/* Mk_u_libresumeinterrupts.c
 *
 * This file contains the MK_ResumeInterrupts() function.
 *
...
/* MK_ResumeInterrupts()
 *
 * This function releases the MK_resLockCat1 or MK_resLockCat2 lock, unless
 * the caller's queuing priority is higher than the lock's ceiling priority.
 *
 * !LINKSTO      Microkernel.Function.MK_ResumeInterrupts, 1
 * !doctype      src
*/
void MK_ResumeInterrupts(mk_lockid_t lockId)
{
	mk_lock_t *lockTable;
	mk_lock_t *lock;
