...
#ifndef CSM_SYMBLOCKENCRYPT_H
#define CSM_SYMBLOCKENCRYPT_H
 ...
 **
 ** This function requests the start of an symmetrical block encryption computation. The start
 ...
 **/
extern FUNC(Csm_ReturnType, CSM_CODE) Csm_SymBlockEncryptStart
(
 ...
 **
 ** This function requests the update of the symmetrical block encryption computation for the
 ...
 **/
extern FUNC(Csm_ReturnType, CSM_CODE) Csm_SymBlockEncryptUpdate
(
          Csm_ConfigIdType                            cfgId,
 ...
 **
 ** This function requests the finishing of the symmetrical block encryption computation and
 ...
 ** \retval  CSM_E_BUSY    request failed, service is still busy
 **/
extern FUNC(Csm_ReturnType, CSM_CODE) Csm_SymBlockEncryptFinish
(
  Csm_ConfigIdType cfgId
);

/** \brief  Used by the symmetrical block encryption primitive to indicate finished computation.
 **
 ** This function has to be called by the symmetrical block encryption primitive to indicate
 ...
 **                      the user.
 **/
extern FUNC(void, CSM_CODE) Csm_SymBlockEncryptCallbackNotification
(
  Csm_ReturnType result
);

/** \brief  Used by the symmetrical block encryption primitive to indicate end of service.
 **
 ** This function has to be called by the symmetrical block encryption primitive to indicate
 ** that it has completely finished the currently computed service. This function then sets the
 ** symmetrical block encryption computation state machine to the idle state.
 **/
extern FUNC(void, CSM_CODE) Csm_SymBlockEncryptServiceFinishNotification
(
  void
);
 ...
 **/
extern FUNC(void, CSM_CODE) Csm_SymBlockEncryptMainFunction
(
  void
);
...
/** \brief  Initialization of the symmetrical block encryption computation interface.
 **
 ** This function initializes the symmetrical block encryption computation interface such that
 ** a service can be requested with Csm_SymBlockEncryptStart().
 **/
extern FUNC(void, CSM_CODE) Csm_SymBlockEncryptInit
(
  void
);
 ...
 **/
extern VAR(boolean, CSM_VAR) Csm_SymBlockEncryptIsRunning;
 ...
 **/
extern VAR(Csm_ConfigIdType, CSM_VAR_NOINIT) Csm_SymBlockEncryptCurrentConfigId;

/** \brief Synchronous mode callback notification return value
 **/
#if (CSM_SYMBLOCKENCRYPT_SYNCJOBPROCESSING_ENABLED == STD_ON)
extern volatile VAR(Csm_ReturnType, CSM_VAR) Csm_SymBlockEncrypt_Ret_CallbackNotification;
...
#endif /* #if (CSM_SYMBLOCKENCRYPT_ENABLED == STD_ON) */

#endif /* #ifndef CSM_SYMBLOCKENCRYPT_H */
