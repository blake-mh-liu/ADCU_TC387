...
[!LOOP "util:distinct(node:order(util:distinct(node:refs(./CryIfChannel/*/CryIfDriverObjectRef))/../../.. | util:distinct(node:refs(./CryIfKey/*/CryIfKeyRef))/../../..))"!][!//
...
[!IF "(CryIfEbGeneral/CryIfEbMisc/CryIfEbEnhancementApiCryIfKeyGetStatus = 'true')"!][!//
#define CRYIF_API_ENABLED_KEYGETSTATUS STD_ON
[!ELSE!][!//
...
[!IF "(CryIfEbGeneral/CryIfEbMisc/CryIfEbEnhancementApiCryIfKeySetInvalid = 'true')"!][!//
#define CRYIF_API_ENABLED_KEYSETINVALID STD_ON
[!ELSE!][!//
...
[!LOOP "util:distinct(node:order(CryIfChannel/*, 'node:value(./CryIfChannelId)'))"!][!//
...
[!LOOP "util:distinct(node:order(CryIfKey/*, 'node:value(./CryIfKeyId)'))"!][!//
