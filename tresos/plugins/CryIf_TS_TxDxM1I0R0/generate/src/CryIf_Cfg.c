...
{
[!LOOP "util:distinct(node:order(CryIfKey/*, 'node:value(./CryIfKeyId)'))"!][!//
  &Crypto[!CALL "CryIf_CryptoMip", "ctr" = "node:path(node:ref(./CryIfKeyRef)/../../..)"!]_KeyElementCopyPartial,
[!ENDLOOP!][!//
};
...
{
[!LOOP "util:distinct(node:order(CryIfKey/*, 'node:value(./CryIfKeyId)'))"!][!//
  &Crypto[!CALL "CryIf_CryptoMip", "ctr" = "node:path(node:ref(./CryIfKeyRef)/../../..)"!]_KeyGetStatus,
[!ENDLOOP!][!//
};
...
{
[!LOOP "util:distinct(node:order(CryIfKey/*, 'node:value(./CryIfKeyId)'))"!][!//
  &Crypto[!CALL "CryIf_CryptoMip", "ctr" = "node:path(node:ref(./CryIfKeyRef)/../../..)"!]_KeySetInvalid,
[!ENDLOOP!][!//
};
