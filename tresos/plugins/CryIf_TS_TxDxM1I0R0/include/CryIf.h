...
#if (defined CRYIF_SID_KEYELEMENTCOPYPARTIAL)
#error CRYIF_SID_KEYELEMENTCOPYPARTIAL already defined
#endif
/** \brief AUTOSAR API service ID for CryIf_KeyElementCopyPartial */
#define CRYIF_SID_KEYELEMENTCOPYPARTIAL 0x12U
...
#if (defined CRYIF_SID_KEYGETSTATUS)
#error CRYIF_SID_KEYGETSTATUS already defined
#endif
/** \brief AUTOSAR API service ID for CryIf_KeyGetStatus */
#define CRYIF_SID_KEYGETSTATUS          0x13U
#endif

#if (CRYIF_API_ENABLED_KEYSETINVALID == STD_ON)
#if (defined CRYIF_SID_KEYSETINVALID)
#error CRYIF_SID_KEYSETINVALID already defined
#endif
/** \brief AUTOSAR API service ID for CryIf_KeySetInvalid */
#define CRYIF_SID_KEYSETINVALID         0x14U
#endif
/*==================[declaration of types]========================================================*/

/** \brief  Configuration data structure of Csm module.
 **/
/* !LINKSTO CryIf.Asr.SWS_CryIf_91118,1 */
#if (CRYIF_API_VERSION == CRYIF_API_VERSION_440)
typedef struct
{
  uint32 dummy;
...
(
  ...
  P2VAR(Crypto_JobInfoType, AUTOMATIC, CRYIF_APPL_DATA) job
...
#if (CRYIF_API_VERSION == CRYIF_API_VERSION_440)
/** \brief Function pointer type for CryIf_KeyElementCopyPartial */
/* !LINKSTO CryIf.Dsn.Api/Types/00018, 1 */
typedef P2FUNC(Std_ReturnType, CRYIF_CODE, CryIf_KeyElementCopyPartialPtrType)
(
  uint32 cryIfKeyId,
  uint32 keyElementId,
...
(
  uint32 cryIfKeyId,
  P2VAR(uint32, AUTOMATIC, CRYIF_APPL_DATA) keyElementIdsPtr,
  P2VAR(uint32, AUTOMATIC, CRYIF_APPL_DATA) keyElementIdsLengthPtr
);
...
#if (CRYIF_API_ENABLED_KEYSETINVALID == STD_ON)
/** \brief Function pointer type for CryIf_KeySetInvalid */
/* !LINKSTO CryIf.Dsn.Api/Types/00016, 1 */
typedef P2FUNC(Std_ReturnType, CRYIF_CODE, CryIf_KeySetInvalidPtrType)
(
  uint32 cryIfKeyId
);
...
#if (CRYIF_API_ENABLED_KEYGETSTATUS == STD_ON)
/** \brief Function pointer type for CryIf_KeyGetStatus */
/* !LINKSTO CryIf.Dsn.Api/Types/00017, 1 */
typedef P2FUNC(Std_ReturnType, CRYIF_CODE, CryIf_KeyGetStatusPtrType)
(
  uint32 cryIfKeyId,
...
/** \brief keyElementCopyPartial Jumptable for different Crypto Driver Objects */
extern CONST(CryIf_KeyElementCopyPartialPtrType, CRYIF_CONST) CryIf_KeyElementCopyPartialJumpTable[CRYIF_KEY_COUNT];
#endif /* #if (   (CRYIF_API_VERSION           == CRYIF_API_VERSION_440) ... */
...
/* !LINKSTO CryIf.Dsn.NoCodeUnconfiguredKeyMgmt, 1 */
#if (CRYIF_API_ENABLED_KEYMNGMNT == STD_ON)
/** \brief RandomSeed Jumptable for different Crypto Driver Objects */
...
/* !LINKSTO CryIf.Dsn.NoCodeUnconfiguredKeyMgmt, 1 */
#if (CRYIF_API_ENABLED_KEYSETINVALID == STD_ON)
/** \brief KeySetInvalid Jumptable for different Crypto Drivers */
extern CONST(CryIf_KeySetInvalidPtrType, CRYIF_CONST) CryIf_KeySetInvalidJumpTable[CRYIF_KEY_COUNT];
#endif /* #if (CRYIF_API_ENABLED_KEYSETINVALID == STD_ON) */

/* !LINKSTO CryIf.Dsn.NoCodeUnconfiguredKeyMgmt, 1 */
#if (CRYIF_API_ENABLED_KEYGETSTATUS == STD_ON)
/** \brief KeyGetStatus Jumptable for different Crypto Drivers */
extern CONST(CryIf_KeyGetStatusPtrType, CRYIF_CONST) CryIf_KeyGetStatusJumpTable[CRYIF_KEY_COUNT];
#endif /* #if (CRYIF_API_ENABLED_KEYGETSTATUS == STD_ON) */
 ...
 *                        (only available in {CRYIF_API_VERSION_440})
 *
 ...
 *                                        (only specified for {CRYIF_API_VERSION_440})
 *
 ...
 *          keyElementCopyLength allows to copy just parts of the source key element into
 *          the destination key element.
 *          (only available in {CRYIF_API_VERSION_440})
 *
 * \param[in]  cryIfKeyId              Holds the identifier of the key whose key element shall be
 *                                     the source element.
 ...
 * \param[in]  keyElementTargetOffset  This is the offset of the target key element indicating
 *                                     the start index of the copy operation.
 * \param[in]  keyElementCopyLength    Specifies the number of bytes that shall be copied.
 * \param[in]  targetCryIfKeyId        Holds the identifier of the key whose key element shall be
 ...
 * \retval  CRYPTO_E_KEY_EMPTY            Request failed because of uninitialized source key element
 *
 * \ServiceID{::CRYIF_SID_KEYELEMENTCOPYPARTIAL}
 * \Synchronicity{Synchronous}
 * \Reentrancy{Reentrant, but not for the same cryIfKeyId}
 */
...
/**
 * \brief   This function shall set the status of the key identified by cryIfKeyId to invalid.
 *
 * \param[in]  cryIfKeyId  Holds the identifier of the key for which the status shall be set to
 *                         invalid.
 *
 * \return  Standard Return Value
 * \retval  E_OK                          Request successful
 ...
 * \retval  CRYPTO_E_BUSY                 Request failed, Crypto Driver Object is busy
 *
 * \ServiceID{::CRYIF_SID_KEYSETINVALID}
 * \Synchronicity{Sync}
 * \Reentrancy{Non Reentrant}
 */
extern FUNC(Std_ReturnType, CRYIF_CODE) CryIf_KeySetInvalid
(
  uint32 cryIfKeyId
);
#endif /* #if (CRYIF_API_ENABLED_KEYSETINVALID == STD_ON) */
...
#if (CRYIF_API_ENABLED_KEYGETSTATUS == STD_ON)
/**
 * \brief   This function shall return the key state of the key identified by cryIfKeyId.
 *
 * \param[in]   cryIfKeyId     Holds the identifier of the key for which the key state shall be
 *                             returned.
 ...
 * \retval  E_NOT_OK                      Request failed
 *
 * \ServiceID{::CRYIF_SID_KEYGETSTATUS}
 * \Synchronicity{Sync}
 * \Reentrancy{Non Reentrant}
 */
extern FUNC(Std_ReturnType, CRYIF_CODE) CryIf_KeyGetStatus
(
  uint32 cryIfKeyId,
  P2VAR(Crypto_KeyStatusType, AUTOMATIC, CRYIF_APPL_DATA) keyStatusPtr
);
