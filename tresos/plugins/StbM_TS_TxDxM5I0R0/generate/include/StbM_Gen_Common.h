...
#if (defined STBM_FRESHNESS_USED)
#error STBM_FRESHNESS_USED is already defined.
#endif
/** \brief Enables/disables freshness */
#define STBM_FRESHNESS_USED            STD_[!IF "$StbMFreshnessUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]

#if (defined STBM_FRESHNESS_CALLBACK_USED)
#error STBM_FRESHNESS_CALLBACK_USED is already defined.
#endif
/** \brief Enables/disables freshness callbacks */
#define STBM_FRESHNESS_CALLBACK_USED            STD_[!IF "$isFreshnessCallbackUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]

#if (defined STBM_FRESHNESS_RTEINTERFACE_USED)
#error STBM_FRESHNESS_RTEINTERFACE_USED is already defined.
#endif
/** \brief Enables/disables freshness Rte interfaces */
#define STBM_FRESHNESS_RTEINTERFACE_USED            STD_[!IF "$isFreshnessRteInterfaceUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]


#if (defined STBM_MASTER_FRESHNESS_USED)
#error STBM_MASTER_FRESHNESS_USED is already defined.
#endif
/** \brief Enables/disables freshness master APIs */
#define STBM_MASTER_FRESHNESS_USED            STD_[!IF "$isMasterReferringFreshnessValue = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]

#if (defined STBM_SLAVE_FRESHNESS_USED)
#error STBM_SLAVE_FRESHNESS_USED is already defined.
#endif
/** \brief Enables/disables freshness slave APIs */
#define STBM_SLAVE_FRESHNESS_USED            STD_[!IF "$isSlaveReferringFreshnessValue = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]


[!IF "$StbMFreshnessUsed = 'true'"!]


#if (defined STBM_TXFRESHNESS_USED)
#error STBM_TXFRESHNESS_USED is already defined.
#endif
/** \brief Enables/disables TxFreshness callbacks or Rte interfaces */
#define STBM_TXFRESHNESS_USED            STD_[!IF "$StbMTxFreshnessUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]

#if (defined STBM_TXFRESHNESSTRUNC_USED)
#error STBM_TXFRESHNESSTRUNC_USED is already defined.
#endif
/** \brief Enables/disables TxFreshnessTrunc callback or Rte interfaces */
#define STBM_TXFRESHNESSTRUNC_USED            STD_[!IF "$StbMTxFreshnessTruncUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]


#if (defined STBM_RXFRESHNESS_USED)
#error STBM_RXFRESHNESS_USED is already defined.
#endif
/** \brief Enables/disables RxFreshness callbacks or Rte interfaces */
#define STBM_RXFRESHNESS_USED            STD_[!IF "$StbMRxFreshnessUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]

#if (defined STBM_TXCONFFRESHNESS_USED)
#error STBM_TXCONFFRESHNESS_USED is already defined.
#endif
/** \brief Enables/disables TxConfFreshness callback or Rte interfaces */
#define STBM_TXCONFFRESHNESS_USED            STD_[!IF "$StbMTxConfFreshnessUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]


#if (defined STBM_NUMBER_OF_FRESHNESSVALUES)
#error STBM_NUMBER_OF_FRESHNESSVALUES is already defined.
#endif
/** \brief Number of configured freshness values. */
#define STBM_NUMBER_OF_FRESHNESSVALUES        [!"$StbMFreshnessValuesNumber"!]U


#if (defined STBM_FRESHNESSVALUE_TRUNCATION_ENABLED)
#error STBM_FRESHNESSVALUE_TRUNCATION_ENABLED is already defined.
#endif
/** \brief Enables/Disables the truncation of the complete freshness value in StbM */
#define STBM_FRESHNESSVALUE_TRUNCATION_ENABLED        STD_[!IF "$StbMFreshnessValueTruncationEnabled  = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]

[!IF "$isFreshnessRteInterfaceUsed = 'true'"!]
#if (defined STBM_TXFRESHNESSTRUNC_CSINTERFACE_USED)
#error STBM_TXFRESHNESSTRUNC_CSINTERFACE_USED is already defined.
#endif
/** \brief Enables/disables Rte GetTxFreshnessTruncData C-S Interface */
#define STBM_TXFRESHNESSTRUNC_CSINTERFACE_USED            STD_[!IF "$isGetTxFreshnessTruncDataCSInterfaceUsed = 'true'"!]ON[!ELSE!]OFF[!ENDIF!]
[!ENDIF!]
