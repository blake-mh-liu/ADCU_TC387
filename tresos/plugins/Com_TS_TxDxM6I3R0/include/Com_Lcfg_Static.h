...
extern FUNC(void, COM_APPL_CODE) Com_IpduGroupControl_UserCallout(Com_IpduGroupVector ipduGroupVector,
                                                                  boolean Initialize);

extern FUNC(void, COM_APPL_CODE) Com_ReceptionDMControl_UserCallout(Com_IpduGroupVector ipduGroupVector);
