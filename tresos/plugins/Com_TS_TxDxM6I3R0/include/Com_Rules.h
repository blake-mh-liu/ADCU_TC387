...
#if (defined COM_VALUE_REPLACE)        /* To prevent double declaration */
#error COM_VALUE_REPLACE already defined
#endif /* #if (defined COM_VALUE_REPLACE) */

#if ((COM_RX_DATA_TOUT_ACTION != COM_RX_DATA_TOUT_ACTION_NONE) || \
      (COM_FILTER_RECEIVER_ENABLE == STD_ON))
#define COM_VALUE_REPLACE STD_ON
#else
#define COM_VALUE_REPLACE STD_OFF
 ...
 * enables multiple partitioning behavior for the signal gateway support */
...
#define COM_HANDLESMALLERRXPDUS_CPY_SIG_TEST 0U
...
#define COM_HANDLESMALLERRXPDUS_CPY_SIG STD_OFF
#define COM_HANDLESMALLERRXPDUS_NOTIFY STD_ON
#define COM_HANDLESMALLERRXPDUS_CPY_SIG_TEST 1U
...
#ifndef COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE
#define COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE STD_OFF
#endif /* ifndef COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE */
