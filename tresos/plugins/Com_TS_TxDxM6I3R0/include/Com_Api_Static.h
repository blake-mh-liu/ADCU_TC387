 ...
 *
 * Reason:
 * AUTOSAR declares Com_Init function and COM_INIT constant.
 *
 */
...
/** \brief Definition of constant COMServiceId_IpduGroupStart */
#if (defined COMServiceId_IpduGroupStart)       /* To prevent double declaration */
#error COMServiceId_IpduGroupStart already defined
#endif /* if (defined COMServiceId_IpduGroupStart) */

/** \brief Define COMServiceId_IpduGroupStart */
#define COMServiceId_IpduGroupStart 0x03U

/** \brief Definition of constant COMServiceId_IpduGroupStop */
#if (defined COMServiceId_IpduGroupStop)       /* To prevent double declaration */
#error COMServiceId_IpduGroupStop already defined
#endif /* if (defined COMServiceId_IpduGroupStop) */

/** \brief Define COMServiceId_IpduGroupStop */
#define COMServiceId_IpduGroupStop 0x04U

/** \brief Definition of constant COMServiceId_EnableReceptionDM */
#if (defined COMServiceId_EnableReceptionDM)       /* To prevent double declaration */
#error COMServiceId_EnableReceptionDM already defined
#endif /* if (defined COMServiceId_EnableReceptionDM) */

/** \brief Define COMServiceId_EnableReceptionDM */
#define COMServiceId_EnableReceptionDM 0x06U

/** \brief Definition of constant COMServiceId_DisableReceptionDM */
#if (defined COMServiceId_DisableReceptionDM)       /* To prevent double declaration */
#error COMServiceId_DisableReceptionDM already defined
#endif /* if (defined COMServiceId_DisableReceptionDM) */

/** \brief Define COMServiceId_DisableReceptionDM */
#define COMServiceId_DisableReceptionDM 0x05U
...
#endif /* RTE_SCHM_SWCBSW_COM_MAINFUNCTIONTX */
...
#endif /* RTE_SCHM_SWCBSW_COM_MAINFUNCTIONROUTESIGNALS */
#endif /* (COM_TIMEBASE == STD_ON) */

/**
 * \brief Com_UpdateShadowSignal (Deprecated) - updates the data in the signal group
 *
...
/**
 * \brief Com_ReceiveShadowSignal (Deprecated) - get a group signal's value from shadow buffer
 *
 ...
 * \param[in] SignalGroupArrayLength Length of the signal group array (optional EB parameter)
 * \return Result of operation
 * \retval E_OK success
 * \retval COM_SERVICE_NOT_AVAILABLE failure (Com not initialized,
 * corresponding I-PDU group was stopped or
...
#if (COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE == STD_ON)
    ,uint16 SignalGroupArrayLength
#endif /* (COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE == STD_ON) */
);
...
#endif /* #if(COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE == STD_ON) */
);
...
#endif /* RTE_SCHM_SWCBSW_COM_MAINFUNCTIONRX */
#endif /* (COM_TIMEBASE == STD_ON) */
