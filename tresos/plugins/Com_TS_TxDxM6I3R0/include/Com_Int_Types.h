...
#if (defined COM_IPDUGROUPMASK_REF_INVALID)        /* To prevent double declaration */
#error COM_IPDUGROUPMASK_REF_INVALID already defined
#endif /* if (defined COM_IPDUGROUPMASK_REF_INVALID) */

/** \brief definition of the COM_IPDUGROUPMASK_REF_INVALID */
#define COM_IPDUGROUPMASK_REF_INVALID COM_INDEX_UINT16
