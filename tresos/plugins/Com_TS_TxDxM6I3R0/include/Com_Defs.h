...
#if (defined COM_RX_DATA_TOUT_ACTION_REPLACE_SUBVAL_INITVAL)        /* To prevent double declaration */
#error COM_RX_DATA_TOUT_ACTION_REPLACE_SUBVAL_INITVAL already defined
#endif /* if (defined COM_RX_DATA_TOUT_ACTION_REPLACE_SUBVAL_INITVAL) */

/** \brief Define COM_RX_DATA_TOUT_ACTION_REPLACE_SUBVAL_INITVAL (COM_RX_DATA_TOUT_ACTION_REPLACE_SUBVAL_INITVAL) */
#define COM_RX_DATA_TOUT_ACTION_REPLACE_SUBVAL_INITVAL 1U
