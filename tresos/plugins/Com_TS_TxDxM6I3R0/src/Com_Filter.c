 ...
 *
 * Reason:
 * The value of the expression is properly casted to the proper type as per
 * coding need and it is not leading to any defect.
 *
 */
...
static FUNC(boolean, COM_CODE) Com_EB_FilterOneEveryN
(
