 ...
 */
static FUNC_P2CONST(ComTxSignalGroupType, COM_APPL_CONST, AUTOMATIC) Com_GetTxSignalGroupCfg
(
 ...
 */
static FUNC(uint8, COM_CODE) Com_SetupTxSignalGroup_DET
(
...
)
{
   ...
   uint16 SignalGroupArrayLength = 0U;
#endif /* (COM_EB_SIGNALGROUPARRAY_LENGTH_ENABLE == STD_OFF) */
