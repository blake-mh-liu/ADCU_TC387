 ...
 *
 * Reason:
 * Com_gConfigPtr is not renamed because of readability and severity of impact
 * to benefit ratio.
 *
 * MISRAC2012-4) Deviated Rule: 5.9 (advisory)
...
VAR(uint8, COM_VAR) Com_IpduGroupVectorState[COM_IPDU_GROUP_VECTOR_NUM_BYTES] = {0U};

VAR(uint8, COM_VAR) Com_IpduGroupVectorStateDM[COM_IPDU_GROUP_VECTOR_NUM_BYTES] = {0U};
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Bool
(
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Uint8
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Uint16
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Uint32
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Sint8
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Sint16
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Sint32
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Uint64
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
static FUNC(boolean, COM_CODE) Com_EB_CalculateFilter_Sint64
(
   P2CONST(ComSignalBaseType, AUTOMATIC, AUTOMATIC) Com_EB_ReadPropPtr,
   P2CONST(uint8, AUTOMATIC, COM_VAR_CLEARED) dataPtr,
   P2CONST(ComFilterConfType, AUTOMATIC, AUTOMATIC) ComFilterPropPtr
...
/* Deviation MISRAC2012-1, MISRAC2012-4 */
