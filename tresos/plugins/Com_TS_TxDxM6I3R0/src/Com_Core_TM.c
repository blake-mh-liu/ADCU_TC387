 ...
 */
static FUNC(void, COM_CODE) Com_EB_Get_RemainingMDTticks
(
...
)
{
   ...
   ComTxModeRepetitionPeriodFactorType OffsetToGetTout = Offset;
   ...
   if(RemainingMDTticks != 0U)
   {
     ...
     OffsetToGetTout = Offset + (ComTxModeRepetitionPeriodFactorType)(RemainingMDTticks - GlobalTimeDelta);
   }
#endif /* (COM_TXMODEBEHAVIOUR == COM_CUSTOM1) */

   TimeOut = (ComTxModeRepetitionPeriodFactorType) ((ComTxModeRepetitionPeriodFactorType)globalTime + OffsetToGetTout);
