 ...
 * memory sections.
 *
 * MISRAC2012-3) Deviated Rule: 12.4 (advisory)
 ...
 */
static FUNC(void, COM_CODE) Com_EB_SetGroupSignalTMSFlagOfSignalGroup
(
 ...
 */
static FUNC(uint8, COM_CODE) Com_EB_CalculateSignalGroupTM
(
 ...
 */
static FUNC(void, COM_CODE) Com_EB_WriteShadowBuffer_Fragment
(
 ...
 */
static FUNC(boolean, COM_CODE) Com_EB_WriteShadowBuffer
(
   P2CONST(ComTxSignalGroupType, AUTOMATIC, COM_APPL_CONST) SignalGPtr,
   P2CONST(ComTxIPduType, AUTOMATIC, COM_APPL_CONST) IPduPtr,
   P2CONST(uint8, AUTOMATIC, COM_APPL_DATA) SGArrayPtr
...
)
{
   ...
   /* Deviation MISRAC2012-2 */
   P2CONST(uint8, AUTOMATIC, COM_APPL_CONST) writeMaskPtr = NULL_PTR;

#if (COM_EVALUATE_TRIGGERED_OC == STD_ON)
   /* Deviation MISRAC2012-2 */
   P2CONST(uint8, AUTOMATIC, COM_APPL_CONST) TOCMaskPtr = NULL_PTR;
#endif /* (COM_EVALUATE_TRIGGERED_OC == STD_ON) */

   /* Deviation MISRAC2012-4 */
   if(SignalGPtr->ComWriteMaskRef != (TS_CfgOffsetType)0U)
   {
      /* Deviation MISRAC2012-2 */
      writeMaskPtr = COM_GET_CONFIG_ELEMENT(uint8, SignalGPtr->ComWriteMaskRef, 0U);
   }

#if (COM_EVALUATE_TRIGGERED_OC == STD_ON)
   /* Deviation MISRAC2012-4 */
   if(SignalGPtr->ComTOCMaskRef != (TS_CfgOffsetType)0U)
   {
   /* Deviation MISRAC2012-2 */
      TOCMaskPtr = COM_GET_CONFIG_ELEMENT(uint8, SignalGPtr->ComTOCMaskRef, 0U);
   }
#endif /* (COM_EVALUATE_TRIGGERED_OC == STD_ON) */
