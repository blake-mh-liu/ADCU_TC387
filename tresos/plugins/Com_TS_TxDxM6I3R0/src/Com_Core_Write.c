 ...
 * \retval None
 */
static FUNC(void, COM_CODE) Com_EB_CheckValueSize8Bit
(
   uint8 Val,
 ...
 * \retval None
 */
static FUNC(void, COM_CODE) Com_EB_CheckValueSize16Bit
(
   uint16 Val,
   P2CONST(ComTxSignalType, AUTOMATIC, AUTOMATIC) Com_EB_WritePropPtr
);
 ...
 * \retval None
 */
static FUNC(void, COM_CODE) Com_EB_CheckValueSize32Bit
(
   uint32 Val,
   P2CONST(ComTxSignalType, AUTOMATIC, AUTOMATIC) Com_EB_WritePropPtr
);
