 ...
 *
 *  MISRAC2012-4) Deviated Rule: 5.8 (Required)
...
/* !LINKSTO EcuM.ASR403.EcuM3023,1 */
/*==================[inclusions]==============================================*/
...
/*==================[macros]==================================================*/
/* !LINKSTO EcuM.EB_Ref.Version.Check,1 */
...
/* patch version check */
#if (ECUM_SW_PATCH_VERSION < 15U)
#error ECUM_SW_PATCH_VERSION wrong (< 15U)
#endif
...
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
/** \brief Indication to BswM of the status of wakeup sources
 **
 ** \param[in]  sources       The wakeup sources to be indicated.
 ** \param[in]  status        The new status of the wakeup sources.
 ** \param[out] CoreInstance  The current core instance of EcuM.
 **
 ** \par One of the following values is passed by the "status" function parameter:
 ** \li ECUM_WKSTATUS_DISABLED
...
STATIC FUNC(void, ECUM_CODE) EcuM_LastIsBestWksIndication
(
...
#if (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
STATIC FUNC(Std_ReturnType, ECUM_CODE) EcuM_SelectShutdownTargetSequence_ASR_R2011(EcuM_ShutdownTargetType shutdownTarget, EcuM_ShutdownModeType shutdownMode);
#else
...
#if (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
#define ECUM_START_SEC_VAR_POWER_ON_INIT_16
#include <EcuM_MemMap.h>
...
STATIC VAR(EcuM_ShutdownModeType, ECUM_VAR_POWER_ON_INIT) EcuM_LastSleepMode = 0U;
 ...
 **
 ** This variable must survive ECU resets. */
STATIC VAR(EcuM_ShutdownModeType, ECUM_VAR_POWER_ON_INIT) EcuM_LastResetMode = 0U;

#define ECUM_STOP_SEC_VAR_POWER_ON_INIT_16
#include <EcuM_MemMap.h>
#endif /* (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011) */
 ...
 **
 ** This variable must survive ECU resets. */
STATIC VAR(EcuM_ShutdownTargetType, ECUM_VAR_POWER_ON_INIT) EcuM_LastShutdownTarget = ECUM_SHUTDOWN_TARGET_OFF;
#else
/** \brief Last Sleep Mode
 **
 ** This variable holds the sleep mode of the last sleep sequence.
...
STATIC VAR(EcuM_ShutdownModeType, ECUM_VAR_CLEARED) EcuM_ResetMode;
 ...
 ** sequence. */
STATIC VAR(EcuM_ShutdownTargetType, ECUM_VAR_CLEARED) EcuM_ShutdownTarget;
#else
/** \brief Current reset mode for Ecu Reset
 **
 ** This variable holds the current reset mode used in the next shutdown
...
/*------------------[EcuM_GoDown]---------------------------------------------*/
/* !LINKSTO EcuM.ASR403.EcuM4046,1 */
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GoDown(uint16 caller)
{
...
#endif
  {
    ...
    /* !LINKSTO EcuM.ASR42.SWS_EcuM_04021,1 */
    else
    {
...
/* !LINKSTO EcuM.ASR42.SWS_EcuM_04019,1 */
STATIC FUNC(Std_ReturnType, ECUM_CODE) EcuM_GoDownMaster(void)
{
  Std_ReturnType ret = E_OK;
...
/*------------------[EcuM_GoHalt]---------------------------------------------*/
/* !LINKSTO EcuM.ASR403.EcuM4048,1 */
FUNC(Std_ReturnType, ECUM_CODE) EcuM_GoHalt(void)
{
...
#endif
  {
    ...
    if (ECUM_CORE_ID_MASTER == ECUM_GET_CORE_ID())
    {
      /* !LINKSTO EcuM.SWS_EcuM_04024,1 */
      ret = EcuM_GoHaltMaster();
    }
    else
    {
      /* !LINKSTO EcuM.SWS_EcuM_04028,1 */
...
STATIC FUNC(Std_ReturnType, ECUM_CODE) EcuM_GoHaltSlave(void)
{
  ...
  /* Callout to allow for synchronization with the PreHalt activities done on the master core */
  /* !LINKSTO EcuM.Impl.Source.SlaveCore.PreHalt,1 */
  /* !LINKSTO EcuM.Impl.Configuration.EcuMPreHaltSlaveCalloutEnabled,1 */
#if (ECUM_PREHALT_SLAVE == STD_ON)
  EcuM_PreHaltSlave();
#endif
...
/* !LINKSTO EcuM.ASR403.EcuM4049,1, EcuM.SWS_EcuM_04025,1, EcuM.SWS_EcuM_04029,1 */
...
STATIC FUNC(void, ECUM_CODE) EcuM_Init_MultiCore(void)
{
  ...
  /* Slave Core STARTUP */
  /* !LINKSTO EcuM.SWS_EcuM_04017,1 */
  if (ECUM_CORE_ID_MASTER != ECUM_GET_CORE_ID())
  {
    EcuM_GetCoreInstance()->SleepMode = (EcuM_ConfigPtr->DefaultMode);
  }
  /* start the operating system */
  /* !LINKSTO EcuM.SWS_EcuM_04093,1 */
  StartOS(EcuM_ConfigPtr->DefaultAppMode);
}
#endif /* (ECUM_MULTICORE_ENABLED == TRUE) */

/*------------------[EcuM_Init]-----------------------------------------------*/
/* !LINKSTO EcuM.SWS_EcuM_02811,1 */
...
/* !LINKSTO EcuM.SWS_EcuM_04016,1, EcuM.SWS_EcuM_04018,1, EcuM.SWS_EcuM_02838,1 */
...
#if (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
    if (EcuM_ShutdownTarget == ECUM_SHUTDOWN_TARGET_RESET)
    {
...
#if (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
STATIC FUNC(Std_ReturnType, ECUM_CODE) EcuM_SelectShutdownTargetSequence_ASR_R2011
(
...
)
{
  ...
  /* !LINKSTO EcuM.ASR42.SWS_EcuM_04094,1 */
#if (ECUM_MULTICORE_ENABLED == TRUE)
  if (ECUM_CORE_ID_MASTER != ECUM_GET_CORE_ID())
  {
#if (ECUM_DEV_ERROR_DETECT == STD_ON)
  ...
  (
    ...
    ((shutdownTarget != ECUM_SHUTDOWN_TARGET_RESET) && (shutdownTarget != ECUM_SHUTDOWN_TARGET_OFF))
  )
  {
    ECUM_DET_REPORT_ERROR(ECUM_SID_SEL_SHUT_TAR, ECUM_E_STATE_PAR_OUT_OF_RANGE);
  }
  else if ((shutdownTarget == ECUM_SHUTDOWN_TARGET_SLEEP) && (shutdownMode >= ECUM_SLEEPMODECONFIGNUM))
  {
...
#endif /* (ECUM_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    {
      EcuM_ShutdownTarget = shutdownTarget;
      EcuM_GetCoreInstance()->SleepMode = shutdownMode;
#if (ECUM_MULTICORE_ENABLED == TRUE)
      sendSleepMode = TRUE;
#endif
    }
    ...
    {
      schMSendResult = SchM_Send_EcuM_EcuM_SetSleepMode(shutdownMode);
...
FUNC(Std_ReturnType, ECUM_CODE) EcuM_ASR_R2011_SelectShutdownTarget
(
  EcuM_ShutdownTargetType shutdownTarget,
  EcuM_ShutdownModeType shutdownMode
)
{
  Std_ReturnType ret = E_NOT_OK;
  ret = EcuM_SelectShutdownTargetSequence_ASR_R2011(shutdownTarget, shutdownMode);

  return ret;
}
#else
/* !LINKSTO EcuM.SWS_EcuM_02822,1 */
...
#endif /* (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011) */
#else /* !((ECUM_MULTICORE_ENABLED == TRUE) && (ECUM_INCLUDE_RTE == STD_ON)) */
#if (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
/* Deviation MISRAC2012-3 */
/* Deviation MISRAC2012-4 */
...
#endif /* (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011) */
#endif /* !((ECUM_MULTICORE_ENABLED == TRUE) && (ECUM_INCLUDE_RTE == STD_ON)) */
...
/* !LINKSTO EcuM.EB.ASR32.EcuM106,1, EcuM.SWS_EcuM_02824,1 */
...
#endif
{
...
#endif
  {
    ...
    if (shutdownMode != NULL_PTR)
    {
      if (EcuM_ShutdownTarget == ECUM_SHUTDOWN_TARGET_SLEEP)
      {
        *shutdownMode = EcuM_GetMasterCoreInstance()->SleepMode;
      }
      else if (EcuM_ShutdownTarget == ECUM_SHUTDOWN_TARGET_RESET)
      {
        *shutdownMode = EcuM_ResetMode;
      }
      else
      {
    ...
    if ((shutdownMode != NULL_PTR) && (shutdownTarget != NULL_PTR))
    {
      ret = E_OK;
    }
#else
...
#else
/* !LINKSTO EcuM.EB.ASR32.EcuM106,1, EcuM.SWS_EcuM_02825,1 */
/* Deviation MISRAC2012-1 */
FUNC(Std_ReturnType, ECUM_CODE) EcuM_ASR40_GetLastShutdownTarget
(
  P2VAR(EcuM_ASR40_StateType, AUTOMATIC, ECUM_APPL_DATA) shutdownTarget,
...
#endif
{
...
#endif
  {
    ...
    if (shutdownMode != NULL_PTR)
    {
      if (EcuM_LastShutdownTarget == ECUM_SHUTDOWN_TARGET_SLEEP)
      {
        /* !LINKSTO EcuM.EB_Ref.SWS_EcuM_02336_1,1 */
        *shutdownMode = EcuM_LastSleepMode;
      }
      else if (EcuM_LastShutdownTarget == ECUM_SHUTDOWN_TARGET_RESET)
      {
        /* !LINKSTO EcuM.EB_Ref.SWS_EcuM_02336_1,1 */
        *shutdownMode = EcuM_LastResetMode;
      }
#else
    if (sleepMode != NULL_PTR)
    {
      ...
      {
        /* !LINKSTO EcuM.EB_Ref.SWS_EcuM_02336_2,1 */
...
/* !LINKSTO EcuM.EB.ASR32.EcuM106,1, EcuM.SWS_EcuM_04050,1 */
...
/* !LINKSTO EcuM.EB.ASR32.EcuM106,1, EcuM.SWS_EcuM_04051,1 */
/* Deviation MISRAC2012-1 */
...
/* !LINKSTO EcuM.ASR403.EcuM4052,1, EcuM.EB.ASR32.EcuM106,1 */
...
/* !LINKSTO EcuM.ASR403.EcuM4053,1, EcuM.EB.ASR32.EcuM106,1 */
...
/* !LINKSTO EcuM.EB.Dsn.Interaction.EcuMMultiCoreWakeupEventHandling,1, EcuM.SWS_EcuM_02827,1 */
...
/* !LINKSTO EcuM.SWS_EcuM_04011,1, EcuM.SWS_EcuM_02837,1 */
FUNC(void, ECUM_CODE) EcuM_MainFunction(void)
{
  ...
  if ((ECUM_STATE_STARTUP_ONE != CoreInstance->State) && (ECUM_STATE_STARTUP_TWO != CoreInstance->State))
  {
    ...
    if ((CoreInstance->State == ECUM_STATE_WAKEUP_VALIDATION) && (wksValidated != 0U))
    {
      CoreInstance->State = ECUM_STATE_RUN;
      /* !LINKSTO EcuM.BswMStateIndication,1 */
      BswM_EcuM_CurrentState(CoreInstance->State);
...
/* !LINKSTO EcuM.EB.Impl.EcuMBswMWakeupIndicationLastIsBest,1 */
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
STATIC FUNC(void, ECUM_CODE) EcuM_LastIsBestWksIndication
(
  EcuM_WakeupSourceType sources,
...
)
{
  switch(status)
  {
    ...
    {
      CoreInstance->WakeupIndication.None &= (EcuM_WakeupSourceType)~sources;
      CoreInstance->WakeupIndication.Expired &= (EcuM_WakeupSourceType)~sources;
      CoreInstance->WakeupIndication.Pending &= (EcuM_WakeupSourceType)~sources;
      CoreInstance->WakeupIndication.Validated &= (EcuM_WakeupSourceType)~sources;
      break;
    }
    case ECUM_WKSTATUS_NONE:
    {
      ...
      CoreInstance->WakeupIndication.Pending &= (EcuM_WakeupSourceType)~sources;
      CoreInstance->WakeupIndication.Validated &= (EcuM_WakeupSourceType)~sources;
      CoreInstance->WakeupIndication.Disabled &= (EcuM_WakeupSourceType)~sources;
      break;
    }
...
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
      EcuM_LastIsBestWksIndication(sources, ECUM_WKSTATUS_DISABLED, CoreInstance);
#endif
...
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
      EcuM_LastIsBestWksIndication(sources, ECUM_WKSTATUS_NONE, CoreInstance);
#endif
...
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
      EcuM_LastIsBestWksIndication(sources, ECUM_WKSTATUS_PENDING, CoreInstance);
#endif
...
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
      EcuM_LastIsBestWksIndication(sources, ECUM_WKSTATUS_VALIDATED, CoreInstance);
#endif
...
#if (ECUM_BSWM_WKINDICATION_LAST_IS_BEST == TRUE)
      EcuM_LastIsBestWksIndication(sources, ECUM_WKSTATUS_EXPIRED, CoreInstance);
#endif
