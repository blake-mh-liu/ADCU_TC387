...
#define ECUM_START_SEC_VAR_CLEARED_ECUM_BOOTTARGET_UNSPECIFIED
#include <EcuM_MemMap.h>

/* Boot target */
VAR(EcuM_BootTargetInternalType, ECUM_VAR_BOOTTARGET) EcuM_BootTarget;

#define ECUM_STOP_SEC_VAR_CLEARED_ECUM_BOOTTARGET_UNSPECIFIED
#include <EcuM_MemMap.h>

#else /* (ECUM_USE_BOOTTARGET_SEC == STD_OFF) */
...
#endif /* (ECUM_USE_BOOTTARGET_SEC == STD_ON) */
...
/* !LINKSTO EcuM.EB.ASR32.EcuM106,1, EcuM.SWS_EcuM_02835,1 */
...
#endif
/*------------------[EcuM_GetBootTarget]------------------------------------*/
/* !LINKSTO EcuM.EB.ASR32.EcuM106,1, EcuM.SWS_EcuM_02836,1 */
