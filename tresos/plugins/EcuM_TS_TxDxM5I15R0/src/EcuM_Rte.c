...
#elif (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
...
{
  return EcuM_ASR_R2011_SelectShutdownTarget(shutdownTarget, shutdownMode);
}
#endif
...
{
  return EcuM_ASR40_GetShutdownTarget(shutdownTarget, shutdownMode);
}
...
{
  return EcuM_ASR40_GetLastShutdownTarget(shutdownTarget, shutdownMode);
}
...
{
  /* !LINKSTO EcuM.EB.ASR32.EcuM110,1 */
  return EcuM_ASR40_SelectShutdownCause(shutdownCause);
}
