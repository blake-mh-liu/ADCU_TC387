...
#ifndef RTE_TYPE_EcuM_ShutdownTargetType
#define RTE_TYPE_EcuM_ShutdownTargetType
typedef VAR(uint8, TYPEDEF) EcuM_ShutdownTargetType;
#endif

#ifndef RTE_TYPE_EcuM_ShutdownModeType
#define RTE_TYPE_EcuM_ShutdownModeType
typedef VAR(uint16, TYPEDEF) EcuM_ShutdownModeType;
#endif
...
/* !LINKSTO EcuM.EB_Ref.SWS_EcuM_04040.Range,1 */
...
#if (ECUM_EB_DEFAULT_ASR_SERVICE_API == ECUM_EB_SERVICE_API_ASR_R2011)
/* !LINKSTO EcuM.EB_Ref.SWS_EcuM_04044_1,1 */
typedef EcuM_ShutdownModeType EcuM_ResetType;
#else
/* !LINKSTO EcuM.SWS_EcuM_04044,1 */
 ...
 **
 ** All valid values for this type are defined as preprocessor macros. */
/* !LINKSTO EcuM.ASR403.EcuM4039,1 */
 ...
 ** A unique User ID, which must be defined for each user at system generation
 ** time. */
/* !LINKSTO EcuM.ASR403.EcuM4067,1 */
 ...
 **
 ** All valid values for this type are defined as preprocessor macros. */
/* !LINKSTO EcuM.ASR403.EcuM4042,1 */
