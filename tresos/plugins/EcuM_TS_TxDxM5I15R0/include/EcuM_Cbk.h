...
/* !LINKSTO EcuM.ASR403.EcuM2994,1 */
...
/** \brief Callout during sleep state.
 **
 ** In this callout, during Halt sequence executed on a slave core, execution of interrupts
 ** leading to wakeup will be disabled before the ECU is halted (call of Mcu_SetMode())
 **
 ** \Reentrancy{Non-Reentrant}
 ** \Synchronicity{Synchronous} */
/* !LINKSTO EcuM.Impl.EcuM_PreHaltSlave,1 */
extern FUNC(void, ECUM_APPL_CODE) EcuM_PreHaltSlave(void);
#endif
