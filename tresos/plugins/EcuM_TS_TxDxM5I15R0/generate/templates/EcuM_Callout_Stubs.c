...
/* !LINKSTO EcuM.SWS_EcuM_02906,1 */
FUNC(EcuM_DeterminePbConfigurationRetType, ECUM_APPL_CODE)
  EcuM_DeterminePbConfiguration(void)
{
  EcuM_DeterminePbConfigurationRetType PbConfig = &([!"as:name(EcuMConfiguration/eb-list::*[1])"!]);
