 ...
 *
 *     Reason:
 *     All Os generated core ID values are verified against the value of ECUM_CORE_ID_INITIAL.
 *     Considering ECUM_CORE_ID_INITIAL is mapped to an Os core ID, then one if condition will never
 *     be reached. This check cannot be avoided.
 *
 */
...
[!VAR "NrComMChannel" = "num:i(count(util:distinct(node:refs(as:modconf('EcuM')[1]/EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMWakeupSource/eb-list::*/EcuMComMChannelRef))))"!]
[!VAR "NrComMPNC" = "num:i(count(util:distinct(node:refs(as:modconf('EcuM')[1]/EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMWakeupSource/eb-list::*/EcuMComMPNCRef))))"!]
[!VAR "CROSSCORECOMMWAKEUP" = "node:existsAndTrue(as:modconf('EcuM')[1]/EcuMGeneral/EcuMCrossCoreComMWakeup)"!]
...
[!VAR "START_INITIAL_CORE" = "node:existsAndTrue(as:modconf('EcuM')/EcuMGeneral/EcuMStartInitialCore)"!]
...
[!VAR "ModuleList"="' Mcu '"!]
[!LOOP "util:union((EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMDriverInitListZero/EcuMDriverInitItem/eb-list::*) , (EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMDriverInitListOne/EcuMDriverInitItem/eb-list::*) , (EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMDriverRestartList/EcuMDriverInitItem/eb-list::*))"!][!//
[!/*
...
*/!][!//
[!IF "node:existsAndTrue(./EcuMEnableVendorApiInfix) and node:empty(./EcuMModuleHeaderFile)"!][!//
[!VAR "ModuleRef" = "as:path(as:ref(../../../../EcuMFlexConfiguration/EcuMFlexModuleConfigurationRef/eb-list::*[starts-with(node:value(.),concat('ASPath:/',node:value(node:current()/EcuMModuleID),'/'))]))"!][!//
...
[!VAR "ModuleId"="as:name(as:ref($ModuleRef)/../../.)"!][!//
...
[!ELSEIF "((EcuMModuleService = 'Init') or (EcuMModuleService = 'PreInit')) and (count(../../../../EcuMFlexConfiguration/EcuMFlexModuleConfigurationRef/eb-list::*[contains(.,$RefSubString)]) > 0)"!][!//
&[!"as:name(as:ref(../../../../EcuMFlexConfiguration/EcuMFlexModuleConfigurationRef/eb-list::*[contains(.,$RefSubString)]))"!][!//
[!ELSE!][!//
...
{
[!VAR "Index" = "0"!]
[!FOR "i" = "0" TO "num:max(EcuMWakeupSource/eb-list::*/EcuMWakeupSourceId)"!]
  [!IF "node:exists(EcuMWakeupSource/eb-list::*[EcuMWakeupSourceId = num:i($i)])"!]
  [!"num:i($Index)"!]U,
  [!VAR "Index" = "$Index + 1"!]
  [!ELSE!]
  ECUM_WKS_INVALID_ID,
...
[!IF "(node:existsAndTrue($MULTICORE_ENABLED)) and (node:existsAndTrue($CROSSCORECOMMWAKEUP))"!]
[!IF "$NrComMChannel > 0"!]
CONST(uint8, ECUM_CONST) EcuM_ComM_Channel_Translation[ECUM_COMM_CHANNELS_NUMBER] = 
{
[!LOOP "util:distinct(node:order(util:distinct(node:refs(as:modconf('EcuM')[1]/EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMWakeupSource/eb-list::*/EcuMComMChannelRef)), 'ComMChannelId'))"!]
 [!"ComMChannelId"!],
[!ENDLOOP!]
...
{
[!LOOP "util:distinct(node:order(util:distinct(node:refs(as:modconf('EcuM')[1]/EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMWakeupSource/eb-list::*/EcuMComMPNCRef)), 'ComMPncId'))"!]
  [!"ComMPncId"!],
[!ENDLOOP!]
};
[!ENDIF!]
...
{
[!LOOP "util:distinct(node:order(EcuMWakeupSource/eb-list::*, 'EcuMWakeupSourceId'))"!]
  [!"num:i(EcuMValidationTimeout div $EcuMPeriodMainFunction)"!]U, /* Timeout for wakeup source [!"as:name(.)"!] */
[!ENDLOOP!]
};
...
[!LOOP "util:distinct(node:order(EcuMWakeupSource/eb-list::*, 'EcuMWakeupSourceId'))"!]
  ...
  [!IF "node:refexists(EcuMResetReasonRef)"!]
    [!"as:name(as:ref(EcuMResetReasonRef)/McuResetReason/..)"!],   /* Reset Reason */
  [!ELSE!]
...
[!INDENT "4"!][!//
    ...
    ECUM_[!"as:name(.)"!]_WKUP_MASK, /* Wakeup event mask of sleep mode [!"as:name(.)"!] */
    /* Sleep mode: [!"as:name(.)"!], ID: [!"EcuMSleepModeId"!] */
#if (defined [!//
...
[!IF "node:existsAndTrue(../../../EcuMGeneral/EcuMIncludeDem)"!][!//
...
CONST(Dem_EventIdType, ECUM_CONST) EcuM_DemErrRamChkFailed =
  ...
  [!IF "node:existsAndTrue(../../../EcuMConfiguration/eb-list::*[1]/EcuMFixedConfiguration/EcuMRunMinimumDuration) or node:existsAndFalse(../../../EcuMConfiguration/eb-list::*[1]/EcuMFixedConfiguration/EcuMRunMinimumDuration)"!][!//
...
[!IF "node:exists(EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMDriverInitListZero)"!][!//
/* Configured Initialization List Zero items */
FUNC(void, ECUM_CODE) EcuM_DefaultInitListZero(void)
{
[!LOOP "EcuMConfiguration/eb-list::*[1]/EcuMCommonConfiguration/EcuMDriverInitListZero/EcuMDriverInitItem/eb-list::*"!][!//
  /* *** Call service [!"EcuMModuleService"!] of module [!"EcuMModuleID"!] *** */
[!VAR "RefSubString"="concat('/',EcuMModuleID,'/',EcuMModuleID,'/')"!][!//
[!IF "node:existsAndTrue(./EcuMEnableVendorApiInfix)"!][!//
[!VAR "RefSubString"="concat('/',EcuMModuleID,'/')"!][!//
...
{
[!FOR "Index" = "0" TO "$MULTICORE_NUM_CORES - 1"!][!//
[!IF "node:existsAndFalse($START_INITIAL_CORE)"!]
  /* Deviation MISRAC2012-1 */
  if ((uint8)OS_CORE_ID_[!"num:i($Index)"!] != (uint8)ECUM_CORE_ID_INITIAL)
[!ENDIF!]
  {
    StatusType status;
