...
/* !LINKSTO LinIf.EB.LinIfBusAHeaderFile_Inclusion,1 */
[!IF "node:exists(LinIfGeneral/LinIfBusATxIndication) or node:exists(LinIfGeneral/LinIfBusARxIndication)"!]
#include <[!"LinIfGeneral/LinIfBusAHeaderfile"!]>    /* Bus Adapter support */
[!ENDIF!]
...
#define LINIF_PBCFGM_SUPPORT_ENABLED [!IF "node:contains(util:distinct(node:refs(as:modconf('PbcfgM')/PbcfgMBswModules/*/PbcfgMBswModuleRef)), as:modconf('LinIf')) = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
#define LINIF_CFG_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('LinIf')[1], 'PreCompile')"!]U
...
#define LINIF_PUBLIC_INFO_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('LinIf')[1]/CommonPublishedInformation, 'PublishedInformation', as:modconf('LinIf')[1]/CommonPublishedInformation/Release)"!]U /* PublicInfoSignature */

/* ----- Pre-processor switch to enable/diable relocateable postbuild config ----- */
[!IF "node:contains(util:distinct(node:refs(as:modconf('PbcfgM')/PbcfgMBswModules/*/PbcfgMBswModuleRef)), as:modconf('LinIf')) = 'true'"!]
...
#if (defined LINIF_DIAG_MSGS_REPORTING_ENABLE)
#error LINIF_DIAG_MSGS_REPORTING_ENABLE already defined!
#endif /* #if( defined LINIF_DIAG_MSGS_REPORTING_ENABLE)*/
#define LINIF_DIAG_MSGS_REPORTING_ENABLE [!IF "LinIfGeneral/LinIfMirrorDiagMsgsEnable = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
...
/* !LINKSTO LinIf.EB.LinIfBusATxIndication_ConfigureAPI,1 */
[!IF "node:exists(LinIfGeneral/LinIfBusATxIndication)"!]
/** \def LINIF_BUS_ADAPTER_TX_SUPPORT
**
** \brief Macro for Bus Adapter Tx extension support.
**
** This switch defines if Bus Adapter Tx extension support is enabled.
*/
#if (defined LINIF_BUS_ADAPTER_TX_SUPPORT)
#error LINIF_BUS_ADAPTER_TX_SUPPORT already defined!
#endif /* #if( defined LINIF_BUS_ADAPTER_TX_SUPPORT)*/
#define LINIF_BUS_ADAPTER_TX_SUPPORT        STD_ON
/** \def BUSA_LINIF_TXINDICATION
**
** \brief Tx Bus Adapter support.
**
** This is a Macro for Tx Bus Adapter configured API.
*/
#if (defined BUSA_LINIF_TXINDICATION)
#error BUSA_LINIF_TXINDICATION already defined!
#endif /* #if( defined BUSA_LINIF_TXINDICATION)*/
#define BUSA_LINIF_TXINDICATION(linId,pduInfo,frameType,currentId) [!"LinIfGeneral/LinIfBusATxIndication"!](linId,pduInfo,frameType,currentId)
[!ELSE!]
/** \def LINIF_BUS_ADAPTER_TX_SUPPORT
**
** \brief Macro for Bus Adapter Tx extension support.
...
#error LINIF_BUS_ADAPTER_TX_SUPPORT already defined!
#endif /* #if( defined LINIF_BUS_ADAPTER_TX_SUPPORT)*/
#define LINIF_BUS_ADAPTER_TX_SUPPORT        STD_OFF
[!ENDIF!]

/* !LINKSTO LinIf.EB.LinIfBusARxIndication_ConfigureAPI,1 */
[!IF "node:exists(LinIfGeneral/LinIfBusARxIndication)"!]
/** \def LINIF_BUS_ADAPTER_RX_SUPPORT
**
** \brief Macro for Bus Adapter Rx extension support.
**
** This switch defines if Bus Adapter Rx extension support is enabled.
*/
#if (defined LINIF_BUS_ADAPTER_RX_SUPPORT)
#error LINIF_BUS_ADAPTER_RX_SUPPORT already defined!
#endif /* #if( defined LINIF_BUS_ADAPTER_RX_SUPPORT)*/
#define LINIF_BUS_ADAPTER_RX_SUPPORT        STD_ON
/** \def BUSA_LINIF_RXINDICATION
**
** \brief Rx Bus Adapter support.
**
** This is a macro for Rx Bus Adapter configured API.
*/
#if (defined BUSA_LINIF_RXINDICATION)
#error BUSA_LINIF_RXINDICATION already defined!
#endif /* #if( defined BUSA_LINIF_RXINDICATION)*/
#define BUSA_LINIF_RXINDICATION(linId, pduInfo, frameType, currentId) [!"LinIfGeneral/LinIfBusARxIndication"!](linId, pduInfo, frameType, currentId)
[!ELSE!]
/** \def LINIF_BUS_ADAPTER_RX_SUPPORT
**
** \brief Macro for Bus Adapter Rx extension support.
...
#error LINIF_BUS_ADAPTER_RX_SUPPORT already defined!
#endif /* #if( defined LINIF_BUS_ADAPTER_RX_SUPPORT)*/
#define LINIF_BUS_ADAPTER_RX_SUPPORT        STD_OFF
[!ENDIF!]
...
#define LINTP_PBCFGM_SUPPORT_ENABLED [!IF "node:contains(util:distinct(node:refs(as:modconf('PbcfgM')/PbcfgMBswModules/*/PbcfgMBswModuleRef)), as:modconf('LinTp')) = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]

/** \brief Compile time verification value */
#if (defined LINTP_CFG_SIGNATURE)
#error LINTP_CFG_SIGNATURE already defined!
#endif /* #if( defined LINTP_CFG_SIGNATURE)*/
#define LINTP_CFG_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('LinTp')[1], 'PreCompile')"!]U
...
#define LINTP_PUBLIC_INFO_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('LinTp')[1]/CommonPublishedInformation, 'PublishedInformation', as:modconf('LinTp')[1]/CommonPublishedInformation/Release)"!]U /* PublicInfoSignature */


/* ----- Pre-processor switch to enable/diable relocateable postbuild config ----- */
[!IF "node:contains(util:distinct(node:refs(as:modconf('PbcfgM')/PbcfgMBswModules/*/PbcfgMBswModuleRef)), as:modconf('LinTp')) = 'true'"!]
