...
*/!][!VAR "numSchTables"="num:i(count(as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfScheduleTable/*[as:name(.) != 'NULL_SCHEDULE']))"!][!/*
*/!][!VAR "numEntries"="num:i(count(as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfScheduleTable/*[as:name(.) != 'NULL_SCHEDULE']/LinIfEntry/*))"!][!/*
...
*/!][!VAR "numTrcvs"="num:i(count(util:distinct(node:refs(as:modconf('LinIf')/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfTransceiverDrvConfig/LinIfTrcvIdRef))/../..))"!][!/*
...
*/!][!VAR "frameListSeps" = "''"!][!/*
*/!][!VAR "SchChgDiagEnabled" = "node:existsAndTrue(as:modconf('LinTp')[1]/LinTpGeneral/LinTpScheduleChangeDiagApiEnable)"!][!/*
...
*/!][!FOR "A"="1" TO "$numChannels"!][!/*
   ...
   */!][!LOOP "as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*[num:i($A)]/LinIfFrame/*[LinIfFrameType='UNCONDITIONAL' and LinIfPduDirection='LinIfRxPdu']"!][!/*
      ...
      */!][!ELSE!][!/*
        */!][!VAR "assocCdd" = "as:modconf('LinIf')[1]/LinIfGeneral/LinIfCddFunctionsUL/*[as:name(.)=node:current()/LinIfPduDirection/LinIfRxIndicationUL]/CddName"!][!/*
      ...
      */!][!ENDIF!][!/*
      */!][!IF "$rxSrcPduHandleId=''"!][!ERROR!] The unconditional Rx frame '[!"as:name(.)"!]' does not have an associated [!"$assocCntr"!] container referenced by the same EcuC reference. [!ENDERROR!][!ENDIF!][!/*
...
*/!][!LOOP "as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfFrame/*[LinIfFrameType='UNCONDITIONAL' and LinIfPduDirection='LinIfTxPdu']"!][!/*
      ...
      */!][!ELSE!][!/*
        */!][!VAR "assocCdd" = "as:modconf('LinIf')[1]/LinIfGeneral/LinIfCddFunctionsUL/*[as:name(.)=node:current()/LinIfPduDirection/LinIfTxTriggerTransmitUL]/CddName"!][!/*
        <!-- !LINKSTO LinIf.EB.LinIfCddRef.Contribution.HandleID.PduRSurrogate,1 -->
      ...
      */!][!ENDIF!][!/*
   */!][!IF "$txDestPduHandleId=''"!][!ERROR!] The unconditional Tx frame '[!"as:name(.)"!]' does not have an associated [!"$assocCntr"!] container referenced by the same EcuC reference. [!ENDERROR!][!ENDIF!][!/*
  ...
  */!][!IF "$vInfix != ''"!][!/*
    ...
    */!][!IF "as:modconf('LinIf')[1]/LinIfGeneral/LinIfLinDriverAPI = 'REV42' or as:modconf('LinIf')[1]/LinIfGeneral/LinIfLinDriverAPI = 'REV431' or as:modconf('LinIf')[1]/LinIfGeneral/LinIfLinDriverAPI = 'REV44'"!][!/*
      */!][!LOOP "as:modconf('Lin')/LinGlobalConfig/LinChannel/*"!][!/*
        */!][!IF "string($ChannelRef) = node:path(.)"!][!/*
...
*/!][!IF "$numSporadic = 0"!][!VAR "fidx" = "0"!][!ELSE!][!/*
   ...
   */!][!LOOP "LinIfGlobalConfig/*[1]/LinIfChannel/*/LinIfFrame/*[LinIfFrameType='SPORADIC']"!][!/*
      ...
      */!][!LOOP "util:distinct(node:order(LinIfSubstitutionFrames/*/LinIfSubstitutionFrameRef, '../LinIfFramePriority'))"!][!/*
...
*/!][!LOOP "util:distinct(node:order(as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*[LinIfNodeType = 'LinIfSlave'], 'LinIfChannelId'))"!][!/*
...
[!IF "node:exists(as:modconf('LinIf')/LinIfGlobalConfig/*[1]/LinIfChannel/*[num:i($A)]/LinIfTransceiverDrvConfig/LinIfTrcvIdRef)"!]
  [!IF "not(text:contains(string($trcvRef), string(as:path(node:ref(as:modconf('LinIf')/LinIfGlobalConfig/*[1]/LinIfChannel/*[num:i($A)]/LinIfTransceiverDrvConfig/LinIfTrcvIdRef)/../..))))"!]
    ...
    [!VAR "includeTrcvCbk" = "as:modconf('LinIf')/LinIfGlobalConfig/*[1]/LinIfChannel/*[num:i($A)]/LinIfTransceiverDrvConfig/LinIfIncludeTrcvCbk"!]
    ...
    [!VAR "trcvLst"!][!"$trcvLst"!][!"as:path(node:ref(as:modconf('LinIf')/LinIfGlobalConfig/*[1]/LinIfChannel/*[num:i($A)]/LinIfTransceiverDrvConfig/LinIfTrcvIdRef)/../..)"!],[!"$trcvPos"!],[!"$wuSupp"!],[!"$includeTrcvCbk"!],[!"$trcvVendorID"!],[!"$trcvApiInfix"!];[!ENDVAR!]
...
[!LOOP "text:split($trcvLst, ';')"!]
  [!VAR "mangledName" = "''"!]
  [!IF "$trcvDoApiInfix = 'true'"!]
    [!VAR "mangledName" = "concat(text:split(.,',')[5], text:split(.,',')[6])"!]
  [!ENDIF!]
[!CODE!][!//
[!WS "0"!]#include <LinTrcv[!"$mangledName"!].h>
[!IF "(text:split(.,',')[3] = 'true') and (text:split(.,',')[4] = 'true')"!][!//
...
*/!][!IF "($SymbolName = '')"!][!/*
*/!][!VAR "SymbolName" = "concat(as:name(../../..),'_',as:name(..))"!][!/*
*/!][!ELSE!][!/*
...
[!LOOP "as:modconf('LinIf')[1]/LinIfGlobalConfig/*[1]/LinIfChannel/*[LinIfNodeType = 'LinIfSlave']"!]
  ...
  [!IF "count(as:ref(LinIfNodeType/LinIfResponseErrorSignal)/../../ComIPdu/*/ComIPduSignalRef/*[. = node:current()/LinIfNodeType/LinIfResponseErrorSignal]) != 1"!]
    [!VAR "errSigCfgErr" = "concat($errSigCfgErr, 'The signal referenced by LinIfResponseErrorSignal shall be associated to a single ComIPdu. Not the case for ', as:name(.))"!]
  [!ELSE!]
    [!IF "'[]' != string(asc:getPdus('PduR','ForUpperLayer','If','Tx',1, as:ref(LinIfNodeType/LinIfResponseErrorSignal)/../../ComIPdu/*/ComIPduSignalRef/*[. = node:current()/LinIfNodeType/LinIfResponseErrorSignal]/../../ComPduIdRef))"!]
      [!VAR "rpCom" = "as:name(node:ref(node:path(asc:getPdus('PduR','ForUpperLayer','If','Tx',1, as:ref(LinIfNodeType/LinIfResponseErrorSignal)/../../ComIPdu/*/ComIPduSignalRef/*[. = node:current()/LinIfNodeType/LinIfResponseErrorSignal]/../../ComPduIdRef)[1]))/../..)"!]
    [!ENDIF!]
  [!ENDIF!]
  ...
  [!IF "'' != $rpCom"!]
    [!FOR "iFrm" = "1" TO "$chNumTxUnCond"!]
      [!SELECT "LinIfFrame/*[LinIfFrameType = 'UNCONDITIONAL' and LinIfPduDirection = 'LinIfTxPdu' and node:refvalid(LinIfPduDirection/LinIfTxPduRef)][number($iFrm)]"!]
        [!IF "$rpCom = as:name(node:ref(node:path(asc:getPdus('PduR','ForLowerLayer','If','Tx',1, ./LinIfPduDirection/LinIfTxPduRef)[1]))/../../..)"!]
          [!VAR "ChanErrSigIdx" = "concat(as:name(../..), ':', LinIfFrameIndex, ';', $ChanErrSigIdx)"!]
          [!VAR "numErrSigTxFrame" = "num:i($numErrSigTxFrame + 1)"!]
          [!VAR "errSigTxFrames" = "concat(as:name(.), ', ', $errSigTxFrames)"!]
        [!ENDIF!]
      [!ENDSELECT!]
    [!ENDFOR!]
  [!ENDIF!]
