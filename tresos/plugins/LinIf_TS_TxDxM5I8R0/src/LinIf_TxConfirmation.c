...
/* !LINKSTO LinIf.SWS_LinIf_00865.Enabled,1 */
...
)
{
  ...
  {
    /* !LINKSTO LinIf.SWS_LinIf_00853,1 */
    (void)Det_ReportError(LINIF_MODULE_ID, LINIF_INSTANCE_ID,
...
#endif /* (LINIF_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    if(pIfChannel->cFSM == LINIF_CHANNEL_OPERATIONAL)
    {
      ...
      /* !LINKSTO LinIf.SWS_LinIf_00754.TxConfirmation,1 */
      ...
      switch(pIfChannel->LastHeaderType)
      {
        ...
        {
          /* !LINKSTO LinIf.SWS_LinIf_00852,1 */
          break;
        }
        case LINIF_FRM_TX:
        {
          /* !LINKSTO LinIf.SWS_LinIf_00741_1,1 */
...
#if (LINIF_BUS_MIRRORING_SUPPORT_ENABLE == STD_ON)
          {
            ...
            if (LINIF_CHANNEL_ENABLED == LINIF_MIRROR_CHANNEL_ENABLED(enabledChannels, Channel))
            {
              ...
              /* !LINKSTO LinIf.SWS_LinIf_00839,1 */
...

          {
            ...
            /* !LINKSTO LinIf.SWS_LinIf_00747,1,
                        LinIf.SWS_LinIf_00763,1
             */
        ...
        case LINIF_FRM_SRF:
        {
          /* !LINKSTO LinIf.SWS_LinIf_00785_2,1 */
...
#if (LINIF_DIAG_MSGS_REPORTING_ENABLE == STD_ON)
          {
            ...
            if (LINIF_CHANNEL_ENABLED == LINIF_MIRROR_CHANNEL_ENABLED(enabledChannels, Channel))
            {
              ...
              pdu.SduDataPtr = pIfChannel->FrameInfo.FrameData;
              pdu.SduLength = 8U;
              /* !LINKSTO LinIf.EB.LinIfMirrorDiagMsgs.SRF-SLAVE_LIN_TX_OK,1,
                          LinIf.EB.LinIfMirrorDiagMsgs.SRF-SLAVE_LIN_TX_OK.Cdd,1 */
              LINIF_UL_REPORTING(LINIF_GET_COMM_CHANNEL(Channel), pIfChannel->FrameInfo.Pid, &pdu, LIN_TX_OK);
            }
          }
...
#endif /* TS_MERGED_COMPILE */
/* !LINKSTO LinIf.SWS_LinIf_00865.Disabled,1 */
