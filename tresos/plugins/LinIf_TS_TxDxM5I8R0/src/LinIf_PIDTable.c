...
/* !LINKSTO LinIf.SWS_LinIf_00859.Enabled,1,
            LinIf.SWS_LinIf_00860.Enabled,1
 */
...
/* !LINKSTO LinIf.SWS_LinIf_91002,1 */
...
)
{
  ...
  {
      /* !LINKSTO LinIf.SWS_LinIf_00818,1 */
      (void)Det_ReportError(LINIF_MODULE_ID, LINIF_INSTANCE_ID,
  ...
  {
      /* !LINKSTO LinIf.SWS_LinIf_00819,1,
                  LinIf.SWS_LinIf_00820,1
       */
      (void)Det_ReportError(LINIF_MODULE_ID, LINIF_INSTANCE_ID,
...
#endif /* (LINIF_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    {
      /* !LINKSTO LinIf.SWS_LinIf_00828,1 */
    ...
    else if(pIfChConfSlave->FrameNumAssoc <= *PidBufferLength)
    {
      ...
      if(0U == (flags & LINIF_FLG_CONF_PID_ALTER))
      {
        ...
        /* !LINKSTO LinIf.SWS_LinIf_00816.PidBufferLength,1 */
        *PidBufferLength = pIfChConfSlave->FrameNumAssoc;
        for(i = 0; i < pIfChConfSlave->FrameNumAssoc; i++)
        {
          /* !LINKSTO LinIf.SWS_LinIf_00816.PidBuffer,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_91003,1 */
...
)
{
...
#endif /* (LINIF_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    if(PidBufferLength == pIfChConfSlave->FrameNumAssoc)
    {
      ...
      if(0U == (flags & LINIF_FLG_CONF_PID_ALTER))
      {
        ...
        for(i = 0; i < pIfChConfSlave->FrameNumAssoc; i++)
        {
          ...
          {
            /* !LINKSTO LinIf.SWS_LinIf_00823,1 */
    ...
    {
#if (LINIF_DEV_ERROR_DETECT == STD_ON)
      /* !LINKSTO LinIf.SWS_LinIf_00827,1 */
      (void)Det_ReportError(LINIF_MODULE_ID, LINIF_INSTANCE_ID,
...
#endif /* TS_MERGED_COMPILE */
/* !LINKSTO LinIf.SWS_LinIf_00859.Disabled,1,
            LinIf.SWS_LinIf_00860.Disabled,1
 */
