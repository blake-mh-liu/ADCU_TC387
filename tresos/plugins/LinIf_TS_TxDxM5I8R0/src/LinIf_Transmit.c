...
)
{
...

    {
...
#endif /* LINIF_DEV_ERROR_DETECT == STD_ON */
      {
        ...
        {
          /* !LINKSTO LinIf.SWS_LinIf_00106.Master,1,
                      LinIf.SWS_LinIf_00106.Slave,1,
                      LinIf.SWS_LinIf_00341.Master,1,
                      LinIf.SWS_LinIf_00341.Slave,1
           */
          /* now set event flag */
          LINIF_SET_BIT_ATOMIC(LinIf_FrameEventFlags,
              (PduIdType)(LinTxPduId));

          /* !LINKSTO LinIf.SWS_LinIf_00700.Master,1,
                      LinIf.SWS_LinIf_00700.Slave,1
           */
          retValue = E_OK;
        }
      }
