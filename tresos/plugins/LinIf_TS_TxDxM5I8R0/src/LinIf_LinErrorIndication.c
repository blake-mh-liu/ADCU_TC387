...
/* !LINKSTO LinIf.SWS_LinIf_00866.Enabled,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_91007,1 */
...
)
{
  ...
  {
      /* !LINKSTO LinIf.SWS_LinIf_00855,1 */
      (void)Det_ReportError(LINIF_MODULE_ID, LINIF_INSTANCE_ID,
...
#endif /* (LINIF_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    if(pIfChannel->cFSM == LINIF_CHANNEL_OPERATIONAL)
    {
      ...
      /* !LINKSTO LinIf.SWS_LinIf_00754.LinErrorIndication,1 */
      ...
      if(FALSE == skipProcessing)
      {
        ...
        /* !LINKSTO LinIf.SWS_LinIf_00764,1 */
        if(0U != errSig)
        {
          TS_AtomicAssign8(pIfChannelSlave->Flags, LINIF_FLG_RESP_ERR_SET);
          (void)Com_SendSignal(pIfChConfSlave->ErrRespSigId, &errSig);
          /* !LINKSTO LinIf.SWS_LinIf_00766,1 */
#if (LINIF_ERR_RES_CHG_CO_SUPPORTED == STD_ON)
          /* !LINKSTO LinIf.SWS_LinIf_00765,1 */
          LINIF_ERR_RES_CHG_CO_FUNC(Channel, TRUE);
#endif /* LINIF_ERR_RES_CHG_CO_SUPPORTED == STD_ON */
        }

        /* !LINKSTO LinIf.SWS_LinIf_00735.LIN_ERR_HEADER,1,
                    LinIf.SWS_LinIf_00869.LIN_ERR_HEADER,1,
                    LinIf.SWS_LinIf_00743.LIN_ERR_HEADER,1
         */
        if(LIN_TX_HEADER_ERROR != status)
        {
          /* !LINKSTO LinIf.SWS_LinIf_00869.ERR_RESP_STOPBIT.RX,1,
                      LinIf.SWS_LinIf_00869.ERR_RESP_STOPBIT.TX,1,
                      LinIf.SWS_LinIf_00869.ERR_RESP_CHKSUM,1,
                      LinIf.SWS_LinIf_00869.ERR_INCOMP_RESP,1,
                      LinIf.SWS_LinIf_00869.ERR_NO_RESP,1,
                      LinIf.SWS_LinIf_00869.ERR_RESP_DATABIT,1
           */
#if(LINIF_BUS_MIRRORING_SUPPORT_ENABLE == STD_ON)
          uint16 chEnabled;
          ...
          /* !LINKSTO LinIf.SWS_LinIf_00735.ERR_RESP_STOPBIT,1,
                      LinIf.SWS_LinIf_00743.ERR_RESP_STOPBIT,1,
                      LinIf.SWS_LinIf_00735.ERR_RESP_CHKSUM,1,
                      LinIf.SWS_LinIf_00743.ERR_RESP_CHKSUM,1,
                      LinIf.SWS_LinIf_00735.ERR_INCOMP_RESP,1,
                      LinIf.SWS_LinIf_00743.ERR_INCOMP_RESP,1,
                      LinIf.SWS_LinIf_00735.ERR_NO_RESP,1,
                      LinIf.SWS_LinIf_00743.ERR_NO_RESP,1,
                      LinIf.SWS_LinIf_00735.ERR_RESP_DATABIT,1,
                      LinIf.SWS_LinIf_00743.ERR_RESP_DATABIT,1
           */
      ...
      switch(pIfChannel->LastHeaderType)
      {
        case LINIF_FRM_SRF:
        {
          ...
          {
            /* !LINKSTO LinIf.SWS_LinIf_00796_1,1,
                        LinIf.SWS_LinIf_00796_2,1,
                        LinIf.SWS_LinIf_00837_2_1,1,
                        LinIf.SWS_LinIf_00837_2_2,1
             */
            PduInfoType PduInfo;
            PduInfo.SduDataPtr = NULL_PTR; /* unused */
            PduInfo.SduLength = (PduLengthType)status;

            LinTp_Err_Tx(Channel, &PduInfo);
          }
          break;
        }
        case LINIF_FRM_MRF:
        {
          /* !LINKSTO LinIf.SWS_LinIf_00837_1_1,1,
                      LinIf.SWS_LinIf_00837_1_2,1
           */
          /* !LINKSTO LinIf.SWS_LinIf_00837_1_3,1 */
          LinTp_Err_Rx(Channel, status);
          break;
        }
        default:
        {
...
#endif
      if (LINIF_FRM_SRF == pIfChannel->LastHeaderType)
      {
...
)
{
  ...
  switch(ErrorStatus)
  {
    ...
    {
      /* !LINKSTO LinIf.SWS_LinIf_00736.ERR_RESP_STOPBIT,1,
                  LinIf.SWS_LinIf_00744.ERR_RESP_STOPBIT,1
       */
      *ErrSig = 1U;
    ...
    {
      /* !LINKSTO LinIf.SWS_LinIf_00736.ERR_RESP_CHKSUM,1,
                  LinIf.SWS_LinIf_00744.ERR_RESP_CHKSUM,1
       */
      *ErrSig = 1U;
    ...
    {
      /* !LINKSTO LinIf.SWS_LinIf_00736.ERR_RESP_DATABIT,1,
                  LinIf.SWS_LinIf_00744.ERR_RESP_DATABIT,1
       */
      *ErrSig = 1U;
    ...
    case LIN_ERR_INC_RESP:
    {
      ...
      {
        /* !LINKSTO LinIf.SWS_LinIf_00736.ERR_INCOMP_RESP,1 */
        *ErrSig = 1U;
      }
      else
      {
...
#endif /* TS_MERGED_COMPILE */
/* !LINKSTO LinIf.SWS_LinIf_00866.Disabled,1 */
