 ...
 *
 * Reason:
 *  The other declartions is in LinIf_Lcfg.c for  purpose of signature verification.
 *  and The symbols aren't exposed through a header.
 *
 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_NONEXISTENT_CHANNEL,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_PARAMETER,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_PARAMETER_POINTER,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_SCHEDULE_REQUEST_ERROR,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_TRCV_INV_CHANNEL,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_ELINIF_E_TRCV_INV_MODE,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_TRCV_NOT_NORMAL,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_E_PARAM_WAKEUPSOURCE,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00729.LINIF_E_RESPONSE,1 */
...
/* !LINKSTO LinIf.SWS_LinIf_00376_1.LINIF_DRIVER_CHANNEL_NOT_IN_SLEEP,1 */
...
/** \brief Flag to indicate an ongoing wakeup pulse on Lin bus */
#if (defined LINIF_WAKEUP_PULSE_ONGOING_FLAG)
#error LINIF_WAKEUP_PULSE_ONGOING_FLAG already defined!
#endif /* #if (defined LINIF_WAKEUP_PULSE_ONGOING_FLAG)*/
#define LINIF_WAKEUP_PULSE_ONGOING_FLAG      0x40U
...
#define LinIf_StartTimerBI(pIfChConfig, pIfData)                  \
        TS_AtomicAssign32((pIfData)->TimerBusIdle, (pIfChConfig)->BusIdleTimeout) \
...
#define LinIf_StopTimerBI(pIfData)     \
        TS_AtomicAssign32((pIfData)->TimerBusIdle, 0U) \
...
/** \brief mask for extracting the PID without the parity bits*/
#if (defined LINIF_PID_PARITY_MASK)
#error LINIF_PID_PARITY_MASK already defined!
#endif /* #if( defined LINIF_PID_PARITY_MASK)*/
#define LINIF_PID_PARITY_MASK 0x3FU
...
/* !LINKSTO LinIf.SWS_LinIf_00722, 1*/
#if (LINIF_UL_CDD_SUPPORTED == STD_ON)
...
typedef struct
{
    uint32 TimerBusIdle;              /**< bus idle timeout */
...
/* !LINKSTO LinIf.ASR40.SWS_LinIf_00590,1 */
#include <LinIf_MemMap.h>
