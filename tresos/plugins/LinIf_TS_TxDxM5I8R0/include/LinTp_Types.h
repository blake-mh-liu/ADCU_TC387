...
#if (defined LINTP_INVALID_SCHEDULE_MODE)
#error LINTP_INVALID_SCHEDULE_MODE already defined!
#endif /* #if (defined LINTP_INVALID_SCHEDULE_MODE)*/
#define LINTP_INVALID_SCHEDULE_MODE 0xFFU
