...
#if (defined LINTP_STATUS_ERR_USRCALLOUT)
#error LINTP_STATUS_ERR_USRCALLOUT already defined!
#endif /* #if (defined LINTP_STATUS_ERR_USRCALLOUT)*/
#define LINTP_STATUS_ERR_USRCALLOUT          &LinTp_Status_Err

#if (defined LINTP_STATUS_ERR_NO_USRCALLOUT)
#error LINTP_STATUS_ERR_NO_USRCALLOUT already defined!
#endif /* #if (defined LINTP_STATUS_ERR_NO_USRCALLOUT)*/
#define LINTP_STATUS_ERR_NO_USRCALLOUT          &LinTp_Status_Err_No_Callout

#if (defined LINTP_STATUS_ERR_USRCALLOUT_NO_DET)
#error LINTP_STATUS_ERR_USRCALLOUT_NO_DET already defined!
#endif /* #if (defined LINTP_STATUS_ERR_USRCALLOUT_NO_DET)*/
#define LINTP_STATUS_ERR_USRCALLOUT_NO_DET   &LinTp_Err_Tx
...
#error LINTP_STATUS_ERR_USRCALLOUT already defined!
#endif /* #if (defined LINTP_STATUS_ERR_USRCALLOUT)*/
#define LINTP_STATUS_ERR_USRCALLOUT          NULL_PTR

#if (defined LINTP_STATUS_ERR_NO_USRCALLOUT)
#error LINTP_STATUS_ERR_NO_USRCALLOUT already defined!
#endif /* #if (defined LINTP_STATUS_ERR_NO_USRCALLOUT)*/
#define LINTP_STATUS_ERR_NO_USRCALLOUT          NULL_PTR

#if (defined LINTP_STATUS_ERR_USRCALLOUT_NO_DET)
#error LINTP_STATUS_ERR_USRCALLOUT_NO_DET already defined!
#endif /* #if (defined LINTP_STATUS_ERR_USRCALLOUT_NO_DET)*/
#define LINTP_STATUS_ERR_USRCALLOUT_NO_DET    NULL_PTR
...
typedef struct
{
    ...
    /* !LINKSTO LinIf.SWS_LinIf_00315,1 */
...
typedef struct
{
    ...
    uint8 ExpectedScheduleTableMode;               /**< Current requested schedule table mode.
                                                        LINTP_DIAG_REQUEST or LINTP_DIAG_RESPONSE */
#endif
#endif
...
/** \brief Check that the requested schedule table mode is
 * the same mode as current schedule table.
 *
 * \param  currentChannel Channel which is processed
*/
extern FUNC(void, LINIF_CODE) LinTp_CheckRequestedDiagSchTable
(
  uint8 currentChannel
);
 ...
 *         Calls a user configured callout
 *
 *  \param currentChannel  Channel which is processed
 *  \param pPduInfo        data which was received from the bus
 */
 ...
 *  \param pPduInfo        data which was received from the bus
 */
extern FUNC(void, LINIF_CODE) LinTp_Status_Err_No_Callout
(
    uint8 currentChannel,
    P2VAR(PduInfoType,AUTOMATIC,LINIF_APPL_DATA) pPduInfo
);
