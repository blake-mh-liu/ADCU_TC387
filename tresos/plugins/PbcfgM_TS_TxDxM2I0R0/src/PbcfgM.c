...
/* major version check */
#if (PBCFGM_SW_MAJOR_VERSION != 2U)
#error PBCFGM_SW_MAJOR_VERSION wrong (!= 2U)
#endif
...
/* minor version check */
#if (PBCFGM_SW_MINOR_VERSION < 0U)
#error PBCFGM_SW_MINOR_VERSION wrong (< 0U)
#endif
...
/* patch version check */
#if (PBCFGM_SW_PATCH_VERSION < 0U)
#error PBCFGM_SW_PATCH_VERSION wrong (< 0U)
#endif
