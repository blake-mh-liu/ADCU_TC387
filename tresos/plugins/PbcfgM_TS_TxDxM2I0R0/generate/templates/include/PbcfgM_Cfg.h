...
#define PBCFGM_PUBLIC_INFO_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('PbcfgM')[1]/CommonPublishedInformation, 'PublishedInformation', as:modconf('PbcfgM')[1]/CommonPublishedInformation/Release)"!]U
...
#define PBCFGM_CFG_SIGNATURE [!"asc:calculateConfigSignature(as:modconf('PbcfgM')[1], 'PreCompile')"!]U /* Compile time verification value */
