...
[!INDENT "0"!][!//
  ...
  [!LOOP "util:distinct(node:order(as:modconf('Dem')[1]/DemConfigSet/eb-list::*/DemEventParameter/eb-list::*, 'DemEventId'))"!][!//
    ...
    [!IF "node:exists(as:modconf('FiM')[1]/FiMConfigSet/eb-list::*/FiMInhibitionConfiguration/eb-list::*[FiMInhEventId/FiMInhRefChoice = 'FiMInhChoiceDemRef' and string(text:split(FiMInhEventId/FiMInhRefChoice/eb-choice::*[1]/FiMInhEventRef, '/')[last()]) = $eventName])"!][!//
    ...
    [!LOOP "as:modconf('FiM')[1]/FiMConfigSet/eb-list::*/FiMEventSummary/eb-list::*[string(text:split(FiMInputSumEventRef/eb-list::*[1], '/')[last()]) = $eventName]"!][!//
...
[!INDENT "0"!][!//
  ...
  [!LOOP "as:modconf('FiM')[1]/FiMConfigSet/eb-list::*/FiMInhibitionConfiguration/eb-list::*"!][!//
    ...
    [!IF "FiMInhEventId/FiMInhRefChoice = 'FiMInhChoiceDemRef'"!][!//
      [!VAR "eventName" = "text:split(FiMInhEventId/FiMInhRefChoice/eb-choice::*[1]/FiMInhEventRef, '/')[last()]"!][!//
