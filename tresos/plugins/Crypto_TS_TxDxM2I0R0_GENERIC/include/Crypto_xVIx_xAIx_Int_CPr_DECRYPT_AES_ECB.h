...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_DECRYPT_AES_ECB.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_H
#define CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_CPr_DECRYPT_AES_ECB_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_DECRYPT_AES_ECB.h/0002,1 */

/*==================[macros]======================================================================*/

/* !LINKSTO Crypto.Req.CPr/DECRYPT_AES_ECB/GENERAL/0002,1 */
/* !LINKSTO Crypto.Req.CPr/DECRYPT_AES_ECB/GENERAL/0003,1 */
/* !LINKSTO Crypto.Req.CPr/DECRYPT_AES_ECB/GENERAL/0004,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_BLOCKSIZE)
#error CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_BLOCKSIZE already defined
#endif
/** \brief  Defines the length in bytes of the AES state. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_BLOCKSIZE 16U

/* !LINKSTO Crypto.Dsn.Api/Macros/CRYPTO_XVIX_XAIX_INT_CPR_SERVICE_AES_ECB_KEY_EXPD_LEN_MAX,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_KEY_EXPD_LEN_MAX)
#error CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_KEY_EXPD_LEN_MAX already defined
#endif
/** \brief  Defines the maximum expanded key length in 4-bytes words. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_KEY_EXPD_LEN_MAX 60U

/*==================[type definitions]============================================================*/

/** \brief  Workspace of primitive DECRYPT_AES_ECB.
 **
 ** ---common---------------------------------------------------------------------
 **
 ** \var    paObjectId
 ...
 **
 ** \var    lockMain
 ** \brief  Flag to lock multiple parallel executions of Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Main().
 **
 ** ---specific-------------------------------------------------------------------
 **
 ** \var  trnNum
...
/* !LINKSTO Crypto.Dsn.Api/Types/Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_WorkspaceType/0001,1 */
...
typedef struct
{
  ...
  uint32 keyExpdLen;
  uint32 keyExpd[CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_KEY_EXPD_LEN_MAX];
  /* !LINKSTO Crypto.Req.CPr/DECRYPT_AES_ECB/GENERAL/0006,2 */
  uint8 aesState[CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_BLOCKSIZE]; /* AES state */
...
Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_WorkspaceType;
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_DECRYPT_AES_ECB == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Process
(
          uint32                                                                    objectId,
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_DECRYPT_AES_ECB == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_DECRYPT_AES_ECB == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_DECRYPT_AES_ECB == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_DECRYPT_AES_ECB == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_DECRYPT_AES_ECB == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_DECRYPT_AES_ECB_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_CPR_DECRYPT_AES_ECB_H */
