...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADENCRYPT_AES_GCM.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_H
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_CPr_AEADENCRYPT_AES_GCM_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADENCRYPT_AES_GCM.h/0002,1 */

/*==================[macros]======================================================================*/

/* !LINKSTO Crypto.Req.CPr/AEADENCRYPT_AES_GCM/GENERAL/0001,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_MAX_KEY_LEN_BYTES)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_MAX_KEY_LEN_BYTES already defined
#endif
/** \brief The maximum key length for GCM. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_MAX_KEY_LEN_BYTES 32U

/* !LINKSTO Crypto.Req.CPr/AEADENCRYPT_AES_GCM/GENERAL/0001,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES already defined
#endif
/** \brief The length of one encryption block for GCM. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES 16U

/* !LINKSTO Crypto.Req.CPr/AEADENCRYPT_AES_GCM/GENERAL/0004,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_IV_LEN_BYTES)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_IV_LEN_BYTES already defined
#endif
/** \brief The length of the initialization vector for GCM. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_IV_LEN_BYTES 12U

/*==================[type definitions]============================================================*/

/** \brief  Workspace of primitive AEADENCRYPT_AES_GCM.
 **
 ** ---common---------------------------------------------------------------------
 **
 ** \var    paObjectId
 ...
 **
 ** \var    lockMain
 ** \brief  Flag to lock multiple parallel executions of Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Main().
 **
 ** ---specific-------------------------------------------------------------------
 **
 ** \brief  Context for the AEADENCRYPT_AES_GCM
 **
...
/* !LINKSTO Crypto.Dsn.Api/Types/Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_WorkspaceType/0001,1 */
...
typedef struct
{
  ...
  uint8 H[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES];
  uint8 first[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES];
  uint8 counter[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES];
  uint8 ctrKey[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES];
  uint8 tag[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES];
  uint8 block[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_BLOCK_LEN_BYTES];
...
Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_WorkspaceType;
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_GCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Process
(
          uint32                                                                    objectId,
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_GCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_GCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_GCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_GCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_GCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_GCM_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_GCM_H */
