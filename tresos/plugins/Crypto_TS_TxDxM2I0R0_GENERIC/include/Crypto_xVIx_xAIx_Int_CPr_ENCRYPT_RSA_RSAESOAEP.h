...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_RSA_RSAESOAEP.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_H
#define CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_RSA_RSAESOAEP_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_RSA_RSAESOAEP.h/0002,1 */
#include <Crypto_xVIx_xAIx_Int_Lib_LN.h>

/*==================[macros]======================================================================*/

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_MGF_CNTLEN)
  #error CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_MGF_CNTLEN is already defined
#endif
/** \brief Defines the length of the MGF count value */
#define CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_MGF_CNTLEN 4U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE)
  #error CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE is already defined
#elif (8U > CRYPTO_XVIX_XAIX_ENCRYPT_RSA_RSAESOAEP_MAX_RSA_KEY_SIZE)
  #error CRYPTO_XVIX_XAIX_ENCRYPT_RSA_RSAESOAEP_MAX_RSA_KEY_SIZE is too small
#endif
 ...
 */
#define CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE \
(CRYPTO_XVIX_XAIX_ENCRYPT_RSA_RSAESOAEP_MAX_RSA_KEY_SIZE) - 7U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_WORD)
  #error CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_WORD is already defined
#endif
/** \brief The maximum length in words of the RSA key. */
#define CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_WORD \
((CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE) / (CRYPTO_XVIX_XAIX_LN_WORD_LEN_BYTES)) + 1U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSAESOAEP_MAX_DB_LEN)
#error CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSAESOAEP_MAX_DB_LEN is already defined
#endif
/** \brief The maximum length to allocate of DB buffer. Not the actual size of DB. */
#define CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSAESOAEP_MAX_DB_LEN CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE
...
typedef struct
{
  ...
  P2VAR(uint8, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) MaskOutputPtr;
        uint8                                         MaskCntStr[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_MGF_CNTLEN];
}
Crypto_xVIx_xAIx_ENCRYPT_RSA_RSAESOAEP_Mgf1CtxType;

/** \brief  Workspace of primitive ENCRYPT_RSA_RSAESOAEP.
 **
 ** ---common---------------------------------------------------------------------
 **
 ** \var    paObjectId
 ...
 **
 ** \var    lockMain
 ** \brief  Flag to lock multiple parallel executions of Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Main().
 **
 ** ---specific-------------------------------------------------------------------
 **
 ** \var    AdditionalInput
 ...
 **
ifelse(ENCRYPT_RSA_RSAESOAEP, ENCRYPT_RSA_RSAESOAEP,dnl
 ** \var    Db
 ...
 **
 ** \var    secondaryRandomJob_primitiveInfo
 ** \brief  The primitiveInfo structure of the secondary random job.
 **
 ** \var    secondaryRandomJob_jobPrimitiveInfo
 ** \brief  The jobPrimitiveInfo structure of the secondary random job.
 **
 ** \var    secondaryRandomJob_jobInfo
 ** \brief  The jobInfo structure of the secondary random job.
 **
 ** \var    secondaryRandomJob
 ** \brief  The job structure of the secondary random job.
 **/

/* !LINKSTO Crypto.Dsn.Api/Types/Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_WorkspaceType/0001,1 */
...
typedef struct
{
  ...
  /* ---specific------------------------------------------------------------------- */
          uint8  AdditionalInput[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE];
          ...
          uint32 EMLength;
          uint8  HashResult[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_HASHRESULTSIZE];
          uint8  MgfSeed[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_HASHRESULTSIZE];
          uint8  MgfSeedMask[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_HASHRESULTSIZE];
          uint8  Db[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE];
          uint8  DbMask[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSAESOAEP_MAX_DB_LEN];
          uint8  Ps[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_BYTE];
          uint8  EM[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSAESOAEP_MAX_DB_LEN + CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_HASHRESULTSIZE + 1U];

          Crypto_xVIx_xAIx_ENCRYPT_RSA_RSAESOAEP_Mgf1CtxType                                     Mgf1Ctx;
          Crypto_xVIx_xAIx_LNCtxType                                          lnCtx;

          Crypto_xVIx_xAIx_LNWordType                                         Tmp1Value[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_WORD];
          Crypto_xVIx_xAIx_LNWordType                                         Tmp2Value[CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_RSA_PUBLIC_MAX_KEY_SIZE_WORD];
/*
...
Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_WorkspaceType;
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_RSA_RSAESOAEP == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Process
(
          uint32                                                                    objectId,
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_RSA_RSAESOAEP == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_RSA_RSAESOAEP == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_RSA_RSAESOAEP == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_RSA_RSAESOAEP == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_RSA_RSAESOAEP == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_RSA_RSAESOAEP_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_RSA_RSAESOAEP_H */
