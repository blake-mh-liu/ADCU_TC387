...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADENCRYPT_AES_CCM.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_H
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_CPr_AEADENCRYPT_AES_CCM_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADENCRYPT_AES_CCM.h/0002,1 */

/*==================[macros]======================================================================*/

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_BLOCK_LEN_BYTES)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_BLOCK_LEN_BYTES already defined
#endif
/** \brief The length of one encryption/decryption block for CCM. **/
/* !LINKSTO Crypto.Req.CPr/AEADENCRYPT_AES_CCM/GENERAL/0002,1 */
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_BLOCK_LEN_BYTES 16U

/*==================[type definitions]============================================================*/

/** \brief  Workspace of primitive AEADENCRYPT_AES_CCM.
 **
 ** ---common---------------------------------------------------------------------
 **
 ** \var    paObjectId
 ...
 **
 ** \var    lockMain
 ** \brief  Flag to lock multiple parallel executions of Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Main().
 **
 ** ---specific-------------------------------------------------------------------
 **
 ** \brief  Context for the AEADENCRYPT_AES_CCM
 **
 **  \var  nounceSize
...
/* !LINKSTO Crypto.Dsn.Api/Types/Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_WorkspaceType/0001,1 */
...
typedef struct
{
  ...
  uint8 Block[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_BLOCK_LEN_BYTES];
  uint8 T[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_BLOCK_LEN_BYTES];
  uint8 Ctr[CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_BLOCK_LEN_BYTES];
...
Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_WorkspaceType;
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_CCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Process
(
          uint32                                                                    objectId,
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_CCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_CCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_CCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_CCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADENCRYPT_AES_CCM == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADENCRYPT_AES_CCM_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_CPR_AEADENCRYPT_AES_CCM_H */
