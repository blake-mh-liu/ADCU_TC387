...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_SHA2224_HMAC.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_H
#define CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_SHA2224_HMAC_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_SHA2224_HMAC.h/0002,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_HASH_SHA2224_NOTSET.h>

/*==================[macros]======================================================================*/

/* !LINKSTO Crypto.Req.CPr/MACGENERATE_SHA2224_HMAC/GENERAL/0002,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_BLOCKSIZE)
#error CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_BLOCKSIZE already defined
#endif
/** \brief  Macro indicating the length of a block in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_BLOCKSIZE CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2224_NOTSET_BLOCKSIZE_BYTE

/* !LINKSTO Crypto.Req.CPr/MACGENERATE_SHA2224_HMAC/GENERAL/0003,1 */
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_RESULTSIZE)
#error CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_RESULTSIZE already defined
#endif
/** \brief  Macro indicating the length of a result in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_RESULTSIZE CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2224_NOTSET_RESULTSIZE

/*==================[type definitions]============================================================*/

/** \brief  Workspace of primitive MACGENERATE_SHA2224_HMAC.
 **
 ** ---common---------------------------------------------------------------------
 **
 ** \var    paObjectId
 ...
 **
 ** \var    lockMain
 ** \brief  Flag to lock multiple parallel executions of Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Main().
 **
 ** ---specific-------------------------------------------------------------------
 **
 ** \var    inputActPtr
 ...
 **         the size must be >= CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_BLOCKSIZE.
 **
 ** \var    secondaryJob_primitiveInfo
 ** \brief  The Crypto_xVIx_xAIx_NonConstPrimitiveInfoType instance of the MACGENERATE_SHA2224_HMAC job used by MACGENERATE_SHA2224_HMAC.
 **
 ** \var    secondaryJob_jobPrimitiveInfo
 ** \brief  The Crypto_JobPrimitiveInfoType instance of the MACGENERATE_SHA2224_HMAC job used by MACGENERATE_SHA2224_HMAC.
 **
 ** \var    secondaryJob_jobInfo
 ** \brief  The Crypto_JobInfoType instance of the MACGENERATE_SHA2224_HMAC job used by MACGENERATE_SHA2224_HMAC.
 **
 ** \var    secondaryJob
 ** \brief  The Crypto_JobType instance of the MACGENERATE_SHA2224_HMAC job used by MACGENERATE_SHA2224_HMAC.
 **/

/* !LINKSTO Crypto.Dsn.Api/Types/Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_WorkspaceType/0001,1 */
...
typedef struct
{
  ...
  uint8                        K0[CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_BLOCKSIZE ];
  uint8                        H1[CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_RESULTSIZE];
  uint8                        H2[CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_RESULTSIZE];

  uint8                        BF[CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_BLOCKSIZE ];
...
Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_WorkspaceType;
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_SHA2224_HMAC == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Process
(
          uint32                                                                    objectId,
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_SHA2224_HMAC == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_SHA2224_HMAC == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_SHA2224_HMAC == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_SHA2224_HMAC == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_SHA2224_HMAC == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_SHA2224_HMAC_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_SHA2224_HMAC_H */
