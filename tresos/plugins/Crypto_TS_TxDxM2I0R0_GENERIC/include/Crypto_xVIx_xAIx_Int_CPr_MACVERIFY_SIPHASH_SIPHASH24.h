...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SIPHASH_SIPHASH24_H
#define CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SIPHASH_SIPHASH24_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.h/0002,1 */

/*==================[macros]======================================================================*/

/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0005,1 */
#if (defined CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_KEY_LEN_BYTES)
#error CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_KEY_LEN_BYTES already defined
#endif
/** \brief  The length of the key for the SipHash. **/
#define CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_KEY_LEN_BYTES 16U

/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0004,2 */
#if (defined CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES)
#error CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES already defined
#endif
/** \brief  The length of one encryption block for the SipHash. **/
#define CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES 8U

/*==================[type definitions]============================================================*/

/** \brief  Workspace of primitive MACVERIFY_SIPHASH_SIPHASH24.
 **
 ** ---common---------------------------------------------------------------------
 **
 ** \var    paObjectId
 ...
 **
 ** \var    lockMain
 ** \brief  Flag to lock multiple parallel executions of Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Main().
 **
 ** ---specific-------------------------------------------------------------------
 **
 ** \var  MessageBlock
...
/* !LINKSTO Crypto.Dsn.Api/Types/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType/0001,1 */
...
typedef struct
{
  ...
  uint8 KeyData[CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_KEY_LEN_BYTES];
}
Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType;
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process
(
          uint32                                                                    objectId,
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SIPHASH_SIPHASH24_H */
