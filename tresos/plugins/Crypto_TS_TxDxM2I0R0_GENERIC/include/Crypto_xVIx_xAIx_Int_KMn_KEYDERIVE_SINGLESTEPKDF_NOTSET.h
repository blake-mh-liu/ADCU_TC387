...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_KMn_KEYDERIVE_SINGLESTEPKDF_NOTSET.h/0001,1 */

#ifndef CRYPTO_XVIX_XAIX_INT_KMN_KEYDERIVE_SINGLESTEPKDF_NOTSET_H
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYDERIVE_SINGLESTEPKDF_NOTSET_H

/*==================[deviations]==================================================================*/

/*==================[includes]====================================================================*/

#include <Crypto_xVIx_xAIx_Int_KMn_KEYDERIVE_SINGLESTEPKDF_NOTSET_Cfg.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_KMn_KEYDERIVE_SINGLESTEPKDF_NOTSET.h/0002,1 */
...
extern CONST(Crypto_xVIx_xAIx_PrimitiveDescriptionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KEYDERIVE_SINGLESTEPKDF_NOTSET_Primitive;

/** \brief  The CDOPrimitiveCnfgType for the dummy primitive. **/
extern CONST(Crypto_xVIx_xAIx_CDOPrimitiveCnfgType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KEYDERIVE_SINGLESTEPKDF_NOTSET_PrimitiveCnfg;

/** \brief  The dummy primitive used if a KeyManagement job shall be executed as secondary job. **/
extern CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KEYDERIVE_SINGLESTEPKDF_NOTSET_DummyPrimitive;
...
/** \brief  Performs the processing of the KMn primitive KEYDERIVE_SINGLESTEPKDF_NOTSET.
 **
KEYDERIVE_, KEYDERIVE_, m4_dnl
 ...
 **                                           (primary part of the) KMn primitive KEYDERIVE_SINGLESTEPKDF_NOTSET.
 ...
 ** \param[in]      targetCryptoKeyId        Identifier of the target crypto key that shall be used.
 **
 ** \returns  Error value.
 **
...
extern FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_Int_KMn_KEYDERIVE_SINGLESTEPKDF_NOTSET_Process
(
          uint32                                                 objectId,
...
#endif /* #ifndef CRYPTO_XVIX_XAIX_INT_KMN_KEYDERIVE_SINGLESTEPKDF_NOTSET_H */
