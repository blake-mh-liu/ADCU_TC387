...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA1_NOTSET.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                           /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA1_NOTSET.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>             /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA1_NOTSET.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_HASH_SHA1_NOTSET.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA1_NOTSET.c/0004,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0027,1 */
#if (defined CRYPTO_XVIX_XAIX_SHA1_T1)
#error CRYPTO_XVIX_XAIX_SHA1_T1 already defined
#endif
/** \brief  This macro calculates the common part of temporay word T1 for each round (0 - 79) **/
#define CRYPTO_XVIX_XAIX_SHA1_T1(i)                                                              \
(                                                                                                \
  CRYPTO_XVIX_XAIX_ADD32(CRYPTO_XVIX_XAIX_ROL32(workspace->R[CRYPTO_XVIX_XAIX_REG_A],            \
                                                5U                                               \
                                               ),                                                \
                         CRYPTO_XVIX_XAIX_ADD32(workspace->R[CRYPTO_XVIX_XAIX_REG_E],            \
                                                workspace->W[((i) == 0U) ? 0U : ((i) % 16U)]      \
                                               )                                                 \
                        )                                                                        \
)

/* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0024,1 */
#if (defined CRYPTO_XVIX_XAIX_SHA1_CH)
#error CRYPTO_XVIX_XAIX_SHA1_CH already defined
#endif
/** \brief  This macro represents the CH logical function mentioned in Chapter 8.2.5 of rfc4634 **/
#define CRYPTO_XVIX_XAIX_SHA1_CH(x, y ,z)                                          \
(                                                                                  \
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0025,1 */
#if (defined CRYPTO_XVIX_XAIX_SHA1_MAJ)
#error CRYPTO_XVIX_XAIX_SHA1_MAJ already defined
#endif
/** \brief  This macro represents the MAJ logical function mentioned in Chapter 8.2.5 of rfc4634 **/
#define CRYPTO_XVIX_XAIX_SHA1_MAJ(x, y, z)                                         \
(                                                                                  \
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0026,1 */
#if (defined CRYPTO_XVIX_XAIX_SHA1_PARITY)
#error CRYPTO_XVIX_XAIX_SHA1_PARITY already defined
#endif
/** \brief  This macro represents the PARITY logical function mentioned in Chapter 8.2.5 of rfc4634 **/
#define CRYPTO_XVIX_XAIX_SHA1_PARITY(x, y, z)                                      \
(                                                                                  \
  CRYPTO_XVIX_XAIX_XOR32(CRYPTO_XVIX_XAIX_XOR32((x), (y)),                         \
                         (z)                                                       \
                        )                                                          \
)
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/** \brief  The sequence of four constant 32-bit words, K0, K1, K2, K3
 **         used by HASH_SHA1_NOTSET.
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
/* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0013,1 */
static CONST(uint32, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_HASH_SHA1_NOTSET_K[CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_ROUND_CONSTANTS] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process ----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Main -------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    /* CHECK: NOPARSE
     * The return value of GetNextState cannot be FALSE for HASH_SHA1_NOTSET, because the state machine
    ...
    /* CHECK: PARSE */
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Cancel -----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Reset ------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Restart ------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Callback ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA1_NOTSET == STD_ON)
/* CHECK: NOPARSE
 * This API is only reachable for cryptographic primitives that are using a secondary primitive.
 */
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0007, 1 */
  /* 2. Initialize the internal state of the hash function */
  workspace->H[0U] = 0x67452301UL;
  workspace->H[1U] = 0xEFCDAB89UL;
  workspace->H[2U] = 0x98BADCFEUL;
  workspace->H[3U] = 0x10325476UL;
  workspace->H[4U] = 0xC3D2E1F0UL;

  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType));
...
)
{
  ...
  bytesFetch  = (uint8) CRYPTO_XVIX_XAIX_MIN(((uint32) CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE - workspace->mLvl),
                                             bytesRemain
                                            );
  ...
  if (   ((CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE                           ) == workspace->mLvl)
      && (((uint32) CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE - workspace->mLvl) <  bytesRemain    )
     )
  {
    /* CHECK: NOPARSE
...
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
    {
      ...
      (void) Crypto_xVIx_xAIx_BufUint8ToBufUint32((P2VAR(uint8, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA)) workspace->M, CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE);
    }
...
)
{
  ...
  L                 = (workspace->mCnt * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE) + workspace->mLvl; /* length of full message in bytes */
   ...
   */
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0003,1 */
  if (   (L % CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE)
      <= (CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE - 1U - (CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_WORDSIZE * 2U))
     )
  {
    /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0004,1 */
    m[L % CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE] = 0x80U;
    /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0005,1 */
    /* CHECK: NOPARSE
     * This is a platform specific check and both paths cannot be covered on the same platform.
     */
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
    ...
    /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0006,1 */
    workspace->M[CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE - 1U] = workspace->length;
...
)
{
  ...
  if (0U == workspace->rounds)
  {
    ...
    TS_MemCpy(wRPtr, workspace->H, (5U * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_WORDSIZE));

    /* prepare the message schedule W */
    TS_MemCpy(wWPtr, workspace->M, (16U * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_WORDSIZE));
  }

  /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0008,1 */
  for (i = workspace->rounds;
       (   (i < ((uint32) workspace->rounds + CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_COMPRESSLOOPS + 1U))
        && (i < CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_ROUNDS                                          )
       );
       i++
      )
  {
    ...
    {
      j               = i % 16U;
      wWPtr[j] = CRYPTO_XVIX_XAIX_ROL32(
                                        CRYPTO_XVIX_XAIX_XOR32(
                                                               wWPtr[(uint8)(i + (uint8)13U) & (uint8)0x0fU],
                                                               CRYPTO_XVIX_XAIX_XOR32(
                                                                                      wWPtr[(uint8)(i + (uint8)8U) &  (uint8)0x0fU],
                                                                                      CRYPTO_XVIX_XAIX_XOR32(
                                                                                                             wWPtr[(uint8)(i + (uint8)2U) &  (uint8)0x0fU],
                                                                                                             wWPtr[j]
                                                                                                            )
                                                                                      )
                                                              ),1U
    ...
    if(i < 20U)
    {
      /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0009,1 */
      T1 = CRYPTO_XVIX_XAIX_ADD32(
                                  CRYPTO_XVIX_XAIX_SHA1_CH(
                                                      wRPtr[CRYPTO_XVIX_XAIX_REG_B],
                                                      wRPtr[CRYPTO_XVIX_XAIX_REG_C],
                                                      wRPtr[CRYPTO_XVIX_XAIX_REG_D]
                                                     ),
                                  Crypto_xVIx_xAIx_HASH_SHA1_NOTSET_K[0U]
                                 );
    }
    else
    /* Deviation TASKING-1 */
    ...
    {
      /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0010,1 */
      T1 = CRYPTO_XVIX_XAIX_ADD32(
                                  CRYPTO_XVIX_XAIX_SHA1_PARITY(
                                                          wRPtr[CRYPTO_XVIX_XAIX_REG_B],
                                                          wRPtr[CRYPTO_XVIX_XAIX_REG_C],
                                                          wRPtr[CRYPTO_XVIX_XAIX_REG_D]
                                                         ),
                                  Crypto_xVIx_xAIx_HASH_SHA1_NOTSET_K[1U]
                                 );
    }
    else
    /* Deviation TASKING-1 */
    ...
    {
      /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0011,1 */
      T1 = CRYPTO_XVIX_XAIX_ADD32(
                                  CRYPTO_XVIX_XAIX_SHA1_MAJ(
                                                       wRPtr[CRYPTO_XVIX_XAIX_REG_B],
                                                       wRPtr[CRYPTO_XVIX_XAIX_REG_C],
                                                       wRPtr[CRYPTO_XVIX_XAIX_REG_D]
                                                      ),
                                  Crypto_xVIx_xAIx_HASH_SHA1_NOTSET_K[2U]
                                 );
    }
    else
    /* CHECK: NOPARSE
     * This condition cannot be false since the value of i is always less than
     * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_ROUNDS because of the loop condition.
     */
    /* Deviation TASKING-1 */
    if (    (i >= 60U)
    /* Deviation TASKING-1 */
    ...
    {
      /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0012,1 */
      T1 = CRYPTO_XVIX_XAIX_ADD32(
                                  CRYPTO_XVIX_XAIX_SHA1_PARITY(
                                                          wRPtr[CRYPTO_XVIX_XAIX_REG_B],
                                                          wRPtr[CRYPTO_XVIX_XAIX_REG_C],
                                  ...
                                  Crypto_xVIx_xAIx_HASH_SHA1_NOTSET_K[3U]
                                 );
    }
    else
    {
    ...
    T1                           += CRYPTO_XVIX_XAIX_SHA1_T1(i);
    wRPtr[CRYPTO_XVIX_XAIX_REG_E] = wRPtr[CRYPTO_XVIX_XAIX_REG_D];
    wRPtr[CRYPTO_XVIX_XAIX_REG_D] = wRPtr[CRYPTO_XVIX_XAIX_REG_C];
    wRPtr[CRYPTO_XVIX_XAIX_REG_C] = CRYPTO_XVIX_XAIX_ROL32(wRPtr[CRYPTO_XVIX_XAIX_REG_B], 30U);
    wRPtr[CRYPTO_XVIX_XAIX_REG_B] = wRPtr[CRYPTO_XVIX_XAIX_REG_A];
    wRPtr[CRYPTO_XVIX_XAIX_REG_A] = T1;
  }

  workspace->rounds += CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_COMPRESSLOOPS + 1U;

  if ((CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_ROUNDS - 1U) <= workspace->rounds)
  {
    for (i = 0U; i < 5U; i++)
    {
    ...
    TS_MemBZero(wWPtr,        CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_ROUNDS        );
    TS_MemBZero(workspace->M, CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_BLOCKSIZE_BYTE);
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType));
...
)
{
...
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
  {
    Crypto_xVIx_xAIx_BufUint32ToBufUint8(workspace->H, 5U);
  }
#endif /* (CPU_BYTE_ORDER == LOW_BYTE_FIRST) */
  /* CHECK: PARSE */

  /* !LINKSTO Crypto.Req.CPr/HASH_SHA1_NOTSET/GENERAL/0016,1 */
  TS_MemCpy(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputPtr,
            ...
            CRYPTO_XVIX_XAIX_MIN(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
                                 CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA1_NOTSET_RESULTSIZE
                                )
           );
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = CRYPTO_XVIX_XAIX_MIN(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA1_NOTSET_WorkspaceType));
