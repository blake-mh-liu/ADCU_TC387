...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                                      /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                        /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SIPHASH_SIPHASH24.c/0004,1 */

/*==================[macros]======================================================================*/

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0002,1 */
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0003,1 */
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0008,1 */
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0009,1 */
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0010,1 */
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0011,1 */
...
/* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0016,1 */
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process -----------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Main --------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Cancel ------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Reset -------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Restart -------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Callback ----------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON)
/* CHECK: NOPARSE
 * This API is only reachable for cryptographic primitives that are using a secondary primitive.
 */
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
  ...
  /* CHECK: NOPARSE
   * The FOR loop condition (i < *smStateIndx) is always FALSE for MACVERIFY_SIPHASH_SIPHASH24, because the state
...
)
{
  ...
  /* Extract key. */
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0006,1 */
  key0 = CRYPTO_XVIX_XAIX_UINT64_UINT8_TO_UINT64_LE(workspace->KeyData);
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0007,1 */
  key1 = CRYPTO_XVIX_XAIX_UINT64_UINT8_TO_UINT64_LE(&workspace->KeyData[CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_KEY_LEN_BYTES >> 1U]);
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType));
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0012,1 */
  if (CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES <= (workspace->DataLength + workspace->RemainingBytes))
  {
    ...
    else
    {
      ...
      for (i = (uint64) CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES - workspace->RemainingBytes; i > 0U; i--)
      {
    ...
    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0014,1 */
    ...
    workspace->DataPtr = &workspace->DataPtr[CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES - workspace->RemainingBytes];

    workspace->DataLength -= (CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES - workspace->RemainingBytes);

    /* Increase the number of total bytes. */
    workspace->TotalNumberOfBytes += (  CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType));

  return E_OK;
}
#endif /*CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SIPHASH_SIPHASH24 == STD_ON*/
...
)
{
  ...
  if (  job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength
      > (CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES << 3U)
     )
  {
    /* It is not possible to have a SipHash value of the size given by the user. This is an
     * error. */

    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0018,1 */
    workspace->smResult         = E_NOT_OK;
    workspace->smOperationDone |= CRYPTO_OPERATIONMODE_FINISH;
    /* The call to Crypto_xVIx_xAIx_Procedure_NotifyCaller shall not fail because the only
     * possible execution path for this call will reset the workspace and the driver object
     * and return E_OK.
     */
    CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType));
    result = E_NOT_OK;
  }
  else
  {
...
)
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType);
        ...
        uint8                   pos           = 0U;
        uint8                   mask          = 0U;
        Crypto_VerifyResultType compareResult = CRYPTO_E_VER_NOT_OK;
        uint8                   sipHashResult[CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_BLOCK_LEN_BYTES];
        uint8  i    = 0U;
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0013,1 */
  /* Deviation MISRAC2012-1 */
  workspace->MessageBlock = CRYPTO_XVIX_XAIX_OR64(workspace->MessageBlock,
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0015,1 */
   ...
   * has just been computed. */
   /* Compare whole bytes*/
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0017,1 */
  if (Crypto_xVIx_xAIx_MemCmpSec(sipHashResult,
                                 job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputPtr,
                                 job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength >> 3U
                                ) == E_OK
     )
  {
    compareResult = CRYPTO_E_VER_OK;

    /* Compare rest of bits */
    if (0U < (job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength % 8U))
    {
      mask = 0x00U;
      for (pos = 0U; pos < (job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength % 8U); pos++)
      {
        mask = (mask >> 1U) + 0x80U;
      }
      if (   ((sipHashResult[job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength >> 3U]) & mask)
          != ((job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputPtr[job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength >> 3U]) & mask)
         )
      {
        compareResult = CRYPTO_E_VER_NOT_OK;
      }
    }
  }
  else
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.verifyPtr) = compareResult;
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SIPHASH_SIPHASH24_WorkspaceType));
...
)
{
  ...
  if (E_OK == result)
  {
    ...
    if (E_OK == result)
    {
      if (CRYPTO_XVIX_XAIX_CPR_MACVERIFY_SIPHASH_SIPHASH24_KEY_LEN_BYTES != keyPtr->data->size)
      {
        /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SIPHASH_SIPHASH24/GENERAL/0021,1 */
        workspace->smResult         = E_NOT_OK;
        workspace->smOperationDone |= CRYPTO_OPERATIONMODE_START;
        result                      = E_NOT_OK;
      }
