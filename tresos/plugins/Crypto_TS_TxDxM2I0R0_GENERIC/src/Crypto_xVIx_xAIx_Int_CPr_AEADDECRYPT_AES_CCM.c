...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_CCM.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                              /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_CCM.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_CCM.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_CCM.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_CCM.c/0004,1 */

/*==================[macros]======================================================================*/

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
...
#if (defined CRYPTO_XVIX_XAIX_STATE_PROCESS_AEADDECRYPT_AES_CCM_MSG)
#error CRYPTO_XVIX_XAIX_STATE_PROCESS_AEADDECRYPT_AES_CCM_MSG already defined
#endif
/** \brief  The process AEADDECRYPT_AES_CCM state. **/
#define CRYPTO_XVIX_XAIX_STATE_PROCESS_AEADDECRYPT_AES_CCM_MSG 4U
...
#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODELEN_THRESHOLD)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODELEN_THRESHOLD already defined
#endif
/** \brief  The encode length threshold. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODELEN_THRESHOLD  65280U /* 2^16 - 2^8*/

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MIN)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MIN already defined
#endif
/** \brief  The minimum nounce size in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MIN  7U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MAX)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MAX already defined
#endif
/** \brief  The maximum nounce size in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MAX  13U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_2BYTES)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_2BYTES already defined
#endif
/** \brief  The 2 bytes encode len for Associate Data. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_2BYTES  2U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_6BYTES)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_6BYTES already defined
#endif
/** \brief  The 6 bytes encode len for Associate Data. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_6BYTES  6U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_BYTESIZE_MAX)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_BYTESIZE_MAX already defined
#endif
/** \brief  The maximum Associate Data length in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_BYTESIZE_MAX  4U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX already defined
#endif
/** \brief  The maximum Payload length in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX  4U

#if (defined CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODE_MAC_INDEX)
#error CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODE_MAC_INDEX already defined
#endif
/** \brief  The encode Max LSB index in Flag byte. **/
#define CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODE_MAC_INDEX  3U

#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON) */
...
/** \brief  AEADDECRYPT_AES_CCM MAC B0 process
 **
 ** Process AEADDECRYPT_AES_CCM MAC B0 and return the error.
 **
...
/** \brief  AEADDECRYPT_AES_CCM MAC Associate Data process
 **
 ** Process AEADDECRYPT_AES_CCM MAC Associate Data process and return the error.
 **
 ** \param[in]      associatedDataLength  Associate Data Length.
...
/** \brief  AEADDECRYPT_AES_CCM MAC Message process
 **
 ** Process AEADDECRYPT_AES_CCM MAC Message and return the error.
 **
 ** \param[in]      msgLength  Message Length.
...
/** \brief  AEADDECRYPT_AES_CCM Message process
 **
 ** Process AEADDECRYPT_AES_CCM Message and return the error.
 **
 ** \param[in]      msgLength            Message Length.
 ** \param[in]      msgDataPtr           Message Data Pointer
...
/** \brief  AEADDECRYPT_AES_CCM Second Primitive Process
 **
 ** Process AEADDECRYPT_AES_CCM Second Primitive.
 **
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process -------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Main ----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Cancel --------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Reset ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Restart ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Callback ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON) */
/* --- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_CCMGHashCTMul -------------------------------------------------- */
...
)
{
   ...
   */
  for (i  = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES;
       i != IV_Index;
       i--
      )
  {
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));
  return result;
}
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON) */
...
)
{
  ...
  if (CRYPTO_XVIX_XAIX_STATE_PROCESS_IDLE == workspace->currProcessState)
  {
    ...
    {
      /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/UPDATE/0001,1 */

      result = CRYPTO_E_SMALL_BUFFER;
      /* Deviation TASKING-2 */
      CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(result, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));
    }
    else
    {
      *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = 0U;

      workspace->currProcessState = CRYPTO_XVIX_XAIX_STATE_PROCESS_AEADDECRYPT_AES_CCM_MSG;

      TS_MemCpy(workspace->Ctr0, workspace->Ctr, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
  ...
  {
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/UPDATE/0003,1 */
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));

  return E_OK;
}
#endif /*CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON*/
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));
...
)
{
  ...
  switch (workspace->currProcessState)
  {
    ...
    {
      result = Crypto_xVIx_xAIx_Procedure_Mac_MsgProcess(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
                                                        job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputPtr,
                                                        primitive
                                                       );
      break;
    }
    case CRYPTO_XVIX_XAIX_STATE_PROCESS_AEADDECRYPT_AES_CCM_MSG:
    {
...
)
{
  ...
  if(E_OK == result)
  {
    ...
    if (E_OK == result)
    {
      ...
      {
        /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/START/0002,1 */
  ...
  if (E_OK == result)
  {
    ...
    if (E_OK == result)
    {
      if (   (CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MIN > counterPtr->data->size)
          || (CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_NOUNCE_SIZE_MAX < counterPtr->data->size)
         )
      {
        /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/START/0004,1 */
        workspace->smResult         = CRYPTO_E_KEY_SIZE_MISMATCH;
        workspace->smOperationDone |= CRYPTO_OPERATIONMODE_START;
        result                      = E_NOT_OK;
      }
      else
      {
        ...
        /* AES CCM Ctr0 Update*/
        TS_MemBZero(workspace->Ctr, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
        TS_MemBZero(workspace->Ctr0, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
  ...
  else
  {
    if( workspace->smResult  != CRYPTO_E_KEY_SIZE_MISMATCH)
      {
        /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/START/0001,1 */
        /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/START/0003,1 */
         workspace->smResult  = E_NOT_OK;
      }
    workspace->smOperationDone |= CRYPTO_OPERATIONMODE_START;
    result                      = E_NOT_OK;
...
)
{
  ...
  Std_ReturnType result = E_NOT_OK;
  Std_ReturnType          tagComp;
  Crypto_VerifyResultType verResult;

  /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/FINISH/0001,1 */
  ...
  if (   ( 32U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && ( 48U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && ( 64U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && ( 80U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && ( 96U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && (112U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && (128U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
     )
  {
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/FINISH/0002,1 */
    result = E_NOT_OK;
    /* Deviation TASKING-2 */
    CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(result, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_CCM_WorkspaceType));
  }
  else
  {
    /* Compare full bytes of the TAG */
    tagComp = Crypto_xVIx_xAIx_MemCmpSec(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputPtr,
                                        workspace->T,
                                        (job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength  / 8U)
                                        );
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/FINISH/0003,1 */
    verResult = (E_OK == tagComp) ? CRYPTO_E_VER_OK : CRYPTO_E_VER_NOT_OK;

    *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.verifyPtr) = verResult;

    TS_MemBZero(workspace->T, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
...
)
{
  ...
  uint8          index   = 0U;
  uint8          msgSize = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX;
  uint8          Q[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX] = {0U};
  uint8          B0[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES] = {0U};
  ...
  B0[0U] |= (uint8)(((workspace->macLen - 2U)/2U) << CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODE_MAC_INDEX);
  ...
  /* CHECK: NOPARSE */
  /*The FOR loop condition can not fail, as the minimum input length is 1. As a result index will never reach the value CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX*/
  for (index = 0U; index < CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX; index++)
  /* CHECK: PARSE */
  {
    if (Q[index] != 0U)
    {
  ...
  {
    TS_MemCpy(&B0[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES - msgSize], &Q[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_MSG_BYTESIZE_MAX - msgSize], msgSize);
    TS_MemCpy(workspace->Block, B0, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
  ...
  {
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/UPDATE/0002,1 */
...
)
{
  ...
  uint8  dataBlocBuff[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES]         = {0U};
  uint8  encodeLenBuff[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_6BYTES] = {0U};
  uint8  assDataLenBuff[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_BYTESIZE_MAX]    = {0U};
  uint8  availableBuffLen = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES;
  uint8  encodeLen        = 0U;
  uint8  copyDataLen      = 0U;

  /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/UPDATE/0004,1 */
  if (0U != associatedDataLength)
  {
    if (0U == workspace->currentDataProcessIndex)
    {
      ...
      /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/UPDATE/0005,1 */
      if (associatedDataLength < CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ENCODELEN_THRESHOLD)
      {
        encodeLen = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_2BYTES;
        TS_MemCpy(&encodeLenBuff, &assDataLenBuff[2U], CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_2BYTES);
      }
      else
      {
        encodeLen = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_ENCODELEN_6BYTES;
        ...
        TS_MemCpy(&encodeLenBuff[2U], assDataLenBuff, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_ADATA_BYTESIZE_MAX);
      }
      TS_MemCpy(dataBlocBuff, encodeLenBuff, encodeLen);

      availableBuffLen = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES - encodeLen;
    }
    ...
    Crypto_xVIx_xAIx_CommonXOR(dataBlocBuff, workspace->T, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);

    TS_MemCpy(workspace->Block, dataBlocBuff, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
  ...
  {
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_CCM/UPDATE/0006,1 */
    workspace->currProcessState = CRYPTO_XVIX_XAIX_STATE_PROCESS_MAC_MSG;
  }
}
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_CCM == STD_ON) */
...
)
{
  ...
  if(workspace->currentDataProcessIndex >= msgLength)
  {
   ...
   Crypto_xVIx_xAIx_Procedure_SecondPrimitiveUpdateProcess(
    ...
    Crypto_xVIx_xAIx_CommonXOR(workspace->T, workspace->Block, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
...
)
{
  ...
  Crypto_xVIx_xAIx_CommonXOR(dataBlocBuff, workspace->Block, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES);
...
)
{
  ...
  workspace->secondaryOutputLength = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES;
  ...
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_CCM_BLOCK_LEN_BYTES;
