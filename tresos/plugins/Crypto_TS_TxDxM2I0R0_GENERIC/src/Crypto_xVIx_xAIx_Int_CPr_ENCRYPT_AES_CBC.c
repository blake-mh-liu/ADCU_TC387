...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_AES_CBC.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                          /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_AES_CBC.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>            /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_AES_CBC.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_AES_CBC.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_ENCRYPT_AES_CBC.c/0004,1 */
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process -----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Main --------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Cancel ------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Reset -------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Restart -------------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Callback ----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_ENCRYPT_AES_CBC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
  ...
  bytesFetch  = (uint8) CRYPTO_XVIX_XAIX_MIN(((uint32) CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE - workspace->yLvl),
                                             bytesRemain
                                            );
  ...
  if (   ((CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE                           ) == workspace->yLvl)
      && (((uint32) CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE - workspace->yLvl) <  bytesRemain    )
     )
  {
    /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0004,1 */
    /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0005,1 */
    for (i = 0U; i < CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE; i++)
    {
    ...
    result                              = E_OK;
    workspace->yLvl                     = 0U;
    workspace->secondaryOutputPtrLength = CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE;

    if (CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE > (workspace->outputLength - outputPosition))
    {
      /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0009,1 */

      result = CRYPTO_E_SMALL_BUFFER;
      /* Deviation TASKING-2 */
      CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(result, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
    }
    else
    {
      TS_MemCpy(&(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputPtr[outputPosition]),
                workspace->x, CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE
               );
      workspace->outputPosition += CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE;
    }
  }
  else
  {
...
)
{
  ...
  uint32         paddingBufferLength = CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE;
  uint32         i                   = 0U;
  uint8 tempresult = E_NOT_OK;
  ...
  {
    /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0002,2 */
    /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0014,1 */
    paddingBufferLength = (uint32) CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE - workspace->yLvl;
    result              = Crypto_xVIx_xAIx_Padding_Add( CRYPTO_XVIX_XAIX_JOBPI(job)->algorithm.secondaryFamily,
                                                        workspace->y,
                                                        workspace->yLvl,
                                                       &(workspace->y[workspace->yLvl]),
                                                       &paddingBufferLength,
                                                        CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE
                                                      );
  }
  else
  {
    /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0010,1 */
    if (0U != workspace->yLvl)
    {
      result = E_NOT_OK;
    }
    else
  ...
  if (E_OK == result)
  {
    ...
    if (CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE > (workspace->outputLength - outputPosition))
    {
      ...
      result = CRYPTO_E_SMALL_BUFFER;
      /* Deviation TASKING-2 */
      CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(result, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
    }
    else
    {
      /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0008,1 */
      TS_MemCpy(&(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputPtr[outputPosition]),
                workspace->x,
                CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE
              );
  ...
  else
  {
    tempresult                              = E_OK;
    /* Deviation TASKING-1 */
    CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(tempresult, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
  }
  ...
  if (0U == workspace->yLvl)
  {
    ...
    {
      *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = workspace->outputLength;
    }
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/ENCRYPT_AES_CBC/GENERAL/0003,1 */
  ...
  if (E_OK == result)
  {
    ...
    else
    {
      ...
      if (E_OK == result)
      {
        if (CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE == ivPtr->data->size)
        {
  ...
  workspace->yLvl = 0U;
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
...
)
{
  ...
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_CPR_ENCRYPT_AES_CBC_BLOCKSIZE;
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_ENCRYPT_AES_CBC_WorkspaceType));
