...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SHA2384_HMAC.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                                 /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SHA2384_HMAC.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                   /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SHA2384_HMAC.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SHA2384_HMAC.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACVERIFY_SHA2384_HMAC.c/0004,1 */
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process ----------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Main -------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Cancel -----------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Reset ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Restart ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Callback ---------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACVERIFY_SHA2384_HMAC == STD_ON)
/* CHECK: NOPARSE
 * This API is only reachable for cryptographic primitives that are using a secondary primitive.
 */
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
  ...
  uint32         processInputLength = CRYPTO_XVIX_XAIX_MIN(CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE,
                                                      (uint32)(workspace->inputEndPtr - workspace->inputActPtr)
                                                     );

  TS_PARAM_UNUSED(job);

  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/UPDATE/0001,1 */
...
)
{
  ...
  TS_MemBZero(k0,            CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE );
  TS_MemBZero(bf,            CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE );
  TS_MemBZero(workspace->H1, CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE);
  TS_MemBZero(workspace->H2, CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE);

  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0001,1 */
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0002,1 */

  if (E_OK == result)
  {
    fromPrimitive = TRUE;
    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0003,1 */
    /* Deviation TASKING-1 */
    CRYPTO_XVIX_XAIX_KEY_ELEMENT_READ_LOCK(result, keyPtr, fromPrimitive);
  }

  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0004,1 */
  if (E_OK == result)
  {
    ...
    if (CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE < keyPtr->data->size)
    {
      /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0005,1 */
      i = CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE;
      ...
      /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0006,1 */
    }
    else
    {
      /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0007,1 */
    ...
    if (E_OK == result)
    {
      /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0008,1 */
      for (i = 0; i<CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE; i++)
      {
        bf[i] = k0[i] ^ 0x36U;
      }

      /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0009,1 */
      workspace->H1Len = CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE;
      workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr        =  bf;
      workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     =  CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE;
    ...
    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/START/0011,1 */
    CRYPTO_XVIX_XAIX_KEY_ELEMENT_READ_RELEASE(keyPtr);
  }

  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0001,1 */
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0002,1 */

  if (E_OK == result)
  {
    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0003,1 */
    for (i = 0; i<CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE; i++)
    {
      bf[i] = k0[i] ^ 0x5CU;
    }

    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0004,1 */
    workspace->H2Len = CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr        =  bf;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     =  CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_BLOCKSIZE;
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0006,1 */
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr    = workspace->H1;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength = CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode        = CRYPTO_OPERATIONMODE_UPDATE;
  ...
  /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0008,1 */
  if (E_OK == result)
  {
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode = CRYPTO_OPERATIONMODE_FINISH;
    ...
    /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0009,1 */
    if (E_OK == result)
    {
      if ((CRYPTO_XVIX_XAIX_INT_CPR_MACVERIFY_SHA2384_HMAC_RESULTSIZE * 8U) >= job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength)
      {
        /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0010,2 */
        /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0011,2 */
        ...
        /* !LINKSTO Crypto.Req.CPr/MACVERIFY_SHA2384_HMAC/FINISH/0012,2 */
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(result, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_SINGLECALL(result, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_MACVERIFY_SHA2384_HMAC_WorkspaceType));
