...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15.c/0001,1 */
 ...
 * For SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 the key is needed in long number representation format.
 */
...
#include <Crypto_xVIx_xAIx_Int.h>                                             /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                               /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15.c/0004,1 */

/*==================[macros]======================================================================*/

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON) */
...
(
  P2VAR(Crypto_JobType,                        AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2VAR(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) workspace
);
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON) */
...
/* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/GENERAL/0012,1 */
static CONST(uint8, CRYPTO_xVIx_xAIx_CONST)
  Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[9U][15U] =
{
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA1_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2224_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2256_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2384_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2512_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3224_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3256_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3384_ID,
  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3512_ID
};
#endif /* ((CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process ----------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Main -------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Cancel -----------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Reset ------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Restart ------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Callback ---------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15 == STD_ON)
/* CHECK: NOPARSE
 * This API is only reachable for cryptographic primitives that are using a secondary primitive.
 */
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/GENERAL/0013,1 */
     ...
     )
  {
    ...
    if(0U != workspace->hashLength)
    {
      ...
      /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0007,1 */
    }
    /* CHECK: PARSE */
  }

  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/UPDATE/0001,1 */
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/UPDATE/0002,1 */
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0001,1 */
  uint32                   hashResultLength   = workspace->hashLength;

  TS_PARAM_UNUSED(job);

  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0012,1 */
    ...
    )
  {
    *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.verifyPtr) = resultVerify;
    ...
    CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
  }
  else
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0002,1 */
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0003,1 */
    workspace->smResult = result;
  }
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0015,1 */
  ...
  /* set the hash algorithm id and hash Id length */
  Crypto_xVIx_xAIx_Procedure_SetAlgorithmId(job, workspace);

  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0004,1 */
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0007,1 */
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0008,1 */
  if
  (
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0006,1 */
  /* check the length of PS = emLen - tLen - 3 */
  if (
         (numberLength >=
            (  workspace->hashLength
             + workspace->algorithmIdLength
      ...
      && ( NULL_PTR != workspace->algorithmId )
     )
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0009,1 */
    /* check the value of PS */
    for
    ( i = 2U;
      i < (numberLength -
           (  workspace->hashLength
    ...
    {
      if (workspace->EM[i] != (uint8)0xFFU)
      {
        resultVerify = CRYPTO_E_VER_NOT_OK;
      }
    }

    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0010,1 */
    if (workspace->EM[i] != (uint8)0x00U)
    {
      resultVerify = CRYPTO_E_VER_NOT_OK;
    }
    i++;
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0004,1 */
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0011,1 */
...
)
{
  ...
  if(0U != workspace->hashLength)
  {
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0001,1 */
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0002,1 */
  if(E_OK == result)
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0003,1 */
    /* Deviation TASKING-1 */
  ...
  if (E_OK == result)
  {
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0004,1 */
  if (E_OK == result)
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0005,1 */
    /* convert the rsa key */
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0008,1 */
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/START/0006,1 */
  ...
  if (E_OK == result)
  {
       ...
       )
    {
      ...
      /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0013,1 */
      ...
      */
      ...
      /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_RSA_RSASSAPKCS1V15/FINISH/0014,1 */
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.verifyPtr) = resultVerify;
  CRYPTO_XVIX_XAIX_SET_SMRESULT_SINGLECALL(result, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_WorkspaceType));
...
)
{
  ...
  {
#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA1_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA1_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA1:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[0U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA1_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA1_NOTSET  )*/
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA1_NOTSET == STD_ON) */

#if    (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2224_NOTSET  )
#if    (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2224_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA2_224:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[1U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2224_ID_LENGTH;
    }
    break;
#endif /* #if    (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2224_NOTSET  ) */
#endif /* #if    (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2224_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2256_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2256_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA2_256:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[2U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2256_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2256_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2256_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2384_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2384_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA2_384:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[3U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2384_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2384_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2384_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2512_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2512_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA2_512:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[4U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA2512_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2512_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA2512_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3224_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3224_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA3_224:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[5U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3224_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3224_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3224_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3256_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3256_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA3_256:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[6U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3256_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3256_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3256_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3384_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3384_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA3_384:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[7U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3384_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3384_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3384_NOTSET == STD_ON) */

#if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3512_NOTSET  )
#if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3512_NOTSET == STD_ON)
    case CRYPTO_ALGOFAM_SHA3_512:
    {
      workspace->algorithmId       = &Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HashAlgorithmId[8U][0U];
      workspace->algorithmIdLength =  CRYPTO_XVIX_XAIX_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_SHA3512_ID_LENGTH;
    }
    break;
#endif /* #if (defined CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3512_NOTSET  ) */
#endif /* #if (CRYPTO_XVIX_XAIX_INC_ENABLED_SIGNATUREVERIFY_RSA_RSASSAPKCS1V15_HASH_SHA3512_NOTSET == STD_ON) */
