...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                                             /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                               /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET.c/0004,1 */
...
#define CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT 17U
...
#define CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT 17U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHPROCESSHASH 7U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHHASH1 8U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHCALCR 9U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHPROCESSENCODER 10U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHHASHUPDATE 11U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHHASH2 12U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHPROCESSHASHRESULT 13U
...
#define CRYPTO_XVIX_XAIX_STATE_SINGLECALL 14U
...
#define CRYPTO_XVIX_XAIX_STATE_CANCEL 15U
...
#define CRYPTO_XVIX_XAIX_STATE_ERROR 16U
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON) */
...
(
    P2VAR(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) workspace,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType,                                     AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
);
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
 ...
 **        Hence, the variable Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Dom consists of 34 octets.
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
static CONST(uint8, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Dom[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_DOM_LENGTH] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process ----------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Main -------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Cancel -----------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Reset ------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Restart ------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Callback ---------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
  ...
  /* CHECK: NOPARSE
   * The FOR loop condition (i < *smStateIndx) is always FALSE for SIGNATUREGENERATE_ED25519PH_NOTSET, because the state
...
)
{
  ...
  if (E_OK == result)
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREGENERATE_ED25519PH_NOTSET/GENERAL/0018,2 */
    if (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_PRIVATEKEY_LENGTH != key->data->size)
    {
    ...
    else
    {
      ...
      workspace->tmp1ArrayLength   = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH;
      TS_MemCpy(workspace->tmp1Array, key->data->data, CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH);

      /* The public key is the last 32 bytes of the key element */
      TS_MemCpy(workspace->tmp2Array,
                &key->data->data[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH],
                CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH
               );
...
)
{
  ...
  workspace->hashResultLength = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_HASH_LENGTH;
  ...
  if (E_OK == result)
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREGENERATE_ED25519PH_NOTSET/GENERAL/0012,1 */
    ...
    workspace->scalar2[0U] = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS;
    ...
    (void)Crypto_xVIx_xAIx_LNLEByteArrayToNumber(
                                                  ...
                                                  (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_HASH_LENGTH >> 1U),
                                                  workspace->scalar2,
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  /* Hash the Message */
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREGENERATE_ED25519PH_NOTSET/GENERAL/0015,1 */
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  if (E_OK == result)
  {
    ...
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr     = &(workspace->hashResult[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_HASH_LENGTH >> 1U]);
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength  = (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_HASH_LENGTH >> 1U);
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode         = CRYPTO_OPERATIONMODE_UPDATE;
...
)
{
  ...
  if (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_SIGN_LENGTH > *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr))
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREGENERATE_ED25519PH_NOTSET/GENERAL/0010,1 */
  ...
  else
  {
    ...
    (void)Crypto_xVIx_xAIx_LNLEByteArrayToNumber(workspace->hashResult,
                                                 ...
                                                 workspace->scalar1,
                                                 CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS
                                                );
    /* r = r mod lValue */
...
{
  uint32 length   = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH;
  ...
  {
    workspace->tmp1Array[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH - 1U] |= (uint8)((uint8)workspace->edCtx.x0 << 7U);
  }
...
)
{
  ...
  if (E_OK == result)
  {
    ...
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr     = workspace->tmp1Array;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength  = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode         = CRYPTO_OPERATIONMODE_UPDATE;
...
)
{
  ...
  (void)Crypto_xVIx_xAIx_LNLEByteArrayToNumber(workspace->hashResult,
                                               workspace->hashResultLength,
                                               &workspace->tmp[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
                                               CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS
                                              );

  /* Tmp1 = HashResult % LValue */
  Crypto_xVIx_xAIx_LNModulo(&workspace->tmp[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
                            Crypto_xVIx_xAIx_EllipticCurveInfo[workspace->edCtx.curveIndex].modulus,
                            &workspace->edCtx.lnCtx
                            );

  /* Tmp1 = HashResult * Scalar s */
  Crypto_xVIx_xAIx_LNMultiplyNumbers(&workspace->tmp[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
                                     &workspace->tmp[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
                                     workspace->scalar2,
                                     &workspace->edCtx.lnCtx
                                    );
...
)
{
  ...
  Crypto_xVIx_xAIx_LNAdditionModular(&workspace->tmp[2U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
                                     workspace->scalar1,
                                     &workspace->tmp[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
                                     Crypto_xVIx_xAIx_EllipticCurveInfo[workspace->edCtx.curveIndex].modulus
                                    );
  ...
  /* The return value is ignored because the parameters are either from the context where they are
     ...
     the function.*/
  (void)Crypto_xVIx_xAIx_LNNumberToLEByteArray(&workspace->tmp[2U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS],
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = (length << 1U);
  ret = E_OK;
  /* Deviation TASKING-1 */
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(ret, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_SINGLECALL(result, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_WorkspaceType));
...
{
  /* Update the parameter Dom */
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr     = Crypto_xVIx_xAIx_CPr_SIGNATUREGENERATE_ED25519PH_NOTSET_Dom;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength  = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_DOM_LENGTH;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode         = CRYPTO_OPERATIONMODE_UPDATE;
...
)
{
  ...
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREGENERATE_ED25519PH_NOTSET_HASH_LENGTH;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode            = CRYPTO_OPERATIONMODE_UPDATE;
  /* Hash the input using the secondary primitive UPDATE. This call shall never fail because
   * the buffers and their sizes are set to valid values before this call.
   */
