...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA2512_NOTSET.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                              /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA2512_NOTSET.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA2512_NOTSET.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_HASH_SHA2512_NOTSET.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA2512_NOTSET.c/0004,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0010,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0011,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0012,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0013,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0014,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0015,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0016,1 */
...
(                                                                                                                                   \
  CRYPTO_XVIX_XAIX_ADD64(CRYPTO_XVIX_XAIX_ADD64(CRYPTO_XVIX_XAIX_ADD64(workspace->R[CRYPTO_XVIX_XAIX_REG_H],                        \
                                                ...
                                                CRYPTO_XVIX_XAIX_ADD64(Crypto_xVIx_xAIx_HASH_SHA2512_NOTSET_K[(i)],                                  \
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0017,1 */
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
 ...
 **         used by HASH_SHA2512_NOTSET.
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0002,1 */
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2384_NOTSET/GENERAL/0002,1 */
static CONST(uint64, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_HASH_SHA2512_NOTSET_K[CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_ROUNDS] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process -------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Main ----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    /* CHECK: NOPARSE
     * The return value of GetNextState cannot be FALSE for HASH_SHA2512_NOTSET, because the state machine
    ...
    /* CHECK: PARSE */
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Cancel --------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Reset ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Restart ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Callback ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA2512_NOTSET == STD_ON)
/* CHECK: NOPARSE
 * This API is only reachable for cryptographic primitives that are using a secondary primitive.
 */
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
  ...
  bytesFetch  = (uint8) CRYPTO_XVIX_XAIX_MIN(((uint32) CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE - workspace->mLvl),
                                             bytesRemain
                                            );
  ...
  if (   ((CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE                           ) == workspace->mLvl)
      && (((uint32) CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE - workspace->mLvl) <  bytesRemain    )
     )
  {
    /* CHECK: NOPARSE
...
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
    {
      ...
      (void) Crypto_xVIx_xAIx_BufUint8ToBufUint64((P2VAR(uint8, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA)) workspace->M, CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE);
    }
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/FINISH/0003,2 */
  L                 = (workspace->mCnt * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE) + workspace->mLvl; /* length of full message in bytes */
   ...
   */
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/FINISH/0009,2 */
  if (   (L % CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE)
      <= (CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE - 1U - (CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_WORDSIZE * 2U))
     )
  {
    /* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/FINISH/0010,1 */
    m[L % CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE] = 0x80U;

    /* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/FINISH/0004,2 */
    /* CHECK: NOPARSE
     * This is a platform specific check and both paths cannot be covered on the same platform.
     */
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
    ...
    /* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/FINISH/0002,2 */
    workspace->M[CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE - 1U] = workspace->length;
...
)
{
  ...
  if (0U == workspace->rounds)
  {
    ...
    TS_MemCpy(wRPtr, workspace->H, (8U * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_WORDSIZE));

    /* prepare the message schedule W */
    TS_MemCpy(wWPtr, workspace->M, (16U * CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_WORDSIZE));
  }

  for (i = workspace->rounds;
       (   (i < ((uint32) workspace->rounds + CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_COMPRESSLOOPS + 1U))
        && (i < CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_ROUNDS                                          )
       );
       i++
      )
  {
  ...
  workspace->rounds += CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_COMPRESSLOOPS + 1U;

  if ((CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_ROUNDS - 1U) <= workspace->rounds)
  {
    for (i = 0U; i < 8U; i++)
    {
    ...
    TS_MemBZero(wWPtr,        CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_ROUNDS        );
    TS_MemBZero(workspace->M, CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_BLOCKSIZE_BYTE);
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/GENERAL/0003,1 */
  workspace->H[0U] = 0x6A09E667F3BCC908ULL;
  workspace->H[1U] = 0xBB67AE8584CAA73BULL;
  workspace->H[2U] = 0x3C6EF372FE94F82BULL;
  workspace->H[3U] = 0xA54FF53A5F1D36F1ULL;
  workspace->H[4U] = 0x510E527FADE682D1ULL;
  workspace->H[5U] = 0x9B05688C2B3E6C1FULL;
  workspace->H[6U] = 0x1F83D9ABFB41BD6BULL;
  workspace->H[7U] = 0x5BE0CD19137E2179ULL;

  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType));
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA2512_NOTSET/FINISH/0008,2 */
  TS_MemCpy(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputPtr,
            ...
            CRYPTO_XVIX_XAIX_MIN(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
                                 CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA2512_NOTSET_RESULTSIZE
                                )
           );
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = CRYPTO_XVIX_XAIX_MIN(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA2512_NOTSET_WorkspaceType));
