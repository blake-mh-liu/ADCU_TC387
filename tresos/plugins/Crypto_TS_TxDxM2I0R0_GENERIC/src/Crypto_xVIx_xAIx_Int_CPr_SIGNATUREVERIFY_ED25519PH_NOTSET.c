...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                                           /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                             /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET.c/0004,1 */
...
#define CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT 21U
...
#define CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT 21U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHDECODEPK1 7U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHDECODEPK2 8U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHDECODEPK 9U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHVALIDATES 10U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHVALIDATER1 11U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHVALIDATER2 12U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHVALIDATER 13U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHHASHUPDATE 14U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHHASH 15U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHSIG1 16U
...
#define CRYPTO_XVIX_XAIX_STATE_FINISHSIG2 17U
...
#define CRYPTO_XVIX_XAIX_STATE_SINGLECALL 18U
...
#define CRYPTO_XVIX_XAIX_STATE_CANCEL 19U
...
#define CRYPTO_XVIX_XAIX_STATE_ERROR 20U
...
/* ---misc procedures---------------------------------------------------------------------------- */
/** \brief  Update the parameter Dom to the hash.
 **
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
static FUNC(void, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_Procedure_UpdateDom
(
    P2VAR(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) workspace,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType,                                   AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
);
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
static CONST(Crypto_xVIx_xAIx_LNWordType, CRYPTO_xVIx_xAIx_CONST)
  Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_DecodingParam1[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_NUM_LEN_WORDS] =
{
  0x00000008UL,
 ...
 */
static CONST(Crypto_xVIx_xAIx_LNWordType, CRYPTO_xVIx_xAIx_CONST)
  Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_DecodingParam2[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_NUM_LEN_WORDS] =
{
  0x00000008UL,
 ...
 **        Hence, the variable Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Dom consists of 34 octets.
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
static CONST(uint8, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Dom[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_DOM_LENGTH] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process ------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Main ---------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Cancel -------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Reset --------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Restart --------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
  ...
  /* CHECK: NOPARSE
   * The FOR loop condition (i < *smStateIndx) is always FALSE for SIGNATUREVERIFY_ED25519PH_NOTSET, because the state
...
)
{
  ...
  if (E_OK == result)
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0019,1 */
    if (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_PUBLICKEY_LENGTH != key->data->size)
    {
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  /* Hash the Message */
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0015,1 */
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  workspace->hashResultLength = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_HASH_LENGTH;
  ...
  if (E_OK == result)
  {
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0020,1 */
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0025,1 */
  if (E_OK == result)
  {
    /* Calculate u * v^3 */
...
)
{
  ...
  if (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_SIGN_LENGTH != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputLength)
  {
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0011,3 */
  ...
  else
  {
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0021,1 */
    (void)Crypto_xVIx_xAIx_LNLEByteArrayToNumber
    (
      &(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.secondaryInputPtr[CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_BYTEARRAY_LENGTH]),
      CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_BYTEARRAY_LENGTH,
      workspace->scalar1,
      CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS
    );
    ...
    /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0022,1 */
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0023,1 */
  ...
  /* !LINKSTO Crypto.Req.CPr/SIGNATUREVERIFY_ED25519PH_NOTSET/GENERAL/0024,1 */
  if (E_OK == result)
  {
    /* Calculate u * v^3 */
    Crypto_xVIx_xAIx_Procedure_EdDSAPointDecodingUV3(workspace->tmp, &(workspace->edCtx));
...
)
{
  ...
  /* start Hash(DOM || ENC(R) || ENC(A) || PH(M)) */
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode = CRYPTO_OPERATIONMODE_START;
  primitive->P2->data->P1                                               = primitive;
  ...
  if (E_OK == result)
  {
    ...
    Crypto_xVIx_xAIx_Procedure_UpdateDom(workspace, primitive);

    /* Update ENC(R) : tmp2Array */
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr     = workspace->tmp2Array;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength  = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_BYTEARRAY_LENGTH;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode         = CRYPTO_OPERATIONMODE_UPDATE;
...
)
{
  ...
  Crypto_xVIx_xAIx_Procedure_UpdateMsgDigest(workspace, primitive);
...
)
{
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.verifyPtr) = resultVerify;
  ret = E_OK;
  /* Deviation TASKING-1 */
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(ret, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_SINGLECALL(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_WorkspaceType));

  return E_OK;
}
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET == STD_ON) */

/* --- Crypto_xVIx_xAIx_Procedure_UpdateDom ----------------------------------------------------- */
...
{
  /* Update the parameter Dom */
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr     = Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_Dom;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength  = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_DOM_LENGTH;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode         = CRYPTO_OPERATIONMODE_UPDATE;
...
)
{
  ...
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr     = workspace->msgDigest;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength  = CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_HASH_LENGTH;
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.mode         = CRYPTO_OPERATIONMODE_UPDATE;
  /* Hash the input using the secondary primitive UPDATE. This call shall never fail because
   * the buffers and their sizes are set to valid values before this call.
   */
...
)
{
  ...
  const uint32 tmp1 = (0U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  const uint32 tmp2 = (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  ...
  (void)Crypto_xVIx_xAIx_LNLEByteArrayToNumber(
                                                ...
                                                CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_BYTEARRAY_LENGTH,
                                                point->yValue,
                                                CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_NUM_LEN_WORDS
                                              );
...
)
{
  ...
  const uint32 tmp1 = (0U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  const uint32 tmp2 = (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  const uint32 tmp3 = (2U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  const uint32 tmp4 = (3U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
...
{
  const uint32 tmp3 = (2U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  const uint32 tmp5 = (4U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);

  uint32 bits = Crypto_xVIx_xAIx_LNBitLengthOfNumber(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_DecodingParam1);
  ...
  while((Crypto_xVIx_xAIx_LNWordType)0U < bits)
  {
    ...
    if ((Crypto_xVIx_xAIx_LNWordType)1U == CRYPTO_XVIX_XAIX_LN_GET_BIT(Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_DecodingParam1, bits))
    {
...
)
{
  ...
  const uint32 vValue    = (0U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  /* uValue    Offset where u is stored. */
  const uint32 uValue    = (CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  /* squareOfX Offset where the result of xValue^2 is stored. */
  const uint32 squareOfX = (2U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  /* Value1    Offset where the result of (v * xValue^2 - u) % prime is stored. */
  const uint32 value1    = (3U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  /* Value2    Offset where the result of (v * xValue^2 + u) % prime is stored. */
  const uint32 value2    = (4U * CRYPTO_XVIX_XAIX_INT_CPR_SIGNATUREVERIFY_ED25519PH_NOTSET_TEMP_LEN_WORDS);
  ...
  else
  {
    ...
    if (0U == (&tmp[value2])[0U])
    {
      ...
      Crypto_xVIx_xAIx_LNMultiplyNumbers(
                                          point->xValue,
                                          point->xValue,
                                          Crypto_xVIx_xAIx_CPr_SIGNATUREVERIFY_ED25519PH_NOTSET_DecodingParam2,
                                          &(edCtx->lnCtx)
                                        );
