...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA3256_NOTSET.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                              /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA3256_NOTSET.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA3256_NOTSET.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_HASH_SHA3256_NOTSET.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_HASH_SHA3256_NOTSET.c/0004,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0011,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0012,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0020,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0021,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0022,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0024,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0025,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0026,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0019,1 */
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0002,1 */
/** \brief SHA3 (Keccak) constants for 24 rounds.
 *
 *  This is the constant padding block used for the SHA3 last block.
 */
static CONST(uint64, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KeccakF_RoundConstants[CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_NUMBER_OF_ROUNDS] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process -------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Main ----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    /* CHECK: NOPARSE
     * The return value of GetNextState cannot be FALSE for HASH_SHA3256_NOTSET, because the state machine
    ...
    /* CHECK: PARSE */
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Cancel --------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Reset ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Restart ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Callback ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
/* CHECK: NOPARSE
 * This API is only reachable for cryptographic primitives that are using a secondary primitive.
 */
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0014,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_HASH_SHA3256_NOTSET == STD_ON)
static FUNC(void, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_SHA3_Theta
(
  P2VAR(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) workspace
)
{
  uint8  x;
  uint8  y;
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0015,1 */
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0016,1 */
...
)
{
  ...
  for (t = 0U; t < CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_NUMBER_OF_ROUNDS; t++)
  {
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0017,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0018,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0013,1 */
...
)
{
   ...
   */
  for (i = 0U; i < CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_NUMBER_OF_ROUNDS; i++)
  {
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0006,1 */
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0010,1 */
  offset = CRYPTO_XVIX_XAIX_MIN(workspace->inputBytes2Fetch, CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_BLOCKSIZE_BYTE);

  /* Absorb the input */
  for (
        i = 0U;
        ((i < offset) && (workspace->inputBytesFetched < CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_BLOCKSIZE_BYTE));
        i++
      )
  {
  ...
  if (workspace->inputBytesFetched == CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_BLOCKSIZE_BYTE)
  {
    /* Apply block permutation function */
    /* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0023,1 */
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0007,1 */
...
)
{
  ...
  workspace->hashState[(CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_BLOCKSIZE_BYTE - 1U) / sizeof(uint64)] ^=
      (uint64)(CRYPTO_XVIX_XAIX_SHA3_KECCAK_FINAL_PADDING_BIT) << (((CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_BLOCKSIZE_BYTE - 1U) % sizeof(uint64)) * 8UL);
...
/* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/GENERAL/0009,1 */
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/HASH_SHA3256_NOTSET/FINISH/0001,1 */
  uint32 ResultLength = CRYPTO_XVIX_XAIX_MIN(*( job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr), CRYPTO_XVIX_XAIX_INT_CPR_HASH_SHA3256_NOTSET_RESULTSIZE);
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType));
...
)
{
  ...
  ret = E_OK;
  /* Deviation TASKING-1 */
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(ret, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_HASH_SHA3256_NOTSET_WorkspaceType));
