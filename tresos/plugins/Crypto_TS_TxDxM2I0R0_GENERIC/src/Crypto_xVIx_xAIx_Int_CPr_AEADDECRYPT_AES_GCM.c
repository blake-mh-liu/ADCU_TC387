...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_GCM.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                              /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_GCM.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_GCM.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_GCM.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_AEADDECRYPT_AES_GCM.c/0004,1 */

/*==================[macros]======================================================================*/

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON) */
 ...
 ** \Synchronicity{Synchronous}
 **/
/* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0005,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
...
Crypto_xVIx_xAIx_CPr_GCMZeroBlock[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES] =
{
  0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
  0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U
};
#endif /* ((CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON) */
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
...
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process -------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Main ----------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Cancel --------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Reset ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Restart ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Callback ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
   ...
   */
  for (i  = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
       i != CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_IV_LEN_BYTES;
       i--
      )
  {
    ++IV[i - 1U];
...
)
{
  ...
  if(E_OK == result)
  {
    ...
    workspace->counter[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES - 1U] = 1U;

    TS_MemBZero(workspace->tag, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES);
    workspace->secondaryOutputLength                                                 = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr        = Crypto_xVIx_xAIx_CPr_GCMZeroBlock;
    workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
    ...
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0016,1 */
    ...
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0017,1 */
    /* Encrypt the block using the secondary primitive UPDATE. This call shall never fail because
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
  return result;
}
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_AEADDECRYPT_AES_GCM == STD_ON) */
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/UPDATE/0001,2 */
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = 0U;
  ...
  if(FALSE == workspace->AADProcessed)
  {
    ...
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0019,1 */
     ...
     */
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0018,1 */
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
...
)
{
  ...
  /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/FINISH/0001,1 */
  /* NIST 800-38D Section 5.2.1.2: 128 or 120 or 112 or 104 or 96 bit */
  if (   ( 96U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && (104U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && (112U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && (120U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
      && (128U != job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.tertiaryInputLength)
     )
  {
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0015,1 */
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0022,1 */
    result = E_NOT_OK;
    /* Deviation TASKING-2 */
    CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(result, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
...
)
{
  ...
  {
    uint8 encLen[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES];
    uint8 lastCTBlock[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES];

    /* Save the last CT block */
    TS_MemCpy(lastCTBlock,
              workspace->block,
              CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES
             );
    ...
    if (0U != workspace->bytesStoredInBlock)
    {
      ...
      *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) += workspace->bytesStoredInBlock;
      ...
      TS_MemBZero
      (
        &lastCTBlock[workspace->bytesStoredInBlock],
        (CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES - workspace->bytesStoredInBlock)
      );
     /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0019,1 */
    ...
    TS_MemCpy(workspace->block, workspace->tag, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES);
    TS_MemBZero(encLen, CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES);
    /* Lengths are in bits */
    ...
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0020,1 */
    ...
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0021,1 */
  ...
  {
    /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0023,1 */
...
)
{
  ...
  {
    if (  (uint32) (workspace->availOutputLen - CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES)
        < (uint32) (0xFFFFFFFFUL              - CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES)
       )
    {
      ...
      uint32 newLen = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES - workspace->bytesStoredInBlock;
      ...
      workspace->outputPtr       = &(workspace->outputPtr[CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES]);
      workspace->outputLength   += CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
      workspace->availOutputLen -= CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
      /* !LINKSTO Crypto.Asr.SWS_Crypto_00135,1 */
      *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) += CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
      /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0006,1 */
      /* Increment the CTR */
      Crypto_xVIx_xAIx_CPr_AEAD_GCMInc(workspace->counter);
      workspace->secondaryOutputLength                                                 = CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_BLOCK_LEN_BYTES;
      workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr        = workspace->counter;
    ...
    else
    {
      ...
      *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = workspace->availOutputLen;
      /* Deviation TASKING-2 */
      CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(result, sizeof(Crypto_xVIx_xAIx_CPr_AEADDECRYPT_AES_GCM_WorkspaceType));
    }
  }
  else
  {
...
)
{
  ...
  if(E_OK == result)
  {
    ...
    if (E_OK == result)
    {
      /* !LINKSTO Crypto.Req.CPr/AEADDECRYPT_AES_GCM/GENERAL/0004,1 */
      if (CRYPTO_XVIX_XAIX_INT_CPR_AEADDECRYPT_AES_GCM_IV_LEN_BYTES != counterPtr->data->size)
      {
