...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_AES_CMAC.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                               /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_AES_CMAC.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                 /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_AES_CMAC.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_AES_CMAC.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_CPr_MACGENERATE_AES_CMAC.c/0004,1 */
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON) */
 ...
 **/
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_StateTransitionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateTransitionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[CRYPTO_XVIX_XAIX_STATETRANSITIONTABLE_COUNT] =
{
 ...
 **/
/* !LINKSTO Crypto.Dsn.Api/Consts/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_StateActionTable/0001,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
static CONST(Crypto_xVIx_xAIx_PrimitiveStateActionType, CRYPTO_xVIx_xAIx_CONST)
Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateActionTable[CRYPTO_XVIX_XAIX_STATEACTIONTABLE_COUNT] =
{
 ...
 **/
 /* !LINKSTO Crypto.Req.CPr/MACGENERATE_AES_CMAC/GENERAL/0012,1 */
#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
static CONST(uint8, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_MACGENERATE_AES_CMAC_Rb[CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE] =
{
...
/*--- Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process ------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
{
  CRYPTO_XVIX_XAIX_CAST_WORKSPACETYPE(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType);
  ...
  {
    (void) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Reset(workspace->paObjectId, job, primitive);
  }
  ...
  if (TRUE == runPrimitive)
  {
    ...
    if (CRYPTO_PROCESSING_SYNC == jobProcessing)
    {
      ...
      do
      {
        ...
        (void) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Main(objectId, job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Main ---------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Main/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Main
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (TRUE == flgExecute)
  {
    ...
    if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateActionTable[curState].fcnAction))
    {
      resultAction = Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateActionTable[curState].fcnAction(job, primitive);
    }
    else
    {
    ...
    if (TRUE == nxtStateFound)
    {
      ...
      if (NULL_PTR != (Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[smStateIndx].fcnTransition))
      {
        /* transition function returns using workspace->smResult */
        (void) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[smStateIndx].fcnTransition(job, primitive);
...
/*--- Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Cancel -------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Cancel/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Cancel
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
...
/*--- Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Reset --------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Reset/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Reset
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESET(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
    result = E_OK;
  }
  else
  {
...
/*--- Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Restart --------------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Restart/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Restart
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive
)
{
  ...
  if (NULL_PTR != workspace->paPrimitive)
  {
    CRYPTO_XVIX_XAIX_SET_SMRESULT_RESTART(E_OK, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
  }
  else
  {
    result = E_OK;
...
/*--- Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Callback -----------------------------------------*/

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Callback/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_CPR_MACGENERATE_AES_CMAC == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
  P2CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) primitive,
...
)
{
  ...
  result              = Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Reset(workspace->paObjectId, job, primitive);
...
)
{
  ...
  {
    if (   (Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[i].curState == curState    )
        && (Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[i].event    == resultAction)
        && (   (Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[i].processingType == jobProcessing                   )
            || (Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[i].processingType == CRYPTO_XVIX_XAIX_PROCESSING_BOTH)
           )
       )
    {
      *nxtState      = Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_Process_StateTransitionTable[i].nxtState;
       nxtStateFound = TRUE;
      *smStateIndx   = i;
      break;
    }
...
)
{
  ...
  if (CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE == workspace->yLvl)
  {
    for (i = 0U; i < CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE; i++)
    {
    ...
    workspace->yLvl                      = 0U;
    workspace->blkCnt                   += 1U;
    workspace->secondaryOutputPtrLength  = CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE;
  }
  /* CHECK: NOPARSE */
  else
  {
  ...
  bytesFetch  = (uint8) CRYPTO_XVIX_XAIX_MIN(((uint32) CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE - workspace->yLvl),
                                             bytesRemain
                                            );
  /* CHECK: NOPARSE
...
)
{
  ...
  if (   (0U == (( workspace->blkCnt * CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE) + workspace->yLvl)                                         )
      || (0U != (((workspace->blkCnt * CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE) + workspace->yLvl) % CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE))
     )
  {
    /* pad the last block */
    workspace->y[workspace->yLvl] = 0x80U;
    TS_MemBZero(&(workspace->y[workspace->yLvl + 1U]),
                (uint8) (CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE - workspace->yLvl - 1U)
               );
...
)
{
  ...
  TS_MemBZero(workspace->x, CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE);
  TS_MemBZero(workspace->y, CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE);
  ...
  if (E_OK == result)
  {
    ...
    if (doCopySubKeys)
    {
      ...
      if (E_OK == result)
      {
        ...
        if (E_OK == result)
        {
          if (   (CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE == k1Ptr->data->size)
              && (CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE == k2Ptr->data->size)
             )
          {
          ...
          {
            /* !LINKSTO Crypto.Req.CPr/MACGENERATE_AES_CMAC/UPDATE/0001,1 */
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_START(result, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
...
)
{
  ...
  workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE;
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_UPDATE(workspace->smResult, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
...
)
{
  ...
  result = E_OK;
  /* !LINKSTO Crypto.Req.CPr/MACGENERATE_AES_CMAC/GENERAL/0003,2 */
  TS_MemCpy(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputPtr,
            ...
            CRYPTO_XVIX_XAIX_MIN(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
                                 CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE
                                )
           );
  ...
  *(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr) = CRYPTO_XVIX_XAIX_MIN(*(job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr),
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_FINISH(result, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
...
)
{
  ...
  if (E_OK == result)
  {
    ...
    if (E_OK == result)
    {
      ...
      for (workspace->inputBytesFetched =  0U;
           (workspace->inputBytesFetched + CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE) < job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength;
           workspace->inputBytesFetched += CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE
          )
      {
        workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE;
        workspace->secondaryJob.CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.outputLengthPtr = &workspace->secondaryOutputPtrLength;
    ...
    if (E_OK == result)
    {
      ...
      if (   (0U ==  job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength                                         )
          || (0U != (job->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength % CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE))
        )
      {
        /* pad the last block */
        workspace->y[workspace->yLvl] = 0x80U;
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_SINGLECALL(result, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
...
)
{
  ...
  CRYPTO_XVIX_XAIX_SET_SMRESULT_CANCEL(CRYPTO_E_JOB_CANCELED, sizeof(Crypto_xVIx_xAIx_CPr_MACGENERATE_AES_CMAC_WorkspaceType));
...
)
{
  ...
  TS_MemBZero(workspace->k2, CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE);
  ...
  Crypto_xVIx_xAIx_ShiftBufUint8Left(workspace->k1, CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE, 1U);

  if (TRUE == msb)
  {
    for (i = 0U; i < CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE; i++)
    {
      workspace->k1[i] ^= Crypto_xVIx_xAIx_MACGENERATE_AES_CMAC_Rb[i];
    }
  }

  msb = CRYPTO_XVIX_XAIX_MSB(workspace->k1);
  TS_MemCpy(workspace->k2, workspace->k1, CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE);

  Crypto_xVIx_xAIx_ShiftBufUint8Left(workspace->k2, CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE, 1U);

  if (TRUE == msb)
  {
    for (i = 0U; i < CRYPTO_XVIX_XAIX_INT_CPR_MACGENERATE_AES_CMAC_BLOCKSIZE; i++)
    {
      workspace->k2[i] ^= Crypto_xVIx_xAIx_MACGENERATE_AES_CMAC_Rb[i];
    }
  }
