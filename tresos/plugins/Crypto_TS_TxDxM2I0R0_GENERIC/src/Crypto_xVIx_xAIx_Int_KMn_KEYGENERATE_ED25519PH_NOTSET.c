...
/* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET.c/0001,1 */
...
#include <Crypto_xVIx_xAIx_Int.h>                                       /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET.c/0002,1 */
#include <Crypto_xVIx_xAIx_Int_KeyManagement.h>                         /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET.c/0003,1 */
#include <Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET.h>  /* !LINKSTO Crypto.Dsn.Api/Files/Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET.c/0004,1 */
#include <Crypto_xVIx_xAIx_Int_Lib_LN.h>
#include <Crypto_xVIx_xAIx_Int_Lib_Ecc.h>
#include <Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET_Cfg.h>

/*==================[macros]======================================================================*/

#if (defined CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PRIVKEY_LENGTH)
#error CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PRIVKEY_LENGTH is already defined
#endif
/** \brief The private key length of the Ed25519yy curve in bytes. */
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PRIVKEY_LENGTH 32U

#if(defined CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PUBKEY_LENGTH)
  #error CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PUBKEY_LENGTH is already defined
#endif
/** \brief The public key length of the Ed25519yy curve in bytes. */
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PUBKEY_LENGTH 32U

#if(defined CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH)
#error CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH is already defined
#endif
/** \brief The maximum length, which is needed for byte array representation **/
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH 32U

#if (defined CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_HASH_LENGTH)
#error CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_HASH_LENGTH is already defined
#endif
/** \brief The maximal allowed length for a hash digest in bytes. **/
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_HASH_LENGTH 64U

#if (defined CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS)
#error CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS is already defined
#endif
 ...
 */
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS                                    \
(                                                                                    \
   (Crypto_xVIx_xAIx_LNWordType)                                                     \
   (                                                                                 \
      CRYPTO_XVIX_XAIX_LN_NUMBER_LEN(CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH) + \
      (Crypto_xVIx_xAIx_LNWordType)1UL                                               \
   )                                                                                 \
)

#if (defined CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS)
#error CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS is already defined
#endif
/** \brief The length, in words, which is needed for the long number representation of
 *         the longest possible temporary number. This length depends on the
 *         configured curve.
 */
#define CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_TEMP_LEN_WORDS                                     \
(                                                                                      \
   (Crypto_xVIx_xAIx_LNWordType)                                                       \
   (                                                                                   \
      (CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS * (Crypto_xVIx_xAIx_LNWordType)2UL) - \
      (Crypto_xVIx_xAIx_LNWordType)1UL                                                 \
   )                                                                                   \
)
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_KMN_KEYGENERATE_ED25519PH_NOTSET == STD_ON)
static FUNC(void, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_GeneratePublicKey
(
 ...
 **/
#if (CRYPTO_XVIX_XAIX_API_ENABLED_KMN_KEYGENERATE_ED25519PH_NOTSET == STD_ON)
static FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET_Callback
(
          uint32                                                                    objectId,
    P2VAR(Crypto_JobType,                    AUTOMATIC, CRYPTO_xVIx_xAIx_APPL_DATA) job,
...
CONST(Crypto_xVIx_xAIx_PrimitiveDescriptionType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_Primitive =
{
  NULL_PTR,
  NULL_PTR,
  NULL_PTR,
  NULL_PTR,
  NULL_PTR,
  Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET_Callback,
  0U,
  0U,
  0U
};
...
CONST(Crypto_xVIx_xAIx_CDOPrimitiveCnfgType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_PrimitiveCnfg =
{
  &Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_Primitive,
  NULL_PTR,
  0U,
  NULL_PTR,
  0U
...
CONST(Crypto_xVIx_xAIx_CDOPrimitiveType, CRYPTO_xVIx_xAIx_CONST) Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_DummyPrimitive =
{
  &Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_PrimitiveCnfg,
  NULL_PTR,
  NULL_PTR,
  NULL_PTR
};
...
#define CRYPTO_xVIx_xAIx_START_SEC_CODE
#include <Crypto_xVIx_xAIx_MemMap.h>
/* --- Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET_Process ------------------------ */

/* !LINKSTO Crypto.Dsn.Api/Interfaces/Crypto_xVIx_xAIx_KMn_KEYGENERATE_ED25519PH_NOTSET_Process/0001,1 */

#if (CRYPTO_XVIX_XAIX_API_ENABLED_KMN_KEYGENERATE_ED25519PH_NOTSET == STD_ON)
FUNC(Std_ReturnType, CRYPTO_xVIx_xAIx_CODE) Crypto_xVIx_xAIx_Int_KMn_KEYGENERATE_ED25519PH_NOTSET_Process
(
          uint32                                                 objectId,
...
)
{
  ...
  uint8          tmpByteArray[CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_HASH_LENGTH] = { 0U };
  uint32         tmpByteArrayLength                                    =   0U;
  boolean        fromPrimitive                                         = FALSE;

  Crypto_xVIx_xAIx_LNWordType scalarS[CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS] = { 0U };
  ...
  /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0003,1 */
  if (E_OK == retVal)
  {
    fromPrimitive = FALSE;
    /* Deviation TASKING-1 */
  ...
  /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0004,1 */
  if (E_OK == retVal)
  {
    /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0005,1 */
    ...
    else
    {
      ...
      tmpByteArrayLength = CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_HASH_LENGTH;
      /* Hash the private key */
      jobs->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputPtr        = privateKeyPtr->data->data;
      jobs->CRYPTO_XVIX_XAIX_JOBPRIMITIVEINPUTOUTPUT.inputLength     = CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PRIVKEY_LENGTH;
      ...
      /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0006,1 */
      ...
      /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0007,1 */
      ...
      scalarS[0U]        = CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_NUM_LEN_WORDS;

      /* Calculate the public key */
      Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_GeneratePublicKey(scalarS,
                                            tmpByteArray,
                                            wkspDataPtr,
                                            curveIndex
                                           );

      /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0008,1 */
      ...
      /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0009,1 */
      if (E_OK == retVal)
      {
        fromPrimitive = FALSE;
        /* Deviation TASKING-1 */
        CRYPTO_XVIX_XAIX_KEY_ELEMENT_WRITE_LOCK(retVal, publicKeyPtr, fromPrimitive);
        /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0010,1 */
        if (E_OK == retVal)
        {
          /* Set the size */
          publicKeyPtr->data->size = CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_PUBKEY_LENGTH;
          /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/COMMON/0001,1 */
          /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/COMMON/0002,1 */
          /* The encoded public key is stored in the second half of the byte array */
          CRYPTO_XVIX_XAIX_KEY_ELEMENT_STORE(
                                              cryptoKeyId,
                                              CRYPTO_KE_KEYGENERATE_KEY,
                                              publicKeyPtr,
                                             &tmpByteArray[CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH],
...
)
{
  ...
  primitivePtr->data->P1 = &Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_DummyPrimitive;
...
#endif /* #if (CRYPTO_XVIX_XAIX_API_ENABLED_KMN_KEYGENERATE_ED25519PH_NOTSET == STD_ON) */
/*--- Crypto_xVIx_xAIx_KEYGENERATE_ED25519PH_NOTSET_GeneratePublicKey ----------------------------- */
...
)
{
  ...
  uint32       length = CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_BYTEARRAY_LENGTH;
  /* Set the index */
   ...
   */
   /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0011,1 */
  ...
  /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0013,1 */
  ...
  {
    /* !LINKSTO Crypto.Req.KMn/KEYGENERATE_ED25519PH_NOTSET/GENERAL/0014,1 */
    byteArray[(CRYPTO_XVIX_XAIX_INT_KMN_KEYGENERATE_ED25519PH_NOTSET_HASH_LENGTH) - 1U] |= (uint8)((uint8)curveCtx.x0 << 7U);
  }
