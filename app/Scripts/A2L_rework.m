...
cd ([Clone_path '\' RAW_CODE_folder '\Merged_a2l'])
fileID = fopen('SWC_ETE_type.a2l');
...
fileID = fopen('A2L_Head_SWC_ETE_type.a2l','r');
...
movefile('NewA2L.a2l','SWC_ETE_type.a2l');
cd (arch_path)
