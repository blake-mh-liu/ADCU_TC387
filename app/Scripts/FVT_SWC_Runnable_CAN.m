...
if ~any(contains(SWCFDC_arxml_Updated, '<DATA-RECEIVE-POINT-BY-ARGUMENTS>'))
    ...
    location_Data_Receive_Point = location_5ms_Runnable + find(contains(SWCFDC_arxml_Updated(location_5ms_Runnable:end, 1), '<DATA-RECEIVE-POINT-BY-ARGUMENTS>'), 1, 'first') - 1;
end
