...
if NM_PDUCnt ~= 0
    for i = 1:2
        ...
        h = find(contains(tmpCell,'<SHORT-NAME>FrameName</SHORT-NAME>'));
        OldString = extractBetween(tmpCell(h),'>','<');
        NewString = [Channel '_NMm_' TargetECU_Abb '_' Direction];
        ...
        OldString = extractBetween(tmpCell(h),'>','<');
        NewString = ['/' Channel '/PDU/' Channel '_NMm_' TargetECU_Abb '_' Direction];
...
OldString = extractBetween(Target_arxml(h),'>','<');
NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel];
...
for i = 1:length(DBC.Messages)
    ...
    OldString = extractBetween(tmpCell(h),'>','<');
    NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/FP_' Channel '_' MsgName '_' Direction];
...
if NM_PDUCnt ~= 0
    for i = 1:2
        ...
        OldString = extractBetween(tmpCell2(h),'>','<');
        NewString = ['FT_' Channel '_NMm_' TargetECU_Abb '_' Direction];
        ...
        OldString = extractBetween(tmpCell2(h),'>','<');
        NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/FP_' Channel '_NMm_' TargetECU_Abb '_' Direction '_' Direction_Port];
        ...
        OldString = extractBetween(tmpCell2(h),'>','<');
        NewString = ['/' Channel '/Frame/' Channel '_NMm_' TargetECU_Abb '_' Direction];
...
for i = 1:length(DBC.Messages)
    ...
    for n = 1:length(SGName)
        ...
        OldString = extractBetween(tmpCell(h),'>','<');
        NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/SP_' char(SGName(n)) '_' Direction]; % /ECU/FUSION/ConnCAN1/SP_CAN1_SG_FD_VCU1_OUT
        tmpCell(h) = strrep(tmpCell(h),OldString,NewString);
    ...
    for k = 1:length(DBC.MessageInfo(i).Signals)
        ...
        h = find(contains(tmpCell,'<I-SIGNAL-PORT-REF DEST="I-SIGNAL-PORT">'));
        OldString = extractBetween(tmpCell(h),'>','<');
        NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/SP_' Channel '_' SignalName '_' Direction];
...
for i = 1:length(DBC.Messages)
    ...
    OldString = extractBetween(tmpCell(h),'>','<');
    NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/PP_' Channel '_' MsgName '_' Direction];
    ...
    if strcmp(MsgType,'N-PDU')
        ...
        h = find(contains(tmpCell,'<I-PDU-PORT-REF DEST="I-PDU-PORT">'));
        OldString = extractBetween(tmpCell(h),'>','<');
        NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/PP_' Channel '_SDU_' MsgName '_' Direction];
...
if NM_PDUCnt ~= 0
    for i = 1:2
        ...
        OldString = extractBetween(tmpCell2(h),'>','<');
        NewString = ['PT_' Channel '_NMm_' TargetECU_Abb '_' Direction];
        ...
        OldString = extractBetween(tmpCell2(h),'>','<');
        NewString = ['/ECU/' TargetECU_Abb '/Conn' Channel '/PP_' Channel '_NMm_' TargetECU_Abb '_' Direction '_' Direction_Port];
