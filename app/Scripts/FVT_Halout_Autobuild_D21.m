function FVT_Halout_Autobuild_D21()
...
ECU_list = {'FUSION','ZONE_DR','ZONE_FR','MCU'};
...
for i = 1:length(CAN_Msg_Output_array)
    while i <= length(CAN_Msg_Output_array) && ...
        ~startsWith(CAN_Msg_Output_array(i),'P_CAN3_MCU_B_R2')... 
...
%                      end
                    ...
                    block_y = 800;
                    block_w = block_x + 20 ;
                    block_h = block_y + 70*ceil(str2double(DLC)-1);
                    srcT = 'simulink/Commonly Used Blocks/Mux';
                    dstT = [TargetModel '/' BlockName];
                    h = add_block(srcT,dstT,'MakeNameUnique','off');     
                    set_param(h,'Inputs',num2str(ceil((str2double(DLC)-1))));
                    set_param(h,'position',[block_x,block_y,block_w,block_h]);
                    sourceport = get_param(h,'PortHandles');
...
ElseOutport_array = {'VOUTP_NetworkReq_flg','VOUTP_SysPowerMode_enum','VOUTP_NvWriteReqRisingEdge_flg','VOUTP_FdcSlpReqRisingEdge_flg','VOUTP_FdcSlpTime_sec','VOUTP_IVIRST_flg','VOUTP_AcoreRebootCmdACK_flg'};
BusSelector_array = 'VOUTP_NetworkReq_flg,VOUTP_SysPowerMode_enum,VOUTP_NvWriteReqRisingEdge_flg,VOUTP_FdcSlpReqRisingEdge_flg,VOUTP_FdcSlpTime_sec,VOUTP_IVIRST_flg,VOUTP_AcoreRebootCmdACK_flg';
