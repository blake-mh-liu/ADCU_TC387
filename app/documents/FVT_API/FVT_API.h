...
#define NUM_CAN_CH1_RX_MSG 7
#define NUM_CAN_CH2_RX_MSG 5
#define NUM_CAN_CH3_RX_MSG 21
#define NUM_CAN_CH4_RX_MSG 16
#define NUM_CAN_CH6_RX_MSG 3
#define NUM_CAN_CH7_RX_MSG 4

#define NUM_LIN_CHANNEL 0

#define CAR_MODEL D21
#define CONTROLLER FD
#define COUNTRY TW
#define	CAR_MODEL_VARIATION X
...
/* DKC */
extern uint8_t dkc_key_status_get(const uint8_t *buf, const uint8_t len);
extern void dkc_main(void);

/* set hazard indicator GPIO control */
extern void ApiDio_SetHazardIND(uint8_t value);
