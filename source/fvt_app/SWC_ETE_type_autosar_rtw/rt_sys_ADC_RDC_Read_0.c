...
void SWC_ETE_type_Delay(float32 *rty_y, ARID_DEF_Delay_SWC_ETE_type_T
 ...
 *    '<S58>/Delay'
 */
void SWC_ETE_type_Delay_Update(float32 rtu_u, ARID_DEF_Delay_SWC_ETE_type_T
  *SWC_ETE_type__ARID_DEF_arg)
{
