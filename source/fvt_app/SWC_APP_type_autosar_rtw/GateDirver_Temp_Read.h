...
#ifndef GateDirver_Temp_Read_h_
#define GateDirver_Temp_Read_h_
...
extern void SWC_APP_ty_GateDirver_Temp_Read(void);

#endif                                 /* GateDirver_Temp_Read_h_ */
