...
push @GenldCommon::usage_fns, \&gnu_usage;
...
sub getMemoryBlockStart
{
	my $self = shift;
	my $memBlock = shift;
	return "ORIGIN(${memBlock})";
}
...
Additional options specific to GNU:
  -emit-load-segements:
  ...
  This is meant as a workaround for versions of the GNU toolchain where the linker generates
