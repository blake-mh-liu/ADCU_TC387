...
/** \brief Convert a float32 value to fixpoint
 *
 * This function converts a value from a float32 format to a fixpoint format.
 *
 *
 ...
 *
 */
IFX_INLINE fract Ifx__float32_to_fixpoint(float32 value, sint32 shift)
{
	fract result;
